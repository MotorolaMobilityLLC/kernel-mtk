...
*
********************************************************/
static	int aw_parse_bin_header_1_0_0(struct aw_bin *bin);	// zane added static

static int aw_check_sum(struct aw_bin *bin, int bin_num)  // zane added static
{
	unsigned int i = 0;
...
static int aw_check_data_version(struct aw_bin *bin, int bin_num) // zane added static
{
	int i = 0;
	DBG("enter\n");
...
static int aw_parse_each_of_multi_bins_1_0_0(unsigned int bin_num, int bin_serial_num,
				      struct aw_bin *bin) // zane added static
{
	int ret = 0;
...
static int aw_get_multi_bin_header_1_0_0(struct aw_bin *bin)  // zane added static
{
	int i = 0;
	int ret = 0;
...
static int aw_check_bin_header_version(struct aw_bin *bin)   // zane  added static
{
	int ret = 0;
 ...
 int pa_aw_parsing_bin_file(struct aw_bin *bin)   // zane added Pa  
{
	int i = 0;
	int ret = 0;
