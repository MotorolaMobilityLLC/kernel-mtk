...
/* physical size in um */
#define LCM_PHYSICAL_WIDTH (66520)
#define LCM_PHYSICAL_HEIGHT (140480)
...
{0x5d,0x01,{0xef}},                   
{0x5e,0x01,{0x00}},                   
{0x5f,0x01,{0x06}},    //GOUT_L1    ST
{0x60,0x01,{0x02}},    //GOUT_L2    VG
{0x61,0x01,{0x02}},    //GOUT_L3    VG
{0x62,0x01,{0x02}},    //GOUT_L4    VG
{0x63,0x01,{0x0c}},    //GOUT_L5    CK
{0x64,0x01,{0x0d}},    //GOUT_L6    CL
{0x65,0x01,{0x0e}},    //GOUT_L7    CK
{0x66,0x01,{0x0f}},    //GOUT_L8    CL
{0x67,0x01,{0x00}},    //GOUT_L9    VS
{0x68,0x01,{0x17}},    //GOUT_L10   GC
{0x69,0x01,{0x07}},    //GOUT_L11   ST
{0x6a,0x01,{0x02}},    //GOUT_L12     
{0x6b,0x01,{0x02}},    //GOUT_L13     
{0x6c,0x01,{0x02}},    //GOUT_L14     
{0x6d,0x01,{0x02}},    //GOUT_L15     
{0x6e,0x01,{0x02}},    //GOUT_L16     
{0x6f,0x01,{0x02}},    //GOUT_L17     
{0x70,0x01,{0x02}},    //GOUT_L18     
{0x71,0x01,{0x02}},    //GOUT_L19     
{0x72,0x01,{0x02}},    //GOUT_L20     
{0x73,0x01,{0x16}},    //GOUT_L21   GC
{0x74,0x01,{0x01}},    //GOUT_L22   VD
{0x75,0x01,{0x06}},                   
{0x76,0x01,{0x02}},                   
{0x77,0x01,{0x02}},                   
{0x78,0x01,{0x02}},                   
...
{0x3B,0x01,{0x98}},    //PUMP SHIFT CL
{0x35,0x01,{0x17}},    //HZ_opt       
{0x3A,0x01,{0x92}},    //PS_EN        
{0xB5,0x01,{0x27}},    //GMA BIAS     
{0x31,0x01,{0x75}},    //SRC BIAS     
{0x30,0x01,{0x03}},    //SRC OUTPUT BI
{0x33,0x01,{0x14}},    //Blanking fram
{0x38,0x01,{0x01}},                   
{0x39,0x01,{0x00}},                   
...
{0x22,0x01,{0x0A}},                   
{0x2E,0x01,{0x0E}},    //GATE 1560    
{0x2F,0x01,{0x80}},    //GATE 1560    
{0x31,0x01,{0x00}},                   
{0x53,0x01,{0xA5}},   //93            
{0x55,0x01,{0x93}},                   
{0x56,0x01,{0x00}},                   
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
   ...
   params->dsi.vertical_sync_active                = 4;
    ...
    params->dsi.ssc_range=2;
		params->dsi.PLL_CLOCK=245;  //LINE </EGAFM-297> <change the mipi clock to reduce disturbing the wifi> <20160413> panzaoyan
...
struct LCM_DRIVER ili9881c_p160_hdplus_dsi_vdo_lch_lcm_drv = 
{
