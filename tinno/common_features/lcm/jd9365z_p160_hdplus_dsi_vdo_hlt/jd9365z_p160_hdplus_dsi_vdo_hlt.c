...
#define LCM_DBG(fmt, arg...) \
    LCM_PRINT("[jd9365z_p160_hdplus_dsi_vdo_hlt.c kernel] %s (line:%d) :" fmt "\r\n", __func__, __LINE__, ## arg)
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->corner_pattern_height_bot = 10;
#endif
...
struct LCM_DRIVER jd9365z_p160_hdplus_dsi_vdo_hlt_lcm_drv =
{
    .name           = "jd9365z_p160_hdplus_dsi_vdo_hlt",
