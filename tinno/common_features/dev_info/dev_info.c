...
static struct device_attribute product_dev_attr_array[] = {
    ...
    PRODUCT_DEV_INFO_ATTR(info_main_camera_sn),
    PRODUCT_DEV_INFO_ATTR(info_sub_camera_sn),
    PRODUCT_DEV_INFO_ATTR(info_main2_camera_sn),
    PRODUCT_DEV_INFO_ATTR(info_main3_camera_sn),
