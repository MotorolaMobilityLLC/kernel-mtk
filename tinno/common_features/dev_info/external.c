...
{										
    ...
    else if(strncasecmp((const char *)tempID, "d6", 2) == 0)		// d6 is OEMid for FORESEE 
   		strcpy(vendorName , "FORESEE");	
    else if(strncasecmp((const char *)tempID, "9b", 2) == 0)            // 9b is OEMid for Ymtc
                strcpy(vendorName , "Ymtc");
