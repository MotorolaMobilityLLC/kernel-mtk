...
/* For ftm test*/
//#define FF_IOC_WRITE_CHIP_NAME        _IOW(FF_IOC_MAGIC, 0x0c, const char)
//#define FF_IOC_WRITE_CHIP_ID          _IOW(FF_IOC_MAGIC, 0x0d, unsigned short)
