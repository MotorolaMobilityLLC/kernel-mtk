...
struct soc_thermal {
	...
	const struct soc_thermal_data *conf;
 ...
 * data.
 */
static const struct soc_thermal_data mt2701_thermal_data = {
 ...
 * data.
 */
static const struct soc_thermal_data mt2712_thermal_data = {
 ...
 * access.
 */
static const struct soc_thermal_data mt7622_thermal_data = {
...
static int soc_thermal_probe(struct platform_device *pdev)
{
	...
	for (i = 0; i < mt->conf->num_banks; i++)
		soc_thermal_init_bank(mt, i, apmixed_phys_base,
				      auxadc_phys_base);
