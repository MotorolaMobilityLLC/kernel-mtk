	...
	struct kobj_attribute *attr, const char *buf, size_t count)
{
	...
	pr_info("[user_vsensor0_store] invalid input\n");
	...
	struct kobj_attribute *attr, const char *buf, size_t count)
{
	...
	pr_info("[user_vsensor1_store] invalid input\n");
	...
	struct kobj_attribute *attr, const char *buf, size_t count)
{
	...
	pr_info("[user_vsensor2_store] invalid input\n");
	...
	struct kobj_attribute *attr, const char *buf, size_t count)
{
	...
	pr_info("[user_vsensor3_store] invalid input\n");
	...
	struct kobj_attribute *attr, const char *buf, size_t count)
{
	...
	pr_info("[user_vsensor4_store] invalid input\n");
