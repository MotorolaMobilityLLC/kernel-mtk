        ...
        size_t count, loff_t *offset)
{
    ...
    pr_err("%s: start reading of %zu bytes\n", __func__, count);
    ...
    pr_err("%s: Success in reading %zu bytes\n", __func__, count);
    return ret;
err:
    mutex_unlock(&nfc_dev->read_mutex);
    return ret;
        ...
        size_t count, loff_t *offset)
{
    ...
    pr_err("%s: start writing of %zu bytes\n", __func__, count);
    ...
    pr_err("%s: Success in writing %zu bytes\n", __func__, count);
    /* delay of 1ms for slow devices*/
    udelay(1000);
    return ret;
}
