				     ...
				     enum phy_mode mode)
{
	...
	//{ Modify by Richard for p412 usb eye diagram
	...
	case PHY_MODE_USB_DEVICE:
		...
		//{ Modify by Richard for p412 usb eye diagram
		if (is_p412) {
			device_property_read_u32(dev, "mediatek,eye-src-412",
				 &instance->eye_src);
			device_property_read_u32(dev, "mediatek,eye-vrt-412",
				 &instance->eye_vrt);
			device_property_read_u32(dev, "mediatek,eye-term-412",
				 &instance->eye_term);
			device_property_read_u32(dev, "mediatek,eye-rev6-412",
				 &instance->eye_rev6);
			device_property_read_u32(dev, "mediatek,eye-disc-412",
				 &instance->eye_disc);
		} else {
