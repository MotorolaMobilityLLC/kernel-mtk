...
#define msdc_oc_check(msdc_host)
...
/* Note: There is "extern void msdc_set_driving(...)"
 * in drivers/misc/mediatek/include/mt-plat/mtk_sd_misc.h,
 * so we cannot declar msdc_set_driving as macro here
 */
