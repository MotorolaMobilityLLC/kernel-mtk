...
void msdc_dump_ldo_sts(struct msdc_host *host)
{
	...
	case 0:
		...
		pr_notice(
		" VEMC_EN=0x%x, VEMC_VOL=0x%x [4b'1011(3V)], VEMC_CAL=0x%x\n",
	...
	case 1:
		...
		pr_notice(
		" VMCH_EN=0x%x, VMCH_VOL=0x%x [4b'1011(3V)], VMCH_CAL=0x%x\n",
			ldo_en, ldo_vol, ldo_cal);
		break;
	default:
		break;
...
void msdc_sd_power(struct msdc_host *host, u32 on)
{
	...
	case 1:
		...
		msdc_ldo_power(card_on, host->mmc->supply.vmmc, VOL_3000,
			&host->power_flash);
		/* VMC VOLSEL */
		/* rollback to 0mv in REG_VMC_VOSEL_CAL in case of SD3.0
		 * setting
		 */
		pmic_config_interface(REG_VMC_VOSEL_CAL,
...
"MSDC1 R1   [0x%p] =0x%8x\tshould: 32'b........ ........ ........ 000001..\n",
		...
		pr_notice(
"should 1.8v & sleep & awake: 32'b00000000 0000.... ........ ........\n");

		pr_notice("MSDC1 RDSEL0  [0x%p] =0x%8x\n",
			MSDC1_GPIO_RDSEL, MSDC_READ32(MSDC1_GPIO_RDSEL));
		pr_notice(
"should 1.8v & sleep & awake: 32'b00000000 00000000 00...... ........\n");
