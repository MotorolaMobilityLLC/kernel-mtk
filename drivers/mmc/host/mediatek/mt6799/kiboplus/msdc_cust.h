...
#ifndef _MSDC_CUST_KIBOPLUS_H_
#define _MSDC_CUST_KIBOPLUS_H_

#include <dt-bindings/mmc/kiboplus-msdc.h>
#include <dt-bindings/clock/kiboplus-clk.h>
...
#define DT_COMPATIBLE_NAME      "mediatek,kiboplus-mmc"
