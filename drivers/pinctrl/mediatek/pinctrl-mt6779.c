...
/* #define GPIO_DEBUG */
	...
	pr_info("%s: pin = %d, enab = %d, sel = %d, arg = %u\n",
		__func__, pin, enable, isup, arg);
#endif
...
static const unsigned int mt6779_debounce_data[] = {
	128, 256, 512, 1024, 16384,
	32768, 65536, 131072, 262144, 524288
};

static unsigned int mt6779_spec_debounce_select(unsigned int debounce)
{
	return mtk_gpio_debounce_select(mt6779_debounce_data,
		ARRAY_SIZE(mt6779_debounce_data), debounce);
}
...
static const struct mtk_pinctrl_devdata mtk_pinctrl_data = {
	...
	.spec_debounce_select = mt6779_spec_debounce_select,
...
MODULE_AUTHOR("Andy Teng <andy.teng@mediatek.com>");
