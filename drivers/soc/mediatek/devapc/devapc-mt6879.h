...
#ifndef __DEVAPC_MT6879_H__
#define __DEVAPC_MT6879_H__
...
#define L3CACHE_1_START				(0x0C800000)
#define L3CACHE_1_END				(0x0CBFFFFF)
...
static const struct mtk_device_info mt6879_devices_infra[] = {
	...
	{0, 76, 121, "MCUSYS_CFGREG_APB_S", true},
	{0, 77, 122, "MCUSYS_CFGREG_APB_S-1", true},
	{0, 78, 123, "MCUSYS_CFGREG_APB_S-2", true},
	{0, 79, 124, "MCUSYS_CFGREG_APB_S-3", true},

	/* 80 */
	{0, 80, 125, "MCUSYS_CFGREG_APB_S-4", true},
	{0, 81, 127, "L3C_S", true},
	{0, 82, 128, "L3C_S-1", true},
	{0, 83, 129, "L3C_S-2", true},
	{0, 84, 136, "VLPSYS_S", true},
	{0, 85, 142, "DEBUGSYS_APB_S", true},
	{0, 86, 143, "DPMAIF_PDN_APB_S", true},
	{0, 87, 144, "DPMAIF_PDN_APB_S-1", true},
	{0, 88, 145, "DPMAIF_PDN_APB_S-2", true},
	{0, 89, 146, "DPMAIF_PDN_APB_S-3", true},

	/* 90 */
	{0, 90, 147, "DEVICE_APC_INFRA_PDN_APB_S", true},
	{0, 91, 148, "DEBUG_TRACKER_APB_S", true},
	{0, 92, 149, "DEBUG_TRACKER_APB1_S", true},
	{0, 93, 150, "BCRM_INFRA_PDN_APB_S", true},
	{0, 94, 151, "M4_IOMMU0_APB_S", true},
	{0, 95, 152, "M4_IOMMU1_APB_S", true},
	{0, 96, 153, "M4_IOMMU2_APB_S", true},
	{0, 97, 154, "M4_IOMMU3_APB_S", true},
	{0, 98, 155, "M4_IOMMU4_APB_S", true},
	{0, 99, 156, "M6_IOMMU0_APB_S", true},

	/* 100 */
	{0, 100, 157, "M6_IOMMU1_APB_S", true},
	{0, 101, 158, "M6_IOMMU2_APB_S", true},
	{0, 102, 159, "M6_IOMMU3_APB_S", true},
	{0, 103, 160, "M6_IOMMU4_APB_S", true},
	{0, 104, 161, "M7_IOMMU0_APB_S", true},
	{0, 105, 162, "M7_IOMMU1_APB_S", true},
	{0, 106, 163, "M7_IOMMU2_APB_S", true},
	{0, 107, 164, "M7_IOMMU3_APB_S", true},
	{0, 108, 165, "M7_IOMMU4_APB_S", true},
	{0, 109, 166, "PTP_THERM_CTRL_APB_S", true},

	/* 110 */
	{0, 110, 167, "PTP_THERM_CTRL2_APB_S", true},
	{0, 111, 168, "SYS_CIRQ_APB_S", true},
	{0, 112, 169, "CCIF0_AP_APB_S", true},
	{0, 113, 170, "CCIF0_MD_APB_S", true},
	{0, 114, 171, "CCIF1_AP_APB_S", true},
	{0, 115, 172, "CCIF1_MD_APB_S", true},
	{0, 116, 173, "MBIST_PDN_APB_S", true},
	{0, 117, 174, "INFRACFG_PDN_APB_S", true},
	{0, 118, 175, "TRNG_APB_S", true},
	{0, 119, 176, "DX_CC_APB_S", true},

	/* 120 */
	{0, 120, 177, "CQ_DMA_APB_S", true},
	{0, 121, 178, "SRAMROM_APB_S", true},
	{0, 122, 179, "RESERVED_DVFS_PROC_APB_S", true},
	{0, 123, 181, "SYS_CIRQ2_APB_S", true},
	{0, 124, 182, "CCIF2_AP_APB_S", true},
	{0, 125, 183, "CCIF2_MD_APB_S", true},
	{0, 126, 184, "CCIF3_AP_APB_S", true},
	{0, 127, 185, "CCIF3_MD_APB_S", true},
	{0, 128, 186, "CCIF4_AP_APB_S", true},
	{0, 129, 187, "CCIF4_MD_APB_S", true},

	/* 130 */
	{0, 130, 188, "CCIF5_AP_APB_S", true},
	{0, 131, 189, "CCIF5_MD_APB_S", true},
	{0, 132, 190, "HWCCF_APB_S", true},
	{0, 133, 191, "INFRA_BUS_HRE_APB_S", true},
	{0, 134, 192, "IPI_APB_S", true},
	...
	{-1, -1, 212, "OOB_way_en", false},
	{-1, -1, 213, "OOB_way_en", true},
	{-1, -1, 214, "OOB_way_en", true},
	{-1, -1, 215, "OOB_way_en", false},
...
static const struct mtk_device_info mt6879_devices_peri_par[] = {
	...
	/* 20 */
	{0, 20, 20, "SSUSB_S-2", false},
	{0, 21, 21, "MSDC1_S-1", false},
	{0, 22, 22, "MSDC1_S-2", true},
	{0, 23, 23, "UFS0_S", true},
	{0, 24, 24, "UFS0_S-1", true},
	{0, 25, 25, "UFS0_S-2", true},
	{0, 26, 26, "UFS0_S-3", true},
	{0, 27, 27, "UFS0_S-4", true},
	{0, 28, 28, "UFS0_S-5", true},
	{0, 29, 29, "UFS0_S-6", true},

	/* 30 */
	{0, 30, 30, "UFS0_S-7", true},
	{0, 31, 31, "UFS0_S-8", true},
	{0, 32, 32, "DEVICE_APC_PERI_PAR_AO_APB_S", true},
	{0, 33, 33, "PERI_MBIST_AO_APB_S", true},
	{0, 34, 34, "PERICFG_AO_APB_S", true},
	{0, 35, 35, "BCRM_PERI_PAR_AO_APB_S", true},
	{0, 36, 36, "DEBUG_CTRL_PERI_PAR_AO_APB_S", true},
	...
	{-1, -1, 64, "APDMA", false},
	{-1, -1, 65, "IIC_P2P_REMAP", false},
	{-1, -1, 66, "DEVICE_APC_PERI_AO", false},
	{-1, -1, 67, "DEVICE_APC_PERI_PDN", false},
};

static const struct mtk_device_info mt6879_devices_vlp[] = {
	/* sys_idx, ctrl_idx, vio_idx, device, vio_irq */
	/* 0 */
	...
	{-1, -1, 96, "PMIF1", false},
	{-1, -1, 97, "PMIF2", false},
	{-1, -1, 98, "DEVICE_APC_VLP_AO", false},
	{-1, -1, 99, "DEVICE_APC_VLP_PDN", false},
};

#if ENABLE_DEVAPC_ADSP
static const struct mtk_device_info mt6879_devices_adsp[] = {
	/* sys_idx, ctrl_idx, vio_idx, device, vio_irq */
	/* 0 */
	{0, 0, 0, "INFRA_S", true},
...
#if ENABLE_DEVAPC_MMINFRA
static const struct mtk_device_info mt6879_devices_mminfra[] = {
	/* sys_idx, ctrl_idx, vio_idx, device, vio_irq */
	/* 0 */
	...
	{0, 32, 32, "MMINFRA_APB_S-37", true},
	{0, 33, 33, "DAPC_PDN_S", true},
	{0, 34, 34, "BCRM_PDN_S", true},
	{0, 35, 35, "MMUP_APB_S", true},
	{0, 36, 36, "MMUP_APB_S-1", true},
	{0, 37, 37, "MMUP_APB_S-2", true},
	{0, 38, 38, "MMUP_APB_S-3", true},
	{0, 39, 39, "MMUP_APB_S-4", true},

	/* 40 */
	{0, 40, 40, "MMUP_APB_S-5", true},
	{0, 41, 41, "MMUP_APB_S-6", true},
	{0, 42, 42, "MMUP_APB_S-7", true},
	{0, 43, 43, "MMUP_APB_S-8", true},
	{0, 44, 44, "MMUP_APB_S-9", true},
	{0, 45, 45, "MMUP_APB_S-10", true},
	{0, 46, 46, "MMUP_APB_S-11", true},
	{0, 47, 47, "MMUP_APB_S-12", true},
	{0, 48, 48, "MMUP_APB_S-13", true},
	{0, 49, 49, "MMUP_APB_S-14", true},

	/* 50 */
	{0, 50, 50, "MMUP_APB_S-15", true},
	{0, 51, 51, "VENC_APB_S", true},
	{0, 52, 52, "VENC_APB_S-1", true},
	{0, 53, 53, "VENC_APB_S-2", true},
	{0, 54, 54, "VENC_APB_S-3", true},
	{0, 55, 55, "VENC_APB_S-4", true},
	{0, 56, 56, "VENC_APB_S-5", true},
	{0, 57, 57, "VENC_APB_S-6", true},
	{0, 58, 58, "VENC_APB_S-7", true},
	{0, 59, 59, "VENC_APB_S-8", true},

	/* 60 */
	{0, 60, 60, "VENC_APB_S-9", true},
	{0, 61, 61, "VENC_APB_S-10", true},
	{0, 62, 62, "VENC_APB_S-11", true},
	{0, 63, 63, "VENC_APB_S-12", true},
	{0, 64, 64, "VENC_APB_S-13", true},
	{0, 65, 65, "VENC_APB_S-14", true},
	{0, 66, 66, "VENC_APB_S-15", true},
	{0, 67, 67, "VDEC_APB_S", true},
	{0, 68, 68, "VDEC_APB_S-1", true},
	{0, 69, 69, "VDEC_APB_S-2", true},

	/* 70 */
	{0, 70, 70, "VDEC_APB_S-3", true},
	{0, 71, 71, "VDEC_APB_S-4", true},
	{0, 72, 72, "VDEC_APB_S-5", true},
	{0, 73, 73, "VDEC_APB_S-6", true},
	{0, 74, 74, "VDEC_APB_S-7", true},
	{0, 75, 75, "VDEC_APB_S-8", true},
	{0, 76, 76, "VDEC_APB_S-9", true},
	{0, 77, 77, "VDEC_APB_S-10", true},
	{0, 78, 78, "VDEC_APB_S-11", true},
	{0, 79, 79, "VDEC_APB_S-12", true},

	/* 80 */
	{0, 80, 80, "VDEC_APB_S-13", true},
	{0, 81, 81, "VDEC_APB_S-14", true},
	{0, 82, 82, "VDEC_APB_S-15", true},
	{0, 83, 83, "CCU_APB_S", true},
	{0, 84, 84, "CCU_APB_S-1", true},
	{0, 85, 85, "CCU_APB_S-2", true},
	{0, 86, 86, "CCU_APB_S-3", true},
	{0, 87, 87, "CCU_APB_S-4", true},
	{0, 88, 88, "CCU_APB_S-5", true},
	{0, 89, 89, "CCU_APB_S-6", true},

	/* 90 */
	{0, 90, 90, "CCU_APB_S-7", true},
	{0, 91, 91, "CCU_APB_S-8", true},
	{0, 92, 92, "CCU_APB_S-9", true},
	{0, 93, 93, "CCU_APB_S-10", true},
	{0, 94, 94, "CCU_APB_S-11", true},
	{0, 95, 95, "CCU_APB_S-12", true},
	{0, 96, 96, "CCU_APB_S-13", true},
	{0, 97, 97, "CCU_APB_S-14", true},
	{0, 98, 98, "CCU_APB_S-15", true},
	{0, 99, 99, "CCU_APB_S-16", true},

	/* 100 */
	{0, 100, 100, "IMG_APB_S", true},
	{0, 101, 101, "IMG_APB_S-1", true},
	{0, 102, 102, "IMG_APB_S-2", true},
	{0, 103, 103, "IMG_APB_S-3", true},
	{0, 104, 104, "IMG_APB_S-4", true},
	{0, 105, 105, "IMG_APB_S-5", true},
	{0, 106, 106, "IMG_APB_S-6", true},
	{0, 107, 107, "IMG_APB_S-7", true},
	{0, 108, 108, "IMG_APB_S-8", true},
	{0, 109, 109, "IMG_APB_S-9", true},

	/* 110 */
	{0, 110, 110, "IMG_APB_S-10", true},
	{0, 111, 111, "IMG_APB_S-11", true},
	{0, 112, 112, "IMG_APB_S-12", true},
	{0, 113, 113, "IMG_APB_S-13", true},
	{0, 114, 114, "IMG_APB_S-14", true},
	{0, 115, 115, "IMG_APB_S-15", true},
	{0, 116, 116, "IMG_APB_S-16", true},
	{0, 117, 117, "IMG_APB_S-17", true},
	{0, 118, 118, "IMG_APB_S-18", true},
	{0, 119, 119, "IMG_APB_S-19", true},

	/* 120 */
	{0, 120, 120, "IMG_APB_S-20", true},
	{0, 121, 121, "IMG_APB_S-21", true},
	{0, 122, 122, "IMG_APB_S-22", true},
	{0, 123, 123, "IMG_APB_S-23", true},
	{0, 124, 124, "IMG_APB_S-24", true},
	{0, 125, 125, "IMG_APB_S-25", true},
	{0, 126, 126, "IMG_APB_S-26", true},
	{0, 127, 127, "IMG_APB_S-27", true},
	{0, 128, 128, "IMG_APB_S-28", true},
	{0, 129, 129, "IMG_APB_S-29", true},

	/* 130 */
	{0, 130, 130, "IMG_APB_S-30", true},
	{0, 131, 131, "IMG_APB_S-31", true},
	{0, 132, 132, "IMG_APB_S-32", true},
	{0, 133, 133, "IMG_APB_S-33", true},
	{0, 134, 134, "IMG_APB_S-34", true},
	{0, 135, 135, "IMG_APB_S-35", true},
	{0, 136, 136, "IMG_APB_S-36", true},
	{0, 137, 137, "IMG_APB_S-37", true},
	{0, 138, 138, "IMG_APB_S-38", true},
	{0, 139, 139, "IMG_APB_S-39", true},

	/* 140 */
	{0, 140, 140, "IMG_APB_S-40", true},
	{0, 141, 141, "IMG_APB_S-41", true},
	{0, 142, 142, "IMG_APB_S-42", true},
	{0, 143, 143, "IMG_APB_S-43", true},
	{0, 144, 144, "IMG_APB_S-44", true},
	{0, 145, 145, "IMG_APB_S-45", true},
	{0, 146, 146, "IMG_APB_S-46", true},
	{0, 147, 147, "IMG_APB_S-47", true},
	{0, 148, 148, "IMG_APB_S-48", true},
	{0, 149, 149, "CAM_APB_S", true},

	/* 150 */
	{0, 150, 150, "CAM_APB_S-1", true},
	{0, 151, 151, "CAM_APB_S-2", true},
	{0, 152, 152, "CAM_APB_S-3", true},
	{0, 153, 153, "CAM_APB_S-4", true},
	{0, 154, 154, "CAM_APB_S-5", true},
	{0, 155, 155, "CAM_APB_S-6", true},
	{0, 156, 156, "CAM_APB_S-7", true},
	{0, 157, 157, "CAM_APB_S-8", true},
	{0, 158, 158, "CAM_APB_S-9", true},
	{0, 159, 159, "CAM_APB_S-10", true},

	/* 160 */
	{0, 160, 160, "CAM_APB_S-11", true},
	{0, 161, 161, "CAM_APB_S-12", true},
	{0, 162, 162, "CAM_APB_S-13", true},
	{0, 163, 163, "CAM_APB_S-14", true},
	{0, 164, 164, "CAM_APB_S-15", true},
	{0, 165, 165, "CAM_APB_S-16", true},
	{0, 166, 166, "CAM_APB_S-17", true},
	{0, 167, 167, "CAM_APB_S-18", true},
	{0, 168, 168, "CAM_APB_S-19", true},
	{0, 169, 169, "CAM_APB_S-20", true},

	/* 170 */
	{0, 170, 170, "CAM_APB_S-21", true},
	{0, 171, 171, "CAM_APB_S-22", true},
	{0, 172, 172, "CAM_APB_S-23", true},
	{0, 173, 173, "CAM_APB_S-24", true},
	{0, 174, 174, "CAM_APB_S-25", true},
	{0, 175, 175, "CAM_APB_S-26", true},
	{0, 176, 176, "CAM_APB_S-27", true},
	{0, 177, 177, "CAM_APB_S-28", true},
	{0, 178, 178, "CAM_APB_S-29", true},
	{0, 179, 179, "CAM_APB_S-30", true},

	/* 180 */
	{0, 180, 180, "CAM_APB_S-31", true},
	{0, 181, 181, "CAM_APB_S-32", true},
	{0, 182, 182, "CAM_APB_S-33", true},
	{0, 183, 183, "CAM_APB_S-34", true},
	{0, 184, 184, "CAM_APB_S-35", true},
	{0, 185, 185, "CAM_APB_S-36", true},
	{0, 186, 186, "CAM_APB_S-37", true},
	{0, 187, 187, "CAM_APB_S-38", true},
	{0, 188, 188, "CAM_APB_S-39", true},
	{0, 189, 189, "CAM_APB_S-40", true},

	/* 190 */
	{0, 190, 190, "CAM_APB_S-41", true},
	{0, 191, 191, "CAM_APB_S-42", true},
	{0, 192, 192, "CAM_APB_S-43", true},
	{0, 193, 193, "CAM_APB_S-44", true},
	{0, 194, 194, "CAM_APB_S-45", true},
	{0, 195, 195, "CAM_APB_S-46", true},
	{0, 196, 196, "CAM_APB_S-47", true},
	{0, 197, 197, "CAM_APB_S-48", true},
	{0, 198, 198, "CAM_APB_S-49", true},
	{0, 199, 199, "CAM_APB_S-50", true},

	/* 200 */
	{0, 200, 200, "CAM_APB_S-51", true},
	{0, 201, 201, "CAM_APB_S-52", true},
	{0, 202, 202, "CAM_APB_S-53", true},
	{0, 203, 203, "CAM_APB_S-54", true},
	{0, 204, 204, "CAM_APB_S-55", true},
	{0, 205, 205, "CAM_APB_S-56", true},
	{0, 206, 206, "CAM_APB_S-57", true},
	{0, 207, 207, "CAM_APB_S-58", true},
	{0, 208, 208, "CAM_APB_S-59", true},
	{0, 209, 209, "CAM_APB_S-60", true},

	/* 210 */
	{0, 210, 210, "CAM_APB_S-61", true},
	{0, 211, 211, "CAM_APB_S-62", true},
	{0, 212, 212, "CAM_APB_S-63", true},
	{0, 213, 213, "CAM_APB_S-64", true},
	{0, 214, 214, "CAM_APB_S-65", true},
	{0, 215, 215, "CAM_APB_S-66", true},
	{0, 216, 216, "CAM_APB_S-67", true},
	{0, 217, 217, "CAM_APB_S-68", true},
	{0, 218, 218, "CAM_APB_S-69", true},
	{0, 219, 219, "CAM_APB_S-70", true},

	/* 220 */
	{0, 220, 220, "CAM_APB_S-71", true},
	{0, 221, 221, "CAM_APB_S-72", true},
	{0, 222, 222, "CAM_APB_S-73", true},
	{0, 223, 223, "CAM_APB_S-74", true},
	{0, 224, 224, "CAM_APB_S-75", true},
	{0, 225, 225, "CAM_APB_S-76", true},
	{0, 226, 226, "CAM_APB_S-77", true},
	{0, 227, 227, "CAM_APB_S-78", true},
	{0, 228, 228, "CAM_APB_S-79", true},
	{0, 229, 229, "CAM_APB_S-80", true},

	/* 230 */
	{0, 230, 230, "CAM_APB_S-81", true},
	{0, 231, 231, "CAM_APB_S-82", true},
	{0, 232, 232, "CAM_APB_S-83", true},
	{0, 233, 233, "CAM_APB_S-84", true},
	{0, 234, 234, "CAM_APB_S-85", true},
	{0, 235, 235, "CAM_APB_S-86", true},
	{0, 236, 236, "CAM_APB_S-87", true},
	{0, 237, 237, "CAM_APB_S-88", true},
	{0, 238, 238, "CAM_APB_S-89", true},
	{0, 239, 239, "CAM_APB_S-90", true},

	/* 240 */
	{0, 240, 240, "CAM_APB_S-91", true},
	{0, 241, 241, "CAM_APB_S-92", true},
	{0, 242, 242, "CAM_APB_S-93", true},
	{0, 243, 243, "CAM_APB_S-94", true},
	{0, 244, 244, "CAM_APB_S-95", true},
	{0, 245, 245, "CAM_APB_S-96", true},
	{0, 246, 246, "CAM_APB_S-97", true},
	{0, 247, 247, "CAM_APB_S-98", true},
	{0, 248, 248, "CAM_APB_S-99", true},
	{0, 249, 249, "CAM_APB_S-100", true},

	/* 250 */
	{0, 250, 250, "CAM_APB_S-101", true},
	{0, 251, 251, "CAM_APB_S-102", true},
	{0, 252, 252, "CAM_APB_S-103", true},
	{0, 253, 253, "CAM_APB_S-104", true},
	{0, 254, 254, "CAM_APB_S-105", true},
	{0, 255, 255, "CAM_APB_S-106", true},
	{1, 0, 256, "CAM_APB_S-107", true},
	{1, 1, 257, "CAM_APB_S-108", true},
	{1, 2, 258, "CAM_APB_S-109", true},
	{1, 3, 259, "CAM_APB_S-110", true},

	/* 260 */
	{1, 4, 260, "CAM_APB_S-111", true},
	{1, 5, 261, "CAM_APB_S-112", true},
	{1, 6, 262, "CAM_APB_S-113", true},
	{1, 7, 263, "CAM_APB_S-114", true},
	{1, 8, 264, "CAM_APB_S-115", true},
	{1, 9, 265, "CAM_APB_S-116", true},
	...
	{1, 80, 337, "HRE_APB_S", true},
	{1, 81, 343, "DAPC_AO_S", true},
	{1, 82, 344, "BCRM_AO_S", true},
	{1, 83, 345, "DEBUG_CTL_AO_S", true},
	...
	{-1, -1, 362, "Decode_error", true},
	{-1, -1, 363, "Decode_error", true},
	{-1, -1, 364, "Decode_error", true},
	{-1, -1, 365, "Decode_error", true},

	{-1, -1, 366, "GCE_D", false},
	{-1, -1, 367, "GCE_M", false},
	{-1, -1, 368, "DEVICE_APC_MM_AO", false},
	{-1, -1, 369, "DEVICE_APC_MM_PDN", false},
};
#endif
...
enum DEVAPC_VIO_SLAVE_NUM {
	...
	VIO_SLAVE_NUM_PERI_PAR = ARRAY_SIZE(mt6879_devices_peri_par),
	VIO_SLAVE_NUM_VLP = ARRAY_SIZE(mt6879_devices_vlp),
#if ENABLE_DEVAPC_ADSP
	VIO_SLAVE_NUM_ADSP = ARRAY_SIZE(mt6879_devices_adsp),
#endif
#if ENABLE_DEVAPC_MMINFRA
