 ...
 */
enum { REG_UFS_PERICFG = 0x448,
	   REG_UFS_PERICFG_RST_N_BIT = 3,
};

enum { REG_UNIPRO_SW_RST_SET = 0x140,
...
enum { SW_RST_TARGET_UFSHCI = 0x1,
	   SW_RST_TARGET_UNIPRO = 0x2,
	   SW_RST_TARGET_UFSCPT = 0x4,
	   SW_RST_TARGET_MPHY = 0x8,
	   SW_RST_TARGET_ALL = (SW_RST_TARGET_UFSHCI | SW_RST_TARGET_UNIPRO |
			    SW_RST_TARGET_UFSCPT),
};
...
pmic_set_register_value_nolock(PMU_FLAGS_LIST_ENUM flagname, unsigned int val);
#endif
