	...
	struct cmdq_client *cmdq_clt)
{
	...
	vcu_queue = vmalloc(sizeof(struct mtk_vcu_queue)); //Motorola, chenmf5 2022-12-2, IKSWT-50134 change kzalloc to vmalloc
	if (vcu_queue == NULL) {
...
void mtk_vcu_mem_release(struct mtk_vcu_queue *vcu_queue)
{
	...
	vfree(vcu_queue);  //Motorola, chenmf5 2022-12-2, IKSWT-50134 change kzalloc to vmalloc
	vcu_queue = NULL;
}
