...
static struct regname rn[] = {
	...
	REGNAME(topckgen,  0x0f0, CLK_CFG_11),
...
static const struct fmeter_clk fclks[] = {
	...
	FMCLK(CKGEN,  43, "hf_fadsp_ck"),
	FMCLK(CKGEN,  44, "hf_fdpmaif_main_ck"),
	FMCLK(CKGEN,  45, "hf_fvenc_ck"),
	FMCLK(CKGEN,  46, "hf_fdec_ck"),
	FMCLK(CKGEN,  47, "hf_fcamtm_ck"),
	FMCLK(CKGEN,  48, "hf_fpwm_ck"),
...
static struct clkdbg_ops clkdbg_mt3967_ops = {
...
static int __init clkdbg_mt3967_init(void)
{
	...
	init_custom_cmds();
	set_clkdbg_ops(&clkdbg_mt3967_ops);
...
device_initcall(clkdbg_mt3967_init);
