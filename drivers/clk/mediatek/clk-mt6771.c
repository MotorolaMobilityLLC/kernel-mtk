...
static const struct mtk_mux_clr_set_upd top_muxes[] __initconst = {
	...
	MUX_CLR_SET_UPD(TOP_MUX_AUD_1, "aud_1_sel", aud_1_parents, CK_CFG_10,
		CK_CFG_10_SET, CK_CFG_10_CLR, 16, 1, INVALID_MUX_GATE, INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT),
	MUX_CLR_SET_UPD(TOP_MUX_AUD_2, "aud_2_sel", aud_2_parents, CK_CFG_10,
		CK_CFG_10_SET, CK_CFG_10_CLR, 24, 1, INVALID_MUX_GATE, INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT),
#else
	/* CLK_CFG_0 */
	MUX_CLR_SET_UPD(TOP_MUX_AXI, "axi_sel", axi_parents, CK_CFG_0,
		CK_CFG_0_SET, CK_CFG_0_CLR, 0, 2, INVALID_MUX_GATE, INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT),
	...
	/* CLK_CFG_10 */
	MUX_CLR_SET_UPD(TOP_MUX_AUD_1, "aud_1_sel", aud_1_parents, CK_CFG_10,
		CK_CFG_10_SET, CK_CFG_10_CLR, 16, 1, 7, CLK_CFG_UPDATE1, 9),
	MUX_CLR_SET_UPD(TOP_MUX_AUD_2, "aud_2_sel", aud_2_parents, CK_CFG_10,
		CK_CFG_10_SET, CK_CFG_10_CLR, 24, 1, 15, CLK_CFG_UPDATE1, 10),
#endif
};
...
static const struct mtk_gate mm_clks[] __initconst = {
	...
	GATE_MM0(MMSYS_GALS_CCU2MM, "mm_gals_ccu2mm", "mm_sel", 5),
	GATE_MM0(MMSYS_GALS_IPU12MM, "mm_gals_ipu12mm", "mm_sel", 6),
