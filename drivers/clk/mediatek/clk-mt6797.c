...
static struct mtk_mux top_muxes[] __initdata = {
	...
	MUX(TOP_MUX_MEM, mem_sel, mem_parents, 0x0040, 8, 1, 15),
	MUX(TOP_MUX_DDRPHYCFG, ddrphycfg_sel, ddrphycfg_parents, 0x0040, 16, 2, 23),
	MUX(TOP_MUX_MM, mm_sel, mm_parents, 0x0040, 24, 2, 31),
	MUX(TOP_MUX_PWM, pwm_sel, pwm_parents, 0x0050, 0, 3, 7),
	MUX(TOP_MUX_VDEC, vdec_sel, vdec_parents, 0x0050, 8, 3, 15),
	MUX(TOP_MUX_VENC, venc_sel, venc_parents, 0x0050, 16, 2, 23),
	MUX(TOP_MUX_MFG, mfg_sel, mfg_parents, 0x0050, 24, 2, 31),
	MUX(TOP_MUX_CAMTG, camtg_sel, camtg, 0x0060, 0, 2, 7),
	...
	MUX(TOP_MUX_ULPOSC_SPI_CK_MUX, ulposc_spi_ck_mux, ulposc_spi_ck_mux_parents, 0x0060, 18, 1,
		INVALID_MUX_GATE_BIT),
	MUX(TOP_MUX_USB20, usb20_sel, usb20_parents, 0x0060, 24, 2, 31),
	...
	MUX(TOP_MUX_MSDC30_1, msdc30_1_sel, msdc30_1_parents, 0x0070, 24, 3, 31),
	MUX(TOP_MUX_MSDC30_2, msdc30_2_sel, msdc30_2_parents, 0x0080, 0, 3, 7),
	MUX(TOP_MUX_AUDIO, audio_sel, audio_parents, 0x0080, 16, 2, 23),
	MUX(TOP_MUX_AUD_INTBUS, aud_intbus_sel, aud_intbus_parents, 0x0080, 24, 2, 31),
	MUX(TOP_MUX_PMICSPI, pmicspi_sel, pmicspi_parents, 0x0090, 0, 3, 7),
	...
	MUX(TOP_MUX_AUD_1, aud_1_sel, aud_1_parents, 0x00A0, 16, 1, 23),
	MUX(TOP_MUX_AUD_2, aud_2_sel, aud_2_parents, 0x00A0, 24, 1, 31),
	...
	MUX(TOP_MUX_BSI_SPI, bsi_spi_sel, bsi_spi_parents, 0x00C0, 8, 2, 15),
	MUX(TOP_MUX_AUDIO_H, audio_h_sel, audio_h_parents, 0x00C0, 16, 2, 23),
	MUX(TOP_MUX_ANC_MD32, anc_md32_sel, anc_md32_parents, 0x00C0, 24, 2, 31),
	MUX(TOP_MUX_MFG_52M, mfg_52m_sel, mfg_52m_parents, 0x0104, 1, 2, 0),/* non glitch operation*/
};
