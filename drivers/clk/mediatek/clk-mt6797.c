...
#define INFRA1_CG  0x0246CF76/*0: Disable  ( with clock), 1: Enable ( without clock )*/
#define INFRA2_CG  0x2DFFb6FD/*0: Disable  ( with clock), 1: Enable ( without clock ), 9:dummy for usb ref*/
