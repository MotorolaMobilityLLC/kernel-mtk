...
static const struct mtk_fixed_factor top_divs[] __initconst = {
	...
	FACTOR(TOP_SYSPLL_D3_D3, "syspll_d3_d3", "syspll_d3", 1, 8),
	...
	FACTOR(TOP_UNIVPLL1_D4, "univpll1_d4", "univpll_d2", 1, 7),
	FACTOR(TOP_UNIVPLL1_D8, "univpll1_d8", "univpll_d2", 1, 26),
	...
	FACTOR(TOP_UNIVPLL2_D16, "univpll2_d16", "univpll_d3", 1, 16),
	FACTOR(TOP_UNIVPLL2_D32, "univpll2_d32", "univpll_d3", 1, 32),
	...
	FACTOR(TOP_UNIVPLL_D26, "univpll_d26", "univpll_ck", 1, 26),
	FACTOR(TOP_UNIVPLL_D52, "univpll_d52", "univpll_ck", 1, 52),
	FACTOR(TOP_UNIVPLL_D104, "univpll_d104", "univpll_ck", 1, 104),
	FACTOR(TOP_UNIVPLL_D208, "univpll_d208", "univpll_ck", 1, 208),
	...
	FACTOR(TOP_AD_OSC_CK, "ad_osc_ck", "osc", 1, 1),
	FACTOR(TOP_OSC_D2, "osc_d2", "osc", 1, 2),
	FACTOR(TOP_OSC_D4, "osc_d4", "osc", 1, 4),
	FACTOR(TOP_OSC_D8, "osc_d8", "osc", 1, 8),
	FACTOR(TOP_OSC_D16, "osc_d16", "osc", 1, 16),
	FACTOR(TOP_OSC_D32, "osc_d32", "osc", 1, 32),
};

static const char *const axi_parents[] __initconst = {"clk26m", "syspll1_d4",
						      "syspll_d7", "osc_d8"};

static const char *const mm_parents[] __initconst = {
	"clk26m",      "mmpll_ck",   "syspll_d3",
	"univpll1_d2", "syspll1_d2", "syspll2_d2"};

static const char *const pwm_parents[] __initconst = {"clk26m", "univpll2_d2",
						      "univpll2_d4"};

static const char *const cam_parents[] __initconst = {
	"clk26m",     "mmpll_ck",   "syspll_d3", "univpll1_d2",
	"syspll1_d2", "syspll2_d2", "tvdpll_ck", "apll2_ck"};

static const char *const mfg_parents[] __initconst = {
	"clk26m", "mfgpll_ck", "univpll_d3", "syspll_d3"};

static const char *const camtg_parents[] __initconst = {
	"clk26m",       "univpll_d52",  "univpll2_d8",  "univpll_d26",
	"univpll2_d16", "univpll2_d32", "univpll_d104", "univpll_d208"};

static const char *const uart_parents[] __initconst = {"clk26m",
						       "univpll2_d8"};

static const char *const spi_parents[] __initconst = {
	"clk26m", "syspll3_d2", "syspll2_d4", "msdcpll_d4"};

static const char *const msdc50_hclk_parents[] __initconst = {
	"clk26m", "syspll1_d2", "syspll2_d2"};

static const char *const msdc50_0_parents[] __initconst = {
	"clk26m",      "msdcpll_ck", "msdcpll_d2",
	"univpll1_d4", "syspll2_d2", "univpll1_d2"};

static const char *const msdc30_1_parents[] __initconst = {
	"clk26m", "univpll2_d2", "syspll2_d2", "syspll_d7", "msdcpll_d2"};
...
static const char *const msdc30_3_parents[] __initconst = {
	"clk26m",    "msdcpll_d8", "msdcpll_d4", "univpll1_d4", "univpll_d26",
	"syspll_d7", "univpll_d7", "syspll3_d4", "msdcpll_d16"};

static const char *const audio_parents[] __initconst = {
	"clk26m", "syspll3_d4", "syspll4_d4", "syspll1_d16"};

static const char *const aud_intbus_parents[] __initconst = {
	"clk26m", "syspll1_d4", "syspll4_d2"};

static const char *const fpwrap_ulposc_parents[] __initconst = {
	"clk26m", "osc_d16", "osc_d8", "osc_d32"};

/* ignore */
static const char *const scp_parents[] __initconst = {"clk26m", "syspll1_d22",
						      "syspll1_d4"};

static const char *const atb_parents[] __initconst = {"clk26m", "syspll1_d2",
						      "syspll_d5"};

static const char *const sspm_parents[] __initconst = {"clk26m", "syspll1_d2",
						       "syspll_d3"};

static const char *const dpi0_parents[] __initconst = {
	"clk26m", "tvdpll_d2", "tvdpll_d4", "tvdpll_d8", "tvdpll_d16"};

static const char *const scam_parents[] __initconst = {"clk26m", "syspll3_d2"};

static const char *const aud_1_parents[] __initconst = {"clk26m", "apll1_ck"};

static const char *const aud_2_parents[] __initconst = {"clk26m", "apll2_ck"};

static const char *const disppwm_parents[] __initconst = {
	"clk26m", "univpll2_d4", "osc_d4", "osc_d16"};

/* ignore */
static const char *const ssusb_top_sys_parents[] __initconst = {"clk26m",
								"univpll3_d2"};
...
static const char *const usb_top_parents[] __initconst = {"clk26m",
							  "univpll3_d4"};

static const char *const spm_parents[] __initconst = {"clk26m", "syspll1_d8"};

static const char *const i2c_parents[] __initconst = {"clk26m", "syspll1_d8",
						      "univpll3_d4"};

static const char *const f52m_mfg_parents[] __initconst = {
	"clk26m", "univpll2_d2", "univpll2_d4", "univpll2_d8"};

static const char *const seninf_parents[] __initconst = {
	"clk26m", "univpll_d7", "univpll2_d2", "univpll1_d4"};

static const char *const dxcc_parents[] __initconst = {
	"clk26m", "syspll1_d2", "syspll1_d4", "syspll1_d8"};
...
static const char *const aud_engen1_parents[] __initconst = {
	"clk26m", "apll1_d2", "apll1_d4", "apll1_d8"};
...
static const char *const faes_ufsfde_parents[] __initconst = {
	"clk26m",    "syspll_d2",  "syspll1_d2",
	"syspll_d3", "syspll1_d4", "univpll_d3"};

static const char *const fufs_parents[] __initconst = {
	"clk26m", "syspll1_d4", "syspll1_d8", "syspll1_d16"};
...
static const struct mtk_mux_clr_set_upd top_muxes[] __initconst = {
	...
	MUX_CLR_SET_UPD(TOP_MUX_AXI, "axi_sel", axi_parents, CK_CFG_0,
		    CK_CFG_0_SET, CK_CFG_0_CLR, 0, 2, INVALID_MUX_GATE,
	...
	MUX_CLR_SET_UPD(TOP_MUX_MSDC50_0_HCLK, "msdc50_hclk_sel",
		    msdc50_hclk_parents, CK_CFG_3, CK_CFG_3_SET, CK_CFG_3_CLR,
		    8, 2, 15, CLK_CFG_UPDATE, 12),
	MUX_CLR_SET_UPD(TOP_MUX_MSDC50_0, "msdc50_0_sel", msdc50_0_parents,
		    CK_CFG_3, CK_CFG_3_SET, CK_CFG_3_CLR, 16, 3, 23,
		    CLK_CFG_UPDATE, 13),
	MUX_CLR_SET_UPD(TOP_MUX_MSDC30_1, "msdc30_1_sel", msdc30_1_parents,
		    CK_CFG_3, CK_CFG_3_SET, CK_CFG_3_CLR, 24, 3, 31,
		    CLK_CFG_UPDATE, 14),
	/* CLK_CFG_4 */
	MUX_CLR_SET_UPD(TOP_MUX_MSDC30_2, "msdc30_2_sel", msdc30_2_parents,
		    CK_CFG_4, CK_CFG_4_SET, CK_CFG_4_CLR, 0, 3, 7,
		    CLK_CFG_UPDATE, 15),
	MUX_CLR_SET_UPD(TOP_MUX_MSDC30_3, "msdc30_3_sel", msdc30_3_parents,
		    CK_CFG_4, CK_CFG_4_SET, CK_CFG_4_CLR, 8, 4, 15,
		    CLK_CFG_UPDATE, 16),
	...
	MUX_CLR_SET_UPD(TOP_MUX_AUD_INTBUS, "aud_intbus_sel",
		aud_intbus_parents, CK_CFG_4, CK_CFG_4_SET, CK_CFG_4_CLR, 24,
		2, 31, CLK_CFG_UPDATE, 18),
	/* CLK_CFG_5 */
	MUX_CLR_SET_UPD(TOP_MUX_FPWRAP_ULPOSC, "fpwrap_ulposc_sel",
		    fpwrap_ulposc_parents, CK_CFG_5, CK_CFG_5_SET,
		    CK_CFG_5_CLR, 0, 2, 7, CLK_CFG_UPDATE, 19),
	...
	CK_CFG_7, CK_CFG_7_SET, CK_CFG_7_CLR, 0, 2, 7, CLK_CFG_UPDATE, 27),
	MUX_CLR_SET_UPD(TOP_MUX_SSUSB_TOP_SYS, "ssusb_top_sys_sel",
		    ssusb_top_sys_parents, CK_CFG_7, CK_CFG_7_SET,
		    CK_CFG_7_CLR, 8, 1, 15, CLK_CFG_UPDATE, 28),
	MUX_CLR_SET_UPD(TOP_MUX_SSUSB_TOP_XHCI, "ssusb_top_xhci_sel",
		    ssusb_top_xhci_parents, CK_CFG_7, CK_CFG_7_SET,
		    CK_CFG_7_CLR, 16, 1, 23, CLK_CFG_UPDATE, 29),
	MUX_CLR_SET_UPD(
		TOP_MUX_USB_TOP, "usb_top_sel", usb_top_parents, CK_CFG_7,
	...
	MUX_CLR_SET_UPD(TOP_MUX_I2C, "i2c_sel", i2c_parents, CK_CFG_8,
		    CK_CFG_8_SET, CK_CFG_8_CLR, 16, 2, INVALID_MUX_GATE,
		    CLK_CFG_UPDATE1, 1),
	/* CLK_CFG_9 */
	MUX_CLR_SET_UPD(TOP_MUX_F52M_MFG, "f52m_mfg_sel", f52m_mfg_parents,
		    CK_CFG_9, CK_CFG_9_SET, CK_CFG_9_CLR, 0, 2, 7,
		    CLK_CFG_UPDATE, 11),
	...
	MUX_CLR_SET_UPD(TOP_MUX_AUD_ENG1, "aud_eng1_sel", aud_engen1_parents,
		    CK_CFG_10, CK_CFG_10_SET, CK_CFG_10_CLR, 0, 2, 7,
		    CLK_CFG_UPDATE1, 5),
	MUX_CLR_SET_UPD(TOP_MUX_AUD_ENG2, "aud_eng2_sel", aud_engen2_parents,
		    CK_CFG_10, CK_CFG_10_SET, CK_CFG_10_CLR, 8, 2, 15,
		    CLK_CFG_UPDATE1, 6),
	MUX_CLR_SET_UPD(TOP_MUX_FAES_UFSFDE, "faes_ufsfde_sel",
		    faes_ufsfde_parents, CK_CFG_10, CK_CFG_10_SET,
		    CK_CFG_10_CLR, 16, 3, 23, CLK_CFG_UPDATE1, 7),
	MUX_CLR_SET_UPD(TOP_MUX_FUFS, "fufs_sel", fufs_parents, CK_CFG_10,
		    CK_CFG_10_SET, CK_CFG_10_CLR, 24, 2, 31, CLK_CFG_UPDATE1,
		    8),
#else
	/* CLK_CFG_0 */
	MUX_CLR_SET_UPD(TOP_MUX_AXI, "axi_sel", axi_parents, CK_CFG_0,
		    ...
		    INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT),
	MUX_CLR_SET_UPD(
		TOP_MUX_MM, "mm_sel", mm_parents, CK_CFG_0, CK_CFG_0_SET,
		    CK_CFG_0_CLR, 24, 3, 31, CLK_CFG_UPDATE, 3),
	/* CLK_CFG_1 */
	MUX_CLR_SET_UPD(TOP_MUX_PWM, "pwm_sel", pwm_parents, CK_CFG_1,
		    CK_CFG_1_SET, CK_CFG_1_CLR, 0, 2, 7, CLK_CFG_UPDATE, 4),
	MUX_CLR_SET_UPD(TOP_MUX_CAM, "cam_sel", cam_parents, CK_CFG_1,
	...
	MUX_CLR_SET_UPD(TOP_MUX_SPI, "spi_sel", spi_parents, CK_CFG_2, /*spi*/
		    CK_CFG_2_SET, CK_CFG_2_CLR, 16, 2, INVALID_MUX_GATE,
		    INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT),
	/* CLK_CFG_3 */
	MUX_CLR_SET_UPD(TOP_MUX_MSDC50_0_HCLK, "msdc50_hclk_sel",
		    msdc50_hclk_parents, CK_CFG_3, CK_CFG_3_SET, CK_CFG_3_CLR,
	...
	MUX_CLR_SET_UPD(TOP_MUX_AUDIO, "audio_sel", audio_parents, CK_CFG_4,
		    CK_CFG_4_SET, CK_CFG_4_CLR, 16, 2, 23, CLK_CFG_UPDATE, 17),
	MUX_CLR_SET_UPD(
		TOP_MUX_AUD_INTBUS, "aud_intbus_sel", aud_intbus_parents,
		    CK_CFG_4, CK_CFG_4_SET, CK_CFG_4_CLR, 24, 2, 31,
		    CLK_CFG_UPDATE, 18),
	/* CLK_CFG_5 */
	MUX_CLR_SET_UPD(TOP_MUX_FPWRAP_ULPOSC, "fpwrap_ulposc_sel",
		    fpwrap_ulposc_parents, CK_CFG_5, /*ulposc*/
		    CK_CFG_5_SET, CK_CFG_5_CLR, 0, 2, INVALID_MUX_GATE,
		    INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT),
	MUX_CLR_SET_UPD(TOP_MUX_SCP, "scp_sel", scp_parents, CK_CFG_5, /*scp*/
		    CK_CFG_5_SET, CK_CFG_5_CLR, 8, 2, INVALID_MUX_GATE,
		    INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT),
	MUX_CLR_SET_UPD(TOP_MUX_ATB, "atb_sel", atb_parents, CK_CFG_5,
		    CK_CFG_5_SET, CK_CFG_5_CLR, 16, 2, 23, CLK_CFG_UPDATE, 21),
	MUX_CLR_SET_UPD(TOP_MUX_SSPM, "sspm_sel", sspm_parents,
		    CK_CFG_5, /*sspm no use*/
		    CK_CFG_5_SET, CK_CFG_5_CLR, 24, 2, INVALID_MUX_GATE,
		    INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT),
	/* CLK_CFG_6 */
	MUX_CLR_SET_UPD(TOP_MUX_DPI0, "dpi0_sel", dpi0_parents, CK_CFG_6,
		    CK_CFG_6_SET, CK_CFG_6_CLR, 0, 3, 7, CLK_CFG_UPDATE, 23),
	...
	/* CLK_CFG_7 */
	MUX_CLR_SET_UPD(
		TOP_MUX_DISP_PWM, "disppwm_sel", disppwm_parents, CK_CFG_7,
...
static void mtk_cg_disable(struct clk_hw *hw) { mtk_cg_set_bit(hw); }
...
static void mtk_cg_disable_inv(struct clk_hw *hw) { mtk_cg_clr_bit(hw); }
...
static const struct mtk_gate_regs infra0_cg_regs = {
	.set_ofs = 0x80, .clr_ofs = 0x84, .sta_ofs = 0x90,
};

static const struct mtk_gate_regs infra1_cg_regs = {
	.set_ofs = 0x88, .clr_ofs = 0x8c, .sta_ofs = 0x94,
};

static const struct mtk_gate_regs infra2_cg_regs = {
	.set_ofs = 0xa4, .clr_ofs = 0xa8, .sta_ofs = 0xac,
};

static const struct mtk_gate_regs infra3_cg_regs = {
	.set_ofs = 0xc0, .clr_ofs = 0xc4, .sta_ofs = 0xc8,
};
...
static const struct mtk_gate infra_clks[] __initconst = {
	/* INFRA0 */
	GATE_INFRA0(INFRACFG_AO_PMIC_CG_TMR, "infra_pmic_tmr", "f_f26m_ck", 0),
	GATE_INFRA0(INFRACFG_AO_PMIC_CG_AP, "infra_pmic_ap", "f_f26m_ck", 1),
	GATE_INFRA0(INFRACFG_AO_PMIC_CG_MD, "infra_pmic_md", "f_f26m_ck", 2),
	GATE_INFRA0(INFRACFG_AO_PMIC_CG_CONN, "infra_pmic_conn",
		"f_f26m_ck", 3),
	GATE_INFRA0(INFRACFG_AO_SCPSYS_CG, "infra_scp", "axi_sel", 4),
	GATE_INFRA0(INFRACFG_AO_SEJ_CG, "infra_sej", "f_f26m_ck", 5),
	GATE_INFRA0(INFRACFG_AO_APXGPT_CG, "infra_apxgpt", "axi_sel", 6),
	GATE_INFRA0(INFRACFG_AO_ICUSB_CG, "infra_icusb", "usb_top_sel", 8),
	GATE_INFRA0(INFRACFG_AO_GCE_CG, "infra_gce", "axi_sel", 9),
	GATE_INFRA0(INFRACFG_AO_THERM_CG, "infra_therm", "axi_sel", 10),
	GATE_INFRA0(INFRACFG_AO_I2C0_CG, "infra_i2c0", "i2c_sel", 11),
	GATE_INFRA0(INFRACFG_AO_I2C1_CG, "infra_i2c1", "i2c_sel", 12),
	GATE_INFRA0(INFRACFG_AO_I2C2_CG, "infra_i2c2", "i2c_sel", 13),
	GATE_INFRA0(INFRACFG_AO_I2C3_CG, "infra_i2c3", "i2c_sel", 14),
	GATE_INFRA0(INFRACFG_AO_PWM_HCLK_CG, "infra_pwm_hclk", "i2c_sel", 15),
	GATE_INFRA0(INFRACFG_AO_PWM1_CG, "infra_pwm1", "i2c_sel", 16),
	GATE_INFRA0(INFRACFG_AO_PWM2_CG, "infra_pwm2", "i2c_sel", 17),
	GATE_INFRA0(INFRACFG_AO_PWM3_CG, "infra_pwm3", "i2c_sel", 18),
	GATE_INFRA0(INFRACFG_AO_PWM4_CG, "infra_pwm4", "i2c_sel", 19),
	GATE_INFRA0(INFRACFG_AO_PWM_CG, "infra_pwm", "i2c_sel", 21),
	GATE_INFRA0(INFRACFG_AO_UART0_CG, "infra_uart0", "uart_sel", 22),
	GATE_INFRA0(INFRACFG_AO_UART1_CG, "infra_uart1", "uart_sel", 23),
	GATE_INFRA0(INFRACFG_AO_UART2_CG, "infra_uart2", "uart_sel", 24),
	GATE_INFRA0(INFRACFG_AO_UART3_CG, "infra_uart3", "uart_sel", 25),
	GATE_INFRA0(INFRACFG_AO_GCE_26M_CG, "infra_gce_26m", "axi_sel", 27),
	GATE_INFRA0(INFRACFG_AO_CQ_DMA_FPC_CG, "infra_cqdma_fpc",
		"axi_sel", 28),
	GATE_INFRA0(INFRACFG_AO_BTIF_CG, "infra_btif", "axi_sel", 31),
	/* INFRA1 */
	GATE_INFRA1(INFRACFG_AO_SPI0_CG, "infra_spi0", "spi_sel", 1),
	GATE_INFRA1(INFRACFG_AO_MSDC0_CG, "infra_msdc0", "msdc50_hclk_sel", 2),
	GATE_INFRA1(INFRACFG_AO_MSDC1_CG, "infra_msdc1", "axi_sel", 4),
	GATE_INFRA1(INFRACFG_AO_MSDC2_CG, "infra_msdc2", "axi_sel", 5),
	GATE_INFRA1(INFRACFG_AO_MSDC0_SCK_CG, "infra_msdc0_sck",
		"msdc50_0_sel", 6),
	GATE_INFRA1(INFRACFG_AO_DVFSRC_CG, "infra_dvfsrc", "f_f26m_ck", 7),
	GATE_INFRA1(INFRACFG_AO_GCPU_CG, "infra_gcpu", "axi_sel", 8),
	GATE_INFRA1(INFRACFG_AO_TRNG_CG, "infra_trng", "axi_sel", 9),
	GATE_INFRA1(INFRACFG_AO_AUXADC_CG, "infra_auxadc", "f_f26m_ck", 10),
	GATE_INFRA1(INFRACFG_AO_CPUM_CG, "infra_cpum", "axi_sel", 11),
	GATE_INFRA1(INFRACFG_AO_CCIF1_AP_CG, "infra_ccif1_ap", "axi_sel", 12),
	GATE_INFRA1(INFRACFG_AO_CCIF1_MD_CG, "infra_ccif1_md", "axi_sel", 13),
	...
	GATE_INFRA1(INFRACFG_AO_MSDC2_SCK_CG, "infra_msdc2_sck",
		"msdc30_2_sel", 17),
	GATE_INFRA1(INFRACFG_AO_AP_DMA_CG, "infra_apdma", "axi_sel", 18),
	GATE_INFRA1(INFRACFG_AO_XIU_CG, "infra_xiu", "axi_sel", 19),
	GATE_INFRA1(INFRACFG_AO_DEVICE_APC_CG, "infra_device_apc",
		"axi_sel", 20),
	GATE_INFRA1(INFRACFG_AO_CCIF_AP_CG, "infra_ccif_ap", "axi_sel", 23),
	GATE_INFRA1(INFRACFG_AO_DEBUGSYS_CG, "infra_debugsys", "axi_sel", 24),
	GATE_INFRA1(INFRACFG_AO_AUDIO_CG, "infra_audio", "axi_sel", 25),
	GATE_INFRA1(INFRACFG_AO_CCIF_MD_CG, "infra_ccif_md", "axi_sel", 26),
	GATE_INFRA1(INFRACFG_AO_DXCC_SEC_CORE_CG, "infra_dxcc_sec_core",
		"dxcc_sel", 27),
	GATE_INFRA1(INFRACFG_AO_DXCC_AO_CG, "infra_dxcc_ao", "dxcc_sel", 28),
	GATE_INFRA1(INFRACFG_AO_DRAMC_F26M_CG, "infra_dramc_f26m", "f_f26m_ck",
		31),
	/* INFRA2 */
	...
	GATE_INFRA2(INFRACFG_AO_I2C4_CG, "infra_i2c4", "i2c_sel", 7),
	GATE_INFRA2(INFRACFG_AO_MODEM_TEMP_SHARE_CG, "infra_md_tmp_share",
		"f_f26m_ck", 8),
	GATE_INFRA2(INFRACFG_AO_SPI2_CG, "infra_spi2", "spi_sel", 9),
	GATE_INFRA2(INFRACFG_AO_SPI3_CG, "infra_spi3", "spi_sel", 10),
	GATE_INFRA2(INFRACFG_AO_UNIPRO_SCK_CG, "infra_unipro_sck",
		"spi_sel", 11),
	GATE_INFRA2(INFRACFG_AO_UNIPRO_TICK_CG, "infra_unipro_tick", "spi_sel",
		12),
	GATE_INFRA2(INFRACFG_AO_UFS_MP_SAP_BCLK_CG, "infra_ufs_mp_sap_bck",
		"spi_sel", 13),
	GATE_INFRA2(INFRACFG_AO_MD32_BCLK_CG, "infra_md32_bclk",
		"spi_sel", 14),
	GATE_INFRA2(INFRACFG_AO_SSPM_CG, "infra_sspm", "spi_sel", 15),
	GATE_INFRA2(INFRACFG_AO_UNIPRO_MBIST_CG, "infra_unipro_mbist",
		"spi_sel", 16),
	GATE_INFRA2(INFRACFG_AO_SSPM_BUS_HCLK_CG, "infra_sspm_bus_hclk",
		"spi_sel", 17),
	GATE_INFRA2(INFRACFG_AO_I2C5_CG, "infra_i2c5", "i2c_sel", 18),
	GATE_INFRA2(INFRACFG_AO_I2C5_ARBITER_CG, "infra_i2c5_arbiter",
		"i2c_sel", 19),
	GATE_INFRA2(INFRACFG_AO_I2C5_IMM_CG, "infra_i2c5_imm", "i2c_sel", 20),
	GATE_INFRA2(INFRACFG_AO_I2C1_ARBITER_CG, "infra_i2c1_arbiter",
		"i2c_sel", 21),
	GATE_INFRA2(INFRACFG_AO_I2C1_IMM_CG, "infra_i2c1_imm", "i2c_sel", 22),
	GATE_INFRA2(INFRACFG_AO_I2C2_ARBITER_CG, "infra_i2c2_arbiter",
		"i2c_sel", 23),
	GATE_INFRA2(INFRACFG_AO_I2C2_IMM_CG, "infra_i2c2_imm", "i2c_sel", 24),
	GATE_INFRA2(INFRACFG_AO_SPI4_CG, "infra_spi4", "spi_sel", 25),
	GATE_INFRA2(INFRACFG_AO_SPI5_CG, "infra_spi5", "spi_sel", 26),
	GATE_INFRA2(INFRACFG_AO_CQ_DMA_CG, "infra_cqdma", "axi_sel", 27),
	GATE_INFRA2(INFRACFG_AO_UFS_CG, "infra_ufs", "fufs_sel", 28),
	GATE_INFRA2(INFRACFG_AO_AES_CG, "infra_aes", "spi_sel", 29),
	GATE_INFRA2(INFRACFG_AO_UFS_TICK_CG, "infra_ufs_tick", "fufs_sel", 30),
	/* INFRA3 */
	...
	GATE_INFRA3(INFRACFG_AO_SSPM_32K_SELF_CG, "infra_sspm_32k_self",
		"f_f26m_ck", 4),
	GATE_INFRA3(INFRACFG_AO_UFS_AXI_CG, "infra_ufs_axi", "axi_sel", 5),
	GATE_INFRA3(INFRACFG_AO_I2C6_CG, "infra_i2c6", "i2c_sel", 6),
...
static const struct mtk_gate_regs mfg_cfg_cg_regs = {
	.set_ofs = 0x4, .clr_ofs = 0x8, .sta_ofs = 0x0,
};

#define GATE_MFG_CFG(_id, _name, _parent, _shift)                             \
	{                                                                     \
		.id = _id, .name = _name, .parent_name = _parent,             \
		.regs = &mfg_cfg_cg_regs, .shift = _shift,                    \
		.ops = &mtk_clk_gate_ops_setclr,                              \
	}
...
static const struct mtk_gate_regs audio0_cg_regs = {
	.set_ofs = 0x0, .clr_ofs = 0x0, .sta_ofs = 0x0,
};

static const struct mtk_gate_regs audio1_cg_regs = {
	.set_ofs = 0x4, .clr_ofs = 0x4, .sta_ofs = 0x4,
};

#define GATE_AUDIO0(_id, _name, _parent, _shift)                              \
	{                                                                     \
		.id = _id, .name = _name, .parent_name = _parent,             \
		.regs = &audio0_cg_regs, .shift = _shift,                     \
...
#define GATE_AUDIO1(_id, _name, _parent, _shift)                              \
	{                                                                     \
		.id = _id, .name = _name, .parent_name = _parent,             \
		.regs = &audio1_cg_regs, .shift = _shift,                     \
		.ops = &mtk_clk_gate_ops,                                     \
	}

static const struct mtk_gate audio_clks[] __initconst = {
	/* AUDIO0 */
	GATE_AUDIO0(AUDIO_AFE, "aud_afe", "audio_sel", 2),
	GATE_AUDIO0(AUDIO_I2S, "aud_i2s", "clk_null", 6),
	GATE_AUDIO0(AUDIO_22M, "aud_22m", "aud_engen1_sel", 8),
	GATE_AUDIO0(AUDIO_24M, "aud_24m", "aud_engen2_sel", 9),
	GATE_AUDIO0(AUDIO_APLL2_TUNER, "aud_apll2_tuner", "aud_engen2_sel",
		18),
	GATE_AUDIO0(AUDIO_APLL_TUNER, "aud_apll_tuner", "aud_engen1_sel", 19),
	GATE_AUDIO0(AUDIO_ADC, "aud_adc", "audio_sel", 24),
	GATE_AUDIO0(AUDIO_DAC, "aud_dac", "audio_sel", 25),
	GATE_AUDIO0(AUDIO_DAC_PREDIS, "aud_dac_predis", "audio_sel", 26),
	GATE_AUDIO0(AUDIO_TML, "aud_tml", "audio_sel", 27),
	/* AUDIO1: hf_faudio_ck/hf_faud_engen1_ck/hf_faud_engen2_ck */
	GATE_AUDIO1(AUDIO_I2S1_BCLK_SW, "aud_i2s1_bclk", "audio_sel", 4),
	GATE_AUDIO1(AUDIO_I2S2_BCLK_SW, "aud_i2s2_bclk", "audio_sel", 5),
	GATE_AUDIO1(AUDIO_I2S3_BCLK_SW, "aud_i2s3_bclk", "audio_sel", 6),
	GATE_AUDIO1(AUDIO_I2S4_BCLK_SW, "aud_i2s4_bclk", "audio_sel", 7),
};
...
static const struct mtk_gate_regs mm0_cg_regs = {
	.set_ofs = 0x104, .clr_ofs = 0x108, .sta_ofs = 0x100,
};

static const struct mtk_gate_regs mm1_cg_regs = {
	.set_ofs = 0x114, .clr_ofs = 0x118, .sta_ofs = 0x110,
};

#define GATE_MM0(_id, _name, _parent, _shift)                                 \
	{                                                                     \
		.id = _id, .name = _name, .parent_name = _parent,             \
		.regs = &mm0_cg_regs, .shift = _shift,                        \
		.ops = &mtk_clk_gate_ops_setclr,                              \
	}
...
static const struct mtk_gate mm_clks[] __initconst = {
	...
	GATE_MM1(MMSYS_DSI0_IF_CK, "mm_dsi0_ifck", "mm_sel",
	     1), /* should mipipll1 */
	GATE_MM1(MMSYS_DPI_MM_CK, "mm_dpi_mmck", "mm_sel", 2),
	GATE_MM1(MMSYS_DPI_IF_CK, "mm_dpi_ifck", "mm_sel",
	     3), /* should mipipll2 */
...
#define GATE_VENC_GLOBAL_CON(_id, _name, _parent, _shift)                     \
	{                                                                     \
		.id = _id, .name = _name, .parent_name = _parent,             \
		.regs = &venc_global_con_cg_regs, .shift = _shift,            \
		.ops = &mtk_clk_gate_ops_setclr_inv,                          \
	}

static const struct mtk_gate venc_global_con_clks[] __initconst = {
	GATE_VENC_GLOBAL_CON(VENC_GCON_LARB, "venc_larb", "mm_sel", 0),
	GATE_VENC_GLOBAL_CON(VENC_GCON_VENC, "venc_venc", "mm_sel", 4),
	GATE_VENC_GLOBAL_CON(VENC_GCON_JPGENC, "venc_jpgenc", "mm_sel", 8),
	GATE_VENC_GLOBAL_CON(VENC_GCON_VDEC, "venc_vdec", "mm_sel", 12),
};
...
static void __init mtk_topckgen_init(struct device_node *node)
{
	...
	mtk_clk_register_mux_clr_set_upds(top_muxes, ARRAY_SIZE(top_muxes),
					  base, &mt6763_clk_lock, clk_data);
...
#define PLL_B(_id, _name, _reg, _pwr_reg, _en_mask, _flags, _pcwbits,         \
	...
	{                                                                     \
		...
		.rst_bar_mask = CON0_MT6763_RST_BAR, .fmax = MT6763_PLL_FMAX, \
...
static const struct mtk_pll_data plls[] = {
	...
	HAVE_RST_BAR, 22, 0x0224, 24, 0x0, 0x0224, 0),

	PLL(APMIXED_UNIVPLL, "univpll", 0x0230, 0x023C, 0x00000001,
	HAVE_RST_BAR, 22, 0x0234, 24, 0x0, 0x0234, 0),

	PLL(APMIXED_MFGPLL, "mfgpll", 0x0240, 0x024C, 0x00000001, 0, 22,
	0x0244, 24, 0x0, 0x0244, 0),

	PLL(APMIXED_MSDCPLL, "msdcpll", 0x0250, 0x025C, 0x00000001, 0, 22,
	0x0254, 24, 0x0, 0x0254, 0),

	PLL(APMIXED_TVDPLL, "tvdpll", 0x0260, 0x026C, 0x00000001, 0, 22,
	0x0264, 24, 0x0, 0x0264, 0),

	PLL(APMIXED_MMPLL, "mmpll", 0x0270, 0x027C, 0x00000001, 0, 22, 0x0274,
	24, 0x0, 0x0274, 0),

	PLL(APMIXED_APLL1, "apll1", 0x02A0, 0x02B0, 0x00000001, 0, 32, 0x02A0,
	1, 0x0, 0x02A4, 0),

	PLL(APMIXED_APLL2, "apll2", 0x02b4, 0x02c4, 0x00000001, 0, 32, 0x02b4,
	1, 0x0, 0x02b8, 0),
};
...
static void __init mtk_apmixedsys_init(struct device_node *node)
{
	...
	clk_writel(
		...
		0x007d5550); /* MPLL, CCIPLL, MAINPLL, TDCLKSQ, CLKSQ1 */
	clk_writel(AP_PLL_CON4, clk_readl(AP_PLL_CON4) & 0x7f5);
	clk_writel(AP_PLL_CON6,
		   clk_readl(AP_PLL_CON6) & 0xfffdffff); /* [17] = 0 */
	clk_writel(
	    AP_PLL_CON8,
	    clk_readl(AP_PLL_CON8) &
		0xfffff6af); /*[4]SSUSB26M, [11][6]MIPIC camera, [8] mm26m*/
#if 0
/*MFGPLL*/
...
CLK_OF_DECLARE(mtk_apmixedsys, "mediatek, apmixed", mtk_apmixedsys_init);
...
static void __init mtk_mfg_cfg_init(struct device_node *node)
{
	...
	mtk_clk_register_gates(node, mfg_cfg_clks, ARRAY_SIZE(mfg_cfg_clks),
			       clk_data);
...
{
	/* confirm seninf clk */
	pr_debug("[%s]CLK_CFG_9 = 0x%08x\r\n", __func__, clk_readl(CLK_CFG_9));
	pr_debug("[%s]UNIVPLL_CON0 = 0x%08x\r\n", __func__,
	       clk_readl(UNIVPLL_CON0));
	pr_debug("[%s]UNIVPLL_CON1 = 0x%08x\r\n", __func__,
	       clk_readl(UNIVPLL_CON1));
	pr_debug("[%s]AP_PLL_CON2 = 0x%08x\r\n", __func__,
...
void mp_enter_suspend(int id, int suspend)
{
	...
	if (id == 0) {
		if (suspend) {
			...
			/* mp0 leave suspend */
			clk_writel(AP_PLL_CON3, clk_readl(AP_PLL_CON3) |
						    0x780000); /* bit[22:19]*/
			clk_writel(AP_PLL_CON4, clk_readl(AP_PLL_CON4) |
						    0x2000); /* bit[13] */
		}
	} else if (id == 1) { /* mp1 */
		if (suspend) {
...
{
	if (en)
		clk_writel(AP_PLL_CON2, clk_readl(AP_PLL_CON2) |
					    0xe0000000); /* bit[31:29] */
	else
...
void armpll_control(int id, int on)
{
	if (id == 1) {
		if (on) {
			mt_reg_sync_writel(
			    (clk_readl(ARMPLL_LL_PWR_CON0) | 0x01),
			    ARMPLL_LL_PWR_CON0);
			udelay(100);
			mt_reg_sync_writel(
			...
			udelay(10);
			mt_reg_sync_writel(
			    (clk_readl(ARMPLL_LL_CON1) | 0x80000000),
			    ARMPLL_LL_CON1);
			...
			mt_reg_sync_writel(
			    (clk_readl(ARMPLL_LL_CON0) & 0xfffffffe),
			    ARMPLL_LL_CON0);
			mt_reg_sync_writel(
		...
		if (on) {
			mt_reg_sync_writel(
			    (clk_readl(ARMPLL_L_PWR_CON0) | 0x01),
			    ARMPLL_L_PWR_CON0);
			udelay(100);
			mt_reg_sync_writel(
			...
			udelay(10);
			mt_reg_sync_writel(
			    (clk_readl(ARMPLL_L_CON1) | 0x80000000),
			    ARMPLL_L_CON1);
			...
			mt_reg_sync_writel(
			    (clk_readl(ARMPLL_L_CON0) & 0xfffffffe),
			    ARMPLL_L_CON0);
			mt_reg_sync_writel(
