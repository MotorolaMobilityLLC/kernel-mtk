...
#define HWM_FUN(f)				pr_debug(HWM_TAG"%s\n", __func__)
#define HWM_ERR(fmt, args...)	pr_err(HWM_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define HWM_LOG(fmt, args...)	pr_debug(HWM_TAG fmt, ##args)
#define HWM_VER(fmt, args...)   pr_debug(HWM_TAG"%s: "fmt, __func__, ##args)	/* ((void)0) */
/******************************************************************************
