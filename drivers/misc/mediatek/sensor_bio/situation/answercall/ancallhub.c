...
#define ANCALLHUB_FUN(f)               pr_err(ANCALLHUB_TAG"%s\n", __func__)
#define ANCALLHUB_ERR(fmt, args...)    pr_err(ANCALLHUB_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define ANCALLHUB_LOG(fmt, args...)    pr_err(ANCALLHUB_TAG fmt, ##args)
