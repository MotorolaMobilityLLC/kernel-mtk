 ...
 *     int32_t ppg_control_fs = 512;            // The sampling frequency of PPG input (Support 125Hz only).
 ...
 *     int32_t ppg_control_mode = PPG_CONTROL_MODE_LEDS; // The PPG control mode.
...
typedef enum{
    PPG_CONTROL_MODE_LED1 = 1, /**< Single channel adjustment. */
    PPG_CONTROL_MODE_LEDS = 3  /**< Dual channel adjustment. */
} ppg_control_mode_t;
 ...
 *  
*/
INT32 ppg_control_process(ppg_control_t *ppg_control_input);
