...
#define ALSPS_ALS_SET_TARGET_LUX _IOW(ALSPS, 0x21, int)
#define ALSPS_PS_SET_CALI_DATA _IOW(ALSPS, 0x22, int)
...
#define COMPAT_ALSPS_ALS_SET_TARGET_LUX _IOW(ALSPS, 0x21, compat_int_t)
#define CMOPAT_ALSPS_PS_SET_CALI_DATA _IOW(ALSPS, 0x22, compat_int_t)
#endif
