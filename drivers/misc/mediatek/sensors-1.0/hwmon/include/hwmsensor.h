...
#define SENSOR_TYPE_CHOP_GESTURE                       73
#define SENSOR_TYPE_CAMERA_GESTURE                     74
...
#define ID_CHOP_GESTURE         (ID_BASE + SENSOR_TYPE_CHOP_GESTURE - 1)
#define ID_CAMERA_GESTURE       (ID_BASE + SENSOR_TYPE_CAMERA_GESTURE - 1)
