...
#define	LSM6DS3H_SENSITIVITY_SCALING_Z	1012843
	...
	#define LSM6DS3H_I2C_SLAVE_ADDR		0xD6
#else
...
enum enum_LSM6DS3H_ACC_GYRO_PEDO_EN_t {
	LSM6DS3H_ACC_GYRO_PEDO_EN_DISABLED		 = 0x00,
	LSM6DS3H_ACC_GYRO_PEDO_EN_ENABLED		 = 0x40,
};
#define LSM6DS3H_ACC_GYRO_PEDO_EN_t enum enum_LSM6DS3H_ACC_GYRO_PEDO_EN_t
#define LSM6DS3H_TILT_EN_MASK 0x20

enum enum_LSM6DS3H_ACC_GYRO_TILT_EN_t {
	LSM6DS3H_ACC_GYRO_TILT_EN_DISABLED		 = 0x00,
	LSM6DS3H_ACC_GYRO_TILT_EN_ENABLED		 = 0x20,
};
#define LSM6DS3H_ACC_GYRO_TILT_EN_t enum enum_LSM6DS3H_ACC_GYRO_TILT_EN_t

enum enum_LSM6DS3H_ACC_GYRO_ROUNT_INT_t {
	LSM6DS3H_ACC_GYRO_INT1		 = 0,
	LSM6DS3H_ACC_GYRO_INT2		 = 1,
};
#define LSM6DS3H_ACC_GYRO_ROUNT_INT_t enum enum_LSM6DS3H_ACC_GYRO_ROUNT_INT_t

enum enum_LSM6DS3H_ACC_GYRO_FUNC_EN_t {
	LSM6DS3H_ACC_GYRO_FUNC_EN_DISABLED		 = 0x00,
	LSM6DS3H_ACC_GYRO_FUNC_EN_ENABLED		 = 0x04,
};
#define LSM6DS3H_ACC_GYRO_FUNC_EN_t enum enum_LSM6DS3H_ACC_GYRO_FUNC_EN_t

enum enum_LSM6DS3H_ACC_GYRO_INT2_TILT_t {
	LSM6DS3H_ACC_GYRO_INT_TILT_DISABLED		 = 0x00,
	LSM6DS3H_ACC_GYRO_INT_TILT_ENABLED		 = 0x02,
};
#define LSM6DS3H_ACC_GYRO_INT2_TILT_t enum enum_LSM6DS3H_ACC_GYRO_INT2_TILT_t

#define	LSM6DS3H_ACC_GYRO_INT_TILT_MASK	0x02
enum enum_LSM6DS3H_ACC_GYRO_TILT_t {
	LSM6DS3H_ACC_GYRO_TILT_DISABLED		 = 0x00,
	LSM6DS3H_ACC_GYRO_TILT_ENABLED		 = 0x02,
};
#define LSM6DS3H_ACC_GYRO_TILT_t enum enum_LSM6DS3H_ACC_GYRO_TILT_t

#define LSM6DS3H_ACC_GYRO_TILT_MASK	0x02

enum enum_LSM6DS3H_ACC_GYRO_INT_SIGN_MOT_t {
	LSM6DS3H_ACC_GYRO_INT_SIGN_MOT_DISABLED		 = 0x00,
	LSM6DS3H_ACC_GYRO_INT_SIGN_MOT_ENABLED		 = 0x40,
};
#define LSM6DS3H_ACC_GYRO_INT_SIGN_MOT_t enum enum_LSM6DS3H_ACC_GYRO_INT_SIGN_MOT_t

#define	LSM6DS3H_ACC_GYRO_INT_SIGN_MOT_MASK	0x40

enum enum_LSM6DS3H_ACC_GYRO_SIGN_MOT_t {
	LSM6DS3H_ACC_GYRO_SIGN_MOT_DISABLED		 = 0x00,
	LSM6DS3H_ACC_GYRO_SIGN_MOT_ENABLED		 = 0x01,
};
#define LSM6DS3H_ACC_GYRO_SIGN_MOT_t enum enum_LSM6DS3H_ACC_GYRO_SIGN_MOT_t

#define	LSM6DS3H_ACC_GYRO_SIGN_MOT_MASK	0x01

enum enum_LSM6DS3H_ACC_GYRO_RAM_PAGE_t {
	LSM6DS3H_ACC_GYRO_RAM_PAGE_DISABLED		 = 0x00,
	LSM6DS3H_ACC_GYRO_RAM_PAGE_ENABLED		 = 0x80,
};
#define LSM6DS3H_ACC_GYRO_RAM_PAGE_t enum enum_LSM6DS3H_ACC_GYRO_RAM_PAGE_t

#define LSM6DS3H_RAM_PAGE_MASK	0x80
#define LSM6DS3H_CONFIG_PEDO_THS_MIN          0x0F

enum enum_LSM6DS3H_ACC_GYRO_PEDO_RST_STEP_t {
	LSM6DS3H_ACC_GYRO_PEDO_RST_STEP_DISABLED	 = 0x00,
	LSM6DS3H_ACC_GYRO_PEDO_RST_STEP_ENABLED		 = 0x02,
};
#define LSM6DS3H_ACC_GYRO_PEDO_RST_STEP_t enum enum_LSM6DS3H_ACC_GYRO_PEDO_RST_STEP_t

#define LSM6DS3H_PEDO_RST_STEP_MASK  0x02

enum enum_LSM6DS3H_ACC_GYRO_INT_ACTIVE_t {
	LSM6DS3H_ACC_GYRO_INT_ACTIVE_HIGH	 = 0x00,
	LSM6DS3H_ACC_GYRO_INT_ACTIVE_LOW		 = 0x20,
};
#define LSM6DS3H_ACC_GYRO_INT_ACTIVE_t enum enum_LSM6DS3H_ACC_GYRO_INT_ACTIVE_t

#define LSM6DS3H_ACC_GYRO_INT_ACTIVE_MASK 0x20

enum enum_LSM6DS3H_ACC_GYRO_INT_LATCH_CTL_t {
	LSM6DS3H_ACC_GYRO_INT_LATCH	  = 0x01,
	LSM6DS3H_ACC_GYRO_INT_NO_LATCH	 = 0x00,
};
#define LSM6DS3H_ACC_GYRO_INT_LATCH_CTL_t enum enum_LSM6DS3H_ACC_GYRO_INT_LATCH_CTL_t
...
/* 180*131/PI = 7506*/
#define PI              3.1415926
#define DEGREE_TO_RAD	1000000 /*we don't report degree but report uPI in kernel, in hal need to divide 1000000 to PI*/
