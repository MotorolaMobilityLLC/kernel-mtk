...
#define SX932X_FUN(f)              printk(KERN_INFO 	SX932X_TAG"%s\n", __FUNCTION__)
#define SX932X_ERR(fmt, args...)   printk(KERN_ERR  	SX932X_TAG"%s %d : "fmt, __FUNCTION__, __LINE__, ##args)
#define SX932X_LOG(fmt, args...)   printk(KERN_NOTICE	SX932X_TAG fmt, ##args)
#define SX932X_DBG(fmt, args...)   printk(KERN_ERR 	SX932X_TAG fmt, ##args)
