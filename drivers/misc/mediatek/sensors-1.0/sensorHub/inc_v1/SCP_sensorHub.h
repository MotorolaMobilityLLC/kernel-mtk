...
struct camera_gesture_event_t {
	int32_t state;		/* 0,1 */
};

struct significant_move_event_t {
	int32_t state;		/* 0,1 */
};
...
struct data_unit_t {
	...
	union {
		...
		struct chop_event_t chop_event;
		struct camera_gesture_event_t camera_event;
		struct significant_move_event_t move_event;
