...
extern void (*low_battery_callback)(LOW_BATTERY_LEVEL level);
extern void
...
extern void (*battery_oc_callback)(BATTERY_OC_LEVEL level);
extern void
...
extern void (*battery_percent_callback)(BATTERY_PERCENT_LEVEL level);
