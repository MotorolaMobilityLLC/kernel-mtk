...
#define FG_RG_INT_EN_NAG_C_DLTV INT_ENUM_MAX
...
#define FG_ZCV_NO INT_ENUM_MAX
#define FG_BAT1_INT_H_NO INT_ENUM_MAX
#define FG_BAT1_INT_L_NO INT_ENUM_MAX
