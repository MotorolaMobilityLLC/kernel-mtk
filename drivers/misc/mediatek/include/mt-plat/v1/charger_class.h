...
struct charger_ops {
	...
	int (*get_charger_type_hvdcp)(struct charger_device *dev, bool *state);
...
extern int charger_dev_get_charger_type_hvdcp(struct charger_device *charger_dev, bool *state);
