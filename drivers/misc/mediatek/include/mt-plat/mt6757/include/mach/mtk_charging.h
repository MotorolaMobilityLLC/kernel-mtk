...
/* charger error check */
/* #define BAT_LOW_TEMP_PROTECT_ENABLE         // stop charging if temp <
...
#define SWITCH_CHR_VINDPM_12V                                                  \
	0x54 /* 11.0 set this tp prevent adapters from failure and reset*/
...
/*enable this to change thread wakeup period to 10 secs to avoid suspend
 * failure*/
...
#define BATTERY_MODULE_INIT
	...
	defined(CONFIG_MTK_BQ24261_SUPPORT) || defined(CONFIG_MTK_RT9466_SUPPORT)
#define SWCHR_POWER_PATH
	...
	defined(CONFIG_MTK_BQ24250_SUPPORT) || defined(CONFIG_MTK_BQ24261_SUPPORT)
