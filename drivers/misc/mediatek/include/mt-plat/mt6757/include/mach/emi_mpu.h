...
#define EMI_MPUD_ST(domain)                                                    \
	(EMI_MPUD0_ST + (4 * domain))	 /* violation status domain */
#define EMI_MPUD0_ST2 (EMI_BASE_ADDR + 0x200) /* violation status domain */
#define EMI_MPUD_ST2(domain)                                                   \
	(EMI_MPUD0_ST2 + (4 * domain)) /* violation status domain */
#define EMI_MPUS                                                               \
	(EMI_BASE_ADDR + 0x01F0) /* Memory protect unit control registers S */
#define EMI_MPUT                                                               \
	(EMI_BASE_ADDR + 0x01F8) /* Memory protect unit control registers S */
#define EMI_MPUT_2ND                                                           \
	(EMI_BASE_ADDR + 0x01FC) /* Memory protect unit control registers S */
...
#define EMI_MPU_APC(region, domain)                                            \
	(EMI_MPU_APC0 + (region * 4) + ((domain / 8) * 0x100))
