...
#define SPM_MFG_ASYNC_PWR_CON		(SPM_BASE + 0x2c4)	/* mt6757 */
#define SPM_MD32_SRAM_CON		(SPM_BASE + 0x2c8)
#define SPM_ARMPLL_DIV_PWR_CON  (SPM_BASE + 0x2cc)
#define SPM_MD2_PWR_CON         (SPM_BASE + 0x2d0)
#define SPM_C2K_PWR_CON         (SPM_BASE + 0x2d4)	/* mt6757 */
#define SPM_INFRA_MD_PWR_CON    (SPM_BASE + 0x2d8)	/* mt6757 */
#define SPM_CPU_EXT_ISO         (SPM_BASE + 0x2dc)	/* mt6757 */
...
#define SPM_AP_STANBY_CON		(SPM_BASE + 0x608)	/* mt6757 */
#define SPM_PWR_STATUS			(SPM_BASE + 0x60c)
#define SPM_PWR_STATUS_2ND		(SPM_BASE + 0x610)
/* #define SPM_AP_BSI_REQ                        (SPM_BASE + 0x614) */
#define SPM_SLEEP_MDBSI_CON		(SPM_BASE + 0x614)	/* mt6757 */
#define SPM_BSI_GEN		        (SPM_BASE + 0x620)	/* mt6757 */
#define SPM_BSI_EN_SR		      (SPM_BASE + 0x624)	/* mt6757 */
#define SPM_BSI_CLK_SR		    (SPM_BASE + 0x628)	/* mt6757 */
#define SPM_BSI_DO_SR		      (SPM_BASE + 0x62c)	/* mt6757 */
#define SPM_BSI_D1_SR		      (SPM_BASE + 0x630)	/* mt6757 */
#define SPM_BSI_D2_SR		      (SPM_BASE + 0x634)	/* mt6757 */
#define SPM_AP_SEMA		        (SPM_BASE + 0x638)	/* mt6757 */
#define SPM_SPM_SEMA		      (SPM_BASE + 0x63c)	/* mt6757 */
...
#define SPM_MD_VRF18_DIS		(1U << 5)	/* mt6757 */
#define SPM_MEMPLL_CG_EN		(1U << 6)	/* mt6757 */
/* #define SPM_MEMPLL_RESET        (1U << 7)//mt6757 no use */
#define SPM_VCORE_DVFS_EN	  (1U << 8)	/* mt6757 */
#define SPM_CPU_DVS_DIS		    (1U << 9)
#define SPM_IFRA_MD_PDN_DIS		(1U << 10)	/* mt6757 */
#define SPM_VCORE_DVS_EVENT_DIS    (1U << 11)	/* mt6757 */
#define SPM_DDR_HIGH_SPEED	      (1U << 12)	/* mt6757 no use */
#define SPM_DISABLE_ATF_ABORT     (1U << 13)	/* mt6757 */
