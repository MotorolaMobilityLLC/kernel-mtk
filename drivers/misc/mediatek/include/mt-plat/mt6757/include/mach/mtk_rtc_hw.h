...
/*
 * 0: embedded clock switch back to dcxo decided by (eosc32_ck_alive &
 * powerkey_match)
...
/*Default 4'b0111, 2nd step suggest to set to 4'b0000 EOSC_CALI = charging cap
 * calibration*/
#define RTC_XOSCCALI_MASK 0x001f

#define OSC32CON_ANALOG_SETTING                                                \
	(RTC_GP_OSC32_CON | RTC_EOSC32_VCT_EN |                                \
	 RTC_EOSC32_CHOP_EN & (~RTC_REG_XOSC32_ENB) & (~RTC_EMBCK_SEL_MODE) |  \
...
#define PMIC_RG_SRCLKEN_IN0_HW_MODE_SHIFT                                      \
	MT6351_PMIC_RG_SRCLKEN_IN0_HW_MODE_SHIFT
...
#define PMIC_RG_SRCLKEN_IN1_HW_MODE_SHIFT                                      \
	MT6351_PMIC_RG_SRCLKEN_IN1_HW_MODE_SHIFT
