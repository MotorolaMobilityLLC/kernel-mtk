...
/*CON1, DDS value */
#define REG_ARMPLL1_CON1	REG_APMIX_ADDR(0x0200)
#define REG_ARMPLL2_CON1	REG_APMIX_ADDR(0x0210)
#define REG_ARMPLL3_CON1	REG_PLL_NOT_SUPPORT
#define REG_CCIPLL_CON1		REG_APMIX_ADDR(0x0290)
#define REG_GPUPLL_CON1		REG_PLL_NOT_SUPPORT
#define REG_MPLL_CON1		REG_APMIX_ADDR(0x0280)
#define REG_MEMPLL_CON1		REG_DDRPHY_ADDR(0x0d94)	/*< Bit[30:10] DDS,  Bit[31] Update DDS */
#define REG_MAINPLL_CON1	REG_APMIX_ADDR(0x0220)
#define REG_MSDCPLL_CON1	REG_APMIX_ADDR(0x0250)
#define REG_MMPLL_CON1		REG_APMIX_ADDR(0x0240)
#define REG_VENCPLL_CON1	REG_APMIX_ADDR(0x0260)
#define REG_TVDPLL_CON1		REG_APMIX_ADDR(0x0270)
/****************************************************/
