...
static const struct of_device_id vcodec_of_match[] = {
	{ .compatible = "mediatek,mt6750-vdec_gcon", },
	{/* sentinel */}
};
...
static int __init vcodec_driver_init(void)
{
...

	{
		...
		node = of_find_compatible_node(NULL, NULL, "mediatek,mt6750-venc");
...

	{
		...
		node = of_find_compatible_node(NULL, NULL, "mediatek,mt6750-vdec_full_top");
	...
	}
	{
		...
		node = of_find_compatible_node(NULL, NULL, "mediatek,mt6750-vdec_gcon");
