...
#ifdef MFV_LOG_ERROR
/* /< show error log */
#define MODULE_MFV_LOGE(...) xlog_printf(ANDROID_LOG_ERROR, "VDO_LOG", \
					__VA_ARGS__)
/* /< show error log */
...
/* /< show warning log */
#define MODULE_MFV_LOGW(...) xlog_printf(ANDROID_LOG_WARN, "VDO_LOG", \
					__VA_ARGS__)
/* /< show warning log */
...
#define MODULE_MFV_LOGD(...) xlog_printf(ANDROID_LOG_DEBUG, "VDO_LOG", \
					__VA_ARGS__)
/* /< show debug information log */
...
#define MODULE_MFV_LOGI(...) xlog_printf(ANDROID_LOG_INFO, "VDO_LOG", \
					__VA_ARGS__)
/* /< show information log */
