...
#define PWRAPERR(fmt, arg...)                                                  \
	pr_debug(PWRAPTAG "ERROR,line=%d " fmt, __LINE__, ##arg)
#define PWRAPREG(fmt, arg...) pripr_debugntk(PWRAPTAG fmt, ##arg)

/*if BringUp doesn't had PMIC, need open this */
/* #define PMIC_WRAP_NO_PMIC */

/******************** MT6797 platform info, PMIC info ************/
#define SLV_6351
...
#define PMIC_WRAP_HARB_SLEEP_GATED_CTRL                                        \
	((unsigned int *)(PMIC_WRAP_BASE + 0x1F0))
#define PMIC_WRAP_MD_ADC_RDATA_ADDR_LATEST                                     \
	((unsigned int *)(PMIC_WRAP_BASE + 0x1F4))
#define PMIC_WRAP_MD_ADC_RDATA_ADDR_WP                                         \
	((unsigned int *)(PMIC_WRAP_BASE + 0x1F8))
...
#define PMIC_WRAP_STARV_COUNTER_0_STATUS                                       \
	((unsigned int *)(PMIC_WRAP_BASE + 0x2D8))
#define PMIC_WRAP_STARV_COUNTER_1_STATUS                                       \
	((unsigned int *)(PMIC_WRAP_BASE + 0x2DC))
#define PMIC_WRAP_STARV_COUNTER_2_STATUS                                       \
	((unsigned int *)(PMIC_WRAP_BASE + 0x2E0))
#define PMIC_WRAP_STARV_COUNTER_3_STATUS                                       \
	((unsigned int *)(PMIC_WRAP_BASE + 0x2E4))
#define PMIC_WRAP_STARV_COUNTER_4_STATUS                                       \
	((unsigned int *)(PMIC_WRAP_BASE + 0x2E8))
#define PMIC_WRAP_STARV_COUNTER_5_STATUS                                       \
	((unsigned int *)(PMIC_WRAP_BASE + 0x2EC))
#define PMIC_WRAP_STARV_COUNTER_6_STATUS                                       \
	((unsigned int *)(PMIC_WRAP_BASE + 0x2F0))
#define PMIC_WRAP_STARV_COUNTER_7_STATUS                                       \
	((unsigned int *)(PMIC_WRAP_BASE + 0x2F4))
#define PMIC_WRAP_STARV_COUNTER_8_STATUS                                       \
	((unsigned int *)(PMIC_WRAP_BASE + 0x2F8))
#define PMIC_WRAP_STARV_COUNTER_9_STATUS                                       \
	((unsigned int *)(PMIC_WRAP_BASE + 0x2FC))
#define PMIC_WRAP_STARV_COUNTER_10_STATUS                                      \
	((unsigned int *)(PMIC_WRAP_BASE + 0x300))
#define PMIC_WRAP_STARV_COUNTER_11_STATUS                                      \
	((unsigned int *)(PMIC_WRAP_BASE + 0x304))
#define PMIC_WRAP_STARV_COUNTER_12_STATUS                                      \
	((unsigned int *)(PMIC_WRAP_BASE + 0x308))
#define PMIC_WRAP_STARV_COUNTER_13_STATUS                                      \
	((unsigned int *)(PMIC_WRAP_BASE + 0x30C))
#define PMIC_WRAP_STARV_COUNTER_14_STATUS                                      \
	((unsigned int *)(PMIC_WRAP_BASE + 0x310))
#define PMIC_WRAP_STARV_COUNTER_15_STATUS                                      \
	((unsigned int *)(PMIC_WRAP_BASE + 0x314))
