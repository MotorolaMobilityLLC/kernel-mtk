...
static void _pwrap_starve_set(void)
{
	...
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_0, 0x0401);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_1, 0x0401);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_2, 0x0403);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_3, 0x0420);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_4, 0x0420);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_5, 0x0420);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_6, 0x0428);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_7, 0x0428);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_8, 0x0417);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_9, 0x0563);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_10, 0x047C);
	WRAP_WR32(PMIC_WRAP_STARV_COUNTER_11, 0x0740);
