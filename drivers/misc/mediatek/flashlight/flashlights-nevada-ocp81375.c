...
static const int ocp81375_current[OCP81375_LEVEL_NUM] = {
	 31,   71,  117,  159,  202,  245, 288, 330, 373, 416,
	459,  501,  544,  587,  630,  672, 715, 758, 801, 843,
	886,  929,  972,  1014, 1057, 1100
};

static const unsigned char ocp81375_torch_level[OCP81375_LEVEL_NUM] = {
	0x00, 0x03, 0x07, 0x0B, 0x10, 0x14, 0x19, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};//I(mA) = level*3.90+3.90

static const unsigned char ocp81375_flash_level[OCP81375_LEVEL_NUM] = {
        0x01, 0x04, 0x06, 0x09, 0x0C, 0x0F, 0x11, 0x14, 0x17, 0x1A,
        0x1C, 0x1F, 0x22, 0x25, 0x27, 0x2A, 0x2D, 0x2F, 0x32, 0x35,
        0x38, 0x3A, 0x3D, 0x40, 0x43, 0x45
...
static int ocp81375_set_level_ch1(int level)
{
	...
	pr_err("nevada flashlight ocp81375_set_level_ch1\n");
...
ocp81375_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if (flashlight_dev_register(NEVADA_OCP81375_NAME, &ocp81375_ops)) {
...
static int ocp81375_i2c_remove(struct i2c_client *client)
{
	...
	flashlight_dev_unregister(NEVADA_OCP81375_NAME);
...
static const struct i2c_device_id ocp81375_i2c_id[] = {
	{NEVADA_OCP81375_NAME, 0},
	{}
};

#ifdef CONFIG_OF
static const struct of_device_id ocp81375_i2c_of_match[] = {
	{.compatible = NEVADA_OCP81375_DTNAME_I2C},
	{},
};
#endif
