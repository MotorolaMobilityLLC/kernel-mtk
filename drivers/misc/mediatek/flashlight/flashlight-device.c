...
#elif IS_ENABLED(CONFIG_MTK_FLASHLIGHT_RT4505)
const struct flashlight_device_id flashlight_id[] = {
	/* {TYPE, CT, PART, "NAME", CHANNEL, DECOUPLE} */
...
#elif defined(CONFIG_MTK_FLASHLIGHT_CANCUNF)
const struct flashlight_device_id flashlight_id[] = {
	/* {TYPE, CT, PART, "NAME", CHANNEL, DECOUPLE} */
	{0, 0, 0, "flashlights-cancunf-pwm", 0, 0},
};
#elif defined(CONFIG_MTK_FLASHLIGHT_BOGOTA_AW36515) || defined(CONFIG_MTK_FLASHLIGHT_OCP81375)
	const struct flashlight_device_id flashlight_id[] = {
	/* {TYPE, CT, PART, "NAME", CHANNEL, DECOUPLE} */
        {0, 0, 0, "flashlights-aw36515", 0, 0},
        {0, 0, 0, "flashlights-ocp81375", 0, 0},
};
#elif defined(CONFIG_MTK_FLASHLIGHT_OCP8132)
const struct flashlight_device_id flashlight_id[] = {
	/* {TYPE, CT, PART, "NAME", CHANNEL, DECOUPLE} */
