...
#if defined(CONFIG_MTK_FLASHLIGHT_AW36515) || defined(CONFIG_MTK_FLASHLIGHT_OCP81375)
...
const struct flashlight_device_id flashlight_id[] = {
	/* {TYPE, CT, PART, "NAME", CHANNEL, DECOUPLE} */
	{0, 0, 0, "flashlights-ocp8135-pwm", 0, 0},
};
#elif defined(CONFIG_MTK_FLASHLIGHT_ORLANDO)
const struct flashlight_device_id flashlight_id[] = {
	/* {TYPE, CT, PART, "NAME", CHANNEL, DECOUPLE} */
...
#elif defined(CONFIG_MTK_FLASHLIGHT_SBUYA_AW36515) || defined(CONFIG_MTK_FLASHLIGHT_SBUYA_SGM37864)
const struct flashlight_device_id flashlight_id[] = {
	/* {TYPE, CT, PART, "NAME", CHANNEL, DECOUPLE} */
	{0, 0, 0, "flashlights-aw36515", 0, 0},
	{0, 0, 0, "flashlights-sgm37864", 0, 0},
};
#elif defined(mt6739)
const struct flashlight_device_id flashlight_id[] = {
	/* {TYPE, CT, PART, "NAME", CHANNEL, DECOUPLE} */
