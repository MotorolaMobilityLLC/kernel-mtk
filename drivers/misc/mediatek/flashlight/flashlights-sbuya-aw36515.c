...
#define AW36515_REG_CHIP_VENDOR_ID   (0x00)
#define AW36515_CHIP_VENDOR_ID       (0x30)
...
//torch current 5, 17, 29, 41, 53, 65, 80
static const unsigned char aw36515_torch_level[AW36515_LEVEL_NUM] = {
	0x02, 0x08, 0x0E, 0x14, 0x1B, 0x21, 0x28, 0x00, 0x00, 0x00,
...
static int aw36515_set_level_ch1(int level)
{
	...
	pr_err("sbuya flashlight aw36515_set_level_ch1\n");
...
int aw36515_read_vendor_id(void)
{
	...
	if (((val & 0x30) == AW36515_CHIP_VENDOR_ID) && !(reg_data & 0x01)) {
...
aw36515_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if (flashlight_dev_register(SBUYA_AW36515_NAME, &aw36515_ops)) {
...
static int aw36515_i2c_remove(struct i2c_client *client)
{
	...
	flashlight_dev_unregister(SBUYA_AW36515_NAME);
...
static const struct i2c_device_id aw36515_i2c_id[] = {
	{SBUYA_AW36515_NAME, 0},
	{}
};

#ifdef CONFIG_OF
static const struct of_device_id aw36515_i2c_of_match[] = {
	{.compatible = SBUYA_AW36515_DTNAME_I2C},
	{},
};
#endif
...
static const struct of_device_id aw36515_of_match[] = {
	{.compatible = SBUYA_AW36515_DTNAME},
	{},
};
