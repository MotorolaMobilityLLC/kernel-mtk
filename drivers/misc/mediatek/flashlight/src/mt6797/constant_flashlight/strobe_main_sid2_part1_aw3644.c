...
extern int flashEnable_aw3644_2(void);
extern int flashDisable_aw3644_2(void);
extern int setDuty_aw3644_2(int duty);
...
static int FL_dim_duty(unsigned int duty)
{
    PK_DBG(" FL_dim_duty line=%d\n",__LINE__);
    setDuty_aw3644_2(duty);
    return 0;
}
...
static int constant_flashlight_ioctl(unsigned int cmd, unsigned long arg)
{
	...
	PK_DBG("aw3644_LED2_constant_flashlight_ioctl() line=%d ior_shift=%d, iow_shift=%d iowr_shift=%d arg=%d\n",__LINE__, ior_shift, iow_shift, iowr_shift, (int)arg);
    switch(cmd)
    {
...
MUINT32 strobeInit_main_sid2_part1_aw3644(PFLASHLIGHT_FUNCTION_STRUCT *pfFunc)
{
    if (pfFunc != NULL)
    {
