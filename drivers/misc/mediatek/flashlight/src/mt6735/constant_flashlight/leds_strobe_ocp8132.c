...
static int g_duty=0;  //bug252879 tiantian.wt modify flashligth is torch mode on default
...
#define FLASH_GPIO_ENF 43 //GPIO_CAMERA_FLASH_EXT1_PIN //flash_en
#define FLASH_GPIO_ENM 55 //GPIO_CAMERA_FLASH_EXT2_PIN //flash_stb
