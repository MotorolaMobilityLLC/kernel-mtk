...
static const struct mst_tbl_entry mst_tbl[] = {
	...
	{.master = MT6771_M2_AXI_MST_VENC_RCPU_HW_VDEC_MC_EXT, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0x40,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_IMGI, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0x80,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_IMG3O, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0x84,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_LCEI, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0x88,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_SMXO, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0x8C,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_WPE0_RDMA0, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0x90,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_FDVT_RP, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0x94,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_FDVT_RB, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0x98,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_WPE1_RDMA1, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0x9C,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_DPE_RDMA, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0xA0,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_IMGO, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0xC0,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_AAO, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0xC4,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_LSCI_0, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0xC8,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_PDO, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0xCC,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_LCSO, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0xD0,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_UFEO, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0xD4,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_SOC1, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0xD8,
		.note = "",
	...
	{.master = MT6771_M2_AXI_MST_CCUI, .port = 2, .id_mask = 0x1FF8,
		.id_val = 0xDC,
		.note = "",
	...
	{.master = MT6771_M7_AXI_MST_SPM1, .port = 7, .id_mask = 0x1FFF,
		.id_val = 0x126,
		.note = "",
		.name = "MT6771_M7_AXI_MST_SPM1"},
	{.master = MT6771_M7_AXI_MST_SSPM, .port = 7, .id_mask = 0x1FFF,
		.id_val = 0x226,
		.note = "",
	...
	{.master = MT6771_M7_AXI_MST_SCPSYS_M, .port = 7, .id_mask = 0x1F1F,
		.id_val = 0x1E,
		.note = "",
		.name = "MT6771_M7_AXI_MST_SCPSYS_M"},
	{.master = MT6771_M7_AXI_MST_READ_WRITE, .port = 7, .id_mask = 0x1F81,
		.id_val = 0x1,
		.note = "",
		.name = "MT6771_M7_AXI_MST_READ_WRITE"},
