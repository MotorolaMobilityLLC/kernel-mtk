...
/* keep same with kernel-4.19/drivers/misc/mediatek/sensor/2.0/core/hf_sensor_type.h */
enum scp_sensor_id {
...
//moto add
	FLAT_UP_FEATURE_ID = 75,
	FLAT_DOWN_FEATURE_ID = 76,
	STOWED_FEATURE_ID = 77,
	CAMERA_ACTIVATE_FEATURE_ID = 78,
	CHOPCHOP_GESTURE_FEATURE_ID = 84,
	MOTO_GLANCE_GESTURE_FEATURE_ID = 86,
	LTS_FEATURE_ID = 91,
	FTM_FEATURE_ID = 92,
	LTV_FEATURE_ID = 94,
	OFFBODY_FEATURE_ID = 98,
	PROXCAL_FEATURE_ID = 99,
	LIGHT_1_FEATURE_ID = 116,
	TAP_FEATURE_ID = 119,
	NUM_SENSOR_TYPE,
};
#else
