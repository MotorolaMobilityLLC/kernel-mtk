...
//moto add
	{
		.feature = FLAT_UP_FEATURE_ID,
		.freq    = 0,
 		.enable  = 0,
 	},
	{
		.feature = FLAT_DOWN_FEATURE_ID,
		.freq    = 0,
 		.enable  = 0,
 	},
	{
		.feature = STOWED_FEATURE_ID,
		.freq    = 0,
 		.enable  = 0,
 	},
	{
		.feature = CAMERA_ACTIVATE_FEATURE_ID,
		.freq    = 0,
 		.enable  = 0,
 	},
	{
		.feature = CHOPCHOP_GESTURE_FEATURE_ID,
		.freq    = 0,
 		.enable  = 0,
 	},
	{
		.feature = MOTO_GLANCE_GESTURE_FEATURE_ID,
		.freq    = 0,
 		.enable  = 0,
 	},
	{
		.feature = LTS_FEATURE_ID,
		.freq    = 0,
 		.enable  = 0,
 	},
	{
		.feature = FTM_FEATURE_ID,
		.freq    = 0,
 		.enable  = 0,
 	},
	{
		.feature = LTV_FEATURE_ID,
		.freq    = 0,
 		.enable  = 0,
 	},
	{
		.feature = OFFBODY_FEATURE_ID,
		.freq    = 0,
 		.enable  = 0,
 	},
	{
		.feature = PROXCAL_FEATURE_ID,
		.freq    = 0,
 		.enable  = 0,
 	},
	{
		.feature = LIGHT_1_FEATURE_ID,
		.freq    = 0,
 		.enable  = 0,
 	},
	{
		.feature = TAP_FEATURE_ID,
		.freq    = 0,
 		.enable  = 0,
 	},
};
