...
static const struct mst_tbl_entry mst_tbl[] = {
	...
	/* apmcu ch2 */
	{.master = MST_ID_APMCU_CH2_0,
	 .port = 0x1,
	 .id_mask = 0xFCF,
	 .id_val = 0x4,
	 .note = "CA7LL: Core nn system domain store exclusive",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_1,
	 .port = 0x1,
	 .id_mask = 0xFCF,
	 .id_val = 0x44,
	 .note = "CA7LL: Core nn barrier",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_2,
	 .port = 0x1,
	 .id_mask = 0xFFF,
	 .id_val = 0x94,
	 .note = "CA7LL: SCU generated barrier",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_3,
	 .port = 0x1,
	 .id_mask = 0xFCF,
	 .id_val = 0xC4,
	 .note = "CA7LL: Core nn non-re-orderable device write",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_4,
	 .port = 0x1,
	 .id_mask = 0xF0F,
	 .id_val = 0x104,
	 .note = "CA7LL: Write to normal memory",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_5,
	 .port = 0x1,
	 .id_mask = 0xFCF,
	 .id_val = 0x4,
	 .note = "CA7LL: Core nn exclusive read",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_6,
	 .port = 0x1,
	 .id_mask = 0xFCF,
	 .id_val = 0x44,
	 .note = "CA7LL: Core nn barrier",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_7,
	 .port = 0x1,
	 .id_mask = 0xFFF,
	 .id_val = 0x94,
	 .note = "CA7LL: SCU generated barrier or DVM complete",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_8,
	 .port = 0x1,
	 .id_mask = 0xF3F,
	 .id_val = 0x104,
	 .note = "CA7LL: ACP read",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_9,
	 .port = 0x1,
	 .id_mask = 0xE0F,
	 .id_val = 0x204,
	 .note = "CA7LL: Core nn read",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_10,
	 .port = 0x1,
	 .id_mask = 0xFCF,
	 .id_val = 0x3,
	 .note = "CA7L: Core nn system domain store exclusive",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_11,
	 .port = 0x1,
	 .id_mask = 0xFCF,
	 .id_val = 0x43,
	 .note = "CA7L: Core nn barrier",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_12,
	 .port = 0x1,
	 .id_mask = 0xFFF,
	 .id_val = 0x93,
	 .note = "CA7L: SCU generated barrier",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_13,
	 .port = 0x1,
	 .id_mask = 0xFCF,
	 .id_val = 0xC3,
	 .note = "CA7L: Core nn non-re-orderable device write",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_14,
	 .port = 0x1,
	 .id_mask = 0xF0F,
	 .id_val = 0x103,
	 .note = "CA7L: Write to normal memory",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_15,
	 .port = 0x1,
	 .id_mask = 0xFCF,
	 .id_val = 0x3,
	 .note = "CA7L: Core nn exclusive read",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_16,
	 .port = 0x1,
	 .id_mask = 0xFCF,
	 .id_val = 0x43,
	 .note = "CA7L: Core nn barrier",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_17,
	 .port = 0x1,
	 .id_mask = 0xFFF,
	 .id_val = 0x93,
	 .note = "CA7L: SCU generated barrier or DVM complete",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_18,
	 .port = 0x1,
	 .id_mask = 0xF3F,
	 .id_val = 0x103,
	 .note = "CA7L: ACP read",
	 .name = "CA53_m_57"},
	{.master = MST_ID_APMCU_CH2_19,
	 .port = 0x1,
	 .id_mask = 0xE0F,
	 .id_val = 0x203,
	 .note = "CA7L: Core nn read",
	...
	/* MM ch1 */
	{.master = MST_ID_MM_CH1_0,
	 .port = 0x2,
	 .id_mask = 0xF80,
	 .id_val = 0x0,
	 .note = "smi_larb0",
	 .name = "smi_larb0_m_57"},
	{.master = MST_ID_MM_CH1_1,
	 .port = 0x2,
	 .id_mask = 0xF80,
	 .id_val = 0x80,
	 .note = "smi_larb1",
	 .name = "smi_larb1_m_57"},
	{.master = MST_ID_MM_CH1_2,
	 .port = 0x2,
	 .id_mask = 0xF80,
	 .id_val = 0x100,
	 .note = "smi_larb2",
	 .name = "smi_larb2_m_57"},
	{.master = MST_ID_MM_CH1_3,
	 .port = 0x2,
	 .id_mask = 0xF80,
	 .id_val = 0x180,
	 .note = "smi_larb3",
	 .name = "smi_larb3_m_57"},
	{.master = MST_ID_MM_CH1_4,
	 .port = 0x2,
	 .id_mask = 0xF80,
	 .id_val = 0x200,
	 .note = "smi_larb4",
	 .name = "smi_larb4_m_57"},
	{.master = MST_ID_MM_CH1_5,
	 .port = 0x2,
	 .id_mask = 0xF80,
	 .id_val = 0x280,
	 .note = "smi_larb5",
	 .name = "smi_larb5_m_57"},
	{.master = MST_ID_MM_CH1_6,
	 .port = 0x2,
	 .id_mask = 0xFFF,
	 .id_val = 0x3FC,
	 .note = "MM IOMMU Internal Used",
	 .name = "MM_IOMMU_Internal_Used_m_57"},
	{.master = MST_ID_MM_CH1_7,
	 .port = 0x2,
	 .id_mask = 0xFFF,
	 .id_val = 0x3FD,
	 .note = "MM IOMMU Internal Used",
	...
	{.master = MST_ID_MDMCU_2,
	 ...
	 .note = "MDMCU ALC",
	 .name = "MDMCU_m_57"},
	{.master = MST_ID_MD_L1MCU_0,
	 .port = 0x3,
	 .id_mask = 0xF0F,
	 .id_val = 0x1,
	 .note = "L1MCU",
	 .name = "L1MCU_m_57"},
	{.master = MST_ID_MD_L1MCU_1,
	 .port = 0x3,
	 .id_mask = 0xF0F,
	 .id_val = 0x5,
	 .note = "L1MCU PREFETCH",
	 .name = "L1MCU_m_57"},
	{.master = MST_ID_MD_L1MCU_2,
	 .port = 0x3,
	 .id_mask = 0xF0F,
	 .id_val = 0x9,
	 .note = "L1MCU ALC",
	...
	{.master = MST_ID_MDHW_9,
	 ...
	 .note = "DFE_SHM",
	 .name = "MDHWMIX_DFE_m_57"},
	{.master = MST_ID_MDHW_10,
	 .port = 0x4,
	 .id_mask = 0xFFF,
	 .id_val = 0x380,
	 .note = "RXBRP_HRQ_WR",
	 .name = "MDHWMIX_RXBRP_m_57"},
	{.master = MST_ID_MDHW_11,
	 .port = 0x4,
	 .id_mask = 0xFFF,
	 .id_val = 0x384,
	 .note = "RXBRP_HRQ_WR1",
	 .name = "MDHWMIX_RXBRP_m_57"},
	{.master = MST_ID_MDHW_12,
	 .port = 0x4,
	 .id_mask = 0xFFF,
	 .id_val = 0x381,
	 .note = "RXBRP_HRQ_RD",
	 .name = "MDHWMIX_RXBRP_m_57"},
	{.master = MST_ID_MDHW_13,
	 .port = 0x4,
	 .id_mask = 0xFFF,
	 .id_val = 0x385,
	 .note = "RXBRP_HRQ_RD1",
	 .name = "MDHWMIX_RXBRP_m_57"},
	{.master = MST_ID_MDHW_14,
	 .port = 0x4,
	 .id_mask = 0xFFF,
	 .id_val = 0x382,
	 .note = "RXBRP_HRQ_DBG",
	 .name = "MDHWMIX_RXBRP_m_57"},
	{.master = MST_ID_MDHW_15,
	 .port = 0x4,
	 .id_mask = 0xFFF,
	 .id_val = 0x386,
	 .note = "RXBRP_HRQ_OTH",
	 .name = "MDHWMIX_RXBRP_m_57"},
	{.master = MST_ID_MDHW_16,
	 .port = 0x4,
	 .id_mask = 0xFC7,
	 .id_val = 0x300,
	 .note = "L1MCU",
	 .name = "MDHWMIX_L1MCU_m_57"},
	{.master = MST_ID_MDHW_17,
	 .port = 0x4,
	 .id_mask = 0xFFB,
	 .id_val = 0x301,
	 .note = "MDL1_GDMA",
	 .name = "MDHWMIX_MDL1_GDMA_m_57"},
	{.master = MST_ID_MDHW_18,
	 .port = 0x4,
	 .id_mask = 0xFFF,
	 .id_val = 0x302,
	 .note = "MDL1_ABM",
	 .name = "MDHWMIX_MDL1_ABM_m_57"},
	{.master = MST_ID_MDHW_19,
	 .port = 0x4,
	 .id_mask = 0xFFF,
	 .id_val = 0x400,
	 .note = "ARM7",
	 .name = "MDHWMIX_ARM7_m_57"},
	{.master = MST_ID_MDHW_20,
	 .port = 0x4,
	 .id_mask = 0xFFF,
	 .id_val = 0x500,
	 .note = "PS_PERI",
	 .name = "MDHWMIX_PS_PERI_m_57"},
	{.master = MST_ID_MDHW_21,
	 .port = 0x4,
	 .id_mask = 0xFFE,
	 .id_val = 0x600,
	 .note = "LTEL2DMA",
	 .name = "MDHWMIX_LTEL2DMA_m_57"},
	{.master = MST_ID_MDHW_22,
	 .port = 0x4,
	 .id_mask = 0xFFE,
	 .id_val = 0x700,
	 .note = "SOE_TRACE",
	...
	{.master = MST_ID_LTE_10,
	 .port = 0x4,
	 .id_mask = 0xFFF,
	 .id_val = 0x832,
	 .note = "ICC_CNWDMA",
	 .name = "MDHWLTE_ICC_CNWDMA_m_57"},
	{.master = MST_ID_LTE_11,
	 .port = 0x4,
	 .id_mask = 0xFFD,
	 .id_val = 0x840,
	 .note = "RXDMP",
	 .name = "MDHWLTE_RXDMP_m_57"},
	{.master = MST_ID_LTE_12,
	 .port = 0x4,
	 .id_mask = 0xFFF,
	 .id_val = 0x801,
	 .note = "cs id0",
	 .name = "MDHWLTE_CS_m_57"},
	{.master = MST_ID_LTE_13,
	 .port = 0x4,
	 .id_mask = 0xFFF,
	 .id_val = 0x803,
	 .note = "cs id1",
	...
	/* MM ch2 */
	{.master = MST_ID_MM_CH2_0,
	 .port = 0x5,
	 .id_mask = 0xF80,
	 .id_val = 0x0,
	 .note = "smi_larb0",
	 .name = "smi_larb0_m_57"},
	{.master = MST_ID_MM_CH2_1,
	 .port = 0x5,
	 .id_mask = 0xF80,
	 .id_val = 0x80,
	 .note = "smi_larb1",
	 .name = "smi_larb1_m_57"},
	{.master = MST_ID_MM_CH2_2,
	 .port = 0x5,
	 .id_mask = 0xF80,
	 .id_val = 0x100,
	 .note = "smi_larb2",
	 .name = "smi_larb2_m_57"},
	{.master = MST_ID_MM_CH2_3,
	 .port = 0x5,
	 .id_mask = 0xF80,
	 .id_val = 0x180,
	 .note = "smi_larb3",
	 .name = "smi_larb3_m_57"},
	{.master = MST_ID_MM_CH2_4,
	 .port = 0x5,
	 .id_mask = 0xF80,
	 .id_val = 0x200,
	 .note = "smi_larb4",
	 .name = "smi_larb4_m_57"},
	{.master = MST_ID_MM_CH2_5,
	 .port = 0x5,
	 .id_mask = 0xF80,
	 .id_val = 0x280,
	 .note = "smi_larb5",
	 .name = "smi_larb5_m_57"},
	{.master = MST_ID_MM_CH2_6,
	 .port = 0x5,
	 .id_mask = 0xFFF,
	 .id_val = 0x3FC,
	 .note = "MM IOMMU Internal Used",
	 .name = "MM_IOMMU_Internal_Used_m_57"},
	{.master = MST_ID_MM_CH2_7,
	 .port = 0x5,
	 .id_mask = 0xFFF,
	 .id_val = 0x3FD,
	 .note = "MM IOMMU Internal Used",
	...
	{.master = MST_ID_PERI_19,
	 ...
	 .note = "SPI2",
	 .name = "SPI_m_57"},
	{.master = MST_ID_PERI_20,
	 .port = 0x7,
	 .id_mask = 0xFFF,
	 .id_val = 0x1A5,
	 .note = "SPI3",
	 .name = "SPI_m_57"},
	{.master = MST_ID_PERI_21,
	 .port = 0x7,
	 .id_mask = 0xFFF,
	 .id_val = 0x2A5,
	 .note = "SPI4",
	 .name = "SPI_m_57"},
	{.master = MST_ID_PERI_22,
	 .port = 0x7,
	 .id_mask = 0xFFF,
	 .id_val = 0x3A5,
	 .note = "SPI5",
	 .name = "SPI_m_57"},
	{.master = MST_ID_PERI_23,
	 .port = 0x7,
	 .id_mask = 0xFDF,
	 .id_val = 0x9,
	 .note = "CONNSYS",
	 .name = "CONNSYS_m_57"},
	{.master = MST_ID_PERI_24,
	 .port = 0x7,
	 .id_mask = 0xFDF,
	 .id_val = 0xD,
	 .note = "GCPU_M",
	 .name = "GCPU_M_m_57"},
	{.master = MST_ID_PERI_25,
	 .port = 0x7,
	 .id_mask = 0xFDF,
	 .id_val = 0x11,
	 .note = "CLDMA",
	 .name = "CLDMA_AP_m_57"},
	{.master = MST_ID_PERI_26,
	 .port = 0x7,
	 .id_mask = 0xFF3,
	 .id_val = 0x3,
	 .note = "GCE_M",
...
char *smi_larb0_port[8] = {"LARB0_display_m_57", "LARB0_display_m_57",
			   "LARB0_display_m_57", "LARB0_display_m_57",
			   "LARB0_MDP_m_57",     "LARB0_MDP_m_57",
			   "LARB0_MDP_m_57",     "LARB0_display_m_57"};
char *smi_larb1_port[7] = {
	"LARB1_VDEC_m_57", "LARB1_VDEC_m_57", "LARB1_VDEC_m_57", "LARB1_VDEC_m_57",
...
char *smi_larb3_port[13] = {
	"LARB3_VENC_m_57", "LARB3_VENC_m_57", "LARB3_VENC_m_57", "LARB3_VENC_m_57",
	"LARB3_VENC_m_57", "LARB3_JPEG_m_57", "LARB3_JPEG_m_57", "LARB3_JPEG_m_57",
	"LARB3_JPEG_m_57", "LARB3_VENC_m_57", "LARB3_VENC_m_57", "LARB3_VENC_m_57",
	"LARB3_VENC_m_57"};
		...
		case 5: /* MASTER_MM_CH2 */
			...
			if (mm_larb == 0x0) { /* smi_larb0 */
				if (smi_port >= ARRAY_SIZE(smi_larb0_port)) {
					pr_debug("[EMI MPU ERROR] Invalidate "
						 "master ID! lookup smi table "
						 "failed!\n");
					return 0;
				}
			...
			break;
		default:
			pr_debug("[EMI MPU ERROR] Invalidate port ID! lookup "
				 "bus ID table failed!\n");
			break;
		}
		return 1;
...
static void __clear_emi_mpu_vio(unsigned int first)
{
	...
	for (i = 0; i < EMI_MPU_DOMAIN_NUMBER; i++) {
		mt_reg_sync_writel(0xFFFFFFFF,
				   EMI_MPUD_ST(i)); /* Region abort violation */
		mt_reg_sync_writel(
		    0x3, EMI_MPUD_ST2(i)); /* Out of region abort violation */
	}
...
static int mpu_check_violation(void)
{
	...
	vio_addr = (dbg_t + (((unsigned long long)(dbg_t_2nd & 0xF)) << 32) +
		    emi_physical_offset);
...
/* EMI violation is relative to MD at user build*/
		...
		if (((master_ID & 0x7) == MASTER_MDMCU) ||
			...
			sprintf(pstr, "EMI_MPUS = 0x%x, ADDR = 0x%llx", dbg_s,
				vio_addr);

			exec_ccci_kern_func_by_md_id(0, ID_MD_MPU_ASSERT, str,
						     strlen(str));
			pr_debug("[EMI MPU] MPU violation trigger MD str=%s "
				 "strlen(str)=%d\n",
				 str, (int)strlen(str));
		} else {
			exec_ccci_kern_func_by_md_id(0, ID_MD_MPU_ASSERT, NULL,
						     0);
		...
		if ((region == 0) && (mt_emi_reg_read(EMI_MPU_SA(0)) == 0) &&
			...
			aee_kernel_exception(
			    "EMI MPU", "%sEMI_MPUS = 0x%x,EMI_MPUT = "
				       "0x%x,EMI_MPUT_2ND = 0x%x,vio_addr = "
				       "0x%llx\n CHKER = 0x%x,CHKER_TYPE = "
				       "0x%x,CHKER_ADR = 0x%x\n%s%s\n",
			    "EMI MPU violation.\n", dbg_s, dbg_t, dbg_t_2nd,
			    vio_addr, readl(IOMEM(EMI_CHKER)),
...
int emi_mpu_set_region_protection(unsigned long long start,
				  unsigned long long end, int region,
...
static ssize_t emi_mpu_show(struct device_driver *driver, char *buf)
{
	...
	static const char *permission[7] = {
	    "No",       "S_RW",      "S_RW_NS_R", "S_RW_NS_W",
	    "S_R_NS_R", "FORBIDDEN", "S_R_NS_RW"};

	for (region = 0; region < EMI_MPU_REGION_NUMBER; region++) {
		start = (unsigned long long)(mt_emi_reg_read(EMI_MPU_SA(region))
					     << 16) +
			emi_physical_offset;
		end = (unsigned long long)(mt_emi_reg_read(EMI_MPU_EA(region))
					   << 16) +
		      emi_physical_offset;
...
#if EMI_MPU_TEST
	{
		...
		temp =
		    (*((volatile unsigned int *)(mpu_test_buffer + 0x10000)));
...
static ssize_t emi_mpu_store(struct device_driver *driver, const char *buf,
			     size_t count)
{
	int i;
	...
	if ((strlen(buf) + 1) > MAX_EMI_MPU_STORE_CMD_LEN) {
		pr_debug("%s command overflow.", __func__);
		return count;
	}
	pr_debug("%s: %s\n", __func__, buf);
	...
	if (!strncmp(buf, EN_MPU_STR, strlen(EN_MPU_STR))) {
		...
		ret =
		    kstrtoul(token[4], 16, (unsigned long *)&access_permission);
		if (ret != 0)
			pr_debug("kstrtoul fails to parse access_permission");
		emi_mpu_set_region_protection(start_addr, end_addr, region,
					      access_permission);
		pr_debug("Set EMI_MPU: start: 0x%x, end: 0x%x, region: %d, "
			 "permission: 0x%x.\n",
		...
		pr_debug("set EMI MPU: start: 0x%x, end: 0x%x, region: %d, "
			 "permission: 0x%x\n",
			 0, 0, region,
			 SET_ACCESS_PERMISSON(NO_PROTECTION, NO_PROTECTION,
					      NO_PROTECTION, NO_PROTECTION,
	...
	for (addr = 0xC0000000; addr < 0xFFF00000; addr += 0x100000) {
		...
		if ((pmd_val(*pmd) & PMD_TYPE_MASK) == PMD_TYPE_TABLE) {
			...
			for (; addr_2nd < (addr_2nd_end); addr_2nd += 0x1000) {
				...
				if (((unsigned long)v_addr & PAGE_MASK) ==
				    ((unsigned long)pte_val(*(pte)) &
				     PAGE_MASK)) {
					pr_debug("[EMI MPU] Find page entry "
						 "section at pte: %lx. "
						 "violation address = 0x%llx\n",
			...
			if (((unsigned long)pmd_val(*(pmd)) & SECTION_MASK) ==
				...
				pr_debug("[EMI MPU] Find page entry section at "
					 "pmd: %lx. violation address = "
					 "0x%llx\n",
...
/* TBD */
	...
	pr_debug("[EMI MPU] ****** Can not find page table entry! violation "
		 "address = 0x%llx ******\n",
		 v_addr);
}
...
static ssize_t pgt_scan_store(struct device_driver *driver, const char *buf,
			      size_t count)
{
	unsigned int value;
	unsigned int ret;
...
static void emi_axi_dump_info(int aee_ke_en)
{
	...
	if (value & 0x0000FFFF) {
		...
		pr_debug("Violation address is 0x%x.\n",
			 readl(IOMEM(EMI_CHKER_ADR)));
		pr_debug("Violation master ID is 0x%x.\n", master_ID);
		pr_debug("Violation type is: AXI_ADR_CHK_EN(%d), "
			 "AXI_LOCK_CHK_EN(%d), AXI_NON_ALIGN_CHK_EN(%d).\n",
...
static ssize_t emi_axi_vio_show(struct device_driver *driver, char *buf)
{
	...
	return snprintf(buf, PAGE_SIZE, "AXI vio setting is: ADR_CHK_EN %s, "
					"LOCK_CHK_EN %s, NON_ALIGN_CHK_EN %s\n",
			(value & (1 << AXI_ADR_CHK_EN)) ? "ON" : "OFF",
			(value & (1 << AXI_LOCK_CHK_EN)) ? "ON" : "OFF",
			(value & (1 << AXI_NON_ALIGN_CHK_EN)) ? "ON" : "OFF");
}

ssize_t emi_axi_vio_store(struct device_driver *driver, const char *buf,
			  size_t count)
{
	int value;
	int cpu = 0;
...
void emi_wp_get_status(void)
{
	...
	pr_debug("[EMI_WP] Violation Address is : 0x%llx\n",
		 (readl(IOMEM(EMI_CHKER_ADR)) +
		  (((unsigned long long)(readl(IOMEM(EMI_CHKER_ADR_2ND)) & 0xF))
		   << 32) +
		  emi_physical_offset));
	...
	pr_debug("[EMI_WP] Transaction Type is : %d beat, %d byte, %s burst "
		 "type (0x%X)\n",
		 (value & 0xF) + 1, 1 << ((value >> 4) & 0x7),
		 (value >> 7 & 1) ? "INCR" : "WRAP", value);

	emi_wp_clr_status();
}

static int emi_wp_set(unsigned int enable, unsigned int address,
		      unsigned int range, unsigned int rw)
{
	if (address < emi_physical_offset) {
		pr_debug("[EMI_WP] Address error, you can't set address less "
			 "than 0x%X\n",
			 emi_physical_offset);
		return -1;
	}
	if (range < 4 || range > 32) {
		pr_debug("[EMI_WP] Range error, you can't set range less than "
			 "16 bytes and more than 4G bytes\n");
		return -1;
	}
...
ssize_t emi_wp_vio_store(struct device_driver *driver, const char *buf,
			 size_t count)
{
	int i;
	...
	if (!strncmp(buf, EN_WP_STR, strlen(EN_WP_STR))) {
		...
		pr_debug("Set EMI_WP: address: 0x%x, range:%d, start addr: "
			 "0x%x, end addr: 0x%x,  rw: %d .\n",
...
static void protect_ap_region(void)
{
	...
	ap_mem_mpu_attr = SET_ACCESS_PERMISSON(
	    FORBIDDEN, SEC_R_NSEC_RW, FORBIDDEN, NO_PROTECTION, FORBIDDEN,
	...
	*((volatile unsigned int *)(mpu_test_buffer + 0x10000)) = 0xdeaddead;
	...
	if (INFRA_BASE_ADDR == NULL) {
		...
		if (node) {
			...
			pr_debug(
			    "can't find compatible node INFRA_BASE_ADDR\n");
			return -1;
		}
	}
	...
	if (INFRACFG_BASE_ADDR == NULL) {
		...
		if (node) {
			...
			pr_debug(
			    "can't find compatible node INFRACFG_BASE_ADDR\n");
			return -1;
		}
	}
...
#ifdef ENABLE_EMI_CHKER
	ret =
	    driver_create_file(&emi_mpu_ctrl.driver, &driver_attr_emi_axi_vio);
	...
	if (ret)
		pr_debug("Fail to create pgt scan sysfs file.\n");
...
unsigned int enable_4G(void) { return enable_4gb; }
...
static int __init dram_4gb_init(void)
{
	...
	if (node) {
		...
		pr_debug("INFRASYS_BASE_ADDR can't find compatible node\n");
		return -1;
	}
...
void dump_emi_latency(void)
{
	...
	mt_reg_sync_writel(readl(MEM_DCM_CTRL) & (~(1 << 7)),
			   MEM_DCM_CTRL); /* Disable EMI DCM */
	mt_reg_sync_writel(readl(MEM_DCM_CTRL) | (0x1f << 1), MEM_DCM_CTRL);
	mt_reg_sync_writel(readl(MEM_DCM_CTRL) | 0x1, MEM_DCM_CTRL);
	mt_reg_sync_writel(readl(MEM_DCM_CTRL) & (~0x1), MEM_DCM_CTRL);
	mt_reg_sync_writel(readl(MEM_DCM_CTRL) | (1 << 31),
			   MEM_DCM_CTRL); /* Disable EMI DCM */
	mt_reg_sync_writel(readl(MEM_DCM_CTRL) | (1 << 28),
			   MEM_DCM_CTRL); /* Disable DDRPHY DCM */

	mt_reg_sync_writel(readl(MISC_CG_PHY0_CTRL0) | (1 << 8),
			   MISC_CG_PHY0_CTRL0); /* Disable EMI DCM */
	mt_reg_sync_writel(readl(MISC_CG_PHY0_CTRL0) | (1 << 9),
			   MISC_CG_PHY0_CTRL0); /* Disable DDRPHY DCM */
	mt_reg_sync_writel(readl(MISC_CG_PHY0_CTRL2) | (1 << 31),
			   MISC_CG_PHY0_CTRL2); /* Disable EMI DCM */
	mt_reg_sync_writel(readl(MISC_CG_PHY0_CTRL2) | (1 << 28),
			   MISC_CG_PHY0_CTRL2); /* Disable DDRPHY DCM */
	...
	mt_reg_sync_writel(readl(CHN0_EMI_CONB) | 0xff000000,
			   CHN0_EMI_CONB); /* Disable chn0_emi dcm */
	mt_reg_sync_writel(readl(CHN1_EMI_CONB) | 0xff000000,
			   CHN1_EMI_CONB); /* Disable chn1_emi dcm */

	/* clear bus monitor */
	mt_reg_sync_writel(readl(EMI_CONM) | (1 << 30), EMI_CONM);
	mt_reg_sync_writel(readl(EMI_BMEN) & 0xfffffffc,
			   EMI_BMEN); /* clear bus monitor */

	/* Enable EMI bus monitor */
	pr_debug("Enable EMI bus monitor\n");
	mt_reg_sync_writel(0x00FF0000,
			   EMI_BMEN); /* Reset counter and set WSCT  for ALL */
	mt_reg_sync_writel(0x00240003,
			   EMI_MSEL); /* Set WSCT3 for MM, WSCT2 for APMCU */
	mt_reg_sync_writel(0x00000018, EMI_MSEL2); /* Set WSCT4 for MD */
	mt_reg_sync_writel(0x02000000, EMI_BMEN2); /* Enable latency monitor */
	mt_reg_sync_writel(0x55555555,
			   EMI_BMRW0); /* Set latency monitor for read */
	mt_reg_sync_writel(readl(EMI_BMEN) | 0x1,
			   EMI_BMEN); /* Enable bus monitor */
	...
	mt_reg_sync_writel(readl(EMI_BMEN) | 0x2,
			   EMI_BMEN); /* Pause bus monitor */
...
void dump_emi_MM(void)
{
	...
	mt_reg_sync_writel(0x00000360,
			   INFRA_TOP_DBG_CON2); /* 6'b0, wff_used[17:16] */
	mt_reg_sync_writel(
	    0x00000380,
	    INFRA_TOP_DBG_CON3); /* rdf_used[19:16], rff_used[19:16] */
	...
	mt_reg_sync_writel(0x00000018, EMI_MSEL2); /* Set WSCT4 for MD */
	mt_reg_sync_writel(0x02000000, EMI_BMEN2); /* Enable latency monitor */
	mt_reg_sync_writel(0xAAAAAAAA,
			   EMI_BMRW0); /* Set latency monitor for write */
	mt_reg_sync_writel(readl(EMI_BMEN) | 0x1,
			   EMI_BMEN); /* Enable bus monitor */
	...
	pr_debug(
	    "CHN0_EMI_DBGB = 0x%x (wff_ch0_req[7:0], 6'b0 ,wff_used[17:0])\n",
	    readl(CHN0_EMI_DBGB));
	...
	pr_debug("CHN0_EMI_DBGB = 0x%x (seq0_len_cnt, {4'b0, seq0_fifo_cnt}, "
		 "seq0_wid, seq0_rid)\n",
		 readl(CHN0_EMI_DBGB));
	...
	pr_debug("(chn_sbr_push, 1'b0, chn0_llat, chn0_hpri, chn0_rank, "
		 "chn0_wr, chn0_new_req, chn0_req, chn0_cdwf)\n");
	pr_debug("(2'b0, seq0_len_pop, seq0_rdy, seq0_rlast, seq0_64b_dle, "
		 "seq0_dle, seq0_wdle)\n");

	mt_reg_sync_writel(0x0a0009, CHN0_EMI_DBGC);
	mt_reg_sync_writel(0x0c000b, CHN0_EMI_DBGD);
	pr_debug("CHN0_EMI_DBGB = 0x%x (seq0_bank_mask[15:0], "
		 "seq0_wdata_cnt[7:0], seq0_rdata_cnt[7:0])\n",
		 readl(CHN0_EMI_DBGB));
	...
	pr_debug(
	    "CHN1_EMI_DBGB = 0x%x (wff_ch0_req[7:0], 6'b0 ,wff_used[17:0])\n",
	    readl(CHN1_EMI_DBGB));
	...
	pr_debug("CHN1_EMI_DBGB = 0x%x (seq0_len_cnt, {4'b0, seq0_fifo_cnt}, "
		 "seq0_wid, seq0_rid)\n",
		 readl(CHN1_EMI_DBGB));
	...
	pr_debug("CHN1_EMI_DBGB = 0x%x (seq0_bank_mask[15:0], "
		 "seq0_wdata_cnt[7:0], seq0_rdata_cnt[7:0])\n",
		 readl(CHN1_EMI_DBGB));
}
