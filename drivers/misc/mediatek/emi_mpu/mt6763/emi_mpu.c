...
static const struct mst_tbl_entry mst_tbl[] = {
	...
	{.master = M4_HRQ_RD, .port = 0x4, .id_mask = 0x1FFF,
		...
		.note = "MT63_M4_HRQ_RD",
		.name = "MT63_M4_HRQ_RD"},
	{.master = M4_RXBRP, .port = 0x4, .id_mask = 0x0C00,
		.id_val = 0x0800,
		.note = "MT63_M4_RXBRP",
		.name = "MT63_M4_RXBRP"},
	{.master = M4_BIGRAM, .port = 0x4, .id_mask = 0x0C00,
		.id_val = 0x0400,
		.note = "MT63_M4_BIGRAM",
		.name = "MT63_M4_BIGRAM"},
	{.master = M4_MD2G, .port = 0x4, .id_mask = 0x1FFF,
		...
		.note = "MT63_M4_MD2G",
		.name = "MT63_M4_MD2G"},
	{.master = M4_TXBRP, .port = 0x4, .id_mask = 0x1F7F,
		.id_val = 0x0028,
		.note = "MT63_M4_TXBRP",
		.name = "MT63_M4_TXBRP"},
	{.master = M4_TXDFE, .port = 0x4, .id_mask = 0x1F7F,
		.id_val = 0x0068,
		.note = "MT63_M4_TXDFE",
		.name = "MT63_M4_TXDFE"},
	{.master = M4_RXDFESYS, .port = 0x4, .id_mask = 0x1F38,
		.id_val = 0x0038,
		.note = "MT63_M4_RXDFESYS",
		.name = "MT63_M4_RXDFESYS"},
	{.master = M4_CS, .port = 0x4, .id_mask = 0x1F38,
		.id_val = 0x0018,
		.note = "MT63_M4_CS",
		.name = "MT63_M4_CS"},
	{.master = M4_MML2, .port = 0x4, .id_mask = 0x0C00,
		.id_val = 0x0C00,
		.note = "MT63_M4_MML2",
		.name = "MT63_M4_MML2"},
	{.master = M4_MDPERI, .port = 0x4, .id_mask = 0x1F1F,
		.id_val = 0x0007,
		.note = "MT63_M4_MDPERI",
		.name = "MT63_M4_MDPERI"},
	{.master = M4_MDINFRA, .port = 0x4, .id_mask = 0x1FE0,
		.id_val = 0x0000,
		.note = "MT63_M4_MDINFRA",
		.name = "MT63_M4_MDINFRA"},
	...
	{.master = M7_AHB_MST_PWR_MD32, .port = 0x7, .id_mask = 0x1FFF,
		.id_val = 0x0126,
		.note = "MT63_M7_AHB_MST_PWR_MD32",
		.name = "MT63_M7_AHB_MST_PWR_MD32"},
