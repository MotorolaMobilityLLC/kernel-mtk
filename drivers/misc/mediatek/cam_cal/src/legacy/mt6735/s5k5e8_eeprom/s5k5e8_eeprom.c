...
OTP_DATA s5k5e8_eeprom_data = {{0}};
//u8 af_inf_data=0;

extern kal_uint16 R_gain,B_gain; 
extern kal_uint8  vendor_id;
#define CAL_VERSION_MAGIC ""
int read_s5k5e8_eeprom_mtk_fmt(void)
{
#if 1
	//int i = 0;
	int offset = 0;
	...
	spin_unlock(&g_CAM_CALLock);
	offset = 0;
	s5k5e8_eeprom_data.Data[2] = vendor_id;
	s5k5e8_eeprom_data.Data[3] = R_gain & 0xFF; 
	s5k5e8_eeprom_data.Data[4] = R_gain >> 8;
	s5k5e8_eeprom_data.Data[5] = B_gain & 0xFF;
	s5k5e8_eeprom_data.Data[6] = B_gain >> 8;
	s5k5e8_eeprom_data.Data[7] = 0x6f;
	s5k5e8_eeprom_data.Data[8] = 0x02;
	s5k5e8_eeprom_data.Data[9] = 0x46;
	s5k5e8_eeprom_data.Data[10] = 0x02;
	CAM_CALINF("wangkangmin s5k5e8 vendor_id =%x\n",vendor_id);
	CAM_CALINF("wangkangmin s5k5e8 R_gain_h =%x,R_gain_l=%x\n",s5k5e8_eeprom_data.Data[4],s5k5e8_eeprom_data.Data[3]);
	CAM_CALINF("wangkangmin s5k5e8 B_gain_h =%x,B_gain_l=%x\n",s5k5e8_eeprom_data.Data[6],s5k5e8_eeprom_data.Data[5]);
...
{
    memcpy((void *)data,(void *)&s5k5e8_eeprom_data.Data[offset],size);
...
#endif
{
    ...
    switch(a_u4Command)
    {
        ...
        case CAM_CALIOC_G_READ:
            ...
            i4RetValue = selective_read_region(ptempbuf->u4Offset, pu1Params, S5K5E8_EEPROM_DEVICE_ID,ptempbuf->u4Length);
