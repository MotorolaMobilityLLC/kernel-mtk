...
typedef struct {
    ...
    UINT32 StartAddr;
    UINT32 BlockSize;
    void (*doCalDataCheck)(u8 *pCamCaldata, UINT32 start_addr, UINT32 BlockSize, RetStatus *rStatus);
...
static void mot_check_mnf_data(u8 *data, UINT32 StartAddr, UINT32 BlockSize, RetStatus *rStatus);
static void mot_check_af_data(u8 *data, UINT32 StartAddr, UINT32 BlockSize, RetStatus *rStatus);
static void mot_check_awb_data(u8 *data, UINT32 StartAddr, UINT32 BlockSize, RetStatus *rStatus);
static void mot_check_lsc_data(u8 *data, UINT32 StartAddr, UINT32 BlockSize, RetStatus *rStatus);
static void mot_check_pdaf_data(u8 *data, UINT32 StartAddr, UINT32 BlockSize, RetStatus *rStatus);
#endif
