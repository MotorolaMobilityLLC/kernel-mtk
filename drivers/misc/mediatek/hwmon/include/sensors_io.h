...
#define ALSPS							0X84
#define ALSPS_SET_PS_MODE				_IOW(ALSPS, 0x01, struct ALSPS_IO_DATA)
#define ALSPS_GET_PS_MODE				_IOR(ALSPS, 0x02, struct ALSPS_IO_DATA)
#define ALSPS_GET_PS_DATA				_IOR(ALSPS, 0x03, struct ALSPS_IO_DATA)
#define ALSPS_GET_PS_RAW_DATA			_IOR(ALSPS, 0x04, struct ALSPS_IO_DATA)
#define ALSPS_SET_ALS_MODE				_IOW(ALSPS, 0x05, struct ALSPS_IO_DATA)
#define ALSPS_GET_ALS_MODE				_IOR(ALSPS, 0x06, struct ALSPS_IO_DATA)
#define ALSPS_GET_ALS_DATA				_IOR(ALSPS, 0x07, struct ALSPS_IO_DATA)
#define ALSPS_GET_ALS_RAW_DATA			_IOR(ALSPS, 0x08, struct ALSPS_IO_DATA)

/*-------------------MTK add-------------------------------------------*/
#define ALSPS_GET_PS_TEST_RESULT		_IOR(ALSPS, 0x09, struct ALSPS_IO_DATA)
#define ALSPS_GET_ALS_TEST_RESULT		_IOR(ALSPS, 0x0A, struct ALSPS_IO_DATA)
#define ALSPS_GET_PS_THRESHOLD_HIGH		_IOR(ALSPS, 0x0B, struct ALSPS_IO_DATA)
#define ALSPS_GET_PS_THRESHOLD_LOW		_IOR(ALSPS, 0x0C, struct ALSPS_IO_DATA)
#define ALSPS_GET_ALS_THRESHOLD_HIGH	_IOR(ALSPS, 0x0D, struct ALSPS_IO_DATA)
#define ALSPS_GET_ALS_THRESHOLD_LOW		_IOR(ALSPS, 0x0E, struct ALSPS_IO_DATA)
#define ALSPS_IOCTL_CLR_CALI			_IOW(ALSPS, 0x0F, struct ALSPS_IO_DATA)
#define ALSPS_IOCTL_GET_CALI			_IOR(ALSPS, 0x10, struct ALSPS_IO_DATA)
#define ALSPS_IOCTL_SET_CALI			_IOW(ALSPS, 0x11, struct ALSPS_IO_DATA)
#define ALSPS_SET_PS_THRESHOLD			_IOW(ALSPS, 0x12, struct ALSPS_IO_DATA)
#define ALSPS_SET_ALS_THRESHOLD			_IOW(ALSPS, 0x13, struct ALSPS_IO_DATA)
#define AAL_SET_ALS_MODE				_IOW(ALSPS, 0x14, struct ALSPS_IO_DATA)
#define AAL_GET_ALS_MODE				_IOR(ALSPS, 0x15, struct ALSPS_IO_DATA)
#define AAL_GET_ALS_DATA				_IOR(ALSPS, 0x16, struct ALSPS_IO_DATA)
#define AAL_GET_ALS_INFO				_IOR(ALSPS, 0x17, struct ALSPS_IO_DATA)
#ifdef CONFIG_COMPAT
#define COMPAT_ALSPS_SET_PS_MODE		_IOW(ALSPS, 0x01, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_GET_PS_MODE		_IOR(ALSPS, 0x02, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_GET_PS_DATA		_IOR(ALSPS, 0x03, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_GET_PS_RAW_DATA	_IOR(ALSPS, 0x04, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_SET_ALS_MODE		_IOW(ALSPS, 0x05, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_GET_ALS_MODE		_IOR(ALSPS, 0x06, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_GET_ALS_DATA		_IOR(ALSPS, 0x07, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_GET_ALS_RAW_DATA	_IOR(ALSPS, 0x08, struct ALSPS_IO_DATA)

/*-------------------MTK add-------------------------------------------*/
#define COMPAT_ALSPS_GET_PS_TEST_RESULT		_IOR(ALSPS, 0x09, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_GET_ALS_TEST_RESULT	_IOR(ALSPS, 0x0A, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_GET_PS_THRESHOLD_HIGH	_IOR(ALSPS, 0x0B, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_GET_PS_THRESHOLD_LOW	_IOR(ALSPS, 0x0C, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_GET_ALS_THRESHOLD_HIGH	_IOR(ALSPS, 0x0D, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_GET_ALS_THRESHOLD_LOW	_IOR(ALSPS, 0x0E, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_IOCTL_CLR_CALI			_IOW(ALSPS, 0x0F, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_IOCTL_GET_CALI			_IOR(ALSPS, 0x10, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_IOCTL_SET_CALI			_IOW(ALSPS, 0x11, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_SET_PS_THRESHOLD		_IOW(ALSPS, 0x12, struct ALSPS_IO_DATA)
#define COMPAT_ALSPS_SET_ALS_THRESHOLD		_IOW(ALSPS, 0x13, struct ALSPS_IO_DATA)
#define COMPAT_AAL_SET_ALS_MODE				_IOW(ALSPS, 0x14, struct ALSPS_IO_DATA)
#define COMPAT_AAL_GET_ALS_MODE				_IOR(ALSPS, 0x15, struct ALSPS_IO_DATA)
#define COMPAT_AAL_GET_ALS_DATA				_IOR(ALSPS, 0x16, struct ALSPS_IO_DATA)
#define COMPAT_AAL_GET_ALS_INFO				_IOR(ALSPS, 0x17, struct ALSPS_IO_DATA)
#endif
