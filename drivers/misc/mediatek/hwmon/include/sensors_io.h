...
#define COMPAT_GSENSOR_IOCTL_READ_RAW_DATA     _IOR(GSENSOR, 0x06, s32)
#define COMPAT_GSENSOR_IOCTL_READ_SENSORDATA   _IOR(GSENSOR, 0x03, s32)
...
#define GSENSOR_SET_ACC_MODE				_IOW(GSENSOR, 0x14, int)
#define GSENSOR_IOCTL_SET_CALI_NEW			_IOW(GSENSOR, 0x15, HWMON_GS_STRUCT)
#define COMPAT_GSENSOR_SET_ACC_MODE			_IOW(GSENSOR, 0x14, s32)
#define COMPAT_GSENSOR_IOCTL_SET_CALI_NEW		_IOW(GSENSOR, 0x15, HWMON_GS_STRUCT)
...
#define ALSPS_SET_PS_CALI           		_IOW(ALSPS, 0x19, HWMON_PS_STRUCT)
#define ALSPS_GET_PS_RAW_DATA_FOR_CALI		_IOR(ALSPS, 0x20, HWMON_PS_STRUCT)
