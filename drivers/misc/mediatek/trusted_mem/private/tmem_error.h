...
enum TMEM_ERROR_STATUS {
	...
	TMEM_GZ_CREATE_SESSION_DATA_FAILED = -1000,
	TMEM_GZ_CREATE_SESSION_FAILED = -1001,
	TMEM_GZ_CLOSE_SESSION_FAILED = -1002,
	TMEM_GZ_APPEND_MEMORY_FAILED = -1003,
	TMEM_GZ_RELEASE_MEMORY_FAILED = -1004,
	TMEM_GZ_ALLOC_CHUNK_FAILED = -1005,
	TMEM_GZ_FREE_CHUNK_FAILED = -1006,
	TMEM_GZ_NOTIFY_MEM_ADD_CFG_TO_TEE_FAILED = -1007,
	TMEM_GZ_NOTIFY_MEM_REMOVE_CFG_TO_TEE_FAILED = -1008,
	TMEM_MOCK_APPEND_MEMORY_FAILED = -1009,
	TMEM_MOCK_RELEASE_MEMORY_FAILED = -1010,
	TMEM_MOCK_NOTIFY_MEM_ADD_CFG_TO_TEE_FAILED = -1011,
	TMEM_MOCK_NOTIFY_MEM_REMOVE_CFG_TO_TEE_FAILED = -1012,
