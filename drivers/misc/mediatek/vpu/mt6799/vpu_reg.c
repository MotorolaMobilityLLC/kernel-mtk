...
#define INS_FIELD(reg, field, msb, lsb) \
	...
	INS_FIELD(EVENT_TRIG, GCE_EVENT3, 3, 3),
	INS_FIELD(EVENT_TRIG, GCE_EVENT2, 2, 2),
	INS_FIELD(EVENT_TRIG, GCE_EVENT1, 1, 1),
	...
	INS_FIELD(CTRL, SPNIDEN, 29, 29),
	INS_FIELD(CTRL, SPIDEN, 28, 28),
	INS_FIELD(CTRL, PARB_CLK_EN, 27, 27),
	INS_FIELD(CTRL, PBCLK_EN, 26, 26),
	INS_FIELD(CTRL, NIDEN, 25, 25),
	INS_FIELD(CTRL, DBG_EN, 24, 24),
	...
	INS_FIELD(AXI_DEFAULT1, AR_DOMAIN_CORE, 30, 28),
	INS_FIELD(AXI_DEFAULT1, AR_FLUSH_CORE, 27, 24),
	INS_FIELD(AXI_DEFAULT1, AW_DOMAIN_CORE, 22, 20),
	INS_FIELD(AXI_DEFAULT1, AW_FLUSH_CORE, 19, 16),
	INS_FIELD(AXI_DEFAULT1, AR_DOMAIN_IDMA, 14, 12),
	INS_FIELD(AXI_DEFAULT1, AR_FLUSH_IDMA, 11, 8),
	INS_FIELD(AXI_DEFAULT1, AW_DOMAIN_IDMA, 6, 4),
	...
	INS_FIELD(AXI_DEFAULT3, AR_DOMAIN_APB, 14, 12),
	INS_FIELD(AXI_DEFAULT3, AR_FLUSH_APB, 11, 8),
	INS_FIELD(AXI_DEFAULT3, AW_DOMAIN_APB, 6, 4),
	INS_FIELD(AXI_DEFAULT3, AW_FLUSH_APB, 3, 0),
	...
	INS_FIELD(DEBUG_INFO01, IPU_DBG_INFO01, 31, 0),
	...
	INS_FIELD(DEBUG_INFO06, IPU_DBG_INFO06, 31, 0),
