...
static struct ccci_clk_node clk_table[] = {
	{NULL, "scp-sys-md1-main"}, {NULL, "infra-cldma-bclk"},
	{NULL, "infra-ccif-ap"},    {NULL, "infra-ccif-md"},
	{NULL, "infra-ccif1-ap"},   {NULL, "infra-ccif1-md"},
};
...
void md_cldma_hw_reset(unsigned char md_id)
{
	...
	reg_value &=
	    ~(CLDMA_AO_RST_MASK); /* read no use, maybe a time delay */
			    ...
			    struct md_hw_info *hw_info)
{
	...
	of_property_read_u32(dev_ptr->dev.of_node, "mediatek,md_id",
			     &dev_cfg->index);
	...
	if (hw_info->ap_ccif_base == 0 || hw_info->md_ccif_base == 0) {
		CCCI_ERROR_LOG(dev_cfg->index, TAG,
	...
	if (cldma_hw->cldma_irq_id == 0 || hw_info->ap_ccif_irq0_id == 0 ||
	    hw_info->ap_ccif_irq1_id == 0 || hw_info->md_wdt_irq_id == 0) {
		CCCI_ERROR_LOG(
		    dev_cfg->index, TAG,
	...
	CCCI_DEBUG_LOG(
	    dev_cfg->index, TAG, "dev_major:%d,minor_base:%d,capability:%d\n",
	...
	CCCI_DEBUG_LOG(
	    dev_cfg->index, TAG, "ap_ccif_base:0x%p, md_ccif_base:0x%p\n",
...
int md_cd_io_remap_md_side_register(struct ccci_modem *md)
{
	...
	/*just for dump begin*/
	md_reg->md_peri_misc =
	    ioremap_nocache(MD_PERI_MISC_BASE, MD_PERI_MISC_LEN);
	md_reg->md_L1_a0 = ioremap_nocache(MDL1A0_BASE, MDL1A0_LEN);

	md_reg->md_sys_clk =
	    ioremap_nocache(MDSYS_CLKCTL_BASE, MDSYS_CLKCTL_LEN);
	md_reg->md_dbg_sys = ioremap_nocache(MD1_OPEN_DEBUG_APB_CLK, 0x1000);
	md_reg->md_pc_mon1 =
	    ioremap_nocache(MD1_PC_MONITOR_BASE0, MD1_PC_MONITOR_LEN0);
	md_info->md_pc_monitor = md_reg->md_pc_mon1;
	md_reg->md_pc_mon2 =
	    ioremap_nocache(MD1_PC_MONITOR_BASE1, MD1_PC_MONITOR_LEN1);
	...
	md_reg->md_pll_mixed_0 =
	    ioremap_nocache(MD1_PLLMIXED_BASE0, MD1_PLLMIXED_LEN0);
	md_reg->md_pll_mixed_1 =
	    ioremap_nocache(MD1_PLLMIXED_BASE1, MD1_PLLMIXED_LEN1);
	md_reg->md_pll_mixed_2 =
	    ioremap_nocache(MD1_PLLMIXED_BASE2, MD1_PLLMIXED_LEN1);
	md_reg->md_pll_mixed_3 =
	    ioremap_nocache(MD1_PLLMIXED_BASE3, MD1_PLLMIXED_LEN3);
	md_reg->md_pll_mixed_4 =
	    ioremap_nocache(MD1_PLLMIXED_BASE4, MD1_PLLMIXED_LEN4);
	md_reg->md_pll_mixed_5 =
	    ioremap_nocache(MD1_PLLMIXED_BASE5, MD1_PLLMIXED_LEN5);
	md_reg->md_pll_mixed_6 =
	    ioremap_nocache(MD1_PLLMIXED_BASE6, MD1_PLLMIXED_LEN6);
	md_reg->md_pll_mixed_7 =
	    ioremap_nocache(MD1_PLLMIXED_BASE7, MD1_PLLMIXED_LEN7);
	md_reg->md_pll_mixed_8 =
	    ioremap_nocache(MD1_PLLMIXED_BASE8, MD1_PLLMIXED_LEN8);
	md_reg->md_pll_mixed_9 =
	    ioremap_nocache(MD1_PLLMIXED_BASE9, MD1_PLLMIXED_LEN9);
	md_reg->md_clk_ctl_0 =
	    ioremap_nocache(MD1_CLKCTL_BASE0, MD1_CLKCTL_LEN0);
	md_reg->md_clk_ctl_1 =
	    ioremap_nocache(MD1_CLKCTL_BASE1, MD1_CLKCTL_LEN1);
	md_reg->md_global_con_0 =
	    ioremap_nocache(MD1_GLOBALCON_BASE0, MD1_GLOBALCON_LEN0);
	md_reg->md_global_con_1 =
	    ioremap_nocache(MD1_GLOBALCON_BASE1, MD1_GLOBALCON_LEN1);
	md_reg->md_global_con_2 =
	    ioremap_nocache(MD1_GLOBALCON_BASE2, MD1_GLOBALCON_LEN2);
	md_reg->md_global_con_3 =
	    ioremap_nocache(MD1_GLOBALCON_BASE3, MD1_GLOBALCON_LEN3);
	md_reg->md_global_con_4 =
	    ioremap_nocache(MD1_GLOBALCON_BASE4, MD1_GLOBALCON_LEN4);
	md_reg->md_global_con_5 =
	    ioremap_nocache(MD1_GLOBALCON_BASE5, MD1_GLOBALCON_LEN5);
	md_reg->md_bus_reg_0 =
	    ioremap_nocache(MD1_BUS_REG_BASE0, MD1_BUS_REG_LEN0);
	md_reg->md_bus_reg_1 =
	    ioremap_nocache(MD1_BUS_REG_BASE1, MD1_BUS_REG_LEN1);
	md_reg->md_bus_reg_2 =
	    ioremap_nocache(MD1_BUS_REG_BASE2, MD1_BUS_REG_LEN2);
	md_reg->md_bus_reg_3 =
	    ioremap_nocache(MD1_BUS_REG_BASE3, MD1_BUS_REG_LEN3);
	md_reg->md_bus_rec_0 =
	    ioremap_nocache(MD1_MCU_MO_BUSREC_BASE0, MD1_MCU_MO_BUSREC_LEN0);
	md_reg->md_bus_rec_1 =
	    ioremap_nocache(MD1_INFRA_BUSREC_BASE0, MD1_INFRA_BUSREC_LEN0);
	md_reg->md_bus_rec_2 =
	    ioremap_nocache(MD1_BUSREC_LAY_BASE0, MD1_BUSREC_LAY_LEN0);
	md_reg->md_ect_0 =
	    ioremap_nocache(MD1_ECT_REG_BASE0, MD1_ECT_REG_LEN0);
	md_reg->md_ect_1 =
	    ioremap_nocache(MD1_ECT_REG_BASE1, MD1_ECT_REG_LEN1);
	md_reg->md_ect_2 =
	    ioremap_nocache(MD1_ECT_REG_BASE2, MD1_ECT_REG_LEN2);
	md_reg->md_ect_3 =
	    ioremap_nocache(MD1_ECT_REG_BASE3, MD1_ECT_REG_LEN3);
	md_reg->md_topsm_reg =
	    ioremap_nocache(MD1_TOPSM_REG_BASE0, MD1_TOPSM_REG_LEN0);
	md_reg->md_rgu_reg_0 =
	    ioremap_nocache(MD1_RGU_REG_BASE0, MD1_RGU_REG_LEN0);
	md_reg->md_rgu_reg_1 =
	    ioremap_nocache(MD1_RGU_REG_BASE1, MD1_RGU_REG_LEN1);
	md_info->md_ost_status =
	    ioremap_nocache(MD_OST_STATUS_BASE, MD_OST_STATUS_LENGTH);
	md_reg->md_ost_status = md_info->md_ost_status;

	md_reg->md_csc_reg =
	    ioremap_nocache(MD_CSC_REG_BASE, MD_CSC_REG_LENGTH);
	md_reg->md_elm_reg =
	    ioremap_nocache(MD_ELM_REG_BASE, MD_ELM_REG_LENGTH);
	...
	md_sram_pd_psmcusys_base = ioremap_nocache(
	    MD_SRAM_PD_PSMCUSYS_SRAM_BASE, MD_SRAM_PD_PSMCUSYS_SRAM_LEN);
...
void md_cd_lock_cldma_clock_src(int locked) { /* spm_ap_mdsrc_req(locked); */}

void md_cd_lock_modem_clock_src(int locked) { spm_ap_mdsrc_req(locked); }
...
void md_cd_dump_md_bootup_status(struct ccci_modem *md)
{
	...
	/*To avoid AP/MD interface delay, dump 3 times, and buy-in the 3rd dump
	 * value.
	 */
...
void md_cd_dump_debug_register(struct ccci_modem *md)
{
	...
	if (per_md_data->md_dbg_dump_flag & (1 << MD_DBG_DUMP_PCMON)) {
		...
		/* Stop all PCMon */
		ccci_write32(md_reg->md_pc_mon1, MD1_PCMNO_CTRL_OFFSET,
			     MD1_PCMON_CTRL_STOP_ALL); /* stop MD PCMon */
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_pc_mon1, 0x100);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_pc_mon1 + 0x100, 0x60);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   (md_reg->md_pc_mon1 + 0x200), 0x60);

		/* core0 */
		CCCI_MEM_LOG_TAG(md->index, TAG, "core0/1: [0]0x%X, [1]0x%X\n",
				 MD1_PC_MONITOR_BASE1,
				 MD1_PC_MONITOR_BASE1 + 0x400);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_pc_mon2, 0x400);
		/* core1 */
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   (md_reg->md_pc_mon2 + 0x400), 0x400);

		/* Resume PCMon */
		ccci_write32(md_reg->md_pc_mon1, MD1_PCMNO_CTRL_OFFSET,
			     MD1_PCMON_RESTART_ALL_VAL);
	...
	if (per_md_data->md_dbg_dump_flag & (1 << MD_DBG_DUMP_PLL)) {
		...
		/* MD CLKSW */
		CCCI_MEM_LOG_TAG(md->index, TAG,
				 "CLKSW: [0]0x%X, [1]0x%X, [2]0x%X, [3]0x%X\n",
				 MD1_CLKSW_BASE0, MD1_CLKSW_BASE1,
				 MD1_CLKSW_BASE2, MD1_CLKSW_BASE3);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_clkSW, MD1_CLKSW_LEN0);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_clkSw1, MD1_CLKSW_LEN1);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_clkSw3, MD1_CLKSW_LEN3);
		/* MD PLLMIXED */
		CCCI_MEM_LOG_TAG(md->index, TAG,
				"PLLMIXED:[0]0x%X,[1]0x%X,[2]0x%X,[3]0x%X,[4]0x%X,[5]0x%X,[6]0x%X,[7]0x%X,[8]0x%X,[9]0x%X\n",
				 MD1_PLLMIXED_BASE0, MD1_PLLMIXED_BASE1,
				 MD1_PLLMIXED_BASE2, MD1_PLLMIXED_BASE3,
				 MD1_PLLMIXED_BASE4, MD1_PLLMIXED_BASE5,
				 MD1_PLLMIXED_BASE6, MD1_PLLMIXED_BASE7,
				 MD1_PLLMIXED_BASE8, MD1_PLLMIXED_BASE9);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_pll_mixed_0, MD1_PLLMIXED_LEN0);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_pll_mixed_1, MD1_PLLMIXED_LEN1);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_pll_mixed_2, MD1_PLLMIXED_LEN2);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_pll_mixed_3, MD1_PLLMIXED_LEN3);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_pll_mixed_4, MD1_PLLMIXED_LEN4);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_pll_mixed_5, MD1_PLLMIXED_LEN5);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_pll_mixed_6, MD1_PLLMIXED_LEN6);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_pll_mixed_7, MD1_PLLMIXED_LEN7);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_pll_mixed_8, MD1_PLLMIXED_LEN8);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_pll_mixed_9, MD1_PLLMIXED_LEN9);

		/* MD CLKCTL */
		CCCI_MEM_LOG_TAG(md->index, TAG, "CLKCTL: [0]0x%X, [1]0x%X\n",
				 MD1_CLKCTL_BASE0, MD1_CLKCTL_BASE1);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_clk_ctl_0, MD1_CLKCTL_LEN0);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_clk_ctl_1, MD1_CLKCTL_LEN1);

		/* MD GLOBAL CON */
		CCCI_MEM_LOG_TAG(md->index, TAG,
			"GLOBAL CON: [0]0x%X, [1]0x%X, [2]0x%X, [3]0x%X, [4]0x%X, [5]0x%X, [6]0x%X, [7]0x%X, [8]0x%X\n",
		    MD1_GLOBALCON_BASE0, MD1_GLOBALCON_BASE1,
		    MD1_GLOBALCON_BASE2, MD1_GLOBALCON_BASE3,
		    MD1_GLOBALCON_BASE4, MD1_GLOBALCON_BASE5,
		    MD1_GLOBALCON_BASE5 + 0x300, MD1_GLOBALCON_BASE5 + 0x400,
		    MD1_GLOBALCON_BASE5 + 0x600);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_global_con_0,
				   MD1_GLOBALCON_LEN0);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
		...
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   ...
				   MD1_GLOBALCON_LEN4);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_global_con_5, 0x8);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_global_con_5 + 0x300, 0x1C);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_global_con_5 + 0x400, 4);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_global_con_5 + 0x600, 8);
	}
	/* 3. Bus status */
	if (per_md_data->md_dbg_dump_flag & (1 << MD_DBG_DUMP_BUS)) {
		CCCI_MEM_LOG_TAG(
		    ...
		    MD1_BUS_REG_BASE3);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_reg_0, MD1_BUS_REG_LEN0);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_reg_1, MD1_BUS_REG_LEN1);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_reg_2, MD1_BUS_REG_LEN2);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_reg_3, MD1_BUS_REG_LEN3);
	}
	...
	if (per_md_data->md_dbg_dump_flag & (1 << MD_DBG_DUMP_BUSREC)) {
		CCCI_MEM_LOG_TAG(
		    ...
		    MD1_MCU_MO_BUSREC_BASE0, MD1_INFRA_BUSREC_BASE0,
		    MD1_BUSREC_LAY_BASE0);
		ccci_write32(
		    md_reg->md_bus_rec_0, 0x10,
		    MD1_MCU_MO_BUSREC_STOP_VAL); /* pre-action: stop busrec */
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_rec_0 + 0x0, 0x104);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_rec_0 + 0x200, 0x18);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_rec_0 + 0x300, 0x30);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_rec_0 + 0x400, 0x18);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_rec_0 + 0x500, 0x30);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_rec_0 + 0x700, 0x51C);
		ccci_write32(
		    md_reg->md_bus_rec_0, 0x10,
		    MD1_MCU_MO_BUSREC_RESTART_VAL); /* restart busrec */
		ccci_write32(
		    md_reg->md_bus_rec_1, 0x10,
		    MD1_INFRA_BUSREC_STOP_VAL); /* pre-action: stop busrec */
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_rec_1 + 0x0, 0x104);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_rec_1 + 0x200, 0x18);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_rec_1 + 0x300, 0x30);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_rec_1 + 0x400, 0x18);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_rec_1 + 0x500, 0x30);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_rec_1 + 0x700, 0x51C);
		 /* post-action:restart busrec */
		ccci_write32(md_reg->md_bus_rec_1,
			0x10, MD1_INFRA_BUSREC_RESTART_VAL);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_bus_rec_2, MD1_BUSREC_LAY_LEN0);
	}
	/* 5. ECT */
	if (per_md_data->md_dbg_dump_flag & (1 << MD_DBG_DUMP_ECT)) {
		CCCI_MEM_LOG_TAG(
		    ...
		    MD1_ECT_REG_BASE0, MD1_ECT_REG_BASE1, MD1_ECT_REG_BASE2,
		    MD1_ECT_REG_BASE3);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_ect_0, MD1_ECT_REG_LEN0);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_ect_1, MD1_ECT_REG_LEN1);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_ect_2, MD1_ECT_REG_LEN2);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_ect_3, MD1_ECT_REG_LEN3);
	}
	...
	if (per_md_data->md_dbg_dump_flag &
		...
		CCCI_MEM_LOG_TAG(
		    md->index, TAG, "ap2md dummy reg 0x%X: 0x%X\n",
		...
		while ((cldma_read32(infra_ao_base, INFRA_MD2PERI_PROT_RDY) &
			...
			;
		CCCI_MEM_LOG_TAG(
		    md->index, TAG, "md2peri: en[0x%X], rdy[0x%X]\n",
		...
		while ((cldma_read32(infra_ao_base, INFRA_PERI2MD_PROT_RDY) &
			...
			;
		CCCI_MEM_LOG_TAG(
		    md->index, TAG, "peri2md: en[0x%X], rdy[0x%X]\n",
	...
	if (per_md_data->md_dbg_dump_flag & (1 << MD_DBG_DUMP_TOPSM)) {
		CCCI_MEM_LOG_TAG(md->index, TAG,
				 ...
				 MD1_TOPSM_REG_BASE0);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_topsm_reg, MD1_TOPSM_REG_LEN0);
	}
	...
	if (per_md_data->md_dbg_dump_flag & (1 << MD_DBG_DUMP_MDRGU)) {
		...
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_rgu_reg_0, MD1_RGU_REG_LEN0);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_rgu_reg_1, MD1_RGU_REG_LEN1);
	}
	/* 8 OST */
	if (per_md_data->md_dbg_dump_flag & (1 << MD_DBG_DUMP_OST)) {
		CCCI_MEM_LOG_TAG(
		    md->index, TAG, "Dump MD OST status: [0]0x%X, [1]0x%X\n",
		    MD_OST_STATUS_BASE, MD_OST_STATUS_BASE + 0x200);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_ost_status, 0xF0);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_ost_status + 0x200, 0x8);
		/* 9 CSC */
		CCCI_MEM_LOG_TAG(md->index, TAG, "Dump MD CSC: 0x%X\n",
				 MD_CSC_REG_BASE);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_csc_reg, MD_CSC_REG_LENGTH);
		/* 10 ELM */
		CCCI_MEM_LOG_TAG(md->index, TAG, "Dump MD ELM: 0x%X\n",
				 MD_ELM_REG_BASE);
		ccci_util_mem_dump(md->index, CCCI_DUMP_MEM_DUMP,
				   md_reg->md_elm_reg, MD_ELM_REG_LENGTH);
	}
...
void md1_pmic_setting_off(void) { vmd1_pmic_setting_off(); }

void md1_pmic_setting_on(void) { vmd1_pmic_setting_on(); }

/* callback for system power off*/
void ccci_power_off(void) { md1_pmic_setting_on(); }
...
kicker_pbm_by_md(enum pbm_kicker kicker, bool status)
{
}
...
int md_cd_soft_power_on(struct ccci_modem *md, unsigned int mode) { return 0; }
...
int md_cd_bootup_cleanup(struct ccci_modem *md, int success) { return 0; }
...
int md_cd_let_md_go(struct ccci_modem *md)
{
	...
	cldma_write32(md_info->md_boot_slave_En, 0,
		      1); /* make boot vector take effect */
...
int ccci_modem_remove(struct platform_device *dev) { return 0; }
...
void ccci_modem_restore_reg(struct ccci_modem *md)
{
	...
	if (cldma_read32(md_ctrl->cldma_ap_pdn_base, CLDMA_AP_TQSAR(0)) ||
		...
		cldma_write32(
		    md_ctrl->cldma_ap_pdn_base, CLDMA_AP_UL_CFG,
		    cldma_read32(md_ctrl->cldma_ap_pdn_base, CLDMA_AP_UL_CFG) |
			0x40);
#endif
		cldma_write32(md_ctrl->cldma_ap_pdn_base,
			      CLDMA_AP_SO_RESUME_CMD,
		...
		cldma_write32(md_ctrl->cldma_ap_pdn_base, CLDMA_AP_L3TIMCR0,
			      CLDMA_BM_INT_ALL);
		cldma_write32(md_ctrl->cldma_ap_pdn_base, CLDMA_AP_L3TIMCR1,
			      CLDMA_BM_INT_ALL);
		cldma_write32(md_ctrl->cldma_ap_pdn_base, CLDMA_AP_L3RIMCR0,
			      CLDMA_BM_INT_ALL);
		cldma_write32(md_ctrl->cldma_ap_pdn_base, CLDMA_AP_L3RIMCR1,
			      CLDMA_BM_INT_ALL);
		spin_unlock_irqrestore(&md_ctrl->cldma_timeout_lock, flags);
		CCCI_NORMAL_LOG(md->index, TAG,
