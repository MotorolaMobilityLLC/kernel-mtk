...
/* network port first for performace */
	...
	{CCCI_CCMNI19_TX, CCCI_CCMNI19_RX, 5, 5, 0xF5, 0xFF, 0, &net_port_ops, 18, "ccmni18",},
	{CCCI_CCMNI20_TX, CCCI_CCMNI20_RX, 5, 5, 0xF5, 0xFF, 0, &net_port_ops, 19, "ccmni19",},
...
/* IPC kernel port */
	...
	{CCCI_IPC_TX, CCCI_IPC_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, 9, "ccci_ipc_9",},
/* sys port */
...
#endif
#ifdef FEATURE_LWA
	{CCCI_SMEM_CH, CCCI_SMEM_CH, 0xFF, 0xFF, 0xFF, 0xFF, 0, &char_port_ops, SMEM_USER_RAW_LWA, "ccci_raw_lwa",},
#endif
};
