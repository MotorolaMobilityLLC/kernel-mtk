...
#include <linux/hardware_info.h> //add by zj to display acc name  for factory mode 
#include "upmu_sw.h"
...
static int kxtj2_1009_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	hardwareinfo_set_prop(HARDWARE_ACCELEROMETER,"KXTJ2-1009-HQ"); //add by zj to display acc name for factory mode
	GSE_LOG("%s: OK\n", __func__);
