...
//Bug 267985  daixinyan modify 20170605 hardware info
		hardwareinfo_set_prop(HARDWARE_BT, "MT6580");
		hardwareinfo_num = HARDWARE_BT;
		break;
	case HARDWARE_WIFI_GET:
//Bug 267985  daixinyan modify 20170605 hardware info
		hardwareinfo_set_prop(HARDWARE_WIFI, "MT6580");
...
//Bug 267985  daixinyan modify 20170605 hardware info
		hardwareinfo_set_prop(HARDWARE_GPS, "MT6580");
	    hardwareinfo_num = HARDWARE_GPS;
		break;
	case HARDWARE_FM_GET:
//Bug 267985  daixinyan modify 20170605 hardware info
		hardwareinfo_set_prop(HARDWARE_FM, "MT6580");
