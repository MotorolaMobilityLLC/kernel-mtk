...
static struct DEVICE_INFO devapc_devices[] = {
	...
	{"INFRA_AO_ APMIXEDSYS",                   true},
	{"INFRA_AO_ PMIC_WRAP_CONTROL_REG",        true},
	{"INFRA_AO_DEVICE_APC_AO",                 true},
	{"INFRA_AO_DDRPHY_CONTROL_REG",            true},
	{"INFRA_AO_KPAD_CONTROL_REG",              true},
	{"INFRA_AO_CKSYS_DMY",                     true},
	{"INFRA_AO_DDRPHY_CONTROL_REG_B",          true},
	{"INFRA_AO_DRAMC_CONTROL_REG_B",           true},

	/* 20 */
	{"INFRA_AO_CLDMA_AO_AP_REG_B",             true},
	{"INFRA_AO_CLDMA_AO_MD_REG_B",             true},
	{"INFRA_AO_AES_TOP0",                      true},
	{"INFRA_AO_AES_TOP1",                      true},
	{"INFRA_AO_DDRPHY_CONTROL_REG_C",          true},
	{"INFRA_AO_DDRPHY_CONTROL_REG_D",          true},
	{"INFRA_AO_MCUMIXEDSYS",                   true},
	{"INFRA_AO_C2K_MISC",                      true},
	{"INFRA_AO_MODEM_TEMP_SHARE",              true},
	{"INFRA_AO_RESERVED",                      true},

	/* 30 */
	{"INFRA_AO_SCP",                           true},
	{"INFRASYS_EMI_MPU",                       true},
	{"INFRASYS_CONTROL_REG",                   true},
	{"INFRASYS_BOOTROM_SRAM",                  true},
	{"INFRASYS_EMI_BUS_INTERFACE",             true},
	{"INFRASYS _SYSTEM_CIRQ",                  true},
	...
	/* 40 */
	{"INFRASYS_CA7_AP_CCIF",                   true},
	{"INFRASYS_CA7_MD1_CCIF",                  true},
	{"INFRASYS_CA7_AP_C2K_CCIF",               true},
	{"INFRASYS_CA7_MD_C2K_CCIF",               true},
	{"INFRASYS_MBIST_CONTROL_REG",             true},
	{"INFRASYS_DRAMC_NAO_REGION_REG",          true},
	{"INFRASYS_TRNG",                          true},
	{"INFRASYS_GCPU",                          true},
	{"INFRASYS_MD2MD_MD1_CCIF",                true},
	{"INFRASYS_GCE",                           true},

	/* 50 */
	{"INFRASYS_MD2MD_MD2_CCIF",                true},
	{"INFRASYS_PERISYS_IOMMU",                 true},
	{"INFRASYS_DSI0",                          true},
	{"INFRASYS_DRAMC_NAO_REGION_REG_B",        true},
	{"INFRASYS_CSI0",                          true},
	{"INFRASYS_CSI1",                          true},
	{"INFRASYS_CLDMA_AP",                      true},
	{"INFRASYS_CLDMA_MD",                      true},
	{"INFRASYS_RESERVED",                      true},
	{"INFRASYS_MDHW_SMI",                      true},

	/* 60 */
	{"INFRASYS_GCPU_RSA",                      true},
	{"INFRASYS_DSI1",                          true},
	{"INFRASYS_VAD",                           true},
	{"INFRASYS_MCUSYS",                        true},
	{"INFRASYS_CPUSYS",                        true},
	{"INFRASYS_MCUSYS1",                       true},
	{"INFRASYS_CPUSYS1",                       true},
	{"INFRASYS_MCUSYS_RSVD0",                  true},
	{"INFRASYS_MCUSYS_RSVD1",                  true},
	{"INFRASYS_MCUSYS_RSVD2",                  true},

	/* 70 */
	{"INFRASYS_MCUSYS_RSVD3",                  true},
	{"INFRASYS_BSI_BPI_0",                     true},
	{"INFRASYS_BSI_BPI_1",                     true},
	{"INFRASYS_BSI_BPI_2",                     true},
	{"INFRASYS_BSI_BPI_3",                     true},
	{"INFRASYS_BSI_BPI_4",                     true},
	{"INFRASYS_BSI_BPI_5",                     true},
	{"INFRASYS_BSI_BPI_6",                     true},
	{"INFRASYS_BSI_BPI_7",                     true},
	{"DEBUG_CORESIGHT",                        true},
	...
	{"USB30_SIF2",                             true},
	{"USB30_REMAP",                            true},
	{"CONN_PERIPHERALS",                       true},
	{"MD1_PERIPHERALS",                        true},
	{"C2K_PERIPHERALS",                        true},
	{"G3D_CONFIG",                             true},
	{"MJC_CONFIG",                             true},
	{"MJC_TOP",                                true},
	{"SMI_LARB4",                              true},
...
static void unmask_module_irq(unsigned int module)
{
	...
	case 5:
		*DEVAPC0_D0_VIO_MASK_5 &= ~(0x1 << apc_bit_index);
		break;
	case 6:
		*DEVAPC0_D0_VIO_MASK_6 &= ~(0x1 << apc_bit_index);
		break;
	default:
...
static void start_devapc(void)
{
	...
	pr_err("[DEVAPC] start_devapc: Current VIO_MASK 0:0x%x, 1:0x%x, 2:0x%x, 3:0x%x, 4:0x%x, 5:0x%x, 6:0x%x\n",
