...
/*For EMI API(DRAM violation) DEVAPC0_D0_VIO_STA_7, idx:225*/
#define ABORT_EMI                0x00000002
#define INDEX_EMI                225

/*For EMI_MPU(APB violation) API DEVAPC0_D0_VIO_STA_7, idx:224*/
