...
struct kbase_jd_atom {
	...
	/* True if this is a JIT allocate soft-job that is blocked waiting for
	 * a JIT free to complete
	 */
	bool jit_blocked;
...
struct kbase_context {
	...
	/* The number of pending JIT free soft-jobs
	 * (protected by kbase_jd_context.lock)
	 */
	int jit_pending_free;
	/* A list of pending JIT free soft-jobs (using the 'queue' list_head)
	 * (protected by kbase_jd_context.lock)
	 */
