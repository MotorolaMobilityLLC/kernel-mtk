...
struct mali_gpu_device_data {
    ...
    atomic_t current_frequency_id;
    atomic_t boost_frequency_id;
    atomic_t current_deferred_count;
    atomic_t input_boost_enabled;
    atomic_t input_boost_duration;
    atomic_t dvfs_threshold_min;
    atomic_t dvfs_threshold_max;
    atomic_t dvfs_deferred_count;
