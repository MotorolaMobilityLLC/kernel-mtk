...
void kbase_pm_get_dvfs_utilisation(struct kbase_device *kbdev, unsigned long *total_out, unsigned long *busy_out, bool reset)
{
	...
	*busy_out = tmp;
	*total_out = tmp + kbdev->pm.metrics.time_idle;
