...
#endif
	LCM_LOGI("%s,ontim_ILI9881Clcm_suspend\n", __func__);
...
{
	LCM_LOGI("%s: ontim_ILI9881C start\n",__func__);
	//ontim_resume = 1;
	lcm_init();
	LCM_LOGI("%s: ontim_ILI9881C done\n",__func__);
}
...
LCM_DRIVER ontim_ILI9881C_lcm_drv_hc_hlt = {
	.name = "ontim_ILI9881C_hc_hlt",
