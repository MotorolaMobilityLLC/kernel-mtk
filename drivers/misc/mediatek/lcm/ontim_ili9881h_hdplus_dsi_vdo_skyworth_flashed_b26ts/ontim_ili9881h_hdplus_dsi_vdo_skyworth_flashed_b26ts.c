 ...
 */
#define LOG_TAG "LCM-ili9881H-flashed-b26ts"
...
struct LCM_DRIVER ontim_ili9881h_hdplus_dsi_vdo_skyworth_flashed_b26ts_lcm_drv = {
	.name = "ontim_ili9881h_hdplus_dsi_vdo_skyworth_flashed_b26ts",
	.lcm_id = 1,
