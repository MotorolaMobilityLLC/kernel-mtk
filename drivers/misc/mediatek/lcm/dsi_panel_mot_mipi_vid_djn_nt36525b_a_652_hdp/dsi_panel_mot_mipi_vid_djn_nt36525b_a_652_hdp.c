...
*/
	{0xFF,1, {0x10}},
	{0xFB,1, {0x01}},
	{0x68,2, {0x03,0x01}},	//EKELLIS-830, shenwenbin.wt, modify, 20211224, set backlight to 11bit and set CABC default UI mode and improve dimming
	{0x51,2, {0x00,0x00}},
	{0x53,1, {0x2C}},
	{0x55,1, {0x01}},	//EKELLIS-830, shenwenbin.wt, modify, 20211224, set backlight to 11bit and set CABC default UI mode and improve dimming
	{0x35,1, {0x00}},
	{0x11,1, {0x00}},
	{REGFLAG_DELAY,150,{}},
	{0x29,1, {0x00}},
...
static struct LCM_setting_table bl_level[] = {
	{ 0x51, 0x02, {0x06, 0x66} },	//EKELLIS-830, shenwenbin.wt, modify, 20211224, set backlight to 11bit and set CABC default UI mode and improve dimming
};
#else
//12bit
static struct LCM_setting_table bl_level[] = {
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.esd_check_enable = 1;	//EKELLIS-830, shenwenbin.wt, modify, 20220106,Open ESD
	params->dsi.customization_esd_check_enable = 1;	//EKELLIS-830, shenwenbin.wt, modify, 20220106,Open ESD
	params->dsi.lcm_esd_check_table[0].cmd = 0x0A;
	params->dsi.lcm_esd_check_table[0].count = 1;
	params->dsi.lcm_esd_check_table[0].para_list[0] = 0x9C;	//EKELLIS-830, shenwenbin.wt, modify, 20220106,Open ESD
...
static unsigned int lcm_compare_id(void)
{
	...
	LCM_LOGI("%s,nt36525b_id=0x%02x%02x%02x%02x\n", __func__,buffer[0], buffer[1],buffer[2],buffer[3]);
		...
		unsigned int *lcm_count, unsigned int *lcm_value)
{
	...
	switch(*lcm_cmd) {
		...
		case PARAM_CABC:
			...
			break;
		default:
			pr_err("%s,djn_nt36525b_a cmd:%d, unsupport\n", __func__, *lcm_cmd);
			break;
	}

	pr_info("%s,djn_nt36525b_a cmd:%d, value = %d done\n", __func__, *lcm_cmd, *lcm_value);
...
struct LCM_DRIVER mipi_mot_vid_djn_nt36525b_a_hdp_652_lcm_drv = {
	.name = "mipi_mot_vid_djn_nt36525b_a_hdp_652",
	.supplier = "djn_a",
