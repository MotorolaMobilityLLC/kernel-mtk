...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_sync_active = 35; //old is 20,now is 8
	params->dsi.horizontal_backporch = 30;//old is 60,now is 12
	params->dsi.horizontal_frontporch = 30;//old is 60,now is 16
	params->dsi.horizontal_active_pixel = FRAME_WIDTH;
	params->dsi.PLL_CLOCK = 330;    /* FrameRate = 60Hz */ /* this value must be in MTK suggested table */
