...
static void lcm_dfps_int(struct LCM_DSI_PARAMS *dsi)
{
	...
	dfps_params[0].vertical_frontporch_for_low_power = 1040;
	...
	dfps_params[1].vertical_frontporch_for_low_power = 1040;//60 FPS in idle mode
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch_for_low_power = 1040;
...
struct LCM_DRIVER mipi_mot_vid_txd_icnl9911c_652_hdp_lcm_drv = {
	.name = "mipi_mot_vid_txd_icnl9911c_652_hdp",
	.supplier = "txd_icnl9911c_hdp_vid",
