...
static struct LCM_setting_table init_setting[] = {
	...
	{0x00, 0x01, {0x42}},  //STV A rise
	{0x01, 0x01, {0x33}},  //STV A overlap
	{0x02, 0x01, {0x01}},
	{0x03, 0x01, {0x00}},
	{0x04, 0x01, {0x02}},  //STV B rise
	{0x05, 0x01, {0x31}},  //STV B overlap
	{0x07, 0x01, {0x00}},
	{0x08, 0x01, {0x80}},  //CLK A rise
	{0x09, 0x01, {0x81}},  //CLK A fall
	{0x0a, 0x01, {0x71}},  //CLK A overlap
	{0x0b, 0x01, {0x00}},
	{0x0c, 0x01, {0x01}},
	{0x0d, 0x01, {0x01}},
	{0x0e, 0x01, {0x00}},
	...
	{0x06, 0x01, {0x8D}},     // Internal Line Time (RTN)
	{0x0B, 0x01, {0xA0}},     // Internal VFP[9]
	{0x0C, 0x01, {0x80}},     // Internal VFP[8]
	{0x0D, 0x01, {0x1A}},     // Internal VBP
	{0x0E, 0x01, {0x04}},     // Internal VFP
	...
	{0xFF, 0x03, {0x98, 0x82, 0x03}},  //pwm 11bit 15.6k
	{0x83, 0x01, {0xE8}},
	{0x84, 0x01, {0x00}},
	{0xC6, 0x01, {0x14}},
