...
static struct LCM_setting_table init_setting[] = {
	...
	{0x00,0x01,{0x42}},  //42 STV A rise    20201022
	{0x01,0x01,{0x33}},  //33 STV A overlap 20201022
	{0x02,0x01,{0x01}},
	{0x03,0x01,{0x00}},
	{0x04,0x01,{0x02}},  //02 STV B rise    20201022
	{0x05,0x01,{0x31}},  //31 STV B overlap 20201022
	{0x07,0x01,{0x00}},
	{0x08,0x01,{0x80}},  //80 CLK A rise    20201022
	{0x09,0x01,{0x81}},  //81 CLK A fall    20201022
	{0x0a,0x01,{0x71}},  //71 CLK A overlap 20201022
	{0x0b,0x01,{0x00}},
	{0x0c,0x01,{0x01}},  //01               20201022
	{0x0d,0x01,{0x01}},  //01               20201022
	{0x0e,0x01,{0x00}},
	{0x0f,0x01,{0x00}},
	{0x28,0x01,{0x83}}, //83 STCH1 RISE     20201022
	...
	{0x8c,0x01,{0x07}},
	{0xa0,0x01,{0x01}},
	{0xa7,0x01,{0x00}},  //LVRA CLK RISE CLW
	{0xa8,0x01,{0x00}},  //LVRA CLK RISE CLW
	{0xb0,0x01,{0x33}},
	{0xba,0x01,{0x06}},
	{0xc0,0x01,{0x07}},
	{0xc1,0x01,{0x00}},
	...
	{0xdf,0x01,{0xb6}},
	{0xe0,0x01,{0x3E}},
	{0xe2,0x01,{0x47}}, //SRC power off GND
	{0xe7,0x01,{0x54}},
	{0xe6,0x01,{0x22}},
	{0xee,0x01,{0x15}},
	{0xf1,0x01,{0x00}},
	...
	{0x07,0x01,{0xF7}},     // ABNORMAL RESET OPTION
	...
	{0x02,0x01,{0x09}},     // VBP_TPV
	{0x07,0x01,{0x21}},     // TPMEnable, 30: Disable
	{0x11,0x01,{0x50}},     // TSVD Rise Poisition
	{0x13,0x01,{0x10}},     // TSHD Rise Poisition
	{0x40,0x01,{0x07}},     // Tp unit
	{0x45,0x01,{0x0B}},     // Real Tp term2_unit0  ( >180us )
	{0x46,0x01,{0x59}},     // Real Tp term2_unit0  ( >180us )
	{0x49,0x01,{0xC8}},     // Unit line number
	{0x4B,0x01,{0x1E}},     // TPM Step: 31
	{0x4D,0x01,{0x8D}},     // RTN2_A
	{0xC0,0x01,{0x01}},     // Tp term1 Number
	{0xC1,0x01,{0x80}},     // Tp term1
	{0xD0,0x01,{0x34}},     // Tp term3 Number
	{0xD6,0x01,{0x8D}},     // Tp term3_4
	{0xD7,0x01,{0x8D}},     // Tp term3_3
	{0xD8,0x01,{0x8D}},     // Tp term3_2
	{0xD9,0x01,{0x8D}},     // Tp term3_1
	{0xDC,0x01,{0x44}},     // Tp 3_3 & 3_4 SRC_OPT
	{0xDD,0x01,{0x44}},     // Tp 3_1 & 3_2 SRC_OPT

	//PWM
	{0xFF,0x03,{0x98,0x82,0x06}},
	{0x06,0x01,{0xA4}},
	{0xFF,0x03,{0x98,0x82,0x03}},
	{0x80,0x01,{0x07}},     // 1 frame , 16 step 20201022
	{0x81,0x01,{0x07}},     // 1 frame , 16 step 20201022
	{0x82,0x01,{0x07}},     // 1 frame , 16 step 20201022
	{0x83,0x01,{0xE8}},     //40 PWM=15.6K       20201022
	{0x84,0x01,{0x00}},     //02                 20201022
	{0xC6,0x01,{0x14}},     //DEV 8bit&PWM 12bit 20201022
	{0xFF,0x03,{0x98,0x82,0x00}},
	{0x51,0x02,{0x00,00}},
	{0x53,0x01,{0x2C}},
	{0x55,0x01,{0x03}},
	{0x68,0x02,{0x04,0x00}},  // Set TT:1 frame , 16 step 20201022
	{0xFF,0x03,{0x98,0x82,0x00}},
	{0x11,0x01,{0x00}},
	{REGFLAG_DELAY, 120, {}},
	{0x29, 0x01, {0x00}},
