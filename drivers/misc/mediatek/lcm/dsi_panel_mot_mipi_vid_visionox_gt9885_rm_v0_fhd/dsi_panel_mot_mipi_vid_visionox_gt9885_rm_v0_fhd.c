...
static unsigned int lcm_compare_id(void)
{
	...
	pr_info("%s:rm692cx_gt9885 v0: id=0x%02x%02x%02x%02x\n", __func__, buffer[0], buffer[1], buffer[2], buffer[3]);
...
struct LCM_DRIVER mipi_mot_vid_visionox_gt9885_rm_v0_fhd_643_lcm_drv = {
	.name = "mipi_mot_vid_visionox_gt9885_rm_v0_fhd_643",
