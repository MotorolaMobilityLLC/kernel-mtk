...
#define NORMAL_MODE_RATIO 65
#define HBM_MODE_RATIO 8
#define TEN 10
#define NORMAL_CONVERT 100
#define HBM_DIFF 4
...
static void lcm_dfps_int(struct LCM_DSI_PARAMS *dsi)
{
	...
	dfps_params[0].vertical_frontporch = 1010;
	...
	dfps_params[1].vertical_frontporch = 132;
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch = 1010;
...
static int lcm_bias_enable(void)
{
	...
	pr_info("lcm td4160 bias enable!\n");
...
static int lcm_bias_disable(void)
{
	...
	pr_info("lcm td4160 bias disable!\n");
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	LCM_LOGI("%s, lcm td4160 backlight: normal brightness_level = %d\n", __func__, brightness_level);
	push_table(handle, bl_level, ARRAY_SIZE(bl_level), 1);
}
...
struct LCM_DRIVER td4160_hdp_dsi_vdo_boe_lcm_drv = {
	.name = "td4160_hdp_dsi_vdo_boe",
