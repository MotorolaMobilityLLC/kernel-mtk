 ...
 */
#define LOG_TAG "LCM-icnl9911c-boe"
...
#define MP_LCM_ID1 (unsigned int)(0x02)
#define MP_LCM_ID3 (unsigned int)(0x05)
...
#endif
	LCM_LOGI("%s,boe icnl9911c done\n", __func__);
}

static void lcm_resume(void)
{
	LCM_LOGI("%s,boe icnl9911c  start\n",__func__);
	lcm_init();
	LCM_LOGI("%s, boe icnl9911c  done\n",__func__);
}
...
struct LCM_DRIVER ontim_icnl9911c_hdplus_dsi_vdo_boe_lcm_drv = {
	.name = "ontim_icnl9911c_hdplus_dsi_vdo_boe",
