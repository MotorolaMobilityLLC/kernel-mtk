 ...
 */
#define LOG_TAG "LCM-hx83112a-tianma"
...
#define LCM_ID_DC_MP		0x93

// #define LCM_ID_DA_MP		0x83
// #define LCM_ID_DB_MP		0x11
// #define LCM_ID_DC_MP		0x2a
...
static struct LCM_setting_table init_setting[] = {
	...
	{0x53, 0x01,{0x2C}},
	{0x55, 0x01,{0x00}},
	{0xC9, 0x04, {0x04, 0x10, 0xC6, 0x01}},
	{0xE4, 0x17, {0x2D, 0x01, 0x2C, 0x00, 0x08, 0x00, 0x10, 0x08, 0x04, 0x04, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x66, 0x66, 0xE2, 0xFF, 0xAA, 0xFE, 0xEF, 0x30}},
	{0xBD, 0x01, {0x01}},
	{0xE4, 0x29, {0x00, 0x77, 0xE1, 0xE1, 0xE1, 0xE1, 0xE1, 0xE1, 0xE1, 0xE1, 0xC7, 0xB2, 0xA0, 0x90, 0x81, 0x75, 0x69, 0x5F, 0x55, 0x4C, 0x44, 0x3D, 0x36, 0x2F, 0x2A, 0x20, 0x1E, 0x19, 0x11, 0x0D, 0x0B, 0x06, 0x03, 0x54, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55}},
	{0xBD, 0x01, {0x00}},
	{0x29, 0x01, {0x00}},
	{REGFLAG_DELAY, 20, {}},
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_sync_active = 5; //old is 2,now is 4
	params->dsi.vertical_backporch = 10; //old is 8,now is 100
	params->dsi.vertical_frontporch = 27; //old is 24,now is 124
	params->dsi.vertical_active_line = FRAME_HEIGHT;
	params->dsi.horizontal_sync_active = 32; //old is 20,now is 8
	params->dsi.horizontal_backporch = 72;//old is 60,now is 12
	params->dsi.horizontal_frontporch = 420;//old is 60,now is 16
...
static void lcm_init(void)
{
	...
	unsigned char data = 0x0f;  //up to +/-5.5
...
struct LCM_DRIVER ontim_hx83112a_hdplus_dsi_vdo_tianma_6517_lcm_drv = {
	.name = "ontim_hx83112a_hdplus_dsi_vdo_tianma_6517",
