...
static void lcm_dfps_int(struct LCM_DSI_PARAMS *dsi)
{
	...
	dfps_params[0].vertical_frontporch = 1262;
	dfps_params[0].vertical_frontporch_for_low_power = 1262;
	...
	dfps_params[1].vertical_frontporch = 300;
	dfps_params[1].vertical_frontporch_for_low_power = 1262;//60 FPS in idle mode
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch = 1262;
	params->dsi.vertical_frontporch_for_low_power = 1262;
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	LCM_LOGI("%s,icnl9916 backlight: level = %d\n", __func__, level);
	//for 11bit
...
struct LCM_DRIVER mipi_mot_vid_tm_icnl9916_652_hdp_lcm_drv = {
	.name = "mipi_mot_vid_tm_icnl9916_652_hdp",
	.supplier = "tianma_icnl9916_hdp_vid",
