 ...
 */
#define LOG_TAG "LCM-ili9882N TIANMA"
...
#define LCM_ID_REG_DA (unsigned int)(0x01)
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_backporch = 116;//old is 60,now is 12
	params->dsi.horizontal_frontporch = 116;//old is 60,now is 16
...
struct LCM_DRIVER ontim_ili9882n_hdplus_dsi_vdo_tianma_lcm_drv = {
	.name = "ontim_ili9882n_hdplus_dsi_vdo_tianma",
