...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0X50, 1, {0X78}},	//Display Inversion Control //78 88 VGMP
	{0X51, 1, {0X78}},	//Display Inversion Control //78 88 VGMN
	{ 0X52, 1, {0X00}},	//Display Inversion Control
	{0X53, 1, {0X14}},	//Display Inversion Control //28 3D Flicker 1207
	...
	{0XA1, 1, {0X09}},	//02 05 Gamma 4  越小越暗
	{0XA2, 1, {0X12}},	//0D 0F Gamma 8
	{0XA3, 1, {0X0F}},	//11 14 Gamma 16
	{0XA4, 1, {0X08}},	//0A 0D Gamma 24
	{0XA5, 1, {0X1d}},	//19 1E Gamma 52
	{0XA6, 1, {0X07}},	//08 0F Gamma 80
	{0XA7, 1, {0X07}},	//06 0C Gamma 108
	{0XA8, 1, {0X04}},	//01 03 Gamma 147
	{0XA9, 1, {0X08}},	//06 08 Gamma 175
	{0XAA, 1, {0X03}},	//02 0B Gamma 203
	{0XAB, 1, {0X03}},	//04 06 Gamma 231
	{0XAC, 1, {0X10}},	//0B 12 Gamma 239
	{0XAD, 1, {0X37}},	//29 33 Gamma 247
	{0XAE, 1, {0X33}},	//26 33 Gamma 251  越小越亮
	{ 0XAF, 1, {0X00}},
	{ 0XC0, 1, {0X00}},	//Negative Gamma Control (01h~16h)
	{0XC1, 1, {0X09}},	//02 05 Gamma 4
	{0XC2, 1, {0X17}},	//11 0C Gamma 8
	{0XC3, 1, {0X11}},	//0E 11 Gamma 16
	{0XC4, 1, {0X0b}},	//07 0B Gamma 24
	{0XC5, 1, {0X16}},	//17 1D Gamma 52
	{0XC6, 1, {0X0a}},	//0D 0C Gamma 80
	{0XC7, 1, {0X08}},	// Gamma 108
	{0XC8, 1, {0X04}},	//02 03 Gamma 147
	{0XC9, 1, {0X08}},	//06 08 Gamma 175
	{0XCA, 1, {0X06}},	//00 06 Gamma 203
	{0XCB, 1, {0X03}},	//04 05 Gamma 231
	{0XCC, 1, {0X08}},	//07 0E Gamma 239
	{0XCD, 1, {0X21}},	//26 28 Gamma 247
	{0XCE, 1, {0X1c}},	//24 1F Gamma 251
	{ 0XCF, 1, {0X00}},
	...
	{ 0X53, 1, {0X10}},
	//{0X54, 1, {0X13}},
	{0X58, 1, {0X97}},//bug 271978 yewei.wt add form FAE for flicker 20170624
