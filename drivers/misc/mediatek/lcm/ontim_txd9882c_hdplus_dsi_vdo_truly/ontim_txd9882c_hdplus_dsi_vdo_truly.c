 ...
 */
#define LOG_TAG "LCM-txd9882c-truly-hjc"
...
#define MP_LCM_ID1 (unsigned int)(0x50)
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch = 364;
...
static unsigned int lcm_compare_id(void)
{
	...
	LCM_LOGI("%s,txd9882c vendor id1 = 0x%08x,id3 = 0x%08x\n", __func__, id1, id3);
...
struct LCM_DRIVER ontim_txd9882c_hdplus_dsi_vdo_truly_lcm_drv = {
	.name = "ontim_txd9882c_hdplus_dsi_vdo_truly",
