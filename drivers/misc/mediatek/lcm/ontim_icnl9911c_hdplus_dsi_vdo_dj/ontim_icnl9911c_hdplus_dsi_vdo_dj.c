...
#define MP_LCM_ID1 (unsigned int)(0x40)
#define MP_LCM_ID3 (unsigned int)(0x98)
...
static struct LCM_setting_table init_setting[] = {
	...
	{0xBE, 0x0A, {0x72, 0x72, 0x50, 0x46, 0x0c, 0x77, 0x43, 0x07, 0x0E, 0x0E}},
	{0xC1, 0x13, {0xC0, 0x20, 0x20, 0x96, 0x04,0x30, 0x28, 0x04, 0x2A, 0x40, 0x36, 0x00, 0x07, 0xCF, 0xFF, 0xFF, 0x7C, 0x01, 0xC0} },
	{0x35,0x01,{0x00}},
	{0x53, 0x01, {0x2C} },
	{0x51, 0x01, {0x00} },
	{0x55, 0x01, {0x01} },
...
static void lcm_dfps_int(struct LCM_DSI_PARAMS *dsi)
{
	...
	dfps_params[1].vertical_frontporch_for_low_power = 1040;
	dsi->dfps_num = 2;//檔位個數
}
#endif
...
static void lcm_init(void)
{
	...
	unsigned char data = 0x14;  //up to +/-5.8V
	int ret = 0;
...
static unsigned int lcm_compare_id(void)
{
	...
	LCM_LOGI("%s,icnl9911c vendor id1 = 0x%08x,id3 = 0x%08x\n", __func__, id1, id3);
...
struct LCM_DRIVER ontim_icnl9911c_hdplus_dsi_vdo_dj_lcm_drv = {
	.name = "ontim_icnl9911c_hdplus_dsi_vdo_dj",
