...
//bug 278527 yewei.wt modify lcd para in 20170718
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0xB8,06,{0x00,0x9F,0x01,0x00,0x9F,0x01}},

	{0xBA,03,{0x3E,0x23,0x04}},
	...
	{0xC8,38,{0x7F,0x7B,0x73,0x68,0x5A,0x40,0x38,0x1C,0x34,0x33,0x35,0x58,0x4C,0x5D,0x56,0x5D,0x58,0x51,0x48,0x7F,0x7B,0x73,0x67,0x5A,0x40,0x38,0x1C,0x34,0x33,0x35,0x58,0x4C,0x5D,0x56,0x5D,0x58,0x51,0x48}},
...
void push_table1(struct LCM_setting_table *table, unsigned int count, unsigned char force_update)
{
	unsigned int i;
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_backporch = 6;//10;//12;
...
static int get_lcd_pin_id_vol(void)
{
    ...
    if(res < 0)
    {
		printk("hs50vc22t6f,[adc_uboot]: get data error\n");
		return 0;
    }

    printk("hs50vc22t6f,[adc_uboot]: lcm_vol= %d\n",lcm_vol);
	lcm_vol = lcm_vol/1000;
	if (lcm_vol >= 700 && lcm_vol <= 1100)
	{
		return 1;
	}
	else
...
static void lcm_init(void)
{
	...
	//SET_RESET_PIN(1);
	MDELAY(120);
	push_table1(lcm_initialization_setting,
...
LCM_DRIVER hs50vc22t6f_fwvga_dsi_vdo_hs_longteng_lcm_drv = {

	.name = "hs50vc22t6f_fwvga_dsi_vdo_hs_longteng",
