 ...
 */
#define LOG_TAG "LCM-ili9882N HLT"
...
#define LCM_ID_REG_DA (unsigned int)(0x23)
...
{0xE0,0x18,{0x00,0x24,0x7A,0xB0,0xF1,0x55,0x24,0x4B,0x78,0x9B,0xA5,0xD2,0xFD,0x24,0x49,0xAA,0x70,0xA2,0xC2,0xEB,0xFF,0x0E,0x3A,0x71,0x9E,0x03,0xEC}},
{0xE1,0x18,{0x00,0x24,0x7A,0xB0,0xF1,0x55,0x24,0x4B,0x78,0x9B,0xA5,0xD2,0xFD,0x24,0x49,0xAA,0x70,0xA2,0xC2,0xEB,0xFF,0x0E,0x3A,0x71,0x9E,0x03,0xEC}},
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch = 230; //old is 24,now is 124
	params->dsi.vertical_active_line = FRAME_HEIGHT;
	params->dsi.horizontal_sync_active = 20; //old is 20,now is 8
	params->dsi.horizontal_backporch = 26;//old is 60,now is 12
	params->dsi.horizontal_frontporch = 26;//old is 60,now is 16
...
struct LCM_DRIVER ontim_ili9882n_hdplus_dsi_vdo_hlt_lcm_drv = {
	.name = "ontim_ili9882n_hdplus_dsi_vdo_hlt",
