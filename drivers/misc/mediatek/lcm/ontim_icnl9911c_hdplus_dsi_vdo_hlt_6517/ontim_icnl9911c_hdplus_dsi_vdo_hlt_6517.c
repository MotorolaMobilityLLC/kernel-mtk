 ...
 */
#define LOG_TAG "LCM-icnl9911c_hlt_6517"
...
#define MP_LCM_DA (unsigned int)(0x00)
#define MP_LCM_DB (unsigned int)(0x00)
#define MP_LCM_DC (unsigned int)(0x15)

#define MP_LCM_DA1 (unsigned int)(0x99)
#define MP_LCM_DB1 (unsigned int)(0x11)
#define MP_LCM_DC1 (unsigned int)(0x01)
...
static struct LCM_setting_table init_setting[] = {
	...
	{0xB1,0x1D,{0x11,0x42,0x86,0x00,0x01,0x01,0x01,0x66,0x01,0x01,0x04,0x08,0x54,0x00,0x00,0x00,0x44,0x40,0x02,0x01,0x40,0x02,0x01,0x40,0x02,0x01,0x40,0x02,0x01}},
	...
	{0xBC,0x0E,{0x00,0x00,0x00,0x00,0x02,0x20,0xFF,0x00,0x03,0x33,0x01,0x73,0x33,0x00}},
	{0xBD,0x0A,{0x53,0x12,0x4F,0xCF,0x72,0xA4,0x08,0x44,0xAE,0x15}},
	{0xBE,0x0A,{0x65,0x65,0x50,0x46,0x0C,0x77,0x43,0x07,0x0E,0x0E}},
	{0xBF,0x08,{0x07,0x25,0x07,0x25,0x7F,0x00,0x11,0x04}},
	{0xC0,0x09,{0x10,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0xFF,0x00}},
	{0xC1,0x13,{0xC0,0x0C,0x20,0x7C,0x04,0x28,0x28,0x04,0x2A,0x40,0x36,0x00,0x07,0xCF,0xFF,0xFF,0xC0,0x00,0xC0}},
	{0xC2,0x01,{0x00}},
	{0xC3,0x09,{0x06,0x00,0xFF,0x00,0xFF,0x00,0x00,0x81,0x01}},
	{0xC5,0x0B,{0x03,0x1C,0xC0,0xC0,0x40,0x10,0x42,0x44,0x08,0x09,0x14}},
	{0xC6,0x0A,{0x87,0x96,0x2A,0x29,0x29,0x31,0x7F,0x34,0x08,0x04}},
	{0xC7,0x16,{0xFC,0xAD,0x8A,0x6E,0x3E,0x1E,0xF0,0x48,0x16,0xF3,0xCE,0xA2,0xFC,0xD0,0xB3,0x89,0x70,0x4C,0x1A,0x7E,0xC0,0x00}},
	{0xC8,0x16,{0xFC,0xAD,0x8A,0x6E,0x3E,0x1E,0xF0,0x48,0x16,0xF3,0xCE,0xA2,0xFC,0xD0,0xB3,0x89,0x70,0x4C,0x1A,0x7E,0xC0,0x00}},
	{0xCB,0x01,{0x00}},
	{0xD0,0x05,{0x80,0x0D,0xFF,0x0F,0x63}},
	{0xD2,0x01,{0x42}},
	//{0xD7,0x01,{0xDE}},//3lane
	{0xE1,0x17,{0xBC,0xF8,0xCC,0xCC,0xDB,0x9B,0xF0,0xE7,0xF0,0x85,0xF0,0x70,0x00,0x00,0x00,0x9A,0xFD,0xF0,0xE0,0xFF,0x00,0x07,0xF3}},
	{0xE0,0x1A,{0x30,0x00,0x80,0x88,0x11,0x3F,0x22,0x62,0xDF,0xA0,0x04,0xCC,0x01,0xFF,0xFA,0xFF,0xF0,0xFD,0xFE,0xFE,0xFE,0xF5,0xFC,0xFC,0xFB,0xFF}},
	{0x51,0x02,{0x00,0x00}},
	{0x53,0x01,{0x2C}},
	{0x55,0x01,{0x03}},
	{0xF1,0x02,{0x5A,0x59}},
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.PLL_CLOCK = 289;    /* FrameRate = 60Hz */ /* this value must be in MTK suggested table */
...
static unsigned int lcm_compare_id(void)
{
	...
	LCM_LOGI("%s,icnl9911c vendor DA = 0x%08x,DB = 0x%08x, DC = 0x%08x\n",
						__func__, id_da, id_db, id_dc);

	if ((MP_LCM_DC == id_dc && MP_LCM_DB == id_db && MP_LCM_DA == id_da)||(MP_LCM_DC1 == id_dc && MP_LCM_DB1 == id_db && MP_LCM_DA1 == id_da)) {
		return 1;
    }
	else
		return 0;
...
struct LCM_DRIVER ontim_icnl9911c_hdplus_dsi_vdo_hlt_6517_lcm_drv = {
	.name = "ontim_icnl9911c_hdplus_dsi_vdo_hlt_6517",
