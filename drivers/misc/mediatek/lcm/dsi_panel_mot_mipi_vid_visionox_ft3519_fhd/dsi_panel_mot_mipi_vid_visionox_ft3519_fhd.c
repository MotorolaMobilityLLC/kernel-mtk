...
{0x59, 0x01, {0x09}},
{0xF0, 0x02, {0xAA,0x10}},
{0xCF, 0x04, {0x0D,0x87,0x0B,0x12}},
{0xD0, 0x11, {0x84,0x15,0x50,0x14,0x14,0x00,0x29,0x2B,0x14,0x19,0x32,0x00,0x2B,0x14,0x19,0x32,0x00}},
{0xEA, 0x02, {0x30,0x00}},
{0xF0, 0x02, {0xAA,0x11}},
{0xBB, 0x02, {0x10,0x21}},
{0xF0, 0x02, {0xAA,0x12}},
{0xC7, 0x04, {0x8F,0x54,0xA5,0x02}},
{0xF0, 0x02, {0xAA,0x15}},
{0xBE, 0x0b, {0x22,0x11,0x22,0x22,0x11,0x11,0x00,0x00,0x00,0x00,0x00}},
{0xF0, 0x02, {0xAA,0x00}},
{0x11, 0x00, {}},
{REGFLAG_DELAY, 120, {}},
/* Display On*/
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_backporch = 10; //40
	params->dsi.horizontal_frontporch = 10; //40
	params->dsi.horizontal_active_pixel = FRAME_WIDTH;
	params->dsi.ssc_disable = 1;
#ifndef CONFIG_FPGA_EARLY_PORTING
	params->dsi.PLL_CLOCK = 590;    /* this value must be in MTK suggested table */
#else
...
static unsigned int lcm_compare_id(void)
{
	...
	if (LCM_ID_0 == buffer[0] && LCM_ID_1 == buffer[1] && LCM_ID_2 == buffer[2]
			&& (LCM_ID_3 == buffer[3] || LCM_ID_3_PIO == buffer[3])) {
