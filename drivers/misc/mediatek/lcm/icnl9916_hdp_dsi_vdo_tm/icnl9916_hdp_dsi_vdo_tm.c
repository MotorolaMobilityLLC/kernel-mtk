...
#define NORMAL_MODE_RATIO 7
#define HBM_MODE_RATIO 9
#define TEN 10
#define HBM_DIFF 4
...
static struct LCM_setting_table init_setting_vdo[] = {
	{0xF0, 2,{0x5A,0x59}},    //pass word
	{0xF1, 2,{0xA5,0xA6}},    //pass word
	{0xCC, 2,{0x02,0x4B}},
	//{0xCA, 2,{0x01,0x40}},    //TEMP_SENSOR
	{0xC1,32,{0x10,0x20,0x20,0x2C,0x04,0x28,0x1E,0x04,0x40,0x06,0x22,0x70,0x30,0x30,0x07,0x11,0x84,0x4C,0x00,0x93,0x13,0x63,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{0xBB, 8,{0x01,0x02,0x03,0x0A,0x04,0x13,0x14,0x12}},
	{0XC8, 3,{0x46,0x00,0x49}},  //Set RST_SLPOUT_EN=0 to solve the problem of abnormal power failure without contact
	{0xE0, 23,{0x0C,0x00,0xB0,0x0C,0x00,0xC4,0x09,0x00,0x0B,0x04,0x01,0x00,0x1F,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1F,0x0F,0x09}},
	{0xE2, 32,{0x36,0x24,0x36,0xD5,0x37,0x86,0x38,0x37,0x38,0xE8,0x39,0x99,0x3A,0x1C,0x3A,0x9F,0x3B,0x22,0x3B,0xA5,0x3C,0x28,0x3C,0xED,0x3D,0xB1,0x3E,0x76,0x3F,0x3A,0x3F,0xFF}},
	{0xE1, 32,{0xD4,0x0F,0x1F,0x2F,0x3F,0x4F,0x5F,0x6F,0x7F,0x90,0xA0,0xB0,0xC0,0xD0,0xE0,0xE8,0xEC,0xED,0xEE,0xEF,0xF0,0xF1,0xF3,0xF5,0xF7,0xF9,0xFB,0xFB,0xFC,0xFD,0xFE,0xFF}},
	{0xF1, 2,{0x5A,0x59}},
	{0xF0, 2,{0xA5,0xA6}},
	{0x53, 1,{0x2c}},        //dimming
	{0x55, 1,{0x01}},
...
static void lcm_dfps_int(struct LCM_DSI_PARAMS *dsi)
{
	...
	dfps_params[0].PLL_CLOCK_dyn = 453;
	dfps_params[0].horizontal_frontporch_dyn = 35;
	dfps_params[0].vertical_frontporch_dyn = 1267;
	...
	dfps_params[1].PLL_CLOCK_dyn = 453;
	dfps_params[1].horizontal_frontporch_dyn = 35;
	dfps_params[1].vertical_frontporch_dyn = 300;
	dfps_params[1].vertical_frontporch_for_low_power_dyn = 0;*/
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch = 1248;
...
//	lcd_bias_set_vspn(1, 0, BIAS_OUT_VALUE); /* Set the output voltage to 6v */
	...
	SET_RESET_PIN(0);
	MDELAY(2);
	pr_info("lcm icnl9916 bias enable!\n");
...
static int lcm_bias_disable(void)
{
	...
	pr_info("lcm icnl9916 bias disable!\n");
...
static void lcm_init(void)
{
	...
	LCM_LOGI(
		"lcm icnl9916 dsi mode=vdo mode:%d\n", lcm_dsi_mode);
}
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	LCM_LOGI("%s, lcm icnl9916 backlight: normal brightness_level = %d\n", __func__, brightness_level);
	push_table(handle, bl_level, ARRAY_SIZE(bl_level), 1);
}
...
static unsigned int lcm_compare_id(void)
{
	...
	LCM_LOGI("[LCM NORMAL] lcm icnl9916 id is %x\n", id);

	if (id == LCM_ID_ICNL9916)
		return 1;
	else
		return 0;
}

struct LCM_DRIVER icnl9916_hdp_dsi_vdo_tm_lcm_drv = {
	.name = "icnl9916_hdp_dsi_vdo_tm",
