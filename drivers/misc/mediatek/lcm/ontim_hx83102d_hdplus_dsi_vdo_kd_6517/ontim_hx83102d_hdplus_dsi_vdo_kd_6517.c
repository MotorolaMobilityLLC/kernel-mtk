 ...
 */
#define LOG_TAG "LCM-hx83102d-kd"
...
static struct LCM_setting_table init_setting[] = {
	...
	{0xB1, 0x0B, {0x22,0x22,0x27,0x27,0x31,0x42,0x52,0x39,0x08,0x08,0x08}},
	{0xB2, 0x0E, {0x00,0x00,0x06,0x40,0x00,0x0E,0xBA,0x36,0x00,0x00,0x00,0x00,0xF4,0xE0}},
	{0xB4, 0x0E, {0x01,0x58,0x01,0x58,0x56,0x56,0x56,0x56,0x01,0xFF,0x01,0x20,0x00,0xFF}},
	{0xCC, 0x01, {0x02}},
	{0xD3, 0x19, {0x00,0x00,0x00,0x00,0x00,0x10,0x00,0x27,0x00,0x63,0x37,0x0D,0x0D,0x00,0x00,0x32,0x10,0x08,0x00,0x08,0x32,0x16,0x4E,0x06,0x4E}},
	{REGFLAG_DELAY, 5, {}},
	...
	{0xBD, 0x01, {0x03}},
	{0xD8, 0x18, {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{0xBD, 0x01, {0x00}},
	{0xBA, 0x13, {0x70,0x23,0xA8,0x93,0xB2,0xC0,0xC0,0x01,0x10,0x00,0x00,0x00,0x0D,0x3D,0x82,0x77,0x04,0x01,0x00}},
	{0xBD, 0x01, {0x01}},
	{0xCB, 0x01, {0x01}},
	{0xBD, 0x01, {0x00}},
	{0xCB, 0x05, {0x00,0x53,0x00,0x02,0x5A}},
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch = 186; //old is 24,now is 124
	params->dsi.vertical_active_line = FRAME_HEIGHT;
	params->dsi.horizontal_sync_active = 9; //old is 20,now is 8
	params->dsi.horizontal_backporch = 29;//old is 60,now is 12
	params->dsi.horizontal_frontporch = 17;//old is 60,now is 16
	params->dsi.horizontal_active_pixel = FRAME_WIDTH;
	params->dsi.PLL_CLOCK = 296;    /* FrameRate = 60Hz */ /* this value must be in MTK suggested table */
