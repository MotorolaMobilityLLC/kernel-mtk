...
#define MP_LCM_ID1 (unsigned int)(0x22)
...
*/
	...
	{0x41,0x02,{0x5A, 0x2F}},
	//{0x39,0x02,{0x41,0x5A}},
	//{0x39,0x03,{0x41,0x5A,0x19}},
	//{0x39,0x05,{0xA0,0x06,0x06,0x62,0x00}},
	{0x19,0x01,{0x01}},
	{0x51,0x02,{0xff,0x0f}},
	{0x53,0x01,{0x24}},
	{0x55,0x01,{0x00}},
...
static void lcm_init(void)
{
	...
	unsigned char data = 0x14;  //up to +/-6V
	int ret = 0;
...
static unsigned int lcm_compare_id(void)
{
	...
	LCM_LOGI("%s,ft8006s vendor id1 = 0x%08x,id3 = 0x%08x\n", __func__, id1, id3);
...
struct LCM_DRIVER ontim_ft8006s_hdplus_dsi_vdo_jz_lcm_drv = {
	.name = "ontim_ft8006s_hdplus_dsi_vdo_jz",
