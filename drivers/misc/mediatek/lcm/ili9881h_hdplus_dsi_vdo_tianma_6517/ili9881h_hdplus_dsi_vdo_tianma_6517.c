...
{0xD4, 0x01, {0x4D}}, //VGL_C
{0xD5, 0x01, {0x4D}}, //VGL_L
{0xD6, 0x01, {0x4D}}, //VGL_M
{0xD7, 0x01, {0x4D}}, //VGL_H
{0xFF, 0x03, {0x98,0x81,0x06}},
{0x27, 0x01, {0x32}}, //20  20200804
{0x28, 0x01, {0x18}}, //20  20200804
{0xFF, 0x03, {0x98,0x81,0x08}},
{0xE0,   27, {0x00,0x24,0x6A,0x9A,0xD7,0x55,0x09,0x30,0x5E,0x82,0xA5,0xBB,0xE6,0x0F,0x36,0xAA,0x5D,0x8E,0xAD,0xD6,0xFE,0xFA,0x2A,0x66,0x99,0x03,0xFC}},
{0xE1,   27, {0x00,0x24,0x6A,0x9A,0xD7,0x55,0x09,0x30,0x5E,0x82,0xA5,0xBB,0xE6,0x0F,0x36,0xAA,0x5D,0x8E,0xAD,0xD6,0xFE,0xFA,0x2A,0x66,0x99,0x03,0xFC}},
{0xFF, 0x03, {0x98,0x81,0x0E}},
{0x45, 0x01, {0x0B}}, //0B
{0x46, 0x01, {0xD0}}, //5B  20200728
{0x4D, 0x01, {0x8B}}, //8D  20200728
...
static void lcm_suspend(void)
{
	...
	ilitek_tddi_sleep_handler(ILITEK_TP_DEEP_SLEEP);
