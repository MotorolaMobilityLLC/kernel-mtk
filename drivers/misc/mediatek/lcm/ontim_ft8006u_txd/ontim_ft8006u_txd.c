...
static void lcm_suspend(void)
{
    ...
    MDELAY(10);
    LCM_LOGI("%s,ontim_ft8006ulcm_txd_suspend power shut start\n", __func__);
#if defined(GPIO_LCD_BIAS_ENN_PIN)||defined(GPIO_LCD_BIAS_ENP_PIN)
...
#endif
    LCM_LOGI("%s,ontim_ft8006ulcm_txd_suspend power shutted over\n", __func__);
...
LCM_DRIVER ontim_ft8006u_lcm_drv_txd = {
    .name = "ontim_ft8006u_txd",
