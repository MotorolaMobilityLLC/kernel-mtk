...
#define LCM_ID_1 			0x04
#define LCM_ID_2	 		0x12
...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0x11,1, {0x00}},
	{REGFLAG_DELAY,85,{}},
	{0xD5, 48, {0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x2F, 0x2F, 0x30, 0x30, 0x31, 0x31, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x2F, 0x2F, 0x30, 0x30, 0x31, 0x31, 0xC0, 0xC0, 0x25, 0x24, 0x03, 0x02, 0x07, 0x06, 0x01, 0x00, 0x05, 0x04, 0x99, 0x99, 0xC0, 0xC0, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x40, 0x40}},
	{0x35,1,{0x00}},
	{0x51,2,{0x00,0x00}},
	{0x53,1,{0x2C}},
	{0x55,1, {0x01}},
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_frontporch = 952;
...
static unsigned int lcm_compare_id(void)
{
	...
	LCM_LOGI("%s,hx83112a_id=0x%02x%02x%02x%02x\n", __func__,buffer[0], buffer[1],buffer[2],buffer[3]);
...
{
	pr_info("%s,tm_hx83112a cmd:%d, value = %d\n", __func__, *lcm_cmd, *lcm_value);
	...
	switch(*lcm_cmd) {
		...
		case PARAM_CABC:
			...
			break;
		default:
			pr_err("%s,tm_hx83112a cmd:%d, unsupport\n", __func__, *lcm_cmd);
			break;
	}
