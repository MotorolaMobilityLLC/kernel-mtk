//zhangchao@wind-mobi.com add at 20170914 begin
...
static struct LCM_setting_table lcm_initialization_setting[] = {	
	...
	{0x50,1,{0x9F}},         	//VREG1OUT=4.104V
	{0x51,1,{0x9F}},         	//VREG2OUT=-4.106V
	{0x60,1,{0x14}},               //SDT
...
// To fix rf
		...
		params->dsi.HS_TRAIL = 6;       //zhangchao@wind-mobi.com modify 15->17->10->8->6 20171010
...
{
	#ifdef CONFIG_WIND_DEVICE_INFO
	if(!strcmp(g_lcm_name,"ili9881_hd720_dsi_vdo_yashi")){
		return 1;
	}else{
		return -1;
	}
...
LCM_DRIVER ili9881_hd720_dsi_vdo_yashi_lcm_drv =
{
    .name           	= "ili9881_hd720_dsi_vdo_yashi",
...
//zhangchao@wind-mobi.com add at 20170914 end
