...
#if defined(JD9161_FWVGA_DSI_VDO_TXD_HC)
	&jd9161_fwvga_dsi_vdo_txd_hc_lcm_drv,
#endif

#if defined(HS50VC22T6F_FWVGA_DSI_VDO_HS_LONGTENG)
	&hs50vc22t6f_fwvga_dsi_vdo_hs_longteng_lcm_drv,
#endif

#if defined(ILI9806E_FWVGA_DSI_VDO_HLT_HC)
	&ili9806e_fwvga_dsi_vdo_hlt_hc_lcm_drv,
#endif
