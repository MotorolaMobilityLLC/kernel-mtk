...
#if defined(ILI9883A_HDP_DSI_VDO_TXD)
	&ili9883a_hdp_dsi_vdo_txd_lcm_drv,
#endif

 #if defined(TD4160_HDP_DSI_VDO_BOE)
	&td4160_hdp_dsi_vdo_boe_lcm_drv,
#endif

#if defined(ICNL9916_HDP_DSI_VDO_TM)
	&icnl9916_hdp_dsi_vdo_tm_lcm_drv,
#endif

#if defined(ILI7807S_HDP_DSI_VDO_TM)
	&ili7807s_hdp_dsi_vdo_tm_lcm_drv,
#endif

#if defined(TD4160_HDP_DSI_VDO_BOE_TIAOSHI)
        &td4160_hdp_dsi_vdo_boe_tiaoshi_lcm_drv,
#endif
};
