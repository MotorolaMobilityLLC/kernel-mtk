...
static struct LCM_setting_table init_setting[] = {
	...
	{0x03, 0x01, {0x00}}, //VCOM
	{0x04, 0x01, {0xDD}}, //FC //VCOM  -1.4v
	{0x58, 0x01, {0x62}},

	{0x63, 0x01, {0x78}}, //GVDDN -5.0v
	{0x64, 0x01, {0x7A}}, //GVDDP +5.0v
	{0x68, 0x01, {0xAA}}, //VGHO  15v WAVEFORM
	{0x69, 0x01, {0xB1}}, //VGH  16V 
	{0x6A, 0x01, {0x86}}, ////VGLO  -10v   WAVEFORM
	{0x6B, 0x01, {0x78}}, //VGL=-11V
	...
	{0x0F, 0x01, {0x40}},
	{0x11, 0x01, {0x03}},
	{0x13, 0x01, {0x54}},  //+0.25%//40c1
	{0x14, 0x01, {0x41}},
	{0x15, 0x01, {0x01}},  //-0.25%//406e
	{0x16, 0x01, {0x41}},
	...
	{0xE0, 0x27, {0x00, 0x24, 0x6D, 0x9E, 0xDC, 0x55, 0x0E, 0x34, 0x5F, 0x83, 0xA5, 0xBB, 0xE6, 0x0E, 0x34, 0xAA, 0x5D, 0x91, 0xB2, 0xDD, 0xFF, 0x02, 0x30, 0x6A, 0x99, 0x03, 0xFF}},							
	{0xE1, 0x27, {0x00, 0x24, 0x6D, 0x9E, 0xDC, 0x55, 0x0E, 0x34, 0x5F, 0x83, 0xA5, 0xBB, 0xE6, 0x0E, 0x34, 0xAA, 0x5D, 0x91, 0xB2, 0xDD, 0xFF, 0x02, 0x30, 0x6A, 0x99, 0x03, 0xFF}},	


	{0xFF, 0x03, {0x98, 0x81, 0x06}},
	{0xD6, 0x01, {0x85}}, //FTE=TSVD1, FTE1=TSHD
	{0x27, 0x01, {0xFF}},  //Internal VFP 
	{0x28, 0x01, {0x20}},  //Internal VBP
	...
	{0x02, 0x01, {0x0A}},
	{0x01, 0x01, {0x75}},
	{0x40, 0x01, {0x46}},  //SDT=1.3us
	{0x42, 0x01, {0x00}},
	{0x4A, 0x01, {0x08}},
	{0x4D, 0x01, {0x4E}},
	{0x4E, 0x01, {0x00}}, 
	{0x1A, 0x01, {0x48}}, //pump clk 1H

	{0x02, 0x01, {0x90}},    //Internal RTB

	{0xFF, 0x03, {0x98, 0x81, 0x07}},
	{0x0F, 0x01, {0x02}},  //TP_term_GVDD_on         //0525
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch = 244; //old is 24,now is 124
	params->dsi.vertical_active_line = FRAME_HEIGHT;
	params->dsi.horizontal_sync_active = 8; //old is 20,now is 8
	params->dsi.horizontal_backporch = 40;//old is 60,now is 12
...
struct LCM_DRIVER ontim_ili9881h_hdplus_dsi_vdo_skyworth_lcm_drv = {
	.name = "ontim_ili9881h_hdplus_dsi_vdo_skyworth",
