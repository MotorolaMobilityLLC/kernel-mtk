...
#define I2C_ADDR_58_TCPC TCPC_INTERFACE

#define I2C_ADDR_54_PPS_TABLE_AND_MISC RX_P2
#define I2C_ADDR_84_MIPI_RX_ODFC_PLL RX_P1
#define I2C_ADDR_7A_DPTX_ANALOG TX_P1
...
#define  IN_YC_COEFFI       7
	/* reserved in MI-2 */
#define  HDMI_HPD           6
/* dalay one pixel of DE: 1=enabled, 0=disabled */
#define  DE_DELAY           5
