...
struct _timing_mode_from_data_sheet_t {
	uint16_t h_total;
	uint16_t v_total;
...
#define timing_mode_from_data_sheet_t struct _timing_mode_from_data_sheet_t
#define Ptiming_mode_from_data_sheet_t struct _timing_mode_from_data_sheet_t *
...
#define CEA_861_D_VIC_info_entry(VIC, columns, rows, HBlank, VBLank, FieldRate, \
image_aspect_ratio, scanmode, PixelAspectRatio, flags, clocksPerPelShift, AdditionalVBlank) \
	{columns, rows, HBlank, VBLank, FieldRate, \
	{image_aspect_ratio, scanmode, PixelAspectRatio, flags, clocksPerPelShift, AdditionalVBlank } }
VIC_info_t VIC_info[] = {
	CEA_861_D_VIC_info_entry(0,   0,   0,  0, 0,  0000, iar_16_to_10,
		vsm_progressive, par_1_to_1, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(1, 640, 480, 160, 45, 60000, iar_4_to_3,
		vsm_progressive, par_1_to_1, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(2, 720, 480, 138, 45, 60000, iar_4_to_3,
		vsm_progressive, par_8_to_9, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(3, 720, 480, 138, 45, 60000, iar_16_to_9,
	vsm_progressive, par_32_to_27, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(4, 1280, 720, 370, 30, 60000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(5, 1920, 1080, 280, 22, 60000, iar_16_to_9,
	vsm_interlaced, par_1_to_1, vif_dual_frame_rate, 0, 1)
	, CEA_861_D_VIC_info_entry(6, 720, 480, 276, 22, 60000, iar_4_to_3,
	vsm_interlaced, par_8_to_9, vif_dual_frame_rate, 1, 1)
	, CEA_861_D_VIC_info_entry(7, 720, 480, 276, 22, 60000, iar_16_to_9,
	vsm_interlaced, par_32_to_27, vif_dual_frame_rate, 1, 1)
	, CEA_861_D_VIC_info_entry(8, 720, 240, 276, 22, 60000, iar_4_to_3,
	vsm_progressive, par_4_to_9, vif_dual_frame_rate, 1, 1)
	, CEA_861_D_VIC_info_entry(9, 720, 428, 276, 22, 60000, iar_16_to_9,
	vsm_progressive, par_16_to_27, vif_dual_frame_rate, 1, 1)
	, CEA_861_D_VIC_info_entry(10, 2880, 480, 552, 22, 60000, iar_4_to_3,
	vsm_interlaced, par_2_to_9_20_to_9, vif_dual_frame_rate, 0, 1)
	, CEA_861_D_VIC_info_entry(11, 2880, 480, 552, 22, 60000, iar_16_to_9,
	vsm_interlaced, par_8_to_27_80_to_27, vif_dual_frame_rate, 0, 1)
	, CEA_861_D_VIC_info_entry(12, 2880, 240, 552, 22, 60000, iar_4_to_3,
	vsm_progressive, par_1_to_9_10_to_9, vif_dual_frame_rate, 0, 1)
	, CEA_861_D_VIC_info_entry(13, 2880, 240, 552, 22, 60000, iar_16_to_9,
	vsm_progressive, par_4_to_27_40_to_27, vif_dual_frame_rate, 0, 1)
	, CEA_861_D_VIC_info_entry(14, 1440, 480, 276, 45, 60000, iar_4_to_3,
	vsm_progressive, par_4_to_9, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(15, 1440, 480, 276, 45, 60000, iar_16_to_9,
	vsm_progressive, par_16_to_27, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(16, 1920, 1080, 280, 45, 60000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(17, 720, 576, 144, 49, 50000, iar_4_to_3,
	vsm_progressive, par_16_to_15, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(18, 720, 576, 144, 49, 50000, iar_16_to_9,
	vsm_progressive, par_64_to_45, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(19, 1280, 720, 700, 30, 50000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(20, 1920, 1080, 720, 22, 50000, iar_16_to_9,
	vsm_interlaced, par_1_to_1, vif_single_frame_rate, 0, 1)
	, CEA_861_D_VIC_info_entry(21, 720, 576, 288, 24, 50000, iar_4_to_3,
	vsm_interlaced, par_16_to_15, vif_single_frame_rate, 1, 1) /* (1440) */
	, CEA_861_D_VIC_info_entry(22, 720, 576, 288, 24, 50000, iar_16_to_9,
	vsm_interlaced, par_64_to_45, vif_single_frame_rate, 1, 1) /* (1440) */
	, CEA_861_D_VIC_info_entry(23, 720, 288, 288, 24, 50000, iar_4_to_3,
	vsm_progressive, par_8_to_15, vif_single_frame_rate, 1, 2) /* (1440) */
	, CEA_861_D_VIC_info_entry(24, 720, 288, 288, 24, 50000, iar_16_to_9,
	vsm_progressive, par_32_to_45, vif_single_frame_rate, 1, 2) /* (1440) */
	, CEA_861_D_VIC_info_entry(25, 2880, 576, 576, 24, 50000, iar_4_to_3,
	vsm_interlaced, par_2_to_15_20_to_15, vif_single_frame_rate, 0, 1)
	, CEA_861_D_VIC_info_entry(26, 2880, 576, 576, 24, 50000, iar_16_to_9,
	vsm_interlaced, par_16_to_45_160_to_45, vif_single_frame_rate, 0, 1)
	, CEA_861_D_VIC_info_entry(27, 2880, 288, 576, 24, 50000, iar_4_to_3,
	vsm_progressive, par_1_to_15_10_to_15, vif_single_frame_rate, 0, 2)
	, CEA_861_D_VIC_info_entry(28, 2880, 288, 576, 24, 50000, iar_16_to_9,
	vsm_progressive, par_8_to_45_80_to_45, vif_single_frame_rate, 0, 2)
	, CEA_861_D_VIC_info_entry(29, 1440, 576, 288, 49, 50000, iar_4_to_3,
	vsm_progressive, par_8_to_15, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(30, 1440, 576, 288, 49, 50000, iar_16_to_9,
	vsm_progressive, par_32_to_45, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(31, 1920, 1080, 720, 45, 50000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(32, 1920, 1080, 830, 45, 24000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(33, 1920, 1080, 720, 45, 25000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(34, 1920, 1080, 280, 45, 30000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(35, 2880, 480, 552, 45, 60000, iar_4_to_3,
	vsm_progressive, par_2_to_9, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(36, 2880, 480, 552, 45, 60000, iar_16_to_9,
	vsm_progressive, par_8_to_27, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(37, 2880, 576, 576, 49, 50000, iar_4_to_3,
	vsm_progressive, par_4_to_15, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(38, 2880, 576, 576, 49, 50000, iar_16_to_9,
	vsm_progressive, par_16_to_45, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(39, 1920, 1080, 384, 85, 50000, iar_16_to_9,
	vsm_interlaced, par_1_to_1, vif_single_frame_rate, 0, 0) /*1250,total*/
	, CEA_861_D_VIC_info_entry(40, 1920, 1080, 720, 22, 100000, iar_16_to_9,
	vsm_interlaced, par_1_to_1, vif_single_frame_rate, 0, 1)
	, CEA_861_D_VIC_info_entry(41, 1280, 720, 700, 30, 100000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(42, 720, 576, 144, 49, 100000, iar_4_to_3,
	vsm_progressive, par_16_to_15, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(43, 720, 576, 144, 49, 100000, iar_16_to_9,
	vsm_progressive, par_64_to_45, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(44, 720, 576, 288, 24, 100000, iar_4_to_3,
	vsm_interlaced, par_16_to_15, vif_single_frame_rate, 1, 1) /* (1440) */
	, CEA_861_D_VIC_info_entry(45, 720, 576, 288, 24, 100000, iar_16_to_9,
	vsm_interlaced, par_64_to_45, vif_single_frame_rate, 1, 1) /* (1440) */
	, CEA_861_D_VIC_info_entry(46, 1920, 1080, 280, 22, 120000, iar_16_to_9,
	vsm_interlaced, par_1_to_1, vif_dual_frame_rate, 0, 1)
	, CEA_861_D_VIC_info_entry(47, 1280, 720, 370, 30, 120000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(48, 720, 480, 138, 45, 120000, iar_4_to_3,
	vsm_progressive, par_8_to_9, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(49, 720, 480, 138, 45, 120000, iar_16_to_9,
	vsm_progressive, par_32_to_27, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(50, 720, 480, 276, 22, 120000, iar_4_to_3,
	vsm_interlaced, par_8_to_9, vif_dual_frame_rate, 1, 1) /* (1440) */
	, CEA_861_D_VIC_info_entry(51, 720, 480, 276, 22, 120000, iar_16_to_9,
	vsm_interlaced, par_32_to_27, vif_dual_frame_rate, 1, 1) /* (1440) */
	, CEA_861_D_VIC_info_entry(52, 720, 576, 144, 49, 200000, iar_4_to_3,
	vsm_progressive, par_16_to_15, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(53, 720, 576, 144, 49, 200000, iar_16_to_9,
	vsm_progressive, par_64_to_45, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(54, 720, 576, 288, 24, 200000, iar_4_to_3,
	vsm_interlaced, par_16_to_15, vif_single_frame_rate, 1, 1) /* (1440) */
	, CEA_861_D_VIC_info_entry(55, 720, 576, 288, 24, 200000, iar_16_to_9,
	vsm_interlaced, par_64_to_45, vif_single_frame_rate, 1, 1) /* (1440) */
	, CEA_861_D_VIC_info_entry(56, 720, 480, 138, 45, 240000, iar_4_to_3,
	vsm_progressive, par_8_to_9, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(57, 720, 480, 138, 45, 240000, iar_16_to_9,
	vsm_progressive, par_32_to_27, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(58, 720, 480, 276, 22, 240000, iar_4_to_3,
	vsm_interlaced, par_8_to_9, vif_dual_frame_rate, 1, 1) /* (1440) */
	, CEA_861_D_VIC_info_entry(59, 720, 480, 276, 22, 240000, iar_16_to_9,
	vsm_interlaced, par_32_to_27, vif_dual_frame_rate, 1, 1) /* (1440) */
	, CEA_861_D_VIC_info_entry(60, 1280, 720, 370, 30, 24000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(61, 1280, 720, 370, 30, 25000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_single_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(62, 1280, 720, 370, 30, 30000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(63, 1920, 1080, 280, 45, 120000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_dual_frame_rate, 0, 0)
	, CEA_861_D_VIC_info_entry(64, 1920, 1080, 280, 45, 100000, iar_16_to_9,
	vsm_progressive, par_1_to_1, vif_single_frame_rate, 0, 0)
	...
	uint8_t VIC)
{
	...
	if (0 == VIC) {
		...
		vertical_active_period_in_microseconds = (vertical_sync_period_in_microseconds *
	...
	vertical_blank_period_in_microseconds  = vertical_sync_period_in_microseconds -
		vertical_active_period_in_microseconds;
	SLIMPORT_TX_EDID_READ(mhl_edid_3d_data->dev_context,
	...
	if (0 == VIC) {
		...
		horizontal_active_period_in_nanoseconds = (horizontal_sync_period_in_nanoseconds * h_clocks) /
			h_total_in_pixels;
	}
	/* rigorous calculation:*/
	horizontal_blank_period_in_nanoseconds = horizontal_sync_period_in_nanoseconds -
		horizontal_active_period_in_nanoseconds;
	SLIMPORT_TX_EDID_READ(mhl_edid_3d_data->dev_context,
	...
	uint8_t VIC)
{
	...
	if (p_MHL2_video_descriptor_parm == NULL) {
	...
	P_18_byte_descriptor_u p_desc, uint8_t limit)
{
	...
	if (limit) {
		for (i = 0 ; i < limit - 1 ; ++i) {
			if ((p_desc->dtd.pixel_clock_low != 0) || (p_desc->dtd.pixel_clock_high != 0)) {
				if ((p_desc->dtd.horz_active_7_0 == 0) &&
	...
	PMHL2_video_descriptor_t pMHL2_video_descriptor)
{
	...
	*p_is_timing = 0;
	...
	/*  18 byte partition is used as either for Monitor Name or*/
	/* for Monitor Range Limits or it is unused */
	if (tmp_word == 0x00) {
		/*  if called from Block #0 and first 2 bytes are 0 => either Monitor Name*/
		/*or for Monitor Range Limits */
		if (Block == EDID_BLOCK_0) {
			if (p_desc->name.data_type_tag == 0xFC) {
				SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
				"Monitor Name: ");
				...
				SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context, "\n");
			} else if (p_desc->name.data_type_tag == 0xFD) {
				SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
		...
		uint32_t vertical_refresh_rate_in_milliHz, horizontal_sync_frequency_in_Hz,
		...
		*p_is_timing = 1;
		...
		tmp_word = p_desc->dtd.horz_blanking_7_0 + 256 *
		...
		tmp_word = p_desc->dtd.vert_blanking_7_0 +
			256 * p_desc->dtd.vert_active_blanking_high.vert_blanking_11_8;
		SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
		"Vertical Blanking (Lines): %u\n", tmp_word);

		vertical_sync_period_in_lines = rows + tmp_word;
		vertical_refresh_rate_in_milliHz = horizontal_sync_frequency_in_Hz * 1000 /
		...
		tmp_word = p_desc->dtd.horz_sync_offset_7_0 + 256 *
			p_desc->dtd.hs_offset_hs_pulse_width_vs_offset_vs_pulse_width.horzSyncOffset9_8;
		SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
		"Horizontal Sync Offset (Pixels): %d\n", tmp_word);
		if (v_edid_timing.timing_id == 0)
			v_edid_timing.timing_info.MIPI_H_Front_Porch = tmp_word;

		tmp_word = p_desc->dtd.horz_sync_pulse_width7_0 + 256 *
			p_desc->dtd.hs_offset_hs_pulse_width_vs_offset_vs_pulse_width.horz_sync_pulse_width_9_8;
		SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
		"Horizontal Sync Pulse Width (Pixels): %d\n", tmp_word);
		if (v_edid_timing.timing_id == 0)
			v_edid_timing.timing_info.MIPI_H_Sync_Width = tmp_word;

		tmp_word = p_desc->dtd.vert_sync_offset_width.vert_sync_offset_3_0 +
			16 * p_desc->dtd.hs_offset_hs_pulse_width_vs_offset_vs_pulse_width.vert_sync_offset_5_4;
		SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
		"Vertical Sync Offset (Lines): %d\n", tmp_word);
		if (v_edid_timing.timing_id == 0)
			v_edid_timing.timing_info.MIPI_V_Front_Porch = tmp_word;
		...
		if (v_edid_timing.timing_id == 0)
			v_edid_timing.timing_info.MIPI_V_Sync_Width = tmp_word;
		...
		if (v_edid_timing.timing_id == 0) {
			v_edid_timing.MIPI_pixel_frequency = pixel_clock_frequency;
			v_edid_timing.timing_info.MIPI_HActive = columns;
			v_edid_timing.timing_info.MIPI_HTOTAL = horizontal_sync_period_in_pixels;
			v_edid_timing.timing_info.MIPI_VActive = rows;
			v_edid_timing.timing_info.MIPI_VTOTAL = vertical_sync_period_in_lines;

	v_edid_timing.timing_info.MIPI_H_Back_Porch =
		v_edid_timing.timing_info.MIPI_HTOTAL - v_edid_timing.timing_info.MIPI_HActive -
		v_edid_timing.timing_info.MIPI_H_Front_Porch - v_edid_timing.timing_info.MIPI_H_Sync_Width;

	v_edid_timing.timing_info.MIPI_V_Back_Porch =
		v_edid_timing.timing_info.MIPI_VTOTAL - v_edid_timing.timing_info.MIPI_VActive -
		v_edid_timing.timing_info.MIPI_V_Front_Porch - v_edid_timing.timing_info.MIPI_V_Sync_Width;

			v_edid_timing.timing_id = 0x0f;
		}
		...
		case 0:
			...
			break;
		case 1:
			if (p_desc->dtd.flags.stereo_bit_0 == 0) {
				SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
		...
		if (pMHL2_video_descriptor) {
			...
			/*
			*
			if ((this_mode_doable=qualify_pixel_clock_for_mhl(
				(void*)mhl_edid_3d_data,pixel_clock_frequency,24))) {
			...
			if (this_mode_doable |=qualify_pixel_clock_for_mhl(
				(void*)mhl_edid_3d_data,pixel_clock_frequency,16)) {
				display_timing_enumeration_callback(mhl_edid_3d_data, columns,
...
static uint8_t si_mhl_tx_parse_861_long_descriptors(edid_3d_data_p mhl_edid_3d_data,uint8_t *p_EDID_block_data)
{
	...
	if (!p_CEA_extension->byte_offset_to_18_byte_descriptors) {
		...
		p_data_u.p_long_descriptors = (P_18_byte_descriptor_u)(((uint8_t *)p_CEA_extension) +
		...
		while ((uint8_t *)(p_data_u.p_long_descriptors + 1) < puc_next_block) {
			...
			if (!si_mhl_tx_parse_detailed_timing_descriptor(mhl_edid_3d_data,
				p_data_u.p_long_descriptors, EDID_BLOCK_2_3, &is_timing, NULL)) {
				break;
			}
...
static void si_mhl_tx_prune_edid(edid_3d_data_p mhl_edid_3d_data)
{
	...
	if (p_CEA_extension->tag == EDID_EXTENSION_BLOCK_MAP) {
	...
	if (mhl_edid_3d_data->parse_data.p_HDMI_vsdb) {
		PHDMI_LLC_vsdb_payload_t p_HDMI_vendor_specific_payload =
			&mhl_edid_3d_data->parse_data.p_HDMI_vsdb->payload_u.HDMI_LLC;
		uint8_t *p_next_db = (uint8_t *)p_HDMI_vendor_specific_payload +
			mhl_edid_3d_data->parse_data.p_HDMI_vsdb->header.fields.length_following_header;
	...
	dtd_limit = sizeof(p_EDID_block_0->detailed_timing_descriptors) /
		sizeof(p_EDID_block_0->detailed_timing_descriptors[0]);
	si_mhl_tx_prune_dtd_list(mhl_edid_3d_data,
		(P_18_byte_descriptor_u)&p_EDID_block_0->detailed_timing_descriptors[0], dtd_limit);
	DUMP_EDID_BLOCK(0, p_EDID_block_0, sizeof(*p_EDID_block_0)); /* no semicolon needed here */
	...
	dtd_limit = (uint8_t)
	p_CEA_extension->version_u.version3.misc_support.total_number_detailed_timing_descriptors_in_entire_EDID;
	...
	if (mhl_edid_3d_data->parse_data.p_3d_mask) {
		uint8_t lower_mask;
		uint32_t mask32;
		int8_t index = mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[0]->
		...
		for (
			...
			if (mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[0]->short_descriptors[index].VIC == 0) {
	...
	if (mhl_edid_3d_data->parse_data.p_three_d) {
		...
		uint8_t limit_2D_VIC = mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[0]->
		...
		*/
		...
		while (p_3D_u.p_as_bytes < mhl_edid_3d_data->parse_data.p_3d_limit) {
			...
			VIC = mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[0]->
		...
		mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->byte14.HDMI_3D_len       -=
			num_3D_structure_bytes_pruned;
		p_CEA_extension->byte_offset_to_18_byte_descriptors               -=
			num_3D_structure_bytes_pruned;
		mhl_edid_3d_data->parse_data.p_HDMI_vsdb->header.fields.length_following_header -=
	...
	if (mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15) {
		...
		if (length_VIC == 0) {
			...
			for (i = 0; i < outer_loop_limit;) {
				if (mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->vicList[i] == 0) {
					uint8_t j, prev;
			...
			/* check the last one */
			if (mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->vicList[outer_loop_limit] == 0) {
				num_HDMI_VICs_pruned++;
				inner_loop_limit--;
			}
			...
			if (num_HDMI_VICs_pruned) {
				uint8_t *pb_dest  = (uint8_t *)&mhl_edid_3d_data->
					parse_data.p_byte_13_through_byte_15->vicList[inner_loop_limit];
				uint8_t *pb_src   = (uint8_t *)&mhl_edid_3d_data->
					parse_data.p_byte_13_through_byte_15->vicList[length_VIC];

				SII_ASSERT(sizeof(*p_CEA_extension) == EDID_BLOCK_SIZE,
			...
			if (mhl_edid_3d_data->parse_data.p_HDMI_vsdb)
				mhl_edid_3d_data->parse_data.p_HDMI_vsdb->
					header.fields.length_following_header -= num_HDMI_VICs_pruned;
			else if (num_HDMI_VICs_pruned)
				SLIMPORT_TX_DBG_ERR(,
					"How can you have HDMI vics to prune if you have no HDMI VSDB?\n");
	...
	/* Now prune the SVD list and move the CEA 861-D data blocks and DTDs up */
	{
		...
		for (vdb_index = mhl_edid_3d_data->parse_data.num_video_data_blocks - 1
			...
			uint8_t inner_loop_limit = mhl_edid_3d_data->
				parse_data.p_video_data_blocks_2d[vdb_index]->header.fields.length_following_header;

			if (inner_loop_limit) {
				uint8_t outer_loop_limit = inner_loop_limit - 1;

				for (i = 0; i < outer_loop_limit;) {
					if (mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[vdb_index]->
						short_descriptors[i].VIC == 0) {
						uint8_t j, prev;
			...
			for (prev = i, j = i + 1; j < inner_loop_limit; ++j, ++prev) {
				...
				VIC0 = mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[vdb_index]->
					short_descriptors[prev].VIC;
				VIC1 = mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[vdb_index]->
		...
		/* check the last one */
		if (mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[vdb_index]->
			short_descriptors[outer_loop_limit].VIC == 0) {
			num_CEA_VICs_pruned++;
			inner_loop_limit--;
			mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[vdb_index]->
				short_descriptors[outer_loop_limit].native = 0;
		}
		...
		{
			uint8_t *pb_dest = (uint8_t *)&mhl_edid_3d_data->
				parse_data.p_video_data_blocks_2d[vdb_index]->short_descriptors[inner_loop_limit];
			uint8_t *pb_src = (uint8_t *)&mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[vdb_index]->
				short_descriptors[mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[vdb_index]->
				header.fields.length_following_header];
		...
		mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[vdb_index]->
			header.fields.length_following_header = inner_loop_limit;
	...
	SII_ASSERT(sizeof(*p_EDID_block_0) == EDID_BLOCK_SIZE, ("\n\n unexpected size for block 0\n\n"));
	...
	/*
	*
		can be optimized: adjust all pointers into the EDID along the way of pruning the contents,
		instead of re-parsing here
	*/
#ifndef EDID_PASSTHROUGH /*(*/
	if (si_mhl_tx_drv_set_upstream_edid(mhl_edid_3d_data->drv_context == 0,
	...
	PMHL2_video_descriptor_t p_mhl2_video_descriptor)
{
	...
	if (VIC > 0) {
		ret_val = is_MHL_timing_mode(mhl_edid_3d_data, VIC_info[VIC].columns, VIC_info[VIC].rows,
			VIC_info[VIC].field_rate_in_milliHz, p_mhl2_video_descriptor, VIC);
		if (VIC_info[VIC].fields.frame_rate_info == vif_dual_frame_rate) {
			...
			ret_val |= is_MHL_timing_mode(mhl_edid_3d_data, VIC_info[VIC].columns,
				VIC_info[VIC].rows, field_rate_in_milliHz, p_mhl2_video_descriptor, VIC);
		}
	}
	return ret_val;
}
	...
	if (mhl_edid_3d_data->parse_data.p_HDMI_vsdb) {
		...
		if (mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15) {
			if (((uint8_t *)&mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->byte13) < p_next_db) {
				uint8_t hdmi3D_present = mhl_edid_3d_data->
					parse_data.p_byte_13_through_byte_15->byte13._3D_present;
				uint8_t hdmi_3D_multi_present = mhl_edid_3d_data->
					parse_data.p_byte_13_through_byte_15->byte13._3D_multi_present;

				/*  if HDMI_VIC_len is present... */
				if (((uint8_t *)&mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->byte14) <
					p_next_db) {
					uint8_t length_VIC;
					uint8_t index;
					...
					length_VIC =  mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->
						byte14.HDMI_VIC_len;
					...
					if (!is_qualified_mhl_hdmi_vic(mhl_edid_3d_data, VIC, &mhl2_video_descriptor)) {
						SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
						"'can't do HDMI VIC:%d\n", (uint16_t)VIC);
						mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->vicList[index] =
							0;
					}
					}
					if (hdmi3D_present) {
						uint8_t length_3D;
						PHDMI_3D_sub_block_t pThree3DSubBlock =
							(PHDMI_3D_sub_block_t)&mhl_edid_3d_data->
							parse_data.p_byte_13_through_byte_15->vicList[length_VIC];
						union {
							P_3D_structure_and_detail_entry_u            p_3D;
							P_3D_structure_and_detail_entry_sans_byte1_t   p_sans_byte_1;
						...
						p_3D_u.p_3D = NULL;
						length_3D  =  mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->
							byte14.HDMI_3D_len;
						limit = mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[vdb_index]->
							header.fields.length_following_header;
				...
				case 0x00:
					...
					p_3D_u.p_3D = &pThree3DSubBlock->
						hDMI_3D_sub_block_sans_all_AND_mask._3D_structure_and_detail_list[0];
					break;
				case 0x01:
					/*
					*
					...
					*/
				{
					P_3D_structure_all_t p_3D_structure_all =
						(P_3D_structure_all_t)&mhl_edid_3d_data->
						parse_data.p_byte_13_through_byte_15->vicList[length_VIC];
					mhl2_video_descriptor.left_right = p_3D_structure_all->
						_3D_structure_all_7_0.side_by_side;
					mhl2_video_descriptor.top_bottom = p_3D_structure_all->
						_3D_structure_all_15_8.top_bottom;
					mhl2_video_descriptor.frame_sequential = p_3D_structure_all->
						_3D_structure_all_15_8.frame_packing;
					DUMP_EDID_BLOCK(0, (PCEA_extension_t)&mhl_edid_3d_data->
						EDID_block_data[EDID_BLOCK_SIZE], EDID_BLOCK_SIZE);
						/* no semicolon needed here */
					for (index = 0; index < limit; ++index) {
						uint8_t VIC;

				VIC = mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[vdb_index]->
				...
				p_3D_u.p_3D = &pThree3DSubBlock->
					HDMI_3D_sub_block_sans_mask._3D_structure_and_detail_list[0];
				break;
				case 0x02:
					/*
					*
				...
				p_3D_u.p_3D = &pThree3DSubBlock->
					HDMI_3D_sub_block_with_all_AND_mask._3D_structure_and_detail_list[0];
...
)
{
	...
	SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
		"burstEntryCount3D_VIC: %d\n", mhl_edid_3d_data->parse_data.burst_entry_count_3d_vic);

	if (mhl_edid_3d_data->parse_data.flags.parse_3d_in_progress) {
		/* check to see if it's time to move on to the next block */
		if (mhl_edid_3d_data->parse_data.vic_2d_index >= mhl_edid_3d_data->
			parse_data.p_video_data_blocks_2d[mhl_edid_3d_data->parse_data.video_data_block_index]->
			header.fields.length_following_header) {
			mhl_edid_3d_data->parse_data.video_data_block_index++;
			if (mhl_edid_3d_data->parse_data.video_data_block_index >=
		...
		if (mhl_edid_3d_data->parse_data.burst_entry_count_3d_vic < mhl_edid_3d_data->
			parse_data.p_video_data_blocks_2d[mhl_edid_3d_data->parse_data.video_data_block_index]->
			header.fields.length_following_header) {
			...
			if (mhl_edid_3d_data->parse_data.vic_2d_index >= mhl_edid_3d_data->
				...
				header.fields.length_following_header) {
				mhl_edid_3d_data->parse_data.video_data_block_index++;
				if (mhl_edid_3d_data->parse_data.video_data_block_index >= mhl_edid_3d_data->
					parse_data.num_video_data_blocks) {
					SET_3D_FLAG(mhl_edid_3d_data, FLAGS_BURST_3D_VIC_DONE)
					break;
				}
			}
				...
				VIC = mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[mhl_edid_3d_data->
					parse_data.video_data_block_index]->
					short_descriptors[mhl_edid_3d_data->parse_data.vic_2d_index].VIC;
				...
				this_mode_doable = IsQualifiedMhlVIC(mhl_edid_3d_data, VIC, p_mhl2_video_descriptor);
					...
					SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
						...
						parse_data.video_data_block_index]->
						short_descriptors[mhl_edid_3d_data->parse_data.vic_2d_index].VIC = 0;
					}
				}
			}
			DUMP_EDID_BLOCK(0, (PCEA_extension_t)&mhl_edid_3d_data->
...
void si_mhl_tx_process_3d_dtd_burst(void *context, PMHL2_video_format_data_t p_write_burst_data)
{
	...
	uint8_t is_timing = 0;
	PCEA_extension_t p_CEA_extension = (PCEA_extension_t)&mhl_edid_3d_data->EDID_block_data[EDID_BLOCK_SIZE];
	uint8_t dtd_limit = (uint8_t)p_CEA_extension->
		version_u.version3.misc_support.total_number_detailed_timing_descriptors_in_entire_EDID;
		...
		if (!TEST_3D_FLAG(mhl_edid_3d_data, FLAGS_BURST_3D_DTD_VESA_DONE)) {
			...
			*/
			for (/* burst_index is set to zero above */
			    ...
			    sizeof(p_EDID_block_0->detailed_timing_descriptors[0]))
			    ; ++mhl_edid_3d_data->parse_data.vesa_dtd_index) {
				P_18_byte_descriptor_u p_desc = (P_18_byte_descriptor_u)&p_EDID_block_0->
					detailed_timing_descriptors[mhl_edid_3d_data->parse_data.vesa_dtd_index];
				bool is_valid = 0;
			...
			if (is_timing) {
				if (is_valid) {
					...
					, (uint16_t)mhl_edid_3d_data->parse_data.vesa_dtd_index, (uint16_t)burst_index
			...
			if (mhl_edid_3d_data->parse_data.vesa_dtd_index >=
				...
				? "3D DTD descriptors exhausted" : "more VESA DTDs to process");
				return;
			}
		}
		{
			PCEA_extension_t p_CEA_extension = (PCEA_extension_t)&mhl_edid_3d_data->
			...
			p_data_u.p_long_descriptors =
				(P_18_byte_descriptor_u)(((uint8_t *)p_CEA_extension) +
				p_CEA_extension->byte_offset_to_18_byte_descriptors);
SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
"burst_index:%d\n 3d_dtd:%d\n this_burst:%d\n total_entries:%d\n dtd_limit:%d\n descriptors:0x%x\n"
	, burst_index
	...
	, p_CEA_extension->byte_offset_to_18_byte_descriptors
			...
			for (/* burst_index is set to zero above */
				...
				P_18_byte_descriptor_u p_desc = &p_data_u.p_long_descriptors[mhl_edid_3d_data->
					parse_data.cea_861_dtd_index];
				bool is_valid = 0;

				p_mhl2_video_descriptor = &p_write_burst_data->video_descriptors[burst_index];
				is_valid = si_mhl_tx_parse_detailed_timing_descriptor(mhl_edid_3d_data, p_desc,
					EDID_BLOCK_2_3, &is_timing, p_mhl2_video_descriptor);
				/* only count it if it's a valid timing */
				if (is_timing) {
					...
					if (is_valid) {
						...
						, (uint16_t)mhl_edid_3d_data->parse_data.cea_861_dtd_index,
						(uint16_t)burst_index,
						(uint16_t)mhl_edid_3d_data->parse_data.burst_entry_count_3d_dtd
						, p_mhl2_video_descriptor->left_right ? psz_left_right : psz_space
						, p_mhl2_video_descriptor->top_bottom ? psz_top_bottom : psz_space
						, p_mhl2_video_descriptor->frame_sequential ?
...
#define DUMP_OFFSET(s, m) \
	SLIMPORT_TX_EDID_INFO(NULL, STRINGIZE(m)" offset:%lx\n", SII_OFFSETOF(s, m))
...
if (p_EDID_block_0->group.et##width##x##height##_##refresh##progressive) { \
	SLIMPORT_TX_EDID_INFO(NULL, STRINGIZE(group)"."STRINGIZE(width)"x" \
...
static void si_mhl_tx_parse_established_timing(
	edid_3d_data_t *mhl_edid_3d_data,
	EDID_block0_t *p_EDID_block_0)
{
/*
*
...
*/
	...
	SLIMPORT_TX_EDID_INFO(NULL, "Parsing Established Timing:\n");
	SLIMPORT_TX_EDID_INFO(NULL, "===========================\n");

	/* Parse Established Timing Byte #0 */
	DUMP_OFFSET(EDID_block0_t, established_timings_I);
	...
	DUMP_OFFSET(EDID_block0_t, established_timings_II);
	...
	DUMP_OFFSET(EDID_block0_t, manufacturers_timings);
	...
	if ((!p_EDID_block_0->header_data[0]) &&
		...
		SLIMPORT_TX_EDID_INFO(NULL, "No established video modes\n");
	}
}
	...
	EDID_block0_t *p_EDID_block_0)
{
	...
	SLIMPORT_TX_EDID_INFO(NULL, "Parsing Standard Timing:\n");
	SLIMPORT_TX_EDID_INFO(NULL, "========================\n");
	...
	for (i = 0;
		...
		if ((1 ==
			 ...
			 */
			SLIMPORT_TX_EDID_INFO(NULL, "Standard Timing Undefined\n");
		} else {
			...
			SLIMPORT_TX_EDID_INFO
			    (NULL, "Aspect Ratio: %5s %4d x %4d at %3d Hz.\n",
			...
			if (!is_MHL_timing_mode
			    (mhl_edid_3d_data, horz_active, vert_active,
			     refresh_rate_in_milliHz, NULL, 0)) {
				/* disable this mode */
				p_EDID_block_0->standard_timings[i].
				...
				SLIMPORT_TX_EDID_INFO(NULL, "Disabled\n\n");
			}
		}
	}
}
	...
	EDID_block0_t *p_EDID_block_0)
{
	...
	for (i = 0; i <
		...
		SLIMPORT_TX_EDID_INFO
		    (NULL, "EDID Block #0, Detailed Descriptor Number %d:\n", (int)i);
		SLIMPORT_TX_EDID_INFO
		    (NULL, "============================================\n\n");

		si_mhl_tx_parse_detailed_timing_descriptor(mhl_edid_3d_data,
			(_18_byte_descriptor_u *) &p_EDID_block_0->
...
static void SiiMhlTx3dReqForNonTranscodeMode(edid_3d_data_p mhl_edid_3d_data)
{
	...
	if (mhl_edid_3d_data->parse_data.HDMI_sink) {
		if (si_get_peer_mhl_version(mhl_edid_3d_data->dev_context) >= 0x20) {
			SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
...
#endif /*)*/
			{
			/* EDID read need to be done in SW TPI mode, as it is done now,
			* switch back to default TPI mode: HW TPI mode
			*/
			si_mhl_tx_drv_set_hw_tpi_mode(mhl_edid_3d_data->drv_context, true);
...
uint8_t CA; /*Channel/Speaker Allocation.*/
	...
	, uint8_t *p_EDID_block_data)
{
	...
	if (p_CEA_extension->tag != EDID_EXTENSION_TAG) {
		SLIMPORT_TX_DBG_ERR(mhl_edid_3d_data->dev_context,
		...
		if (p_CEA_extension->revision != EDID_REV_THREE) {
			SLIMPORT_TX_DBG_ERR(mhl_edid_3d_data->dev_context,
			...
			mhl_edid_3d_data->parse_data.underscan   =
				p_CEA_extension_version_3->misc_support.underscan_IT_formats_by_default ? 1 : 0;
			...
			*((uint8_t *)&p_CEA_extension_version_3->misc_support));
			...
			if (mhl_edid_3d_data->parse_data.YCbCr_4_4_4) {
				si_mhl_tx_drv_set_output_color_space(mhl_edid_3d_data->drv_context,
					BIT_EDID_FIELD_FORMAT_YCbCr444);
			} else if (mhl_edid_3d_data->parse_data.YCbCr_4_2_2) {
				si_mhl_tx_drv_set_output_color_space(mhl_edid_3d_data->drv_context,
					BIT_EDID_FIELD_FORMAT_YCbCr422);
			} else {
				si_mhl_tx_drv_set_output_color_space(mhl_edid_3d_data->drv_context,
					BIT_EDID_FIELD_FORMAT_HDMI_TO_RGB);
			}
#endif	/*	NEVER*/

			p_data_u.puc_data_block = &p_CEA_extension->
				version_u.version3.Offset4_u.data_block_collection[0];
			...
			while (p_data_u.puc_data_block < puc_long_descriptors) {
				...
				case DBTC_VIDEO_DATA_BLOCK:
					...
					if (mhl_edid_3d_data->parse_data.num_video_data_blocks <
						NUM_VIDEO_DATA_BLOCKS_LIMIT) {
						mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[
							mhl_edid_3d_data->parse_data.num_video_data_blocks] =
							(p_video_data_block_t)p_data_u.puc_data_block;

				/* each SVD is 1 byte long */
				while (i < data_block_length) {
					uint8_t VIC;

					VIC = mhl_edid_3d_data->parse_data.p_video_data_blocks_2d[
						mhl_edid_3d_data->parse_data.num_video_data_blocks]->
				...
				case DBTC_AUDIO_DATA_BLOCK: {
					Paudio_data_block_t p_audio_data_block =
						(Paudio_data_block_t) p_data_u.puc_data_block;
					...
					while (i < data_block_length /
						sizeof(p_audio_data_block->short_audio_descriptors[0])) {
	...
	AudioFormatCode = p_audio_data_block->short_audio_descriptors[i].audio_format_code;
					...
					if (AudioFormatCode == 1) {
						MAX_channel = (uint8_t)p_audio_data_block->
							short_audio_descriptors[i].max_channels_minus_one + 1;
						pr_info("\nMax N of channels %d\n", MAX_channel);
						pr_info("\nFs:\n");
				...
				if (AudioFormatCode == 1) {
					...
					if (p_audio_data_block->short_audio_descriptors[i].
						byte3.audio_code_1_LPCM.res_16_bit) {
						pr_info("16bits\n");
						Samplebit = 16;
						Cap_Samplebit = HDMI_BITWIDTH_16;
					}
					if (p_audio_data_block->short_audio_descriptors[i].
						byte3.audio_code_1_LPCM.res_20_bit) {
						pr_info("20\n");
						Samplebit = 20;
						Cap_Samplebit = HDMI_BITWIDTH_20;
					}
					if (p_audio_data_block->short_audio_descriptors[i].
						byte3.audio_code_1_LPCM.res_24_bit) {
						pr_info("24bits\n");
						Samplebit = 24;
				...
				case DBTC_SPEAKER_ALLOCATION_DATA_BLOCK: {
					Pspeaker_allocation_data_block_t p_speaker_allocation_data_block =
						(Pspeaker_allocation_data_block_t) p_data_u.puc_data_block;

	*((Pspeaker_allocation_flags_t)&mhl_edid_3d_data->parse_data.speaker_alloc[i++]) =
			p_speaker_allocation_data_block->payload.speaker_alloc_flags;
			...
			pr_info("EDID -> Short Descriptor Speaker Allocation Block\n");
			{
				...
				case ETC_VIDEO_CAPABILITY_DATA_BLOCK: {
					Pvideo_capability_data_block_t p_video_capability_data_block =
						(Pvideo_capability_data_block_t)p_data_u.puc_data_block;
					Pvideo_capability_data_payload_t p_payload =
						&p_video_capability_data_block->payload;
					mhl_edid_3d_data->parse_data.video_capability_flags = *((uint8_t *)p_payload);
					mhl_edid_3d_data->parse_data.p_video_capability_data_block =
				...
				case ETC_COLORIMETRY_DATA_BLOCK: {
					Pcolorimetry_data_block_t p_colorimetry_data_block =
						(Pcolorimetry_data_block_t)p_data_u.puc_data_block;
					Pcolorimetry_data_payload_t p_payload =
						&p_colorimetry_data_block->payload;
					mhl_edid_3d_data->parse_data.colorimetry_support_flags =
				...
				case DBTC_VENDOR_SPECIFIC_DATA_BLOCK: {
					...
					uint8_t *puc_next_db = ((uint8_t *)&p_vsdb->header) +
						sizeof(p_vsdb->header) + data_block_length;
					uint8_t SP_4k_VIC[5] = { 0};
					uint8_t i = 0;
					/*#ifdef CONFIG_MTK_HDMI_3D_SUPPORT*/
				...
				if ((p_vsdb->IEEE_OUI[0] == 0x03)
					...
					SII_ASSERT(data_block_length >= 5, ("unexpected data_block_length\n"));
					mhl_edid_3d_data->parse_data.HDMI_sink = true;
					*((PHDMI_LLC_BA_t)&mhl_edid_3d_data->parse_data.CEC_A_B) =
						p_HDMI_vendor_specific_payload->B_A;   /* CEC Physical address */
					*((PHDMI_LLC_DC_t)&mhl_edid_3d_data->parse_data.CEC_C_D) =
						p_HDMI_vendor_specific_payload->D_C;
				...
				if (p_HDMI_vendor_specific_payload->byte8.latency_fields_present) {
					if (p_HDMI_vendor_specific_payload->byte8.I_latency_fields_present) {
						mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15 =
							&p_HDMI_vendor_specific_payload->
							vsdb_fields_byte_9_through_byte_15.
							vsdb_all_fields_byte_9_through_byte_15.byte_13_through_byte_15;
					} else {
						mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15 =
							&p_HDMI_vendor_specific_payload->
							vsdb_fields_byte_9_through_byte_15.
				...
				if  (((uint8_t *)&mhl_edid_3d_data->parse_data.
					p_byte_13_through_byte_15->byte13) >= puc_next_db) {
					mhl_edid_3d_data->parse_data._3D_supported = false;
				} else if (mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->
					byte13._3D_present) {
				...
				if	(mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->
					byte14.HDMI_VIC_len) {
					for (i = 0; i < mhl_edid_3d_data->parse_data.p_byte_13_through_byte_15->
						byte14.HDMI_VIC_len && i < 5; i++) {
						SP_4k_VIC[i] = mhl_edid_3d_data->
							parse_data.p_byte_13_through_byte_15->vicList[i];
					if (SP_4k_VIC[i] == 1)
						Notify_AP_MHL_TX_Event(SLIMPORT_TX_EVENT_EDID_UPDATE,
							HDMI_4k30_DSC, NULL);
					/*update_av_info_edid(true, HDMI_4k30_DSC, 0);*/
					else if ((SP_4k_VIC[i] == 3) || (SP_4k_VIC[i] == 4))
						Notify_AP_MHL_TX_Event(SLIMPORT_TX_EVENT_EDID_UPDATE,
							HDMI_4k24_DSC, NULL);
			/*		update_av_info_edid(true, HDMI_4k24_DSC, 0);*/
					...
					SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
						"check VS IEEE code failed!\n");
					SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
						"00:%02X, 01:%02X, 02:%02X\n",
				...
				p_data_u.puc_data_block += sizeof(p_data_u.p_CEA_data_block->header)
					+ data_block_length;
			}
...
static uint8_t parse_861_block(edid_3d_data_p mhl_edid_3d_data, uint8_t *p_EDID_block_data)
{
	...
	if (p_CEA_extension->tag == EDID_EXTENSION_BLOCK_MAP) {
		...
		for (i = 0; i < mhl_edid_3d_data->parse_data.num_EDID_extensions - 1; ++i) {
			if (p_block_map->block_tags[i] != EDID_EXTENSION_TAG) {
				SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
...
void si_mhl_tx_handle_atomic_hw_edid_read_complete(edid_3d_data_p mhl_edid_3d_data)
{
	...
	if (p_EDID_block_0->extension_flag == 0) {
		...
		for (counter = 1; counter <= mhl_edid_3d_data->parse_data.num_EDID_extensions; ++counter) {
			SLIMPORT_TX_EDID_INFO(mhl_edid_3d_data->dev_context,
				...
				&mhl_edid_3d_data->EDID_block_data[EDID_BLOCK_SIZE * counter]);
			Result = parse_861_block(mhl_edid_3d_data,
				&mhl_edid_3d_data->EDID_block_data[EDID_BLOCK_SIZE * counter]);
			if (Result != EDID_OK) {
				SLIMPORT_TX_DBG_ERR(mhl_edid_3d_data->dev_context
	 ...
	 */
	p_EDID_block_0->checksum = 0;
	p_EDID_block_0->checksum = calculate_generic_checksum((uint8_t *)p_EDID_block_0,
		0, sizeof(*p_EDID_block_0));
