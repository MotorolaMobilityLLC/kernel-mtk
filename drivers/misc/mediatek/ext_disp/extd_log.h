...
/* Eink log functions */
#define EPD_LOG(fmt, arg...)	pr_err("[EXTD-EPD]:"fmt, ##arg)
#define EPD_FUNC()		pr_err("[EXTD-EPD]:%s\n", __func__)
#define EPD_ERR(fmt, arg...)	pr_err("[EXTD-EPD]:"fmt, ##arg)

/*external display - multi-control log functions */
#define MULTI_COTRL_LOG(fmt, arg...)	pr_err("[EXTD-MULTI]:"fmt, ##arg)
#define MULTI_COTRL_ERR(fmt, arg...)	pr_err("[EXTD-MULTI]:"fmt, ##arg)
#define MULTI_COTRL_FUNC()		pr_err("[EXTD-MULTI]:%s\n", __func__)
...
#define EXT_DISP_FUNC()			pr_err("[EXTD]:%s\n", __func__)

/*external display mgr log functions*/
#define EXT_MGR_LOG(fmt, arg...)	pr_err("[EXTD-MGR]:"fmt, ##arg)
#define EXT_MGR_ERR(fmt, arg...)	pr_err("[EXTD-MGR]:"fmt, ##arg)
#define EXT_MGR_FUNC()			pr_err("[EXTD-MGR]:%s\n", __func__)
