...
#define MULTI_COTRL_FUNC()		pr_warn("[EXTD-MULTI]:%s\n", __func__)
...
#define EXT_DISP_FUNC()			pr_warn("[EXTD]:%s\n", __func__)
...
#define EXT_MGR_FUNC()			pr_warn("[EXTD-MGR]:%s\n", __func__)

/*external display - factory log functions*/
#define EXTD_FACTORY_LOG(fmt, arg...)	pr_warn("[EXTD]:"fmt, ##arg)
#define EXTD_FACTORY_ERR(fmt, arg...)	pr_err("[EXTD]:"fmt, ##arg)
#define EXTD_FACTORY_FUNC()		pr_warn("[EXTD]:%s\n", __func__)
