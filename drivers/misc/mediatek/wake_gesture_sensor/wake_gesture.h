...
#define WAG_FUN(f)		pr_debug(WAG_TAG"%s\n", __func__)
#define WAG_ERR(fmt, args...)	pr_err(WAG_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define WAG_LOG(fmt, args...)	pr_debug(WAG_TAG fmt, ##args)
#define WAG_VER(fmt, args...)  pr_debug(WAG_TAG"%s: "fmt, __func__, ##args)	/* ((void)0) */
