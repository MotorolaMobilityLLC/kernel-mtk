...
int epl_sensor_read_als(struct i2c_client *client)
{
	...
	//tuwenzan@wind-mobi.com remove this log at 20161109 begin
	/*
	APS_LOG("als: ~~~~ ALS ~~~~~ \n");
	...
	*/
	//tuwenzan@wind-mobi.com remove this log at 20161109 end
    return 0;
}
...
static int als_get_data(int* value, int* status)
{
   ...
   // APS_LOG("[%s]:*value = %d\n", __func__, *value);  //tuwenzan@wind-mobi.com remove this log at 20161109
