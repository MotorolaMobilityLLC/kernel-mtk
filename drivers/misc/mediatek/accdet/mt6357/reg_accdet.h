...
#define ACCDET_EINT0_PWM_THRSH_MASK	(0x03<<8)
#define ACCDET_EINT0_PWM_WIDTH_MASK	(0x07<<8)
...
#define ACCDET_EINT1_PWM_THRSH_MASK	(0x03<<8)
#define ACCDET_EINT1_PWM_WIDTH_MASK	(0x07<<8)
