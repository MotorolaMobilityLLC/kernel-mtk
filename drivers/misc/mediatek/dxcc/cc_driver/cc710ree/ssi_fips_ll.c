...
struct fips_cmac_ctx {
	...
	uint8_t din[NIST_CIPHER_AES_MAX_VECTOR_SIZE];
	uint8_t mac_res[SEP_DIGEST_SIZE_MAX];
};
...
struct fips_hash_ctx {
	uint8_t initial_digest[SEP_DIGEST_SIZE_MAX];
...
struct fips_hmac_ctx {
	uint8_t initial_digest[SEP_DIGEST_SIZE_MAX];
	uint8_t key[SEP_HMAC_BLOCK_SIZE_MAX];
	uint8_t k0[SEP_HMAC_BLOCK_SIZE_MAX];
	uint8_t digest_bytes_len[HASH_LEN_SIZE];
	uint8_t tmp_digest[SEP_DIGEST_SIZE_MAX];
...
struct fips_gcm_ctx {
	...
	uint8_t key[SEP_AES_KEY_SIZE_MAX];
	uint8_t hkey[SEP_AES_KEY_SIZE_MAX];
...
static const FipsCipherData FipsCipherDataTable[] = {
	/* AES */
	{ 1, NIST_AES_128_KEY, SEP_AES_128_BIT_KEY_SIZE, NIST_AES_ECB_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_ECB, NIST_AES_PLAIN_DATA, NIST_AES_128_ECB_CIPHER, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_128_KEY, SEP_AES_128_BIT_KEY_SIZE, NIST_AES_ECB_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_ECB, NIST_AES_128_ECB_CIPHER, NIST_AES_PLAIN_DATA, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_192_KEY, SEP_AES_192_BIT_KEY_SIZE, NIST_AES_ECB_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_ECB, NIST_AES_PLAIN_DATA, NIST_AES_192_ECB_CIPHER, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_192_KEY, SEP_AES_192_BIT_KEY_SIZE, NIST_AES_ECB_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_ECB, NIST_AES_192_ECB_CIPHER, NIST_AES_PLAIN_DATA, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_256_KEY, SEP_AES_256_BIT_KEY_SIZE, NIST_AES_ECB_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_ECB, NIST_AES_PLAIN_DATA, NIST_AES_256_ECB_CIPHER, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_256_KEY, SEP_AES_256_BIT_KEY_SIZE, NIST_AES_ECB_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_ECB, NIST_AES_256_ECB_CIPHER, NIST_AES_PLAIN_DATA, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_128_KEY, SEP_AES_128_BIT_KEY_SIZE, NIST_AES_CBC_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_CBC, NIST_AES_PLAIN_DATA, NIST_AES_128_CBC_CIPHER, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_128_KEY, SEP_AES_128_BIT_KEY_SIZE, NIST_AES_CBC_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_CBC, NIST_AES_128_CBC_CIPHER, NIST_AES_PLAIN_DATA, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_192_KEY, SEP_AES_192_BIT_KEY_SIZE, NIST_AES_CBC_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_CBC, NIST_AES_PLAIN_DATA, NIST_AES_192_CBC_CIPHER, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_192_KEY, SEP_AES_192_BIT_KEY_SIZE, NIST_AES_CBC_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_CBC, NIST_AES_192_CBC_CIPHER, NIST_AES_PLAIN_DATA, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_256_KEY, SEP_AES_256_BIT_KEY_SIZE, NIST_AES_CBC_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_CBC, NIST_AES_PLAIN_DATA, NIST_AES_256_CBC_CIPHER, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_256_KEY, SEP_AES_256_BIT_KEY_SIZE, NIST_AES_CBC_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_CBC, NIST_AES_256_CBC_CIPHER, NIST_AES_PLAIN_DATA, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_128_KEY, SEP_AES_128_BIT_KEY_SIZE, NIST_AES_OFB_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_OFB, NIST_AES_PLAIN_DATA, NIST_AES_128_OFB_CIPHER, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_128_KEY, SEP_AES_128_BIT_KEY_SIZE, NIST_AES_OFB_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_OFB, NIST_AES_128_OFB_CIPHER, NIST_AES_PLAIN_DATA, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_192_KEY, SEP_AES_192_BIT_KEY_SIZE, NIST_AES_OFB_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_OFB, NIST_AES_PLAIN_DATA, NIST_AES_192_OFB_CIPHER, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_192_KEY, SEP_AES_192_BIT_KEY_SIZE, NIST_AES_OFB_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_OFB, NIST_AES_192_OFB_CIPHER, NIST_AES_PLAIN_DATA, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_256_KEY, SEP_AES_256_BIT_KEY_SIZE, NIST_AES_OFB_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_OFB, NIST_AES_PLAIN_DATA, NIST_AES_256_OFB_CIPHER, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_256_KEY, SEP_AES_256_BIT_KEY_SIZE, NIST_AES_OFB_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_OFB, NIST_AES_256_OFB_CIPHER, NIST_AES_PLAIN_DATA, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_128_KEY, SEP_AES_128_BIT_KEY_SIZE, NIST_AES_CTR_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_CTR, NIST_AES_PLAIN_DATA, NIST_AES_128_CTR_CIPHER, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_128_KEY, SEP_AES_128_BIT_KEY_SIZE, NIST_AES_CTR_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_CTR, NIST_AES_128_CTR_CIPHER, NIST_AES_PLAIN_DATA, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_192_KEY, SEP_AES_192_BIT_KEY_SIZE, NIST_AES_CTR_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_CTR, NIST_AES_PLAIN_DATA, NIST_AES_192_CTR_CIPHER, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_192_KEY, SEP_AES_192_BIT_KEY_SIZE, NIST_AES_CTR_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_CTR, NIST_AES_192_CTR_CIPHER, NIST_AES_PLAIN_DATA, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_256_KEY, SEP_AES_256_BIT_KEY_SIZE, NIST_AES_CTR_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_CTR, NIST_AES_PLAIN_DATA, NIST_AES_256_CTR_CIPHER, NIST_AES_VECTOR_SIZE },
	{ 1, NIST_AES_256_KEY, SEP_AES_256_BIT_KEY_SIZE, NIST_AES_CTR_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_CTR, NIST_AES_256_CTR_CIPHER, NIST_AES_PLAIN_DATA, NIST_AES_VECTOR_SIZE },
	{ 1, RFC3962_AES_128_KEY,  SEP_AES_128_BIT_KEY_SIZE, RFC3962_AES_CBC_CTS_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_CBC_CTS, RFC3962_AES_PLAIN_DATA, RFC3962_AES_128_CBC_CTS_CIPHER, RFC3962_AES_VECTOR_SIZE },
	{ 1, RFC3962_AES_128_KEY,  SEP_AES_128_BIT_KEY_SIZE, RFC3962_AES_CBC_CTS_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_CBC_CTS, RFC3962_AES_128_CBC_CTS_CIPHER, RFC3962_AES_PLAIN_DATA, RFC3962_AES_VECTOR_SIZE },
	{ 1, NIST_AES_256_XTS_KEY, SEP_AES_256_BIT_KEY_SIZE,   NIST_AES_256_XTS_IV,  SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_XTS,     NIST_AES_256_XTS_PLAIN, NIST_AES_256_XTS_CIPHER, NIST_AES_256_XTS_VECTOR_SIZE },
	{ 1, NIST_AES_256_XTS_KEY, SEP_AES_256_BIT_KEY_SIZE,   NIST_AES_256_XTS_IV,  SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_XTS,     NIST_AES_256_XTS_CIPHER, NIST_AES_256_XTS_PLAIN, NIST_AES_256_XTS_VECTOR_SIZE },
#if (SEP_SUPPORT_SHA > 256)
	{ 1, NIST_AES_512_XTS_KEY, 2*SEP_AES_256_BIT_KEY_SIZE, NIST_AES_512_XTS_IV,  SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_XTS,     NIST_AES_512_XTS_PLAIN, NIST_AES_512_XTS_CIPHER, NIST_AES_512_XTS_VECTOR_SIZE },
	{ 1, NIST_AES_512_XTS_KEY, 2*SEP_AES_256_BIT_KEY_SIZE, NIST_AES_512_XTS_IV,  SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_XTS,     NIST_AES_512_XTS_CIPHER, NIST_AES_512_XTS_PLAIN, NIST_AES_512_XTS_VECTOR_SIZE },
#endif
	/* DES */
	{ 0, NIST_TDES_ECB3_KEY, SASI_DRV_DES_TRIPLE_KEY_SIZE, NIST_TDES_ECB_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_ECB, NIST_TDES_ECB3_PLAIN_DATA, NIST_TDES_ECB3_CIPHER, NIST_TDES_VECTOR_SIZE },
	{ 0, NIST_TDES_ECB3_KEY, SASI_DRV_DES_TRIPLE_KEY_SIZE, NIST_TDES_ECB_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_ECB, NIST_TDES_ECB3_CIPHER, NIST_TDES_ECB3_PLAIN_DATA, NIST_TDES_VECTOR_SIZE },
	{ 0, NIST_TDES_CBC3_KEY, SASI_DRV_DES_TRIPLE_KEY_SIZE, NIST_TDES_CBC3_IV, SEP_CRYPTO_DIRECTION_ENCRYPT, SEP_CIPHER_CBC, NIST_TDES_CBC3_PLAIN_DATA, NIST_TDES_CBC3_CIPHER, NIST_TDES_VECTOR_SIZE },
	{ 0, NIST_TDES_CBC3_KEY, SASI_DRV_DES_TRIPLE_KEY_SIZE, NIST_TDES_CBC3_IV, SEP_CRYPTO_DIRECTION_DECRYPT, SEP_CIPHER_CBC, NIST_TDES_CBC3_CIPHER, NIST_TDES_CBC3_PLAIN_DATA, NIST_TDES_VECTOR_SIZE },
};
...
static const FipsCmacData FipsCmacDataTable[] = {
	{ SEP_CRYPTO_DIRECTION_ENCRYPT, NIST_AES_128_CMAC_KEY, AES_128_BIT_KEY_SIZE, NIST_AES_128_CMAC_PLAIN_DATA, NIST_AES_128_CMAC_VECTOR_SIZE, NIST_AES_128_CMAC_MAC, NIST_AES_128_CMAC_OUTPUT_SIZE },
	{ SEP_CRYPTO_DIRECTION_ENCRYPT, NIST_AES_192_CMAC_KEY, AES_192_BIT_KEY_SIZE, NIST_AES_192_CMAC_PLAIN_DATA, NIST_AES_192_CMAC_VECTOR_SIZE, NIST_AES_192_CMAC_MAC, NIST_AES_192_CMAC_OUTPUT_SIZE },
	{ SEP_CRYPTO_DIRECTION_ENCRYPT, NIST_AES_256_CMAC_KEY, AES_256_BIT_KEY_SIZE, NIST_AES_256_CMAC_PLAIN_DATA, NIST_AES_256_CMAC_VECTOR_SIZE, NIST_AES_256_CMAC_MAC, NIST_AES_256_CMAC_OUTPUT_SIZE },
};
#define FIPS_CMAC_NUM_OF_TESTS        (sizeof(FipsCmacDataTable) / sizeof(FipsCmacData))

static const FipsHashData FipsHashDataTable[] = {
        { SEP_HASH_SHA1,   NIST_SHA_1_MSG,   NIST_SHA_MSG_SIZE, NIST_SHA_1_MD },
        { SEP_HASH_SHA256, NIST_SHA_256_MSG, NIST_SHA_MSG_SIZE, NIST_SHA_256_MD },
#if (SEP_SUPPORT_SHA > 256)
        { SEP_HASH_SHA512, NIST_SHA_512_MSG, NIST_SHA_MSG_SIZE, NIST_SHA_512_MD },
#endif
};
#define FIPS_HASH_NUM_OF_TESTS        (sizeof(FipsHashDataTable) / sizeof(FipsHashData))

static const FipsHmacData FipsHmacDataTable[] = {
        { SEP_HASH_SHA1,   NIST_HMAC_SHA1_KEY,   NIST_HMAC_SHA1_KEY_SIZE,   NIST_HMAC_SHA1_MSG,   NIST_HMAC_MSG_SIZE, NIST_HMAC_SHA1_MD },
        { SEP_HASH_SHA256, NIST_HMAC_SHA256_KEY, NIST_HMAC_SHA256_KEY_SIZE, NIST_HMAC_SHA256_MSG, NIST_HMAC_MSG_SIZE, NIST_HMAC_SHA256_MD },
#if (SEP_SUPPORT_SHA > 256)
        { SEP_HASH_SHA512, NIST_HMAC_SHA512_KEY, NIST_HMAC_SHA512_KEY_SIZE, NIST_HMAC_SHA512_MSG, NIST_HMAC_MSG_SIZE, NIST_HMAC_SHA512_MD },
#endif
};
#define FIPS_HMAC_NUM_OF_TESTS        (sizeof(FipsHmacDataTable) / sizeof(FipsHmacData))

static const FipsCcmData FipsCcmDataTable[] = {
        { SEP_CRYPTO_DIRECTION_ENCRYPT, NIST_AESCCM_128_KEY, NIST_AESCCM_128_BIT_KEY_SIZE, NIST_AESCCM_128_NONCE, NIST_AESCCM_128_ADATA, NIST_AESCCM_ADATA_SIZE, NIST_AESCCM_128_PLAIN_TEXT, NIST_AESCCM_TEXT_SIZE, NIST_AESCCM_128_CIPHER, NIST_AESCCM_TAG_SIZE, NIST_AESCCM_128_MAC },
        { SEP_CRYPTO_DIRECTION_DECRYPT, NIST_AESCCM_128_KEY, NIST_AESCCM_128_BIT_KEY_SIZE, NIST_AESCCM_128_NONCE, NIST_AESCCM_128_ADATA, NIST_AESCCM_ADATA_SIZE, NIST_AESCCM_128_CIPHER, NIST_AESCCM_TEXT_SIZE, NIST_AESCCM_128_PLAIN_TEXT, NIST_AESCCM_TAG_SIZE, NIST_AESCCM_128_MAC },
        { SEP_CRYPTO_DIRECTION_ENCRYPT, NIST_AESCCM_192_KEY, NIST_AESCCM_192_BIT_KEY_SIZE, NIST_AESCCM_192_NONCE, NIST_AESCCM_192_ADATA, NIST_AESCCM_ADATA_SIZE, NIST_AESCCM_192_PLAIN_TEXT, NIST_AESCCM_TEXT_SIZE, NIST_AESCCM_192_CIPHER, NIST_AESCCM_TAG_SIZE, NIST_AESCCM_192_MAC },
        { SEP_CRYPTO_DIRECTION_DECRYPT, NIST_AESCCM_192_KEY, NIST_AESCCM_192_BIT_KEY_SIZE, NIST_AESCCM_192_NONCE, NIST_AESCCM_192_ADATA, NIST_AESCCM_ADATA_SIZE, NIST_AESCCM_192_CIPHER, NIST_AESCCM_TEXT_SIZE, NIST_AESCCM_192_PLAIN_TEXT, NIST_AESCCM_TAG_SIZE, NIST_AESCCM_192_MAC },
        { SEP_CRYPTO_DIRECTION_ENCRYPT, NIST_AESCCM_256_KEY, NIST_AESCCM_256_BIT_KEY_SIZE, NIST_AESCCM_256_NONCE, NIST_AESCCM_256_ADATA, NIST_AESCCM_ADATA_SIZE, NIST_AESCCM_256_PLAIN_TEXT, NIST_AESCCM_TEXT_SIZE, NIST_AESCCM_256_CIPHER, NIST_AESCCM_TAG_SIZE, NIST_AESCCM_256_MAC },
        { SEP_CRYPTO_DIRECTION_DECRYPT, NIST_AESCCM_256_KEY, NIST_AESCCM_256_BIT_KEY_SIZE, NIST_AESCCM_256_NONCE, NIST_AESCCM_256_ADATA, NIST_AESCCM_ADATA_SIZE, NIST_AESCCM_256_CIPHER, NIST_AESCCM_TEXT_SIZE, NIST_AESCCM_256_PLAIN_TEXT, NIST_AESCCM_TAG_SIZE, NIST_AESCCM_256_MAC },
};
#define FIPS_CCM_NUM_OF_TESTS        (sizeof(FipsCcmDataTable) / sizeof(FipsCcmData))

static const FipsGcmData FipsGcmDataTable[] = {
        { SEP_CRYPTO_DIRECTION_ENCRYPT, NIST_AESGCM_128_KEY, NIST_AESGCM_128_BIT_KEY_SIZE, NIST_AESGCM_128_IV, NIST_AESGCM_128_ADATA, NIST_AESGCM_ADATA_SIZE, NIST_AESGCM_128_PLAIN_TEXT, NIST_AESGCM_TEXT_SIZE, NIST_AESGCM_128_CIPHER, NIST_AESGCM_TAG_SIZE, NIST_AESGCM_128_MAC },
        { SEP_CRYPTO_DIRECTION_DECRYPT, NIST_AESGCM_128_KEY, NIST_AESGCM_128_BIT_KEY_SIZE, NIST_AESGCM_128_IV, NIST_AESGCM_128_ADATA, NIST_AESGCM_ADATA_SIZE, NIST_AESGCM_128_CIPHER, NIST_AESGCM_TEXT_SIZE, NIST_AESGCM_128_PLAIN_TEXT, NIST_AESGCM_TAG_SIZE, NIST_AESGCM_128_MAC },
        { SEP_CRYPTO_DIRECTION_ENCRYPT, NIST_AESGCM_192_KEY, NIST_AESGCM_192_BIT_KEY_SIZE, NIST_AESGCM_192_IV, NIST_AESGCM_192_ADATA, NIST_AESGCM_ADATA_SIZE, NIST_AESGCM_192_PLAIN_TEXT, NIST_AESGCM_TEXT_SIZE, NIST_AESGCM_192_CIPHER, NIST_AESGCM_TAG_SIZE, NIST_AESGCM_192_MAC },
        { SEP_CRYPTO_DIRECTION_DECRYPT, NIST_AESGCM_192_KEY, NIST_AESGCM_192_BIT_KEY_SIZE, NIST_AESGCM_192_IV, NIST_AESGCM_192_ADATA, NIST_AESGCM_ADATA_SIZE, NIST_AESGCM_192_CIPHER, NIST_AESGCM_TEXT_SIZE, NIST_AESGCM_192_PLAIN_TEXT, NIST_AESGCM_TAG_SIZE, NIST_AESGCM_192_MAC },
        { SEP_CRYPTO_DIRECTION_ENCRYPT, NIST_AESGCM_256_KEY, NIST_AESGCM_256_BIT_KEY_SIZE, NIST_AESGCM_256_IV, NIST_AESGCM_256_ADATA, NIST_AESGCM_ADATA_SIZE, NIST_AESGCM_256_PLAIN_TEXT, NIST_AESGCM_TEXT_SIZE, NIST_AESGCM_256_CIPHER, NIST_AESGCM_TAG_SIZE, NIST_AESGCM_256_MAC },
        { SEP_CRYPTO_DIRECTION_DECRYPT, NIST_AESGCM_256_KEY, NIST_AESGCM_256_BIT_KEY_SIZE, NIST_AESGCM_256_IV, NIST_AESGCM_256_ADATA, NIST_AESGCM_ADATA_SIZE, NIST_AESGCM_256_CIPHER, NIST_AESGCM_TEXT_SIZE, NIST_AESGCM_256_PLAIN_TEXT, NIST_AESGCM_TAG_SIZE, NIST_AESGCM_256_MAC },
};
#define FIPS_GCM_NUM_OF_TESTS        (sizeof(FipsGcmDataTable) / sizeof(FipsGcmData))


static inline ssi_fips_error_t 
FIPS_CipherToFipsError(enum sep_cipher_mode mode, bool is_aes)
{
	switch (mode)
	{
	case SEP_CIPHER_ECB:
			 ...
			 size_t data_size)
{
	...
	ssi_blkcipher_create_setup_desc(cipher_mode,
					is_aes ? S_DIN_to_AES : S_DIN_to_DES,
					direction,
					key_dma_addr,
					key_len,
					iv_dma_addr,
	...
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, din_dma_addr, data_size, AXI_ID, NS_BIT);
	HW_DESC_SET_DOUT_DLLI(&desc[idx], dout_dma_addr, data_size, AXI_ID, NS_BIT, 0);
	...
	rc = ssi_send_request(drvdata, &ssi_req, desc, idx, false);
...
ssi_cipher_fips_power_up_tests(struct ssi_drvdata *drvdata, void *cpu_addr_buffer, dma_addr_t dma_coherent_buffer)
{
	...
	for (i = 0; i < FIPS_CIPHER_NUM_OF_TESTS; ++i)
	{
		...
		if (rc != 0)
		{
			FIPS_LOG("ssi_cipher_fips_run_test %zu returned error - rc = %d \n", i, rc);
		       ...
		       size_t digest_len)
{
	...
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, key_dma_addr,
			     ((key_len == 24) ? AES_MAX_KEY_SIZE : key_len), AXI_ID, NS_BIT);
	...
	/* Load MAC state */
	HW_DESC_INIT(&desc[idx]);
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, digest_dma_addr, SEP_AES_BLOCK_SIZE, AXI_ID, NS_BIT);
	...
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, 
			     din_dma_addr, 
			     din_len, AXI_ID, NS_BIT);
	HW_DESC_SET_FLOW_MODE(&desc[idx], DIN_AES_DOUT);
	idx++;
	
	/* Get final MAC result */
	HW_DESC_INIT(&desc[idx]);
	HW_DESC_SET_DOUT_DLLI(&desc[idx], digest_dma_addr, SEP_AES_BLOCK_SIZE, AXI_ID, NS_BIT, 0);
...
ssi_cmac_fips_power_up_tests(struct ssi_drvdata *drvdata, void *cpu_addr_buffer, dma_addr_t dma_coherent_buffer)
{
	...
	for (i = 0; i < FIPS_CMAC_NUM_OF_TESTS; ++i)
	{
		...
		BUG_ON(cmac_data->direction != SEP_CRYPTO_DIRECTION_ENCRYPT);
		...
		if (rc != 0)
		{
			FIPS_LOG("ssi_cmac_fips_run_test %zu returned error - rc = %d \n", i, rc);
...
static inline ssi_fips_error_t 
FIPS_HashToFipsError(enum sep_hash_mode hash_mode)
{
	switch (hash_mode) {
	case SEP_HASH_SHA1:
		       ...
		       int inter_digestsize)
{
	...
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, initial_digest_dma_addr, inter_digestsize, AXI_ID, NS_BIT);
	...
	/* data descriptor */
	HW_DESC_INIT(&desc[idx]);
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, din_dma_addr, data_in_size, AXI_ID, NS_BIT);
	...
	HW_DESC_INIT(&desc[idx]);
	HW_DESC_SET_CIPHER_MODE(&desc[idx], hw_mode);
	HW_DESC_SET_DOUT_DLLI(&desc[idx], mac_res_dma_addr, digest_size, AXI_ID, NS_BIT, 0);
	HW_DESC_SET_FLOW_MODE(&desc[idx], S_HASH_to_DOUT);
	HW_DESC_SET_SETUP_MODE(&desc[idx], SETUP_WRITE_STATE0);
	HW_DESC_SET_CIPHER_CONFIG1(&desc[idx], HASH_PADDING_DISABLED);
	if (unlikely((hash_mode == SEP_HASH_MD5) ||
		     (hash_mode == SEP_HASH_SHA384) ||
		     (hash_mode == SEP_HASH_SHA512))) {
...
ssi_hash_fips_power_up_tests(struct ssi_drvdata *drvdata, void *cpu_addr_buffer, dma_addr_t dma_coherent_buffer)
{
	...
	for (i = 0; i < FIPS_HASH_NUM_OF_TESTS; ++i)
	{
		...
		case SEP_HASH_SHA1:
			...
			digest_size = SEP_SHA1_DIGEST_SIZE;
			inter_digestsize = SEP_SHA1_DIGEST_SIZE;
			/* copy the initial digest into the allocated cache coherent buffer */
			memcpy(virt_ctx->initial_digest, (void*)sha1_init, SEP_SHA1_DIGEST_SIZE);
			break;
		case SEP_HASH_SHA256:
			hw_mode = SEP_HASH_HW_SHA256;
			digest_size = SEP_SHA256_DIGEST_SIZE;
			inter_digestsize = SEP_SHA256_DIGEST_SIZE;
			memcpy(virt_ctx->initial_digest, (void*)sha256_init, SEP_SHA256_DIGEST_SIZE);
			break;
#if (SEP_SUPPORT_SHA > 256)
		case SEP_HASH_SHA512:
			hw_mode = SEP_HASH_HW_SHA512;
			digest_size = SEP_SHA512_DIGEST_SIZE;
			inter_digestsize = SEP_SHA512_DIGEST_SIZE;
			memcpy(virt_ctx->initial_digest, (void*)sha512_init, SEP_SHA512_DIGEST_SIZE);
			break;
#endif
		default:
		...
		if (rc != 0)
		{
			FIPS_LOG("ssi_hash_fips_run_test %zu returned error - rc = %d \n", i, rc);
			error = FIPS_HashToFipsError(hash_data->hash_mode);
			break;
                }
...
static inline ssi_fips_error_t 
FIPS_HmacToFipsError(enum sep_hash_mode hash_mode)
{
	switch (hash_mode) {
	case SEP_HASH_SHA1:
		       ...
		       dma_addr_t digest_bytes_len_dma_addr)
{
	...
	HW_DESC_INIT(&desc[idx]);
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, key_dma_addr, key_size, AXI_ID, NS_BIT);
	HW_DESC_SET_FLOW_MODE(&desc[idx], BYPASS);
	HW_DESC_SET_DOUT_DLLI(&desc[idx], k0_dma_addr, key_size, AXI_ID, NS_BIT, 0);
	idx++;
	...
	rc = ssi_send_request(drvdata, &ssi_req, desc, idx, 0);
	if (unlikely(rc != 0)) {
	...
	HW_DESC_INIT(&desc[idx]);
	HW_DESC_SET_CIPHER_MODE(&desc[idx], hw_mode);
	HW_DESC_SET_DOUT_DLLI(&desc[idx], k0_dma_addr, HASH_LEN_SIZE, AXI_ID, NS_BIT, 0);
	HW_DESC_SET_FLOW_MODE(&desc[idx], S_HASH_to_DOUT);
	...
	HW_DESC_INIT(&desc[idx]);
	HW_DESC_SET_CIPHER_MODE(&desc[idx], hw_mode);
	HW_DESC_SET_DOUT_DLLI(&desc[idx], k0_dma_addr, digest_size, AXI_ID, NS_BIT, 0);
	HW_DESC_SET_FLOW_MODE(&desc[idx], S_HASH_to_DOUT);
	if (unlikely((hash_mode == SEP_HASH_MD5) ||
		     (hash_mode == SEP_HASH_SHA384) ||
		     (hash_mode == SEP_HASH_SHA512))) {
	...
	HW_DESC_INIT(&desc[idx]);
	HW_DESC_SET_CIPHER_MODE(&desc[idx], hw_mode);
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, tmp_digest_dma_addr, inter_digestsize, AXI_ID, NS_BIT);
	HW_DESC_SET_FLOW_MODE(&desc[idx], S_DIN_to_HASH);
	HW_DESC_SET_SETUP_MODE(&desc[idx], SETUP_LOAD_STATE0);
	idx++;
	...
	HW_DESC_INIT(&desc[idx]);
	HW_DESC_SET_CIPHER_MODE(&desc[idx], hw_mode);
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, digest_bytes_len_dma_addr, HASH_LEN_SIZE, AXI_ID, NS_BIT);
	HW_DESC_SET_CIPHER_CONFIG1(&desc[idx], HASH_PADDING_ENABLED);
	HW_DESC_SET_FLOW_MODE(&desc[idx], S_DIN_to_HASH);
	HW_DESC_SET_SETUP_MODE(&desc[idx], SETUP_LOAD_KEY0);
	idx++;
	...
	/* Perform HASH update */
	HW_DESC_INIT(&desc[idx]);
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, k0_dma_addr, digest_size, AXI_ID, NS_BIT);
	HW_DESC_SET_FLOW_MODE(&desc[idx], DIN_HASH);
	idx++;
...
ssi_hmac_fips_power_up_tests(struct ssi_drvdata *drvdata, void *cpu_addr_buffer, dma_addr_t dma_coherent_buffer)
{
	...
	for (i = 0; i < FIPS_HMAC_NUM_OF_TESTS; ++i)
	{
		...
		rc = ssi_hmac_fips_run_test(drvdata,
					    ...
					    digest_size,
					    inter_digestsize,
					    SEP_HMAC_BLOCK_SIZE_MAX,
					    k0_dma_addr,
					    tmp_digest_dma_addr,
					    digest_bytes_len_dma_addr);
		if (rc != 0)
		{
			FIPS_LOG("ssi_hmac_fips_run_test %zu returned error - rc = %d \n", i, rc);
			error = FIPS_HmacToFipsError(hmac_data->hash_mode);
			break;
		}
		      ...
		      dma_addr_t mac_res_dma_addr)
{
	...
	if (direction == SEP_CRYPTO_DIRECTION_DECRYPT) {
	...
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, key_dma_addr,
			     ((key_size == NIST_AESCCM_192_BIT_KEY_SIZE) ? SEP_AES_KEY_SIZE_MAX : key_size),
			     AXI_ID, NS_BIT);
	...
	HW_DESC_SET_CIPHER_MODE(&desc[idx], SEP_CIPHER_CBC_MAC);
	HW_DESC_SET_KEY_SIZE_AES(&desc[idx], key_size);
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, mac_res_dma_addr, NIST_AESCCM_TAG_SIZE, AXI_ID, NS_BIT);
	HW_DESC_SET_CIPHER_CONFIG0(&desc[idx], DESC_DIRECTION_ENCRYPT_ENCRYPT);	
	HW_DESC_SET_SETUP_MODE(&desc[idx], SETUP_LOAD_STATE0);
	HW_DESC_SET_FLOW_MODE(&desc[idx], S_DIN_to_HASH);
	HW_DESC_SET_AES_NOT_HASH_MODE(&desc[idx]);
	...
	/* prcess assoc data */
	HW_DESC_INIT(&desc[idx]);
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, b0_a0_adata_dma_addr, b0_a0_adata_size, AXI_ID, NS_BIT);
	HW_DESC_SET_FLOW_MODE(&desc[idx], DIN_HASH);
	idx++;

	/* process the cipher */
	HW_DESC_INIT(&desc[idx]);
	HW_DESC_SET_DIN_TYPE(&desc[idx], DMA_DLLI, din_dma_addr, din_size, AXI_ID, NS_BIT);
	HW_DESC_SET_DOUT_DLLI(&desc[idx], dout_dma_addr, din_size, AXI_ID, NS_BIT, 0);
	...
	HW_DESC_INIT(&desc[idx]);
	HW_DESC_SET_CIPHER_MODE(&desc[idx], SEP_CIPHER_CBC_MAC);
	HW_DESC_SET_DOUT_DLLI(&desc[idx], mac_res_dma_addr, NIST_AESCCM_TAG_SIZE, AXI_ID, NS_BIT, 0);
	HW_DESC_SET_SETUP_MODE(&desc[idx], SETUP_WRITE_STATE0);
	HW_DESC_SET_CIPHER_CONFIG0(&desc[idx], HASH_DIGEST_RESULT_LITTLE_ENDIAN);
	HW_DESC_SET_FLOW_MODE(&desc[idx], S_HASH_to_DOUT);
	HW_DESC_SET_AES_NOT_HASH_MODE(&desc[idx]);
...
ssi_ccm_fips_power_up_tests(struct ssi_drvdata *drvdata, void *cpu_addr_buffer, dma_addr_t dma_coherent_buffer)
{
	...
	for (i = 0; i < FIPS_CCM_NUM_OF_TESTS; ++i)
	{
		...
		if (rc != 0)
		{
			FIPS_LOG("ssi_ccm_fips_run_test %zu returned error - rc = %d \n", i, rc);
...
ssi_gcm_fips_power_up_tests(struct ssi_drvdata *drvdata, void *cpu_addr_buffer, dma_addr_t dma_coherent_buffer)
{
	...
	for (i = 0; i < FIPS_GCM_NUM_OF_TESTS; ++i)
	{
		...
		if (rc != 0)
		{
			FIPS_LOG("ssi_gcm_fips_run_test %zu returned error - rc = %d \n", i, rc);
