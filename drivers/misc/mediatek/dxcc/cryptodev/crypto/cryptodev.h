...
//changed to support BLOB key length
#define CRYPTO_CIPHER_MAX_KEY_LEN   240  
...
enum cryptodev_crypto_op_t {
    ...
    CRYPTO_DES_ECB = 21,
    CRYPTO_3DES_ECB = 22,
    CRYPTO_MD5_HMAC_SYNC = 25,
    CRYPTO_MD5_SYNC = 26,
    CRYPTO_SHA2_256_HMAC_SYNC = 27,
    CRYPTO_SHA1_SYNC = 28,
    CRYPTO_SHA1_HMAC_SYNC = 29,

    CRYPTO_AES_ECB = 30,
    CRYPTO_AES_CTR = 31,
    CRYPTO_AES_XTS = 32,
    CRYPTO_AES_MAC = 33,
    CRYPTO_AES_XCBC_MAC = 34,
    CRYPTO_AES_CMAC = 35,
    CRYPTO_AES_CBC_CTS = 36,
    CRYPTO_AES_OFB = 37,
    CRYPTO_AES_CCM = 38,
    CRYPTO_AES_CCM_RFC4309 = 39,
    
    CRYPTO_AES_GCM = 50,
    CRYPTO_AES_GCM_RFC4543=51,
    CRYPTO_AES_GCM_RFC4106=52,

    CRYPTO_SAES_CBC = 60,
    CRYPTO_SAES_CTR = 61,
    CRYPTO_SAES_CTS = 62,
    CRYPTO_SMULTI2_OFB = 66,
    CRYPTO_SMULTI2_CBC = 67,
    CRYPTO_SBYPASS = 70,
    CRYPTO_SMULTI2_OFB_SYNC = 71,
    CRYPTO_SBYPASS_SYNC = 72,
    CRYPTO_SMULTI2_CBC_SYNC = 73,
    CRYPTO_SAES_CTR_SYNC = 74,
    CRYPTO_SAES_CTS_SYNC = 75,
    CRYPTO_SAES_CBC_SYNC = 76,
    ...
    CRYPTO_SHA2_224_SYNC,
    CRYPTO_SHA2_224_HMAC_SYNC,
    CRYPTO_SHA2_256_SYNC,
