...
module_param(BT_major, uint, 0000);
 ...
 *******************************************************************
*/
static VOID bt_cdev_rst_cb(enum ENUM_WMTDRV_TYPE_T src,
			   enum ENUM_WMTDRV_TYPE_T dst, enum ENUM_WMTMSG_TYPE_T type, PVOID buf, UINT32 sz)
{
	enum ENUM_WMTRSTMSG_TYPE_T rst_msg;

	if (sz <= sizeof(enum ENUM_WMTRSTMSG_TYPE_T)) {
