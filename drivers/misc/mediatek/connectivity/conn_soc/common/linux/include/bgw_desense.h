...
#define ERR(fmt, arg ...) pr_debug(PFX "[D]%s: "  fmt, __func__ , ##arg)
...
parameter: command could be macro ON: enable co-exist;
OFF: disable co-exist; ACK: after get native process init message send ACK
