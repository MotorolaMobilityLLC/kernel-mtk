...
struct fm_basic_interface {
	...
	fm_s32 (*rds_tx_adapter)(fm_u16 pi, fm_u16 *ps, fm_u16 *other_rds, fm_u8 other_rds_cnt);
};
...
extern fm_s32 fm_low_ops_register(struct fm_callback *cb, struct fm_basic_interface *bi);
extern fm_s32 fm_low_ops_unregister(struct fm_basic_interface *bi);
extern fm_s32 fm_rds_ops_register(struct fm_basic_interface *bi, struct fm_rds_interface *ri);
extern fm_s32 fm_rds_ops_unregister(struct fm_rds_interface *ri);
