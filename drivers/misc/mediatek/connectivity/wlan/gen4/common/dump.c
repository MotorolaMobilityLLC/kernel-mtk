		...
		if (u4Length >= 16) {
			...
			case 3:
				DBGFUNC(u4DbgIndex, ucDbgClass, "(%08x) %02x %02x %02x\n",
					(ULONG) pucStartAddr, pucStartAddr[0], pucStartAddr[1], pucStartAddr[2]);
				break;
			case 4:
		...
		if (u4Length >= 16) {
			...
			case 6:
				...
				DBGFUNC(u4DbgIndex, ucDbgClass, "(%08x) %08x ----%02x%02x\n",
					(ULONG) pu4StartAddr, pu4StartAddr[0], pucAddr[1], pucAddr[0]);
				break;
			case 7:
				pucAddr = (PUINT_8) &pu4StartAddr[1];
				DBGFUNC(u4DbgIndex, ucDbgClass, "(%08x) %08x --%02x%02x%02x\n",
					(ULONG) pu4StartAddr, pu4StartAddr[0], pucAddr[2], pucAddr[1], pucAddr[0]);
				break;
			case 8:
			...
			case 9:
				...
				DBGFUNC(u4DbgIndex, ucDbgClass, "(%08x) %08x %08x ------%02x\n",
					(ULONG) pu4StartAddr, pu4StartAddr[0], pu4StartAddr[1], pucAddr[0]);
				break;
			case 10:
				pucAddr = (PUINT_8) &pu4StartAddr[2];
				DBGFUNC(u4DbgIndex, ucDbgClass,
					"(%08x) %08x %08x ----%02x%02x\n",
					(ULONG) pu4StartAddr, pu4StartAddr[0], pu4StartAddr[1], pucAddr[1], pucAddr[0]);
				break;
			case 11:
				pucAddr = (PUINT_8) &pu4StartAddr[2];
				DBGFUNC(u4DbgIndex, ucDbgClass,
			...
			case 12:
				DBGFUNC(u4DbgIndex, ucDbgClass, "(%08x) %08x %08x %08x\n",
					(ULONG) pu4StartAddr, pu4StartAddr[0], pu4StartAddr[1], pu4StartAddr[2]);
				break;
			case 13:
