 ...
 *
 * 11 11 2011 wh.su
 * [WCXRP00001078] [MT6620 Wi-Fi][Driver] Adding the mediatek log improvement support : XLOG
...
/* Sigma */
		...
		if (prAdapter->fgIsP2PRegistered) {
			...
			if (prBssInfo)
				p2pFuncValidateRxActionFrame(prAdapter, prSwRfb, (UINT_8) prBssInfo->u4PrivateData);
			else
				p2pFuncValidateRxActionFrame(prAdapter, prSwRfb, 0);
		}
#endif
		break;
