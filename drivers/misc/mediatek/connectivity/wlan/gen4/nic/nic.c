 ...
 * 2) TX descriptors, RX descriptors and management buffer should use virtually continuous buffer instead of
 * physically continuous one
 *
 * 01 04 2011 cp.wu
 * [WCXRP00000338] [MT6620 Wi-Fi][Driver] Separate kalMemAlloc into kmalloc and vmalloc implementations to ease
 * physically continuous memory demands
 ...
 * [WPD00001556]Basic power management function
...
WLAN_STATUS nicEnterTPTestMode(IN P_ADAPTER_T prAdapter, IN BOOLEAN fgEnable)
{
	CMD_SW_DBG_CTRL_T rCmdSwCtrl;
	WLAN_STATUS rWlanStatus;
	UINT_8 ucBssIdx;
