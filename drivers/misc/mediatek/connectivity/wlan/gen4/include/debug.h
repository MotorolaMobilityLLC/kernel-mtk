...
/* Define PF related debug classes */
#if (PF_DBG_CLASSES & DBG_CLASS_ERROR)
#define PF_ERROR_LOGFUNC(_Module, _Class, _Fmt) \
	DBGLOG_FUNC(_Module, _Class, _Fmt)
#define PF_ERROR_LOGDUMP8(_StartAddr, _Length) \
	dumpMemory8(DBG_PF_IDX, DBG_CLASS_ERROR, _StartAddr, _Length)
#define PF_ERROR_LOGDUMP32(_StartAddr, _Length) \
	dumpMemory32(DBG_PF_IDX, DBG_CLASS_ERROR, _StartAddr, _Length)
#else
#define PF_ERROR_LOGFUNC(_Module, _Class, _Fmt)
#define PF_ERROR_LOGDUMP8(_StartAddr, _Length)
#define PF_ERROR_LOGDUMP32(_StartAddr, _Length)
...
#if (PF_DBG_CLASSES & DBG_CLASS_WARN)
#define PF_WARN_LOGFUNC(_Module, _Class, _Fmt) \
	DBGLOG_FUNC(_Module, _Class, _Fmt)
#define PF_WARN_LOGDUMP8(_StartAddr, _Length) \
	dumpMemory8(DBG_PF_IDX, DBG_CLASS_WARN, _StartAddr, _Length)
#define PF_WARN_LOGDUMP32(_StartAddr, _Length) \
	dumpMemory32(DBG_PF_IDX, DBG_CLASS_WARN, _StartAddr, _Length)
#else
#define PF_WARN_LOGFUNC(_Module, _Class, _Fmt)
#define PF_WARN_LOGDUMP8(_StartAddr, _Length)
#define PF_WARN_LOGDUMP32(_StartAddr, _Length)
...
#if (PF_DBG_CLASSES & DBG_CLASS_STATE)
#define PF_STATE_LOGFUNC(_Module, _Class, _Fmt) \
	DBGLOG_FUNC(_Module, _Class, _Fmt)
#define PF_STATE_LOGDUMP8(_StartAddr, _Length) \
	dumpMemory8(DBG_PF_IDX, DBG_CLASS_STATE, _StartAddr, _Length)
#define PF_STATE_LOGDUMP32(_StartAddr, _Length) \
	dumpMemory32(DBG_PF_IDX, DBG_CLASS_STATE, _StartAddr, _Length)
#else
#define PF_STATE_LOGFUNC(_Module, _Class, _Fmt)
#define PF_STATE_LOGDUMP8(_StartAddr, _Length)
#define PF_STATE_LOGDUMP32(_StartAddr, _Length)
...
#if (PF_DBG_CLASSES & DBG_CLASS_EVENT)
#define PF_EVENT_LOGFUNC(_Module, _Class, _Fmt) \
	DBGLOG_FUNC(_Module, _Class, _Fmt)
#define PF_EVENT_LOGDUMP8(_StartAddr, _Length) \
	dumpMemory8(DBG_PF_IDX, DBG_CLASS_EVENT, _StartAddr, _Length)
#define PF_EVENT_LOGDUMP32(_StartAddr, _Length) \
	dumpMemory32(DBG_PF_IDX, DBG_CLASS_EVENT, _StartAddr, _Length)
#else
#define PF_EVENT_LOGFUNC(_Module, _Class, _Fmt)
#define PF_EVENT_LOGDUMP8(_StartAddr, _Length)
#define PF_EVENT_LOGDUMP32(_StartAddr, _Length)
...
#if (PF_DBG_CLASSES & DBG_CLASS_TRACE)
#define PF_TRACE_LOGFUNC(_Module, _Class, _Fmt) \
	DBGLOG_FUNC(_Module, _Class, _Fmt)
#define PF_TRACE_LOGDUMP8(_StartAddr, _Length) \
	dumpMemory8(DBG_PF_IDX, DBG_CLASS_TRACE, _StartAddr, _Length)
#define PF_TRACE_LOGDUMP32(_StartAddr, _Length) \
	dumpMemory32(DBG_PF_IDX, DBG_CLASS_TRACE, _StartAddr, _Length)
#else
#define PF_TRACE_LOGFUNC(_Module, _Class, _Fmt)
#define PF_TRACE_LOGDUMP8(_StartAddr, _Length)
#define PF_TRACE_LOGDUMP32(_StartAddr, _Length)
...
#if (PF_DBG_CLASSES & DBG_CLASS_INFO)
#define PF_INFO_LOGFUNC(_Module, _Class, _Fmt) \
	DBGLOG_FUNC(_Module, _Class, _Fmt)
#define PF_INFO_LOGDUMP8(_StartAddr, _Length) \
	dumpMemory8(DBG_PF_IDX, DBG_CLASS_INFO, _StartAddr, _Length)
#define PF_INFO_LOGDUMP32(_StartAddr, _Length) \
	dumpMemory32(DBG_PF_IDX, DBG_CLASS_INFO, _StartAddr, _Length)
#else
#define PF_INFO_LOGFUNC(_Module, _Class, _Fmt)
#define PF_INFO_LOGDUMP8(_StartAddr, _Length)
#define PF_INFO_LOGDUMP32(_StartAddr, _Length)
...
#if (PF_DBG_CLASSES & DBG_CLASS_LOUD)
#define PF_LOUD_LOGFUNC(_Module, _Class, _Fmt) \
	DBGLOG_FUNC(_Module, _Class, _Fmt)
#define PF_LOUD_LOGDUMP8(_StartAddr, _Length) \
	dumpMemory8(DBG_PF_IDX, DBG_CLASS_LOUD, _StartAddr, _Length)
#define PF_LOUD_LOGDUMP32(_StartAddr, _Length) \
	dumpMemory32(DBG_PF_IDX, DBG_CLASS_LOUD, _StartAddr, _Length)
#else
#define PF_LOUD_LOGFUNC(_Module, _Class, _Fmt)
#define PF_LOUD_LOGDUMP8(_StartAddr, _Length)
#define PF_LOUD_LOGDUMP32(_StartAddr, _Length)
...
#if (PF_DBG_CLASSES & DBG_CLASS_TEMP)
#define PF_TEMP_LOGFUNC(_Module, _Class, _Fmt) \
	DBGLOG_FUNC(_Module, _Class, _Fmt)
#define PF_TEMP_LOGDUMP8(_StartAddr, _Length) \
	dumpMemory8(DBG_PF_IDX, DBG_CLASS_TEMP, _StartAddr, _Length)
#define PF_TEMP_LOGDUMP32(_StartAddr, _Length) \
	dumpMemory32(DBG_PF_IDX, DBG_CLASS_TEMP, _StartAddr, _Length)
#else
#define PF_TEMP_LOGFUNC(_Module, _Class, _Fmt)
#define PF_TEMP_LOGDUMP8(_StartAddr, _Length)
#define PF_TEMP_LOGDUMP32(_StartAddr, _Length)
...
#define DBGLOG(_Module, _Class, _Fmt, ...) \
	do { \
		if ((aucDebugModule[DBG_##_Module##_IDX] & DBG_CLASS_##_Class) == 0) \
			break; \
		pr_info(WLAN_TAG"[%u]"_Fmt, KAL_GET_CURRENT_THREAD_ID(), ##__VA_ARGS__); \
	} while (0)
#else /* for 7623 pcie */
#define DBGLOG(_Module, _Class, _Fmt, ...) \
	printk(WLAN_TAG"[%u]"_Fmt, KAL_GET_CURRENT_THREAD_ID(), ##__VA_ARGS__)
#endif
