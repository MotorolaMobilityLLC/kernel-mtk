...
********************************************************************************
*/
static void *glResetCallback(enum ENUM_WMTDRV_TYPE_T eSrcType,
			     enum ENUM_WMTDRV_TYPE_T eDstType,
			     enum ENUM_WMTMSG_TYPE_T eMsgType, void *prMsgBody, unsigned int u4MsgLength);
			     ...
			     enum ENUM_WMTMSG_TYPE_T eMsgType, void *prMsgBody, unsigned int u4MsgLength)
{
	...
	case WMTMSG_TYPE_RESET:
		if (u4MsgLength == sizeof(enum ENUM_WMTRSTMSG_TYPE_T)) {
			enum ENUM_WMTRSTMSG_TYPE_T *prRstMsg = (enum ENUM_WMTRSTMSG_TYPE_T *) prMsgBody;
