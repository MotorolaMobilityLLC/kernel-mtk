...
/*STP exp*/
MTK_WCN_STP_SEND_DATA mtk_wcn_stp_send_data_f;
MTK_WCN_STP_SEND_DATA mtk_wcn_stp_send_data_raw_f;
MTK_WCN_STP_PARSER_DATA mtk_wcn_stp_parser_data_f;
MTK_WCN_STP_RECV_DATA mtk_wcn_stp_receive_data_f;
MTK_WCN_STP_IS_RXQ_EMPTY mtk_wcn_stp_is_rxqueue_empty_f;
MTK_WCN_STP_IS_RDY mtk_wcn_stp_is_ready_f;
MTK_WCN_STP_SET_BLUEZ mtk_wcn_stp_set_bluez_f;
MTK_WCN_STP_REG_IF_TX mtk_wcn_stp_if_tx_f;
MTK_WCN_STP_REG_IF_RX mtk_wcn_stp_if_rx_f;
MTK_WCN_STP_REG_EVENT_CB mtk_wcn_stp_reg_event_cb_f;
MTK_WCN_STP_RGE_TX_EVENT_CB mtk_wcn_stp_reg_tx_event_cb_f;
MTK_WCN_STP_COREDUMP_START_GET mtk_wcn_stp_coredump_start_get_f;

/*WMT exp*/
MTK_WCN_WMT_FUNC_CTRL mtk_wcn_wmt_func_on_f;
MTK_WCN_WMT_FUNC_CTRL mtk_wcn_wmt_func_off_f;
MTK_WCN_WMT_THERM_CTRL mtk_wcn_wmt_therm_ctrl_f;
MTK_WCN_WMT_HWVER_GET mtk_wcn_wmt_hwver_get_f;
MTK_WCN_WMT_DSNS_CTRL mtk_wcn_wmt_dsns_ctrl_f;
MTK_WCN_WMT_MSGCB_REG mtk_wcn_wmt_msgcb_reg_f;
MTK_WCN_WMT_MSGCB_UNREG mtk_wcn_wmt_msgcb_unreg_f;
MTK_WCN_WMT_SDIO_OP_REG mtk_wcn_wmt_sdio_op_reg_f;
MTK_WCN_WMT_SDIO_HOST_AWAKE mtk_wcn_wmt_sdio_host_awake_f;
MTK_WCN_WMT_ASSERT mtk_wcn_wmt_assert_f;
MTK_WCN_WMT_ASSERT_TIMEOUT mtk_wcn_wmt_assert_timeout_f;
MTK_WCN_WMT_IC_INFO_GET mtk_wcn_wmt_ic_info_get_f;
MTK_WCN_WMT_PSM_CTRL mtk_wcn_wmt_psm_ctrl_f;
MTK_WCN_WMT_FLASH_PATCH_CTRL mtk_wcn_wmt_flash_patch_ctrl_f;
