...
static enum ENUM_WMT_CHIP_TYPE g_chip_type = WMT_CHIP_TYPE_INVALID;
...
enum ENUM_WMT_CHIP_TYPE wmt_detect_get_chip_type(void)
{
	return g_chip_type;
}
...
module_param(gWmtDetectMajor, uint, 0000);
