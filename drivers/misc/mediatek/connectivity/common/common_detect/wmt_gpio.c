...
struct GPIO_CTRL_INFO gpio_ctrl_info;
...
VOID _wmt_gpio_pre_regs(INT32 num, struct WMT_GPIO_STATE_INFO *gpio_state)
{
...
VOID _wmt_dump_gpio_pre_regs(struct WMT_GPIO_STATE_INFO gpio_state)
{
	pr_err("PIN: [MODE] [PULL_SEL] [DIN] [DOUT] [PULL EN] [DIR] [IES]\n");
	pr_err("idx = %3d: %d %d %d %d %d %d %d\n",
