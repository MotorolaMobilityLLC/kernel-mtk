...
#endif
#if defined(CONFIG_MTK_PMIC_CHIP_MT6355)
		pmic_set_register_value(PMIC_RG_LDO_VCN33_EN_BT, 1);
#else
...
#if CONSYS_PMIC_CTRL_ENABLE
#if defined(CONFIG_MTK_PMIC_CHIP_MT6355)
		pmic_set_register_value(PMIC_RG_LDO_VCN33_EN_BT, 0);
#else
...
#endif
#if defined(CONFIG_MTK_PMIC_CHIP_MT6355)
		pmic_set_register_value(PMIC_RG_LDO_VCN33_EN_WIFI, 1);
#else
...
#if CONSYS_PMIC_CTRL_ENABLE
#if defined(CONFIG_MTK_PMIC_CHIP_MT6355)
		pmic_set_register_value(PMIC_RG_LDO_VCN33_EN_WIFI, 0);
#else
