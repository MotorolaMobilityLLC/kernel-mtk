...
struct WMT_CONSYS_IC_OPS *wmt_consys_ic_ops;
...
struct WMT_CONSYS_IC_OPS *__weak mtk_wcn_get_consys_ic_ops(VOID)
{
	WMT_PLAT_WARN_FUNC("Does not support on combo\n");
	return NULL;
}
...
struct CONSYS_EMI_ADDR_INFO *mtk_wcn_consys_soc_get_emi_phy_add(VOID)
{
