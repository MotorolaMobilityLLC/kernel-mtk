...
enum ENUM_EMI_CTRL_STATE_OFFSET {
...
typedef struct CONSYS_EMI_ADDR_INFO *(*CONSYS_IC_SOC_GET_EMI_PHY_ADD) (VOID);
...
extern struct EMI_CTRL_STATE_OFFSET mtk_wcn_emi_state_off;
extern struct CONSYS_EMI_ADDR_INFO mtk_wcn_emi_addr_info;
...
struct WMT_CONSYS_IC_OPS *mtk_wcn_get_consys_ic_ops(VOID);
