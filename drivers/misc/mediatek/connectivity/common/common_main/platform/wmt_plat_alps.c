...
#endif
static INT32 wmt_plat_ldo_ctrl(enum ENUM_PIN_STATE state);
static INT32 wmt_plat_pmu_ctrl(enum ENUM_PIN_STATE state);
static INT32 wmt_plat_rtc_ctrl(enum ENUM_PIN_STATE state);
static INT32 wmt_plat_rst_ctrl(enum ENUM_PIN_STATE state);
static INT32 wmt_plat_bgf_eint_ctrl(enum ENUM_PIN_STATE state);
static INT32 wmt_plat_wifi_eint_ctrl(enum ENUM_PIN_STATE state);
static INT32 wmt_plat_all_eint_ctrl(enum ENUM_PIN_STATE state);
static INT32 wmt_plat_uart_ctrl(enum ENUM_PIN_STATE state);
static INT32 wmt_plat_pcm_ctrl(enum ENUM_PIN_STATE state);
static INT32 wmt_plat_i2s_ctrl(enum ENUM_PIN_STATE state);
static INT32 wmt_plat_sdio_pin_ctrl(enum ENUM_PIN_STATE state);
static INT32 wmt_plat_gps_sync_ctrl(enum ENUM_PIN_STATE state);
static INT32 wmt_plat_gps_lna_ctrl(enum ENUM_PIN_STATE state);
static INT32 wmt_plat_uart_rx_ctrl(enum ENUM_PIN_STATE state);
...
UINT32 gCoClockFlag;
struct BGF_IRQ_BALANCE g_bgf_irq_lock;
...
static enum ENUM_STP_TX_IF_TYPE gCommIfType = STP_MAX_IF_TX;
#if CFG_WMT_WAKELOCK_SUPPORT
static struct OSAL_SLEEPABLE_LOCK gOsSLock;
static struct OSAL_WAKE_LOCK wmt_wake_lock;
#endif
...
INT32 wmt_plat_sdio_ctrl(enum WMT_SDIO_SLOT_NUM sdioPortType, enum ENUM_FUNC_STATE on)
{
	return board_sdio_ctrl(sdioPortType, (on == FUNC_OFF) ? 0 : 1);
}

INT32 wmt_plat_irq_ctrl(enum ENUM_FUNC_STATE state)
{
	return -1;
}
...
INT32 wmt_plat_ps_ctrl(enum ENUM_FUNC_STATE state)
{
	return -1;
}
...
static INT32 wmt_plat_cmb_i2s_ctrl(enum ENUM_PIN_STATE state)
{
...
static INT32 wmt_plat_soc_i2s_ctrl(enum ENUM_PIN_STATE state)
{
...
static INT32 wmt_plat_cmb_gps_sync_ctrl(enum ENUM_PIN_STATE state)
{
	if (gpio_ctrl_info.gpio_ctrl_state[GPIO_GPS_SYNC_PIN].gpio_num == DEFAULT_PIN_ID) {
...
static INT32 wmt_plat_soc_gps_sync_ctrl(enum ENUM_PIN_STATE state)
{
...
static INT32 wmt_plat_soc_gps_lna_ctrl(enum ENUM_PIN_STATE state)
{
...
static INT32 wmt_plat_cmb_gps_lna_ctrl(enum ENUM_PIN_STATE state)
{
	if (gpio_ctrl_info.gpio_ctrl_state[GPIO_GPS_LNA_PIN].gpio_num != DEFAULT_PIN_ID) {
		switch (state) {
		case PIN_STA_INIT:
