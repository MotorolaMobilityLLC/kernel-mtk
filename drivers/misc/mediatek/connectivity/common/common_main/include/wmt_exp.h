...
#endif
extern struct OSAL_BIT_OP_VAR gBtWifiGpsState;
extern struct OSAL_BIT_OP_VAR gGpsFmState;
...
typedef VOID(*PF_WMT_CB) (enum ENUM_WMTDRV_TYPE_T,	/* Source driver type */
			  enum ENUM_WMTDRV_TYPE_T,	/* Destination driver type */
			  enum ENUM_WMTMSG_TYPE_T,	/* Message type */
...
typedef INT32(*PF_WMT_SDIO_PSOP) (enum SDIO_PS_OP);
...
enum ENUM_WMT_FLASH_PATCH_TYPE {
...
enum ENUM_WMT_FLASH_PATCH_STATUS {
...
typedef MTK_WCN_BOOL(*MTK_WCN_WMT_FUNC_CTRL) (enum ENUM_WMTDRV_TYPE_T type);
typedef INT8(*MTK_WCN_WMT_THERM_CTRL) (enum ENUM_WMTTHERM_TYPE_T eType);
typedef enum ENUM_WMTHWVER_TYPE_T(*MTK_WCN_WMT_HWVER_GET) (VOID);
typedef MTK_WCN_BOOL(*MTK_WCN_WMT_DSNS_CTRL) (enum ENUM_WMTDSNS_TYPE_T eType);
typedef INT32(*MTK_WCN_WMT_MSGCB_REG) (enum ENUM_WMTDRV_TYPE_T eType, PF_WMT_CB pCb);
typedef INT32(*MTK_WCN_WMT_MSGCB_UNREG) (enum ENUM_WMTDRV_TYPE_T eType);
typedef INT32(*MTK_WCN_WMT_SDIO_OP_REG) (PF_WMT_SDIO_PSOP own_cb);
typedef INT32(*MTK_WCN_WMT_SDIO_HOST_AWAKE) (VOID);
typedef MTK_WCN_BOOL(*MTK_WCN_WMT_ASSERT) (enum ENUM_WMTDRV_TYPE_T type, UINT32 reason);
typedef MTK_WCN_BOOL(*MTK_WCN_WMT_ASSERT_TIMEOUT)(enum ENUM_WMTDRV_TYPE_T type,
		UINT32 reason, INT32 timeout);
typedef UINT32(*MTK_WCN_WMT_IC_INFO_GET) (enum ENUM_WMT_CHIPINFO_TYPE_T type);
typedef INT32 (*MTK_WCN_WMT_PSM_CTRL)(MTK_WCN_BOOL flag);

typedef enum ENUM_WMT_FLASH_PATCH_STATUS(*MTK_WCN_WMT_FLASH_PATCH_CTRL)(enum ENUM_WMT_FLASH_PATCH_CTRL ctrlId,
		PUINT8 pBuf, UINT32 length, enum ENUM_WMT_FLASH_PATCH_SEQ seq, enum ENUM_WMT_FLASH_PATCH_TYPE type,
		PUINT32 version, UINT32 checksum);

struct MTK_WCN_WMT_EXP_CB_INFO {
...
enum ENUM_BT_GPS_ONOFF_STATE_T {
	WMT_BT_ON = 0,
	WMT_GPS_ON = 1,
	WMT_WIFI_ON = 2,
	WMT_FM_ON = 3,
...
extern INT32 mtk_wcn_wmt_wlan_reg(struct MTK_WCN_WMT_WLAN_CB_INFO *pWmtWlanCbInfo);
...
extern MTK_WCN_BOOL mtk_wcn_wmt_assert(enum ENUM_WMTDRV_TYPE_T type, UINT32 reason);

#ifdef MTK_WCN_WMT_STP_EXP_SYMBOL_ABSTRACT

extern MTK_WCN_BOOL mtk_wcn_wmt_func_off(enum ENUM_WMTDRV_TYPE_T type);

extern MTK_WCN_BOOL mtk_wcn_wmt_func_on(enum ENUM_WMTDRV_TYPE_T type);

extern MTK_WCN_BOOL mtk_wcn_wmt_dsns_ctrl(enum ENUM_WMTDSNS_TYPE_T eType);

extern MTK_WCN_BOOL mtk_wcn_wmt_assert(enum ENUM_WMTDRV_TYPE_T type, UINT32 reason);

extern MTK_WCN_BOOL mtk_wcn_wmt_assert_timeout(enum ENUM_WMTDRV_TYPE_T type, UINT32 reason, INT32 timeout);

extern INT32 mtk_wcn_wmt_msgcb_reg(enum ENUM_WMTDRV_TYPE_T eType, PF_WMT_CB pCb);

extern INT32 mtk_wcn_wmt_msgcb_unreg(enum ENUM_WMTDRV_TYPE_T eType);
...
*/
extern INT8 mtk_wcn_wmt_therm_ctrl(enum ENUM_WMTTHERM_TYPE_T eType);

extern enum ENUM_WMTHWVER_TYPE_T mtk_wcn_wmt_hwver_get(VOID);

extern UINT32 mtk_wcn_wmt_ic_info_get(enum ENUM_WMT_CHIPINFO_TYPE_T type);


extern INT32 mtk_wcn_wmt_chipid_query(VOID);

extern INT32 mtk_wcn_wmt_psm_ctrl(MTK_WCN_BOOL flag);
extern enum ENUM_WMT_FLASH_PATCH_STATUS mtk_wcn_wmt_flash_patch_ctrl(enum ENUM_WMT_FLASH_PATCH_CTRL ctrlId,
		PUINT8 pBuf, UINT32 length, enum ENUM_WMT_FLASH_PATCH_SEQ seq, enum ENUM_WMT_FLASH_PATCH_TYPE type,
		PUINT32 version, UINT32 checksum);
...
#ifdef CONFIG_MTK_COMBO_ANT
extern enum ENUM_WMT_ANT_RAM_STATUS mtk_wcn_wmt_ant_ram_ctrl(ENUM_WMT_ANT_RAM_CTRL ctrlId, PUINT8 pBuf,
...
extern VOID mtk_wcn_wmt_func_ctrl_for_plat(UINT32 on, enum ENUM_WMTDRV_TYPE_T type);
