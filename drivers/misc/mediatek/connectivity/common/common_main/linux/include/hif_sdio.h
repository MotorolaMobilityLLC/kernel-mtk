...
typedef INT32 (*MTK_WCN_HIF_SDIO_PROBE)(UINT32,
		const struct MTK_WCN_HIF_SDIO_FUNCINFO *);
typedef INT32 (*MTK_WCN_HIF_SDIO_REMOVE)(UINT32);
typedef INT32 (*MTK_WCN_HIF_SDIO_IRQ)(UINT32);
...
struct MTK_WCN_HIF_SDIO_LOCKINFO {
...
struct MTK_WCN_HIF_SDIO_DS_CLT_INFO {
	UINT32 ctx;
	UINT16 func_num;
	UINT8 act_flag;
	UINT8 ds_en_flag;
...
struct MTK_WCN_HIF_SDIO_DS_INFO {
	...
	struct MTK_WCN_HIF_SDIO_DS_CLT_INFO clt_info[2];	/*currently, only BGF and WIFI function need this function */
	struct mutex lock;
} ;
 ...
 * \retval < 0  error code
 */
extern INT32 mtk_wcn_hif_sdio_client_reg(const struct MTK_WCN_HIF_SDIO_CLTINFO *pinfo);

extern INT32 mtk_wcn_hif_sdio_client_unreg(const struct MTK_WCN_HIF_SDIO_CLTINFO *pinfo);

extern INT32 mtk_wcn_hif_sdio_readb(UINT32 ctx, UINT32 offset, PUINT8 pvb);

extern INT32 mtk_wcn_hif_sdio_writeb(UINT32 ctx, UINT32 offset, UINT8 vb);

extern INT32 mtk_wcn_hif_sdio_readl(UINT32 ctx, UINT32 offset, PUINT32 pvl);

extern INT32 mtk_wcn_hif_sdio_writel(UINT32 ctx, UINT32 offset, UINT32 vl);

extern INT32 mtk_wcn_hif_sdio_read_buf(UINT32 ctx,
				       UINT32 offset, PUINT32 pbuf, UINT32 len);

extern INT32 mtk_wcn_hif_sdio_write_buf(UINT32 ctx,
					UINT32 offset, PUINT32 pbuf, UINT32 len);

extern INT32 mtk_wcn_hif_sdio_abort(UINT32 ctx);

INT32 hif_sdio_wake_up_ctrl(UINT32 ctx);

extern VOID mtk_wcn_hif_sdio_set_drvdata(UINT32 ctx, PVOID private_data_p);

extern PVOID mtk_wcn_hif_sdio_get_drvdata(UINT32 ctx);

extern INT32 mtk_wcn_hif_sdio_wmt_control(enum WMT_SDIO_FUNC_TYPE func_type, MTK_WCN_BOOL is_on);

extern INT32 mtk_wcn_hif_sdio_bus_set_power(UINT32 ctx, UINT32 pwrState);

extern VOID mtk_wcn_hif_sdio_get_dev(UINT32 ctx, struct device **dev);

extern INT32 mtk_wcn_hif_sdio_update_cb_reg(INT32(*ts_update)(VOID));

extern VOID mtk_wcn_hif_sdio_enable_irq(UINT32 ctx, MTK_WCN_BOOL enable);

extern INT32 mtk_wcn_hif_sdio_f0_writeb(UINT32 ctx, UINT32 offset, UINT8 vb);

extern INT32 mtk_wcn_hif_sdio_f0_readb(UINT32 ctx, UINT32 offset, PUINT8 pvb);
