...
INT32 mtk_wcn_consys_stp_btif_dpidle_ctrl(enum ENUM_BTIF_DPIDLE_CTRL en_flag);
INT32 mtk_wcn_consys_stp_btif_lpbk_ctrl(enum ENUM_BTIF_LPBK_MODE mode);
INT32 mtk_wcn_consys_stp_btif_logger_ctrl(enum ENUM_BTIF_DBG_ID flag);
