...
static enum ENUM_STP_TX_IF_TYPE g_stp_if_type = STP_MAX_IF_TX;
...
VOID mtk_wcn_stp_set_if_tx_type(enum ENUM_STP_TX_IF_TYPE stp_if_type)
{
...
#if STP_EXP_HID_API_EXPORT
INT32 _mtk_wcn_stp_register_if_tx(enum ENUM_STP_TX_IF_TYPE stp_if, MTK_WCN_STP_IF_TX func)
#else
INT32 mtk_wcn_stp_register_if_tx(enum ENUM_STP_TX_IF_TYPE stp_if, MTK_WCN_STP_IF_TX func)
#endif
{
...
INT32 mtk_wcn_stp_sdio_wake_up_ctrl(UINT32 ctx)
{
