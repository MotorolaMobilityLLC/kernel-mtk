...
static INT32 wmt_func_bt_on(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf);
static INT32 wmt_func_bt_off(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf);

struct WMT_FUNC_OPS wmt_func_bt_ops = {
...
static INT32 wmt_func_fm_on(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf);
static INT32 wmt_func_fm_off(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf);

struct WMT_FUNC_OPS wmt_func_fm_ops = {
...
static INT32 wmt_func_gps_on(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf);
static INT32 wmt_func_gps_off(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf);

struct WMT_FUNC_OPS wmt_func_gps_ops = {
...
static INT32 wmt_func_wifi_on(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf);
static INT32 wmt_func_wifi_off(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf);

struct WMT_FUNC_OPS wmt_func_wifi_ops = {
...
static INT32 wmt_func_ant_on(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf);
static INT32 wmt_func_ant_off(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf);

struct WMT_FUNC_OPS wmt_func_ant_ops = {
	/* BT subsystem function on/off */
...
*/
#if CFG_FUNC_GPS_SUPPORT
struct CMB_PIN_CTRL_REG eediPinOhRegs[] = {
	{
...
struct CMB_PIN_CTRL_REG eediPinOlRegs[] = {
	{
	 .regAddr = 0x80050020,
	 .regValue = 0x1L << 5,
	 .regMask = 0x00000020L,
...
struct CMB_PIN_CTRL_REG eedoPinOhRegs[] = {
	{
	 .regAddr = 0x80050020,
	 .regValue = ~(0x1L << 7),
	 .regMask = 0x00000080L,
...
struct CMB_PIN_CTRL_REG eedoPinOlRegs[] = {
	{
	 .regAddr = 0x80050020,
	 .regValue = 0x1L << 7,
	 .regMask = 0x00000080L,
...
struct CMB_PIN_CTRL_REG gsyncPinOnRegs[] = {
	{
	 .regAddr = 0x80050110,
	 .regValue = 0x3L << 20,
	 .regMask = 0x7L << 20,
...
struct CMB_PIN_CTRL_REG gsyncPinOffRegs[] = {
	{
	 .regAddr = 0x80050110,
	 .regValue = 0x0L << 20,
	 .regMask = 0x7L << 20,
...
struct CMB_PIN_CTRL gCmbPinCtrl[3] = {
	{
...
INT32 _osal_inline_ wmt_func_bt_ctrl(enum ENUM_FUNC_STATE funcState)
{
...
INT32 wmt_func_bt_on(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf)
{
	INT32 iRet = -1;
	ULONG ctrlPa1;
	ULONG ctrlPa2;
...
INT32 wmt_func_bt_off(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf)
{
	INT32 iRet1 = -1;
	INT32 iRet2 = -1;
	ULONG ctrlPa1;
...
INT32 _osal_inline_ wmt_func_ant_ctrl(enum ENUM_FUNC_STATE funcState)
{
	/*only need to send turn BT subsystem wmt command */
...
INT32 wmt_func_ant_on(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf)
{
	return wmt_core_func_ctrl_cmd(WMTDRV_TYPE_ANT, MTK_WCN_BOOL_TRUE);
}

INT32 wmt_func_ant_off(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf)
{
...
INT32 _osal_inline_ wmt_func_gps_ctrl(enum ENUM_FUNC_STATE funcState)
{
...
INT32 wmt_func_gps_pre_ctrl(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf, enum ENUM_FUNC_STATE funcStatus)
{
	UINT32 i = 0;
	UINT32 iRet = 0;
	UINT32 regAddr = 0;
	...
	UINT32 regMask = 0;
	UINT32 regNum = 0;
	struct CMB_PIN_CTRL_REG *pReg;
	struct CMB_PIN_CTRL *pCmbPinCtrl = &gCmbPinCtrl[CMB_PIN_GSYNC_ID];
	struct WMT_CTRL_DATA ctrlData;
	enum WMT_IC_PIN_ID wmtIcPinId = WMT_IC_PIN_MAX;
	/* sanity check */
...
INT32 wmt_func_gps_pre_on(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf)
{
	return wmt_func_gps_pre_ctrl(pOps, pConf, FUNC_ON);
}

INT32 wmt_func_gps_pre_off(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf)
{
...
INT32 wmt_func_gps_on(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf)
{
	INT32 iRet = 0;
...
INT32 wmt_func_gps_off(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf)
{
	INT32 iRet = 0;
...
INT32 _osal_inline_ wmt_func_fm_ctrl(enum ENUM_FUNC_STATE funcState)
{
...
INT32 wmt_func_fm_on(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf)
{
	ULONG ctrlPa1 = 0;
	ULONG ctrlPa2 = 0;
	INT32 iRet = -1;
...
INT32 wmt_func_fm_off(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf)
{
	ULONG ctrlPa1 = 0;
	ULONG ctrlPa2 = 0;
	INT32 iRet = -1;
...
INT32 wmt_func_wifi_ctrl(enum ENUM_FUNC_STATE funcState)
{
	INT32 iRet = 0;
...
INT32 wmt_func_wifi_on(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf)
{
	INT32 iRet = 0;
	ULONG ctrlPa1;
	ULONG ctrlPa2;
...
INT32 wmt_func_wifi_off(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf)
{
	INT32 iRet = 0;
	ULONG ctrlPa1 = 0;
	ULONG ctrlPa2 = 0;
