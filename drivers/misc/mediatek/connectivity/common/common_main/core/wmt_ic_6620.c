...
static const struct WMT_IC_INFO_S *gp_mt6620_info;
static struct WMT_PATCH gp_mt6620_patch_info;
...
static const struct WMT_IC_INFO_S mt6620_info_table[] = {
	{
	 .u4HwVer = 0x8A00,
...
static INT32 mt6620_sw_init(struct WMT_HIF_CONF *pWmtHifConf);

static INT32 mt6620_sw_deinit(struct WMT_HIF_CONF *pWmtHifConf);

static INT32 mt6620_pin_ctrl(enum WMT_IC_PIN_ID id, enum  WMT_IC_PIN_STATE state, UINT32 flag);

static INT32 mt6620_aif_ctrl(enum WMT_IC_PIN_STATE state, UINT32 flag);

static INT32 mt6620_ver_check(VOID);

static const struct WMT_IC_INFO_S *mt6620_find_wmt_ic_info(const UINT32 hw_ver);
...
struct WMT_IC_OPS wmt_ic_ops_mt6620 = {
	.icId = 0x6620,
...
static INT32 mt6620_patch_dwn(UINT32 index)
{
	 ...
	 */
	osal_memcpy(&gp_mt6620_patch_info, patchHdr, osal_sizeof(struct WMT_PATCH));
