...
********************************************************************************
*/
struct OSAL_BIT_OP_VAR gBtWifiGpsState;
struct OSAL_BIT_OP_VAR gGpsFmState;
UINT32 gWifiProbed;
...
static MTK_WCN_BOOL mtk_wcn_wmt_func_ctrl(enum ENUM_WMTDRV_TYPE_T type, enum ENUM_WMT_OPID_T opId);
...
MTK_WCN_BOOL mtk_wcn_wmt_func_off(enum ENUM_WMTDRV_TYPE_T type)
{
	MTK_WCN_BOOL ret;
...
MTK_WCN_BOOL mtk_wcn_wmt_func_on(enum ENUM_WMTDRV_TYPE_T type)
{
	MTK_WCN_BOOL ret;
...
*/
VOID mtk_wcn_wmt_func_ctrl_for_plat(UINT32 on, enum ENUM_WMTDRV_TYPE_T type)
{
	if (on)
...
INT8 mtk_wcn_wmt_therm_ctrl(enum ENUM_WMTTHERM_TYPE_T eType)
{
	struct OSAL_OP *pOp;
	struct OSAL_OP_DAT *pOpData;
	MTK_WCN_BOOL bRet;
	struct OSAL_SIGNAL *pSignal;
...
enum ENUM_WMTHWVER_TYPE_T mtk_wcn_wmt_hwver_get(VOID)
{
...
UINT32 mtk_wcn_wmt_ic_info_get(enum ENUM_WMT_CHIPINFO_TYPE_T type)
{
	return wmt_lib_get_icinfo(type);
}
EXPORT_SYMBOL(mtk_wcn_wmt_ic_info_get);

MTK_WCN_BOOL mtk_wcn_wmt_dsns_ctrl(enum ENUM_WMTDSNS_TYPE_T eType)
{
	struct OSAL_OP *pOp;
	struct OSAL_OP_DAT *pOpData;
	MTK_WCN_BOOL bRet;
...
INT32 mtk_wcn_wmt_msgcb_reg(enum ENUM_WMTDRV_TYPE_T eType, PF_WMT_CB pCb)
{
	return (INT32) wmt_lib_msgcb_reg(eType, pCb);
}
EXPORT_SYMBOL(mtk_wcn_wmt_msgcb_reg);

INT32 mtk_wcn_wmt_msgcb_unreg(enum ENUM_WMTDRV_TYPE_T eType)
{
...
MTK_WCN_BOOL mtk_wcn_wmt_assert_timeout(enum ENUM_WMTDRV_TYPE_T type, UINT32 reason, INT32 timeout)
{
...
MTK_WCN_BOOL mtk_wcn_wmt_assert(enum ENUM_WMTDRV_TYPE_T type, UINT32 reason)
{
...
*/
enum ENUM_WMT_FLASH_PATCH_STATUS mtk_wcn_wmt_flash_patch_ctrl(enum ENUM_WMT_FLASH_PATCH_CTRL ctrlId,
...
{
	enum ENUM_WMT_FLASH_PATCH_STATUS eRet = 0;
	struct OSAL_OP *pOp = NULL;
	MTK_WCN_BOOL bRet = MTK_WCN_BOOL_FALSE;
	struct OSAL_SIGNAL *pSignal;
...
INT32 mtk_wcn_wmt_wlan_reg(struct MTK_WCN_WMT_WLAN_CB_INFO *pWmtWlanCbInfo)
{
	INT32 iRet = -1;
...
*/
enum ENUM_WMT_ANT_RAM_STATUS mtk_wcn_wmt_ant_ram_ctrl(enum ENUM_WMT_ANT_RAM_CTRL ctrlId, PUINT8 pBuf,
						 UINT32 length, enum ENUM_WMT_ANT_RAM_SEQ seq)
{
	enum ENUM_WMT_ANT_RAM_STATUS eRet = 0;
	struct OSAL_OP *pOp = NULL;
	MTK_WCN_BOOL bRet = MTK_WCN_BOOL_FALSE;
	struct OSAL_SIGNAL *pSignal;
...
#endif
MTK_WCN_BOOL mtk_wcn_wmt_do_reset(enum ENUM_WMTDRV_TYPE_T type)
{
	INT32 iRet = -1;
	UINT8 *drv_name[] = {
		"DRV_TYPE_BT",
