...
struct WMT_FUNC_OPS *gpWmtFuncOps[WMTDRV_TYPE_MAX] = {
...
static struct WMT_CTX gMtkWmtCtx;
...
static INT32 opfunc_hif_conf(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_pwr_on(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_pwr_off(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_func_on(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_func_off(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_reg_rw(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_exit(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_pwr_sv(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_dsns(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_lpbk(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_cmd_test(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_hw_rst(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_sw_rst(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_stp_rst(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_therm_ctrl(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_efuse_rw(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_therm_ctrl(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_gpio_ctrl(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_sdio_ctrl(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_pin_state(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_bgw_ds(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_set_mcu_clk(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_adie_lpbk_test(struct OSAL_OP_DAT *pWmtOp);
...
#ifdef CONFIG_MTK_COMBO_ANT
static INT32 opfunc_ant_ram_down(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_ant_ram_stat_get(struct OSAL_OP_DAT *pWmtOp);
#endif
#if CFG_WMT_LTE_COEX_HANDLING
static INT32 opfunc_idc_msg_handling(struct OSAL_OP_DAT *pWmtOp);
#endif
static INT32 opfunc_trigger_stp_assert(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_flash_patch_down(struct OSAL_OP_DAT *pWmtOp);
static INT32 opfunc_flash_patch_ver_get(struct OSAL_OP_DAT *pWmtOp);
...
INT32 wmt_core_func_ctrl_cmd(enum ENUM_WMTDRV_TYPE_T type, MTK_WCN_BOOL fgEn)
{
	INT32 iRet = 0;
	...
	struct WMT_PKT rWmtPktCmd;
	struct WMT_PKT rWmtPktEvent;
	MTK_WCN_BOOL fgFail;
...
INT32 wmt_core_opid_handler(struct OSAL_OP_DAT *pWmtOp)
{
	UINT32 opId;
	INT32 ret;
...
INT32 wmt_core_opid(struct OSAL_OP_DAT *pWmtOp)
{
...
INT32 wmt_core_ctrl(enum ENUM_WMT_CTRL_T ctrId, PULONG pPa1, PULONG pPa2)
{
	INT32 iRet = -1;
	struct WMT_CTRL_DATA ctrlData;
...
static INT32 wmt_core_stp_init(VOID)
{
	...
	ULONG ctrlPa2;
	UINT8 co_clock_type;
	struct WMT_CTX *pctx = &gMtkWmtCtx;
	struct WMT_GEN_CONF *pWmtGenConf = NULL;
...
enum ENUM_DRV_STS wmt_core_get_drv_status(enum ENUM_WMTDRV_TYPE_T type)
{
...
{
	INT32 iRet = -1;
	enum WMT_IC_PIN_ID id;
	enum WMT_IC_PIN_STATE stat;
	UINT32 flag;
...
INT32 opfunc_sdio_ctrl(struct OSAL_OP_DAT *pWmtOp)
{
	ULONG ctrlPa1 = 0;
	ULONG ctrlPa2 = 0;
	UINT32 iRet = 0;
...
INT32 opfunc_trigger_stp_assert(struct OSAL_OP_DAT *pWmtOp)
{
...
#endif
INT32 opfunc_pin_state(struct OSAL_OP_DAT *pWmtOp)
{
	ULONG ctrlPa1 = 0;
	ULONG ctrlPa2 = 0;
	INT32 iRet = 0;
...
#ifdef CONFIG_MTK_COMBO_ANT
INT32 opfunc_ant_ram_down(struct OSAL_OP_DAT *pWmtOp)
{
	INT32 iRet = 0;
...
INT32 opfunc_ant_ram_stat_get(struct OSAL_OP_DAT *pWmtOp)
{
	INT32 iRet = 0;
	UINT32 u4Res = 0;
...
#endif
VOID wmt_core_set_coredump_state(enum ENUM_DRV_STS state)
{
	WMT_INFO_FUNC("wmt-core: set coredump state(%d)\n", state);
	gMtkWmtCtx.eDrvStatus[WMTDRV_TYPE_COREDUMP] = state;
}

INT32 opfunc_flash_patch_down(struct OSAL_OP_DAT *pWmtOp)
{
	INT32 iRet = 0;
...
INT32 opfunc_flash_patch_ver_get(struct OSAL_OP_DAT *pWmtOp)
{
	INT32 iRet = 0;
	UINT32 u4Res = 0;
