...
/* kernel lib */
/* INT32                g_block_tx = 0; */
static struct mtkstp_context_struct stp_core_ctx = { 0 };
...
static enum mtkstp_parser_state prev_state = -1;


#define CONFIG_DEBUG_STP_TRAFFIC_SUPPORT
#ifdef CONFIG_DEBUG_STP_TRAFFIC_SUPPORT
static struct MTKSTP_DBG_T *g_mtkstp_dbg;
#endif
...
static VOID stp_change_rx_state(enum mtkstp_parser_state next);
...
static INT32 stp_ctx_lock_init(struct mtkstp_context_struct *pctx)
{
...
INT32 __weak mtk_wcn_consys_stp_btif_logger_ctrl(enum ENUM_BTIF_DBG_ID flag)
{
...
INT32 __weak mtk_wcn_consys_stp_btif_lpbk_ctrl(enum ENUM_BTIF_LPBK_MODE mode)
{
...
static INT32 stp_ctx_lock_deinit(struct mtkstp_context_struct *pctx)
{
#if CFG_STP_CORE_CTX_SPIN_LOCK
...
static INT32 stp_ctx_lock(struct mtkstp_context_struct *pctx)
{
	/* dump_stack(); */
	/* pr_debug("stp_lock\n\r"); */
#if CFG_STP_CORE_CTX_SPIN_LOCK
...
static INT32 stp_ctx_unlock(struct mtkstp_context_struct *pctx)
{
	/* dump_stack(); */
	/* pr_debug("stp_unlock\n\r"); */
...
*****************************************************************************/
INT32 mtk_wcn_stp_init(const struct mtkstp_callback * const cb_func)
{
	INT32 ret = 0;
	INT32 i = 0;
...
*****************************************************************************/
INT32 mtk_wcn_stp_psm_notify_stp(const enum MTKSTP_PSM_ACTION_T action)
{
	return stp_psm_notify_stp(STP_PSM_CORE(stp_core_ctx), action);
}

INT32 mtk_wcn_stp_set_psm_state(enum MTKSTP_PSM_STATE_T state)
{
...
*  always 0
*****************************************************************************/
INT32 mtk_wcn_stp_dpidle_ctrl(enum ENUM_BTIF_DPIDLE_CTRL en_flag)
{
...
*  INT32 0-success,other fail.
*****************************************************************************/
INT32 mtk_wcn_stp_lpbk_ctrl(enum ENUM_BTIF_LPBK_MODE mode)
{
...
*  INT32 0-success,other fail.
*****************************************************************************/
INT32 mtk_wcn_stp_logger_ctrl(enum ENUM_BTIF_DBG_ID flag)
{
