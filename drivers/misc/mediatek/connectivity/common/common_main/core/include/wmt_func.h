...
typedef INT32 (*SUBSYS_FUNC_ON)(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf);
typedef INT32 (*SUBSYS_FUNC_OFF)(struct WMT_IC_OPS *pOps, struct WMT_GEN_CONF *pConf);
...
struct CMB_PIN_CTRL {
	UINT32 pinId;
	UINT32 regNum;
	struct CMB_PIN_CTRL_REG *pFuncOnArray;
	struct CMB_PIN_CTRL_REG *pFuncOffArray;

};

enum ENUM_CMP_PIN_ID {
	CMB_PIN_EEDI_ID = 0,
	CMB_PIN_EEDO_ID = 1,
	CMB_PIN_GSYNC_ID = 2,
};
...
extern struct WMT_FUNC_OPS wmt_func_bt_ops;
#endif

#if CFG_FUNC_FM_SUPPORT
extern struct WMT_FUNC_OPS wmt_func_fm_ops;
#endif

#if CFG_FUNC_GPS_SUPPORT
extern struct WMT_FUNC_OPS wmt_func_gps_ops;
#endif

#if CFG_FUNC_WIFI_SUPPORT
extern struct WMT_FUNC_OPS wmt_func_wifi_ops;
#endif

#if CFG_FUNC_ANT_SUPPORT
extern struct WMT_FUNC_OPS wmt_func_ant_ops;
#endif
