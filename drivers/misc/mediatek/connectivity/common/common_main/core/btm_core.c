...
struct MTKSTP_BTM_T stp_btm_i;
struct MTKSTP_BTM_T *stp_btm = &stp_btm_i;
...
static INT32 _stp_btm_handler(struct MTKSTP_BTM_T *stp_btm, struct OSAL_OP_DAT *pStpOp)
{
	INT32 ret = -1;
...
static struct OSAL_OP *_stp_btm_get_op(struct MTKSTP_BTM_T *stp_btm, struct OSAL_OP_Q *pOpQ)
{
	struct OSAL_OP *pOp;
	/* INT32 ret = 0; */
...
static INT32 _stp_btm_put_op(struct MTKSTP_BTM_T *stp_btm, struct OSAL_OP_Q *pOpQ, struct OSAL_OP *pOp)
{
	INT32 ret;
	struct OSAL_OP *pOp_latest = NULL;
	struct OSAL_OP *pOp_current = NULL;
	INT32 flag_latest = 1;
...
struct OSAL_OP *_stp_btm_get_free_op(struct MTKSTP_BTM_T *stp_btm)
{
	struct OSAL_OP *pOp;
...
INT32 _stp_btm_put_act_op(struct MTKSTP_BTM_T *stp_btm, struct OSAL_OP *pOp)
{
	INT32 bRet = 0;
	INT32 bCleanup = 0;
	INT32 wait_ret = -1;
...
{
	struct MTKSTP_BTM_T *stp_btm = (struct MTKSTP_BTM_T *) pvData;
...
static inline INT32 _stp_btm_dump_type(struct MTKSTP_BTM_T *stp_btm, enum ENUM_STP_BTM_OPID_T opid)
{
	struct OSAL_OP *pOp;
	INT32 bRet;
	INT32 retval;
...
static inline INT32 _stp_btm_notify_wmt_rst_wq(struct MTKSTP_BTM_T *stp_btm)
{
	INT32 retval;
...
static inline INT32 _stp_btm_notify_stp_retry_wq(struct MTKSTP_BTM_T *stp_btm)
{
	INT32 retval;
...
static inline INT32 _stp_btm_notify_coredump_timeout_wq(struct MTKSTP_BTM_T *stp_btm)
{
	INT32 retval;
...
static inline INT32 _stp_btm_notify_wmt_dmp_wq(struct MTKSTP_BTM_T *stp_btm)
{
...
static inline INT32 _stp_notify_btm_handle_wmt_lte_coex(struct MTKSTP_BTM_T *stp_btm)
{
	INT32 retval;
...
static inline INT32 _stp_btm_do_fw_assert(struct MTKSTP_BTM_T *stp_btm)
{
	INT32 status = -1;
	INT32 j = 0;
