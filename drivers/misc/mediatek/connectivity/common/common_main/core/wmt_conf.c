...
struct parse_data {
	PINT8 name;
	INT32 (*parser)(struct DEV_WMT *pWmtDev, const struct parse_data *data, const PINT8 value);
	PINT8 (*writer)(struct DEV_WMT *pWmtDev, const struct parse_data *data);
...
*******************************************************************************
*/
static INT32 wmt_conf_parse_char(struct DEV_WMT *pWmtDev, const struct parse_data *data, const PINT8 pos);

static PINT8 wmt_conf_write_char(struct DEV_WMT *pWmtDev, const struct parse_data *data);

static INT32 wmt_conf_parse_short(struct DEV_WMT *pWmtDev,
				  const struct parse_data *data, const PINT8 pos);

static PINT8 wmt_conf_write_short(struct DEV_WMT *pWmtDev, const struct parse_data *data);

static INT32 wmt_conf_parse_int(struct DEV_WMT *pWmtDev, const struct parse_data *data, const PINT8 pos);

static PINT8 wmt_conf_write_int(struct DEV_WMT *pWmtDev, const struct parse_data *data);

static INT32 wmt_conf_parse_pair(struct DEV_WMT *pWmtDev, const PINT8 pKey, const PINT8 pVal);

static INT32 wmt_conf_parse(struct DEV_WMT *pWmtDev, const PINT8 pInBuf, UINT32 size);

#define OFFSET(v) ((void *) &((struct DEV_WMT *) 0)->v)
...
static INT32 wmt_conf_parse_short(struct DEV_WMT *pWmtDev, const struct parse_data *data, const PINT8 pos)
{
	PUINT16 dst;
	long res;
...
{
	INT32 ret = -1;
	enum ENUM_WMT_CHIP_TYPE chip_type;
	...
	if (0 ==
	    wmt_dev_patch_get(&gDevWmt.cWmtcfgName[0], (struct firmware **) &gDevWmt.pWmtCfg)) {
		...
		wmt_dev_patch_put((struct firmware **) &gDevWmt.pWmtCfg);
/*
*	if (gDevWmt.pWmtCfg)
*	{
...
struct WMT_GEN_CONF *wmt_conf_get_cfg(VOID)
{
