...
static void mtktspmic_read_efuse(void)
{
	...
	mtktspmic_dprintk("[pmic_debug] 6356_efuse: g_o_vts        = %d\n", g_o_vts);
	mtktspmic_dprintk("[pmic_debug] 6356_efuse: g_degc_cali    = %d\n", g_degc_cali);
	mtktspmic_dprintk("[pmic_debug] 6356_efuse: g_adc_cali_en  = %d\n", g_adc_cali_en);
	mtktspmic_dprintk("[pmic_debug] 6356_efuse: g_o_slope      = %d\n", g_o_slope);
	mtktspmic_dprintk("[pmic_debug] 6356_efuse: g_o_slope_sign = %d\n", g_o_slope_sign);
	mtktspmic_dprintk("[pmic_debug] 6356_efuse: g_id		   = %d\n", g_id);
