...
#define tscpu_dpr_debug(fmt, args...)                                          \
	do {                                                                  \
...
extern void tscpu_thermal_read_tc_temp(int tc_num, enum thermal_sensor type,
				       int order);
extern void tscpu_thermal_cal_prepare(void);
extern void tscpu_thermal_cal_prepare_2(unsigned int ret);
extern irqreturn_t tscpu_thermal_all_tc_interrupt_handler(int irq,
							  void *dev_id);
...
#define INFRA_GLOBALCON_RST_0_SET                                             \
	(INFRACFG_AO_BASE_2 + 0x120) /*yes, 0x10000000*/
#define INFRA_GLOBALCON_RST_0_CLR                                             \
	(INFRACFG_AO_BASE_2 + 0x124) /*yes, 0x10000000*/
#define INFRA_GLOBALCON_RST_0_STA                                             \
	(INFRACFG_AO_BASE_2 + 0x128) /*yes, 0x10000000*/
/*******************************************************************************
