...
//Common to all Vtskin
static int mtktsvtskin_change_mode
...
static struct thermal_zone_device_ops mtktsvtskin3_dev_ops = {
	...
	.change_mode = mtktsvtskin_change_mode,
...
static int mtkts_vtskin0_open(struct inode *inode, struct file *file)
{
...
static const struct proc_ops mtkts_vtskin_max_fops = {
	.proc_open = mtkts_vtskin0_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_write = mtktsvtskin0_write,
	.proc_release = single_release,
};


static const struct proc_ops mtkts_vtskin1_fops = {
	.proc_open = mtkts_vtskin1_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_write = mtktsvtskin1_write,
	.proc_release = single_release,
};

static const struct proc_ops mtkts_vtskin2_fops = {
	.proc_open = mtkts_vtskin2_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_write = mtktsvtskin2_write,
	.proc_release = single_release,
};

static const struct proc_ops mtkts_vtskin3_fops = {
	.proc_open = mtkts_vtskin3_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_write = mtktsvtskin3_write,
	.proc_release = single_release,
};
...
int vtskin_init(void)
{
	pr_notice("[%s]\n", __func__);
	platform_driver_register(&vtskin_driver);
	return 0;
}

void vtskin_exit(void)
{
	pr_notice("[%s]\n", __func__);
	mtktsvtskin_max_unregister_thermal();
	mtktsvtskin1_unregister_thermal();
