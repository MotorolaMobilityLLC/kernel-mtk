...
struct SMI_SETTING_VALUE smi_profile_setting_larb4_vss[SMI_LARB4_PORT_NUM] = {
	{0x200, 0x20}, {0x204, 0x8}, {0x208, 0x2}, {0x20c, 0x1}, {0x210, 0x1}, {0x214, 0x2}, {0x218, 0x1},
...
struct SMI_SETTING_VALUE smi_profile_setting_larb7_vss[SMI_LARB7_PORT_NUM] = {
	{0x200, 0x1}, {0x204, 0x3}, {0x208, 0x1}, {0x20c, 0x1}, {0x210, 0x1}, {0x214, 0x1}, {0x218, 0x1}, {0x21c,
											     0x1},
	{0x220, 0x1}, {0x224, 0x4}, {0x228, 0x2}, {0x22c, 0x6}, {0x230, 0x3}, {0x234, 0xb}, {0x238, 0xC}, {0x23c, 0x1},
	{0x240, 0x1}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb0_init[SMI_LARB0_PORT_NUM] = {
	{0x200, 0x2f}, {0x204, 0x2f}, {0x208, 0x10}, {0x20c, 0x10}, {0x210, 0x5}, {0x214, 0x5}, {0x218, 0x5},
	    {0x21c, 0x1f}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb1_init[SMI_LARB1_PORT_NUM] = {
	{0x200, 0x2f}, {0x204, 0x2f}, {0x208, 0x10}, {0x20c, 0x10}, {0x210, 0x10}, {0x214, 0x10}, {0x218, 0x10},
	{0x21c, 0x2f}, {0x220, 0x5}, {0x224, 0x5}, {0x228, 0x1}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb2_init[SMI_LARB2_PORT_NUM] = {
	{0x200, 0x5}, {0x204, 0x1}, {0x208, 0x1}, {0x20c, 0x5}, {0x210, 0x1}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb5_init[SMI_LARB5_PORT_NUM] = {
	{0x200, 0xa}, {0x204, 0x1}, {0x208, 0x6}, {0x20c, 0x6}, {0x210, 0x1}, {0x214, 0x1}, {0x218, 0x1}, {0x21c,
											     0x1},
	{0x220, 0x1}, {0x224, 0x1}, {0x228, 0x1}, {0x22c, 0x1}, {0x230, 0x1}, {0x234, 0x1}, {0x238, 0x1}, {0x23c, 0x1},
	{0x240, 0x1}, {0x244, 0x1}, {0x248, 0x1}, {0x24c, 0x1}, {0x250, 0x1}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb6_init[SMI_LARB6_PORT_NUM] = {
	{0x200, 0x16}, {0x204, 0x14}, {0x208, 0x2}, {0x20c, 0x2}, {0x210, 0x1}, {0x214, 0x1}, {0x218, 0x2}, {0x21c,
											     0x2},
	{0x220, 0x2}, {0x224, 0x2}, {0x228, 0x2}, {0x22c, 0x1}, {0x230, 0x1}, {0x234, 0x1}, {0x238, 0x1}, {0x23c, 0x1},
	{0x240, 0x1}, {0x244, 0x1}, {0x248, 0x1}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb7_init[SMI_LARB7_PORT_NUM] = {
	{0x200, 0x1}, {0x204, 0x3}, {0x208, 0x1}, {0x20c, 0x1}, {0x210, 0x1}, {0x214, 0x1}, {0x218, 0x1}, {0x21c,
											     0x1},
	{0x220, 0x1}, {0x224, 0x1}, {0x228, 0x1}, {0x22c, 0x6}, {0x230, 0x3}, {0x234, 0x1}, {0x238, 0xC}, {0x23c, 0x1},
	{0x240, 0x1}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_larb1_vp[SMI_LARB1_PORT_NUM] = {
	...
	{0x21c, 0x20}, {0x220, 0x6}, {0x224, 0x9}, {0x228, 0xe}
...
struct SMI_SETTING_VALUE smi_profile_setting_larb5_vp[SMI_LARB5_PORT_NUM] = {
	{0x200, 0xC}, {0x204, 0x1}, {0x208, 0x6}, {0x20c, 0x6}, {0x210, 0x1}, {0x214, 0x1}, {0x218, 0x6}, {0x21c,
											     0x9},
	{0x220, 0x1}, {0x224, 0x1}, {0x228, 0x1}, {0x22c, 0x1}, {0x230, 0x1}, {0x234, 0x1}, {0x238, 0x1}, {0x23c, 0x1},
	{0x240, 0x1}, {0x244, 0x1}, {0x248, 0x1}, {0x24c, 0x1}, {0x250, 0x1}
};
