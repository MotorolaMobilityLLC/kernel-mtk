...
#define MT6763_MMDVFS_OPP_MAX                                                 \
	4 /* Max total MMDVFS opps of the profile support */
#define MT6763_MMDVFS_CLK_OPP_MAX                                             \
	4 /* Max total CLK opps of the profile support */
#define MT6763_MMDVFS_VCORE_OPP_MAX                                           \
	4 /* Max total CLK opps of the profile support */
 ...
 */
/* Field decscription: */
/* 1. config_method: MMDVFS_CLK_CONFIG_BY_MUX/ MMDVFS_CLK_CONFIG_PLL /
 * MMDVFS_CLK_CONFIG_NONE
 */
/* 2. pll_id: MTK' PLL ID, please set -1 if PLL hopping is not used */
/* 3. clk mux desc {hanlde, name}, the please handle -1 and it will be
 * initialized by driver automaticlly
 */
...
struct mmdvfs_clk_hw_map
	mt6763_mmdvfs_clk_hw_map_setting[MMDVFS_CLK_MUX_NUM] = {
	  {MMDVFS_CLK_CONFIG_NONE,
	  {NULL, "MMDVFS_CLK_MUX_TOP_SMI0_2X_SEL"},
	  -1,
	  2,
	  {-1, -1},
	  {-1, -1} },
	 {MMDVFS_CLK_CONFIG_PLL_RATE,
	  {NULL, "MMDVFS_CLK_TOP_MMPLL_CK"},
	  9,
	  2,
	  {0x00204EC4, 0x001713B1},
	  {-1, -1} },
	 {MMDVFS_CLK_CONFIG_BY_MUX,
	  {NULL, "MMDVFS_CLK_MUX_TOP_CAM_SEL"},
	  -1,
	  2,
	  {-1, -1},
	  {MT6763_MMDVFS_CLK_TOP_TVDPLL_CK, MT6763_MMDVFS_CLK_TOP_MMPLL_CK} },
	 {MMDVFS_CLK_CONFIG_NONE,
	  {NULL, "MMDVFS_CLK_MUX_TOP_IMG_SEL"},
	  -1,
	  2,
	  {-1, -1},
	  {-1, -1} },
	 {MMDVFS_CLK_CONFIG_NONE,
	  {NULL, "MMDVFS_CLK_MUX_TOP_VENC_SEL"},
	  -1,
	  2,
	  {-1, -1},
	  {-1, -1} },
	 {MMDVFS_CLK_CONFIG_NONE,
	  {NULL, "MMDVFS_CLK_MUX_TOP_VDEC_SEL"},
	  -1,
	  2,
	  {-1, -1},
	  {-1, -1} },
	 {MMDVFS_CLK_CONFIG_NONE,
	  {NULL, "MMDVFS_CLK_MUX_TOP_MJC_SEL"},
	  -1,
	  2,
	  {-1, -1},
	  {-1, -1} },
	 {MMDVFS_CLK_CONFIG_NONE,
	  {NULL, "MMDVFS_CLK_MUX_TOP_VPU_IF_SEL"},
	  -1,
	  2,
	  {-1, -1},
	  {-1, -1} },
	 {MMDVFS_CLK_CONFIG_NONE,
	  ...
	  {-1, -1} },
	 {MMDVFS_CLK_CONFIG_NONE,
	  {NULL, "MMDVFS_CLK_MUX_TOP_VPU_SEL"},
	  -1,
	  2,
	  {-1, -1},
	  {-1, -1} } };
...
struct mmdvfs_profile mt6763_mmdvfs_opp0_profiles[MT6763_MMDVFS_OPP0_NUM] = {
	...
	{"Full Sensor Capture (ZSD)",
	 SMI_BWC_SCEN_CAM_CP,
	 {MT6763_MMDVFS_SENSOR_MIN, 0, 0},
	 {0, 0, 0} },
	{"PIP Feature Preview",
	 SMI_BWC_SCEN_CAM_PV,
	 {0, MMDVFS_CAMERA_MODE_FLAG_PIP, 0},
	 {0, 0, 0} },
	{"PIP Feature Capture",
	 SMI_BWC_SCEN_CAM_CP,
	 {0, MMDVFS_CAMERA_MODE_FLAG_PIP, 0},
	 {0, 0, 0} },
	{"PIP Feature Recording",
	 SMI_BWC_SCEN_VR,
	 {0, MMDVFS_CAMERA_MODE_FLAG_PIP, 0},
	 {0, 0, 0} },
	{"Stereo Feature Preview",
	 SMI_BWC_SCEN_CAM_PV,
	 {0, MMDVFS_CAMERA_MODE_FLAG_STEREO, 0},
	 {0, 0, 0} },
	{"Stereo Feature Capture",
	 SMI_BWC_SCEN_CAM_CP,
	 {0, MMDVFS_CAMERA_MODE_FLAG_STEREO, 0},
	 {0, 0, 0} },
	{"Stereo Feature Recording",
	 SMI_BWC_SCEN_VR,
	 {0, MMDVFS_CAMERA_MODE_FLAG_STEREO, 0},
	 {0, 0, 0} },
	{"Dual zoom preview (reserved)",
	 SMI_BWC_SCEN_CAM_CP,
	 {0, MMDVFS_CAMERA_MODE_FLAG_DUAL_ZOOM, 0},
	 {0, 0, 0} },
	{"EIS 4K Feature Recording",
	 SMI_BWC_SCEN_VR,
	 {MT6763_MMDVFS_SENSOR_MIN, MMDVFS_CAMERA_MODE_FLAG_EIS_2_0, 0},
	 {0, 0, 0} },
...
struct mmdvfs_profile mt6763_mmdvfs_opp2_profiles[MT6763_MMDVFS_OPP2_NUM] = {
	{"vFB Feature Preview",
	 SMI_BWC_SCEN_CAM_PV,
	 {0, MMDVFS_CAMERA_MODE_FLAG_VFB, 0},
	 {0, 0, 0} },
	{"vFB Feature Capture",
	 SMI_BWC_SCEN_CAM_CP,
	 {0, MMDVFS_CAMERA_MODE_FLAG_VFB, 0},
	 {0, 0, 0} },
	{"vFB Feature Recording",
	 SMI_BWC_SCEN_VR,
	 {0, MMDVFS_CAMERA_MODE_FLAG_VFB, 0},
	 {0, 0, 0} },
};
...
struct mmdvfs_profile mt6763_mmdvfs_opp3_profiles[MT6763_MMDVFS_OPP3_NUM] = {
	{"Full Sensor Preview (ZSD)",
	 SMI_BWC_SCEN_CAM_PV,
	 {MT6763_MMDVFS_SENSOR_MIN, 0, 0},
	 {0, 0, 0} },
	{"Full Sensor Camera Recording",
	 SMI_BWC_SCEN_VR,
	 {MT6763_MMDVFS_SENSOR_MIN, 0, 0},
	 {0, 0, 0} },
	{"Dual zoom preview",
	...
	{"Dual zoom preview (reserved)",
	 ...
	 {0, MMDVFS_CAMERA_MODE_FLAG_DUAL_ZOOM, 0},
	 {0, 0, 0} },
	{"EIS Feature Recording",
	 SMI_BWC_SCEN_VR,
	 {0, MMDVFS_CAMERA_MODE_FLAG_EIS_2_0, 0},
	 {0, 0, 0} },
...
struct mmdvfs_profile
	mt6763_mmdvfs_opp0_profiles_lp4_1ch[MT6763_LP4_1CH_MMDVFS_OPP0_NUM] = {
	{"SMVR", SMI_BWC_SCEN_VR_SLOW, {0, 0, 0}, {0, 0, 0} },
	{"ICFP", SMI_BWC_SCEN_ICFP, {0, 0, 0}, {0, 0, 0} },
	{"Full Sensor Preview (ZSD)",
	 SMI_BWC_SCEN_CAM_PV,
...
struct mmdvfs_profile
	mt6763_mmdvfs_opp1_profiles_lp4_1ch[MT6763_LP4_1CH_MMDVFS_OPP1_NUM] = {
	{"High resolution video playback",
	 SMI_BWC_SCEN_VP_HIGH_RESOLUTION,
	 {0, 0, 0},
	 {0, 0, 0} },
...
struct mmdvfs_profile
	mt6763_mmdvfs_opp2_profiles_lp4_1ch[MT6763_LP4_1CH_MMDVFS_OPP2_NUM] = {
	{"vFB Feature Preview",
	 SMI_BWC_SCEN_CAM_PV,
	 {0, MMDVFS_CAMERA_MODE_FLAG_VFB, 0},
	 {0, 0, 0} },
...
struct mmdvfs_profile
	mt6763_mmdvfs_opp3_profiles_lp4_1ch[MT6763_LP4_1CH_MMDVFS_OPP3_NUM]
	= {};
...
struct mmdvfs_profile
	mt6763_mmdvfs_opp0_profiles_lp3[MT6763_LP3_MMDVFS_OPP0_NUM] = {
	{"SMVR", SMI_BWC_SCEN_VR_SLOW, {0, 0, 0}, {0, 0, 0} },
	{"ICFP", SMI_BWC_SCEN_ICFP, {0, 0, 0}, {0, 0, 0} },
	{"Full Sensor Preview (ZSD)",
	 SMI_BWC_SCEN_CAM_PV,
...
struct mmdvfs_profile
	mt6763_mmdvfs_opp2_profiles_lp3[MT6763_LP3_MMDVFS_OPP2_NUM] = {
	{"High resolution video playback",
	 SMI_BWC_SCEN_VP_HIGH_RESOLUTION,
	 {0, 0, 0},
	 {0, 0, 0} },
...
struct mmdvfs_profile
	mt6763_mmdvfs_opp3_profiles_lp3[MT6763_LP3_MMDVFS_OPP3_NUM] = {
	{"vFB Feature Preview",
	 SMI_BWC_SCEN_CAM_PV,
	 {0, MMDVFS_CAMERA_MODE_FLAG_VFB, 0},
	 {0, 0, 0} },
...
struct mmdvfs_profile
	mt6763_mmdvfs_opp1_profiles_lp3[MT6763_LP3_MMDVFS_OPP1_NUM] = {};
...
struct mmdvfs_step_to_profile_mapping
	...
	{0,
	 mt6763_mmdvfs_opp0_profiles,
	 MT6763_MMDVFS_OPP0_NUM,
	 {OPP_0,
	  {MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0,
	   MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0,
	   MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0,
	   MMDVFS_MMCLK_OPP0},
	  MMDVFS_CLK_MUX_NUM} },
	{1,
	 mt6763_mmdvfs_opp1_profiles,
	 MT6763_MMDVFS_OPP1_NUM,
	 {OPP_1,
	  {MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1},
	  MMDVFS_CLK_MUX_NUM} },
	{2,
	 mt6763_mmdvfs_opp2_profiles,
	 MT6763_MMDVFS_OPP2_NUM,
	 {OPP_2,
	  {MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	  ...
	  MMDVFS_CLK_MUX_NUM} },
	{3,
	 mt6763_mmdvfs_opp3_profiles,
	 MT6763_MMDVFS_OPP3_NUM,
	 {OPP_3,
	  {MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
...
struct mmdvfs_step_to_profile_mapping
	...
	{0,
	 mt6763_mmdvfs_opp0_profiles_lp4_1ch,
	 MT6763_LP4_1CH_MMDVFS_OPP0_NUM,
	 {OPP_0,
	  {MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0,
	   MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0,
	   MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0,
	  ...
	  MMDVFS_CLK_MUX_NUM} },
	{1,
	 mt6763_mmdvfs_opp1_profiles_lp4_1ch,
	 MT6763_LP4_1CH_MMDVFS_OPP1_NUM,
	 {OPP_1,
	  {MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	  ...
	  MMDVFS_CLK_MUX_NUM} },
	{2,
	 mt6763_mmdvfs_opp2_profiles_lp4_1ch,
	 MT6763_LP4_1CH_MMDVFS_OPP2_NUM,
	 {OPP_2,
	  {MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	  ...
	  MMDVFS_CLK_MUX_NUM} },
	{3,
	 mt6763_mmdvfs_opp3_profiles_lp4_1ch,
	 MT6763_LP4_1CH_MMDVFS_OPP3_NUM,
	 {OPP_3,
	  {MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
...
struct mmdvfs_step_to_profile_mapping
	...
	{0,
	 mt6763_mmdvfs_opp0_profiles_lp3,
	 MT6763_LP3_MMDVFS_OPP0_NUM,
	 {OPP_0,
	  {MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0,
	   MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0,
	   MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0, MMDVFS_MMCLK_OPP0,
	  ...
	  MMDVFS_CLK_MUX_NUM} },
	{1,
	 mt6763_mmdvfs_opp1_profiles_lp3,
	 MT6763_LP3_MMDVFS_OPP1_NUM,
	 {OPP_1,
	  {MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	  ...
	  MMDVFS_CLK_MUX_NUM} },
	{2,
	 mt6763_mmdvfs_opp2_profiles_lp3,
	 MT6763_LP3_MMDVFS_OPP2_NUM,
	 {OPP_2,
	  {MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	  ...
	  MMDVFS_CLK_MUX_NUM} },
	{3,
	 mt6763_mmdvfs_opp3_profiles_lp3,
	 MT6763_LP3_MMDVFS_OPP3_NUM,
	 {OPP_3,
	  {MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
	   MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1, MMDVFS_MMCLK_OPP1,
...
int mt6763_mmdvfs_legacy_step_to_opp[MMDVFS_VOLTAGE_COUNT] = {
	MT6763_MMDVFS_VOLTAGE_LOW_OPP, MT6763_MMDVFS_VOLTAGE_HIGH_OPP,
	MT6763_MMDVFS_VOLTAGE_DEFAULT_STEP_OPP,
...
int mt6763_mmdvs_isp_threshold_opp[MMDVFS_ISP_THRESHOLD_NUM] = {
	MMDVFS_FINE_STEP_OPP0, MMDVFS_FINE_STEP_OPP3};

struct mmdvfs_threshold_setting
	mt6763_mmdvfs_threshold_settings[MMDVFS_PM_QOS_SUB_SYS_NUM] = {
	{MMDVFS_PM_QOS_SUB_SYS_CAMERA, mt6763_mmdvs_isp_threshold_setting,
	 mt6763_mmdvs_isp_threshold_opp, MMDVFS_ISP_THRESHOLD_NUM,
	 MMDVFS_PMQOS_ISP},
};
