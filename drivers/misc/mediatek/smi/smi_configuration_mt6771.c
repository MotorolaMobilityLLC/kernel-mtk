...
struct SMI_SETTING_VALUE smi_basic_larb0_setting[SMI_BASIC_LARB0_SETTING_NUM] = {
	{0x40, 0x1}, {0x100, 0x7}, {0x104, 0x7}, {0x108, 0x7}, {0x10c, 0x7}, {0x110, 0x7}
};
...
struct SMI_SETTING_VALUE smi_profile_setting_common_init[SMI_PROFILE_SETTING_COMMON_INIT_NUM] = {
	{0x220, 0x4},
	{REG_OFFSET_SMI_L1ARB0, 0x1744}, {REG_OFFSET_SMI_L1ARB1, 0x1000}, {REG_OFFSET_SMI_L1ARB2, 0x1000},
...
/* ICFP */
#define SMI_PROFILE_SETTING_COMMON_ICFP_NUM 5

struct SMI_SETTING_VALUE smi_profile_setting_common_icfp[SMI_PROFILE_SETTING_COMMON_ICFP_NUM] = {
	{0x220, 0x44},
	{REG_OFFSET_SMI_L1ARB0, 0x1361}, {REG_OFFSET_SMI_L1ARB4, 0x119e}, {REG_OFFSET_SMI_L1ARB5, 0x12ad},
	{REG_OFFSET_SMI_L1ARB6, 0x130d}
};

struct SMI_SETTING_VALUE smi_profile_setting_larb0_icfp[SMI_LARB0_PORT_NUM] = {
	{0x200, 0x1f}, {0x204, 0xc}, {0x208, 0xc}, {0x20c, 0xc}, {0x210, 0xc}, {0x214, 0x5}, {0x218, 0x9},
...
struct SMI_PROFILE_CONFIG smi_profile_config[SMI_PROFILE_CONFIG_NUM] = {
	...
	{SMI_BWC_SCEN_VR, &init_setting_config},
	...
	{SMI_BWC_SCEN_CAM_PV, &init_setting_config},
