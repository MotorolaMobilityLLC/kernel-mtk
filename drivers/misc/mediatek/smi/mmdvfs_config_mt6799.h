...
#define MMDVFS_VPU_OPP_MAX 4
#define MMDVFS_VPU_INTERNAL_VPU_CLK_NUM 3
#define MMDVFS_VPU_INTERNAL_VPU_IF_CLK_NUM 3
#define MMDVFS_VPU_INTERNAL_VIMVO_VOL_NUM 3

struct mmdvfs_vpu_steps_setting mmdvfs_vpu_steps_settings[MMDVFS_VPU_OPP_MAX] = {
