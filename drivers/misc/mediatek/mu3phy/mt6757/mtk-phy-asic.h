...
#define U3D_USBPHYACR0                                                         \
	(SSUSB_SIFSLV_U2PHY_COM_SIV_B_BASE + 0x0000) /*2:30 SIV_B */
#define U3D_USBPHYACR1                                                         \
	(SSUSB_SIFSLV_U2PHY_COM_SIV_B_BASE + 0x0004) /*0:23 SIV_B */
#define U3D_USBPHYACR2                                                         \
	(SSUSB_SIFSLV_U2PHY_COM_SIV_B_BASE + 0x0008) /*0:15 SIV_B */
#define U3D_USBPHYACR4                                                         \
	(SSUSB_SIFSLV_U2PHY_COM_SIV_B_BASE + 0x0010) /*0:31 SIV_B */
#define U3D_USBPHYACR5                                                         \
	(SSUSB_SIFSLV_U2PHY_COM_SIV_B_BASE + 0x0014) /*0:28 SIV_B */
#define U3D_USBPHYACR6                                                         \
	(SSUSB_SIFSLV_U2PHY_COM_SIV_B_BASE + 0x0018) /*0:31 SIV_B */
#define U3D_U2PHYACR3                                                          \
	(SSUSB_SIFSLV_U2PHY_COM_SIV_B_BASE + 0x001c) /*0:31 SIV_B */
#define U3D_U2PHYACR4_0                                                        \
	(SSUSB_SIFSLV_U2PHY_COM_SIV_B_BASE + 0x0020) /*0:5 SIV_B */
