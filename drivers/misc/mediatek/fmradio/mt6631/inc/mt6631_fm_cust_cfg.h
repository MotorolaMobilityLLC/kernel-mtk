...
#define FM_RX_PRX_TH_MT6631           64
#define FM_RX_SMG_TH_MT6631          16421	/* FM soft-mute gain threshold */
#define FM_RX_DEEMPHASIS_MT6631       0	/* 0-50us, China Mainland; 1-75us China Taiwan */
#define FM_RX_OSC_FREQ_MT6631         0	/* 0-26MHz; 1-19MHz; 2-24MHz; 3-38.4MHz; 4-40MHz; 5-52MHz */
#define FM_AUTO_HILO_OFF_MT6631    0
#define FM_AUTO_HILO_ON_MT6631     1

/* seek threshold */
#define FM_SEEKTH_LEVEL_DEFAULT_MT6631 4

extern fm_cust_cfg mt6631_fm_config;
