...
#include "mot_dubai_ov32cmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_DUBAI_OV32C_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
    ...
    { 6528, 4896,   0,   0, 6528, 4896,  6528, 4896,  0,  0, 6528, 4896, 0, 0, 6528, 4896},       // custom1
};

static kal_uint16 addr_data_pair_init_mot_dubai_ov32c[] = {
...
static kal_uint32 set_test_pattern_mode(struct subdrv_ctx *ctx, kal_bool enable)
{
	...
	if (enable)
	{
		...
		write_cmos_sensor_8(ctx, 0x4301,0x00);
		write_cmos_sensor_8(ctx, 0x4302,0x00);
		write_cmos_sensor_8(ctx, 0x4303,0x00);
		write_cmos_sensor_8(ctx, 0x4304,0x00);
		write_cmos_sensor_8(ctx, 0x4305,0x00);
		write_cmos_sensor_8(ctx, 0x4306,0x00);
		write_cmos_sensor_8(ctx, 0x4307,0x00);
	} else {
...
static const struct subdrv_ctx defctx = {
	...
	.ana_gain_max = 16320,//1024 * 15.9375=16320
...
const struct subdrv_entry mot_dubai_ov32c_mipi_raw_entry = {
	.name = SENSOR_DRVNAME_MOT_DUBAI_OV32C_MIPI_RAW,
	.id = MOT_DUBAI_OV32C_SENSOR_ID,
	.pw_seq = pw_seq,
