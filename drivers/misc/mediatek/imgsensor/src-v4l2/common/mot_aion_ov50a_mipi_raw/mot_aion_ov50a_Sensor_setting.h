 ...
 * Filename:
 * ---------
 *	 mot_aion_ov50a2q_Sensor_setting.h
 *
 * Project:
 * --------
 * Description:
 ...
 *
 ****************************************************************************/
#ifndef _MOT_AION_OV50A2Q_SENSOR_SETTING_H
#define _MOT_AION_OV50A2Q_SENSOR_SETTING_H

#define CPHY_3TRIO
#define SEAMLESS_SWITCH_V2
#define ROTATION_180

kal_uint16 addr_data_pair_xtalk_mot_aion_ov50a2q[] = {
...
kal_uint16 addr_data_pair_init_mot_aion_ov50a_20230307[] = {
...
kal_uint16 addr_data_pair_seamless_switch_step1_mot_aion_ov50a2q[] = {
	//group 0
	0x3208, 0x00,
	0x3016, 0xf1,
	//new mode settings
...
kal_uint16 addr_data_pair_seamless_switch_step2_mot_aion_ov50a2q[] = {
	0x3016, 0xf0,
	0x3208, 0x10,
	//group 1
	0x3208, 0x01,
...
kal_uint16 addr_data_pair_seamless_switch_step3_mot_aion_ov50a2q[] = {
	//0x3016, 0xf0,
	0x3208, 0x11,
