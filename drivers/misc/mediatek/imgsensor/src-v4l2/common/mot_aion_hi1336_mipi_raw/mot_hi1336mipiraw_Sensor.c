...
{
	return (((read_cmos_sensor_8(ctx, 0x0716) << 8) | read_cmos_sensor_8(ctx, 0x0717))+1);
}
...
const struct subdrv_entry mot_aion_hi1336_mipi_raw_entry = {
	.name = "mot_aion_hi1336_mipi_raw",
	.id = MOT_AION_HI1336_SENSOR_ID,
	.pw_seq = pw_seq,
