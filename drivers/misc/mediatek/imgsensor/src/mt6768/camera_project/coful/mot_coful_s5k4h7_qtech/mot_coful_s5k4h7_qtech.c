...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_COFUL_S5K4H7_QTECH_ID,	/*MOT_COFUL_S5K4H7_QTECH_ID = 0x487C */
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
 ...
 { 3264, 2448,	  0,	0, 3264, 2448, 3264,  2448, 0000, 0000, 3264, 2448,	    0,	0, 3264, 2448}, /* custom1 */
};
...
static kal_uint16 s5k4h7qtech_custom1_setting[] = {
#include "setting/4h7_3264x2448_M24_VT280_MIPI700_20fps.h"
};
#if 0
...
{
	LOG_INF("E!\n");
	table_write_cmos_sensor(s5k4h7qtech_custom1_setting,
		sizeof(s5k4h7qtech_custom1_setting) / sizeof(kal_uint16));
}
...
static const char *mot_coful_s5k4h7_scenario_to_name(enum MSDK_SCENARIO_ID_ENUM scenario_id)
{
...
static kal_uint32 control(enum MSDK_SCENARIO_ID_ENUM scenario_id,
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	LOG_INF_N("scenario(%d): %s\n", scenario_id, mot_coful_s5k4h7_scenario_to_name(scenario_id));
	spin_lock(&imgsensor_drv_lock);
...
UINT32 MOT_COFUL_S5K4H7_QTECH_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
