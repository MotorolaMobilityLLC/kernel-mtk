...
#define PFX "S5K4H7QTECHOTP"
#define LOG_1 SENSORDB("S5K4H7QTECH,MIPI CAM\n")
...
bool S5K4H7QTECH_update_awb(unsigned char page)
{
	kal_uint32 r_ratio;
	kal_uint32 b_ratio;
...
bool S5K4H7QTECH_otp_update(void)
{
	...
	flag = S5K4H7QTECH_update_awb(page);
	return flag;
}
...
unsigned char s5k4h7qtech_get_module_id(void)
{
	...
	LOG_INF("S5K4H7QTECH module id = 0x%x\n", module_id);
	return module_id;
}
