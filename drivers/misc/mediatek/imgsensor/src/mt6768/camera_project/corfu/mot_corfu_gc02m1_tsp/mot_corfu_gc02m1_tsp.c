...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_CORFU_GC02M1_TSP_ID,
...
static const char *mot_corfu_gc02m1_scenario_to_name(enum MSDK_SCENARIO_ID_ENUM scenario_id)
{
...
static kal_uint32 control(enum MSDK_SCENARIO_ID_ENUM scenario_id,
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	LOG_INF_N("scenario(%d): %s\n", scenario_id, mot_corfu_gc02m1_scenario_to_name(scenario_id));
	spin_lock(&imgsensor_drv_lock);
...
UINT32 MOT_CORFU_GC02M1_TSP_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
