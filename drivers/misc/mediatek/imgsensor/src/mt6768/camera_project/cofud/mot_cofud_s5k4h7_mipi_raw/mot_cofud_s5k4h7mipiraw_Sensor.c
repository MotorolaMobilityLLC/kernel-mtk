...
#include "mot_cofud_s5k4h7mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_COFUD_S5K4H7_SENSOR_ID,	/*MOT_COFUD_S5K4H7_SENSOR_ID = 0x487C */
...
static const char *mot_cofud_s5k4h7_scenario_to_name(enum MSDK_SCENARIO_ID_ENUM scenario_id)
{
...
static kal_uint32 control(enum MSDK_SCENARIO_ID_ENUM scenario_id,
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	LOG_INF_N("scenario(%d): %s\n", scenario_id, mot_cofud_s5k4h7_scenario_to_name(scenario_id));
	spin_lock(&imgsensor_drv_lock);
...
UINT32 MOT_COFUD_S5K4H7_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
