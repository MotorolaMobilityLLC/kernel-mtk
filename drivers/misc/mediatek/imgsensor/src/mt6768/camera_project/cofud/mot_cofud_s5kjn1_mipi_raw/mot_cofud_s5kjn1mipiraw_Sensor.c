...
#include "mot_cofud_s5kjn1mipiraw_Sensor.h"

#define FPTPDAFSUPPORT

#define MULTI_WRITE 1

#define PFX "mot_cofud_s5kjn1_mipi_raw"
...
#define COFUD_S5KJN1_EEPROM_SIZE  0x39c7
#define COFUD_S5KJN1_EEPROM_GGC_SIZE 346
#define COFUD_S5KJN1_EEPROM_GGC_START_ADDR 0x386B
#define COFUD_S5KJN1_EEPROM_GGC_END_ADDR 0x39C4

extern int32_t eeprom_util_check_crc16(uint8_t *data, uint32_t size, uint32_t ref_crc);
static kal_uint16 addr_data_pair_ggc_jn1[COFUD_S5KJN1_EEPROM_GGC_SIZE+4] = {0};
static uint8_t COFUD_S5KJN1_eeprom[COFUD_S5KJN1_EEPROM_SIZE] = {0};
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_COFUD_S5KJN1_SENSOR_ID,
...
static kal_uint16 mot_cofud_s5kjn1_qtech_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static void set_shutter_frame_length(kal_uint32 shutter, kal_uint32 frame_length)
{
	...
	write_cmos_sensor(0x0202, imgsensor.shutter & 0xffff);
}
...
kal_uint16 addr_data_pair_init_mot_cofud_s5kjn1_qtech[] = {
	0x6028, 0x2400,
	0x602A, 0x1354,
	0x6F12, 0x0100,
	0x6F12, 0x7017,
...
static void sensor_init(void)
{
	...
	mot_cofud_s5kjn1_qtech_table_write_cmos_sensor(
		addr_data_pair_init_mot_cofud_s5kjn1_qtech,
		sizeof(addr_data_pair_init_mot_cofud_s5kjn1_qtech) /
		sizeof(kal_uint16));
	LOG_INF_N("X\n");

}

kal_uint16 addr_data_pair_custom1_mot_cofud_s5kjn1_qtech[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void custom1_setting(void)
{
	...
	LOG_INF_N("E\n");
	mot_cofud_s5kjn1_qtech_table_write_cmos_sensor(
		addr_data_pair_custom1_mot_cofud_s5kjn1_qtech,
		sizeof(addr_data_pair_custom1_mot_cofud_s5kjn1_qtech) /
		sizeof(kal_uint16));
	LOG_INF_N("X\n");
}

kal_uint16 addr_data_pair_capture_mot_cofud_s5kjn1_qtech[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	LOG_INF_N("E\n");
	mot_cofud_s5kjn1_qtech_table_write_cmos_sensor(
		addr_data_pair_capture_mot_cofud_s5kjn1_qtech,
		sizeof(addr_data_pair_capture_mot_cofud_s5kjn1_qtech) /
		sizeof(kal_uint16));
	LOG_INF_N("X\n");
}

kal_uint16 addr_data_pair_custom2_mot_cofud_s5kjn1_qtech[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void custom2_setting(void)
{
	...
	LOG_INF_N("E\n");
	mot_cofud_s5kjn1_qtech_table_write_cmos_sensor(
		addr_data_pair_custom2_mot_cofud_s5kjn1_qtech,
		sizeof(addr_data_pair_custom2_mot_cofud_s5kjn1_qtech) /
		sizeof(kal_uint16));
	LOG_INF_N("X\n");
}

kal_uint16 addr_data_pair_custom3_mot_cofud_s5kjn1_qtech[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void custom3_setting(void)
{
	...
	LOG_INF_N("E\n");
	mot_cofud_s5kjn1_qtech_table_write_cmos_sensor(
		addr_data_pair_custom3_mot_cofud_s5kjn1_qtech,
		sizeof(addr_data_pair_custom3_mot_cofud_s5kjn1_qtech) /
		sizeof(kal_uint16));
	LOG_INF_N("X\n");
}
...
kal_uint16 addr_data_pair_hs_video_mot_cofud_s5kjn1_qtech[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void hs_video_setting(void)
{
	...
	LOG_INF_N("E\n");
	mot_cofud_s5kjn1_qtech_table_write_cmos_sensor(
		addr_data_pair_hs_video_mot_cofud_s5kjn1_qtech,
		sizeof(addr_data_pair_hs_video_mot_cofud_s5kjn1_qtech) /
		sizeof(kal_uint16));
	LOG_INF_N("X\n");
}
...
static void COFUD_S5KJN1_eeprom_format_ggc_data(void)
{
	kal_uint16 gcc_crc16 = COFUD_S5KJN1_eeprom[COFUD_S5KJN1_EEPROM_GGC_END_ADDR+1]<<8|COFUD_S5KJN1_eeprom[COFUD_S5KJN1_EEPROM_GGC_END_ADDR+2];
	kal_uint16 i = 0;

	if (eeprom_util_check_crc16((COFUD_S5KJN1_eeprom+COFUD_S5KJN1_EEPROM_GGC_START_ADDR),
		COFUD_S5KJN1_EEPROM_GGC_SIZE, gcc_crc16)) {
		...
		for(i = 0; i < COFUD_S5KJN1_EEPROM_GGC_SIZE; i += 2){
			addr_data_pair_ggc_jn1[i+4] = 0x6F12;
			addr_data_pair_ggc_jn1[i+5] = COFUD_S5KJN1_eeprom[i+COFUD_S5KJN1_EEPROM_GGC_START_ADDR]<<8 | COFUD_S5KJN1_eeprom[i+COFUD_S5KJN1_EEPROM_GGC_START_ADDR+1];
		}
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				COFUD_S5KJN1_eeprom_format_ggc_data();
...
static kal_uint32 open(void)
{
	...
	mot_cofud_s5kjn1_qtech_table_write_cmos_sensor(addr_data_pair_ggc_jn1,
...
static const char *mot_cofud_s5kjn1_scenario_to_name(enum MSDK_SCENARIO_ID_ENUM scenario_id)
{
...
control(enum MSDK_SCENARIO_ID_ENUM scenario_id,
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	LOG_INF_N("scenario(%d): %s\n", scenario_id, mot_cofud_s5kjn1_scenario_to_name(scenario_id));
	spin_lock(&imgsensor_drv_lock);
...
UINT32
MOT_COFUD_S5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
