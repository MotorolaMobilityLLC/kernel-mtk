 ...
 *Filename:
 *---------
 *   mot_milan_s5kjn1mipiraw_Sensor.c
 *
 *Project:
 *--------
 *   ALPS MT6768
...
#include "mot_milan_s5kjn1mipiraw_Sensor.h"

#define FPTPDAFSUPPORT

#define MULTI_WRITE 1

#define PFX "mot_milan_s5kjn1"
...
#define MILAN_S5KJN1_EEPROM_GGC_START_ADDR 0x386B
...
static kal_uint16 addr_data_pair_ggc_jn1[MILAN_S5KJN1_EEPROM_GGC_SIZE+4] = {0};
static uint8_t MILAN_S5KJN1_eeprom[MILAN_S5KJN1_EEPROM_SIZE] = {0};
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_MILAN_S5KJN1_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
	...
	{8160, 6144, 0, 0, 8160, 6144, 4080, 3072, 0, 0, 4080, 3072,0, 0, 4080, 3072},
	{8160, 6144, 0, 0, 8160, 6144, 8160, 6144, 0, 0, 8160, 6144,0, 0, 8160, 6144},
...
static kal_uint16 mot_milan_s5kjn1_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
kal_uint16 addr_data_pair_init_mot_milan_s5kjn1[] = {
	0x6028, 0x2400,
	0x602A, 0x1354,
	0x6F12, 0x0100,
	0x6F12, 0x7017,
...
static void sensor_init(void)
{
	...
	mot_milan_s5kjn1_table_write_cmos_sensor(
		addr_data_pair_init_mot_milan_s5kjn1,
		sizeof(addr_data_pair_init_mot_milan_s5kjn1) /
		sizeof(kal_uint16));
	LOG_INF_N("X\n");

}

kal_uint16 addr_data_pair_custom1_mot_milan_s5kjn1[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void custom1_setting(void)
{
	...
	LOG_INF_N("E\n");
	mot_milan_s5kjn1_table_write_cmos_sensor(
		addr_data_pair_custom1_mot_milan_s5kjn1,
		sizeof(addr_data_pair_custom1_mot_milan_s5kjn1) /
		sizeof(kal_uint16));
	LOG_INF_N("X\n");
}

kal_uint16 addr_data_pair_capture_mot_milan_s5kjn1[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	LOG_INF_N("E\n");
	mot_milan_s5kjn1_table_write_cmos_sensor(
		addr_data_pair_capture_mot_milan_s5kjn1,
		sizeof(addr_data_pair_capture_mot_milan_s5kjn1) /
		sizeof(kal_uint16));
	LOG_INF_N("X\n");
}

kal_uint16 addr_data_pair_custom2_mot_milan_s5kjn1[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void custom2_setting(void)
{
	...
	LOG_INF_N("E\n");
	mot_milan_s5kjn1_table_write_cmos_sensor(
		addr_data_pair_custom2_mot_milan_s5kjn1,
		sizeof(addr_data_pair_custom2_mot_milan_s5kjn1) /
		sizeof(kal_uint16));
	LOG_INF_N("X\n");
}

kal_uint16 addr_data_pair_custom3_mot_milan_s5kjn1[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void custom3_setting(void)
{
	...
	LOG_INF_N("E\n");
	mot_milan_s5kjn1_table_write_cmos_sensor(
		addr_data_pair_custom3_mot_milan_s5kjn1,
		sizeof(addr_data_pair_custom3_mot_milan_s5kjn1) /
		sizeof(kal_uint16));
	LOG_INF_N("X\n");
}
...
kal_uint16 addr_data_pair_hs_video_mot_milan_s5kjn1[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void hs_video_setting(void)
{
	...
	LOG_INF_N("E\n");
	mot_milan_s5kjn1_table_write_cmos_sensor(
		addr_data_pair_hs_video_mot_milan_s5kjn1,
		sizeof(addr_data_pair_hs_video_mot_milan_s5kjn1) /
		sizeof(kal_uint16));
	LOG_INF_N("X\n");
}
...
#define S5KJN1_REMOSAIC_PARAM_TOTAL_DATA_WITH_CRC_SIZE \
                                (S5KJN1_REMOSAIC_PARAM_TOTAL_DATA_SIZE  + 8)

static uint8_t MILAN_S5KJN1_eeprom_data_for_remosaic[S5KJN1_REMOSAIC_PARAM_TOTAL_DATA_WITH_CRC_SIZE] = {0};
...
static void s5kjn1_get_remosaic_param_from_eeprom(char *data)
{
    ...
    data_crc16[0] = MILAN_S5KJN1_eeprom_data_for_remosaic[data_addr_index+S5KJN1_REMOSAIC_PARAM_XTC_DATA_SIZE];
...
static void MILAN_S5KJN1_eeprom_format_ggc_data(void)
{
	kal_uint16 gcc_crc16 = MILAN_S5KJN1_eeprom[MILAN_S5KJN1_EEPROM_GGC_END_ADDR+1]<<8|MILAN_S5KJN1_eeprom[MILAN_S5KJN1_EEPROM_GGC_END_ADDR+2];
	kal_uint16 i = 0;

	if (eeprom_util_check_crc16((MILAN_S5KJN1_eeprom+MILAN_S5KJN1_EEPROM_GGC_START_ADDR),
		MILAN_S5KJN1_EEPROM_GGC_SIZE, gcc_crc16)) {
		...
		for(i = 0; i < MILAN_S5KJN1_EEPROM_GGC_SIZE; i += 2){
			addr_data_pair_ggc_jn1[i+4] = 0x6F12;
			addr_data_pair_ggc_jn1[i+5] = MILAN_S5KJN1_eeprom[i+MILAN_S5KJN1_EEPROM_GGC_START_ADDR]<<8 | MILAN_S5KJN1_eeprom[i+MILAN_S5KJN1_EEPROM_GGC_START_ADDR+1];
		}
...
static kal_uint32 open(void)
{
	...
	mot_milan_s5kjn1_table_write_cmos_sensor(addr_data_pair_ggc_jn1,
...
static const char *mot_milan_s5kjn1_scenario_to_name(enum MSDK_SCENARIO_ID_ENUM scenario_id)
{
...
control(enum MSDK_SCENARIO_ID_ENUM scenario_id,
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	LOG_INF_N("scenario(%d): %s\n", scenario_id, mot_milan_s5kjn1_scenario_to_name(scenario_id));
	spin_lock(&imgsensor_drv_lock);
...
UINT32
MOT_MILAN_S5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
