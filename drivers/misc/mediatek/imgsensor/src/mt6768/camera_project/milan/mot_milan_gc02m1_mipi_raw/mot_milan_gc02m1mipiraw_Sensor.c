 ...
 * Filename:
 * ---------
 *     mot_milan_gc02m1mipiraw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#define PFX "mot_milan_gc02m1_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_MILAN_GC02M1_SENSOR_ID,
...
UINT32 MOT_MILAN_GC02M1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
