 ...
 * Filename:
 * ---------
 *	 mot_milan_ov16a1qmipiraw_Sensor.h
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *
 ****************************************************************************/
#ifndef _MOT_MILAN_OV16A1QMIPI_SENSOR_H
#define _MOT_MILAN_OV16A1QMIPI_SENSOR_H
#include <linux/types.h>
#include "kd_camera_typedef.h" //add by wei.wang2 for IN2

static kal_uint16 ov16a1q_custom1_setting[] = {
...
static kal_uint16 ov16a1q_preview_setting[] = {
    0x0307,0x01,
    0x4837,0x15,
    0x0329,0x01,
    0x0344,0x01,
...
static kal_uint16 ov16a1q_capture_setting[] = {
    0x0307,0x01,
    0x4837,0x15,
    0x0329,0x01,
    0x0344,0x01,
...
static kal_uint16 ov16a1q_normal_video_setting[] = {
    0x0307,0x01,
    0x4837,0x15,
    0x0329,0x01,
    0x0344,0x01,
...
//2304x1728 4C2 Binning 10-bit 30fps 726Mbps/lane
static kal_uint16 ov16a1q_slim_video_setting[] = {
    0x0307,0x01,
    0x4837,0x15,
    0x0329,0x01,
    0x0344,0x01,
...
struct ov16a1q_eeprom_t{
	...
	uint8_t ovcrosstalk_data[600];
	uint8_t ovcrosstalk_crc16[2];
	uint8_t ovdpc_data[1920];
	uint8_t ovdpc_crc16[2];
