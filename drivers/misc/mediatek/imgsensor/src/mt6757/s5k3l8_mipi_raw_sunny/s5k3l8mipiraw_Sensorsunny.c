...
#include "s5k3l8mipiraw_Sensorsunny.h"
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3L8_SUNNY_SENSOR_ID,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
...
UINT32 S5K3L8_MIPI_RAW_SensorInit_SUNNY(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
