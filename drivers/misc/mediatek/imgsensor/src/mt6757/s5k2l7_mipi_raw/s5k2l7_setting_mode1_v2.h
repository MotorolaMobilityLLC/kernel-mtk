...
#define _S5K2L7_MODE1_V2_SENSOR_INFO_ static imgsensor_info_struct _imgsensor_info_m1_v2 =                     \
{                                                                                                              \
...
#define _S5K2L7_MODE1_V2_WINSIZE_INFO_ static SENSOR_WINSIZE_INFO_STRUCT _imgsensor_winsize_info_m1_v2[5] = \
{                                                                                                           \
...
#define _SET_MODE1_V2_SENSOR_INFO_AND_WINSIZE_ do{ \
    ...
    memcpy((void *)&imgsensor_winsize_info, (void *)&_imgsensor_winsize_info_m1_v2, sizeof(SENSOR_WINSIZE_INFO_STRUCT)*5); \
}while(0)
