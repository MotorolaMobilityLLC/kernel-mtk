...
#define _S5K2L7_MODE3_SENSOR_INFO_ static imgsensor_info_struct _imgsensor_info_m3 =                                  \
{                                                                                                              \
...
#define _S5K2L7_MODE3_WINSIZE_INFO_ static SENSOR_WINSIZE_INFO_STRUCT _imgsensor_winsize_info_m3[5] =            \
{                                                                                                         \
...
#define _SET_MODE3_SENSOR_INFO_AND_WINSIZE_ do{ \
    ...
    memcpy((void *)&imgsensor_winsize_info, (void *)&_imgsensor_winsize_info_m3, sizeof(SENSOR_WINSIZE_INFO_STRUCT)*5); \
}while(0)
