...
{
	LOG_INF("OV5670_2_Sensor_Init_2lane E\n");
...
{
	LOG_INF(" OV5670PreviewSetting_2lane_2 enter\n");
...
{
	LOG_INF("OV5670CaptureSetting_2lane_2 enter! currefps:%d\n",currefps);
