...
//end
static int ReadOV13855AWBData(unsigned short ui4_offset, unsigned int  ui4_length, unsigned char * pinputdata)
{
	int i = 0;
	int addr = ui4_offset;
	u8 AWBdatabuf[37];
	...
	if( AWBdatabuf[0] != 0x40)
	{
		...
		CAM_CALDB("OV13855_OTP AWB data invalid!\n");
	}
...
static int ReadOV13855AFData(unsigned short ui4_offset, unsigned int  ui4_length, unsigned char * pinputdata)
{
	int i = 0;
	int addr = ui4_offset;
	u8 AFdatabuf[7];
	...
	if( AFdatabuf[0] != 0x40)
	{
		...
		CAM_CALDB("OV13855_OTP AF data invalid!\n");
	}
	for(i = 3; i < 7; i++)
	{
...
static int ReadOV13855LSCData(unsigned short ui4_offset, unsigned int  ui4_length, unsigned char * pinputdata)
{
	int i = 0;
	int addr = ui4_offset;
