...
#include "s5k4h8mipi_Sensorqtech.h"

#define PFX "S5K4H8_camera_sensorqtech"
#define LOG_1 LOG_INF("indriya plus S5K4H8,MIPI 4LANE\n")
...
//lcsh tqq add device_info
#ifdef CONFIG_LCT_DEVINFO_SUPPORT
	devinfo_camera_regchar("S5k4h8","qtech",DEVINFO_USED);
...
UINT32 S5K4H8_MIPI_RAW_SensorInit_QTECH(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
