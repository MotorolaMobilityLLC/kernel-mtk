...
kal_uint16 addr_data_pair_init_imx300[] =
{
	...
	,0x305D,     0x03
	,0x31B0,     0x00 //Fixed area (16x12),Type of AF detection area
	,0x3208,     0x01
	,0x3210,     0x00
	,0x406C,     0x01
	,0x406D,     0x39
	...
	,0x4F4E,     0x01
	,0x505C,	    0x35
	,0x505D,	    0x36  //20160812 pdaf date type bmj
	,0x505F,     0x35
	//,0x5069,      0x00
	,0x5069,      0x01   //20160929  vc id
	,0x5E6A,	    0xFE
	,0x5E70, 	    0x00
	,0x6153, 	    0x01
	,0x6156,      0x01
...
kal_uint16 addr_data_pair_preview_imx300_pdaf[] =
{
	...
	,0x3154,     0x01 //PD_AREA_WIDTH[12:8]
	,0x3155,     0x1A //PD_AREA_WIDTH[7:0]
	,0x3156,     0x01 //PD_AREA_HEIGHT[12:8]
	,0x3157,     0x66 //PD_AREA_HEIGHT[7:0]
	...
	,0x31BB	,0x00
	#endif
	,0x3291	,0x01   //Window Reflection Timing,PDAF window 1 Frame later reflecting enable
...
kal_uint16 addr_data_pair_capture_imx300[] =
{
	...
	,0x0220,	0x00   // [0] 0 HDR disable
	,0x0222,	0x01
	,0x0224,	0x01
	,0x0225,	0xF4
	,0x3000,	0x54
	,0x3001,	0x00   //  1 pd enable(during HDR)
...
kal_uint16 addr_data_pair_capture_imx300_pdaf[] =
{
	...
	0X3154~0X3157:PD_AREA_WIDTH&HEIGHT*/
        ,0x3154,     0x01 //PD_AREA_WIDTH[12:8]
	,0x3155,     0x59 //PD_AREA_WIDTH[7:0]
	,0x3156,     0x01 //PD_AREA_HEIGHT[12:8]
	,0x3157,     0x55 //PD_AREA_HEIGHT[7:0]
...
kal_uint16 addr_data_pair_video_imx300[] =
{
	...
	,0x0220,	0x03  // [0] 0 HDR disable
	,0x0222,	0x01
	,0x0224,	0x09
	,0x0225,	0x0C
	,0x3000,	0x54
	,0x3001,	0x01   //  1 pd enable(during HDR)
