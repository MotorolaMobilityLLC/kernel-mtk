...
{3872, 2192, 0, 0, 3872, 2192, 3872, 2192, 0, 0000, 3872, 2192, 0, 0, 3872, 2192},	/* capture */
...
{
	LOG_INF("E\n");
	imx268_table_write_cmos_sensor(addr_data_pair_init_imx268,
				       sizeof(addr_data_pair_init_imx268) / sizeof(kal_uint16));
}				/*    sensor_init  */
...
{
	imx268_table_write_cmos_sensor(addr_data_pair_preview_imx268,
				       sizeof(addr_data_pair_preview_imx268) / sizeof(kal_uint16));
...
{
	imx268_table_write_cmos_sensor(addr_data_pair_capture_imx268,
				       sizeof(addr_data_pair_capture_imx268) / sizeof(kal_uint16));
	write_cmos_sensor(0x0100, 0x01);
}
...
*/
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		/* read_imx268_DCC((kal_uint16 )(*feature_data),
