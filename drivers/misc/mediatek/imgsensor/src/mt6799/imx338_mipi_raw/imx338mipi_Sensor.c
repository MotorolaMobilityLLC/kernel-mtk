...
{{ 5344, 4016,    0,    0, 5344, 4016, 2672, 2008, 0000, 0000, 2672, 2008,      0,    0, 2672, 2008}, // Preview
 ...
 { 5344, 4016,    0,  568, 5344, 2880, 1296,  736, 0000, 0000, 1296,  736,      0,    0, 1296,  736}, //hight speed video
 { 5344, 4016,    0,  504, 5344, 3008, 1296,  736, 0000, 0000, 1296,  736,      0,    0, 1296,  736}, // slim video
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if((imgsensor.hdr_mode == 2) || (imgsensor.hdr_mode == 9)){
		...
		imx338_table_write_cmos_sensor(addr_data_pair_capture_imx338, sizeof(addr_data_pair_capture_imx338)/sizeof(kal_uint16));
		zvhdr_setting();
	}
	if(imgsensor.pdaf_mode == 1)
	{
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	if((imgsensor.hdr_mode == 2) || (imgsensor.hdr_mode == 9)){
		imx338_table_write_cmos_sensor(addr_data_pair_video_imx338_hdr, sizeof(addr_data_pair_video_imx338_hdr)/sizeof(kal_uint16));
		zvhdr_setting();
	}
	else{
