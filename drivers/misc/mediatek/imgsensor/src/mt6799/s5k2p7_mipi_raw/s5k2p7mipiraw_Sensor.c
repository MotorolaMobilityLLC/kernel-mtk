...
#if 0
#else
#define shutter1_30 3609	/* 3214//3196 */
#define shutter1_15 7218	/* 6428 //6392 */
#define shutter1_8 13671	/* 12106 */
#define shutter1_4 27343	/* 24213 */
#define shutter1_2 54686	/* 48426 */
#define shutter1 109373		/* 96852 */
#define shutter2 218746		/* 193704 */
#define shutter3 328119		/* 290556 */
#define shutter4 437493		/* 387409 */
#define shutter6 656239		/* 581113 less */
#define shutter8 874986		/* 774818 */
#define shutter12 1312479	/* 1162227 less */
#endif
...
static imgsensor_info_struct imgsensor_info = {
	...
	.hs_video = {
		     ...
		     .startx = 0,	/* 0 */
		     .starty = 0,
		     .grabwindow_width = 1920,	/* 1920 */
		     .grabwindow_height = 1080,	/* 1080 */
		     .mipi_data_lp2hs_settle_dc = 85,
		     .max_framerate = 600,	/*  */
		     },
	.slim_video = {
...
/* <GN_BSP_camera> <yangym> <20170411> add for 97071 0x20 not used begin */
	.i2c_addr_table = { /*0x20, */ 0x5a, 0xff},
/* <GN_BSP_camera> <yangym> <20170411> add for 97071 0x20 not used end */
};
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{4640, 3488, 400, 664, 3840, 2160, 1920, 1080, 0000, 0000, 1920, 1080, 0, 0, 1920, 1080},/* hs video */
...
static void write_longexp_shutter(kal_uint32 shutter)
{

	switch (shutter) {
	case shutter1_30:
		LOG_INF("enter shutter1_30\n");
		...
		break;
	case shutter1_15:
		LOG_INF("enter shutter1_15\n");
		/* write_cmos_sensor(0x0100, 0x0000);// stream off */
		write_cmos_sensor(0x0342, 0x1400);
		write_cmos_sensor(0x0340, 0x1C59);
		write_cmos_sensor(0x0202, 0x1C5E);
		write_cmos_sensor(0x0700, 0x0000);
		write_cmos_sensor(0x0702, 0x0000);
		/* write_cmos_sensor(0x0100, 0x0100);//stream on */
		...
		break;
	case shutter1_8:
		LOG_INF("enter shutter1_8\n");
		/* write_cmos_sensor(0x0100, 0x0000);// stream off */
		write_cmos_sensor(0x0342, 0x1400);
		write_cmos_sensor(0x0340, 0x3528);
		write_cmos_sensor(0x0202, 0x352D);
		write_cmos_sensor(0x0700, 0x0000);
		write_cmos_sensor(0x0702, 0x0000);
		/* write_cmos_sensor(0x0100, 0x0100);//stream on */
		...
		break;
	case shutter1_4:
		LOG_INF("enter shutter1_4\n");
		/* write_cmos_sensor(0x0100, 0x0000);// stream off */
		write_cmos_sensor(0x0342, 0x1400);
		write_cmos_sensor(0x0340, 0x6A50);
		write_cmos_sensor(0x0202, 0x6A55);
		write_cmos_sensor(0x0700, 0x0000);
		write_cmos_sensor(0x0702, 0x0000);
		/* write_cmos_sensor(0x0100, 0x0100);//stream on */
		...
		break;
	case shutter1_2:
		LOG_INF("enter shutter1_2\n");
		/* write_cmos_sensor(0x0100, 0x0000);// stream off */
		write_cmos_sensor(0x0342, 0x1400);
		write_cmos_sensor(0x0340, 0xD4A0);
		write_cmos_sensor(0x0202, 0xD4A5);
		write_cmos_sensor(0x0700, 0x0000);
		write_cmos_sensor(0x0702, 0x0000);
		/* write_cmos_sensor(0x0100, 0x0100);//stream on */
		...
		break;
	case shutter1:
		LOG_INF("enter shutter1\n");
		/* write_cmos_sensor(0x0100, 0x0000);// stream off */
		write_cmos_sensor(0x0342, 0x1400);
		write_cmos_sensor(0x0340, 0x06AA);
		write_cmos_sensor(0x0202, 0x0645);
		...
		break;
	case shutter2:
		LOG_INF("enter shutter2\n");
		/* write_cmos_sensor(0x0100, 0x0000);// stream off */
		write_cmos_sensor(0x0342, 0x1400);
		write_cmos_sensor(0x0340, 0x0D4F);
		write_cmos_sensor(0x0202, 0x0D4A);
		write_cmos_sensor(0x0700, 0x0006);
		write_cmos_sensor(0x0702, 0x0606);
		/* write_cmos_sensor(0x0100, 0x0100);//stream on */
		...
		break;
	case shutter3:
		LOG_INF("enter shutter3\n");
		/* write_cmos_sensor(0x0100, 0x0000);// stream off */
		write_cmos_sensor(0x0342, 0x1400);
		write_cmos_sensor(0x0340, 0x13F4);
		write_cmos_sensor(0x0202, 0x13EF);
		write_cmos_sensor(0x0700, 0x0006);
		write_cmos_sensor(0x0702, 0x0606);
		/* write_cmos_sensor(0x0100, 0x0100);//stream on */
		...
		break;
	case shutter4:
		LOG_INF("enter shutter4\n");
		/* write_cmos_sensor(0x0100, 0x0000);// stream off */
		write_cmos_sensor(0x0342, 0x1400);
		write_cmos_sensor(0x0340, 0x1A99);
		write_cmos_sensor(0x0202, 0x1A94);
		write_cmos_sensor(0x0700, 0x0006);
		write_cmos_sensor(0x0702, 0x0606);
		/* write_cmos_sensor(0x0100, 0x0100);//stream on */
		...
		break;
	case shutter6:
		LOG_INF("enter shutter6\n");
		/* write_cmos_sensor(0x0100, 0x0000);// stream off */
		write_cmos_sensor(0x0342, 0x1400);
		write_cmos_sensor(0x0340, 0x27E3);
		write_cmos_sensor(0x0202, 0x27DE);
		write_cmos_sensor(0x0700, 0x0006);
		write_cmos_sensor(0x0702, 0x0606);
		/* write_cmos_sensor(0x0100, 0x0100);//stream on */
		...
		break;
	case shutter8:
		LOG_INF("enter shutter8\n");
		/* write_cmos_sensor(0x0100, 0x0000);// stream off */
		write_cmos_sensor(0x0342, 0x1400);
		write_cmos_sensor(0x0340, 0x352D);
		write_cmos_sensor(0x0202, 0x3528);
		write_cmos_sensor(0x0700, 0x0006);
		write_cmos_sensor(0x0702, 0x0606);
		/* write_cmos_sensor(0x0100, 0x0100);//stream on */
		...
		break;
	case shutter12:
		LOG_INF("enter shutter12\n");
		/* write_cmos_sensor(0x0100, 0x0000);// stream off */
		write_cmos_sensor(0x0342, 0x1400);
		write_cmos_sensor(0x0340, 0x4FC1);
		write_cmos_sensor(0x0202, 0x4FBC);
		write_cmos_sensor(0x0700, 0x0006);
		write_cmos_sensor(0x0702, 0x0606);
		/* write_cmos_sensor(0x0100, 0x0100);//stream on */
...
/* <GN_BSP_CAMERA> <fangrui> <20170408> add for fixing rolling flicker begin */
#ifdef ORIGINAL_VERSION
#else
	kal_uint32 tmp_lines;
#endif
/* <GN_BSP_CAMERA> <fangrui> <20170408> add for fixing rolling flicker end */
/*
*	spin_lock(&imgsensor_drv_lock);
...
/* <GN_BSP_CAMERA> <fangrui> <20170408> add for fixing rolling flicker begin */
...
#else
	{
		...
		if (shutter < tmp_lines) {
			LOG_INF("Fix rolling flicker --> old_frame_length=%d\n",
										imgsensor.frame_length);
			spin_lock(&imgsensor_drv_lock);
			imgsensor.frame_length =
			    (imgsensor.frame_length + tmp_lines - 1) / tmp_lines * tmp_lines;
			spin_unlock(&imgsensor_drv_lock);
			LOG_INF("Fix rolling flicker --> new_frame_length=%d\n",
										imgsensor.frame_length);
			write_cmos_sensor(0x0340, imgsensor.frame_length);
		}
	}
...
{
	unsigned long flags;
	/* static kal_uint16 LongExporsureFlag = 0; */

	LOG_INF("set shutter value =%d\n", shutter);
	...
	case shutter8:
	case shutter12:
		LOG_INF("enter longshutter writsetting start\n");
		write_longexp_shutter(shutter);
		/* LongExporsureFlag = 1; */
		LOG_INF("enter longshutter writsetting end\n");
		break;
	default:
		LOG_INF("enter normalshutter writsetting\n");
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0xF444, 0x0801);
	write_cmos_sensor(0xF43A, 0x000C);
	write_cmos_sensor(0xF472, 0x0014);
	write_cmos_sensor(0xF406, 0xFFFF);
	write_cmos_sensor(0xF40A, 0x001F);
	write_cmos_sensor(0xF43E, 0x0000);
	write_cmos_sensor(0xF440, 0x002F);
	write_cmos_sensor(0xF442, 0x64C6);
	write_cmos_sensor(0xF43C, 0x0090);
	write_cmos_sensor(0xF474, 0x0000);
	write_cmos_sensor(0xF494, 0x0810);
	write_cmos_sensor(0xF496, 0x0000);
	write_cmos_sensor(0xF470, 0x0010);
	write_cmos_sensor(0xF47C, 0x0014);
	write_cmos_sensor(0xF47E, 0x0000);
	write_cmos_sensor(0xF486, 0x0007);
	write_cmos_sensor(0xF488, 0x0008);
	write_cmos_sensor(0xF48A, 0x0000);
	write_cmos_sensor(0xF262, 0x0001);
	write_cmos_sensor(0xF498, 0x001D);
	write_cmos_sensor(0xF4CC, 0x0DEC);
	write_cmos_sensor(0xF4CE, 0x0DF4);
	write_cmos_sensor(0xA3FC, 0x0100);
	write_cmos_sensor(0xA3FE, 0x0000);
	write_cmos_sensor(0xB138, 0x0000);
	write_cmos_sensor(0x6028, 0x2000);
	write_cmos_sensor(0x602A, 0x1F94);
	write_cmos_sensor(0x6F12, 0x4010);
	write_cmos_sensor(0x602A, 0x1EBC);
	write_cmos_sensor(0x6F12, 0x8080);
	write_cmos_sensor(0x602A, 0x21B0);
	...
	write_cmos_sensor(0x602A, 0x2250);
	write_cmos_sensor(0x6F12, 0x03E8);
	write_cmos_sensor(0x602A, 0x1B26);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x602A, 0x1AE2);
	write_cmos_sensor(0x6F12, 0x0105);
	write_cmos_sensor(0x6F12, 0x0105);
	write_cmos_sensor(0x602A, 0x1AEA);
	write_cmos_sensor(0x6F12, 0x00F0);
	write_cmos_sensor(0x602A, 0x1ACC);
...
/* write_cmos_sensor(0x3190, 0x0008); */
	write_cmos_sensor(0x3246, 0x0001);
	write_cmos_sensor(0x3588, 0x0069);
	write_cmos_sensor(0x358E, 0x005E);
	write_cmos_sensor(0x3594, 0x004D);
	write_cmos_sensor(0x359A, 0x0010);
	write_cmos_sensor(0x35A0, 0x0065);
	write_cmos_sensor(0x35A6, 0x0062);
	write_cmos_sensor(0x35AC, 0x0049);
	write_cmos_sensor(0x35B8, 0x004B);
	write_cmos_sensor(0x37E6, 0x0001);
	write_cmos_sensor(0x37E8, 0x001B);
	write_cmos_sensor(0x37FA, 0x007F);
	write_cmos_sensor(0x37C0, 0x0907);
	write_cmos_sensor(0x37C8, 0x300F);
	write_cmos_sensor(0x37CA, 0x1813);
	write_cmos_sensor(0x37CC, 0x0F18);
	write_cmos_sensor(0x37CE, 0x1305);
	write_cmos_sensor(0x37D0, 0x0803);
	write_cmos_sensor(0x37D2, 0x0404);
	write_cmos_sensor(0x37E4, 0x0064);
	write_cmos_sensor(0x37F8, 0x0001);
	write_cmos_sensor(0x37FC, 0x0107);
	write_cmos_sensor(0x31AA, 0x0001);
	write_cmos_sensor(0x31B2, 0x0035);
	write_cmos_sensor(0x37EA, 0x004E);
	write_cmos_sensor(0x37EC, 0x004D);
	write_cmos_sensor(0x37F0, 0x0004);
	write_cmos_sensor(0x37F2, 0x0004);
	write_cmos_sensor(0x37F6, 0x0001);
	write_cmos_sensor(0x3218, 0x01C0);
	write_cmos_sensor(0x3252, 0x00BC);
	write_cmos_sensor(0x3258, 0x00DF);
	write_cmos_sensor(0x325E, 0x00BA);
	write_cmos_sensor(0x3264, 0x00E1);
	write_cmos_sensor(0x326A, 0x00B8);
	write_cmos_sensor(0x3270, 0x01E8);
	write_cmos_sensor(0x3276, 0x00BC);
	write_cmos_sensor(0x327C, 0x01E6);
	write_cmos_sensor(0x3282, 0x00B8);
	write_cmos_sensor(0x3288, 0x00FD);
	write_cmos_sensor(0x32B8, 0x00B8);
	write_cmos_sensor(0x32CA, 0x00DF);
	write_cmos_sensor(0x32D0, 0x00F7);
	write_cmos_sensor(0x32F4, 0x01E4);
	write_cmos_sensor(0x333C, 0x00BA);
	write_cmos_sensor(0x3342, 0x0125);
	write_cmos_sensor(0x3348, 0x01E6);
	write_cmos_sensor(0x3354, 0x00BE);
	write_cmos_sensor(0x335A, 0x0121);
	write_cmos_sensor(0x3360, 0x01EA);
	write_cmos_sensor(0x3390, 0x00B8);
	write_cmos_sensor(0x3396, 0x014C);
	write_cmos_sensor(0x339C, 0x01E4);
	write_cmos_sensor(0x33A2, 0x00C0);
	write_cmos_sensor(0x33A8, 0x00D7);
	write_cmos_sensor(0x33AE, 0x00C7);
	write_cmos_sensor(0x33B4, 0x00DF);
	write_cmos_sensor(0x33BA, 0x00CF);
	write_cmos_sensor(0x33C0, 0x00DF);
	write_cmos_sensor(0x33C6, 0x00C0);
	write_cmos_sensor(0x33CC, 0x00C2);
	write_cmos_sensor(0x33DE, 0x00C7);
	write_cmos_sensor(0x33E4, 0x00DF);
	write_cmos_sensor(0x33F6, 0x00C0);
	write_cmos_sensor(0x33FC, 0x00C2);
	write_cmos_sensor(0x3408, 0x00BA);
	write_cmos_sensor(0x340E, 0x014A);
	write_cmos_sensor(0x3414, 0x01E6);
	write_cmos_sensor(0x3432, 0x00C0);
	write_cmos_sensor(0x3438, 0x00DA);
	write_cmos_sensor(0x344A, 0x00C0);
	write_cmos_sensor(0x3450, 0x00C2);
	write_cmos_sensor(0x345C, 0x01EA);
	write_cmos_sensor(0x346E, 0x00BA);
	write_cmos_sensor(0x3474, 0x00BD);
	write_cmos_sensor(0x347A, 0x01E6);
	write_cmos_sensor(0x3480, 0x01E9);
	write_cmos_sensor(0x3486, 0x00BA);
	write_cmos_sensor(0x361E, 0x00ED);
	write_cmos_sensor(0x3636, 0x01FE);
	write_cmos_sensor(0x3642, 0x0109);
	write_cmos_sensor(0x3648, 0x00BB);
	write_cmos_sensor(0x3654, 0x01E7);
	write_cmos_sensor(0x365A, 0x01FE);
	write_cmos_sensor(0x3666, 0x00ED);
	write_cmos_sensor(0x366C, 0x000B);
	write_cmos_sensor(0x3678, 0x00BB);
	write_cmos_sensor(0x367E, 0x01FE);
	write_cmos_sensor(0x368A, 0x00F1);
	write_cmos_sensor(0x36A2, 0x01FE);
	write_cmos_sensor(0x36AE, 0x010D);
	write_cmos_sensor(0x36B4, 0x00BB);
	write_cmos_sensor(0x36C0, 0x01E7);
	write_cmos_sensor(0x36C6, 0x01FE);
	write_cmos_sensor(0x36D2, 0x00F1);
	write_cmos_sensor(0x36D8, 0x000B);
	write_cmos_sensor(0x36E4, 0x00BB);
	write_cmos_sensor(0x36EA, 0x01FE);
	write_cmos_sensor(0x6028, 0x2000);
	...
	write_cmos_sensor(0x6028, 0x2000);
	write_cmos_sensor(0x602A, 0x1E10);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor(0x602A, 0x1E84);
	write_cmos_sensor(0x6F12, 0x0101);
	write_cmos_sensor(0x0B00, 0x0080);
	write_cmos_sensor(0x3060, 0x0742);
	write_cmos_sensor(0x6028, 0x2000);
	write_cmos_sensor(0x602A, 0x1C7A);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor(0x602A, 0x1CA2);
	write_cmos_sensor(0x6F12, 0x0000);
}				/*      sensor_init  */
...
{
	/* Preview 2320*1744 30fps 24M MCLK 4lane 744Mbps/lane */
	/* preview 30.01fps */
	LOG_INF("preview_setting() E\n");
	LOG_INF("PDAF mode :%d preview_setting\n", imgsensor.pdaf_mode);	/*  */
	write_cmos_sensor(0x6028, 0x4000);
	...
	write_cmos_sensor(0x317A, 0x0000);
	write_cmos_sensor(0x317C, 0x0130);
	...
	write_cmos_sensor(0x0202, 0x0E10);
	write_cmos_sensor(0x0204, 0x0080);
	write_cmos_sensor(0x0216, 0x0000);
	write_cmos_sensor(0x021C, 0x0000);
	write_cmos_sensor(0x021E, 0x0000);
	write_cmos_sensor(0x0700, 0x0000);
	write_cmos_sensor(0x0702, 0x0000);
	write_cmos_sensor(0x37B0, 0x0002);
	write_cmos_sensor(0x37B2, 0x0103);
...
static void capture_setting(kal_uint16 currefps)
{
	...
	LOG_INF("PDAF mode :%d capture_setting\n", imgsensor.pdaf_mode);	/*  */
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	LOG_INF("PDAF mode :%d normal_video_setting\n", imgsensor.pdaf_mode);

	write_cmos_sensor(0x6028, 0x4000);
	/* 2320*1744 30fps 744Mbps/lane  */
	write_cmos_sensor_8(0x0100, 0x00);
	mdelay(3);
	check_stremoff();
...
static void hs_video_setting(void)
{
	...
	LOG_INF("PDAF mode :%d hs_video_setting\n", imgsensor.pdaf_mode);	/*  */
...
/* sensor_init(); */
	...
	mdelay(5);
	check_stremoff();
	write_cmos_sensor(0xB19A, 0x0000);	/* add setting(virtual chananel bypass) */
	write_cmos_sensor(0x6028, 0x2000);	/* tail mode off */
	write_cmos_sensor(0x602A, 0x2230);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor(0x30D4, 0x0000);	/* tail VC ==0 */
	write_cmos_sensor(0x30D6, 0x0030);
	write_cmos_sensor(0x3056, 0x0100);
	...
	write_cmos_sensor(0x317C, 0x0130);
	write_cmos_sensor(0x3190, 0x0004);
	write_cmos_sensor(0x0340, 0x0718);
	write_cmos_sensor(0x0342, 0x1400);
	...
	write_cmos_sensor(0x300A, 0x0001);
	write_cmos_sensor(0x0200, 0x0200);
	write_cmos_sensor(0x0202, 0x0710);
	write_cmos_sensor(0x0204, 0x0080);
	write_cmos_sensor(0x0216, 0x0000);
	write_cmos_sensor(0x021C, 0x0000);
	write_cmos_sensor(0x021E, 0x0000);
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor(0x0340, 0x0E1A);
	write_cmos_sensor(0x0342, 0x1400);
	write_cmos_sensor(0x0344, 0x0410);
	write_cmos_sensor(0x0346, 0x0400);
	write_cmos_sensor(0x0348, 0x0E0F);
			...
			*sensor_id =
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				LOG_INF("--- module id: 0x%x\n",
					(read_cmos_sensor_8(0x000D) << 8) |	read_cmos_sensor_8(0x000E));
