...
static imgsensor_info_struct imgsensor_info = { 
	...
	.pre = {
		...
		.linelength = 5650,				/*record different mode's linelength*/
	...
	.hs_video = {
		.pclk = 180000000,
		.linelength = 2600,			//5650,
		.framelength = 574,			//1060,
		.startx = 0,
		.starty = 0,
	...
	.slim_video = {
		.pclk = 180000000,			//168000000,
		.linelength = 5650,			//5248,
		.framelength = 1060,		//1066,
		.startx = 0,
		.starty = 0,
...
{{ 2608, 1960,	  0,	0, 2608, 1960, 1304,  980, 0000, 0000, 1304,  980,	  0,	0, 1304,  980}, // Preview 
 ...
 { 2608, 1960,	  24, 260, 2560, 1440, 1280,  720, 0000, 0000, 1280,  720,	  0,	0, 1280,  720}};// slim video 

static kal_uint16 read_cmos_sensor(kal_uint32 addr)
{
	//kdSetI2CSpeed(imgsensor_info.i2c_speed); // Add this func to set i2c speed by each sensor, but it is invalid in devicetree @ MT6797.
...
static void sensor_WDR_zhdr(void)
{
	if(imgsensor.hdr_mode == 9)
	{
		...
		//write_cmos_sensor(0x0218, 0x0200);	//0x0218/0x021A is the ratio of LE. For example,0x0218=0x0800,0x021A=0x0200,the the LE is 4 times of SE.
...
static void sensor_init(void)
{
	...
	mDELAY(3);
	write_cmos_sensor(0x535A,0xC700);
	write_cmos_sensor(0x5400,0x061D);
	write_cmos_sensor(0x5402,0x1500);
	write_cmos_sensor(0x6102,0xC000);
	write_cmos_sensor(0x614C,0x25AA);
	write_cmos_sensor(0x614E,0x25B8);
	write_cmos_sensor(0x618C,0x08D4);
	write_cmos_sensor(0x618E,0x08D6);
	write_cmos_sensor(0x6028,0x2000);
	write_cmos_sensor(0x602A,0x11A8);
	write_cmos_sensor(0x6F12,0x3AF9);
	...
	write_cmos_sensor(0x602A,0x12BC);
	write_cmos_sensor(0x6F12,0x1020);
	write_cmos_sensor(0x602A,0x12C2);
	write_cmos_sensor(0x6F12,0x1020);
	write_cmos_sensor(0x6F12,0x1020);
	write_cmos_sensor(0x602A,0x12CA);
	write_cmos_sensor(0x6F12,0x1020);
	write_cmos_sensor(0x6F12,0x1010);
	write_cmos_sensor(0x602A,0x12FC);
	write_cmos_sensor(0x6F12,0x1020);
	write_cmos_sensor(0x602A,0x1302);
	write_cmos_sensor(0x6F12,0x1020);
	write_cmos_sensor(0x6F12,0x1020);
	write_cmos_sensor(0x602A,0x130A);
	write_cmos_sensor(0x6F12,0x1020);
	write_cmos_sensor(0x6F12,0x1010);
	write_cmos_sensor(0x602A,0x14B8);
	write_cmos_sensor(0x6F12,0x0101);
	write_cmos_sensor(0x602A,0x14C0);
	write_cmos_sensor(0x6F12,0x0000);
	...
	write_cmos_sensor(0x6F12,0xFF80);
	write_cmos_sensor(0x6F12,0xFF80);
	write_cmos_sensor(0x602A,0x1496);
	write_cmos_sensor(0x6F12,0xFF80);
	write_cmos_sensor(0x6F12,0xFF80);
	write_cmos_sensor(0x6F12,0xFF80);
	write_cmos_sensor(0x6F12,0xFF80);
	write_cmos_sensor(0x602A,0x14A4);
	write_cmos_sensor(0x6F12,0xFFC0);
	write_cmos_sensor(0x6F12,0xFFC0);
	write_cmos_sensor(0x6F12,0xFFC0);
	write_cmos_sensor(0x6F12,0xFFC0);
	write_cmos_sensor(0x602A,0x147A);
	write_cmos_sensor(0x6F12,0x0000);
	write_cmos_sensor(0x6F12,0x0002);
	write_cmos_sensor(0x6F12,0xFFFC);
	write_cmos_sensor(0x602A,0x0512);
	write_cmos_sensor(0x6F12,0x0111);
	write_cmos_sensor(0x602A,0x066A);
	write_cmos_sensor(0x6F12,0x4110);
	write_cmos_sensor(0x602A,0x14AC);
	write_cmos_sensor(0x6F12,0x0000);
	write_cmos_sensor(0x602A,0x0524);
	write_cmos_sensor(0x6F12,0x0007);
	write_cmos_sensor(0x3284,0x3800);
	write_cmos_sensor(0x327A,0x0001);
	write_cmos_sensor(0x3282,0x000A);
	write_cmos_sensor(0x3296,0x0418);
	write_cmos_sensor(0x32E0,0x0000);
	write_cmos_sensor(0x3286,0x9000);
	write_cmos_sensor(0x3298,0x4007);
	write_cmos_sensor(0x32AA,0x0100);
	write_cmos_sensor(0x327C,0x0400);
	write_cmos_sensor(0x328A,0x0800);
	write_cmos_sensor(0x3284,0x3700);
	write_cmos_sensor(0x32A0,0x0320);
	write_cmos_sensor(0x32A2,0x1000);
	write_cmos_sensor(0x32A4,0x0C00);
	write_cmos_sensor(0x3204,0x000C);
	write_cmos_sensor(0x3206,0x000B);
	write_cmos_sensor(0x3208,0x0009);
	write_cmos_sensor(0x3210,0x0007);
	write_cmos_sensor(0x3212,0x0007);
	write_cmos_sensor(0x0200,0x0408);
	write_cmos_sensor(0x3218,0x031C);
	write_cmos_sensor(0x321A,0x3224);
	write_cmos_sensor(0x321C,0x0700);
	write_cmos_sensor(0x321E,0x0800);
	write_cmos_sensor(0x3220,0x1300);
	write_cmos_sensor(0x3226,0x525C);
	write_cmos_sensor(0x3228,0x0304);	
...
static void preview_setting(void)
{
	...
	// Reset for operation                                                                         
		write_cmos_sensor(0x5330,0XD403);
		write_cmos_sensor(0x5428,0X1800);
		write_cmos_sensor(0x3300,0X0000);
		write_cmos_sensor(0x0304,0X0006);
		write_cmos_sensor(0x0306,0X00B4);
		write_cmos_sensor(0x5362,0X0A00);
		write_cmos_sensor(0x5364,0X4298);
		write_cmos_sensor(0x534E,0X4910);
		write_cmos_sensor(0x0340,0X0424);		//1060,frame length
		write_cmos_sensor(0x0342,0X1612);
		write_cmos_sensor(0x0202,0X03FC);		//1020
		write_cmos_sensor(0x0344,0X0000);//0
		write_cmos_sensor(0x0346,0X0000);//0
		write_cmos_sensor(0x0348,0X0A2F);
		write_cmos_sensor(0x034A,0X07A7);
		write_cmos_sensor(0x034C,0X0518);
		write_cmos_sensor(0x034E,0X03D4);
		write_cmos_sensor(0x3500,0X0122);
		write_cmos_sensor(0x3088,0X0001);
		write_cmos_sensor(0x0216,0X0000);
		write_cmos_sensor(0x5332,0X04E0);
		write_cmos_sensor(0x5080,0X0100);
...
static void capture_setting(kal_uint16 currefps)
{
	...
	write_cmos_sensor(0x3286,0x9000);
	write_cmos_sensor(0x3298,0x4007);
	write_cmos_sensor(0x32AA,0x0000);
	write_cmos_sensor(0x327C,0x0400);
	write_cmos_sensor(0x328A,0x0800);
	write_cmos_sensor(0x3284,0x3700);
	write_cmos_sensor(0x32A0,0x0320);
	...
	write_cmos_sensor(0x3226,0x525C);
	write_cmos_sensor(0x3228,0x0304);	 	
	write_cmos_sensor(0x5330,0x5403);
	write_cmos_sensor(0x5428,0x1800);
	write_cmos_sensor(0x3300,0x0000);
	write_cmos_sensor(0x0304,0x0006);
	write_cmos_sensor(0x0306,0x00B4);
	...
	write_cmos_sensor(0x5364,0x4298);
	write_cmos_sensor(0x534E,0x4910);
	write_cmos_sensor(0x0340,0x07F8);
	write_cmos_sensor(0x0342,0x16D0);
	write_cmos_sensor(0x0202,0x03FC);
	write_cmos_sensor(0x0344,0x0000);
	write_cmos_sensor(0x0346,0x0000);
	write_cmos_sensor(0x0348,0x0A2F);
	write_cmos_sensor(0x034A,0x07A7);
	write_cmos_sensor(0x034C,0x0A30);
	write_cmos_sensor(0x034E,0x07A8);
	write_cmos_sensor(0x3500,0x0022);
	write_cmos_sensor(0x3088,0x0000);
	write_cmos_sensor(0x0216,0x0000);
	write_cmos_sensor(0x5332,0x04E0);
	write_cmos_sensor(0x5080,0x0100);
	...
	write_cmos_sensor(0x534E,0x4910);
	write_cmos_sensor(0x0340,0x07F8);
	write_cmos_sensor(0x0342,0x0E5C);
	write_cmos_sensor(0x0202,0x03FC);
	write_cmos_sensor(0x0344,0x0000);
	write_cmos_sensor(0x0346,0x0000);
	write_cmos_sensor(0x0348,0x0A2F);
	...
	write_cmos_sensor(0x534E,0x4910);
	write_cmos_sensor(0x0340,0x07F8);
	write_cmos_sensor(0x0342,0x0B68);
	write_cmos_sensor(0x0202,0x03FC);
	write_cmos_sensor(0x0344,0x0000);
	write_cmos_sensor(0x0346,0x0000);
	write_cmos_sensor(0x0348,0x0A2F);
...
static void hs_video_setting(void)
{
	...
	write_cmos_sensor(0x5364,0x4298);
	write_cmos_sensor(0x534E,0x4910);
	write_cmos_sensor(0x0340,0x023E);
	write_cmos_sensor(0x0342,0x0A28);
	write_cmos_sensor(0x021E,0x03FC);
	write_cmos_sensor(0x0344,0x0000);
	write_cmos_sensor(0x0346,0x0000);
	write_cmos_sensor(0x0348,0x0A2F);
	write_cmos_sensor(0x034A,0x079F);
	write_cmos_sensor(0x034C,0x028C);
	write_cmos_sensor(0x034E,0x01E8);
	write_cmos_sensor(0x3500,0x0122);
	write_cmos_sensor(0x3088,0x0001);
	write_cmos_sensor(0x0216,0x0000);
	write_cmos_sensor(0x5332,0x04E0);
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor(0x5364,0x4298); 
	write_cmos_sensor(0x534E,0x4910);	
	write_cmos_sensor(0x0340,0x0424); 
	write_cmos_sensor(0x0342,0x1612); 
	write_cmos_sensor(0x0202,0x03FC); 
	write_cmos_sensor(0x0344,0x0018); 
	write_cmos_sensor(0x0346,0x0104); 
	write_cmos_sensor(0x0348,0x0A17); 
	write_cmos_sensor(0x034A,0x06A3); 
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	LOG_INF("Matrix ZHDR_Mode = %d\n", sensor_info->ZHDR_Mode);
