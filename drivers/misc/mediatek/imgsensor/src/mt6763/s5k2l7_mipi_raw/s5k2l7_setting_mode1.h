...
#define _S5K2L7_MODE1_INIT_ do{ \
	table_write_cmos_sensor(addr_data_pair_init_2l7_m1, sizeof(addr_data_pair_init_2l7_m1)/sizeof(kal_uint16)); \
}while(0)


#define _S5K2L7_MODE1_PREVIEW_ do{ \
	table_write_cmos_sensor(addr_data_pair_preview_2l7_m1, sizeof(addr_data_pair_preview_2l7_m1)/sizeof(kal_uint16)); \
}while(0)

#define _S5K2L7_MODE1_CAPTURE_ do{ \
    table_write_cmos_sensor(addr_data_pair_capture_2l7_m1, sizeof(addr_data_pair_capture_2l7_m1)/sizeof(kal_uint16)); \
}while(0)

#define _S5K2L7_MODE1_HS_VIDEO_ do{ \
    table_write_cmos_sensor(addr_data_pair_hs_2l7_m1, sizeof(addr_data_pair_hs_2l7_m1)/sizeof(kal_uint16)); \
}while(0)

#define _S5K2L7_MODE1_SLIM_VIDEO_ do{ \
    table_write_cmos_sensor(addr_data_pair_slim_2l7_m1, sizeof(addr_data_pair_slim_2l7_m1)/sizeof(kal_uint16)); \
}while(0)

#define _S5K2L7_MODE1_CAPTURE_WDR_ do{ \
    table_write_cmos_sensor(addr_data_pair_capture_wdr_2l7_m1, sizeof(addr_data_pair_capture_wdr_2l7_m1)/sizeof(kal_uint16)); \
}while(0)
