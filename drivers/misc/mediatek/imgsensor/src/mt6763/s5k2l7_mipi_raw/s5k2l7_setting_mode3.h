...
#define _S5K2L7_MODE3_INIT_ do{ \
	table_write_cmos_sensor(addr_data_pair_init_2l7_m3, sizeof(addr_data_pair_init_2l7_m3)/sizeof(kal_uint16)); \
}while(0)


#define _S5K2L7_MODE3_PREVIEW_ do{ \
	table_write_cmos_sensor(addr_data_pair_preview_2l7_m3, sizeof(addr_data_pair_preview_2l7_m3)/sizeof(kal_uint16)); \
}while(0)

#define _S5K2L7_MODE3_CAPTURE_ do{ \
    table_write_cmos_sensor(addr_data_pair_capture_2l7_m3, sizeof(addr_data_pair_capture_2l7_m3)/sizeof(kal_uint16)); \
}while(0)

#define _S5K2L7_MODE3_HS_VIDEO_ do{ \
    table_write_cmos_sensor(addr_data_pair_hs_2l7_m3, sizeof(addr_data_pair_hs_2l7_m3)/sizeof(kal_uint16)); \
}while(0)

#define _S5K2L7_MODE3_SLIM_VIDEO_ do{ \
    table_write_cmos_sensor(addr_data_pair_slim_2l7_m3, sizeof(addr_data_pair_slim_2l7_m3)/sizeof(kal_uint16)); \
}while(0)

#define _S5K2L7_MODE3_CAPTURE_WDR_ do{ \
    table_write_cmos_sensor(addr_data_pair_capture_wdr_2l7_m3, sizeof(addr_data_pair_capture_wdr_2l7_m3)/sizeof(kal_uint16)); \
}while(0)
