...
static const struct i2c_device_id gi2c_dev_id_0[] = {
	{IMGSENSOR_I2C_DRV_NAME_0, 0}
};

static const struct i2c_device_id gi2c_dev_id_1[] = {
	{IMGSENSOR_I2C_DRV_NAME_1, 0}
};

static const struct i2c_device_id gi2c_dev_id_2[] = {
	...
	enum   IMGSENSOR_I2C_DEV  device)
{
	...
	i2c_add_driver(pi2c_cfg->pi2c_driver);
...
{
	i2c_del_driver(pi2c_cfg->pi2c_driver);
	return IMGSENSOR_RETURN_SUCCESS;
}
