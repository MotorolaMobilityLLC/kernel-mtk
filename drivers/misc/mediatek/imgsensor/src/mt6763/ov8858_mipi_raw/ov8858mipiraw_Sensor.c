...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
	    ...
	    .grabwindow_width =
		1632, /* record different mode's width of grabwindow */
	    .grabwindow_height =
		1224, /* record different mode's height of grabwindow */
	...
	.cap1 = {
	    /*
	     * capture for PIP 15fps relative information, capture1 mode must
	     * use same framelength,
	...
	.max_frame_length =
	0x90f7, /* max framelength by sensor register's limitation */
	.ae_shut_delay_frame = 0,
	.ae_sensor_gain_delay_frame =
	0, /* sensor gain delay frame for AE cycle,
	...
	.sensor_mode_num =
	5, /* support sensor mode num ,don't support Slow motion */
	...
	MIPI_SETTLEDELAY_AUTO, /* 0,MIPI_SETTLEDELAY_AUTO;
				* 1,MIPI_SETTLEDELAY_MANNUAL
				*/
	.sensor_output_dataformat =
	SENSOR_OUTPUT_FORMAT_RAW8_B, /* sensor output first pixel color */
	.mclk = 24, /* mclk value, suggest 24 or 26 for 24Mhz or 26Mhz */
	.mipi_lane_num = SENSOR_MIPI_2_LANE, /* mipi lane num */
	.i2c_addr_table = {0x42, 0x6c,
		       0xff}, /* record sensor support all write id addr,
...
static struct imgsensor_struct imgsensor = {
	...
	.sensor_mode = IMGSENSOR_MODE_INIT,
				  ...
				  * INIT, Preview, Capture, Video,High
				  * Speed Video, Slim Video
				  */
	...
	.autoflicker_en = KAL_FALSE,
			 /* auto flicker enable:
			  * KAL_FALSE for disable auto flicker, KAL_TRUE
			  * for enable auto flicker
			  */
	.test_pattern = KAL_FALSE,
			 /* test pattern mode or not.
			  * KAL_FALSE for in test pattern mode, KAL_TRUE
			  * for normal output
			  */
	.current_scenario_id =
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{3264, 2448, 0, 0, 3264, 2448, 1632, 1224, 0, 0, 1632, 1224, 0, 0, 1632,
	 1224}, /* Preview */
	{3264, 2448, 0, 0, 3264, 2448, 3264, 2448, 0, 0, 3264, 2448, 0, 0, 3264,
	 2448}, /* capture */
	{3264, 2448, 0, 0, 3264, 2448, 1632, 1224, 0, 0, 1632, 1224, 0, 0, 1632,
	 1224}, /* video */
	{3264, 2448, 0, 0, 3264, 2448, 1632, 1224, 0, 0, 1632, 1224, 0, 0, 1632,
	 1224}, /* hight speed video */
	{3264, 2448, 0, 0, 3264, 2448, 1632, 1224, 0, 0, 1632, 1224, 0, 0, 1632,
	 1224} /* slim video */
};

enum SENSOR_DPCM_TYPE_ENUM imgsensor_dpcm_info_ov8858[10] = {
	COMP8_NONE, COMP8_NONE, COMP8_NONE, COMP8_NONE, COMP8_NONE,
	COMP8_NONE, COMP8_NONE, COMP8_NONE, COMP8_NONE, COMP8_NONE};
...
#endif
static kal_uint16 ov8858_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
kal_uint16 addr_data_pair_init_ov8858[] = {
	0x100, 0x00, 0x302, 0x1e, 0x303, 0x00, 0x304, 0x03, 0x30e, 0x02, 0x30f,
	0x04, 0x312, 0x03, 0x31e, 0x0c, 0x3600, 0x00, 0x3601, 0x00, 0x3602,
	0x00,
	0x3603, 0x00, 0x3604, 0x22, 0x3605, 0x20, 0x3606, 0x00, 0x3607, 0x20,
	0x3608, 0x11, 0x3609, 0x28, 0x360a, 0x00, 0x360b, 0x05, 0x360c, 0xd4,
	0x360d, 0x40, 0x360e, 0x0c, 0x360f, 0x20, 0x3610, 0x07, 0x3611, 0x20,
	0x3612, 0x88, 0x3613, 0x80, 0x3614, 0x58, 0x3615, 0x00, 0x3616, 0x4a,
	0x586e, 0x10, 0x586f, 0x08, 0x58f8, 0x3d, /* add */
	0x5901, 0x00, 0x5b00, 0x02, 0x5b01, 0x10, 0x5b02, 0x03, 0x5b03, 0xcf,
	0x5b05, 0x6c, 0x5e00, 0x00, 0x5e01, 0x41, 0x382d, 0x7f, 0x4825, 0x3a,
	0x4826, 0x40, 0x4808, 0x25, 0x3763, 0x18, 0x3768, 0xcc, 0x470b, 0x28,
	0x4202, 0x00, 0x400d, 0x10, 0x4040, 0x07, /* 04 */
	0x403e, 0x08,			      /* 04 */
	0x4041, 0xc6, 0x3007, 0x80, 0x400a, 0x01,
...
static void sensor_init(void)
{
	...
	ov8858_table_write_cmos_sensor(addr_data_pair_init_ov8858,
				       sizeof(addr_data_pair_init_ov8858) /
					   sizeof(kal_uint16));
/*
...
kal_uint16 addr_data_pair_preview_ov8858[] = {
	0x0302, 0x1e, 0x030e, 0x00, 0x0312, 0x01, 0x3015, 0x01, 0x3501, 0x4d,
	0x3502, 0x40, 0x3700, 0x30, 0x3701, 0x18, 0x3702, 0x50, 0x3703, 0x32,
	0x3704, 0x28, 0x3707, 0x08, 0x3708, 0x48, 0x3709, 0x66, 0x370c, 0x07,
	0x3718, 0x14, 0x3712, 0x44, 0x371e, 0x31, 0x371f, 0x7f, 0x3720, 0x0a,
	0x3721, 0x0a, 0x3724, 0x0c, 0x3725, 0x02, 0x3726, 0x0c, 0x3728, 0x0a,
	0x3729, 0x03, 0x372a, 0x06, 0x372b, 0xa6, 0x372c, 0xa6, 0x372d, 0xa6,
	0x372e, 0x0c, 0x372f, 0x20, 0x3730, 0x02, 0x3731, 0x0c, 0x3732, 0x28,
	0x3736, 0x30, 0x373a, 0x0a, 0x373b, 0x0b, 0x373c, 0x14, 0x373e, 0x06,
	0x375a, 0x0c, 0x375b, 0x26, 0x375d, 0x04, 0x375f, 0x28, 0x3768, 0xcc,
	0x3769, 0x44, 0x376a, 0x44, 0x3772, 0x46, 0x3773, 0x04, 0x3774, 0x2c,
	0x3775, 0x13, 0x3776, 0x08, 0x3778, 0x17, 0x37a0, 0x88, 0x37a1, 0x7a,
	0x37a2, 0x7a, 0x37a7, 0x88, 0x37a8, 0x98, 0x37a9, 0x98, 0x37aa, 0x88,
	0x37ab, 0x5c, 0x37ac, 0x5c, 0x37ad, 0x55, 0x37ae, 0x19, 0x37af, 0x19,
	0x37b3, 0x84, 0x37b4, 0x84, 0x37b5, 0x60, 0x3808, 0x06, 0x3809, 0x60,
	0x380a, 0x04, 0x380b, 0xc8, 0x380c, 0x07, 0x380d, 0x88, 0x380e, 0x09,
	0x380f, 0xb8, 0x3814, 0x03, 0x3821, 0x67, 0x382a, 0x03, 0x382b, 0x01,
	0x3830, 0x08, 0x3836, 0x02, 0x3f08, 0x10, 0x4001, 0x10, 0x4022, 0x06,
	0x4023, 0x00, 0x4025, 0x2a, 0x4027, 0x2b, 0x402a, 0x04, 0x402b, 0x04,
	0x402e, 0x04, 0x402f, 0x04, 0x4600, 0x00, 0x4601, 0xcb, 0x4837, 0x16,
	0x5901, 0x00, 0x382d, 0x7f, 0x3031, 0x08, /* 8 bits */
...
/* mdelay(5); */
	...
	ov8858_table_write_cmos_sensor(addr_data_pair_preview_ov8858,
				       sizeof(addr_data_pair_preview_ov8858) /
					   sizeof(kal_uint16));
...
kal_uint16 addr_data_pair
	0x3769, 0x44, 0x376a, 0x44, 0x3772, 0x23, 0x3773, 0x02, 0x3774, 0x16,
	0x3775, 0x12, 0x3776, 0x04, 0x3778, 0x1a, 0x37a0, 0x44, 0x37a1, 0x3d,
	0x37a2, 0x3d, 0x37a7, 0x44, 0x37a8, 0x4c, 0x37a9, 0x4c, 0x37aa, 0x44,
	0x37ab, 0x2e, 0x37ac, 0x2e, 0x37ad, 0x33, 0x37ae, 0x0d, 0x37af, 0x0d,
	0x37b3, 0x42, 0x37b4, 0x42, 0x37b5, 0x31, 0x3808, 0x0c, 0x3809, 0xc0,
	0x380a, 0x09, 0x380b, 0x90, 0x380c, 0x07, 0x380d, 0x94, 0x380e, 0x09,
	0x380f, 0xaa, 0x3814, 0x01, 0x3821, 0x46, 0x382a, 0x01, 0x382b, 0x01,
	0x3830, 0x06, 0x3836, 0x01, 0x3f08, 0x08, 0x4001, 0x00, 0x4022, 0x0c,
	0x4023, 0x60, 0x4025, 0x36, 0x4027, 0x37, 0x402a, 0x04, 0x402b, 0x08,
	0x402e, 0x04, 0x402f, 0x08, 0x4600, 0x01, 0x4601, 0x97, 0x4837, 0x10,
	0x5901, 0x00, 0x382d, 0xff, 0x3031, 0x08,
...
kal_uint16 addr_data_pair_capture_24fps_ov8858[] = {
	...
	0x37ab, 0x5c, 0x37ac, 0x5c, 0x37ad, 0x55, 0x37ae, 0x19, 0x37af, 0x19,
	0x37b3, 0x84, 0x37b4, 0x84, 0x37b5, 0x60, 0x3808, 0x0c, 0x3809, 0xc0,
	0x380a, 0x09, 0x380b, 0x90, 0x380c, 0x09, 0x380d, 0x28, 0x380e, 0x09,
	0x380f, 0xfc, 0x3814, 0x01, 0x3821, 0x46, 0x382a, 0x01, 0x382b, 0x01,
	0x3830, 0x06, 0x3836, 0x01, 0x3f08, 0x10, 0x4001, 0x00, 0x4022, 0x0c,
	0x4023, 0x60, 0x4025, 0x36, 0x4027, 0x37, 0x402a, 0x04, 0x402b, 0x08,
	0x402e, 0x04, 0x402f, 0x08, 0x4600, 0x01, 0x4601, 0x97, 0x4837, 0x0d,
	0x5901, 0x00, 0x382d, 0xff,
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				if ((read_cmos_sensor(0x302A)) == 0XB2) {
					...
					if (bm == FACTORY_BOOT ||
						...
						imgsensor_dpcm_info_ov8858[1] =
						    COMP8_DI_2A;
					}
					return ERROR_NONE;
				} else if ((read_cmos_sensor(0x302A)) ==
					   0XB1) {
					LOG_INF(
 ...
 *  *sensor_config_data : address pointer of line numbers in one period of
 *VSYNC
 *
 * RETURNS
 *	None
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if (imgsensor.current_fps == imgsensor_info.cap1.max_framerate) {
		/* PIP capture: 24fps for less than 13M, 20fps for 16M,15fps
		 * for
		 * 20M
		 */
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sensor_info->AEShutDelayFrame =
	    imgsensor_info.ae_shut_delay_frame; /* The frame of setting
						 * shutter default 0 for TG int
						 */
	sensor_info->AESensorGainDelayFrame =
	    imgsensor_info.ae_sensor_gain_delay_frame; /* The frame of setting
							* sensor gain
							*/
