...
/* extern void register_imgsensor_deviceinfo(char *name, char *version, u8
 * module_id);
 */
/* static uint8_t deviceInfo_register_value = 0x00; */
#endif

/* #define LOG_WRN(format, args...) xlog_printk(ANDROID_LOG_WARN ,PFX, "[%S] "
 * format, __FUNCTION__, ##args)
 */
/* #defineLOG_INF(format, args...) xlog_printk(ANDROID_LOG_INFO ,PFX, "[%s] "
 * format, __FUNCTION__, ##args)
 */
...
static struct imgsensor_struct imgsensor = {
	...
	/* IMGSENSOR_MODE enum value,record current sensor
	 * mode,such as: INIT, Preview,
...
/* auto flicker enable: KAL_FALSE for disable auto flicker, KAL_TRUE for
 * enable auto flicker
 */
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{5184, 3880, 0, 0, 5184, 3880, 2592, 1940, 0000, 0000, 2592, 1940, 0, 0,
	 2592, 1940}, /*Preview*/
#if USE_REMOSAIC
	{5184, 3880, 0, 0, 5184, 3880, 5184, 3880, 0000, 0000, 5184, 3880, 0, 0,
	 5184, 3880}, /* remosic*/
#else
	{2592, 1940, 0, 0, 2592, 1940, 2592, 1940, 0000, 0000, 2592, 1940, 0, 0,
	 2592, 1940}, /* capture*/
#endif
	{5184, 3880, 0, 0, 5184, 3880, 2592, 1940, 0000, 0000, 2592, 1940, 0, 0,
	 2592, 1940}, /* video */
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
...
#ifdef VENDOR_EDIT
				/*zhaozhengtao 2016/02/19,modify for different
				 * module
				 */
...
#ifndef VENDOR_EDIT
				/* Add by LiuBin for register device info at
				 * 20160616
				 */
				if (deviceInfo_register_value == 0x00) {
					register_imgsensor_deviceinfo(
					    "Cam_f", DEVICE_VERSION_IMX376,
					    imgsensor_info.module_id);
	...
	if (!vendor_kthread) {
		...
		vendor_init_task = kthread_create(vendor_init_kthread, NULL,
						  "vendor_kthread_front");
	...
	case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
		if (imgsensor.current_fps ==
			...
			spin_unlock(&imgsensor_drv_lock);
			   ...
			   imgsensor_info.cap2.max_framerate) {
			frame_length = imgsensor_info.cap2.pclk / framerate *
				       10 / imgsensor_info.cap2.linelength;
			spin_lock(&imgsensor_drv_lock);
			imgsensor.dummy_line =
				  ...
				  UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		/* read_3P3_eeprom((kal_uint16
		 *)(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),
	...
	case SENSOR_FEATURE_GET_PDAF_INFO:
		...
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
			 ...
			 * *)&imgsensor_pd_info,sizeof(struct
			 * SET_PD_BLOCK_INFO_T));
			 */
			break;
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
	...
	case SENSOR_FEATURE_GET_4CELL_DATA: {
		...
		if (type == FOUR_CELL_CAL_TYPE_ALL) {
			LOG_INF("SENSOR_FEATURE_GET_4CELL_DATA type=%d\n",
				type);
			m24c64s_read_4cell_from_eeprom(
			    (char *)(*(feature_data + 1)));
