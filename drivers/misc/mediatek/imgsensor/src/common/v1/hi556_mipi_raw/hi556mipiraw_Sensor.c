...
static struct imgsensor_struct imgsensor = {
	.mirror = IMAGE_NORMAL,//IMAGE_NORMAL,
...
static void read_hi556_otp(void)
{
	...
	RGr=(data_awb[0]<<8)|(data_awb[1]&0x03ff);
	BGb=(data_awb[2]<<8)|(data_awb[3]&0x03ff);
	GbGr=(data_awb[4]<<8)|(data_awb[5]&0x03ff);
	gRGr=(data_awb[6]<<8)|(data_awb[7]&0x03ff);
	gBGb=(data_awb[8]<<8)|(data_awb[9]&0x03ff);
	gGbGr=(data_awb[10]<<8)|(data_awb[11]&0x03ff);
...
static void apply_hi556_otp(void)
{
	...
	RG_golden = 0x103;
	BG_golden = 0x129;
	R_gain = (0x200*RG_golden/RG_unit);
	B_gain = (0x200*BG_golden/BG_unit);
	G_gain = 0x200;
	if(R_gain < B_gain)
	{
		if(R_gain < 0x200)
