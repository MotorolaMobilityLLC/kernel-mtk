...
/* Corfu */
UINT32 MOT_CORFU_S5KGM1_QTECH_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 MOT_COFUL_S5KJN1_QTECH_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
/* Cofud */
...
UINT32 MOT_COFUD_S5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
/* Milan */
...
UINT32 MOT_MILAN_S5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 MOT_ELLIS_SC500CS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 MOT_TONGA_S5KJN1SQ_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
