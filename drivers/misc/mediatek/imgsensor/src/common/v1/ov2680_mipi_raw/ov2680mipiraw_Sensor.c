...
#define LOG_INF(format, args...)    \
	printk(" ov2680mipiraw_Sensor [%s] " format, __func__, ##args)
...
{{ 1616, 1216,	  0,  0, 1616, 1216, 1616, 1216, 8, 8, 1600, 1200,	  0,	0, 1600, 1200}, // Preview 
 ...
 { 1616, 1216,	  0,  0, 1616, 1216, 1616, 1216, 8, 8, 1600, 1200,	  0,	0, 1600, 1200}};// slim video 
		...
		do {
            *sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				memcpy(backaux_cam_name, "2_ov2680", 64);
...
UINT32 OV2680_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
