...
kal_uint16 addr_data_pair_init_hi1336_por[] = {
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
...
kal_uint16 addr_data_pair_preview_hi1336_por[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
...
kal_uint16 addr_data_pair_capture_30fps_hi1336_por[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1)
	0x0732, 0xe0b0, //pll_cfg_mipi_b b13-11:100_isp_div1(1/5) b10-8:000_mipi_div1(1/1) b1-0:00_mipi_div2(1/1)
	0x1118, 0x0006, //LSC r_win_y B[11]: Bit8 of y offset in start block when cropping. B[10:8] y start index of block when cropping. B[7:0] y offset in start block when cropping.
...
kal_uint16 addr_data_pair_capture_15fps_hi1336_por[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
...
kal_uint16 addr_data_pair_video_hi1336_por[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1)
	0x0732, 0xe0b0, //pll_cfg_mipi_b b13-11:100_isp_div1(1/5) b10-8:000_mipi_div1(1/1) b1-0:00_mipi_div2(1/1)
	0x1118, 0x0006, //LSC r_win_y B[11]: Bit8 of y offset in start block when cropping. B[10:8] y start index of block when cropping. B[7:0] y offset in start block when cropping.
...
kal_uint16 addr_data_pair_hs_video_hi1336_por[] = {
	          /********************************
	*hs_video setting
...
kal_uint16 addr_data_pair_slim_video_hi1336_por[] = {
	          /********************************
	*slim_video setting
	*1280x720@120fps[720Mbps]
	*****************************/
...
kal_uint16 addr_data_pair_custom1_hi1336_por[] = {
	0x3250, 0xa060,
	0x0730, 0x530f,
	0x0732, 0xe0b0,
	0x1118, 0x00c6,
