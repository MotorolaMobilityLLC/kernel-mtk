...
#include "mot_maui_gc02m1_mipi_raw.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "mot_maui_gc02m1_camera_sensor"
...
#define MODULE_DATA_SIZE 17
#define MAUI_GC02M1_OTP_CRC_AWB_GROUP1_CAL_SIZE 7
#define MAUI_GC02M1_OTP_CRC_AWB_GROUP2_CAL_SIZE 6
#define DEPTH_AWB_DATA_PATH "/data/vendor/camera_dump/mot_maui_gc02m1_otp.bin"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = MOT_MAUI_GC02M1_SENSOR_ID,
...
static kal_uint16 mot_maui_gc02m1_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static calibration_status_t MAUI_GC02M1_check_awb_data(void *data)
{
...
static void MAUI_GC02M1_eeprom_format_calibration_data(void *data)
{
	if (NULL == data) {
	...
	mnf_status            = 0;
	af_status             = 0;
	awb_status            = MAUI_GC02M1_check_awb_data(data);
	lsc_status            = 0;
	pdaf_status           = 0;
	dual_status           = 0;
...
static void read_gc02m1_awb_info(void)
{
    ...
    for(i = 0; i < GC02M1_SERIAL_NUM_SIZE; i++){
    	write_cmos_sensor(0x17, (0x18 + i*0x08));
    	write_cmos_sensor(0xf3, 0x34);
    	gc02m1_data_serial_num[i] = read_cmos_sensor(0x19);
    	LOG_INF("addr = 0x%x, value = 0x%x\n", (0x18+i*0x08), gc02m1_data_serial_num[i]);
    }
    for(i = 0; i < MODULE_DATA_SIZE; i++){
    	write_cmos_sensor(0x17, (AWB_GROUP_FLAG_ADDR+i*0x08));
    	write_cmos_sensor(0xf3, 0x34);
    	gc02m1_data_awb[i] = read_cmos_sensor(0x19);
    	LOG_INF("addr = 0x%x, value = 0x%x\n", (AWB_GROUP_FLAG_ADDR+i*0x08), gc02m1_data_awb[i]);
    }
}
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
    ...
    if (reg_gain < MOT_MAUI_GC02M1_SENSOR_GAIN_BASE)
    	reg_gain = MOT_MAUI_GC02M1_SENSOR_GAIN_BASE;
    else if (reg_gain > MOT_MAUI_GC02M1_SENSOR_GAIN_MAX)
    	reg_gain = MOT_MAUI_GC02M1_SENSOR_GAIN_MAX;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
    ...
    kal_uint16 MOT_MAUI_GC02M1_AGC_Param[MOT_MAUI_GC02M1_SENSOR_GAIN_MAX_VALID_INDEX][2] = {
    	{  1024,  0 },
    	{  1536,  1 },
    	{  2035,  2 },
    	{  2519,  3 },
    ...
    for (gain_index = MOT_MAUI_GC02M1_SENSOR_GAIN_MAX_VALID_INDEX - 1; gain_index >= 0; gain_index--)
    	if (reg_gain >= MOT_MAUI_GC02M1_AGC_Param[gain_index][0])
    		break;

    write_cmos_sensor(0xfe, 0x00);
    write_cmos_sensor(0xb6, MOT_MAUI_GC02M1_AGC_Param[gain_index][1]);
...
kal_uint16 addr_data_pair_init_mot_maui_gc02m1[] = {
    /*system*/
    0xfc, 0x01,
    0xf4, 0x41,
    0xf5, 0xc0,
...
kal_uint16 addr_data_pair_preview_mot_maui_gc02m1[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

kal_uint16 addr_data_pair_capture_mot_maui_gc02m1[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

kal_uint16 addr_data_pair_normal_video_mot_maui_gc02m1[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

kal_uint16 addr_data_pair_hs_video_mot_maui_gc02m1[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

kal_uint16 addr_data_pair_slim_video_mot_maui_gc02m1[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};
...
static void sensor_init(void)
{
    ...
    mot_maui_gc02m1_table_write_cmos_sensor(
        addr_data_pair_init_mot_maui_gc02m1,
    	sizeof(addr_data_pair_init_mot_maui_gc02m1) /
    	sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
    LOG_INF("E\n");
    mot_maui_gc02m1_table_write_cmos_sensor(
    	addr_data_pair_preview_mot_maui_gc02m1,
    	sizeof(addr_data_pair_preview_mot_maui_gc02m1) /
    	sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
    LOG_INF("E\n");
    mot_maui_gc02m1_table_write_cmos_sensor(
    	addr_data_pair_capture_mot_maui_gc02m1,
    	sizeof(addr_data_pair_capture_mot_maui_gc02m1) /
    	sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
    LOG_INF("E\n");
    mot_maui_gc02m1_table_write_cmos_sensor(
        addr_data_pair_normal_video_mot_maui_gc02m1,
    	sizeof(addr_data_pair_normal_video_mot_maui_gc02m1) /
    	sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
    LOG_INF("E\n");
    mot_maui_gc02m1_table_write_cmos_sensor(
    	addr_data_pair_hs_video_mot_maui_gc02m1,
    	sizeof(addr_data_pair_hs_video_mot_maui_gc02m1) /
    	sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
    LOG_INF("E\n");
    mot_maui_gc02m1_table_write_cmos_sensor(
    	addr_data_pair_slim_video_mot_maui_gc02m1,
    	sizeof(addr_data_pair_slim_video_mot_maui_gc02m1) /
    	sizeof(kal_uint16));
...
#define MOT_MAUI_GC02M1_I2CBUS    (4)
    	...
    	do {
    		*sensor_id = return_sensor_id() + 1;
    		if (*sensor_id == imgsensor_info.sensor_id) {
    			...
    			gc02m1_otp_dump_bin(DEPTH_AWB_DATA_PATH, MODULE_DATA_SIZE, (void *)gc02m1_data_awb);
    			gc02m1_otp_dump_bin(DEPTH_SERIAL_NUM_DATA_PATH, GC02M1_SERIAL_NUM_SIZE, (void *)gc02m1_data_serial_num);
    			MAUI_GC02M1_eeprom_format_calibration_data((void *)gc02m1_data_awb);
				return ERROR_NONE;
    		}
    ...
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    sensor_info->calibration_status.dual = dual_status;
    {
    	...
    	gc02m1_data_serial_num[0], gc02m1_data_serial_num[1],
    	gc02m1_data_serial_num[2], gc02m1_data_serial_num[3],
    	gc02m1_data_serial_num[4], gc02m1_data_serial_num[5],
    	gc02m1_data_serial_num[6], gc02m1_data_serial_num[7],
...
UINT32 MOT_MAUI_GC02M1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
