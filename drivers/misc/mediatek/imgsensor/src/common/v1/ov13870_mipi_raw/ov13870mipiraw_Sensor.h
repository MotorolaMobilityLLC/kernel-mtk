...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct
	    custom5; /* custom5 scenario relative information */
	...
	kal_uint8 frame_time_delay_frame; /* The delay frame of setting frame
					     length  */
...
static kal_uint16 table_write_cmos_sensor_byte(kal_uint16 *para,
					       kal_uint32 len);
