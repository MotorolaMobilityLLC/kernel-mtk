...
#include "blackjack_tsp_gc02m1b_mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "tsp_gc02m1b_camera_sensor"
#define LOG_1 LOG_INF("TSP GC02M1B, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	if (*sensor_id != BLACKJACK_TSP_GC02M1B_SENSOR_ID) {
...
UINT32 BLACKJACK_TSP_GC02M1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
