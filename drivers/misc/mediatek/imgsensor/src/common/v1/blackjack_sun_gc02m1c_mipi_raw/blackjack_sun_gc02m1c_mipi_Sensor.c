...
#include "blackjack_sun_gc02m1c_mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "sun_gc02m1c_camera_sensor"
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(0x0D == imgsensor_info.module_id)
				{
					*sensor_id = BLACKJACK_SUN_GC02M1C_SENSOR_ID;
					memset(backaux_cam_name, 0x00, sizeof(backaux_cam_name));
					memcpy(backaux_cam_name, "2_blackjack_sun_gc02m1c", 64);
...
UINT32 BLACKJACK_SUN_GC02M1C_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
