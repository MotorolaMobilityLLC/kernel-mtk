...
#include "maltalite_sea_gc02m1_mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "maltalite_sea_gc02m1_mipi_Sensor.c"
#define LOG_1 LOG_INF("SEASUNS GC02M1, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/

#define LOG_INF(format, args...)            pr_debug(PFX "[%s](%d) " format"\n", __func__,__LINE__, ##args)
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MALTALITE_SEA_GC02M1_SENSOR_ID,
...
UINT32 MALTALITE_SEA_GC02M1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
