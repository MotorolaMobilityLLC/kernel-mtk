 ...
 * Filename:
 * ---------
 *     mot_gnevan_s5kjn1_rear_txd_mipiraw_sensor.h
 *
 * Project:
 * --------
 *     ALPS
 ...
 *
 ****************************************************************************/
#ifndef MOT_GNEVAN_S5KJN1_REAR_TXD_MIPI_SENSOR_H
#define MOT_GNEVAN_S5KJN1_REAR_TXD_MIPI_SENSOR_H
...
extern bool S5KJN1_read_eeprom(kal_uint16 addr,	BYTE *data, kal_uint32 size);
