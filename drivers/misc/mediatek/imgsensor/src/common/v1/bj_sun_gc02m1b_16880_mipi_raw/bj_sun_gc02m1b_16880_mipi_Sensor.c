...
#include "bj_sun_gc02m1b_16880_mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "sun_gc02m1b_16880_camera_sensor"
#define LOG_1 LOG_INF("SUN GC02M1B FOR TSP16880, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			LOG_INF("gc02m1b_tsp16880 sensorid = 0x%x\n", *sensor_id);
			if (*sensor_id == imgsensor_info.sensor_id) {
				imgsensor_info.module_id = sun_gc02m1b_read_otp(MODULE_ID_OFFSET);
				if((0x0C == imgsensor_info.module_id) && ((strncmp(back_cam_name, "0_ov16880_TSP",strlen("0_ov16880_TSP"))) == 0))
				{
                                        *sensor_id = BJ_SUN_GC02M1B_16880_SENSOR_ID;
					memset(backaux_cam_name, 0x00, sizeof(backaux_cam_name));
					memcpy(backaux_cam_name, "2_bj_sun_gc02m1b_16880", 64);
					LOG_INF("2_bj_sun_gc02m1b_16880 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
					return ERROR_NONE;
				}
			}
	...
	if ((*sensor_id != imgsensor_info.sensor_id) || (0x0C != imgsensor_info.module_id) || (strncmp(back_cam_name, "0_ov16880_TSP",strlen("0_ov16880_TSP")))) {
...
UINT32 BJ_SUN_GC02M1B_16880_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
