...
#include "ellis_lce_sc500csmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_ELLIS_SC500CS_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
 { 2592, 1944,	  0,	0, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944,    0,	0
, 2592, 1944}, // Preview 
 { 2592, 1944,	  0,	0, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944,    0,	0
, 2592, 1944}, // capture 
 { 2592, 1944,	  0,	0, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944,    0,	0
, 2592, 1944}, // video
 { 2592, 1944,	  0,	0, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944,    0,	0
, 2592, 1944}, //hight speed video 
 { 2592, 1944,	  0,	0, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944,    0,	0
, 2592, 1944},};// slim video

#if MULTI_WRITE
#define I2C_BUFFER_LEN 765

static kal_uint16 ellis_lce_sc500cs_table_write_cmos_sensor(
...
, reg_gain,ana_real_gain,read_cmos_sensor(0x3e06),read_cmos_sensor(0x3e07));
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ellis_lce_sc500cs[] = {
	0x0103,0x01,
	0x0100,0x00,
	0x36e9,0x80,
	0x36f9,0x80,
...
{
#if MULTI_WRITE
	ellis_lce_sc500cs_table_write_cmos_sensor(
		addr_data_pair_init_ellis_lce_sc500cs,
		sizeof(addr_data_pair_init_ellis_lce_sc500cs) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ellis_lce_sc500cs[] = {
0x0100,0x00,
0x0100,0x01,
0x302d,0x00
};
...
#if MULTI_WRITE
	ellis_lce_sc500cs_table_write_cmos_sensor(
		addr_data_pair_preview_ellis_lce_sc500cs,
		sizeof(addr_data_pair_preview_ellis_lce_sc500cs) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor8(0x0100,0x00);
	mdelay(10);                    
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_ellis_lce_sc500cs[] = {
0x0100,0x00,
0x0100,0x01,
0x302d,0x00
};

kal_uint16 addr_data_pair_capture_30fps_ellis_lce_sc500cs[] = {
0x0100,0x00,
0x0100,0x01,
0x302d,0x00
};
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	ellis_lce_sc500cs_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_ellis_lce_sc500cs,
		sizeof(addr_data_pair_capture_30fps_ellis_lce_sc500cs) /
		sizeof(kal_uint16));
	} else {
	ellis_lce_sc500cs_table_write_cmos_sensor(
		addr_data_pair_capture_fps_ellis_lce_sc500cs,
		sizeof(addr_data_pair_capture_fps_ellis_lce_sc500cs) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 300) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ellis_lce_sc500cs[] = {
0x0100,0x00,
0x0100,0x01,
0x302d,0x00
};
...
#if MULTI_WRITE
	ellis_lce_sc500cs_table_write_cmos_sensor(
		addr_data_pair_hs_video_ellis_lce_sc500cs,
		sizeof(addr_data_pair_hs_video_ellis_lce_sc500cs) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor8(0x0100,0x00);
	mdelay(10);                    
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ellis_lce_sc500cs[] = {
0x0100,0x00,
0x0100,0x01,
0x302d,0x00
};
...
#if MULTI_WRITE
	ellis_lce_sc500cs_table_write_cmos_sensor(
		addr_data_pair_slim_video_ellis_lce_sc500cs,
		sizeof(addr_data_pair_slim_video_ellis_lce_sc500cs) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor8(0x0100,0x00);
	mdelay(10);                    
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		pr_err("ellis_lce_sc500cs Read id fail,sensor id: 0x%x\n", *sensor_id);
...
UINT32 MOT_ELLIS_SC500CS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **
pfFunc)
{
