...
#include "s5k4h7yx03mipiraw_Sensor.h"
#include "s5k4h7yx03otp.h"


/******************Modify Following Strings for Debug*******************/
#define PFX "S5K4H7YX03OTP"
#define LOG_1 SENSORDB("S5K4H7YX03,MIPI CAM\n")
...
bool S5K4H7YX03_update_awb(unsigned char page)
{
	kal_uint32 r_ratio;
	kal_uint32 b_ratio;
 ...
 ***************************************************************************/
bool S5K4H7YX03_otp_update(void)
{
	bool flag = 0;
	...
	flag = S5K4H7YX03_update_awb(page);
	return flag;
}

unsigned char s5k4h7yx03_get_module_id(void)
{
	...
	LOG_INF("S5K4H7YX03 module id = 0x%x\n", module_id);
	return module_id;
}
