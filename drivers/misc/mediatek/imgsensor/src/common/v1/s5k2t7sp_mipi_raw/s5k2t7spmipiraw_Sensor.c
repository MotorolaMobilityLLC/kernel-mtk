...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{ 5200, 3896,    8,    8, 5184, 3880, 2592, 1940,
		0,    0, 2592, 1940,    0,    0, 2592, 1940},

	{ 5200, 3896,    8,    8, 5184, 3880, 5184, 3880,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x6F12, 0xE3B8);
	...
	write_cmos_sensor(0x6F12, 0x00F0);
	write_cmos_sensor(0x6F12, 0x15F9);
	write_cmos_sensor(0x6F12, 0x00F0);
	write_cmos_sensor(0x6F12, 0x18F9);
	write_cmos_sensor(0x6F12, 0x7A4E);
	write_cmos_sensor(0x6F12, 0x0022);
	write_cmos_sensor(0x6F12, 0x7A49);
	write_cmos_sensor(0x6F12, 0x0C36);
	...
	write_cmos_sensor(0x6F12, 0x00F0);
	write_cmos_sensor(0x6F12, 0xFAF8);
	write_cmos_sensor(0x6F12, 0x0022);
	write_cmos_sensor(0x6F12, 0xBDE8);
	...
	write_cmos_sensor(0x6F12, 0x00F0);
	write_cmos_sensor(0x6F12, 0xE8B8);
	write_cmos_sensor(0x6F12, 0x10B5);
	write_cmos_sensor(0x6F12, 0x0446);
	write_cmos_sensor(0x6F12, 0x00F0);
	write_cmos_sensor(0x6F12, 0xF3F8);
	write_cmos_sensor(0x6F12, 0x6349);
	...
	write_cmos_sensor(0x6F12, 0x5C49);
	...
	write_cmos_sensor(0x6F12, 0x00F0);
	write_cmos_sensor(0x6F12, 0xD3B8);
	...
	write_cmos_sensor(0x6F12, 0x0122);
	write_cmos_sensor(0x6F12, 0x00F0);
	write_cmos_sensor(0x6F12, 0x8DB8);
	write_cmos_sensor(0x6F12, 0x70B5);
	write_cmos_sensor(0x6F12, 0x00F0);
	...
	write_cmos_sensor(0x6F12, 0x3A4D);
	...
	write_cmos_sensor(0x6F12, 0x364C);
	write_cmos_sensor(0x6F12, 0x334E);
	...
	write_cmos_sensor(0x6F12, 0x00F0);
	write_cmos_sensor(0x6F12, 0x81B8);
	write_cmos_sensor(0x6F12, 0x10B5);
	write_cmos_sensor(0x6F12, 0x0022);
	write_cmos_sensor(0x6F12, 0xAFF2);
	write_cmos_sensor(0x6F12, 0xBB11);
	write_cmos_sensor(0x6F12, 0x1B48);
	write_cmos_sensor(0x6F12, 0x00F0);
	write_cmos_sensor(0x6F12, 0x7FF8);
	write_cmos_sensor(0x6F12, 0x0F4C);
	write_cmos_sensor(0x6F12, 0xAFF2);
	write_cmos_sensor(0x6F12, 0x5711);
	...
	write_cmos_sensor(0x6F12, 0xAFF2);
	write_cmos_sensor(0x6F12, 0xF301);
	write_cmos_sensor(0x6F12, 0x1448);
	write_cmos_sensor(0x6F12, 0x00F0);
	write_cmos_sensor(0x6F12, 0x6EF8);
	write_cmos_sensor(0x6F12, 0x0022);
	write_cmos_sensor(0x6F12, 0xAFF2);
	...
	write_cmos_sensor(0x6F12, 0x00F0);
	write_cmos_sensor(0x6F12, 0x67F8);
	...
	write_cmos_sensor(0x602A, 0x0C48);
	...
	write_cmos_sensor(0x602A, 0x0E30);
	write_cmos_sensor(0x6F12, 0x0012);
	...
	write_cmos_sensor(0x602A, 0x42EC);
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x0340, 0x09F0);
	write_cmos_sensor(0x0342, 0x2330);
 ...
 */
	...
	write_cmos_sensor(0x0340, 0x0FA8);
	write_cmos_sensor(0x0342, 0x1608);
	write_cmos_sensor(0x602A, 0x1C78);
 ...
 *     }
 *	//stream on
 *	write_cmos_sensor(0x0600, 0x0002);//test pattern
 *	write_cmos_sensor_8(0x0100, 0x01);
 */
...
static void slim_video_setting(void)
{
	...
	/// No setfile ready yet	// streaming ON
	write_cmos_sensor_8(0x0100, 0x01);
