...
#define LOG_INF(format, args...)    printk("ov16a10mipiraw_Sensor [%s] " format, __func__, ##args)
...
//	write_cmos_sensor(0x4819, 0x90);
	write_cmos_sensor(0x481b, 0x3c); //0x50);
//	write_cmos_sensor(0x4826, 0x50);
//	write_cmos_sensor(0x4827, 0x52);
