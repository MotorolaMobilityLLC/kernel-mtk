 ...
 *
 *****************************************************************************/
#ifndef _S5K3P9SXMIPI_SENSOR_H
#define _S5K3P9SXMIPI_SENSOR_H
...
struct imgsensor_struct {
	...
	/* record test pattern mode or not */
...
extern bool s5k3p9_read_otp_pdaf_data(
	kal_uint16 addr, BYTE *data, kal_uint32 size);
