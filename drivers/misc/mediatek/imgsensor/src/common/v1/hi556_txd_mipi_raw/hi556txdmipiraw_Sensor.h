...
struct hi556_eeprom_t {
	kal_uint8 module_inf_flg[1];
	kal_uint8 module_inf_id[27];
	kal_uint8 module_serial_number[16];
	kal_uint8 module_fuse_id[11];
	kal_uint8 module_checksum[1];

	kal_uint8 awb_flg[1];
	kal_uint8 awb_data[16];
	kal_uint8 awb_checksum[1];

	kal_uint8 lsc_flg[1];
	kal_uint8 lsc_data[1868];
	kal_uint8 lsc_checksum[1];
} hi556_eeprom_t;
