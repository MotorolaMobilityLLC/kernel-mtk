...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = MOT_ELLIS_OV02B1B_SENSOR_ID,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    if (*sensor_id != imgsensor_info.sensor_id) {
        LOG_ERR("sunwin ov02b1b Read id fail,sensor id: 0x%x\n", *sensor_id);
...
static kal_uint32 open(void)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            sensor_id = return_sensor_id();
            if (sensor_id == imgsensor_info.sensor_id) {
                LOG_INF("sunwin ov02b1b i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, sensor_id);
                break;
            }
...
UINT32 MOT_ELLIS_OV02B1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
