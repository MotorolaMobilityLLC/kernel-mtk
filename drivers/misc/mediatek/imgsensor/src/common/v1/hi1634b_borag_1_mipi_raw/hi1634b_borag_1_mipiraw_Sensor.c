...
#include "hi1634b_borag_1_mipiraw_Sensor.h"

#define PFX "hi1634b_borag_1_camera_sensor"
...
#if USE_BURST_MODE
static kal_uint16 HI1634B_BORAG_1_table_write_cmos_sensor(
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.cap = {
		.pclk = 640000000,         //80M *8
		.linelength = 5680,         //710 * 8
		.framelength = 3754,
		.startx = 0,
		.starty = 0,
	...
	.custom1 = {
		.pclk = 800000000,
		.linelength = 17528,    //2191*8
		.framelength = 1824,
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 3000,
		.grabwindow_height = 1688,
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 250,
		.mipi_pixel_rate = 182400000//846*4/10
    },
	.custom2 = {
		.pclk = 800000000,
		.linelength = 17528,    //2191*8
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{ 4672, 3520, 0,   6, 4672, 3508, 4672, 3508,   836, 910, 3000, 1688, 0, 0, 3000, 1688}, //custom1
	{ 4672, 3520, 0,   6, 4672, 3508, 4672, 3508,   1136, 1078, 2400, 1352, 0, 0, 2400, 1352},//custom2
};
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[3] = {	/* Preview mode setting */
	...
	0x01, 0x2b, 0x0168, 0x0360, 0x03, 0x00, 0x0000, 0x0000},
	{0x02, 0x0a, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x2b, 0x0000, 0x0000, 0x01, 0x00, 0x0000, 0x0000,
	0x01, 0x2b, 0x0168, 0x0360, 0x03, 0x00, 0x0000, 0x0000},
	{0x02, 0x0a, 0x00, 0x00, 0x00, 0x00,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
	...
	.i4SubBlkW = 16,
	.i4SubBlkH = 8,
	.i4PosL = {{28, 25}, {44, 25}, {36, 37}, {52, 37},
		{28, 41}, {44, 41}, {36, 53}, {52, 53} },
	.i4PosR = {{28, 29}, {44, 29}, {36, 33}, {52, 33},
...
static kal_uint16 read_cmos_sensor_otp(kal_uint16 i2c_addr, kal_uint16 reg_addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(reg_addr >> 8), (char)(reg_addr & 0xFF) };
...
static kal_uint16 HI1634B_BORAG_1_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
// HI1634B_BORAG_1_2.0.8.9_gain_cal_1696Mbps_20220419
static kal_uint16 HI1634B_BORAG_1_init_setting[] = {
	0x0790, 0x0100,
	0x2000, 0x1001,
	0x2002, 0x0000,
	0x2006, 0x40B2,
...
static kal_uint16 HI1634B_BORAG_1_capture_setting[] = {
	0x0B00, 0x0000,
	0x0204, 0x0000,
	0x0206, 0x02C6,
	0x020A, 0x0EA6,
...
static kal_uint16 HI1634B_BORAG_1_preview_setting[] = {
	0x0B00, 0x0000,
	0x0204, 0x0000,
	0x0206, 0x02C6,
	0x020A, 0x0EA6,
...
static kal_uint16 HI1634B_BORAG_1_normal_video_setting[] = {
	0x0B00, 0x0000,
	0x0204, 0x0000,
	0x0206, 0x02C6,
	0x020A, 0x0EA6,
...
static kal_uint16 HI1634B_BORAG_1_hs_video_setting[] = {
	0x0B00, 0x0000,
	0x0204, 0x0001,
	0x0206, 0x02D5,
	0x020A, 0x0479,
...
static kal_uint16 HI1634B_BORAG_1_slim_video_setting[] = {
	0x0B00, 0x0000,
	0x0204, 0x0001,
	0x0206, 0x02D5,
	0x020A, 0x0479,
...
static kal_uint16 HI1634B_BORAG_1_custom1_setting[] = {
	0x0B00, 0x0000,
	0x0204, 0x0001,
	0x0206, 0x088F,
	0x020A, 0x071C,	
...
static kal_uint16 HI1634B_BORAG_1_custom2_setting[] = {
	0x0B00, 0x0000,
	0x0204, 0x0001,
	0x0206, 0x088F,
	0x020A, 0x05EC,
...
static void sensor_init(void)
{
	...
	HI1634B_BORAG_1_table_write_cmos_sensor(HI1634B_BORAG_1_init_setting,
		sizeof(HI1634B_BORAG_1_init_setting)/sizeof(kal_uint16));
...
static void preview_setting(void)
{
	...
	HI1634B_BORAG_1_table_write_cmos_sensor(HI1634B_BORAG_1_preview_setting,
		sizeof(HI1634B_BORAG_1_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
	...
	/*************MIPI output setting************/
	HI1634B_BORAG_1_table_write_cmos_sensor(HI1634B_BORAG_1_capture_setting,
		sizeof(HI1634B_BORAG_1_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	HI1634B_BORAG_1_table_write_cmos_sensor(HI1634B_BORAG_1_normal_video_setting,
		sizeof(HI1634B_BORAG_1_normal_video_setting)/sizeof(kal_uint16));
...
static void hs_video_setting(void)
{
	...
	HI1634B_BORAG_1_table_write_cmos_sensor(HI1634B_BORAG_1_hs_video_setting,
		sizeof(HI1634B_BORAG_1_hs_video_setting)/sizeof(kal_uint16));
...
static void slim_video_setting(void)
{
	...
	HI1634B_BORAG_1_table_write_cmos_sensor(HI1634B_BORAG_1_slim_video_setting,
		sizeof(HI1634B_BORAG_1_slim_video_setting)/sizeof(kal_uint16));
...
{
	LOG_INF("Hi-1634Q custom1_setting start\n");

	HI1634B_BORAG_1_table_write_cmos_sensor(HI1634B_BORAG_1_custom1_setting,
		sizeof(HI1634B_BORAG_1_custom1_setting)/sizeof(kal_uint16));

	LOG_INF("Hi-1634Q custom1_setting end\n");
}

static void custom2_setting(void)
{
	LOG_INF("Hi-1634Q custom2_setting start\n");

	HI1634B_BORAG_1_table_write_cmos_sensor(HI1634B_BORAG_1_custom2_setting,
		sizeof(HI1634B_BORAG_1_custom2_setting)/sizeof(kal_uint16));

	LOG_INF("Hi-1634Q custom2_setting end\n");
}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			printk("Read sensor id fail,i2c write id: 0x%x, read sensor id :0x%x, Qteck module id 0x5154 != 0x%x\n", imgsensor.i2c_write_id, return_sensor_id(), module_id);
			retry--;
		} while (retry > 0);
		i++;
		retry = 2;
...
UINT32 HI1634B_BORAG_1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* HI1634B_BORAG_1_MIPI_RAW_SensorInit */
