...
#include "blackjack_jsl_gc2375hmipi_Sensor.h"

/**************** Modify Following Strings for Debug ******************/
#define PFX "blackjack_jsl_gc2375h_camera_sensor"
#define LOG_1 cam_pr_debug("BLACKJACK_JSL_GC2375H, MIPI 1LANE\n")
/********************   Modify end    *********************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = BLACKJACK_JSL_GC2375H_SENSOR_ID,
        .module_id = 0x0A,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17, BLACKJACK_JSL_GC2375H_MIRROR);
	...
	write_cmos_sensor(0x4e, BLACKJACK_JSL_GC2375H_BLK_Select1_H);
	write_cmos_sensor(0x4f, BLACKJACK_JSL_GC2375H_BLK_Select1_L);
	write_cmos_sensor(0x66, BLACKJACK_JSL_GC2375H_BLK_Select2_H);
	write_cmos_sensor(0x67, BLACKJACK_JSL_GC2375H_BLK_Select2_L);
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if ((*sensor_id == imgsensor_info.sensor_id) && imgsensor_info.module_id == eeprom_module_id) {
					...
					memcpy(backaux2_cam_name, "3_blackjack_jsl_gc2375h", 64);
...
UINT32 BLACKJACK_JSL_GC2375H_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
