...
/*
#define shutter1_30 3783
#define shutter1_15 7566
#define shutter1_8 14329
#define shutter1_4 28659
#define shutter1_2 57319
*/
/*
#define shutter1 114639
#define shutter2 229278
#define shutter3 343918	
#define shutter4 458557
#define shutter6 687836
#define shutter8 917115
#define shutter10 1146394
#define shutter12 1375673
*/
#define shutter1 107944
#define shutter2 215889
#define shutter3 323834	
#define shutter4 431778
#define shutter6 647668
#define shutter8 863557
#define shutter10 1079447
#define shutter12 1295336

static DEFINE_SPINLOCK(imgsensor_drv_lock);

//extern bool read_ov16880_eeprom( kal_uint16 addr, BYTE* data, kal_uint32 size);
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.cap = { /* 95:line 5312, 52/35:line 5336 */
		...
		/*	 following for MIPIDataLowPwr2HighSpeedSettleDelayCount by different scenario	*/
		.mipi_data_lp2hs_settle_dc = 180,//unit , ns
		/*	 following for GetDefaultFramerateByScenario()	*/
		.max_framerate = 300,
	},
...
//Gionee <liu_hao> <20160602> modifed for GNSPR #14162 begin
...
{{ 4704, 3536,	   0,     8, 4704, 3520, 2352, 1760,  8, 4, 2336, 1752,	  0,	0, 2336, 1752}, // Preview 
 ...
 { 4704, 3536,	   0,     8, 4704, 3520, 2352, 1760,  8, 4, 2336, 1752,	  0,	0, 2336, 1752}, // video 
...
static void write_shutter(kal_uint32 shutter)
{
 ...
 // Gionee wanguocheng added for fixing rolling-flicker at 20160530 ---Begin
#if ORIGINAL_VERSION
#else
 // Gionee wanguocheng added for fixing rolling-flicker at 20160530 ---End
    ...
    if (imgsensor.frame_length > imgsensor_info.max_frame_length)
        imgsensor.frame_length = imgsensor_info.max_frame_length;
    spin_unlock(&imgsensor_drv_lock);
	LOG_INF("Enter! shenweikun shutter =%d, framelength =%d\n", shutter,imgsensor.frame_length);
...
/*
		 case shutter1_30:				
			...
			break;
		 case shutter1_15:
			 LOG_INF("pangfei -------shutter1_15 \n ");
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x0303,0x01);
			write_cmos_sensor_8(0x030a,0x00);
			write_cmos_sensor_8(0x030d,0x18);
			...
			write_cmos_sensor_8(0x3502,0x74);
			write_cmos_sensor_8(0x4837,0x16);
			write_cmos_sensor_8(0x3208,0x10);
			write_cmos_sensor_8(0x3208,0xa0);
			break;			
		 case shutter1_8:
			 LOG_INF("pangfei-------shutter1_8 \n ");
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x0303,0x01);
			write_cmos_sensor_8(0x030a,0x00);
			write_cmos_sensor_8(0x030d,0x18);
			...
			write_cmos_sensor_8(0x380e,0x0e);
			write_cmos_sensor_8(0x380f,0xf0);
			write_cmos_sensor_8(0x3501,0x0d);
			write_cmos_sensor_8(0x3502,0xfd);
			write_cmos_sensor_8(0x4837,0x16);
			write_cmos_sensor_8(0x3208,0x10);
			write_cmos_sensor_8(0x3208,0xa0);
			break;
		 case shutter1_4:				
			LOG_INF("pangfei -------shutter1_4 \n ");
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x0303,0x01);
			write_cmos_sensor_8(0x030a,0x00);
			write_cmos_sensor_8(0x030d,0x18);
			...
			write_cmos_sensor_8(0x380c,0x13);
			write_cmos_sensor_8(0x380d,0xa0);
			write_cmos_sensor_8(0x380e,0x1c);
			write_cmos_sensor_8(0x380f,0x08);
			write_cmos_sensor_8(0x3501,0x1c);
		 ...
		 case shutter1_2:				
			...
			write_cmos_sensor_8(0x380c,0x13);
			write_cmos_sensor_8(0x380d,0xa0);
			write_cmos_sensor_8(0x380e,0x38);
			write_cmos_sensor_8(0x380f,0x06);
			write_cmos_sensor_8(0x3501,0x37);
			write_cmos_sensor_8(0x3502,0xfe);
			write_cmos_sensor_8(0x4837,0x16);
			write_cmos_sensor_8(0x3208,0x10);
			write_cmos_sensor_8(0x3208,0xa0);
			break;
*/
		 case shutter1: 			
			LOG_INF("pangfei-------shutter1 \n ");	
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x030e,0x02);
			write_cmos_sensor_8(0x030f,0x0f);
			write_cmos_sensor_8(0x380c,0x14);
			write_cmos_sensor_8(0x380d,0xe8);
			write_cmos_sensor_8(0x380e,0x70);
			write_cmos_sensor_8(0x380f,0x00);
			write_cmos_sensor_8(0x3501,0x6f);
			write_cmos_sensor_8(0x3502,0xf8);
			write_cmos_sensor_8(0x3208,0x10);
			write_cmos_sensor_8(0x3208,0xa0);
			break;
		 case shutter2: 			
			LOG_INF("pangfei-------shutter2 \n ");
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x030e,0x02);
			write_cmos_sensor_8(0x030f,0x0f);
			write_cmos_sensor_8(0x380c,0x22);
			write_cmos_sensor_8(0x380d,0x5a);
			write_cmos_sensor_8(0x380e,0x7f);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3501,0x7f);
			write_cmos_sensor_8(0x3502,0xf7);
			write_cmos_sensor_8(0x3208,0x10);
			write_cmos_sensor_8(0x3208,0xa0);
			break;
		 case shutter3: 
			LOG_INF("pangfei-------shutter3 \n ");
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x030e,0x02);
			write_cmos_sensor_8(0x030f,0x0f);
			write_cmos_sensor_8(0x380c,0x33);
			write_cmos_sensor_8(0x380d,0x88);
			write_cmos_sensor_8(0x380e,0x7f);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3501,0x7f);
			write_cmos_sensor_8(0x3502,0xf7);
			...
			break;
		 case shutter4: 
			LOG_INF("pangfei-------shutter4 \n ");
		    write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x030e,0x02);
			write_cmos_sensor_8(0x030f,0x0f);
			write_cmos_sensor_8(0x380c,0x44);
			write_cmos_sensor_8(0x380d,0xb0);
			write_cmos_sensor_8(0x380e,0x7f);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3501,0x7f);
			write_cmos_sensor_8(0x3502,0xf7);
			...
			break;	
		 case shutter6: 
			LOG_INF("pangfei-------shutter6 \n ");
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x030e,0x02);
			write_cmos_sensor_8(0x030f,0x0f);
			write_cmos_sensor_8(0x380c,0x67);
			write_cmos_sensor_8(0x380d,0x08);
			write_cmos_sensor_8(0x380e,0x7f);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3501,0x7f);
			write_cmos_sensor_8(0x3502,0xf7);
			...
			break;
		 case shutter8: 
			LOG_INF("pangfei-------shutter8 \n ");
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x030e,0x02);
			write_cmos_sensor_8(0x030f,0x0f);
			write_cmos_sensor_8(0x380c,0x89);
			write_cmos_sensor_8(0x380d,0x60);
			write_cmos_sensor_8(0x380e,0x7f);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3501,0x7f);
			write_cmos_sensor_8(0x3502,0xf7);
			...
			break;
		case shutter10: 
		   LOG_INF("pangfei-------shutter10 \n ");
		   write_cmos_sensor_8(0x3208,0x00);
		   write_cmos_sensor_8(0x030e,0x02);
		   write_cmos_sensor_8(0x030f,0x0f);
		   write_cmos_sensor_8(0x380c,0xab);
		   write_cmos_sensor_8(0x380d,0xb8);
		   write_cmos_sensor_8(0x380e,0x7f);
		   write_cmos_sensor_8(0x380f,0xff);
		   write_cmos_sensor_8(0x3501,0x7f);
		   write_cmos_sensor_8(0x3502,0xf7);
		 ...
		 case shutter12:
			LOG_INF("pangfei-------shutter12 \n ");
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x030e,0x02);
			write_cmos_sensor_8(0x030f,0x0f);
			write_cmos_sensor_8(0x380c,0xce);
			write_cmos_sensor_8(0x380d,0x10);
			write_cmos_sensor_8(0x380e,0x7f);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3501,0x7f);
			write_cmos_sensor_8(0x3502,0xf7);
		 ...
		 default:
			...
			LOG_INF("shenweikun-------shutter default \n ");
...
static void sensor_init(void)
{
	...
	write_cmos_sensor_8(0x481b, 0x50);		//mipi_hs_trail_80ns
...
{ 
	...
	write_cmos_sensor_8(0x380f, 0x78);
	write_cmos_sensor_8(0x3810, 0x00);
