...
#include "melta_sun_gc5035mipi_Sensor.h"
#include <linux/slab.h>

/**************** Modify Following Strings for Debug ******************/
#define PFX "melta_sun_gc5035_camera_sensor"
/********************   Modify end    *********************************/
...
UINT32 MELTA_SUN_GC5035_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	cam_pr_debug("E\n");
