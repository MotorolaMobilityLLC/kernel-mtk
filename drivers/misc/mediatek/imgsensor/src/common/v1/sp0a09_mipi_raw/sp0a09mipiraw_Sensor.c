...
static void set_mirror_flip(kal_uint8 image_mirror)
{
    ...
    /********************************************************
       *
       *   
       *   0x31[1] Sensor Vertical flip
       *
       *   
       *   0x31[0] Sensor Horizontal mirror
       *
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    kal_uint8 i = 0;
    kal_uint8 retry = 2;
    //sensor have two i2c address 0x42 0x6d & 0x21 0x20, we should detect the module used i2c address
