...
#define PFX "FIJI_JSL_OV2180_camera_sensor"
...
#include "fiji_jsl_ov2180mipiraw_Sensor.h"
#define LOG_INF(format, args...)    \
	printk(" fiji_jsl_ov2180mipiraw_Sensor [%s] " format, __func__, ##args)
...
/*according tofiji_jsl_ov2180 datasheet p53 image cropping*/
...
{{ 1616, 1216,	  0,  0, 1616, 1216, 1616, 1216, 8, 8, 1600, 1200,	  0,	0, 1600, 1200}, // Preview 
 ...
 { 1616, 1216,	  0,  0, 1616, 1216, 1616, 1216, 8, 8, 1600, 1200,	  0,	0, 1600, 1200},//custom1
 { 1616, 1216,	  0,  0, 1616, 1216, 1616, 1216, 8, 8, 1600, 1200,	  0,	0, 1600, 1200}, //custom2
};
...
static void set_dummy(void)
{
	...
	/*  Add dummy pixels: */
    /* 0x380c [0:4], 0x380d defines the PCLKs in one line of FIJI_JSL_OV2180  */  
    /* Add dummy lines:*/
    /* 0x380e [0:1], 0x380f defines total lines in one frame of FIJI_JSL_OV2180 */
		...
		do {
            *sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				memcpy(backaux_cam_name, "2_fiji_jsl_ov2180", 64);
...
UINT32 FIJI_JSL_OV2180_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
/*UINT32 FIJI_JSL_OV2180MIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)*/
