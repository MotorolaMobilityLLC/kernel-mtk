...
#include "melta_s5kgm1stmipiraw_Sensor.h"
#ifndef VENDOR_EDIT
...
#define PFX "melta_s5kgm1st_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = MELTA_S5KGM1ST_SENSOR_ID,
...
static void sensor_init(void)
{
	LOG_INF("E\n");
	write_cmos_sensor(0x6028, 0x4000);
	write_cmos_sensor(0x0000, 0x101E);
	...
	//Tnp ,sw
	//TnP SVN16396	
    write_cmos_sensor(0x6028, 0x2000);  //tnp sw
    ...
    write_cmos_sensor(0x6028, 0x2000);  //global
    ...
    write_cmos_sensor(0x6028, 0x2000);    //pd
			...
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001));
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(0xaa == module_id) //ofilm module
				{
					...
					LOG_INF("TSP i2c write id: 0x%x, sensor id: 0x%x\n", module_id, *sensor_id);
					return ERROR_NONE;
				}
				...
				else
				{
					...
					LOG_INF("0_s5kgm1st_nootp i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
					return ERROR_NONE;
				}			
...
UINT32 MElTA_S5KGM1ST_MIPI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	if (pfFunc!=NULL) {
		*pfFunc=&sensor_func;
	}
