...
#include "mot_tonga_s5k4h7mipiraw_Setting.h"
...
#if MULTI_WRITE
#define I2C_BUFFER_LEN 756	/* trans# max is 255, each 3 bytes */
#else
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_TONGA_S5K4H7_SENSOR_ID,	/*S5K4H7_SENSOR_ID = 0x487B */
...
static kal_uint32 return_sensor_id(void)
{
	...
	LOG_INF("[4h7]res0 = 0x%x,[4h7]res1 = 0x%x\n", res0,res1);
	return ((res0 << 8) |res1);
 ...
 *
 *************************************************************************/
static kal_uint16 mot_tonga_s5k4h7_table_write_cmos_sensor(
...
{
	mot_tonga_s5k4h7_table_write_cmos_sensor(addr_data_pair_init_mot_tonga_s5k4h7,
	   sizeof(addr_data_pair_init_mot_tonga_s5k4h7)/sizeof(kal_uint16));
}	/*	sensor_init  */
...
static void preview_setting(void)
{
	...
	mot_tonga_s5k4h7_table_write_cmos_sensor(addr_data_pair_preview_mot_tonga_s5k4h7,
	   sizeof(addr_data_pair_preview_mot_tonga_s5k4h7)/sizeof(kal_uint16));
}	/*	preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
		...
		/*Delay 1 frame*/
		mDELAY(67);
		mot_tonga_s5k4h7_table_write_cmos_sensor(
			addr_data_pair_capture_mot_tonga_s5k4h7_15fps,
	sizeof(addr_data_pair_capture_mot_tonga_s5k4h7_15fps)/sizeof(kal_uint16));
...
/*mipi_datarate:836,pvi_pclk_inverwrite_cmos_sensor*/
		...
		mDELAY(42);
		mot_tonga_s5k4h7_table_write_cmos_sensor(
			addr_data_pair_capture_mot_tonga_s5k4h7_24fps,
	sizeof(addr_data_pair_capture_mot_tonga_s5k4h7_24fps)/sizeof(kal_uint16));
	} else{
		/*Delay 1 frame*/
		mDELAY(33);
		mot_tonga_s5k4h7_table_write_cmos_sensor(
			addr_data_pair_capture_mot_tonga_s5k4h7,
	sizeof(addr_data_pair_capture_mot_tonga_s5k4h7)/sizeof(kal_uint16));
	}
}
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	/*Delay 1 frame*/
	mDELAY(33);
	mot_tonga_s5k4h7_table_write_cmos_sensor(addr_data_pair_capture_mot_tonga_s5k4h7,
		sizeof(addr_data_pair_capture_mot_tonga_s5k4h7)/sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	...
	/*Delay 1 frame*/
	mDELAY(83);
	mot_tonga_s5k4h7_table_write_cmos_sensor(addr_data_pair_hs_video_mot_tonga_s5k4h7,
		sizeof(addr_data_pair_hs_video_mot_tonga_s5k4h7)/sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	...
	/*Delay 1 frame*/
	mDELAY(33);
	mot_tonga_s5k4h7_table_write_cmos_sensor(addr_data_pair_slim_video_mot_tonga_s5k4h7,
		sizeof(addr_data_pair_slim_video_mot_tonga_s5k4h7)/sizeof(kal_uint16));
}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				mot_tonga_s5k4h7_otp_data();
				return ERROR_NONE;
			}
			LOG_ERR("Read id fail,i2c_write_id 0x%x id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
