...
#include "gc02m1_borag_1_mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "sun_gc02m1_borag_1_camera_sensor"
#define LOG_1 LOG_INF("SUN GC02M1_BORAG_1, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_BORAG_1_SENSOR_ID,
...
static kal_uint16 gc02m1_borag_1_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if (reg_gain < GC02M1_BORAG_1_SENSOR_GAIN_BASE)
		reg_gain = GC02M1_BORAG_1_SENSOR_GAIN_BASE;
	else if (reg_gain > GC02M1_BORAG_1_SENSOR_GAIN_MAX)
		reg_gain = GC02M1_BORAG_1_SENSOR_GAIN_MAX;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 GC02M1_BORAG_1_AGC_Param[GC02M1_BORAG_1_SENSOR_GAIN_MAX_VALID_INDEX][2] = {
		{  1024,  0 },
		{  1536,  1 },
		{  2035,  2 },
		{  2519,  3 },
	...
	for (gain_index = GC02M1_BORAG_1_SENSOR_GAIN_MAX_VALID_INDEX - 1; gain_index >= 0; gain_index--)
		if (reg_gain >= GC02M1_BORAG_1_AGC_Param[gain_index][0])
			break;

	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xb6, GC02M1_BORAG_1_AGC_Param[gain_index][1]);
	temp_gain = reg_gain * GC02M1_BORAG_1_SENSOR_DGAIN_BASE / GC02M1_BORAG_1_AGC_Param[gain_index][0];
	write_cmos_sensor(0xb1, (temp_gain >> 8) & 0x1f);
	write_cmos_sensor(0xb2, temp_gain & 0xff);
	LOG_INF("GC02M1_BORAG_1_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
		GC02M1_BORAG_1_AGC_Param[gain_index][1], temp_gain, reg_gain);
...
static kal_uint16 addr_data_pair_init_gc02m1_borag_1[] = {
...
static kal_uint16 addr_data_pair_preview_gc02m1_borag_1[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

static kal_uint16 addr_data_pair_capture_gc02m1_borag_1[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

static kal_uint16 addr_data_pair_normal_video_gc02m1_borag_1[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

static kal_uint16 addr_data_pair_hs_video_gc02m1_borag_1[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

static kal_uint16 addr_data_pair_slim_video_gc02m1_borag_1[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
...
static void sensor_init(void)
{
	...
	gc02m1_borag_1_table_write_cmos_sensor(
		addr_data_pair_init_gc02m1_borag_1,
		sizeof(addr_data_pair_init_gc02m1_borag_1) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1_borag_1_table_write_cmos_sensor(
		addr_data_pair_preview_gc02m1_borag_1,
		sizeof(addr_data_pair_preview_gc02m1_borag_1) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1_borag_1_table_write_cmos_sensor(
		addr_data_pair_capture_gc02m1_borag_1,
		sizeof(addr_data_pair_capture_gc02m1_borag_1) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_borag_1_table_write_cmos_sensor(
		addr_data_pair_normal_video_gc02m1_borag_1,
		sizeof(addr_data_pair_normal_video_gc02m1_borag_1) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_borag_1_table_write_cmos_sensor(
		addr_data_pair_hs_video_gc02m1_borag_1,
		sizeof(addr_data_pair_hs_video_gc02m1_borag_1) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_borag_1_table_write_cmos_sensor(
		addr_data_pair_slim_video_gc02m1_borag_1,
		sizeof(addr_data_pair_slim_video_gc02m1_borag_1) /
		sizeof(kal_uint16));
}
...
extern char backaux_cam_otp_status[64];
static kal_uint32 gc02m1_macro_cali_awb(unsigned char *buff) {
	...
	memset(backaux_cam_otp_status, 0x00, sizeof(backaux_cam_otp_status));
	if (ret == 0)
		memcpy(backaux_cam_otp_status, "1", 64);
	else
		memcpy(backaux_cam_otp_status, "0", 64);
	if (0 != ret) {
...
UINT32 GC02M1_BORAG_1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
