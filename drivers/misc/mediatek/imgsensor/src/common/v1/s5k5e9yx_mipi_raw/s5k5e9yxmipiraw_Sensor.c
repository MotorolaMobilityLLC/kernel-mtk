...
{
//Preview 1296*972 30fps 24M MCLK 2lane 876Mbps/lane
// preview 30.08fps
LOG_INF("E\n");
write_cmos_sensor_8(0x0100,	0x00);
...
{
//custom1 2592*1944 24fps 24M MCLK 2lane 876Mbps/lane
// custom1 24fps                                 
LOG_INF("E\n");
write_cmos_sensor_8(0x0100,	0x00);
write_cmos_sensor_8(0x0136, 0x18);
...
{
//custom2 1296*972 24fps 24M MCLK 2lane 876Mbps/lane
// custom2 24fps                                     
LOG_INF("E\n");
write_cmos_sensor_8(0x0100,	0x00);
write_cmos_sensor_8(0x0136, 0x18);
...
{
//capture 2592*1944 29.99fps 24M MCLK 2lane 876Mbps/lane
// capture 29.99fps                                    
...
{ 
//video 2592*1944 29.99fps 24M MCLK 2lane 876Mbps/lane	
// video 29.99fps                                     	
...
{
//video 2592*1460 30.08fps 24M MCLK 2lane 876Mbps/lane	
// video 30.08fps                                     		
LOG_INF("E\n");
write_cmos_sensor_8(0x0100,	0x00);
write_cmos_sensor_8(0x0136,	0x18);
...
static kal_uint32 open(void)
{
	...
	LOG_INF("tanyijun debug PLATFORM:MT6595,MIPI 2LANE\n");
	LOG_INF("tanyijun debug preview 1280*960@30fps,864Mbps/lane; video 1280*960@30fps,864Mbps/lane; capture 5M@30fps,864Mbps/lane\n");
