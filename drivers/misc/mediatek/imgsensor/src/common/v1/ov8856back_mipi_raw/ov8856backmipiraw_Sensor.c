...
#include "ov8856backmipiraw_Sensor.h"

#define PFX "ov8856backmipiraw_Sensor.c"
...
OV8856BACK_VERSION ov8856backversion = OV8856BACKR1A;
...
extern bool camera_back_probe_ok;//bit1
/*************************************************************************
* FUNCTION
*	get_imgsensor_id
*
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) 
    {
		...
		spin_unlock(&imgsensor_drv_lock);
		do {
			get_sensorid = ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C));
			if (get_sensorid == imgsensor_info.sensor_id) 
            {
...
UINT32 OV8856BACK_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	OV8856BACK_MIPI_RAW_SensorInit	*/
