...
static void set_dummy()
{
	 ...
	 cam_pr_debug("[BLACKJACK_SEA_MT9D015MIPI_SetDummy]Frame_length = %d, Line_length = %d", imgsensor.frame_length, imgsensor.line_length);
#if 1
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x301A,0x4110); // RESET_REGISTER			 
	...
	write_cmos_sensor(0x305E,0x102C); // GLOBAL_GAIN				 
	write_cmos_sensor(0x301A,0x4118); // RESET_REGISTER			 
	write_cmos_sensor_8(0x0104,0x00  ); // GROUPED_PARAMETER_HOLD	 
