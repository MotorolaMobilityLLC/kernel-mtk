 ...
 */
#define PFX "MOT_LYRIQ_HI1336_camera_sensor"
...
#include "mot_lyriq_hi1336_Setting.h"
#include "mot_lyriq_hi1336_otp.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_LYRIQ_HI1336_SENSOR_ID,
...
{
	return (((read_cmos_sensor(0x0716) << 8) | read_cmos_sensor(0x0717))+0x1);
...
/* The frame of setting sensor gain */
	...
	LYRIQ_HI1336_eeprom_get_mnf_data((void *) LYRIQ_HI1336_eeprom, &sensor_info->mnf_calibration);
#endif
	switch (scenario_id) {
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
       ...
       if (enable)
	{
		write_cmos_sensor(0x0b04, 0x037d);
...
UINT32 MOT_LYRIQ_HI1336_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	MOT_LYRIQ_HI1336_SensorInit	*/
