...
static void custom2_setting(void)
{
	LOG_INF("E\n");
	saipan_qtech_hi4821q_table_write_cmos_sensor(
		addr_data_pair_custom2_saipan_qtech_hi4821q,
		sizeof(addr_data_pair_custom2_saipan_qtech_hi4821q) /
		sizeof(kal_uint16));
}
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 10040000;//uint is ns
		break;
		...
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
			memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info,
				sizeof(struct SET_PD_BLOCK_INFO_T));
                        break;
		case MSDK_SCENARIO_ID_CUSTOM1:
			memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info_1920_1080,
				sizeof(struct SET_PD_BLOCK_INFO_T));
			break;
		default:
			break;
