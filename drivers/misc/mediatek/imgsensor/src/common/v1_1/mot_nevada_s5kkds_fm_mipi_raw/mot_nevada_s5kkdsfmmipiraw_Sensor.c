 ...
 * Filename:
 * ---------
 *	 mot_nevada_s5kkdsfmmipi_Sensor.c
 *
 * Project:
 * --------
 *	 MTK SOP
 ...
 *============================================================================
 ****************************************************************************/
#define PFX "MOT_NEVADA_S5KKDS_FM_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_NEVADA_S5KKDS_FM_SENSOR_ID,
...
kal_uint16 mot_nevada_s5kkdsfm_burst_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
#if MULTI_WRITE
kal_uint16 mot_nevada_s5kkdsfm_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
int s5kkdsfm_bNeedSetNormalMode = 0;
/*************************************************************************
 * FUNCTION
 *	set_shutter
 *
...
static void set_shutter(kal_uint32 shutter)
{
	...
	if (shutter > 0xFFF0) {
		...
		if (s5kkdsfm_bNeedSetNormalMode == KAL_TRUE) {
			s5kkdsfm_bNeedSetNormalMode = KAL_FALSE;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if (gain < S5KKDS_FM_BASEGAIN || gain > max_gain) {
		...
		if (gain < S5KKDS_FM_BASEGAIN)
			gain = S5KKDS_FM_BASEGAIN;
...
{
	pr_debug("MOT NEVADA S5KKDS_FM init start\n");
	...
	mot_nevada_s5kkdsfm_burst_write_cmos_sensor(addr_data_pair_init_mot_nevada_s5kkdsfm_part1,
		sizeof(addr_data_pair_init_mot_nevada_s5kkdsfm_part1)/sizeof(kal_uint16));
	mot_nevada_s5kkdsfm_burst_write_cmos_sensor(addr_data_pair_init_mot_nevada_s5kkdsfm_part2,
		sizeof(addr_data_pair_init_mot_nevada_s5kkdsfm_part2)/sizeof(kal_uint16));
	mot_nevada_s5kkdsfm_table_write_cmos_sensor(addr_data_pair_init_mot_nevada_s5kkdsfm_part3,
		sizeof(addr_data_pair_init_mot_nevada_s5kkdsfm_part3)/sizeof(kal_uint16));
	pr_debug("MOT NEVADA S5KKDS_FM init end\n");
/*	if (xtc_data_valid == 1)
		write_xtc_data();
	pr_debug("MOT NEVADA S5KKDS_FM init end\n");
*/
...
{
	pr_debug("MOT NEVADA S5KKDS_FM preview_setting start\n");

	mot_nevada_s5kkdsfm_table_write_cmos_sensor(addr_data_pair_preview_mot_nevada_s5kkdsfm,
		sizeof(addr_data_pair_preview_mot_nevada_s5kkdsfm)/sizeof(kal_uint16));

	pr_debug("MOT NEVADA S5KKDS_FM preview_setting end\n");
...
{
	pr_debug("MOT NEVADA S5KKDS_FM capture_setting start\n");
	mot_nevada_s5kkdsfm_table_write_cmos_sensor(addr_data_pair_preview_mot_nevada_s5kkdsfm,
		sizeof(addr_data_pair_preview_mot_nevada_s5kkdsfm)/sizeof(kal_uint16));

	pr_debug("MOT NEVADA S5KKDS_FM capture_setting end\n");
}

static void normal_video_setting(kal_uint16 currefps)
{
	pr_debug("MOT NEVADA S5KKDS_FM normal_video_setting start\n");

	mot_nevada_s5kkdsfm_table_write_cmos_sensor(addr_data_pair_normal_video_mot_nevada_s5kkdsfm,
		sizeof(addr_data_pair_normal_video_mot_nevada_s5kkdsfm)/sizeof(kal_uint16));

	pr_debug("MOT NEVADA S5KKDS_FM normal_video_setting end\n");
}

static void hs_video_setting(void)
{
	pr_debug("MOT NEVADA S5KKDS_FM hs_video_setting start\n");

	mot_nevada_s5kkdsfm_table_write_cmos_sensor(addr_data_pair_hs_video_mot_nevada_s5kkdsfm,
		sizeof(addr_data_pair_hs_video_mot_nevada_s5kkdsfm)/sizeof(kal_uint16));

	pr_debug("MOT NEVADA S5KKDS_FM hs_video_setting end\n");
}

static void slim_video_setting(void)
{
	pr_debug("MOT NEVADA S5KKDS_FM slim_video_setting start\n");

	mot_nevada_s5kkdsfm_table_write_cmos_sensor(addr_data_pair_preview_mot_nevada_s5kkdsfm,
		sizeof(addr_data_pair_preview_mot_nevada_s5kkdsfm)/sizeof(kal_uint16));

	pr_debug("MOT NEVADA S5KKDS_FM slim_video_setting end\n");
}
...
UINT32 MOT_NEVADA_S5KKDS_FM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	return ERROR_NONE;
} /* MOT_NEVADA_S5KKDS_FM_MIPI_RAW_SensorInit */
