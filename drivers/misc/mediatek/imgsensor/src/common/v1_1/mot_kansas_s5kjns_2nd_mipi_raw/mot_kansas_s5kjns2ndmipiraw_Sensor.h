 ...
 * Filename:
 * ---------
 *     mot_kansas_s5kjns2ndmipiraw_Sensor.h
 *
 * Project:
 * --------
 *     ALPS
 ...
 *
 ****************************************************************************/
#ifndef _MOT_KANSAS_S5KJNS_2ND_MIPI_RAW_SENSOR_H
#define _MOT_KANSAS_S5KJNS_2ND_MIPI_RAW_SENSOR_H
...
struct KANSAS_S5KJNS_2ND_MIPI_RAW_eeprom_t{
	//MNF_DATA
