...
#include "mot_vicky_ov02b10mipiraw_Sensor.h"

#undef IMGSENSOR_I2C_1000K
#include "imgsensor_i2c.h"
#define IMGSENSOR_MODULE_ID_SUNNY       0x01
#define PFX "MOT_VICKY_OV02B10_camera_sensor"
...
static  imgsensor_info_struct imgsensor_info = {
    ...
    .sensor_id = MOT_VICKY_OV02B10_SENSOR_ID,
...
UINT32 MOT_VICKY_OV02B10_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    ...
    return ERROR_NONE;
}    /*    MOT_VICKY_OV02B10_MIPI_RAW_SensorInit    */
