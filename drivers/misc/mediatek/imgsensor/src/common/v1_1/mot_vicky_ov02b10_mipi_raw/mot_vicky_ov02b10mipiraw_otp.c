...
static calibration_status_t VICKY_OV02B10_check_awb_data(void *data)
{
    ...
    if(((data_awb[0]&0xC0)>>6) == 0x01){ //Bit[7:6] 01:Valid 11:Invalid
        ...
        VICKY_OV02B10_OTP_CRC_AWB_GROUP1_CAL_SIZE,
        data_awb[7])) {
        ...
        VICKY_OV02B10_OTP_CRC_AWB_GROUP2_CAL_SIZE,
        data_awb[14])) {
            LOG_INF("AWB CRC Fails!");
            return CRC_FAILURE;
        }
...
void VICKY_OV02B10_eeprom_format_calibration_data(void *data, ov02b10_calibration_status_t *ov02b10_cal_info)
{
    if (NULL == data) {
    ...
    ov02b10_cal_info->awb_status            = VICKY_OV02B10_check_awb_data(data);
