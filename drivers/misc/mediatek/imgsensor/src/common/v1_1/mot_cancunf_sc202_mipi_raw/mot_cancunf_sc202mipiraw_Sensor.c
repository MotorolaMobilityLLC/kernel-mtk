...
#include "mot_cancunf_sc202mipiraw_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "sc202_mipi_raw"
...
static mot_calibration_info_t sc202cs_cal_info = {0};


static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_CANCUNF_SC202_SENSOR_ID,
...
static kal_uint16 mot_cancunf_sc202_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
/*
kal_uint16 mot_cancunf_sc202_init_setting_array[] = {
...
static void sensor_init(void)
{
	...
	mDELAY(10);
	mot_cancunf_sc202_table_write_cmos_sensor(mot_cancunf_sc202_init_setting_array,
		sizeof(mot_cancunf_sc202_init_setting_array)/sizeof(kal_uint16));
	*/
	write_cmos_sensor(0x0103,0x01);
	mDELAY(10);
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sensor_info->calibration_status.af    = sc202cs_cal_info.af_status;
	sensor_info->calibration_status.awb   = sc202cs_cal_info.awb_status;
	sensor_info->calibration_status.lsc   = sc202cs_cal_info.lsc_status;
	sensor_info->calibration_status.pdaf  = sc202cs_cal_info.pdaf_status;
	sensor_info->calibration_status.dual  = sc202cs_cal_info.dual_status;
...
UINT32 MOT_CANCUNF_SC202_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
