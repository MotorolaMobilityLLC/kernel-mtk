 ...
 */
#ifndef _HM1062_2_MIPI_SENSOR_H
#define _HM1062_2_MIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	/* preview 1 scenario relative information */
	struct imgsensor_mode_struct pre1;
	/* capture scenario relative information */
	struct imgsensor_mode_struct cap;
	/* capture 1 scenario relative information */
...
extern void hm1062_stream_on(kal_bool enable, kal_uint32 shutter, kal_uint16 gain);
extern void hm1062_cmu(void);
extern void hm1062_ae_cmu(kal_uint32 mode);
