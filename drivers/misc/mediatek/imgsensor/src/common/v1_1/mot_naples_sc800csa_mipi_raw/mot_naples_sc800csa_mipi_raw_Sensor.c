 ...
 * Filename:
 * ---------
 *	 mot_naples_sc800csa_mipi_raw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "mot_naples_sc800csa_sensor_setting.h"

#define MOT_NAPLES_SC800CSA_SENSOR_GAIN_MAX_VALID_INDEX  6
...
//             kal_uint32 sensorID);
char mot_naples_sc800csa_cameraSn[24] = {0};

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_NAPLES_SC800CSA_SENSOR_ID,
...
static kal_uint16 mot_naples_sc800csa_table_write_cmos_sensor(
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	for (gain_index = MOT_NAPLES_SC800CSA_SENSOR_GAIN_MAX_VALID_INDEX - 1; gain_index >= 0; gain_index--)
		if (reg_gain >= MOT_NAPLES_SC800CSA_AGC_Param[gain_index][0])
			break;

	write_cmos_sensor8(0x3e08, MOT_NAPLES_SC800CSA_AGC_Param[gain_index][1]);
	temp_gain = reg_gain * MOT_NAPLES_SC800CSA_SENSOR_BASE_GAIN / MOT_NAPLES_SC800CSA_AGC_Param[gain_index][0];
	write_cmos_sensor8(0x3e07, (temp_gain >> 3) & 0xff);
	pr_debug(PFX, "MOT_NAPLES_SC800CSA_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d, gain = %d\n",
		MOT_NAPLES_SC800CSA_AGC_Param[gain_index][1], temp_gain, reg_gain, gain);
...
{/* update20230213��wangruo */
	...
	mDELAY(10);
     ...
     mot_naples_sc800csa_table_write_cmos_sensor(
         addr_data_pair_init_mot_naples_sc800csa,
         sizeof(addr_data_pair_init_mot_naples_sc800csa) /
         sizeof(kal_uint16));
...
static void preview_setting(void)
{
     ...
     mot_naples_sc800csa_table_write_cmos_sensor(
         addr_data_pair_preview_mot_naples_sc800csa,
         sizeof(addr_data_pair_preview_mot_naples_sc800csa)/
         sizeof(kal_uint16));
}
...
{
     mot_naples_sc800csa_table_write_cmos_sensor(
         addr_data_pair_capture_fps_mot_naples_sc800csa,
         sizeof(addr_data_pair_capture_fps_mot_naples_sc800csa) /
         sizeof(kal_uint16));
}
...
{
     mot_naples_sc800csa_table_write_cmos_sensor(
         addr_data_pair_normal_video_mot_naples_sc800csa,
         sizeof(addr_data_pair_normal_video_mot_naples_sc800csa) /
         sizeof(kal_uint16));
}
...
{
     mot_naples_sc800csa_table_write_cmos_sensor(
         addr_data_pair_hs_video_mot_naples_sc800csa,
         sizeof(addr_data_pair_hs_video_mot_naples_sc800csa) /
         sizeof(kal_uint16));
}
...
{
     mot_naples_sc800csa_table_write_cmos_sensor(
         addr_data_pair_slim_video_mot_naples_sc800csa,
         sizeof(addr_data_pair_slim_video_mot_naples_sc800csa) /
         sizeof(kal_uint16));
}
...
static int front_cam_get_info(char *buf, void *arg0)
{
	...
	return sprintf(buf, "%s [%d*%d] %dM", "mot_naples_sc800csa_front_sw_|_mipi_raw", imgsensor_info.cap.grabwindow_width, imgsensor_info.cap.grabwindow_height, pi);
}
#endif
...
UINT32 MOT_NAPLES_SC800CSA_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	return ERROR_NONE;
};	/*	MOT_NAPLES_SC800CSA_MIPI_RAW_SensorInit	*/
