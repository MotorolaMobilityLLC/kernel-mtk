...
#include "mot_vicky_s5k4h7mipiraw_Sensor.h"
#include "mot_vicky_s5k4h7otp.h"


/******************Modify Following Strings for Debug*******************/
#define PFX "MOT_VICKY_S5K4H7OTP"
#define LOG_1 SENSORDB("MOT_VICKY_S5K4H7,MIPI CAM\n")
...
bool MOT_VICKY_S5K4H7_update_awb(unsigned char page)
{
	kal_uint32 r_ratio;
	kal_uint32 b_ratio;
...
bool MOT_VICKY_S5K4H7_otp_update(void)
{
	...
	flag = MOT_VICKY_S5K4H7_update_awb(page);
	return flag;
}
...
unsigned char mot_vicky_s5k4h7_get_module_id(void)
{
	...
	LOG_INF("MOT_VICKY_S5K4H7 module id = 0x%x\n", module_id);
	return module_id;
}
