...
#define PFX "mot_vicky_s5k4h7_camera_sensor"
...
#define DEVICE_VERSION_MOT_VICKY_S5K4H7    "mot_vicky_s5k4h7"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_VICKY_S5K4H7_SENSOR_ID,	/*MOT_VICKY_S5K4H7_SENSOR_ID = 0x487B */
...
static kal_uint16 mot_vicky_s5k4h7_init_setting[] = {
	0x0100, 0x00,
	0x0B05, 0x01,
	0x3074, 0x06,
	0x3075, 0x2F,
...
static kal_uint16 mot_vicky_s5k4h7_preview_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 mot_vicky_s5k4h7_cap_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 mot_vicky_s5k4h7_cap1_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 mot_vicky_s5k4h7_normal_video_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 mot_vicky_s5k4h7_hs_video_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 mot_vicky_s5k4h7_slim_video_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
{
	table_write_cmos_sensor(mot_vicky_s5k4h7_init_setting,
		sizeof(mot_vicky_s5k4h7_init_setting) / sizeof(kal_uint16));
}				/*  mot_vicky_s5k4h7MIPI_Sensor_Init  */


static void preview_setting(void)
{
	table_write_cmos_sensor(mot_vicky_s5k4h7_preview_setting,
		sizeof(mot_vicky_s5k4h7_preview_setting) / sizeof(kal_uint16));
}				/*  mot_vicky_s5k4h7MIPI_Capture_Setting  */

static void capture_setting(kal_uint16 currefps)
{
	if (currefps == 150) {
		table_write_cmos_sensor(mot_vicky_s5k4h7_cap1_setting,
			sizeof(mot_vicky_s5k4h7_cap1_setting) / sizeof(kal_uint16));
	} else {
		table_write_cmos_sensor(mot_vicky_s5k4h7_cap_setting,
			sizeof(mot_vicky_s5k4h7_cap_setting) / sizeof(kal_uint16));
	}
}
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(mot_vicky_s5k4h7_normal_video_setting,
		sizeof(mot_vicky_s5k4h7_normal_video_setting) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
	LOG_INF("EVGA 120fps");
	table_write_cmos_sensor(mot_vicky_s5k4h7_hs_video_setting,
		sizeof(mot_vicky_s5k4h7_hs_video_setting) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
	LOG_INF("E");
	table_write_cmos_sensor(mot_vicky_s5k4h7_slim_video_setting,
		sizeof(mot_vicky_s5k4h7_slim_video_setting) / sizeof(kal_uint16));
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	do {
		*sensor_id = read_cmos_sensor(0x0000);
			LOG_INF("mot_vicky_s5k4h7mipiraw_Sensor get_imgsensor_id *get_sensor_id = 0x%x ,id = %d,i2c_write_id = 0x%x\n", *sensor_id,imgsensor_info.sensor_id,imgsensor.i2c_write_id);
		if (*sensor_id == imgsensor_info.sensor_id) {
			 ...
			 */
			imgsensor_info.module_id = mot_vicky_s5k4h7_get_module_id();
			/*
			...
			if (deviceInfo_register_value == 0x00) {
				register_imgsensor_deviceinfo("Cam_f",
					DEVICE_VERSION_MOT_VICKY_S5K4H7,
...
#ifdef VENDOR_EDIT
	/*zhengjiang.zhu@Camera.Drv, 2017/10/18 add for otp */
	otp_flag = MOT_VICKY_S5K4H7_otp_update();
	if (otp_flag)
...
UINT32 MOT_VICKY_S5K4H7_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      mot_vicky_s5k4h7_MIPI_RAW_SensorInit      */
