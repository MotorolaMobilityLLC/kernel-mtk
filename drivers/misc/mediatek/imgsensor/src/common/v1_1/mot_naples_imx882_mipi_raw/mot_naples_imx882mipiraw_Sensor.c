 ...
 * Filename:
 * ---------
 *	 mot_naples_imx882mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "mot_naples_imx882mipiraw_Sensor.h"
#include "mot_naples_imx882_sensor_setting.h"

extern mot_calibration_status_t *NAPLES_IMX882_eeprom_get_calibration_status(void);
extern mot_calibration_mnf_t *NAPLES_IMX882_eeprom_get_mnf_info(void);
extern void NAPLES_IMX882_eeprom_format_calibration_data(struct imgsensor_struct *pImgsensor);
extern void imx882_qsc_spc_apply(void);

#undef VENDOR_EDIT
/***************Modify Following Strings for Debug**********************/
#define PFX "MOT_NAPLES_IMX882_camera_sensor"
/****************************   Modify end	**************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_NAPLES_IMX882_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{8192, 6144,  000,  768, 8192, 4608, 4096, 2304, 0000, 0000, 4096, 2304, 0, 0, 4096, 2304},  /* Video 4096x2304@30fps*/
...
kal_uint16 mot_imx882_burst_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
kal_uint16 mot_imx882_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
	char puSendCmd[I2C_BUFFER_LEN];
	kal_uint32 tosend, IDX;
...
static void mot_imx882_get_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void mot_imx882_set_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	mot_imx882_table_write_cmos_sensor(regDa, regNum*2);
}
...
static void sensor_init(void)
{
	...
	mot_imx882_table_write_cmos_sensor(mot_imx882_init_setting_part1,
		sizeof(mot_imx882_init_setting_part1)/sizeof(kal_uint16));

	mot_imx882_burst_write_cmos_sensor(mot_imx882_init_setting_part2,
		sizeof(mot_imx882_init_setting_part2)/sizeof(kal_uint16));

	mot_imx882_table_write_cmos_sensor(mot_imx882_init_setting_part3,
		sizeof(mot_imx882_init_setting_part3)/sizeof(kal_uint16));

	mot_imx882_burst_write_cmos_sensor(mot_imx882_init_setting_part4,
		sizeof(mot_imx882_init_setting_part4)/sizeof(kal_uint16));

	mot_imx882_table_write_cmos_sensor(mot_imx882_init_setting_part5,
		sizeof(mot_imx882_init_setting_part5)/sizeof(kal_uint16));
...
static void preview_setting(void)
{
	...
	mot_imx882_table_write_cmos_sensor(mot_imx882_preview_setting,
		sizeof(mot_imx882_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
	...
	mot_imx882_table_write_cmos_sensor(mot_imx882_capture_30_setting,
		sizeof(mot_imx882_capture_30_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	mot_imx882_table_write_cmos_sensor(mot_imx882_normal_video_setting,
	sizeof(mot_imx882_normal_video_setting)/sizeof(kal_uint16));
...
{
	mot_imx882_table_write_cmos_sensor(mot_imx882_hs_120_setting,
	sizeof(mot_imx882_hs_120_setting)/sizeof(kal_uint16));
...
static kal_uint32 seamless_switch(enum MSDK_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
	...
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
	{
		...
		FMC_GPH_START;
		mot_imx882_table_write_cmos_sensor(imx882_seamless_preview,
	...
	case MSDK_SCENARIO_ID_CUSTOM3:
	{
		...
		FMC_GPH_START;
		mot_imx882_table_write_cmos_sensor(imx882_seamless_custom3,
...
static void slim_video_setting(void)
{
	...
	mot_imx882_table_write_cmos_sensor(mot_imx882_slim_30_setting,
		sizeof(mot_imx882_slim_30_setting)/sizeof(kal_uint16));
...
static void custom1_setting(void)
{
	...
	mot_imx882_table_write_cmos_sensor(mot_imx882_custom1_setting,
		sizeof(mot_imx882_custom1_setting)/sizeof(kal_uint16));
...
static void custom2_setting(void)
{
	...
	mot_imx882_table_write_cmos_sensor(mot_imx882_custom2_setting,
		sizeof(mot_imx882_custom2_setting)/sizeof(kal_uint16));
...
static void custom3_setting(void)
{
	...
	mot_imx882_table_write_cmos_sensor(mot_imx882_custom3_setting,
		sizeof(mot_imx882_custom3_setting)/sizeof(kal_uint16));
...
static void custom4_setting(void)
{
	...
	mot_imx882_table_write_cmos_sensor(mot_imx882_custom4_setting,
		sizeof(mot_imx882_custom4_setting)/sizeof(kal_uint16));
...
static void custom5_setting(void)
{
	...
	mot_imx882_table_write_cmos_sensor(mot_imx882_custom5_setting,
		sizeof(mot_imx882_custom5_setting)/sizeof(kal_uint16));
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0016) << 8)
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				NAPLES_IMX882_eeprom_format_calibration_data(&imgsensor);
				return ERROR_NONE;
			}
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	memcpy(&sensor_info->calibration_status, NAPLES_IMX882_eeprom_get_calibration_status(), sizeof(mot_calibration_status_t));
	memcpy(&sensor_info->mnf_calibration, NAPLES_IMX882_eeprom_get_mnf_info(), sizeof(mot_calibration_mnf_t));
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((*(feature_data + 0)) == 0) {
			*(feature_data + 0) =
				sizeof(mot_imx882_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)mot_imx882_ana_gain_table,
			sizeof(mot_imx882_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		mot_imx882_get_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		 ...
		 *	(*feature_para_len));
		 */
		mot_imx882_set_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
...
UINT32 MOT_NAPLES_IMX882_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
...
} /* MOT_NAPLES_IMX882_MIPI_RAW_SensorInit */
