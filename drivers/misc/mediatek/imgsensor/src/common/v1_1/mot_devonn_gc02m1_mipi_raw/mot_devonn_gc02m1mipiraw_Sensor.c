...
#include "mot_devonn_gc02m1mipiraw_Sensor.h"
...
#ifdef EEPROM_READY
				read_gc02m1_module_info();
				gc02m1_eeprom_format_calibration_data();
				//gc02m1_otp_dump_bin(DEPTH_SERIAL_NUM_DATA_PATH, MODULE_DATA_SIZE, (void *)gc02m1_serial_data);
				//gc02m1_otp_dump_bin(GC02M1_EEPROM_DATA_PATH, DEVONN_GC02M1_EEPROM_SIZE, (void *)gc02m1_data_eeprom);
#endif
				return ERROR_NONE;
			}
