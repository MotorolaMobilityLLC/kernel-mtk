 ...
 * Filename:
 * ---------
 *	 mot_sydney_imx882mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "mot_sydney_imx882_sensor_setting.h"

#define IMX882_BASEGAIN 128

extern mot_calibration_status_t *SYDNEY_IMX882_eeprom_get_calibration_status(void);
extern mot_calibration_mnf_t *SYDNEY_IMX882_eeprom_get_mnf_info(void);
extern void SYDNEY_IMX882_eeprom_format_calibration_data(struct imgsensor_struct *pImgsensor);
extern void imx882_qsc_spc_apply(void);

#undef VENDOR_EDIT
/***************Modify Following Strings for Debug**********************/
#define PFX "MOT_SYDNEY_IMX882_camera_sensor"
/****************************   Modify end	**************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_SYDNEY_IMX882_SENSOR_ID,
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0016) << 8)
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				SYDNEY_IMX882_eeprom_format_calibration_data(&imgsensor);
				return ERROR_NONE;
			}
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	memcpy(&sensor_info->calibration_status, SYDNEY_IMX882_eeprom_get_calibration_status(), sizeof(mot_calibration_status_t));
	memcpy(&sensor_info->mnf_calibration, SYDNEY_IMX882_eeprom_get_mnf_info(), sizeof(mot_calibration_mnf_t));
...
} /* MOT_SYDNEY_IMX882_MIPI_RAW_SensorInit */
