 ...
 * Filename:
 * ---------
 *     MOT_CANCUNF_HI1634Qmipi_Sensor.h
 *
 * Project:
 * --------
 *     ALPS
 ...
 *
 ****************************************************************************/
#ifndef _MOT_CANCUNF_HI1634QMIPI_SENSOR_H
#define _MOT_CANCUNF_HI1634QMIPI_SENSOR_H
...
struct mot_hi1634q_eeprom_t {
	...
	uint8_t sfr_field4_upper_left_distance1[2];
	uint8_t sfr_field4_upper_right_distance1[2];
	uint8_t sfr_field4_lower_right_distance1[2];
	uint8_t sfr_field4_lower_left_distance1[2];
	...
	uint8_t sfr_field4_upper_left_distance2[2];
	uint8_t sfr_field4_upper_right_distance2[2];
	uint8_t sfr_field4_lower_right_distance2[2];
	uint8_t sfr_field4_lower_left_distance2[2];
	...
	uint8_t sfr_field4_upper_left_distance3[2];
	uint8_t sfr_field4_upper_right_distance3[2];
	uint8_t sfr_field4_lower_right_distance3[2];
	uint8_t sfr_field4_lower_left_distance3[2];
	uint8_t sfr_field2_corner_to_corner_variation_distance3_reserve[2];
	uint8_t sfr_crc16[2];

	uint8_t qcom_lsc_calibration[1768];
	uint8_t qcom_lsc_crc16[2];
	uint8_t mtk_lsc_calibration[1868];
	uint8_t mtk_lsc_crc16[2];
