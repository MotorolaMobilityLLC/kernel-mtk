...
UINT32 MOT_NEVADA_OV08F_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 MOT_NEVADA_OV02F_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 MOT_NEVADA_S5KKDS_FM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 MOT_SYDNEY_IMX882_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 MOT_SYDNEY_GC08A3_UW_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 MOT_SYDNEY_GC50F6A_2ND_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 MOT_SYDNEY_GC02M1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
#endif
//Naples bring up
...
UINT32 MOT_NAPLES_OV08F_2ND_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 MOT_SBUYA_OV08F_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
#endif
...
UINT32 MOT_VEGAS_S5K3P9_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
