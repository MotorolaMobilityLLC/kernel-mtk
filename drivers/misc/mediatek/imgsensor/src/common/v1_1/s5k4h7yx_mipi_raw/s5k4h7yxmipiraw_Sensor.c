...
#define EEPROM_DATA_PATH "/data/vendor/camera_dump/s5k4h7yx_otp_data.bin"
...
static imgsensor_info_struct imgsensor_info = {
	...
	.linelength = 3584,				/* record different mode's linelength */
	.framelength = 2560,         /* record different mode's framelength */
	...
	.slim_video = {
		...
		.framelength = 2568,		   /* record different mode's framelength */
		.startx = 0,					/* record different mode's startx of grabwindow */
		.starty = 0,					/* record different mode's starty of grabwindow */
...
//	shutter = (shutter > (imgsensor_info.max_frame_length - imgsensor_info.margin)) ? (imgsensor_info.max_frame_length - imgsensor_info.margin) : shutter;
	...
	if (shutter > 65530) {  //linetime=10160/960000000<< maxshutter=3023622-line=32s
		...
		if (bIsLongExposure == KAL_TRUE) {
			...
			write_cmos_sensor_8(0x0340, imgsensor.frame_length & 0xFFFF);
			...
			write_cmos_sensor_8(0x0202, shutter & 0xFFFF);
			/*stream on*/
...
static void preview_setting(void)
{
	...
	write_cmos_sensor_8(0X0307, 0X8A);
	...
	write_cmos_sensor_8(0X0341, 0X00);
	write_cmos_sensor_8(0X0342, 0X0E);
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor_8(0X0101, 0X00);
	write_cmos_sensor_8(0X0340, 0X0A);
	write_cmos_sensor_8(0X0341, 0X08);
...
static uint8_t s5k4h7yx_eeprom[S5K4H7YX_EEPROM_SIZE] = {0};
...
static int s5k4h7yx_read_data_from_otp(void)
{
	LOGE("s5k4h7yx_read_data_from_otp -E");
	/* Read otp data of three group*/
	s5k4h7yx_read_otp_page_data(21, 0x0a04, s5k4h7yx_eeprom, 64);
	s5k4h7yx_read_otp_page_data(22, 0x0a04, s5k4h7yx_eeprom + 64, 64);
	s5k4h7yx_read_otp_page_data(23, 0x0a04, s5k4h7yx_eeprom + 128, 64);
	s5k4h7yx_read_otp_page_data(24, 0x0a04, s5k4h7yx_eeprom + 192, 46);
	s5k4h7yx_read_otp_page_data(25, 0x0a04, s5k4h7yx_eeprom + 238, 64);
	s5k4h7yx_read_otp_page_data(26, 0x0a04, s5k4h7yx_eeprom + 302, 64);
	s5k4h7yx_read_otp_page_data(27, 0x0a04, s5k4h7yx_eeprom + 366, 64);
	s5k4h7yx_read_otp_page_data(28, 0x0a04, s5k4h7yx_eeprom + 430, 46);
	s5k4h7yx_read_otp_page_data(29, 0x0a04, s5k4h7yx_eeprom + 476, 64);
	s5k4h7yx_read_otp_page_data(30, 0x0a04, s5k4h7yx_eeprom + 540, 64);
	s5k4h7yx_read_otp_page_data(31, 0x0a04, s5k4h7yx_eeprom + 604, 64);
	s5k4h7yx_read_otp_page_data(32, 0x0a04, s5k4h7yx_eeprom + 668, 46);
	//TODO: Add LSC data
...
static void s5k4h7yx_eeprom_dump_bin(const char *file_name, uint32_t size, const void *data)
{
	struct file *fp = NULL;
	mm_segment_t old_fs;
	int ret = 0;
...
static calibration_status_t s5k4h7yx_check_manufacturing_data(void *data)
{
...
static calibration_status_t s5k4h7yx_check_awb_data(void *data)
{
	struct s5k4h7yx_eeprom_t *eeprom = (struct s5k4h7yx_eeprom_t*)data;
...
static void s5k4h7yx_eeprom_format_calibration_data(void *data)
{
	if (NULL == data) {
	...
	mnf_status = s5k4h7yx_check_manufacturing_data(data);
	af_status = 0;
	awb_status = s5k4h7yx_check_awb_data(data);
	lsc_status = 0;
	pdaf_status = 0;
	dual_status = 0;
...
static void s5k4h7yx_eeprom_get_mnf_data(void *data,
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	s5k4h7yx_eeprom_get_mnf_data((void *)s5k4h7yx_eeprom, &sensor_info->mnf_calibration);
							 ...
							 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
		case SENOSR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
			*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 6500000;
			break;
