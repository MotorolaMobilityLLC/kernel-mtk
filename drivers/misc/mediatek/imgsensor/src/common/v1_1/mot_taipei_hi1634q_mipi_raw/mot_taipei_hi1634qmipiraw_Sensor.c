 ...
 * Filename:
 * ---------
 *	 MOT_TAIPEI_HI1634Qmipi_Sensor.c
 *
 * Project:
 * --------
 *	 MTK SOP
 ...
 *============================================================================
 ****************************************************************************/
#define PFX "MOT_TAIPEI_HI1634Q_camera_sensor"
...
#include "mot_taipei_hi1634qmipiraw_Sensor.h"
#include "mot_taipei_hi1634qmipiraw_sensor_settings.h"
...
#if USE_BURST_MODE
static kal_uint16 mot_taipei_hi1634q_table_write_cmos_sensor(
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_TAIPEI_HI1634Q_SENSOR_ID,
...
static kal_uint16 mot_taipei_hi1634q_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
static void sensor_init(void)
{
	...
	mot_taipei_hi1634q_table_write_cmos_sensor(mot_taipei_hi1634q_init_setting,
		sizeof(mot_taipei_hi1634q_init_setting)/sizeof(kal_uint16));
...
static void preview_setting(void)
{
	...
	mot_taipei_hi1634q_table_write_cmos_sensor(mot_taipei_2320x1740_30fps_setting,
		sizeof(mot_taipei_2320x1740_30fps_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	mot_taipei_hi1634q_table_write_cmos_sensor(mot_taipei_2320x1312_30fps_setting,
		sizeof(mot_taipei_2320x1312_30fps_setting)/sizeof(kal_uint16));
...
#define TAIPEI_HI1634Q_EEPROM_SLAVE_ADDR 0xA2
#define TAIPEI_HI1634Q_SENSOR_IIC_SLAVE_ADDR 0x42
#define TAIPEI_HI1634Q_EEPROM_SIZE  4389
#define TAIPEI_HI1634Q_EEPROM_CRC_AWB_CAL_SIZE 43
#define TAIPEI_HI1634Q_EEPROM_CRC_OPTICAL_CENTER_CAL_SIZE 16
#define TAIPEI_HI1634Q_EEPROM_CRC_SFR_CAL_SIZE 117
#define TAIPEI_HI1634Q_EEPROM_CRC_LSC_SIZE 1868
#define TAIPEI_HI1634Q_EEPROM_CRC_NECESSARY_DATA_CAL_SIZE 18
#define TAIPEI_HI1634Q_EEPROM_CRC_MANUFACTURING_SIZE 37
#define TAIPEI_HI1634Q_MANUFACTURE_PART_NUMBER "28C85320"
#define TAIPEI_HI1634Q_MPN_LENGTH 8
static uint8_t TAIPEI_HI1634Q_eeprom[TAIPEI_HI1634Q_EEPROM_SIZE] = {0};
...
static void TAIPEI_HI1634Q_read_data_from_eeprom(kal_uint8 slave, kal_uint32 start_add, uint32_t size)
{
	int i = 0;
	spin_lock(&imgsensor_drv_lock);
	...
	//read eeprom data
	for (i = 0; i < size; i ++) {
		TAIPEI_HI1634Q_eeprom[i] = read_cmos_sensor_8(start_add);
		start_add ++;
	}
	spin_lock(&imgsensor_drv_lock);
	imgsensor.i2c_write_id = TAIPEI_HI1634Q_SENSOR_IIC_SLAVE_ADDR;
	spin_unlock(&imgsensor_drv_lock);
}
...
static calibration_status_t TAIPEI_HI1634Q_check_awb_data(void *data)
{
	...
	if(!eeprom_util_check_crc16(eeprom->cie_ev,
		TAIPEI_HI1634Q_EEPROM_CRC_AWB_CAL_SIZE,
...
static calibration_status_t TAIPEI_HI1634Q_check_lsc_data(void *data)
{
	struct mot_hi1634q_eeprom_t *eeprom = (struct mot_hi1634q_eeprom_t*)data;
	if (!eeprom_util_check_crc16(eeprom->mtk_lsc_calibration, TAIPEI_HI1634Q_EEPROM_CRC_LSC_SIZE,
...
static void TAIPEI_HI1634Q_eeprom_get_mnf_data(void *data,
...
static calibration_status_t TAIPEI_HI1634Q_check_optical_center_data(void *data)
{
	struct mot_hi1634q_eeprom_t *eeprom = (struct mot_hi1634q_eeprom_t*)data;
	if (!eeprom_util_check_crc16(eeprom->optical_center_x_1_r_channel, TAIPEI_HI1634Q_EEPROM_CRC_OPTICAL_CENTER_CAL_SIZE,
...
static calibration_status_t TAIPEI_HI1634Q_check_sfr_data(void *data)
{
	struct mot_hi1634q_eeprom_t *eeprom = (struct mot_hi1634q_eeprom_t*)data;
	if (!eeprom_util_check_crc16(eeprom->sfr_distance1_reserve, TAIPEI_HI1634Q_EEPROM_CRC_SFR_CAL_SIZE,
...
static calibration_status_t TAIPEI_HI1634Q_check_necessary_data(void *data)
{
	struct mot_hi1634q_eeprom_t *eeprom = (struct mot_hi1634q_eeprom_t*)data;
	if (!eeprom_util_check_crc16(eeprom->module_check_flag, TAIPEI_HI1634Q_EEPROM_CRC_NECESSARY_DATA_CAL_SIZE,
...
static calibration_status_t TAIPEI_HI1634Q_check_manufacturing_data(void *data)
{
	struct mot_hi1634q_eeprom_t *eeprom = (struct mot_hi1634q_eeprom_t*)data;
    LOG_INF("Manufacturing eeprom->mpn = %s !",eeprom->mpn);
#if 0
	if(strncmp(eeprom->mpn, TAIPEI_HI1634Q_MANUFACTURE_PART_NUMBER, TAIPEI_HI1634Q_MPN_LENGTH) != 0) {
		LOG_INF("Manufacturing part number (%s) check Fails!", eeprom->mpn);
		return CRC_FAILURE;
	}
#endif
	if (!eeprom_util_check_crc16(eeprom->eeprom_table_version, TAIPEI_HI1634Q_EEPROM_CRC_MANUFACTURING_SIZE,
...
static void TAIPEI_HI1634Q_eeprom_format_calibration_data(void *data)
{
	if (NULL == data) {
		LOG_INF("data is NULL");
		return;
	}
	mnf_status            = TAIPEI_HI1634Q_check_manufacturing_data(data);
	awb_status            = TAIPEI_HI1634Q_check_awb_data(data);
	optical_center_status = TAIPEI_HI1634Q_check_optical_center_data(data);;
	sfr_status            = TAIPEI_HI1634Q_check_sfr_data(data);;
	lsc_status            = TAIPEI_HI1634Q_check_lsc_data(data);
	necessary_data_status = TAIPEI_HI1634Q_check_necessary_data(data);
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				TAIPEI_HI1634Q_read_data_from_eeprom(TAIPEI_HI1634Q_EEPROM_SLAVE_ADDR, 0x0000, TAIPEI_HI1634Q_EEPROM_SIZE);
				TAIPEI_HI1634Q_eeprom_format_calibration_data((void *)TAIPEI_HI1634Q_eeprom);
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	TAIPEI_HI1634Q_eeprom_get_mnf_data((void *) TAIPEI_HI1634Q_eeprom, &sensor_info->mnf_calibration);
...
UINT32 MOT_TAIPEI_HI1634Q_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* MOT_TAIPEI_HI1634Q_MIPI_RAW_SensorInit */
