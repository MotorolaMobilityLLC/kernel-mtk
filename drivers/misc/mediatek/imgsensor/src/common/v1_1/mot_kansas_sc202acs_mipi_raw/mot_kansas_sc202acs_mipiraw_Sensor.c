 ...
 * Filename:
 * ---------
 *     mot_kansas_sc202acs_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "mot_kansas_sc202acs_mipiraw_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "mot_kansas_sc202acs_mipi_raw"

#define LOG_1 LOG_INF("MOT_KANSAS_SC202ACS,MIPI 1LANE\n")
...
/****************************   Modify end    *******************************************/
extern void sc202acs_read_otp_data(void);
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_KANSAS_SC202ACS_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] =
{
	...
	{ 1600, 1200, 0, 0, 1600, 1200, 1600, 1200, 0000, 0000, 1600, 1200,    0, 150, 1600,  900}, // video
...
//#ifdef __GAINMAP__
#if 1
#define MOT_KANSAS_SC202ACS_SENSOR_GAIN_BASE             1024
#define MOT_KANSAS_SC202ACS_SENSOR_GAIN_MAX              65024 //(63.5 * MOT_KANSAS_SC202ACS_SENSOR_GAIN_BASE)
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	else if (reg_gain > MOT_KANSAS_SC202ACS_SENSOR_GAIN_MAX)
		reg_gain = MOT_KANSAS_SC202ACS_SENSOR_GAIN_MAX;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 MOT_KANSAS_SC202ACS_AGC_Param[MOT_KANSAS_SC202ACS_SENSOR_GAIN_MAX_VALID_INDEX][2] = {
		{  1024,  0x00 },
		{  2048,  0x01 },
		{  4096,  0x03 },
		{  8192,  0x07 },
	...
	for (gain_index = MOT_KANSAS_SC202ACS_SENSOR_GAIN_MAX_VALID_INDEX - 1; gain_index >= 0; gain_index--)
		if (reg_gain >= MOT_KANSAS_SC202ACS_AGC_Param[gain_index][0])
			break;

	write_cmos_sensor(0x3e09, MOT_KANSAS_SC202ACS_AGC_Param[gain_index][1]);
	temp_gain = reg_gain * MOT_KANSAS_SC202ACS_SENSOR_GAIN_BASE / MOT_KANSAS_SC202ACS_AGC_Param[gain_index][0];
...
{
	LOG_INF("E! hs_video setting\n");
	preview_setting();
	/*    Reuse preview_setting  */
}

static void slim_video_setting()
{
	LOG_INF("E! slim_video setting\n");
	preview_setting();
	/*    Reuse preview_setting  */
}
#if 1
...
UINT32 MOT_KANSAS_SC202ACS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}    /*    MOT_KANSAS_SC202ACS_MIPI_RAW_SensorInit    */
