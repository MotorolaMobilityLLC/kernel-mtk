 ...
 * Filename:
 * ---------
 *    mot_naples_gc08a3_mipi_raw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 *
 * Version:  V20250805111949 by GC-S-TEAM
 *
...
extern mot_calibration_status_t *NAPLES_GC08A3_otp_get_calibration_status(void);
extern mot_calibration_mnf_t *NAPLES_GC08A3_otp_get_mnf_info(void);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_NAPLES_GC08A3_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{ 3264, 2448, 0, 0, 3264, 2448, 3264, 2448, 0, 306, 3264, 1836, 0, 0, 3264, 1836}, /* hs video */
	{ 3264, 2448, 0, 0, 3264, 2448, 3264, 2448, 0, 306, 3264, 1836, 0, 0, 3264, 1836}  /* slim video */
};
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(addr_data_pair_init_mot_naples_gc08a3,
		sizeof(addr_data_pair_init_mot_naples_gc08a3)/sizeof(kal_uint16));
	pr_debug("[%s] init_End\n", __func__);
}	/*	  sensor_init  */
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(addr_data_pair_mot_naples_gc08a3_3264x2448,
	  sizeof(addr_data_pair_mot_naples_gc08a3_3264x2448)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(addr_data_pair_mot_naples_gc08a3_3264x1836,
		sizeof(addr_data_pair_mot_naples_gc08a3_3264x1836)/sizeof(kal_uint16));
	pr_debug("[%s] normal_video_End\n", __func__);
}

static void hs_video_setting(void)
{
	pr_debug("[%s] hs_video_Start, 3264x1836@300fps\n", __func__);
	table_write_cmos_sensor(addr_data_pair_mot_naples_gc08a3_3264x1836,
		sizeof(addr_data_pair_mot_naples_gc08a3_3264x1836)/sizeof(kal_uint16));
...
{
	pr_debug("[%s] slim_video_Start, 3264x1836@300fps\n", __func__);
	table_write_cmos_sensor(addr_data_pair_mot_naples_gc08a3_3264x1836,
		sizeof(addr_data_pair_mot_naples_gc08a3_3264x1836)/sizeof(kal_uint16));
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(check_mot_naples_gc08a3_otp()) {
					pr_debug("mot_naples_gc08a3,check OTP pass\n");
				} else {
					pr_debug("mot_naples_gc08a3,check OTP fail\n");
				}
				return ERROR_NONE;
			}
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	memcpy(&sensor_info->mnf_calibration, NAPLES_GC08A3_otp_get_mnf_info(), sizeof(mot_calibration_mnf_t));
	memcpy(&sensor_info->calibration_status, NAPLES_GC08A3_otp_get_calibration_status(), sizeof(mot_calibration_status_t));
...
UINT32 MOT_NAPLES_GC08A3_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	 pr_debug("MOT_NAPLES_GC08A3_MIPI_RAW_SensorInit ");
	return ERROR_NONE;
}
