...
#include "mot_cancunn_s5k4h7mipiraw_otp.h"
...
unsigned int mot_cancunn_s5k4h7_read_region(struct i2c_client *client, unsigned int addr,
...
EXPORT_SYMBOL(mot_cancunn_s5k4h7_read_region);
