 ...
 */
#ifndef _HM1062MIPI_SENSOR_H
#define _HM1062MIPI_SENSOR_H
...
extern void hm1062_2_stream_on(kal_bool enable, kal_uint32 shutter, kal_uint16 gain);
extern void hm1062_2_cmu(void);
extern void hm1062_2_ae_cmu(kal_uint32 mode);
