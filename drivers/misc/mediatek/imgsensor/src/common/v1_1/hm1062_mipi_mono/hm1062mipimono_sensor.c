...
#include "hm1062mipimono_sensor.h"

/************************* Modify Following Strings for Debug ****************/
#define PFX "hm1062_camera_primax mono"
...
{
	if (imgsensor.sync_mode == SENSOR_SLAVE_SYNC_MODE) {
		hm1062_2_stream_on(enable, imgsensor.shutter, imgsensor.gain);
	} else {
...
void hm1062_stream_on(kal_bool enable, kal_uint32 shutter, kal_uint16 gain)
{
	LOG_INF("hm1062_stream_on\n");
...
void hm1062_ae_cmu(kal_uint32 mode)
{
	static kal_uint32 status;

	LOG_INF("hm1062 ae cmu (%d)\n", mode);
