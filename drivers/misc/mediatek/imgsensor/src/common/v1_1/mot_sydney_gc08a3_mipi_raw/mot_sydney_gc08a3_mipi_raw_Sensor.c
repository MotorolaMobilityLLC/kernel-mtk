 ...
 * Filename:
 * ---------
 *     mot_sydney_gc08a3_mipi_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 */
#define PFX "mot_sydney_gc08a3_camera_sensor"
...
#include "mot_sydney_gc08a3_mipi_raw_Sensor.h"

#define LONG_EXP 1

static DEFINE_SPINLOCK(imgsensor_drv_lock);
extern bool check_mot_sydney_gc08a3_otp(void);
extern mot_calibration_status_t *SYDNEY_GC08A3_otp_get_calibration_status(void);
extern mot_calibration_mnf_t *SYDNEY_GC08A3_otp_get_mnf_info(void);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_SYDNEY_GC08A3_SENSOR_ID,
...
static struct imgsensor_struct imgsensor = {
	...
	.i2c_write_id = 0x24, /* record current sensor's i2c write id */
};
...
static kal_uint32 return_sensor_id(void)
{
	...
	sensor_id = (read_cmos_sensor(0x03f0) << 8) | read_cmos_sensor(0x03f1); //08a3
	return sensor_id;
}
...
kal_uint16 mot_sydney_gc08a3_init_addr_data[] = {
/*system*/
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x51,
	...
	0x0059, 0x11,
	0x0070, 0x05,
	0x0101, MOT_SYDNEY_GC08A3_MIRROR,
/*analog*/
	0x0344, 0x00,
	0x0345, 0x06,
	0x0346, 0x00,
...
static kal_uint16 mot_sydney_gc08a3_1632x1224_addr_data[] = {
/*system*/
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x55,
...
static kal_uint16 mot_sydney_gc08a3_3264x2448_addr_data[] = {
/*system*/
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x51,
...
static kal_uint16 mot_sydney_gc08a3_1280x720_addr_data[] = {
/*system*/
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x55,
...
static kal_uint16 mot_sydney_gc08a3_3264x1836_addr_data[] = {
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x51,
	0x0336, 0x70,
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(mot_sydney_gc08a3_init_addr_data,
		sizeof(mot_sydney_gc08a3_init_addr_data)/sizeof(kal_uint16));
	pr_debug("[%s] init_End\n", __func__);
}	/*	  sensor_init  */
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(mot_sydney_gc08a3_3264x2448_addr_data,
		sizeof(mot_sydney_gc08a3_3264x2448_addr_data)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(mot_sydney_gc08a3_3264x1836_addr_data,
		sizeof(mot_sydney_gc08a3_3264x1836_addr_data)/sizeof(kal_uint16));
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(mot_sydney_gc08a3_1632x1224_addr_data,
		sizeof(mot_sydney_gc08a3_1632x1224_addr_data)/sizeof(kal_uint16));
...
static void slim_video_setting(void)
{
	...
	table_write_cmos_sensor(mot_sydney_gc08a3_1280x720_addr_data,
		sizeof(mot_sydney_gc08a3_1280x720_addr_data)/sizeof(kal_uint16));
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[mot_sydney_gc08a3_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				if(check_mot_sydney_gc08a3_otp()) {
					pr_debug("mot_sydney_gc08a3,check OTP pass\n");
				} else {
					pr_debug("mot_sydney_gc08a3,check OTP fail\n");
				}
				return ERROR_NONE;
			}
			pr_debug("[mot_sydney_gc08a3_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			if (sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[mot_sydney_gc08a3_camera_sensor]open:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
			pr_debug("[mot_sydney_gc08a3_camera_sensor]open:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	memcpy(&sensor_info->mnf_calibration, SYDNEY_GC08A3_otp_get_mnf_info(), sizeof(mot_calibration_mnf_t));
	memcpy(&sensor_info->calibration_status, SYDNEY_GC08A3_otp_get_calibration_status(), sizeof(mot_calibration_status_t));
...
UINT32 MOT_SYDNEY_GC08A3_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
