...
#include "hi846_mipiraw_Sensor.h"
...
static struct stCAM_CAL_DATAINFO_STRUCT n22hi846frontst_eeprom_data ={
	.sensorID= HI846_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x077C,
...
static struct stCAM_CAL_CHECKSUM_STRUCT hi846_checksum[8] =
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		imgsensor.i2c_write_id = imgsensor_info.i2c_addr_table[i];
                pr_info("i2c_write_id =0x%x",imgsensor.i2c_write_id);
		spin_unlock(&imgsensor_drv_lock);
		do {
