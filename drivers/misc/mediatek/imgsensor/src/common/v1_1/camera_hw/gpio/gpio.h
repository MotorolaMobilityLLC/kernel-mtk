...
#if defined(CONFIG_MOT_DEVONN_CAMERA_PROJECT) || defined(CONFIG_MOT_DEVONF_CAMERA_PROJECT) || defined(CONFIG_MOT_CANCUNF_CAMERA_PROJECT) || defined(CONFIG_MOT_CANCUNN_CAMERA_PROJECT) || defined(CONFIG_MOT_TAIPEI_CAMERA_PROJECT) || defined(CONFIG_MOT_BOGOTA_CAMERA_PROJECT)
