...
struct GPIO_PINCTRL gpio_pinctrl_list_cam[
	...
	{"ldo_vcamafvdd_1"},
	{"ldo_vcamafvdd_0"},
#if defined(CONFIG_MOT_CANCUNF_CAMERA_PROJECT)  || defined(CONFIG_MOT_DEVONN_CAMERA_PROJECT) || defined(CONFIG_MOT_DEVONF_CAMERA_PROJECT) || defined(CONFIG_MOT_CANCUNN_CAMERA_PROJECT) || defined(CONFIG_MOT_TAIPEI_CAMERA_PROJECT) || defined(CONFIG_MOT_BOGOTA_CAMERA_PROJECT)
	{"ldo_vcamaf_1"},
	{"ldo_vcamaf_0"},
#endif
	{"ldo_vcamd_1"},
