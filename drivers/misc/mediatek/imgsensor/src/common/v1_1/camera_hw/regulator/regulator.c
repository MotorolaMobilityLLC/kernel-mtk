...
#if defined(CONFIG_MOT_VEGAS_CAMERA_PROJECT)|| defined(CONFIG_MOT_NAPLES_CAMERA_PROJECT)
...
#if defined(CONFIG_MOT_NAPLES_CAMERA_PROJECT) || defined(CONFIG_MOT_SYDNEY_CAMERA_PROJECT)
