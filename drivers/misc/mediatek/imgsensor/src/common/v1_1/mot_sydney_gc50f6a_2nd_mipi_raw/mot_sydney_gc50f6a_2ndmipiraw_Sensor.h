 ...
 * Filename:
 * ---------
 *     mot_sydney_gc50f6a_2ndmipiraw_Sensor.h
 *
 * Project:
 * --------
 *     ALPS
 ...
 *
 ****************************************************************************/
#ifndef _GC50F6MIPI_SENSOR_H
#define _GC50F6MIPI_SENSOR_H
...
#define MIRROR	     0x00
#elif GC50F6_IMAGE_H_MIRROR
#define MIRROR	     0x01
#elif GC50F6_IMAGE_V_MIRROR
#define MIRROR	     0x02
#elif GC50F6_IMAGE_HV_MIRROR
#define MIRROR	     0x03
#else
#define MIRROR	    0x00
#endif
...
#define CROSSTALK_BUF_SIZE      492 // 294+192+2
...
extern void mot_sydney_gc50f6a_2nd_read_crosstalk_data(void);
extern void mot_sydney_gc50f6a_2nd_write_crosstalk_data(void);
#endif
