...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[7] = {
	...
	{0x02, 0x0A,   0x00,   0x08, 0x40, 0x00,
	0x00, 0x2B, 0x0800, 0x0600, 0x01, 0x00, 0x0000, 0x0000},
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{ 4096, 3072, 0, 0, 4096, 3072, 4096, 3072, 0, 384, 4096, 2304, 0, 0, 4096, 2304},/*video */
	{ 4096, 3072, 0, 0, 4096, 3072, 2048, 1536, 0, 192, 2048, 1152, 0, 0, 2048, 1152}, /* hs video */
	{ 4096, 3072, 0, 0, 4096, 3072, 4096, 3072, 0, 0, 4096, 3072, 0, 0, 4096, 3072},/* slim video */
	{ 4096, 3072, 0, 0, 4096, 3072, 2048, 1536, 0, 0, 2048, 1536, 0, 0, 2048, 1536},/* custom1 */
	{ 4096, 3072, 0, 0, 4096, 3072, 2048, 1536, 0, 192, 2048, 1152, 0, 0, 2048, 1152},/* custom2 */
};
...
kal_uint16 mot_sydney_gc50f6a_2nd_4096x3072_cap_data[] = {
0x0315,0x80,
0x0fe2,0x17,
0x0fa2,0x03,
0x0900,0x10,
...
kal_uint16 mot_sydney_gc50f6a_2nd_4096x2304_video_data[] = {
0x0315,0x80,
0x0fe2,0x17,
0x0fa2,0x03,
0x0900,0x10,
...
kal_uint16 mot_sydney_gc50f6a_2nd_2048x1152_hs_data[] = {
0x0315,0x80,
0x0fe2,0x17,
0x0fa2,0x03,
0x0900,0x10,
...
kal_uint16 mot_sydney_gc50f6a_2nd_4096x3072_slim_data[] = {
0x0315,0x80,
0x0fe2,0x17,
0x0fa2,0x03,
0x0900,0x10,
...
kal_uint16 mot_sydney_gc50f6a_2nd_2048x1536_custom1_data[] = {
0x0315,0x80,
0x0fe2,0x17,
0x0fa2,0x03,
0x0900,0x10,
...
kal_uint16 mot_sydney_gc50f6a_2nd_2048x1152_custom2_data[] = {
0x0315,0x80,
0x0fe2,0x17,
0x0fa2,0x03,
0x0900,0x10,
...
static void capture_setting(void)
{
	pr_debug("[%s] capture_Start\n", __func__);
		table_write_cmos_sensor(mot_sydney_gc50f6a_2nd_4096x3072_cap_data,
		sizeof(mot_sydney_gc50f6a_2nd_4096x3072_cap_data)/sizeof(kal_uint16));
	ratio = 2;
...
static void normal_video_setting(void)
{
	...
	table_write_cmos_sensor(mot_sydney_gc50f6a_2nd_4096x2304_video_data,
		sizeof(mot_sydney_gc50f6a_2nd_4096x2304_video_data)/sizeof(kal_uint16));
	ratio = 1;
...
{
	pr_debug("[%s] hs_video_Start, 2048x1152@120fps\n", __func__);
	table_write_cmos_sensor(mot_sydney_gc50f6a_2nd_2048x1152_hs_data,
		sizeof(mot_sydney_gc50f6a_2nd_2048x1152_hs_data)/sizeof(kal_uint16));
	ratio = 1;
...
{
	pr_debug("[%s] slim_video_Start, 4096x3072@30fps\n", __func__);
	table_write_cmos_sensor(mot_sydney_gc50f6a_2nd_4096x3072_slim_data,
		sizeof(mot_sydney_gc50f6a_2nd_4096x3072_slim_data)/sizeof(kal_uint16));
	ratio = 1;
...
{
	pr_debug("[%s] custom1_Start, 2048x1536@30fps\n", __func__);
	table_write_cmos_sensor(mot_sydney_gc50f6a_2nd_2048x1536_custom1_data,
		sizeof(mot_sydney_gc50f6a_2nd_2048x1536_custom1_data)/sizeof(kal_uint16));
	ratio = 1;
...
{
	pr_debug("[%s] custom2_Start, 2048x1152@60fps\n", __func__);
	table_write_cmos_sensor(mot_sydney_gc50f6a_2nd_2048x1152_custom2_data,
		sizeof(mot_sydney_gc50f6a_2nd_2048x1152_custom2_data)/sizeof(kal_uint16));
	ratio = 1;
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				mot_sydney_gc50f6a_2nd_read_crosstalk_data();
				return ERROR_NONE;
			}
...
void mot_sydney_gc50f6a_2nd_read_crosstalk_data(void)
{
	...
	// pr_debug("ct_flag = %d\n", ct_flag);
	pr_debug("CAIHF check success addr  = %x\n",CROSSTALK_START_ADDR);
	ct_flag = 1;
