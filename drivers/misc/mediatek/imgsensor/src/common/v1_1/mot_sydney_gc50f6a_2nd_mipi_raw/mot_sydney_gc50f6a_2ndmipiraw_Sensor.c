...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
	...
	{ 4096, 3072, 0, 0, 4096, 3072, 2048, 1536, 0, 192, 2048, 1152, 0, 0, 2048, 1152},/* slim video */
...
kal_uint16 mot_sydney_gc50f6a_2nd_2048x1152_slim_data[] = {
0x0315,0x80,
0x0fe2,0x17,
0x0fa2,0x03,
0x0900,0x10,
...
{
	pr_debug("[%s] slim_video_Start, 2048x1152@60fps\n", __func__);
	table_write_cmos_sensor(mot_sydney_gc50f6a_2nd_2048x1152_slim_data,
		sizeof(mot_sydney_gc50f6a_2nd_2048x1152_slim_data)/sizeof(kal_uint16));
	ratio = 1;
...
{
	pr_debug("[%s] custom_Start, 2048x1536@30fps\n", __func__);
