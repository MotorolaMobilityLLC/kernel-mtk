 ...
 *
 ****************************************************************************/
#ifndef _MOT_VICKY_S5KHM6MIPI_SENSOR_H
#define _MOT_VICKY_S5KHM6MIPI_SENSOR_H
...
struct VICKY_S5KHM6_eeprom_t{
	...
	uint8_t dcc_crc[2];
	//QCOM PD OFFSET
	uint8_t pd_offset[198];
	uint8_t pd_offset_crc[2];
	//MTK LSC
	...
	//AF Posture
	uint8_t af_comp_data[19];
	uint8_t af_comp_crc[2];
};
