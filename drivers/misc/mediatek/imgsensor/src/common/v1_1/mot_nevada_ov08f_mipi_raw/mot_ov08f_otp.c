...
{
	struct NEVADA_OV08F_otp_t *otp = (struct NEVADA_OV08F_otp_t*)data;
...
mot_calibration_status_t *NEVADA_OV08F_otp_get_calibration_status(void)
{
	return &calibration_status;
}

mot_calibration_mnf_t *NEVADA_OV08F_otp_get_mnf_info(void)
{
	return &mnf_info;
}
...
{
	struct NEVADA_OV08F_otp_t *otp = (struct NEVADA_OV08F_otp_t*)g_otpMemoryData;
