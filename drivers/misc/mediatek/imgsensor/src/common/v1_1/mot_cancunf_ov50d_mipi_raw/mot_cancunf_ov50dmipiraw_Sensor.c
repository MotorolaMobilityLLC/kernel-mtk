 ...
 * Filename:
 * ---------
 *	 mot_cancunf_ov50dmipi_Sensor.c
 *
 * Project:
 * --------
 *	 MTK SOP
 ...
 *============================================================================
 ****************************************************************************/
#define PFX "MOT_CANCUNF_OV50D_camera_sensor"
...
#include "mot_cancunf_ov50dmipiraw_Sensor.h"
#include "mot_cancunf_ov50d_Sensor_setting.h"
#include "mot_cancunf_ov50d_ana_gain_table.h"

extern mot_calibration_status_t *CANCUNF_OV50D_eeprom_get_calibration_status(void);
...
#define OV50D_MAX_GAIN_FULLSIZE_PLATFORM 2040        /*15.9375*128, 128 GAINBASE*/
...
#define FULLSIZE_MODE 1
#define FPS60_MODE 2
#define FPS120_MODE 3
static int sensor_mode = 0;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_CANCUNF_OV50D_SENSOR_ID,
	...
	.i2c_addr_table = {0x20, 0x44, 0x6c, 0x46, 0xff},
	.i2c_speed = 1000,
};
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[1]=
{
	{0x02, 0x0A,   0x00,   0x08, 0x40, 0x00,
	 ...
	 0x01, 0x2B, 0x03F0, 0x02F8, 0x03, 0x00, 0x0000, 0x0000
	},
};
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
	...
	.i4SubBlkW  =8,
	.i4SubBlkH  =4,
	.i4PosL = {{40, 17},{48, 17},{36, 21},{44, 21},{40, 25},{48, 25},{36, 29},{44, 29}},
	.i4PosR = {{39, 17},{47, 17},{35, 21},{43, 21},{39, 25},{47, 25},{35, 29},{43, 29}},
	.iMirrorFlip = 0,
	.i4BlockNumX = 252,
	.i4BlockNumY = 190,
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if(sensor_mode == FULLSIZE_MODE) {
		max_gain = OV50D_MAX_GAIN_FULLSIZE_PLATFORM;
	}
...
{
	pr_debug("MOT CANCUNF OV50D preview_setting start\n");
	...
	pr_debug("MOT CANCUNF OV50D preview_setting end\n");
...
{
	pr_debug("MOT CANCUNF OV50D capture_setting start\n");
	mot_cancunf_ov50d_table_write_cmos_sensor(addr_data_pair_preview_mot_cancunf_ov50d,
		sizeof(addr_data_pair_preview_mot_cancunf_ov50d)/sizeof(kal_uint16));

	pr_debug("MOT CANCUNF OV50D capture_setting end\n");
}

static void normal_video_setting(kal_uint16 currefps)
{
	pr_debug("MOT CANCUNF OV50D normal_video_setting start\n");
	...
	pr_debug("MOT CANCUNF OV50D normal_video_setting end\n");
}

static void hs_video_setting(void)
{
	pr_debug("MOT CANCUNF OV50D hs_video_setting start\n");

	mot_cancunf_ov50d_table_write_cmos_sensor(addr_data_pair_120fps_ov50d40,
		sizeof(addr_data_pair_120fps_ov50d40)/sizeof(kal_uint16));

	pr_debug("MOT CANCUNF OV50D hs_video_setting end\n");
}
...
{
	pr_debug("MOT CANCUNF OV50D custom1_setting start\n");

	mot_cancunf_ov50d_table_write_cmos_sensor(addr_data_pair_fullsize_ov50d40,
		sizeof(addr_data_pair_fullsize_ov50d40)/sizeof(kal_uint16));
	pr_debug("OV50D40 custom1_setting end\n");
}
static void custom2_setting(void)
{
	pr_debug("OV50D40 custom2_setting start\n");
	mot_cancunf_ov50d_table_write_cmos_sensor(addr_data_pair_60fps_ov50d40,
		sizeof(addr_data_pair_60fps_ov50d40)/sizeof(kal_uint16));
	pr_debug("OV50D40 custom2_setting end\n");
}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				CANCUNF_OV50D_eeprom_format_calibration_data(&imgsensor);
				return ERROR_NONE;
			}
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	memcpy(&sensor_info->calibration_status, CANCUNF_OV50D_eeprom_get_calibration_status(), sizeof(mot_calibration_status_t));
	memcpy(&sensor_info->mnf_calibration, CANCUNF_OV50D_eeprom_get_mnf_info(), sizeof(mot_calibration_mnf_t));
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable) {
		...
		write_cmos_sensor_8(0x4308, 0x01);

	} else {
		write_cmos_sensor_8(0x3019, 0xd2);
		write_cmos_sensor_8(0x4308, 0x00);
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_GAIN_RANGE_BY_SCENARIO:
		...
		*(feature_data + 2) = imgsensor_info.max_gain;
		...
		if(sensor_mode == FULLSIZE_MODE) {
			*(feature_data + 2) = imgsensor_info.max_gain_fullsize;
		}
		if(sensor_mode == FPS60_MODE) {
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((*(feature_data + 0)) == 0) {
			*(feature_data + 0) =
				sizeof(mot_cancunf_ov50d_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)mot_cancunf_ov50d_ana_gain_table,
			sizeof(mot_cancunf_ov50d_ana_gain_table));
		}
		break;
	case SENSOR_FEATURE_GET_MIN_SHUTTER_BY_SCENARIO:
		...
		*(feature_data + 2) = imgsensor_info.exp_step_fullsize;
			break;
...
UINT32 MOT_CANCUNF_OV50D_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	return ERROR_NONE;
} /* MOT_CANCUNF_OV50D_MIPI_RAW_SensorInit */
