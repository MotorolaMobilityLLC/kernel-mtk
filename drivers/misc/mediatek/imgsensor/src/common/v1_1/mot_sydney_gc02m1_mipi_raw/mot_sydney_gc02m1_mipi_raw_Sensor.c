 ...
 * Filename:
 * ---------
 *     mot_sydney_gc02m1mipi_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
 ...
 *============================================================================
 */
#define PFX "mot_sydney_gc02m1_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_SYDNEY_GC02M1_SENSOR_ID,
...
static void mot_sydney_gc02m1_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	else if (reg_gain > MOT_SYDNEY_GC02M1_SENSOR_GAIN_MAX)
		reg_gain = MOT_SYDNEY_GC02M1_SENSOR_GAIN_MAX;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 MOT_SYDNEY_GC02M1_AGC_Param[MOT_SYDNEY_GC02M1_SENSOR_GAIN_MAX_VALID_INDEX][2] = {
		{  1024,  0 },
		{  1536,  1 },
		{  2035,  2 },
		{  2519,  3 },
	...
	for (gain_index = MOT_SYDNEY_GC02M1_SENSOR_GAIN_MAX_VALID_INDEX - 1; gain_index >= 0; gain_index--)
		if (reg_gain >= MOT_SYDNEY_GC02M1_AGC_Param[gain_index][0])
			break;

	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xb6, MOT_SYDNEY_GC02M1_AGC_Param[gain_index][1]);
	temp_gain = reg_gain * MOT_SYDNEY_GC02M1_SENSOR_DGAIN_BASE / MOT_SYDNEY_GC02M1_AGC_Param[gain_index][0];
	write_cmos_sensor(0xb1, (temp_gain >> 8) & 0x1f);
	write_cmos_sensor(0xb2, temp_gain & 0xff);
	LOG_INF("MOT_SYDNEY_GC02M1_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
		MOT_SYDNEY_GC02M1_AGC_Param[gain_index][1], temp_gain, reg_gain);
...
kal_uint16 addr_data_pair_init_mot_sydney_gc02m1[] = {
	/*system*/
	0xfc, 0x01,
	0xf4, 0x41,
...
kal_uint16 addr_data_pair_preview_mot_sydney_gc02m1[] = {
	0xfe, 0x00,
};

kal_uint16 addr_data_pair_capture_mot_sydney_gc02m1[] = {
	0xfe, 0x00,
};

kal_uint16 addr_data_pair_normal_video_mot_sydney_gc02m1[] = {
	0xfc, 0x01,
	0xf4, 0x41,
	0xf5, 0xe3,
	0xf6, 0x44,
...
kal_uint16 addr_data_pair_hs_video_mot_sydney_gc02m1[] = {
	0xfe, 0x00,
};

kal_uint16 addr_data_pair_slim_video_mot_sydney_gc02m1[] = {
	0xfe, 0x00,
};
...
static void sensor_init(void)
{
	...
	mot_sydney_gc02m1_table_write_cmos_sensor(
		addr_data_pair_init_mot_sydney_gc02m1,
		sizeof(addr_data_pair_init_mot_sydney_gc02m1) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	mot_sydney_gc02m1_table_write_cmos_sensor(
		addr_data_pair_preview_mot_sydney_gc02m1,
		sizeof(addr_data_pair_preview_mot_sydney_gc02m1) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	mot_sydney_gc02m1_table_write_cmos_sensor(
		addr_data_pair_capture_mot_sydney_gc02m1,
		sizeof(addr_data_pair_capture_mot_sydney_gc02m1) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	mot_sydney_gc02m1_table_write_cmos_sensor(
		addr_data_pair_normal_video_mot_sydney_gc02m1,
		sizeof(addr_data_pair_normal_video_mot_sydney_gc02m1) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	mot_sydney_gc02m1_table_write_cmos_sensor(
		addr_data_pair_hs_video_mot_sydney_gc02m1,
		sizeof(addr_data_pair_hs_video_mot_sydney_gc02m1) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	mot_sydney_gc02m1_table_write_cmos_sensor(
		addr_data_pair_slim_video_mot_sydney_gc02m1,
		sizeof(addr_data_pair_slim_video_mot_sydney_gc02m1) /
		sizeof(kal_uint16));
}
