 ...
 * Filename:
 * ---------
 *	 mot_sbuya_imx882mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "MOT_SBUYA_IMX882_camera_sensor"
/****************************   Modify end	**************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_SBUYA_IMX882_SENSOR_ID,
		...
		do {
			*sensor_id = (((read_cmos_sensor_8(0x0016) << 8)
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				SBUYA_IMX882_eeprom_format_calibration_data(&imgsensor);
				return ERROR_NONE;
			}
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	memcpy(&sensor_info->calibration_status, SBUYA_IMX882_eeprom_get_calibration_status(), sizeof(mot_calibration_status_t));
	memcpy(&sensor_info->mnf_calibration, SBUYA_IMX882_eeprom_get_mnf_info(), sizeof(mot_calibration_mnf_t));
...
UINT32 MOT_SBUYA_IMX882_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
...
} /* MOT_SBUYA_IMX882_MIPI_RAW_SensorInit */
