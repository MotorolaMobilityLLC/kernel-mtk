 ...
 *
 ****************************************************************************/
#ifndef _S5K3L6BACKUPMIPI_SENSOR_H
#define _S5K3L6BACKUPMIPI_SENSOR_H
...
#define S5K3L6_BACKUP_EEPROM_CRC_MANUFACTURING_SIZE (37)
#define S5K3L6_BACKUP_EEPROM_CRC_AF_CAL_SIZE (24)

#define S5K3L6_BACKUP_EEPROM_CRC_AWB_CAL_SIZE (43)
#define S5K3L6_BACKUP_EEPROM_CRC_LSC_SIZE (1868)
#define S5K3L6_BACKUP_EEPROM_CRC_PDAF_OUTPUT1_SIZE (496)
#define S5K3L6_BACKUP_EEPROM_CRC_PDAF_OUTPUT2_SIZE (918)
...
extern void kdSetI2CSpeed(u16 i2cSpeed);
//extern bool S5K3L6_backup_read_eeprom( kal_uint16 addr, BYTE* data, kal_uint32 size);
#endif
