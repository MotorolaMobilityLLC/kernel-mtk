 ...
 * Filename:
 * ---------
 *	 mot_orlando_s5kkdsmipi_Sensor.c
 *
 * Project:
 * --------
 *	 MTK SOP
 ...
 *============================================================================
 ****************************************************************************/
#define PFX "MOT_ORLANDO_S5KKDS_camera_sensor"
...
#include "mot_orlando_s5kkdsmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_ORLANDO_S5KKDS_SENSOR_ID,
...
kal_uint16 mot_orlando_s5kkds_burst_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
#if MULTI_WRITE
kal_uint16 mot_orlando_s5kkds_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
{
	pr_debug("MOT ORLANDO S5KKDS init start\n");
	...
	mot_orlando_s5kkds_burst_write_cmos_sensor(addr_data_pair_init_mot_orlando_s5kkds_part1,
		sizeof(addr_data_pair_init_mot_orlando_s5kkds_part1)/sizeof(kal_uint16));
	mot_orlando_s5kkds_burst_write_cmos_sensor(addr_data_pair_init_mot_orlando_s5kkds_part2,
		sizeof(addr_data_pair_init_mot_orlando_s5kkds_part2)/sizeof(kal_uint16));
	mot_orlando_s5kkds_table_write_cmos_sensor(addr_data_pair_init_mot_orlando_s5kkds_part3,
		sizeof(addr_data_pair_init_mot_orlando_s5kkds_part3)/sizeof(kal_uint16));
	pr_debug("MOT ORLANDO S5KKDS init end\n");
/*	if (xtc_data_valid == 1)
		write_xtc_data();
	pr_debug("MOT ORLANDO S5KKDS init end\n");
*/
...
{
	pr_debug("MOT ORLANDO S5KKDS preview_setting start\n");

	mot_orlando_s5kkds_table_write_cmos_sensor(addr_data_pair_preview_mot_orlando_s5kkds,
		sizeof(addr_data_pair_preview_mot_orlando_s5kkds)/sizeof(kal_uint16));

	pr_debug("MOT ORLANDO S5KKDS preview_setting end\n");
...
{
	pr_debug("MOT ORLANDO S5KKDS capture_setting start\n");
	mot_orlando_s5kkds_table_write_cmos_sensor(addr_data_pair_preview_mot_orlando_s5kkds,
		sizeof(addr_data_pair_preview_mot_orlando_s5kkds)/sizeof(kal_uint16));

	pr_debug("MOT ORLANDO S5KKDS capture_setting end\n");
}

static void normal_video_setting(kal_uint16 currefps)
{
	pr_debug("MOT ORLANDO S5KKDS normal_video_setting start\n");

	mot_orlando_s5kkds_table_write_cmos_sensor(addr_data_pair_normal_video_mot_orlando_s5kkds,
		sizeof(addr_data_pair_normal_video_mot_orlando_s5kkds)/sizeof(kal_uint16));

	pr_debug("MOT ORLANDO S5KKDS normal_video_setting end\n");
}

static void hs_video_setting(void)
{
	pr_debug("MOT ORLANDO S5KKDS hs_video_setting start\n");

	mot_orlando_s5kkds_table_write_cmos_sensor(addr_data_pair_hs_video_mot_orlando_s5kkds,
		sizeof(addr_data_pair_hs_video_mot_orlando_s5kkds)/sizeof(kal_uint16));

	pr_debug("MOT ORLANDO S5KKDS hs_video_setting end\n");
}

static void slim_video_setting(void)
{
	pr_debug("MOT ORLANDO S5KKDS slim_video_setting start\n");

	mot_orlando_s5kkds_table_write_cmos_sensor(addr_data_pair_preview_mot_orlando_s5kkds,
		sizeof(addr_data_pair_preview_mot_orlando_s5kkds)/sizeof(kal_uint16));

	pr_debug("MOT ORLANDO S5KKDS slim_video_setting end\n");
}
...
UINT32 MOT_ORLANDO_S5KKDS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	return ERROR_NONE;
} /* MOT_ORLANDO_S5KKDS_MIPI_RAW_SensorInit */
