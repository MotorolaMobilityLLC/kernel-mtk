 ...
 * Filename:
 * ---------
 *	 mot_orlando_ov50dmipi_Sensor.c
 *
 * Project:
 * --------
 *	 MTK SOP
 ...
 *============================================================================
 ****************************************************************************/
#define PFX "MOT_ORLANDO_OV50D_camera_sensor"
...
#include "mot_orlando_ov50dmipiraw_Sensor.h"
#include "mot_orlando_ov50d_Sensor_setting.h"
#include "mot_orlando_ov50d_ana_gain_table.h"

extern int aw86006_update_fw_sync(void);

extern mot_calibration_status_t *ORLANDO_OV50D_eeprom_get_calibration_status(void);
extern mot_calibration_mnf_t *ORLANDO_OV50D_eeprom_get_mnf_info(void);
extern void ORLANDO_OV50D_eeprom_format_calibration_data(struct imgsensor_struct *pImgsensor);

extern void write_pdc_data_orlando(void);
extern int pdc_data_valid_orlando;
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MOT_ORLANDO_OV50D_SENSOR_ID,
...
/*
static uint8_t mot_orlando_ov50d_read_actuator_id_from_eeprom(kal_uint8 slave, kal_uint16 eeprom_addr)
{
...
kal_uint16 mot_orlando_ov50d_burst_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
kal_uint16 mot_orlando_ov50d_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
	char puSendCmd[I2C_BUFFER_LEN];
	kal_uint32 tosend, IDX;
...
{
	pr_debug("MOT ORLANDO OV50D init start\n");

	mot_orlando_ov50d_table_write_cmos_sensor(addr_data_pair_init_mot_orlando_ov50d_part1,
		sizeof(addr_data_pair_init_mot_orlando_ov50d_part1)/sizeof(kal_uint16));

	if (pdc_data_valid_orlando == 1) {
		write_pdc_data_orlando();
	}
	else
	{
		mot_orlando_ov50d_burst_write_cmos_sensor(addr_data_pair_init_mot_orlando_ov50d_part2,
		sizeof(addr_data_pair_init_mot_orlando_ov50d_part2)/sizeof(kal_uint16));
	}

	mot_orlando_ov50d_table_write_cmos_sensor(addr_data_pair_init_mot_orlando_ov50d_part3,
		sizeof(addr_data_pair_init_mot_orlando_ov50d_part3)/sizeof(kal_uint16));
	mot_orlando_ov50d_burst_write_cmos_sensor(addr_data_pair_init_mot_orlando_ov50d_part4,
		sizeof(addr_data_pair_init_mot_orlando_ov50d_part4)/sizeof(kal_uint16));
	mot_orlando_ov50d_table_write_cmos_sensor(addr_data_pair_init_mot_orlando_ov50d_part5,
		sizeof(addr_data_pair_init_mot_orlando_ov50d_part5)/sizeof(kal_uint16));
	mot_orlando_ov50d_burst_write_cmos_sensor(addr_data_pair_init_mot_orlando_ov50d_part6,
		sizeof(addr_data_pair_init_mot_orlando_ov50d_part6)/sizeof(kal_uint16));
	mot_orlando_ov50d_table_write_cmos_sensor(addr_data_pair_init_mot_orlando_ov50d_part7,
		sizeof(addr_data_pair_init_mot_orlando_ov50d_part7)/sizeof(kal_uint16));

	pr_debug("MOT ORLANDO OV50D init end\n");

}	/*	  sensor_init  */

static void preview_setting(void)
{
	pr_debug("MOT ORLANDO OV50D preview_setting start\n");

	mot_orlando_ov50d_table_write_cmos_sensor(addr_data_pair_preview_mot_orlando_ov50d,
		sizeof(addr_data_pair_preview_mot_orlando_ov50d)/sizeof(kal_uint16));

	pr_debug("MOT ORLANDO OV50D preview_setting end\n");
...
{
	pr_debug("MOT ORLANDO OV50D capture_setting start\n");
	mot_orlando_ov50d_table_write_cmos_sensor(addr_data_pair_preview_mot_orlando_ov50d,
		sizeof(addr_data_pair_preview_mot_orlando_ov50d)/sizeof(kal_uint16));

	pr_debug("MOT ORLANDO OV50D capture_setting end\n");
}

static void normal_video_setting(kal_uint16 currefps)
{
	pr_debug("MOT ORLANDO OV50D normal_video_setting start\n");

	mot_orlando_ov50d_table_write_cmos_sensor(addr_data_pair_normal_video_mot_orlando_ov50d,
		sizeof(addr_data_pair_normal_video_mot_orlando_ov50d)/sizeof(kal_uint16));

	pr_debug("MOT ORLANDO OV50D normal_video_setting end\n");
}

static void hs_video_setting(void)
{
	pr_debug("MOT ORLANDO OV50D hs_video_setting start\n");

	mot_orlando_ov50d_table_write_cmos_sensor(addr_data_pair_120fps_ov50d_orlando,
		sizeof(addr_data_pair_120fps_ov50d_orlando)/sizeof(kal_uint16));

	pr_debug("MOT ORLANDO OV50D hs_video_setting end\n");
}

static void slim_video_setting(void)
{
	pr_debug("MOT ORLANDO OV50D slim_video_setting start\n");

	mot_orlando_ov50d_table_write_cmos_sensor(addr_data_pair_preview_mot_orlando_ov50d,
		sizeof(addr_data_pair_preview_mot_orlando_ov50d)/sizeof(kal_uint16));

	pr_debug("MOT ORLANDO OV50D slim_video_setting end\n");
}

static void custom1_setting(void)
{
	pr_debug("MOT ORLANDO OV50D custom1_setting start\n");
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				ORLANDO_OV50D_eeprom_format_calibration_data(&imgsensor);
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	memcpy(&sensor_info->mnf_calibration, ORLANDO_OV50D_eeprom_get_mnf_info(), sizeof(mot_calibration_mnf_t));
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((*(feature_data + 0)) == 0) {
			*(feature_data + 0) =
				sizeof(mot_orlando_ov50d_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)mot_orlando_ov50d_ana_gain_table,
			sizeof(mot_orlando_ov50d_ana_gain_table));
		}
		break;
...
UINT32 MOT_ORLANDO_OV50D_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	return ERROR_NONE;
} /* MOT_ORLANDO_OV50D_MIPI_RAW_SensorInit */
