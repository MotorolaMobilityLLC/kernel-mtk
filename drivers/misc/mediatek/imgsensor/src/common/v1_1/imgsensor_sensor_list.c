...
#endif
//add lisbon sensor begin
#if defined(MOT_LISBON_OV64B40_MIPI_RAW)
{OV64B40_SENSOR_ID, SENSOR_DRVNAME_MOT_LISBON_OV64B40_MIPI_RAW,
	MOT_LISBON_OV64B40_MIPI_RAW_SensorInit},
#endif
#if defined(MOT_LISBON_OV16A1Q_MIPI_RAW)
{OV16A1Q_SENSOR_ID, SENSOR_DRVNAME_MOT_LISBON_OV16A1Q_MIPI_RAW,
	MOT_LISBON_OV16A1Q_MIPI_RAW_SensorInit},
#endif
#if defined(MOT_LISBON_OV02B1B_MIPI_RAW)
{OV02B1B_SENSOR_ID, SENSOR_DRVNAME_MOT_LISBON_OV02B1B_MIPI_RAW,
	MOT_LISBON_OV02B1B_MIPI_RAW_SensorInit},
#endif
#if defined(MOT_LISBON_S5K4H7_MIPI_RAW)
{S5K4H7YX03_SENSOR_ID, SENSOR_DRVNAME_MOT_LISBON_S5K4H7_MIPI_RAW,
	MOT_LISBON_S5K4H7_MIPI_RAW_SensorInit},
#endif
#if defined(MOT_LISBON_S5K5E9_MIPI_RAW)
{S5K5E9YX04_SENSOR_ID, SENSOR_DRVNAME_MOT_LISBON_S5K5E9_MIPI_RAW,
	MOT_LISBON_S5K5E9_MIPI_RAW_SensorInit},
#endif
//add lisbon sensor end
