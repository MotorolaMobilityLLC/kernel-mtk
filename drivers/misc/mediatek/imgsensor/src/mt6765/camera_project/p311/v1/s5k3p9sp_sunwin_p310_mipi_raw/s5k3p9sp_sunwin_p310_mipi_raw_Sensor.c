...
#include "s5k3p9sp_sunwin_p310_mipi_raw_Sensor.h"
...
#define PFX "s5k3p9sp_sunwin_p310_mipi_raw_Sensor"
...
static imgsensor_info_struct imgsensor_info = {
		.sensor_id = S5K3P9SP_SUNWIN_P310_SENSOR_ID,
...
static void burst_read_to_check(void)
{
	...
	for(i = 0; i < (u16)sizeof(uTnpArrayA)/2; i++)
	{
...
UINT32 S5K3P9SP_SUNWIN_P310_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
