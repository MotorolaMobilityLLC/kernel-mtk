...
#include "hi1336_qtech_p410ae_mipiraw_Sensor.h"

#define PFX "hi1336_qtech_p410ae_camera_sensor"
...
// bool read_hi1336_qtech_p410ae_eeprom( kal_uint16 addr, BYTE *data, kal_uint32 size); 
...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI1336_QTECH_P410AE_SENSOR_ID,
...
static kal_uint16 hi1336_qtech_p410ae_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi1336_qtech_p410ae[] = {
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
...
LOG_INF("LZH sensor_init");
	hi1336_qtech_p410ae_table_write_cmos_sensor(
		addr_data_pair_init_hi1336_qtech_p410ae,
		sizeof(addr_data_pair_init_hi1336_qtech_p410ae) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_hi1336_qtech_p410ae[] = {
...
LOG_INF("LZH %s",__func__);
	hi1336_qtech_p410ae_table_write_cmos_sensor(
		addr_data_pair_preview_hi1336_qtech_p410ae,
		sizeof(addr_data_pair_preview_hi1336_qtech_p410ae) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_30fps_hi1336_qtech_p410ae[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
kal_uint16 addr_data_pair_capture_15fps_hi1336_qtech_p410ae[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	hi1336_qtech_p410ae_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi1336_qtech_p410ae,
		sizeof(addr_data_pair_capture_30fps_hi1336_qtech_p410ae) /
		sizeof(kal_uint16));

	} else {
	hi1336_qtech_p410ae_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_hi1336_qtech_p410ae,
		sizeof(addr_data_pair_capture_15fps_hi1336_qtech_p410ae) /
		sizeof(kal_uint16));
	}
#else
  if( currefps == 300) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_hi1336_qtech_p410ae[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
	0x0732, 0xe0b0, //pll_cfg_mipi_b b13-11:100_isp_div1(1/5) b10-8:000_mipi_div1(1/1) b1-0:00_mipi_div2(1/1) 
	0x1118, 0x0006, //LSC r_win_y B[11]: Bit8 of y offset in start block when cropping. B[10:8] y start index of block when cropping. B[7:0] y offset in start block when cropping.
...
#if MULTI_WRITE
	hi1336_qtech_p410ae_table_write_cmos_sensor(
		addr_data_pair_video_hi1336_qtech_p410ae,
		sizeof(addr_data_pair_video_hi1336_qtech_p410ae) /
		sizeof(kal_uint16));
#else
	  write_cmos_sensor(0x3250, 0xa060); //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	  write_cmos_sensor(0x0730, 0x770f); //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi1336_qtech_p410ae[] = {
	0x3250, 0xa470, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
#if MULTI_WRITE
	hi1336_qtech_p410ae_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi1336_qtech_p410ae,
		sizeof(addr_data_pair_hs_video_hi1336_qtech_p410ae) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi1336_qtech_p410ae[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
#if MULTI_WRITE
	hi1336_qtech_p410ae_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi1336_qtech_p410ae,
		sizeof(addr_data_pair_slim_video_hi1336_qtech_p410ae) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x3250, 0xa060); //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	write_cmos_sensor(0x0730, 0x770f); //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
static kal_uint32 open(void)
{
	...
	LOG_INF("lzh [open]: hi1336_qtech_p410ae@MT6765,MIPI 4LANE\n");
...
/*#if e2prom
		...
		read_hi1336_qtech_p410ae_eeprom((kal_uint16)(*feature_data), 
				(char *)(uintptr_t)(*(feature_data+1)), 
				(kal_uint32)(*(feature_data+2)) );
...
UINT32 HI1336_QTECH_P410AE_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
