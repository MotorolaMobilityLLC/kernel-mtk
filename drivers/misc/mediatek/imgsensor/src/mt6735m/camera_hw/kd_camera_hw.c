...
#define VOL_1000 1000000
	...
	if (On) {
		...
		else if (1 == pinSetIdx && currSensorName && (0 == strcmp(SENSOR_DRVNAME_C2590_MIPI_RAW, currSensorName)))
		{
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN,
		...
		else if (1 == pinSetIdx && currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2509_MIPI_RAW, currSensorName)))
		{
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN,
		...
		else if (1 == pinSetIdx && currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2375_MIPI_RAW, currSensorName))){
			/* VCAM_IO */
			if (TRUE != _hwPowerOnCnt(VCAMIO, VOL_1800, mode_name)) {
				PK_DBG("[CAMERA SENSOR] Fail to enable IO power (VCAM_IO),power id = %d\n", VCAMIO);
				goto _kdCISModulePowerOn_exit_;
