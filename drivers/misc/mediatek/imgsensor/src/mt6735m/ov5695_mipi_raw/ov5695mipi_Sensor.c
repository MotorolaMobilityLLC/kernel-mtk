...
void OV5695_Sensor_Init_Powerup(void)
{
	printk("OV5695 ==>sensor_init_powerup enter+\n");
...
//;mipi_datarate per lane: 840Mbps
		...
		write_cmos_sensor(0x3635, 0x0c);
		write_cmos_sensor(0x3636, 0x0c);
		write_cmos_sensor(0x3638, 0x11);
		write_cmos_sensor(0x3639, 0x15);
		write_cmos_sensor(0x363a, 0x1f);
		write_cmos_sensor(0x363b, 0x1f);
		write_cmos_sensor(0x363c, 0xff);
		write_cmos_sensor(0x363d, 0xfa);
		write_cmos_sensor(0x3650, 0x44);
		write_cmos_sensor(0x3651, 0x44);
		...
		write_cmos_sensor(0x3c88, 0x00);
		write_cmos_sensor(0x3d85, 0x14);
		write_cmos_sensor(0x3f02, 0x02);
		write_cmos_sensor(0x3f03, 0x04);
		write_cmos_sensor(0x4008, 0x02);
		write_cmos_sensor(0x4009, 0x09);
		write_cmos_sensor(0x404e, 0x20);
		write_cmos_sensor(0x4501, 0x00);
	...
	printk("OV5695 ==>sensor_init_powerup exit-\n");
}	/*	sensor_init_powerup  */
...
*/
	while(i<6)
	{
		temp = read_cmos_sensor(0x3811+2*i);
		printk("sensorDebug:%s,0x3811+%d = 0x%x\n",__FUNCTION__,2*i,temp);
		i++;
	}
