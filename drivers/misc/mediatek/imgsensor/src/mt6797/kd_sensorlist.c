...
#define PK_INF(fmt, args...)	printk(PFX "[%s] " fmt, __FUNCTION__, ##args)
#define PK_DBG(fmt, args...)	printk(fmt, ##args)
#define PK_ERR(fmt, args...)		printk(fmt, ##args)
#define PK_XLOG_INFO(fmt, args...)  printk(fmt, ##args)
