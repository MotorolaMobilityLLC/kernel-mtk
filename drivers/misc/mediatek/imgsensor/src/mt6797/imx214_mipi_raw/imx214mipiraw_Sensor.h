...
typedef struct imgsensor_info_struct {
	...
	imgsensor_mode_struct custom1;  //preview/captuure scenario for VSDoF 24fps relative information
	imgsensor_mode_struct custom2;  //video scenario for VSDoF 24fps relative information
