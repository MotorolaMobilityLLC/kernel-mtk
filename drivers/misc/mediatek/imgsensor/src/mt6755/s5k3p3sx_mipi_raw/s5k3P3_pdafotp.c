...
#define S5K3P3_EEPROM_READ_ID  0xA0
...
//if((s5k3P3_eeprom_data[0] != 1) || (s5k3P3_eeprom_data[498] != 1) || (s5k3P3_eeprom_data[1306] != 1))
	if((s5k3P3_eeprom_data[0] != 1) || (s5k3P3_eeprom_data[498] != 1))
	{
	...
	{
		data[i] = s5k3P3_eeprom_data[i+1];
	}

	for(i = 496; i < 1404; i++)  // proc2 data
	{
		data[i] = s5k3P3_eeprom_data[i+3];
	}	
