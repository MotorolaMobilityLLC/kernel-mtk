...
//lenovo.sw START wuyt3 config k52 2nd front camera
UINT32 OV8865_SUNNY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
//lenovo.sw END wuyt3 config k52 2nd front camera
...
//lenovo.sw START huangsh4 config kungfu 2nd front camera
UINT32 S5K3P3SX_OFILM_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
//lenovo.sw END huangsh4 config kungfu 2nd front camera
UINT32 S5K3M2_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
//lenovo.sw START wuyt3 config k52 2nd camera
UINT32 S5K3M2_SUNNY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
//lenovo.sw END wuyt3 config k52 2nd camera
...
#endif
//lenovo.sw START huangsh4 config kungfu 2nd front camera
#if defined(IMX219_OFILM_MIPI_RAW)
...
#endif
//lenovo.sw START wuyt3 add k52 2nd camera 
...
#endif
//lenovo.sw END  wuyt3 add k52 2nd camera
#if defined(S5K3P3SX_MIPI_RAW)
    {S5K3P3SX_SENSOR_ID, SENSOR_DRVNAME_S5K3P3SX_MIPI_RAW, S5K3P3SX_MIPI_RAW_SensorInit},
#endif
//lenovo.sw START huangsh4 add kungfu 2nd camera 
#if defined(S5K3P3SX_MIPI_RAW)
    {S5K3P3SX_OFILM_SENSOR_ID, SENSOR_DRVNAME_S5K3P3SX_OFILM_MIPI_RAW, S5K3P3SX_MIPI_RAW_SensorInit},
#endif
//end
