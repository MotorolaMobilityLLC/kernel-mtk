...
/*lenovo-sw caoyi1 modify A+G sensro iic address 20150928 begin*/
//the addr is an vitrual 7 bit address,the real iic address is (0xD6>>1)
//static struct i2c_board_info __initdata i2c_lsm6ds3_gyro={ I2C_BOARD_INFO(LSM6DS3_GYRO_DEV_NAME, 0x70)}; 
/*lenovo-sw caoyi1 modify A+G sensro iic address 20150928 end*/
...
#ifdef LSM6DS3_CALIB_HAL
static DRIVER_ATTR(gyroscope_cali_val_x,      S_IRUGO | S_IWUSR, show_cali_gyrox_value, store_cali_gyrox_value);
static DRIVER_ATTR(gyroscope_cali_val_y,      S_IRUGO | S_IWUSR, show_cali_gyroy_value, store_cali_gyroy_value);
static DRIVER_ATTR(gyroscope_cali_val_z,      S_IRUGO | S_IWUSR, show_cali_gyroz_value, store_cali_gyroz_value);
#endif
/*lenovo-sw caoyi1 add for Gyroscope APK calibration 20150513 end*/
/*lenovo-sw caoyi1 add for selftest function 20150708 begin*/
#ifdef LSM6DS3_FTM_ENABLE
