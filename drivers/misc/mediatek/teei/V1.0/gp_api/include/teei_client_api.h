...
TEEIC_Result TEEIC_InitializeContext(const char *name, TEEIC_Context *context);



void TEEIC_FinalizeContext(TEEIC_Context *context);

TEEIC_Result TEEIC_RegisterSharedMemory(TEEIC_Context *context, TEEIC_SharedMemory *sharedMem);


TEEIC_Result TEEIC_AllocateSharedMemory(TEEIC_Context *context, TEEIC_SharedMemory *sharedMem);


void TEEIC_ReleaseSharedMemory(TEEIC_SharedMemory *sharedMem);

TEEIC_Result TEEIC_OpenSession(TEEIC_Context *context,
...
void TEEIC_CloseSession(TEEIC_Session *session);

TEEIC_Result TEEIC_InvokeCommand(TEEIC_Session *session,
				uint32_t commandID,
				TEEIC_Operation *operation,
				uint32_t *returnOrigin);


void TEEIC_RequestCancellation(TEEIC_Operation *operation);
