...
extern int teei_client_close_session_for_service(void *private_data, struct teei_session *temp_ses);
extern int teei_client_service_exit(void *private_data);
extern void *__teei_client_map_mem(unsigned long dev_file_id, unsigned long size, unsigned long user_addr);
