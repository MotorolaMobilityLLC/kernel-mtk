...
static const char *const gM4U_SMILARB[] = {
	...
	"mediatek,smi_larb3", "mediatek,smi_larb5", "mediatek,smi_larb7",
	"mediatek,smi_larb8", "mediatek,smi_larb9", "mediatek,smi_larb10"
};
...
struct m4u_port_t gM4uPort[] = {
	...
	M4U0_PORT_INIT("DISP_OVL0_2L_HDR", 0, 0, 0, 2),
	M4U0_PORT_INIT("DISP_OVL0", 0, 0, 0, 3),
	M4U0_PORT_INIT("DISP_OVL0_2L", 0, 0, 0, 4),
	...
	/*larb1-MMSYS-14*/
	M4U0_PORT_INIT("DISP_OVL1_HDR", 0, 1, 4, 0),
	M4U0_PORT_INIT("DISP_OVL1_2L_HDR", 0, 1, 4, 1),
	M4U0_PORT_INIT("DISP_OVL1", 0, 1, 4, 2),
	...
	M4U0_PORT_INIT("IMGCI_D1", 0, 5, 16, 1),
	M4U0_PORT_INIT("DMGI_D1", 0, 5, 16, 2),
	M4U0_PORT_INIT("UFDI_D1", 0, 5, 16, 3),
	M4U0_PORT_INIT("LCE_D1", 0, 5, 16, 4),
	...
	M4U0_PORT_INIT("UFOYW", 0, 5, 16, 9),

	M4U0_PORT_INIT("UFOCW", 0, 5, 16, 10),
	M4U0_PORT_INIT("UFOYR", 0, 5, 16, 11),
	M4U0_PORT_INIT("UFOCR", 0, 5, 16, 12),
	M4U0_PORT_INIT("UFOY2R", 0, 5, 16, 13),
	M4U0_PORT_INIT("UFOC2R", 0, 5, 16, 14),
	M4U0_PORT_INIT("WPE_RDMA1", 0, 5, 16, 15),
	M4U0_PORT_INIT("WPE_RDMA0", 0, 5, 16, 16),
	M4U0_PORT_INIT("WPE_WDMA", 0, 5, 16, 17),
	M4U0_PORT_INIT("TIMGO_D1", 0, 5, 16, 18),
	M4U0_PORT_INIT("PVRYR", 0, 5, 16, 19),

	M4U0_PORT_INIT("PVRCR", 0, 5, 16, 20),
	M4U0_PORT_INIT("MFB_RDMA0", 0, 5, 16, 21),
	M4U0_PORT_INIT("MFB_RDMA1", 0, 5, 16, 22),
	M4U0_PORT_INIT("MFB_RDMA2", 0, 5, 16, 23),
	M4U0_PORT_INIT("MFB_RDMA3", 0, 5, 16, 24),
	M4U0_PORT_INIT("WDMA", 0, 5, 16, 25),
	...
	/*larb9-CAM-24*/
	M4U0_PORT_INIT("CAM_IMGO_C", 0, 9, 28, 0),
	M4U0_PORT_INIT("CAM_RRZO_C", 0, 9, 28, 1),
	M4U0_PORT_INIT("CAM_LSCI_C", 0, 9, 28, 2),
	M4U0_PORT_INIT("CAM_BPCI_C", 0, 9, 28, 3),
	M4U0_PORT_INIT("CAM_IMGCO_C", 0, 9, 28, 4),
	M4U0_PORT_INIT("CAM_PDI_C", 0, 9, 28, 5),
	M4U0_PORT_INIT("CAM_CRZO_C", 0, 9, 28, 6),
	M4U0_PORT_INIT("CAM_CRZO_R2_C", 0, 9, 28, 7),
	...
	M4U0_PORT_INIT("CAM_MQEO_C", 0, 9, 28, 14),
	M4U0_PORT_INIT("CAM_AFO_C", 0, 9, 28, 15),
	M4U0_PORT_INIT("CAM_PDO_C", 0, 9, 28, 16),
	M4U0_PORT_INIT("CAM_RAWI_C", 0, 9, 28, 17),
	M4U0_PORT_INIT("CAM_RAWI_R4_C", 0, 9, 28, 18),
	M4U0_PORT_INIT("CAM_LCESO_C", 0, 9, 28, 19),

	M4U0_PORT_INIT("CAM_RSSO_C", 0, 9, 28, 20),
	M4U0_PORT_INIT("CAM_CCUI", 0, 9, 28, 21),
	M4U0_PORT_INIT("CAM_CCUO", 0, 9, 28, 22),
	M4U0_PORT_INIT("CAM_FAKE", 0, 9, 28, 23),

	/*larb10-CAM-31*/
	M4U0_PORT_INIT("CAM_IMGO_A", 0, 10, 25, 0),
	M4U0_PORT_INIT("CAM_RRZO_A", 0, 10, 25, 1),
	M4U0_PORT_INIT("CAM_LSCI_A", 0, 10, 25, 2),
	M4U0_PORT_INIT("CAM_BPCI_A", 0, 10, 25, 3),
	M4U0_PORT_INIT("CAM_IMGCO_A", 0, 10, 25, 4),
	M4U0_PORT_INIT("CAM_PDI_A", 0, 10, 25, 5),
	M4U0_PORT_INIT("CAM_CRZO_A", 0, 10, 25, 6),
	M4U0_PORT_INIT("CAM_CRZO_R2_A", 0, 10, 25, 7),
	M4U0_PORT_INIT("CAM_IMGO_B", 0, 10, 25, 8),
	M4U0_PORT_INIT("CAM_RRZO_B", 0, 10, 25, 9),

	M4U0_PORT_INIT("CAM_LSCI_B", 0, 10, 25, 10),
	M4U0_PORT_INIT("CAM_BPCI_B", 0, 10, 25, 11),
	M4U0_PORT_INIT("CAM_IMGCO_B,", 0, 10, 25, 12),
	M4U0_PORT_INIT("CAM_PDI_B", 0, 10, 25, 13),
	M4U0_PORT_INIT("CAM_CRZO_B", 0, 10, 25, 14),
	M4U0_PORT_INIT("CAM_CRZO_R2_B", 0, 10, 25, 15),
	M4U0_PORT_INIT("CAM_CAMSV_0", 0, 10, 25, 16),
	M4U0_PORT_INIT("CAM_MQEO_A", 0, 10, 25, 17),
	M4U0_PORT_INIT("CAM_AFO_A", 0, 10, 25, 18),
	M4U0_PORT_INIT("CAM_PDO_A", 0, 10, 25, 19),

	M4U0_PORT_INIT("CAM_RAWI_A", 0, 10, 25, 20),
	M4U0_PORT_INIT("CAM_RAWI_R4_A", 0, 10, 25, 21),
	M4U0_PORT_INIT("CAM_MQEO_B", 0, 10, 25, 22),
	M4U0_PORT_INIT("CAM_AFO_B", 0, 10, 25, 23),
	M4U0_PORT_INIT("CAM_PDO_B", 0, 10, 25, 24),
	M4U0_PORT_INIT("CAM_RAWI_B", 0, 10, 25, 25),
	M4U0_PORT_INIT("CAM_RAWI_R4_B", 0, 10, 25, 26),
	M4U0_PORT_INIT("CAM_LCESO_A", 0, 10, 25, 27),
	M4U0_PORT_INIT("CAM_RSSO_A", 0, 10, 25, 28),
	M4U0_PORT_INIT("CAM_LCESO_B", 0, 10, 25, 29),
	M4U0_PORT_INIT("CAM_RSSO_B", 0, 10, 25, 30),
	/*larb11-CAM-5
