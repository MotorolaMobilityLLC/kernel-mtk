...
/* 6799 New Event */
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DSC1_SOF, 257, disp_dsc_sof_1)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DSC2_SOF, 258, disp_dsc_sof_2)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_RSZ0_SOF, 259, disp_rsz0_sof)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_RSZ1_SOF, 260, disp_rsz1_sof)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DSC0_EOF, 261, disp_dsc_frame_done_0)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DSC1_EOF, 262, disp_dsc_frame_done_1)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_RSZ0_EOF, 263, disp_rsz0_frame_done)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_RSZ1_EOF, 264, disp_rsz1_frame_done)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL0_RST_DONE, 265, disp_ovl0_frame_rst_done_pusle)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL1_RST_DONE, 266, disp_ovl1_frame_rst_done_pusle)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL0_2L_RST_DONE, 267, disp_ovl0_2l_frame_rst_done_pusle)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL1_2L_RST_DONE, 268, disp_ovl1_2l_frame_rst_done_pusle)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_MUTEX_REG_UPD_FOR_MODULE35, 269, disp_mutex_reg_upd_for_module35)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_MUTEX_REG_UPD_FOR_MODULE36, 270, disp_mutex_reg_upd_for_module36)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_MUTEX_REG_UPD_FOR_MODULE37, 271, disp_mutex_reg_upd_for_module37)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_MUTEX_REG_UPD_FOR_MODULE38, 272, disp_mutex_reg_upd_for_module38)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_WPE_A_EOF, 273, wpe_a_frame_done)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_EAF_EOF, 274, eaf_frame_done)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_VENC_BSDMA_FULL, 275, venc_bsdma_full)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_IPU0_EOF, 276, ipu_done_0)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_IPU1_EOF, 277, ipu_done_1)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_IPU2_EOF, 278, ipu_done_2)
DECLARE_CMDQ_EVENT(CMDQ_EVENT_IPU3_EOF, 279, ipu_done_3)
