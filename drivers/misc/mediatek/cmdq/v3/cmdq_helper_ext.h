...
typedef void (*cmdq_core_handle_begin)(struct cmdqRecStruct *handle);
typedef void (*cmdq_core_handle_end)(struct cmdqRecStruct *handle);

struct cmdq_core_handle_life {
	cmdq_core_handle_begin begin;
