...
#define CMDQ_THR_DELAY_START_CPR	(CMDQ_THR_FREE_CPR_MAX + 0)
#define CMDQ_THR_DELAY_DURATION_CPR	(CMDQ_THR_FREE_CPR_MAX + 1)
#define CMDQ_THR_DELAY_RESULT_CPR	(CMDQ_THR_FREE_CPR_MAX + 2)
#define CMDQ_THR_CPR_MAX			(CMDQ_THR_FREE_CPR_MAX + 3)
...
#define CMDQ_POLLING_TPR_MASK_VALUE	(10)
