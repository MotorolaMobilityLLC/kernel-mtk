...
void testcase_secure_meta_data(void)
{
	...
	/* record command */
	cmdq_op_write_reg(hReqMDP, CMDQ_TEST_GCE_DUMMY_PA, PATTERN_MDP, ~0);
	...
	/* record command */
	cmdq_op_write_reg(hReqDISP, CMDQ_TEST_GCE_DUMMY_PA, PATTERN_DISP, ~0);
