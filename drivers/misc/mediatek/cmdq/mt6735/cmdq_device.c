...
bool cmdq_dev_clock_is_enable_##FN_NAME(void)	\
{		\
	return cmdq_dev_device_clock_is_enable(gCmdqModuleClock.clk_##HW_NAME);	\
}
...
void cmdq_dev_init_module_PA_stat(void)
{
	...
	cmdq_dev_get_module_PA_by_name_stat("mediatek,DISPSYS", 31,
