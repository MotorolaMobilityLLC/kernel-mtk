...
#ifdef CONFIG_MTK_LENS_GT9762AFW_SUPPORT
#define GT9762AFW_SetI2Cclient GT9762AFW_SetI2Cclient_Main
#define GT9762AFW_Ioctl GT9762AFW_Ioctl_Main
#define GT9762AFW_Release GT9762AFW_Release_Main
extern void GT9762AFW_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long GT9762AFW_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9762AFW_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
