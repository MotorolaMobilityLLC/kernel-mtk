...
#define LC898217AFD_SetI2Cclient LC898217AFD_SetI2Cclient_Main
...
extern int LC898217AFD_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
