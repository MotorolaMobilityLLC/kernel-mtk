...
static struct stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	...
	{1, AFDRV_MOT_LISBON_DW9800VAF, MOT_LISBON_DW9800VAF_SetI2Cclient, MOT_LISBON_DW9800VAF_Ioctl,
	MOT_LISBON_DW9800VAF_Release, MOT_LISBON_DW9800VAF_GetFileName, NULL},
	...
	if (Stage == 0) {
		if (regVCAMAF == NULL) {
			...
			if (node) {
				...
				regVCAMAF =
					regulator_get(lens_device, "vldo28");
				#elif defined(CONFIG_MACH_MT6833) && !defined(CONFIG_MOT_WL2868)
				regVCAMAF =
