...
#define AF_DRVNAME "LCT_DW9763AF_DRV"
...
{/*
	...
	char puSendCmd3[2] = { 0x06, 0x41 };
	char puSendCmd4[2] = { 0x07, 0x3F };
	char puSendCmd5[2] = { 0x08, 0x00 };	
...
/* ////////////////////////////////////////////////////////////// */
long LCT_DW9763AF_SUNNY_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int LCT_DW9763AF_SUNNY_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void LCT_DW9763AF_SUNNY_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
