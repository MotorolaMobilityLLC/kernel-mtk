...
#define AF_DRVNAME "MOT_LISBON_DW9800VAF_DRV"
...
static int s4MOT_LISBON_DW9800VAF_ReadReg(unsigned short *a_pu2Result)
{
...
static int initdrv(void)
{
	...
	{0x02, 0x02}, {0x06, 0x40}, {0x07, 0x6E}, {0x10,0x01}, {0xFE, 0xFE},
	};
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		initdrv();
		ret = s4MOT_LISBON_DW9800VAF_ReadReg(&InitPos);
...
/* ////////////////////////////////////////////////////////////// */
long MOT_LISBON_DW9800VAF_Ioctl_Main(struct file *a_pstFile,
...
int MOT_LISBON_DW9800VAF_SetI2Cclient_Main(struct i2c_client *pstAF_I2Cclient,
...
int MOT_LISBON_DW9800VAF_GetFileName_Main(unsigned char *pFileName)
{
