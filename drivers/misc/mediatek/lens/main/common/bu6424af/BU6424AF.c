...
/* ////////////////////////////////////////////////////////////// */
long BU6424AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int BU6424AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int BU6424AF_GetFileName(unsigned char *pFileName)
{
