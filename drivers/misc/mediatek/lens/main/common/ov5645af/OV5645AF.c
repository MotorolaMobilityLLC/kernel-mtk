...
static int s4AF_WriteReg_OV5645AF(u8 *a_pSendData, u16 a_sizeSendData, u16 i2cId)
{
	int i4RetValue = 0;
...
{
	char pusendcmd[3] = { (char)(a_u2Data >> 8), (char)(a_u2Data & 0xFF), (char)(a_u2Para & 0xFF) };
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if ((s4AF_WriteReg(0x3602, AFValueL) == 0) && (s4AF_WriteReg(0x3603, AFValueH) == 0) &&
		(s4AF_WriteReg(0x3604, 0x05) == 0) && (s4AF_WriteReg(0x3605, 0x46) == 0) &&
...
/* ////////////////////////////////////////////////////////////// */
long OV5645AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int OV5645AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
