...
/*
 * MOT_DW9800VAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "MOT_DW9800VAF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long MOT_DW9800VAF_Ioctl_Main(struct file *a_pstFile,
...
int MOT_DW9800VAF_Release_Main(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int MOT_DW9800VAF_SetI2Cclient_Main(struct i2c_client *pstAF_I2Cclient,
...
int MOT_DW9800VAF_GetFileName_Main(unsigned char *pFileName)
{
