...
//Begin: Add lens driver interface for Kansas
#define MOT_KANSAS_GT9764VCMSHICOH_SetI2CClient MOT_KANSAS_GT9764VCMSHICOHAF_SetI2Cclient
#define MOT_KANSAS_GT9764VCMSHICOH_Ioctl MOT_KANSAS_GT9764VCMSHICOHAF_Ioctl
#define MOT_KANSAS_GT9764VCMSHICOH_Release MOT_KANSAS_GT9764VCMSHICOHAF_Release
#define MOT_KANSAS_GT9764VCMSHICOH_PowerDown MOT_KANSAS_GT9764VCMSHICOHAF_PowerDown
#define MOT_KANSAS_GT9764VCMSHICOH_GetFileName MOT_KANSAS_GT9764VCMSHICOHAF_GetFileName
extern int MOT_KANSAS_GT9764VCMSHICOHAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_KANSAS_GT9764VCMSHICOHAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int MOT_KANSAS_GT9764VCMSHICOHAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_KANSAS_GT9764VCMSHICOHAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int MOT_KANSAS_GT9764VCMSHICOHAF_GetFileName(unsigned char *pFileName);
//End


//Begin: Add lens driver interface for VEGAS
#define MOT_VEGAS_AW86006_SetI2Cclient MOT_VEGAS_AW86006AF_SetI2Cclient
#define MOT_VEGAS_AW86006_Ioctl MOT_VEGAS_AW86006AF_Ioctl
#define MOT_VEGAS_AW86006_Release MOT_VEGAS_AW86006AF_Release
#define MOT_VEGAS_AW86006_PowerDown MOT_VEGAS_AW86006AF_PowerDown
#define MOT_VEGAS_AW86006_GetFileName MOT_VEGAS_AW86006AF_GetFileName
extern int MOT_VEGAS_AW86006AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_VEGAS_AW86006AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int MOT_VEGAS_AW86006AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_VEGAS_AW86006AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int MOT_VEGAS_AW86006AF_GetFileName(unsigned char *pFileName);
//End
...
#define MOT_NEVADA_GT9764V_Ioctl MOT_NEVADA_GT9764VAF_Ioctl
#define MOT_NEVADA_GT9764V_Release MOT_NEVADA_GT9764VAF_Release
#define MOT_NEVADA_GT9764V_PowerDown MOT_NEVADA_GT9764VAF_PowerDown
#define MOT_NEVADA_GT9764V_GetFileName MOT_NEVADA_GT9764VAF_GetFileName
extern int MOT_NEVADA_GT9764VAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_NEVADA_GT9764VAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int MOT_NEVADA_GT9764VAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_NEVADA_GT9764VAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int MOT_NEVADA_GT9764VAF_GetFileName(unsigned char *pFileName);
//End

//Begin: Add lens driver interface for Utah
#define MOT_NEVADA_GT9764_SetI2CClient MOT_NEVADA_GT9764AF_SetI2Cclient
#define MOT_NEVADA_GT9764_Ioctl MOT_NEVADA_GT9764AF_Ioctl
#define MOT_NEVADA_GT9764_Release MOT_NEVADA_GT9764AF_Release
#define MOT_NEVADA_GT9764_PowerDown MOT_NEVADA_GT9764AF_PowerDown
#define MOT_NEVADA_GT9764_GetFileName MOT_NEVADA_GT9764AF_GetFileName
extern int MOT_NEVADA_GT9764AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_NEVADA_GT9764AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int MOT_NEVADA_GT9764AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_NEVADA_GT9764AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int MOT_NEVADA_GT9764AF_GetFileName(unsigned char *pFileName);
//End

//Begin: Add lens driver interface for SYDNEY
#define MOT_SYDNEY_GT9764V_SetI2CClient MOT_SYDNEY_GT9764VAF_SetI2Cclient
#define MOT_SYDNEY_GT9764V_Ioctl MOT_SYDNEY_GT9764VAF_Ioctl
#define MOT_SYDNEY_GT9764V_Release MOT_SYDNEY_GT9764VAF_Release
#define MOT_SYDNEY_GT9764V_PowerDown MOT_SYDNEY_GT9764VAF_PowerDown
#define MOT_SYDNEY_GT9764V_GetFileName MOT_SYDNEY_GT9764VAF_GetFileName
extern int MOT_SYDNEY_GT9764VAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_SYDNEY_GT9764VAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int MOT_SYDNEY_GT9764VAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_SYDNEY_GT9764VAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int MOT_SYDNEY_GT9764VAF_GetFileName(unsigned char *pFileName);
//End
...
#define MOT_SYDNEY_PD9402V_PowerDown MOT_SYDNEY_PD9402VAF_PowerDown
#define MOT_SYDNEY_PD9402V_GetFileName MOT_SYDNEY_PD9402VAF_GetFileName
extern int MOT_SYDNEY_PD9402VAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_SYDNEY_PD9402VAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int MOT_SYDNEY_PD9402VAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_SYDNEY_PD9402VAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int MOT_SYDNEY_PD9402VAF_GetFileName(unsigned char *pFileName);
//End
...
#define MOT_SYDNEY_GT9778W_PowerDown MOT_SYDNEY_GT9778WAF_PowerDown
#define MOT_SYDNEY_GT9778W_GetFileName MOT_SYDNEY_GT9778WAF_GetFileName
extern int MOT_SYDNEY_GT9778WAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_SYDNEY_GT9778WAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int MOT_SYDNEY_GT9778WAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_SYDNEY_GT9778WAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int MOT_SYDNEY_GT9778WAF_GetFileName(unsigned char *pFileName);
//End

//Begin: Add lens driver interface for SYDNEY
#define MOT_SYDNEY_GT9764_SetI2CClient MOT_SYDNEY_GT9764AF_SetI2Cclient
#define MOT_SYDNEY_GT9764_Ioctl MOT_SYDNEY_GT9764AF_Ioctl
#define MOT_SYDNEY_GT9764_Release MOT_SYDNEY_GT9764AF_Release
#define MOT_SYDNEY_GT9764_PowerDown MOT_SYDNEY_GT9764AF_PowerDown
#define MOT_SYDNEY_GT9764_GetFileName MOT_SYDNEY_GT9764AF_GetFileName
extern int MOT_SYDNEY_GT9764AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_SYDNEY_GT9764AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int MOT_SYDNEY_GT9764AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_SYDNEY_GT9764AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int MOT_SYDNEY_GT9764AF_GetFileName(unsigned char *pFileName);
//End

//Begin: Add lens driver interface for Naples
#define MOT_NAPLES_GT9764_SetI2CClient MOT_NAPLES_GT9764AF_SetI2Cclient
#define MOT_NAPLES_GT9764_Ioctl MOT_NAPLES_GT9764AF_Ioctl
#define MOT_NAPLES_GT9764_Release MOT_NAPLES_GT9764AF_Release
#define MOT_NAPLES_GT9764_PowerDown MOT_NAPLES_GT9764AF_PowerDown
#define MOT_NAPLES_GT9764_GetFileName MOT_NAPLES_GT9764AF_GetFileName
extern int MOT_NAPLES_GT9764AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_NAPLES_GT9764AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int MOT_NAPLES_GT9764AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_NAPLES_GT9764AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
...
//Begin: Add lens driver interface for Naples
#define MOT_NAPLES_AK7377_SetI2CClient MOT_NAPLES_AK7377AF_SetI2Cclient
#define MOT_NAPLES_AK7377_Ioctl MOT_NAPLES_AK7377AF_Ioctl
#define MOT_NAPLES_AK7377_Release MOT_NAPLES_AK7377AF_Release
#define MOT_NAPLES_AK7377_PowerDown MOT_NAPLES_AK7377AF_PowerDown
#define MOT_NAPLES_AK7377_GetFileName MOT_NAPLES_AK7377AF_GetFileName
extern int MOT_NAPLES_AK7377AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
                                spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_NAPLES_AK7377AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
                                unsigned long a_u4Param);
extern int MOT_NAPLES_AK7377AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_NAPLES_AK7377AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
                                int *pAF_Opened);
extern int MOT_NAPLES_AK7377AF_GetFileName(unsigned char *pFileName);
//End

//Begin: Add lens driver interface for sbuya
#define MOT_SBUYA_GT9764V_SetI2CClient MOT_SBUYA_GT9764VAF_SetI2Cclient
#define MOT_SBUYA_GT9764V_Ioctl MOT_SBUYA_GT9764VAF_Ioctl
#define MOT_SBUYA_GT9764V_Release MOT_SBUYA_GT9764VAF_Release
#define MOT_SBUYA_GT9764V_PowerDown MOT_SBUYA_GT9764VAF_PowerDown
#define MOT_SBUYA_GT9764V_GetFileName MOT_SBUYA_GT9764VAF_GetFileName
extern int MOT_SBUYA_GT9764VAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_SBUYA_GT9764VAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int MOT_SBUYA_GT9764VAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_SBUYA_GT9764VAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int MOT_SBUYA_GT9764VAF_GetFileName(unsigned char *pFileName);
//End
#endif
