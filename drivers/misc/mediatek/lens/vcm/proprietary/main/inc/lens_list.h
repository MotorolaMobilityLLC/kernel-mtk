...
//Begin: Add lens driver interface for CANCUNN
#define MOT_CANCUNN_AW86006_SetI2Cclient MOT_CANCUNN_AW86006AF_SetI2Cclient
#define MOT_CANCUNN_AW86006_Ioctl MOT_CANCUNN_AW86006AF_Ioctl
#define MOT_CANCUNN_AW86006_Release MOT_CANCUNN_AW86006AF_Release
#define MOT_CANCUNN_AW86006_PowerDown MOT_CANCUNN_AW86006AF_PowerDown
#define MOT_CANCUNN_AW86006_GetFileName MOT_CANCUNN_AW86006AF_GetFileName
extern int MOT_CANCUNN_AW86006AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_CANCUNN_AW86006AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int MOT_CANCUNN_AW86006AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_CANCUNN_AW86006AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
