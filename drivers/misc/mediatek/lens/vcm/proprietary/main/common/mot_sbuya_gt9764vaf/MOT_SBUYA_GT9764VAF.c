...
/*
 * GT9764VAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "GT9764VAF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long MOT_SBUYA_GT9764VAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int MOT_SBUYA_GT9764VAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int MOT_SBUYA_GT9764VAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int MOT_SBUYA_GT9764VAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int MOT_SBUYA_GT9764VAF_GetFileName(unsigned char *pFileName)
{
