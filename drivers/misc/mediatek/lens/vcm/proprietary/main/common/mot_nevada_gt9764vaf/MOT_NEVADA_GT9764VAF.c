...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		s4AF_WriteReg(0, 0x07, 0x06);
		s4AF_WriteReg(0, 0x0B, 0x12);
...
/* ////////////////////////////////////////////////////////////// */
long MOT_NEVADA_GT9764VAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int MOT_NEVADA_GT9764VAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int MOT_NEVADA_GT9764VAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int MOT_NEVADA_GT9764VAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int MOT_NEVADA_GT9764VAF_GetFileName(unsigned char *pFileName)
{
