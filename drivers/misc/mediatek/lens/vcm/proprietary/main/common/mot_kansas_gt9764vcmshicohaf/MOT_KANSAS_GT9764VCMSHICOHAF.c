...
/*
 * GT9764VCMSHICOHAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "GT9764VCMSHICOHAF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long MOT_KANSAS_GT9764VCMSHICOHAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int MOT_KANSAS_GT9764VCMSHICOHAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int MOT_KANSAS_GT9764VCMSHICOHAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int MOT_KANSAS_GT9764VCMSHICOHAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int MOT_KANSAS_GT9764VCMSHICOHAF_GetFileName(unsigned char *pFileName)
{
