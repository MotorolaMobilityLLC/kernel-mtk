...
/*
 * GT9778WAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "GT9778WAF_DRV"
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		s4AF_WriteReg(0, 0x06, 0x61);
		s4AF_WriteReg(0, 0x07, 0x32);
		s4AF_WriteReg(0, 0x0B, 0x00);
...
#ifdef CONFIG_AF_NOISE_ELIMINATION
void MOT_SYDNEY_GT9778WAF_VIB_ResetPos(unsigned long a_u4Position)
{
	moveAF(a_u4Position);
}
#endif
...
/* ////////////////////////////////////////////////////////////// */
long MOT_SYDNEY_GT9778WAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int MOT_SYDNEY_GT9778WAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int MOT_SYDNEY_GT9778WAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int MOT_SYDNEY_GT9778WAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int MOT_SYDNEY_GT9778WAF_GetFileName(unsigned char *pFileName)
{
