...
long MOT_CANCUNN_AW86006AF_Ioctl(struct file *a_pstFile, uint32_t a_u4Command,
...
int MOT_CANCUNN_AW86006AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	AW_LOGI("Start");
...
int MOT_CANCUNN_AW86006AF_PowerDown(struct i2c_client *pstAF_I2Cclient, int *pAF_Opened)
{
	AW_LOGI("Start");
...
int MOT_CANCUNN_AW86006AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int MOT_CANCUNN_AW86006AF_GetFileName(uint8_t *pFileName)
{
