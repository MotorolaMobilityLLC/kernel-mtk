...
/* ////////////////////////////////////////////////////////////// */
long MOT_DEVONF_DW9714AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int MOT_DEVONF_DW9714AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int MOT_DEVONF_DW9714AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int MOT_DEVONF_DW9714AF_GetFileName(unsigned char *pFileName)
{
