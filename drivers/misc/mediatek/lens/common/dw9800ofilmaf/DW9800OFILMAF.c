...
#define AF_DRVNAME "DW9800wOFILMAF"
...
static int s4AF_ReadReg(unsigned short * a_pu2Result)
{
    //int  i4RetValue = 0;
    //char pBuff[2];
    //revise DW9800wsunnysf driver and open SAC mode
...
/*wuyt3 end*/
/* ////////////////////////////////////////////////////////////// */
long DW9800wOFILMAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int DW9800wOFILMAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void DW9800wOFILMAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
