...
extern int MOT_MILAN_DW9714AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long MOT_MILAN_DW9714AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int MOT_MILAN_DW9714AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int MOT_MILAN_DW9714AF_GetFileName(unsigned char *pFileName);
