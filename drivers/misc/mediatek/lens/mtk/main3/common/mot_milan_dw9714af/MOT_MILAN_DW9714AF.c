...
#define AF_DRVNAME "MOT_MILAN_DW9714AF_DRV"
...
static int initAF(void)
{
	...
	unsigned char  puSendCmdArray[6][3] = {
		{0xED, 0xAB,0},
		{0x02, 0x01,0},
		{0x02, 0x00,1},
		{0x06, 0x84,0},
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if ( a_u4Position > g_u4AF_MACRO) {
		a_u4Position = g_u4AF_MACRO;
	}

	if ( a_u4Position <  g_u4AF_INF) {
...
/* ////////////////////////////////////////////////////////////// */
long MOT_MILAN_DW9714AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int MOT_MILAN_DW9714AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
...
int MOT_MILAN_DW9714AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int MOT_MILAN_DW9714AF_GetFileName(unsigned char *pFileName)
{
