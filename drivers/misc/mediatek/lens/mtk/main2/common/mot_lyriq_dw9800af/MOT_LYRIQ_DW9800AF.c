...
#define AF_DRVNAME "MOT_LYRIQ_DW9800AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long MOT_LYRIQ_DW9800AF_Ioctl(struct file *a_pstFile,
...
int MOT_LYRIQ_DW9800AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int MOT_LYRIQ_DW9800AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int MOT_LYRIQ_DW9800AF_GetFileName(unsigned char *pFileName)
{
