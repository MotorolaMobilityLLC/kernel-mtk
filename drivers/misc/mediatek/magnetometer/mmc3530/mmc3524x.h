...
#define SENSOR_DATA_SIZE 9
	...
	#define TRUE 1
#endif
#define MMC3524x_I2C_ADDR		0x60	// 8-bit    7-bit  0x30
...
#define MMC3524X_MODE_SNG_MEASURE	0x01
#define MMC3524X_MODE_SELF_TEST		0x10
#define MMC3524X_MODE_FUSE_ACCESS	0x1F
#define MMC3524X_MODE_POWERDOWN		0x00
#define MMC3524X_RESET_DATA			0x01
