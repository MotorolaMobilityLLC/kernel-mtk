...
extern void (*fpsgo_notify_qudeq_fp)(int qudeq, unsigned int startend, unsigned long long bufID, int pid);
extern void (*fpsgo_notify_intended_vsync_fp)(int pid);
extern void (*fpsgo_notify_framecomplete_fp)(int ui_pid, unsigned long long frame_time, int render_method, int render);
