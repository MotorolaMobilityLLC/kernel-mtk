...
static int __init init_fliper(void)
{
	...
	total_enable = 1;
	total_threshold[0][0] = 8560;
	total_threshold[0][1] = 3840;
	total_threshold[0][2] = 2560;
	total_threshold[1][0] = 8560;
	total_threshold[1][1] = 3840;
	total_threshold[1][2] = 2560;
	total_threshold[2][0] = 8560;
	total_threshold[2][1] = 3840;
	total_threshold[2][2] = 2560;
	total_threshold[3][0] = 8560;
	total_threshold[3][1] = 3840;
	total_threshold[3][2] = 2560;
	total_threshold_2[0][0] = 8560 * 2;
	total_threshold_2[0][1] = 3840 * 2;
	total_threshold_2[0][2] = 2560 * 2;
	total_threshold_2[1][0] = 8560 * 2;
	total_threshold_2[1][1] = 3840 * 2;
	total_threshold_2[1][2] = 2560 * 2;
	total_threshold_2[2][0] = 8560 * 2;
	total_threshold_2[2][1] = 3840 * 2;
	total_threshold_2[2][2] = 2560 * 2;
	total_threshold_2[3][0] = 8560 * 2;
	total_threshold_2[3][1] = 3840 * 2;
	total_threshold_2[3][2] = 2560 * 2;
	total_period = 17;
	total_intr = 1;
