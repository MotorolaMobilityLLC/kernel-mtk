...
/* --- R12ext Define --- */
#define R12EXT_SRCCLKENI0                     (1U << 0)
#define R12EXT_SRCCLKENI1                     (1U << 1)
#define R12EXT_MD_SRCCLKENA_0                 (1U << 2)
#define R12EXT_MD_APSRC_REQ_0                 (1U << 3)
#define R12EXT_CONN_DDR_EN                    (1U << 4)
#define R12EXT_MD_SRCCLKENA_1                 (1U << 5)
#define R12EXT_SSPM_SRCCLKENA                 (1U << 6)
#define R12EXT_SSPM_APSRC_REQ                 (1U << 7)
#define R12EXT_MD1_STATE                      (1U << 8)
#define R12EXT_EMI_CLK_OFF_2_ACK              (1U << 9)
#define R12EXT_MM_STATE                       (1U << 10)
#define R12EXT_SSPM_STATE                     (1U << 11)
#define R12EXT_MD_DDR_EN_0                    (1U << 12)
#define R12EXT_CONN_STATE                     (1U << 13)
#define R12EXT_CONN_SRCCLKENA                 (1U << 14)
#define R12EXT_CONN_APSRC_REQ                 (1U << 15)
#define R12EXT_16                             (1U << 16)
#define R12EXT_17                             (1U << 17)
#define R12EXT_SCP_STATE                      (1U << 18)
#define R12EXT_CSYSPWRUPREQ                   (1U << 19)
#define R12EXT_PWRAP_SLEEP_ACK                (1U << 20)
#define R12EXT_EMI_CLK_OFF_ACK_ALL            (1U << 21)
#define R12EXT_AUDIO_DSP_STATE                (1U << 22)
#define R12EXT_SW_DMDRAMCSHU_ACK_ALL          (1U << 23)
#define R12EXT_CONN_SRCCLKENB                 (1U << 24)
#define R12EXT_SC_DR_SRAM_LOAD_ACK_ALL        (1U << 25)
#define R12EXT_INFRA_AUX_IDLE                 (1U << 26)
#define R12EXT_DVFS_STATE                     (1U << 27)
#define R12EXT_SC_DR_SRAM_PLL_LOAD_ACK_ALL    (1U << 28)
#define R12EXT_SC_DR_SRAM_RESTORE_ACK_ALL     (1U << 29)
#define R12EXT_MD_VRF18_REQ_0                 (1U << 30)
#define R12EXT_DDR_EN_STATE                   (1U << 31)
/* --- R13 Define --- */
#define R13_26M_WAKE                          (1U << 0)
#define R13_26M_SLEEP                         (1U << 1)
#define R13_INFRA_WAKE                        (1U << 2)
#define R13_INFRA_SLEEP                       (1U << 3)
#define R13_APSRC_WAKE                        (1U << 4)
#define R13_APSRC_SLEEP                       (1U << 5)
#define R13_VRF18_WAKE                        (1U << 6)
#define R13_VRF18_SLEEP                       (1U << 7)
#define R13_DVFS_WAKE                         (1U << 8)
#define R13_DDREN_WAKE                        (1U << 9)
#define R13_DDREN_SLEEP                       (1U << 10)
#define R13_DDREN2_WAKE                       (1U << 11)
#define R13_DDREN2_SLEEP                      (1U << 12)
#define R13_CONN_SRCCLKENB                    (1U << 13)
#define R13_CONN_SRCCLKENB__B                 (1U << 14)
#define R13_SW_MAILBOX_WAKE                   (1U << 15)
#define R13_SSPM_MAILBOX_WAKE                 (1U << 16)
#define R13_ADSP_MAILBOX_WAKE                 (1U << 17)
#define R13_SCP_MAILBOX_WAKE                  (1U << 18)
#define R13_VS2_VOTER_INT0                    (1U << 19)
#define R13_VS2_VOTER_INT1                    (1U << 20)
#define R13_VS2_VOTER_INT2                    (1U << 21)
#define R13_VS1_VOTER_INT0                    (1U << 22)
#define R13_VS1_VOTER_INT1                    (1U << 23)
#define R13_BIT24                             (1U << 24)
#define R13_BIT25                             (1U << 25)
#define R13_BIT26                             (1U << 26)
#define R13_BIT27                             (1U << 27)
#define R13_BIT28                             (1U << 28)
#define R13_BIT29                             (1U << 29)
#define R13_BIT30                             (1U << 30)
#define R13_BIT31                             (1U << 31)
