...
#define DEBUG_PHYPLL_MASK (CTRL0_SC_DPHY_RXDLY_TRACK_EN \
	| CTRL0_SC_PHYPLL_SHU_EN \
	| CTRL0_SC_PHYPLL2_SHU_EN \
	| CTRL0_SC_PHYPLL_MODE_SW \
	| CTRL0_SC_PHYPLL2_MODE_SW)
...
#define DEBUG_ABORT_MASK_1 (DEBUG_IDX_VTCXO_SLEEP_ABORT_0 \
	...
	| DEBUG_IDX_PMIC_IRQ_ACK_HITH_ABORT \
...
enum {
	...
	/* CLK_CFG_5 1000_0090*/
	CLKMUX_AUDIO		= 20,
	CLKMUX_AUD_INTBUS	= 21,
	CLKMUX_PMICSPI		= 22,
	CLKMUX_PWRAP_ULPOSC	= 23,
	...
	/* CLK_CFG_9 1000_00D0*/
	CLKMUX_AUD_ENGEN1	= 36,
	CLKMUX_AUD_ENGEN2	= 37,
	CLKMUX_AES_UFSFDE	= 38,
	CLKMUX_UFS		= 39,
