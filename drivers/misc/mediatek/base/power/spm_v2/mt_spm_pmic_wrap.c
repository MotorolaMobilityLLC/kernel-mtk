...
static struct pmic_wrap_setting pw = {
	...
	.set[PMIC_WRAP_PHASE_SUSPEND] = {
		...
		._[IDX_SP_VCORE_LPM] = { MT6351_PMIC_BUCK_VCORE_VOSEL_ON_ADDR, VOLT_TO_PMIC_VAL(90000),},
		._[IDX_SP_SRCCLKEN_IN2_NORMAL] = { MT6351_PMIC_RG_SRCLKEN_IN2_EN_ADDR, _BITS_(3:3, 1),},
		._[IDX_SP_SRCCLKEN_IN2_SLEEP] = { MT6351_PMIC_RG_SRCLKEN_IN2_EN_ADDR, _BITS_(3:3, 0),},
