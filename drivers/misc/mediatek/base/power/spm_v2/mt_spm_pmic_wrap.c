...
static struct pmic_wrap_setting pw = {
	...
	.set[PMIC_WRAP_PHASE_NORMAL] = {
		...
		._[IDX_NM_VSRAM_CORE_0P9V] = { MT6351_BUCK_VSRAM_PROC_CON4, VOLT_TO_PMIC_VAL(85625),},
	...
	.set[PMIC_WRAP_PHASE_SUSPEND] = {
		...
		._[IDX_SP_VSRAM_CORE_0P9V] = { MT6351_BUCK_VSRAM_PROC_CON4, VOLT_TO_PMIC_VAL(85625),},
	...
	.set[PMIC_WRAP_PHASE_DEEPIDLE] = {
		...
		._[IDX_DI_VSRAM_CORE_0P9V] = { MT6351_BUCK_VSRAM_PROC_CON4, VOLT_TO_PMIC_VAL(85625),},
