...
static struct pll_ops sdm_pll_ops = {
.get_state = pll_get_state_op, .enable = sdm_pll_enable_op, .disable =
	    sdm_pll_disable_op, .fsel = sdm_pll_fsel_op, .dump_regs =
	    sdm_pll_dump_regs_op, .hp_enable = sdm_pll_hp_enable_op, .hp_disable =
...
static struct pll_ops arm_pll_ops = {
.get_state = pll_get_state_op, .enable = sdm_pll_enable_op, .disable =
	    sdm_pll_disable_op, .fsel = arm_pll_fsel_op, .dump_regs =
	    sdm_pll_dump_regs_op, .hp_enable = sdm_pll_hp_enable_op, .hp_disable =
	    sdm_pll_hp_disable_op,};
...
static struct subsys syss[NR_SYSS] = {
	{
		.name = __stringify(SYS_MD1), .type = SYS_TYPE_MODEM, .default_sta =
		    PWR_DOWN, .sta_mask = 1U << 0,
/* .ctl_addr = SPM_MD_PWR_CON, */
	.ops = &md1_sys_ops,}, {
		.name = __stringify(SYS_MD2), .type = SYS_TYPE_MODEM, .default_sta =
		    PWR_DOWN, .sta_mask = 1U << 22,
/* .ctl_addr = SPM_MD2_PWR_CON, */
	.ops = &md2_sys_ops,}, {
		.name = __stringify(SYS_CONN), .type = SYS_TYPE_CONN, .default_sta =
		    PWR_DOWN, .sta_mask = 1U << 1,
/* .ctl_addr = SPM_CONN_PWR_CON, */
	.ops = &conn_sys_ops,}, {
		.name = __stringify(SYS_DIS), .type = SYS_TYPE_MEDIA, .default_sta =
		    PWR_ON, .sta_mask = 1U << 3,
/* .ctl_addr = SPM_DIS_PWR_CON, */
	.ops = &dis_sys_ops, .start = &grps[CG_DISP0], .nr_grps = 2, .mux =
		    &muxs[MT_MUX_MM],}, {
		.name = __stringify(SYS_MFG), .type = SYS_TYPE_MEDIA, .default_sta =
		    PWR_ON, .sta_mask = 1U << 4,
/* .ctl_addr = SPM_MFG_PWR_CON, */
	.ops = &mfg_sys_ops, .start = &grps[CG_MFG], .nr_grps = 1, .mux =
		    &muxs[MT_MUX_MFG],}, {
		.name = __stringify(SYS_ISP), .type = SYS_TYPE_MEDIA, .default_sta =
		    PWR_ON, .sta_mask = 1U << 5,
/* .ctl_addr = SPM_ISP_PWR_CON, */
		    .ops = &isp_sys_ops, .start = &grps[CG_IMAGE], .nr_grps = 1,
		    /* .mux = &muxs[MT_MUX_SCAM], */
	}, {
		.name = __stringify(SYS_VDE), .type = SYS_TYPE_MEDIA, .default_sta =
		    PWR_ON, .sta_mask = 1U << 7,
/* .ctl_addr = SPM_VDE_PWR_CON, */
	.ops = &vde_sys_ops, .start = &grps[CG_VDEC0], .nr_grps = 2, .mux = &muxs[MT_MUX_VDEC],},	/*{
	...
	.mux = &muxs[MT_MUX_MJC],
		...
		.name = __stringify(SYS_VEN), .type = SYS_TYPE_MEDIA, .default_sta =
		    PWR_ON, .sta_mask = 1U << 8,
/* .ctl_addr = SPM_VEN_PWR_CON, */
		    .ops = &ven_sys_ops, .start = &grps[CG_VENC], .nr_grps = 1,
...
static struct subsys_ops md1_sys_ops = {
.enable = md1_sys_enable_op, .disable = md1_sys_disable_op, .get_state =
	    sys_get_state_op, .dump_regs = sys_dump_regs_op,};

static struct subsys_ops conn_sys_ops = {
.enable = conn_sys_enable_op, .disable = conn_sys_disable_op, .get_state =
	    sys_get_state_op, .dump_regs = sys_dump_regs_op,};

static struct subsys_ops dis_sys_ops = {
.enable = dis_sys_enable_op, .disable = dis_sys_disable_op, .get_state =
	    sys_get_state_op, .dump_regs = sys_dump_regs_op,};
...
static struct subsys_ops isp_sys_ops = {
.enable = isp_sys_enable_op, .disable = isp_sys_disable_op, .get_state =
	    sys_get_state_op, .dump_regs = sys_dump_regs_op,};

static struct subsys_ops vde_sys_ops = {
.enable = vde_sys_enable_op, .disable = vde_sys_disable_op, .get_state =
	    sys_get_state_op, .dump_regs = sys_dump_regs_op,};
...
*/
static struct subsys_ops ven_sys_ops = {
.enable = ven_sys_enable_op, .disable = ven_sys_disable_op, .get_state =
	    sys_get_state_op, .dump_regs = sys_dump_regs_op,};
...
*/
static struct subsys_ops md2_sys_ops = {
.enable = md2_sys_enable_op, .disable = md2_sys_disable_op, .get_state =
	    sys_get_state_op, .dump_regs = sys_dump_regs_op,};
...
spm_is_md1_sleep, spm_is_md2_sleep,};
#endif
...
/* .base_addr = CLK_CFG_0, */
	.sel_mask = 0x07000000, .pdn_mask = 0x80000000, .offset = 24, .nr_inputs = 8, .ops =
		    &clkmux_ops, .pll = &plls[VENCPLL],}, {
		.name = __stringify(MUX_DDRPHY),	/* 1 */
/* .base_addr = CLK_CFG_0, */
	.sel_mask = 0x00010000, .pdn_mask = 0x00800000, .offset = 16, .nr_inputs = 2, .ops =
		    &clkmux_ops,}, {
		.name = __stringify(MUX_MEM),	/* 2 */
/* .base_addr = CLK_CFG_0, */
	.sel_mask = 0x00000100, .pdn_mask = 0x00008000, .offset = 8, .nr_inputs = 2, .ops =
		    &clkmux_ops,}, {
		.name = __stringify(MUX_AXI),	/* 3 */
/* .base_addr = CLK_CFG_0, */
	.sel_mask = 0x00000007, .pdn_mask = 0x00000080, .offset = 0, .nr_inputs = 8, .ops =
		    &clkmux_ops,}, {
		.name = __stringify(MUX_CAMTG),	/* 4 */
/* .base_addr = CLK_CFG_1, */
	.sel_mask = 0x07000000, .pdn_mask = 0x80000000, .offset = 24, .nr_inputs = 7, .ops =
		    &clkmux_ops, .pll = &plls[UNIVPLL],}, {
		.name = __stringify(MUX_MFG),	/* 5 */
/* .base_addr = CLK_CFG_1, */
	.sel_mask = 0x000f0000, .pdn_mask = 0x00800000, .offset = 16, .nr_inputs =
		    14, .ops = &clkmux_ops, .siblings = &muxs[MT_MUX_MFG13M], .pll = &plls[MMPLL],}, {
		.name = __stringify(MUX_VDEC),	/* 6 */
/* .base_addr = CLK_CFG_1, */
	.sel_mask = 0x00000700, .pdn_mask = 0x00008000, .offset = 8, .nr_inputs = 8, .ops =
		    &clkmux_ops,}, {
		.name = __stringify(MUX_PWM),	/* 7 */
/* .base_addr = CLK_CFG_1, */
	.sel_mask = 0x00000003, .pdn_mask = 0x00000080, .offset = 0, .nr_inputs = 4, .ops =
		    &clkmux_ops,}, {
		.name = __stringify(MUX_MSDC50_0),	/* 8 */
/* .base_addr = CLK_CFG_2, */
		    .sel_mask = 0x07000000, .pdn_mask = 0x80000000, .offset = 24, .nr_inputs = 6, .ops =
		    &clkmux_ops,
		    /* .pll = &plls[MSDCPLL], */
	}, {
		.name = __stringify(MUX_USB20),	/* 9 */
/* .base_addr = CLK_CFG_2, */
	.sel_mask = 0x00030000, .pdn_mask = 0x00800000, .offset = 16, .nr_inputs = 3, .ops =
		    &clkmux_ops, .pll = &plls[UNIVPLL],}, {
		.name = __stringify(MUX_SPI),	/* 10 */
/* .base_addr = CLK_CFG_2, */
	.sel_mask = 0x00000700, .pdn_mask = 0x00008000, .offset = 8, .nr_inputs = 7, .ops =
		    &clkmux_ops,}, {
		.name = __stringify(MUX_UART),	/* 11 */
/* .base_addr = CLK_CFG_2, */
	.sel_mask = 0x00000001, .pdn_mask = 0x00000080, .offset = 0, .nr_inputs = 2, .ops =
		    &clkmux_ops,}, {
		.name = __stringify(MUX_MSDC30_3),	/* 12 */
/* .base_addr = CLK_CFG_3, */
	.sel_mask = 0x0f000000, .pdn_mask = 0x80000000, .offset = 24, .nr_inputs = 9, .ops =
		    &clkmux_ops, .pll = &plls[MSDCPLL],}, {
		.name = __stringify(MUX_MSDC30_2),	/* 13 */
/* .base_addr = CLK_CFG_3, */
	.sel_mask = 0x00070000, .pdn_mask = 0x00800000, .offset = 16, .nr_inputs = 8, .ops =
		    &clkmux_ops, .pll = &plls[MSDCPLL],}, {
...
/* .base_addr = CLK_CFG_3, */
	.sel_mask = 0x0000000f, .pdn_mask = 0x00000080, .offset = 0, .nr_inputs = 11, .ops =
		    &clkmux_ops, .siblings = &muxs[MT_MUX_MSDC50_0], .pll = &plls[MSDCPLL],}, {
		.name = __stringify(MUX_SCP),	/* 16 */
/* .base_addr = CLK_CFG_4, */
	.sel_mask = 0x03000000, .pdn_mask = 0x80000000, .offset = 24, .nr_inputs = 4, .ops =
		    &clkmux_ops,}, {
...
/* .base_addr = CLK_CFG_4, */
	.sel_mask =
		    0x00000300, .pdn_mask =
		    0x00008000, .offset = 8, .nr_inputs = 4, .ops =
		    &audio_clkmux_ops, .siblings = &muxs[MT_MUX_AUDIO],}, {
		.name = __stringify(MUX_AUDIO),	/* 19 */
/* .base_addr = CLK_CFG_4, */
	.sel_mask =
		    0x00000003, .pdn_mask =
		    0x00000080, .offset = 0, .nr_inputs = 4, .ops = &audio_clkmux_ops,}, {
		.name = __stringify(MUX_MFG13M),	/* 20 */
/* .base_addr = CLK_CFG_5, */
	.sel_mask =
		    0x01000000, .pdn_mask =
		    0x80000000, .offset = 24, .nr_inputs = 2, .ops = &clkmux_ops,}, {
		.name = __stringify(MUX_SCAM),	/* 21 */
/* .base_addr = CLK_CFG_5, */
		    .sel_mask
		    =
		    0x00030000, .pdn_mask
		    = 0x00800000, .offset = 16, .nr_inputs = 4, .ops = &clkmux_ops,
		    /* .pll = &plls[UNIVPLL], */
	}, {
...
/* .base_addr = CLK_CFG_5, */
	.sel_mask
		    ...
		    =
		    0x00008000, .offset
		    = 8, .nr_inputs = 5, .ops = &clkmux_ops, .pll = &plls[TVDPLL],}, {
		.name = __stringify(MUX_ATB),	/* 23 */
/* .base_addr = CLK_CFG_5, */
	.sel_mask
		    =
		    0x00000003, .pdn_mask
		    = 0x00000080, .offset = 0, .nr_inputs = 4, .ops = &clkmux_ops,}, {
...
/* .base_addr = CLK_CFG_6, */
	.sel_mask
		    ...
		    =
		    0x00800000, .offset
		    = 16, .nr_inputs = 2, .ops = &clkmux_ops, .pll = &plls[UNIVPLL],}, {
...
/* .base_addr = CLK_CFG_6, */
	.sel_mask
		    ...
		    =
		    0x00008000, .offset
		    = 8, .nr_inputs = 2, .ops = &clkmux_ops, .pll = &plls[APLL2],}, {
...
/* .base_addr = CLK_CFG_6, */
	.sel_mask
		    ...
		    =
		    0x00000080, .offset
		    = 0, .nr_inputs = 2, .ops = &clkmux_ops, .pll = &plls[APLL1],}, {
...
/* .base_addr = CLK_CFG_7, */
	.sel_mask
		    ...
		    0x00000003, .pdn_mask
		    =
		    0x00000080, .offset = 0, .nr_inputs = 4, .ops = &clkmux_ops, .pll = &plls[UNIVPLL],}
};
...
static struct clkmux_ops clkmux_ops = {
.sel = clkmux_sel_op, .enable = clkmux_enable_op, .disable = clkmux_disable_op,};
...
.enable = clkmux_enable_op, .disable = clkmux_disable_op,};
...
/* .sta_addr = VENC_CG_CON, */
	.mask = 0x00001111, .ops = &venc_cg_grp_ops, .sys = &syss[SYS_VEN],}
};
...
static struct cg_grp_ops general_cg_grp_ops = {
.get_state = general_grp_get_state_op, .dump_regs = general_grp_dump_regs_op,};
...
static struct cg_grp_ops disp0_cg_grp_ops = {
.get_state = disp0_grp_get_state_op, .dump_regs = disp0_grp_dump_regs_op,};
...
static struct cg_grp_ops vdec_cg_grp_ops = {
.get_state = vdec_grp_get_state_op, .dump_regs = vdec_grp_dump_regs_op,};
...
static struct cg_grp_ops venc_cg_grp_ops = {
.get_state = venc_grp_get_state_op, .dump_regs = venc_grp_dump_regs_op,};
...
static struct cg_clk clks[NR_CLKS] = {
	...
	.cnt = 0, .ops = &general_cg_clk_ops, .grp = &grps[CG_INFRA],}, [CG_PERI_FROM ... CG_PERI_TO] = {
	.cnt = 0, .ops = &general_cg_clk_ops, .grp = &grps[CG_PERI],},
	    [CG_DISP0_FROM ... CG_DISP0_TO] = {
	.cnt = 0, .ops = &disp0_cg_clk_ops, .grp = &grps[CG_DISP0],}, [CG_DISP1_FROM ... CG_DISP1_TO] = {
	.cnt = 0, .ops = &general_cg_clk_ops, .grp = &grps[CG_DISP1],},
	    [CG_IMAGE_FROM ... CG_IMAGE_TO] = {
	.cnt = 0, .ops = &general_cg_clk_ops, .grp = &grps[CG_IMAGE],}, [CG_MFG_FROM ... CG_MFG_TO] = {
	.cnt = 0, .ops = &general_cg_clk_ops, .grp = &grps[CG_MFG],}, [CG_AUDIO_FROM ... CG_AUDIO_TO] = {
	.cnt = 0, .ops = &audsys_cg_clk_ops, .grp = &grps[CG_AUDIO],},
	    [CG_VDEC0_FROM ... CG_VDEC0_TO] = {
	.cnt = 0, .ops = &vdec_cg_clk_ops, .grp = &grps[CG_VDEC0],}, [CG_VDEC1_FROM ... CG_VDEC1_TO] = {
	.cnt = 0, .ops = &vdec_cg_clk_ops, .grp = &grps[CG_VDEC1],},
...
.cnt = 0, .ops = &venc_cg_clk_ops, .grp = &grps[CG_VENC],},};
...
static struct cg_clk_ops general_cg_clk_ops = {
.get_state = general_clk_get_state_op, .check_validity =
	    general_clk_check_validity_op, .enable = general_clk_enable_op, .disable =
...
static struct cg_clk_ops disp0_cg_clk_ops = {
.get_state = disp0_clk_get_state_op, .check_validity =
	    general_clk_check_validity_op, .enable = disp0_clk_enable_op, .disable =
	    disp0_clk_disable_op,};
...
static struct cg_clk_ops audio_cg_clk_ops = {
.get_state = general_clk_get_state_op, .check_validity =
	    general_clk_check_validity_op, .enable = audio_clk_enable_op, .disable =
...
.get_state = general_clk_get_state_op, .check_validity =
	    general_clk_check_validity_op, .enable = audsys_clk_enable_op, .disable =
...
static struct cg_clk_ops vdec_cg_clk_ops = {
.get_state = vdec_clk_get_state_op, .check_validity = general_clk_check_validity_op, .enable =
	    general_clk_enable_op, .disable = general_clk_disable_op,};
...
static struct cg_clk_ops venc_cg_clk_ops = {
.get_state = venc_clk_get_state_op, .check_validity = general_clk_check_validity_op, .enable =
	    general_clk_enable_op, .disable = general_clk_disable_op,};
...
static void mt_clks_init(void)
{
	...
	grps[CG_DISP0].dummy_addr = MMSYS_DUMMY, grps[CG_DISP1].set_addr = DISP_CG_SET1;
...
.owner = THIS_MODULE, .open = proc_pll_test_open, .read = seq_read, .write = pll_test_write,};
...
.owner = THIS_MODULE, .open = proc_pll_fsel_open, .read = seq_read, .write = pll_fsel_write,};
...
.owner = THIS_MODULE, .open = proc_pll_stat_open, .read = seq_read,};
#endif
...
.owner = THIS_MODULE, .open = proc_subsys_test_open, .read = seq_read, .write =
	    subsys_test_write};
...
.owner = THIS_MODULE, .open = proc_subsys_stat_open, .read = seq_read,};
#endif
...
.owner = THIS_MODULE, .open = proc_mux_test_open, .read = seq_read,};
...
.owner = THIS_MODULE, .open = proc_mux_stat_open, .read = seq_read,};
#endif
...
.owner = THIS_MODULE, .open = proc_clk_test_open, .read = seq_read, .write = clk_test_write,};
...
.owner = THIS_MODULE, .open = proc_clk_stat_open, .read = seq_read,};
#endif
...
.owner = THIS_MODULE, .open = proc_clk_force_on_open, .read = seq_read, .write =
	    clk_force_on_write,};
...
.owner = THIS_MODULE, .open = proc_slp_chk_mtcmos_pll_stat_open, .read = seq_read,};
...
.owner = THIS_MODULE, .open = proc_armpll_ckdiv_open, .read = seq_read, .write =
	    armpll_ckdiv_write,};
