...
#define OCP_FREQ_PCT_100_B	(2800)
...
extern int mt_ocp_set_freq(enum ocp_cluster cluster, unsigned int freq_khz);
extern int mt_ocp_set_volt(enum ocp_cluster cluster, unsigned int volt_mv);
