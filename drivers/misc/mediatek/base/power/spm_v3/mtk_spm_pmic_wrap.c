...
static struct pmic_wrap_setting pw = {
	...
	.set[PMIC_WRAP_PHASE_ALLINONE] = {
		._[IDX_ALL_VSRAM_PWR_ON]        = {MT6335_LDO_VSRAM_DVFS1_CON0, _BITS_(0:0, 1),},
		._[IDX_ALL_VSRAM_SHUTDOWN]      = {MT6335_LDO_VSRAM_DVFS1_CON0, _BITS_(0:0, 0),},
		._[IDX_ALL_VSRAM_NORMAL]        = {MT6335_LDO_VSRAM_DVFS1_CON0, _BITS_(1:1, 1),},
		._[IDX_ALL_VSRAM_SLEEP]         = {MT6335_LDO_VSRAM_DVFS1_CON0, _BITS_(1:0, 3),},
		._[IDX_ALL_SRCCLKEN_IN2_NORMAL] = {MT6335_TOP_CON, _BITS_(3:3, 1),},
		._[IDX_ALL_SRCCLKEN_IN2_SLEEP]  = {MT6335_TOP_CON, _BITS_(3:3, 0),},
		._[IDX_ALL_RESERVE_6]           = {0, 0,},
		._[IDX_ALL_RESERVE_7]           = {0, 0,},
		...
		._[IDX_ALL_RESERVE_C]           = {0, 0,},
		._[IDX_ALL_RESERVE_D]           = {0, 0,},
		._[IDX_ALL_RESERVE_E]           = {0, 0,},
		._[IDX_ALL_RESERVE_F]           = {0, 0,},
		.nr_idx = NR_IDX_ALL,
	},
};
