...
static struct pmic_wrap_setting pw = {
	...
	.set[PMIC_WRAP_PHASE_ALLINONE] = {
		...
		._[IDX_ALL_VCORE_LEVEL0]      = {PMIC_RG_BUCK_VCORE_VOSEL_ADDR, VOLT_TO_PMIC_VAL(62500),},
		._[IDX_ALL_VCORE_LEVEL1]      = {PMIC_RG_BUCK_VCORE_VOSEL_ADDR, VOLT_TO_PMIC_VAL(62500),},
