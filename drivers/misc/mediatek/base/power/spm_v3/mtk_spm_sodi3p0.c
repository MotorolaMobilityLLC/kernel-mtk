...
static void spm_sodi3_pre_process(struct pwr_ctrl *pwrctrl, u32 operation_cond)
{
	...
	spm_pmic_vcore_setting((operation_cond &
			DEEPIDLE_OPT_VCORE_LP_MODE)?1:0);
#endif
...
#endif
#endif
	sodi3_debug("atf_time_sync\n");
}

enum wk_reason spm_go_to_sodi3(u32 spm_flags,
		u32 spm_data, u32 sodi3_flags, u32 operation_cond)
{
	void *api = NULL;
...
RESTORE_IRQ:
	...
	if (wr == WR_UART_BUSY)
		sodi3_info("request uart sleep: fail\n");
	else
