...
struct spower_leakage_info spower_lkg_info[MTK_SPOWER_MAX] = {
	...
	[MTK_VSRAM_CCI_LEAKAGE] = {
		.name = __stringify(MTK_VSRAM_CCI_LEAKAGE),
		.devinfo_idx = DEVINFO_IDX_VSRAM_CCI,
		.devinfo_offset = DEVINFO_OFF_VSRAM_CCI,
		.value = DEF_VSRAM_CCI_LEAKAGE,
		.v_of_fuse = V_OF_FUSE_VSRAM_CCI,
		.t_of_fuse = T_OF_FUSE,
	},
