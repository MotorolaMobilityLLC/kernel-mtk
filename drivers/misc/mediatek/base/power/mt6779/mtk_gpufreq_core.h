...
/**************************************************
 * MT6779 segment_1 : GPU DVFS OPP table Setting
 **************************************************/
...
#define VSRAM_MAX_VOLT			(SEG1_GPU_DVFS_VSRAM0)
#define VMDLA_MIN_VOLT			(62500) /* mV x 100 */
#define VAPU_MIN_VOLT			(62500) /* mV x 100 */
