...
#define SPM_DBG_CPU_CORE_PDN_ACK_ABORT        (1U << 15)
#define SPM_DBG_CPU_TOP_PDN_ACK_ABORT         (1U << 16)
#define SPM_DBG_MCUSYS_PDN_ACK_ABORT          (1U << 17)
#define SPM_DBG_VCORE_SLEEP_ACK_ABORT         (1U << 18)
#define SPM_DBG_VSRAM_PDN_ACK_ABORT           (1U << 19)
#define SPM_DBG_VTCXO_OFF_PWRAP_SLEEP_ABORT   (1U << 20)
#define SPM_DBG_SSPM_WFI_ABORT                (1U << 21)
#define SPM_DBG_CPU_CORE_ON_ACK_ABORT         (1U << 22)
#define SPM_DBG_CPU_TOP_ON_ACK_ABORT          (1U << 23)
#define SPM_DBG_MCUSYS_ON_ACK_ABORT           (1U << 24)
#define SPM_DBG_VCORE_ON_ACK_ABORT            (1U << 25)
#define SPM_DBG_VSRAM_ON_ACK_ABORT            (1U << 26)
#define SPM_DBG_VTCXO_OFF_PWRAP_SLP_ABORT     (1U << 27)
#define SPM_DBG_VTCXO_ON_PWRAP_SLP_ABORT      (1U << 28)
#define SPM_DBG_VTCXO_ON_PMIC_IRQ_ABORT       (1U << 29)
