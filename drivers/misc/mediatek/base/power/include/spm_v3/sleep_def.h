...
#define SPM_FLAG_DISABLE_CLUSTER_PDN          (1U << 12)
#define SPM_FLAG_DISABLE_MCUSYS_PDN           (1U << 13)
...
#define SPM_FLAG_RUN_SUSPEND_SCENARIO         (1U << 19)
#define SPM_FLAG_RUN_DEEPIDLE_SCENARIO        (1U << 20)
#define SPM_FLAG_RUN_SODI_SCENARIO            (1U << 21)
