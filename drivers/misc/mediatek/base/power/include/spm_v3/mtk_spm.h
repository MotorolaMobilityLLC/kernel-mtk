 ...
 * See http://www.gnu.osrg/licenses/gpl-2.0.html for more details.
 */
...
extern void __iomem *device_mpu_ao_base;
extern u32 spm_irq_0;
extern int spm_for_gps_flag;

#undef SPM_BASE
#define SPM_BASE spm_base
#undef DEVICE_MPU_AO_BASE
#define DEVICE_MPU_AO_BASE device_mpu_ao_base
...
extern void spm_vcorefs_register_handler(vcorefs_handler_t handler,
				vcorefs_start_handler_t start_handler);
...
extern void sspm_ipi_lock_spm_scenario(int start, int id,
