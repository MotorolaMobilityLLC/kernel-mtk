...
#define spm_idle_err(fmt, args...)		pr_info(TAG fmt, ##args)
#define spm_idle_warn(fmt, args...)		pr_info(TAG fmt, ##args)
...
enum wk_reason spm_go_to_dpidle(u32 spm_flags, u32 spm_data,
...
enum wk_reason spm_go_to_sodi3(u32 spm_flags, u32 spm_data,
...
enum wk_reason spm_go_to_sodi(u32 spm_flags, u32 spm_data,
				u32 sodi_flags, u32 operation_cond);
...
void spm_go_to_mcsodi(u32 spm_flags, u32 spm_data,
			u32 mcsodi_flags, u32 operation_cond);
