...
enum mt_cg_clk_id {
	...
	/* INFRA1 */
	MTK_CG_INFRA1_PMIC_CG_TMR_STA = 32,		/* 32 + 0 */
	...
	MTK_CG_INFRA1_CCIF3_AP_CG_STA = 49,		/* 32 + 17 */
	...
	MTK_CG_INFRA1_CCIF3_MD_CG_STA = 56,		/* 32 + 24 */
	...
	/* INFRA2 */
	MTK_CG_INFRA2_THERM_BCLK_CG_STA = 70,		/* 64 + 6 */
	MTK_CG_INFRA2_PTP_BCLK_CG_STA,		/* 64 + 7 */
	MTK_CG_INFRA2_AUXADC_MD_CG_STA = 88,		/* 64 + 24 */
	MTK_CG_INFRA2_RESERVED = 93,		/* 64 + 29 */
	MTK_CG_INFRA2_DVFS_CTRL_APB_RX_CK_CG_STA,		/* 64 + 30 */

	/* PERI0 */
	MTK_CG_PERI0_RG_PWM_BCLK_CK_PDN_STA = 96,	/* 96 + 0 */
	...
	MTK_CG_PERI0_RG_I2C0_BCLK_CK_PDN_STA = 112,	/* 96 + 16 */
	...
	/* PERI1 */
	MTK_CG_PERI1_RG_UART0_CK_PDN_STA = 128,		/* 128 + 0 */
	...
	MTK_CG_PERI1_RG_SPI0_CK_PDN_STA = 144,		/* 128 + 16 */
	...
	/* PERI2 */
	MTK_CG_PERI2_RG_MSDC0_CK_PDN_AP_NORM_STA = 160,/* 160 + 0 */
	MTK_CG_PERI2_RG_MSDC1_CK_PDN_STA,		/* 160 + 1 */
	MTK_CG_PERI2_RG_MSDC3_CK_PDN_STA = 163,		/* 160 + 3 */
	MTK_CG_PERI2_RG_UFSCARD_CK_PDN_STA = 170,		/* 160 + 10 */
	MTK_CG_PERI2_RG_UFSCARD_MP_SAP_CFG_CK_PDN_STA,		/* 160 + 11 */
	MTK_CG_PERI2_RG_UFS_AES_CORE_CK_PDN_STA,		/* 160 + 12 */
	MTK_CG_PERI2_RG_FLASHIF_CK_PDN_STA = 176,		/* 160 + 16 */
	MTK_CG_PERI2_RG_MSDC0_CK_PDN_AP_SECURE_STA = 184,	/* 160 + 24 */
	...
	MTK_CG_PERI2_RG_MSDC3_SRC_CK_PDN_STA = 189,		/* 160 + 29 */

	/* PERI3 */
	MTK_CG_PERI3_RG_USB_P0_CK_PDN_STA = 192,		/* 192 + 0 */
	MTK_CG_PERI3_RG_USB_P1_CK_PDN_STA,		/* 192 + 1 */
	MTK_CG_PERI3_RG_MPCIE_P0_CK_PDN_STA = 196,		/* 192 + 4 */
	MTK_CG_PERI3_RG_MPCIE_P0_OBFF_CLK_CK_PDN_STA,		/* 192 + 5 */
	MTK_CG_PERI3_RG_MPCIE_P0_AUX_CLK_CK_PDN_STA,		/* 192 + 6 */

	/* PERI4 */
	MTK_CG_PERI4_RG_AP_DM_CK_PDN_STA = 224,	/* 224 + 0 */
	MTK_CG_PERI4_RG_IRTX_CK_PDN_STA,		/* 224 + 1 */
	MTK_CG_PERI4_RG_DISP_PWM0_CK_PDN_STA = 227,	/* 224 + 3 */
	MTK_CG_PERI4_RG_DISP_PWM1_CK_PDN_STA,		/* 224 + 4 */
	MTK_CG_PERI4_RG_BTIF_CK_PDN_STA,			/* 224 + 5 */
	MTK_CG_PERI4_RG_CQ_DMA_CK_PDN_STA,		/* 224 + 6 */
	MTK_CG_PERI4_RG_MBIST_MEM_OFF_DLY_CK_PDN_STA = 232,	/* 224 + 8 */
	MTK_CG_PERI4_RG_DEVICE_APC_PERI_CK_PDN_STA,		/* 224 + 9 */
	MTK_CG_PERI4_RG_GCPU_CK_PDN_STA,		/* 224 + 10 */
	MTK_CG_PERI4_RG_DXCC_AO_CK_PDN_STA = 240,	/* 224 + 16 */
	MTK_CG_PERI4_RG_DXCC_PUB_CK_PDN_STA,		/* 224 + 17 */
	MTK_CG_PERI4_RG_DXCC_SEC_CK_PDN_STA,		/* 224 + 18 */
	MTK_CG_PERI4_RG_DEBUGTOP_CK_PDN = 244,		/* 224 + 20 */
	MTK_CG_PERI4_RG_DXFDE_CORE_CK_PDN = 248,		/* 224 + 24 */
	MTK_CG_PERI4_RG_UFOZIP_CK_PDN_STA = 252,		/* 224 + 28 */

	/* PERI5 */
	MTK_CG_PERI5_RG_PERIAPB_PERICFG_REG_CK_PDN_STA = 256,	/* 256 + 0 */
	...
	/* AUDIO0 */
	MTK_CG_AUDIO0_PDN_AFE = 290,		/* 288 + 2 */
	MTK_CG_AUDIO0_PDN_I2S = 294,		/* 288 + 6 */
	MTK_CG_AUDIO0_PDN_22M = 296,		/* 288 + 8 */
	MTK_CG_AUDIO0_PDN_24M,		/* 288 + 9 */
	MTK_CG_AUDIO0_APB_W2T = 300,		/* 288 + 12 */
	MTK_CG_AUDIO0_APB_R2T,		/* 288 + 13 */
	MTK_CG_AUDIO0_APB3_SEL,		/* 288 + 14 */
	MTK_CG_AUDIO0_PDN_APLL2_TUNER = 306,		/* 288 + 18 */
	MTK_CG_AUDIO0_PDN_APLL_TUNER,		/* 288 + 19 */
	MTK_CG_AUDIO0_PDN_TDM_CK,		/* 288 + 20 */
	MTK_CG_AUDIO0_PDN_ADC = 312,		/* 288 + 24 */
	...
	/* IMAGE */
	MTK_CG_IMAGE_LARB5_CGPDN = 480,		/* 480 + 0 */
	...
	MTK_CG_IMAGE_DFP_CGPDN = 490,		/* 480 + 10 */
	MTK_CG_IMAGE_VAD_CGPDN,		/* 480 + 11 */

	/* MFG */
	MTK_CG_MFG_BAXI_PDN = 512,		/* 512 + 0 */
	...
	/* VDEC0 */
	MTK_CG_VDEC0_VDEC_CKEN = 544,		/* 544 + 0 */
	MTK_CG_VDEC0_VDEC_ACTIVE = 548,		/* 544 + 4 */
	MTK_CG_VDEC0_VDEC_CKEN_ENG = 552,	/* 544 + 8 */

	/* VDEC1 */
	LARB1_CKEN = 576,		/* 576 + 0 */

	/* VENC0 */
	MTK_CG_VENC0_CE = 608,		/* 608 + 0 */

	/* VENC1 */
	MTK_CG_VENC1_CKE0 = 640,		/* 640 + 0 */
	MTK_CG_VENC1_CKE1 = 644,		/* 640 + 4 */
	MTK_CG_VENC1_CKE2 = 648,		/* 640 + 8 */
	MTK_CG_VENC1_CKE3 = 652,		/* 640 + 12 */
	MTK_CG_VENC1_CKE4 = 656,		/* 640 + 16 */
	MTK_CG_VENC1_CKE5 = 660,		/* 640 + 20 */
	MTK_CG_VENC1_GALS_DCM_OFF = 664,		/* 640 + 24 */

	/* MJC */
	MTK_CG_MJC_SMI_LARB = 672,		/* 672 + 0 */
	...
	/* IPU */
	MTK_CG_IPU_IPU_CGPDN = 704,		/* 704 + 0 */
