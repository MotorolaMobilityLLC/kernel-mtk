...
struct pwr_ctrl {
	...
	u32 pcm_flags_cust_set;	/* set bit of pcm_flags,
				 * after pcm_flags_cust
				 */
	u32 pcm_flags_cust_clr;	/* clr bit of pcm_flags,
				 * after pcm_flags_cust
				 */
	u32 pcm_flags1;
	u32 pcm_flags1_cust;	/* can override pcm_flags1 */
	u32 pcm_flags1_cust_set;	/* set bit of pcm_flags1,
					 * after pcm_flags1_cust
					 */
	u32 pcm_flags1_cust_clr;	/* clr bit of pcm_flags1,
					 * after pcm_flags1_cust
					 */
...
extern unsigned int __spm_get_vcore_volt_pmic_val(bool is_vcore_volt_lower,
						int ch);
extern void __spm_update_pcm_flags_dcs_workaround(struct pwr_ctrl *pwrctrl,
							int ch);
...
extern enum wk_reason __spm_output_wake_reason(
...
extern u32 _spm_get_wake_period(int pwake_time, enum wk_reason last_wr);
