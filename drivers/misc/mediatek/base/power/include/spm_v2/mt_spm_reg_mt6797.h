...
#define CPU_IDLE_STA2                  (SPM_BASE + 0x178)
#define PCM_FSM_STA                    (SPM_BASE + 0x17C)
...
#define PCM_WDT_LATCH_4                (SPM_BASE + 0x1C8)
#define SPM_SRC_RDY_STA                (SPM_BASE + 0x1D0)
#define SPM_WAKEUP_MISC2               (SPM_BASE + 0x1E0)
#define CPU_RET_STATUS                 (SPM_BASE + 0x1E4)
#define MCUSYS_PWR_CON                 (SPM_BASE + 0x200)
#define MP_TOP_PWR_CON                 (SPM_BASE + 0x204)
#define MP0_CPUSYS_PWR_CON             (SPM_BASE + 0x210)
#define MP1_CPUSYS_PWR_CON             (SPM_BASE + 0x214)
#define MP2_CPUSYS_PWR_CON             (SPM_BASE + 0x218)
#define MP3_CPUSYS_PWR_CON             (SPM_BASE + 0x21C)
...
#define MP2_CPU2_PWR_CON               (SPM_BASE + 0x248)
#define MP2_CPU3_PWR_CON               (SPM_BASE + 0x24C)
#define MP3_CPU0_PWR_CON               (SPM_BASE + 0x250)
#define MP3_CPU1_PWR_CON               (SPM_BASE + 0x254)
#define MP3_CPU2_PWR_CON               (SPM_BASE + 0x258)
#define MP3_CPU3_PWR_CON               (SPM_BASE + 0x25C)
#define CPU_EXT_BUCK_ISO               (SPM_BASE + 0x290)
#define DUMMY0_PWR_CON                 (SPM_BASE + 0x2B0)
#define DUMMY1_PWR_CON                 (SPM_BASE + 0x2B4)
#define BIG_CLK_CON                    (SPM_BASE + 0x2C0)
#define LITTLE_CLK_CON                 (SPM_BASE + 0x2C4)
...
#define MFG_SRAM_CON                   (SPM_BASE + 0x33C)
#define MFG_CORE0_PWR_CON              (SPM_BASE + 0x340)
#define MFG_CORE1_PWR_CON              (SPM_BASE + 0x344)
#define MFG_CORE2_PWR_CON              (SPM_BASE + 0x348)
#define MFG_CORE3_PWR_CON              (SPM_BASE + 0x34C)
...
#define DVFSP0_SRAM_CON                (SPM_BASE + 0x374)
#define DVFSP1_SRAM_CON                (SPM_BASE + 0x378)
#define MD_EXT_BUCK_ISO                (SPM_BASE + 0x390)
#define DUMMY2_PWR_CON                 (SPM_BASE + 0x3B0)
#define DUMMY3_PWR_CON                 (SPM_BASE + 0x3B4)
#define DPY_CH1_PWR_CON                (SPM_BASE + 0x3B8)
...
#define MP2_CPU0_IRQ_MASK              (SPM_BASE + 0x520)
#define MP2_CPU1_IRQ_MASK              (SPM_BASE + 0x524)
#define MP2_CPU2_IRQ_MASK              (SPM_BASE + 0x528)
#define MP2_CPU3_IRQ_MASK              (SPM_BASE + 0x52C)
#define MP3_CPU0_IRQ_MASK              (SPM_BASE + 0x530)
#define MP3_CPU1_IRQ_MASK              (SPM_BASE + 0x534)
#define MP3_CPU2_IRQ_MASK              (SPM_BASE + 0x538)
#define MP3_CPU3_IRQ_MASK              (SPM_BASE + 0x53C)
#define MP0_CPU0_WFI_EN                (SPM_BASE + 0x540)
#define MP0_CPU1_WFI_EN                (SPM_BASE + 0x544)
#define MP0_CPU2_WFI_EN                (SPM_BASE + 0x548)
#define MP0_CPU3_WFI_EN                (SPM_BASE + 0x54C)
#define MP1_CPU0_WFI_EN                (SPM_BASE + 0x550)
#define MP1_CPU1_WFI_EN                (SPM_BASE + 0x554)
#define MP1_CPU2_WFI_EN                (SPM_BASE + 0x558)
#define MP1_CPU3_WFI_EN                (SPM_BASE + 0x55C)
#define MP2_CPU0_WFI_EN                (SPM_BASE + 0x560)
#define MP2_CPU1_WFI_EN                (SPM_BASE + 0x564)
#define MP2_CPU2_WFI_EN                (SPM_BASE + 0x568)
#define MP2_CPU3_WFI_EN                (SPM_BASE + 0x56C)
#define MP3_CPU0_WFI_EN                (SPM_BASE + 0x570)
#define MP3_CPU1_WFI_EN                (SPM_BASE + 0x574)
#define MP3_CPU2_WFI_EN                (SPM_BASE + 0x578)
#define MP3_CPU3_WFI_EN                (SPM_BASE + 0x57C)
