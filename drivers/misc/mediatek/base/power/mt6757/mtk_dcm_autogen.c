...
#define INFRACFG_AO_DCM_INFRA_BUS_REG0_MASK                                    \
	((0x1 << 0) | (0x1 << 1) | (0x1 << 2) | (0x1 << 3) | (0x1 << 4) |      \
	 (0x1 << 20) | (0x1 << 21) | (0x1 << 22))
#define INFRACFG_AO_DCM_INFRA_BUS_REG0_ON                                      \
	((0x1 << 0) | (0x1 << 1) | (0x0 << 2) | (0x0 << 3) | (0x0 << 4) |      \
	 (0x1 << 20) | (0x1 << 21) | (0x1 << 22))
#define INFRACFG_AO_DCM_INFRA_BUS_REG0_OFF                                     \
	((0x0 << 0) | (0x0 << 1) | (0x0 << 2) | (0x0 << 3) | (0x0 << 4) |      \
	 (0x0 << 20) | (0x1 << 21) | (0x1 << 22))
#if 0
...
static void infracfg_ao_infra_dcm_rg_fsel_set(unsigned int val)
{
	reg_write(INFRA_BUS_DCM_CTRL,
		  (reg_read(INFRA_BUS_DCM_CTRL) & ~(0x1f << 5)) |
		      (val & 0x1f) << 5);
}
static void infracfg_ao_infra_dcm_rg_sfsel_set(unsigned int val)
{
	reg_write(INFRA_BUS_DCM_CTRL,
		  (reg_read(INFRA_BUS_DCM_CTRL) & ~(0x1f << 10)) |
		      (val & 0x1f) << 10);
}
...
#define INFRACFG_AO_DCM_PERI_BUS_REG0_MASK                                     \
	((0x1 << 0) | (0x1 << 1) | (0x1 << 3) | (0x1 << 4) | (0x1f << 15) |    \
	 (0x1 << 20) | (0x1 << 21) | (0x1 << 28) | (0x1 << 29) | (0x1 << 31))
#define INFRACFG_AO_DCM_PERI_BUS_REG0_ON                                       \
	((0x1 << 0) | (0x1 << 1) | (0x0 << 3) | (0x0 << 4) | (0x1f << 15) |    \
	 (0x1 << 20) | (0x1 << 21) | (0x1 << 28) | (0x1 << 29) | (0x1 << 31))
#define INFRACFG_AO_DCM_PERI_BUS_REG0_OFF                                      \
	((0x0 << 0) | (0x0 << 1) | (0x0 << 3) | (0x0 << 4) | (0x0 << 15) |     \
	 (0x0 << 20) | (0x0 << 21) | (0x0 << 28) | (0x0 << 29) | (0x0 << 31))
#if 0
...
bool dcm_infracfg_ao_infra_md_fmem_is_on(int on)
{
	...
	ret &= !!(reg_read(INFRA_MISC) & ~INFRACFG_AO_INFRA_MD_FMEM_REG0_MASK &
...
void dcm_infracfg_ao_infra_md_fmem(int on)
{
	if (on) {
		...
		reg_write(INFRA_MISC, (reg_read(INFRA_MISC) &
...
bool dcm_infracfg_ao_p2p_rxclk_ctrl_is_on(int on)
{
	...
	ret &=
	    !!(reg_read(P2P_RX_CLK_ON) & ~INFRACFG_AO_P2P_RXCLK_CTRL_REG0_MASK &
 ...
 * This workaround is for left shift 1 for bit (15, 16, 17) after read
 *register(0x10001010)
 ******************************************************************************/
#if 0
#define INFRA_TOPCKGEN_DCMCTL_SW_WORKAROUND_MASK                               \
	((0x1 << 15) | (0x1 << 16) | (0x1 << 17))

#define INFRA_TOPCKGEN_DCMCTL_SW_WORKAROUND(reg)                               \
	((reg & ~INFRA_TOPCKGEN_DCMCTL_SW_WORKAROUND_MASK) |                   \
...
#define INFRACFG_AO_MCU_ARMPLL_BUS_REG0_MODE2_MASK                             \
	((0x1 << 3) | (0x1 << 14) | (0x1 << 18))
#define INFRACFG_AO_MCU_ARMPLL_BUS_REG0_MODE2_ON                               \
	((0x1 << 3) | (0x1 << 14) | (0x1 << 18))
#define INFRACFG_AO_MCU_ARMPLL_BUS_REG0_MODE2_OFF                              \
	((0x0 << 3) | (0x0 << 14) | (0x0 << 18))
...
#define INFRACFG_AO_MCU_ARMPLL_CA7L_REG0_MODE2_MASK                            \
	((0x1 << 1) | (0x1 << 12) | (0x1 << 16))
#define INFRACFG_AO_MCU_ARMPLL_CA7L_REG0_MODE2_ON                              \
	((0x1 << 1) | (0x1 << 12) | (0x1 << 16))
#define INFRACFG_AO_MCU_ARMPLL_CA7L_REG0_MODE2_OFF                             \
	((0x0 << 1) | (0x0 << 12) | (0x0 << 16))
...
#define INFRACFG_AO_MCU_ARMPLL_CA7LL_REG0_MODE2_MASK                           \
	((0x1 << 2) | (0x1 << 13) | (0x1 << 17))
#define INFRACFG_AO_MCU_ARMPLL_CA7LL_REG0_MODE2_ON                             \
	((0x1 << 2) | (0x1 << 13) | (0x1 << 17))
#define INFRACFG_AO_MCU_ARMPLL_CA7LL_REG0_MODE2_OFF                            \
	((0x0 << 2) | (0x0 << 13) | (0x0 << 17))
...
void dcm_mcsi_a(int on)
{
	if (on) {
		...
		MCSI_A_SMC_WRITE(MCSI_A_DCM, (MCSI_A_SMC_READ(MCSI_A_DCM) &
					      ~MCSI_A_REG0_MASK) |
						 MCSI_A_REG0_ON);
	} else {
...
bool dcm_mp0_cpucfg_dcm_mcu_bus_is_on(int on)
{
	...
	ret &=
	    !!(reg_read(MP0_DBG_PWR_CTRL) & ~MP0_CPUCFG_DCM_MCU_BUS_REG0_MASK &
...
bool dcm_mp1_cpucfg_dcm_mcu_bus_is_on(int on)
{
	...
	ret &=
	    !!(reg_read(MP1_DBG_PWR_CTRL) & ~MP1_CPUCFG_DCM_MCU_BUS_REG0_MASK &
...
bool dcm_mcu_misccfg_cci_sync_dcm_is_on(int on)
{
	...
	ret &=
	    !!(reg_read(SYNC_DCM_CONFIG) & ~MCU_MISCCFG_CCI_SYNC_DCM_REG0_MASK &
...
bool dcm_mcu_misccfg_mp0_sync_dcm_is_on(int on)
{
	...
	ret &=
	    !!(reg_read(SYNC_DCM_CONFIG) & ~MCU_MISCCFG_MP0_SYNC_DCM_REG0_MASK &
...
bool dcm_mcu_misccfg_mp1_sync_dcm_is_on(int on)
{
	...
	ret &=
	    !!(reg_read(SYNC_DCM_CONFIG) & ~MCU_MISCCFG_MP1_SYNC_DCM_REG0_MASK &
...
#define MCU_MISCCFG_DCM_MCU_BUS_REG2_MASK                                      \
	((0x1 << 0) | (0x1 << 1) | (0x1 << 2) | (0x1 << 3) | (0x1 << 4) |      \
	 (0x1 << 5) | (0x1 << 6) | (0x1 << 7) | (0x1 << 8) | (0x1 << 9) |      \
	 (0x1 << 10) | (0x1 << 11) | (0x1 << 12) | (0x1 << 16) | (0x1 << 17) | \
	 (0x1 << 18) | (0x1 << 19) | (0x1 << 20) | (0x1 << 21) | (0x1 << 22) | \
	 (0x1 << 23))
#define MCU_MISCCFG_DCM_MCU_BUS_REG3_MASK                                      \
	((0x1 << 0) | (0x1 << 1) | (0x1 << 2) | (0x1 << 3) | (0x1 << 4) |      \
	 (0x1 << 5) | (0x1 << 6))
...
#define MCU_MISCCFG_DCM_MCU_BUS_REG2_ON                                        \
	((0x1 << 0) | (0x1 << 1) | (0x1 << 2) | (0x1 << 3) | (0x1 << 4) |      \
	 (0x1 << 5) | (0x1 << 6) | (0x1 << 7) | (0x1 << 8) | (0x1 << 9) |      \
	 (0x1 << 10) | (0x1 << 11) | (0x1 << 12) | (0x1 << 16) | (0x1 << 17) | \
	 (0x1 << 18) | (0x1 << 19) | (0x1 << 20) | (0x1 << 21) | (0x1 << 22) | \
	 (0x1 << 23))
#define MCU_MISCCFG_DCM_MCU_BUS_REG3_ON                                        \
	((0x1 << 0) | (0x1 << 1) | (0x1 << 2) | (0x1 << 3) | (0x1 << 4) |      \
	 (0x1 << 5) | (0x1 << 6))
...
#define MCU_MISCCFG_DCM_MCU_BUS_REG2_OFF                                       \
	((0x0 << 0) | (0x0 << 1) | (0x0 << 2) | (0x0 << 3) | (0x0 << 4) |      \
	 (0x0 << 5) | (0x0 << 6) | (0x0 << 7) | (0x0 << 8) | (0x0 << 9) |      \
	 (0x0 << 10) | (0x0 << 11) | (0x0 << 12) | (0x0 << 16) | (0x0 << 17) | \
	 (0x0 << 18) | (0x0 << 19) | (0x0 << 20) | (0x0 << 21) | (0x0 << 22) | \
	 (0x0 << 23))
#define MCU_MISCCFG_DCM_MCU_BUS_REG3_OFF                                       \
	((0x0 << 0) | (0x0 << 1) | (0x0 << 2) | (0x0 << 3) | (0x0 << 4) |      \
	 (0x0 << 5) | (0x0 << 6))
...
bool dcm_mcu_misccfg_dcm_mcu_bus_is_on(int on)
{
	...
	ret &= !!(reg_read(L2C_SRAM_CTRL) & ~MCU_MISCCFG_DCM_MCU_BUS_REG0_MASK &
		  MCU_MISCCFG_DCM_MCU_BUS_REG0_ON);
	ret &= !!(reg_read(CCI_CLK_CTRL) & ~MCU_MISCCFG_DCM_MCU_BUS_REG1_MASK &
	...
	ret &=
	    !!(reg_read(BIG_DBG_PWR_CTRL) & ~MCU_MISCCFG_DCM_MCU_BUS_REG4_MASK &
...
void dcm_mcu_misccfg_dcm_mcu_bus(int on)
{
	if (on) {
		...
		reg_write(L2C_SRAM_CTRL, (reg_read(L2C_SRAM_CTRL) &
					  ~MCU_MISCCFG_DCM_MCU_BUS_REG0_MASK) |
					     MCU_MISCCFG_DCM_MCU_BUS_REG0_ON);
		reg_write(CCI_CLK_CTRL, (reg_read(CCI_CLK_CTRL) &
...
bool dcm_emi_dcm_emi_group_is_on(int on)
{
	...
	ret &= !!(reg_read(EMI_CONM) & ~EMI_DCM_EMI_GROUP_REG0_MASK &
		  EMI_DCM_EMI_GROUP_REG0_ON);
	ret &= !!(reg_read(EMI_CONN) & ~EMI_DCM_EMI_GROUP_REG1_MASK &
...
void dcm_emi_dcm_emi_group(int on)
{
	if (on) {
		...
		reg_write(EMI_CONM,
			  (reg_read(EMI_CONM) & ~EMI_DCM_EMI_GROUP_REG0_MASK) |
			      EMI_DCM_EMI_GROUP_REG0_ON);
		reg_write(EMI_CONN,
			  (reg_read(EMI_CONN) & ~EMI_DCM_EMI_GROUP_REG1_MASK) |
			      EMI_DCM_EMI_GROUP_REG1_ON);
	} else {
...
#define DRAMC_CH0_TOP0_DDRPHY_REG0_MASK                                        \
	((0x1 << 8) | (0x1 << 9) | (0x1 << 10) | (0x1 << 11) | (0x1 << 12) |   \
	 (0x1 << 13) | (0x1 << 14) | (0x1 << 15) | (0x1 << 16) | (0x1 << 17) | \
	 (0x1 << 19))
#define DRAMC_CH0_TOP0_DDRPHY_REG1_MASK ((0x1 << 6) | (0x1 << 7) | (0x1 << 26))
#define DRAMC_CH0_TOP0_DDRPHY_REG0_ON                                          \
	((0x0 << 8) | (0x0 << 9) | (0x0 << 10) | (0x0 << 11) | (0x0 << 12) |   \
	 (0x0 << 13) | (0x0 << 14) | (0x0 << 15) | (0x0 << 16) | (0x0 << 17) | \
	 (0x0 << 19))
#define DRAMC_CH0_TOP0_DDRPHY_REG1_ON ((0x0 << 6) | (0x0 << 7) | (0x0 << 26))
#define DRAMC_CH0_TOP0_DDRPHY_REG0_OFF                                         \
	((0x1 << 8) | (0x1 << 9) | (0x1 << 10) | (0x1 << 11) | (0x1 << 12) |   \
	 (0x1 << 13) | (0x1 << 14) | (0x1 << 15) | (0x1 << 16) | (0x1 << 17) | \
	 (0x1 << 19))
#define DRAMC_CH0_TOP0_DDRPHY_REG1_OFF ((0x1 << 6) | (0x1 << 7) | (0x0 << 26))
#if 0
...
static void dramc_ch0_top0_rg_mem_dcm_idle_fsel_set(unsigned int val)
{
	reg_write(DRAMC_CH0_TOP0_MISC_CG_CTRL2,
		  (reg_read(DRAMC_CH0_TOP0_MISC_CG_CTRL2) & ~(0x1f << 21)) |
		      (val & 0x1f) << 21);
}
...
#define DRAMC_CH0_TOP1_DCM_DRAMC_CH0_PD_CTRL_REG0_MASK                         \
	((0x1 << 0) | (0x1 << 1) | (0x1 << 2) | (0x1 << 26) | (0x1 << 30) |    \
	 (0x1 << 31))
#define DRAMC_CH0_TOP1_DCM_DRAMC_CH0_PD_CTRL_REG1_MASK ((0x1 << 31))
#define DRAMC_CH0_TOP1_DCM_DRAMC_CH0_PD_CTRL_REG0_ON                           \
	((0x1 << 0) | (0x1 << 1) | (0x1 << 2) | (0x0 << 26) | (0x1 << 30) |    \
	 (0x1 << 31))
#define DRAMC_CH0_TOP1_DCM_DRAMC_CH0_PD_CTRL_REG1_ON ((0x1 << 31))
#define DRAMC_CH0_TOP1_DCM_DRAMC_CH0_PD_CTRL_REG0_OFF                          \
	((0x0 << 0) | (0x0 << 1) | (0x0 << 2) | (0x1 << 26) | (0x0 << 30) |    \
	 (0x0 << 31))
...
#define DRAMC_CH1_TOP0_DDRPHY_REG0_MASK                                        \
	((0x1 << 8) | (0x1 << 9) | (0x1 << 10) | (0x1 << 11) | (0x1 << 12) |   \
	 (0x1 << 13) | (0x1 << 14) | (0x1 << 15) | (0x1 << 16) | (0x1 << 17) | \
	 (0x1 << 19))
#define DRAMC_CH1_TOP0_DDRPHY_REG1_MASK ((0x1 << 6) | (0x1 << 7) | (0x1 << 26))
#define DRAMC_CH1_TOP0_DDRPHY_REG0_ON                                          \
	((0x0 << 8) | (0x0 << 9) | (0x0 << 10) | (0x0 << 11) | (0x0 << 12) |   \
	 (0x0 << 13) | (0x0 << 14) | (0x0 << 15) | (0x0 << 16) | (0x0 << 17) | \
	 (0x0 << 19))
#define DRAMC_CH1_TOP0_DDRPHY_REG1_ON ((0x0 << 6) | (0x0 << 7) | (0x0 << 26))
#define DRAMC_CH1_TOP0_DDRPHY_REG0_OFF                                         \
	((0x1 << 8) | (0x1 << 9) | (0x1 << 10) | (0x1 << 11) | (0x1 << 12) |   \
	 (0x1 << 13) | (0x1 << 14) | (0x1 << 15) | (0x1 << 16) | (0x1 << 17) | \
	 (0x1 << 19))
#define DRAMC_CH1_TOP0_DDRPHY_REG1_OFF ((0x1 << 6) | (0x1 << 7) | (0x0 << 26))
#if 0
...
static void dramc_ch1_top0_rg_mem_dcm_idle_fsel_set(unsigned int val)
{
	reg_write(DRAMC_CH1_TOP0_MISC_CG_CTRL2,
		  (reg_read(DRAMC_CH1_TOP0_MISC_CG_CTRL2) & ~(0x1f << 21)) |
		      (val & 0x1f) << 21);
}
...
#define DRAMC_CH1_TOP1_DCM_DRAMC_CH1_PD_CTRL_REG0_MASK                         \
	((0x1 << 0) | (0x1 << 1) | (0x1 << 2) | (0x1 << 26) | (0x1 << 30) |    \
	 (0x1 << 31))
#define DRAMC_CH1_TOP1_DCM_DRAMC_CH1_PD_CTRL_REG1_MASK ((0x1 << 31))
#define DRAMC_CH1_TOP1_DCM_DRAMC_CH1_PD_CTRL_REG0_ON                           \
	((0x1 << 0) | (0x1 << 1) | (0x1 << 2) | (0x0 << 26) | (0x1 << 30) |    \
	 (0x1 << 31))
#define DRAMC_CH1_TOP1_DCM_DRAMC_CH1_PD_CTRL_REG1_ON ((0x1 << 31))
#define DRAMC_CH1_TOP1_DCM_DRAMC_CH1_PD_CTRL_REG0_OFF                          \
	((0x0 << 0) | (0x0 << 1) | (0x0 << 2) | (0x1 << 26) | (0x0 << 30) |    \
	 (0x0 << 31))
