...
unsigned int abist_meter_32k(void)
{
	...
	pminit_write(CLK_DBG_CFG, (clk_dbg_cfg & 0xFFC0FFFC) | (39 << 16));
	...
	pminit_write(CLK26CALI_0, 0x0100);
	temp = pminit_read(CLK26CALI_1);
	pminit_write(CLK26CALI_1, (temp&0xfc00ffff)|(0x40<<16));
	...
	pminit_write(CLK26CALI_1, (temp&0xfc00ffff)|(0x3FF<<16));
