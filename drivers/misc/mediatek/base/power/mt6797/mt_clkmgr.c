...
/* apmixed */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6797-apmixedsys");
	if (!node)
...
/* cksys_base */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6797-topckgen");
	if (!node)
...
/* pericfg_base */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6797-perisys");
	if (!node)
...
/* audio */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6797-audiosys");
	if (!node)
...
/* mfgcfg */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6797-mfgsys");
	if (!node)
...
/* mmsys_config */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6797-mmsys");
	if (!node)
...
/* imgsys */
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6797-imgsys");
	if (!node)
