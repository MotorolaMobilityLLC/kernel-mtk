...
int BigIDVFSFreq(unsigned int Freqpct_x100)
{
	...
	idvfs_ver("iDVFS freq cur setting success. Freq_pct_x100 = %d, Freq_cur = %dMHz. Freq_SWREQ = 0x%x.\n",
				Freqpct_x100, idvfs_init_opt.freq_cur, freq_swreq);
	return 0;
}
