...
#if CLKDBG_6755
	const char *cmp = "mediatek,mt6750-scpsys";
#endif
...
{
#if CLKDBG_6755
	get_base_from_node("mediatek,mt6750-topckgen", 0, &topckgen_base);
	get_base_from_node("mediatek,mt6750-infrasys", 0, &infrasys_base);
	get_base_from_node("mediatek,mt6750-perisys", 0, &perisys_base);
	get_base_from_node("mediatek,mcucfg", 0, &mcucfg_base);
	get_base_from_node("mediatek,mt6750-apmixedsys", 0, &apmixedsys_base);
	get_base_from_node("mediatek,mt6750-mfgsys", 0, &mfgsys_base);
	get_base_from_node("mediatek,mt6750-mmsys", 0, &mmsys_base);
	get_base_from_node("mediatek,mt6750-imgsys", 0, &imgsys_base);
	get_base_from_node("mediatek,mt6750-vdecsys", 0, &vdecsys_base);
	get_base_from_node("mediatek,mt6750-vencsys", 0, &vencsys_base);
	get_base_from_node("mediatek,mt6750-audiosys", 0, &audiosys_base);
	get_base_from_node("mediatek,mt6750-scpsys", 1, &scpsys_base);
#endif /* CLKDBG_SOC */
}
