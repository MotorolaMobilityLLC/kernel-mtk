...
#else
#define NR_PTP1_EFUSE_SPARE_REG	1
#endif
...
static unsigned int efuse_spare_reg[NR_PTP1_EFUSE_SPARE_REG] = {EEMSPARE0};
...
static void picachu_get_data(enum mt_picachu_vproc_id vproc_id)
{
	...
	p->pi_offset_n_vmin = picachu_read(eem_base_addr + EEMSPARE1);

}

static int eem_ctrl_id[NR_PICACHU_VPROC][NR_PTP1_EFUSE_SPARE_REG] = {
	[MT_PICACHU_LITTLE_VPROC] = {EEM_CTRL_2L},
};
