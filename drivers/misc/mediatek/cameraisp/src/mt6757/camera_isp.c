...
/* Mark codes first, should check it in later */
/*#define EP_CODE_MARK*/
...
enum ISP_HW_MODULE {
	CAM_A   = 0,
	CAM_B,
	/* CAM_C,        //not supported in MT6797 */
	/* CAM_D,        //not supported in MT6797 */
	CAM_MAX,
	CAMSV_START = CAM_MAX,
	CAMSV_0 = CAMSV_START,
	CAMSV_1,
...
static signed int
	ISP_ResetResume_Cam(enum ISP_IRQ_TYPE_ENUM module, unsigned int resume);
#if (TIMESTAMP_QUEUE_EN == 1)
static void
...
static enum
	CAM_FrameST Irq_CAM_SttFrameStatus(
...
static signed int
	G_WRDMA_IonCt[CAM_MAX][_dma_max_wr_][_ion_keep_max_] = { { {0} } };
static signed int
	G_WRDMA_IonFd[CAM_MAX][_dma_max_wr_][_ion_keep_max_] = { { {0} } };
static struct ion_handle
	*G_WRDMA_IonHnd[CAM_MAX][_dma_max_wr_][_ion_keep_max_] = { { {NULL} } };
/* protect G_WRDMA_IonHnd & G_WRDMA_IonFd */
static spinlock_t
	SpinLock_IonHnd[CAM_MAX][_dma_max_wr_];
#endif
/******************************************************************************
 *
 ******************************************************************************/
...
static void ISP_DumpDmaDeepDbg(enum ISP_IRQ_TYPE_ENUM module)
{
	...
	case ISP_IRQ_TYPE_INT_CAM_A_ST:
		IRQ_LOG_KEEPER(module, m_CurrentPPB, _LOG_ERR,
	"CAM_A:IMGO:0x%x,RRZO:0x%x,AAO=0x%x,AFO=0x%x,LCSO=0x%x,\n",
			dmaerr[0],
			dmaerr[1],
			dmaerr[2],
			dmaerr[3],
			dmaerr[4]);
		IRQ_LOG_KEEPER(module, m_CurrentPPB, _LOG_ERR,
	"CAM_A:UFEO=0x%x,BPCI:0x%x,CACI:0x%x,LSCI=0x%x,PDO=0x%x\n",
			dmaerr[5],
			dmaerr[6],
			dmaerr[7],
			dmaerr[8],
	...
	case ISP_IRQ_TYPE_INT_CAM_B_ST:
		IRQ_LOG_KEEPER(module, m_CurrentPPB, _LOG_ERR,
	"CAM_B:IMGO:0x%x,RRZO:0x%x,AAO=0x%x,AFO=0x%x,LCSO=0x%x,\n",
			dmaerr[0],
			dmaerr[1],
			dmaerr[2],
			dmaerr[3],
			dmaerr[4]);
		IRQ_LOG_KEEPER(module, m_CurrentPPB, _LOG_ERR,
	"CAM_B:UFEO=0x%x,BPCI:0x%x,CACI:0x%x,LSCI=0x%x,PDO=0x%x\n",
			dmaerr[5],
			dmaerr[6],
			dmaerr[7],
			dmaerr[8],
...
static signed int ISP_DumpSeninfReg(void)
{
	...
	LOG_INF("seninf:0008(0x%x)-0010(0x%x)-03a0(0x%x)-07a0(0x%x)\n",
		ISP_RD32(ISP_SENINF0_BASE + 0x0008),
		ISP_RD32(ISP_SENINF0_BASE + 0x0010),
		ISP_RD32(ISP_SENINF0_BASE + 0x03a0),
		ISP_RD32(ISP_SENINF0_BASE + 0x07a0));
	LOG_INF("seninf:03b4(0x%x)-07b4(0x%x)-03b4(0x%x)-07b4(0x%x)\n",
		ISP_RD32(ISP_SENINF0_BASE + 0x03b4),
		ISP_RD32(ISP_SENINF0_BASE + 0x07b4),
		ISP_RD32(ISP_SENINF0_BASE + 0x03b4),
		ISP_RD32(ISP_SENINF0_BASE + 0x07b4));

	/*Sensor interface0 control*/
	LOG_INF("seninf:0200(0x%x)-0204(0x%x)-0a00(0x%x)-0a14(0x%x)\n",
		ISP_RD32(ISP_SENINF0_BASE + 0x03b0),
		ISP_RD32(ISP_SENINF0_BASE + 0x03b4),
		ISP_RD32(ISP_SENINF0_BASE + 0x03b8),
		ISP_RD32(ISP_SENINF0_BASE + 0x03bc));
	LOG_INF("seninf:0a3c(0x%x)-0a44(0x%x)-0af0(0x%x)-0af4(0x%x)\n",
		ISP_RD32(ISP_SENINF0_BASE + 0x07b0),
		ISP_RD32(ISP_SENINF0_BASE + 0x07b4),
		ISP_RD32(ISP_SENINF0_BASE + 0x07b8),
		ISP_RD32(ISP_SENINF0_BASE + 0x07bc));
	/*Sensor interface mux*/
	LOG_INF("seninf:0100(0x%x)-0108(0x%x)-0114(0x%x)-0118(0x%x)\n",
		ISP_RD32(ISP_SENINF0_BASE + 0x0100),
		ISP_RD32(ISP_SENINF0_BASE + 0x0108),
		ISP_RD32(ISP_SENINF0_BASE + 0x0114),
		ISP_RD32(ISP_SENINF0_BASE + 0x0118));
	LOG_INF("seninf: 0a3c(0x%x)-0a44(0x%x)-0af0(0x%x)-0af4(0x%x)\n",
		ISP_RD32(ISP_SENINF0_BASE + 0x0500),
		ISP_RD32(ISP_SENINF0_BASE + 0x0508),
		ISP_RD32(ISP_SENINF0_BASE + 0x0514),
		ISP_RD32(ISP_SENINF0_BASE + 0x0518));
	LOG_INF("seninf:0900(0x%x)-0908(0x%x)-0914(0x%x)-0918(0x%x)\n",
		ISP_RD32(ISP_SENINF0_BASE + 0x0900),
		ISP_RD32(ISP_SENINF0_BASE + 0x0908),
		ISP_RD32(ISP_SENINF0_BASE + 0x0914),
		ISP_RD32(ISP_SENINF0_BASE + 0x0918));
...
static signed int ISP_ReadReg(struct ISP_REG_IO_STRUCT *pRegIo)
{
	...
	if ((pRegIo->Count >
		(PAGE_SIZE/sizeof(unsigned int))) || (pRegIo->pData == NULL)) {
		LOG_ERR(
		"ERROR %s pRegIo->pData is NULL or pRegIo->Count error:%d\n",
			__func__,
			pRegIo->Count);
		Ret = -EFAULT;
		goto EXIT;
...
static signed int ISP_DumpBuffer(struct ISP_DUMP_BUFFER_STRUCT *pDumpBufStruct)
{
	...
	case ISP_DUMP_TPIPEBUF_CMD:
		if (pDumpBufStruct->BytesofBufferSize >
			...
			LOG_ERR("tpipe size error, size:0x%x",
		...
		case ISP_RT_BUF_CTRL_CLEAR:
			...
			case ISP_IRQ_TYPE_INT_CAM_B_ST:
				if ((pstRTBuf[rt_buf_ctrl.module]->ring_buf[
					...
					gSTime[rt_buf_ctrl.module].sec =
						ISP_HW_TS_UNDEFINED;
					gSTime[rt_buf_ctrl.module].usec =
						ISP_HW_TS_UNDEFINED;
					#if (TSTMP_SUBSAMPLE_INTPL == 1)
				...
				memset((void *)
					g_DmaErr_CAM[rt_buf_ctrl.module],
					0,
					sizeof(unsigned int)*nDMA_ERR_CAM);
				break;
 ...
 ******************************************************************************/
static inline unsigned int
	ISP_P2_BufQue_WaitEventState(struct ISP_P2_BUFQUE_STRUCT param,
	...
	unsigned int fbclen)
{
	...
	if ((irqstat[ISP_IRQ_TYPE_INT_CAM_A_ST] &
		(ISP_IRQ_P1_STATUS_PASS1_DON_ST))) {
		if (pstRTBuf[ISP_IRQ_TYPE_INT_CAM_A_ST]->ring_buf[
			_rrzo_].active) {
			regWCNT = (pFbc[1].Raw & 0x0f000000) >> 24;
			regRCNT = (pFbc[1].Raw & 0x00f00000) >> 20;
			regFBCCNT = (pFbc[1].Raw & 0x0000000f);
			backup_WCNT =
				(g_backupReg.CAM_CTL_RRZO_FBC &
					0x0f000000) >> 24;
			backup_RCNT =
				(g_backupReg.CAM_CTL_RRZO_FBC &
					0x00f00000) >> 20;
			backup_FBCCNT =
				(g_backupReg.CAM_CTL_RRZO_FBC & 0x0000000F);
		} else if (pstRTBuf[
			ISP_IRQ_TYPE_INT_CAM_A_ST]->ring_buf[_imgo_].active) {
			regWCNT = (pFbc[0].Raw & 0x0f000000) >> 24;
			regRCNT = (pFbc[0].Raw & 0x00f00000) >> 20;
			regFBCCNT = (pFbc[0].Raw & 0x0000000f);
			backup_WCNT =
				(g_backupReg.CAM_CTL_IMGO_FBC &
					0x0f000000) >> 24;
			backup_RCNT =
				(g_backupReg.CAM_CTL_IMGO_FBC &
					0x00f00000) >> 20;
			backup_FBCCNT =
				(g_backupReg.CAM_CTL_IMGO_FBC & 0x0000000f);
		}
		...
		if ((backup_WCNT == backup_RCNT) && (backup_FBCCNT > 0)) {
			if (backup_WCNT != CONSST_FBC_CNT_INIT) {
				...
				if (backup_RCNT > regRCNT) {
					...
					ISP_WR32(CAM_REG_ADDR_IMGO_FBC_1,
						pFbc[0].Raw);
					pFbc[1].Bits.RCNT_INC = 1;
					ISP_WR32(CAM_REG_ADDR_RRZO_FBC_1,
						pFbc[1].Raw);
				}
			}
			...
			if (regFBCCNT == backup_FBCCNT) {
				for (i = 0; i < IRQ_USER_NUM_MAX; i++) {
					...
					ISP_IRQ_TYPE_INT_CAM_A_ST][i] |=
					ISP_IRQ_P1_STATUS_PESUDO_P1_DON_ST;
				}
				ISP_WR32(ISP_ADDR + 0x20,
					(g_backupReg.CAM_CTL_CQ_EN &
					0xffff7bff));
				ISP_WR32((void *)(ISP_IMGSYS_BASE +
					0x7300),
					g_backupReg.CAM_IMGO_BASE_ADDR);
				ISP_WR32((void *)(ISP_IMGSYS_BASE +
					0x7320),
					g_backupReg.CAM_RRZO_BASE_ADDR);
				bResumeSignal = 0;
			...
			/* When we still have buffer to write. */
			/* we only let the WCNT is equtal to backup WCNT */
	...
	if (irqstat[ISP_IRQ_TYPE_INT_CAM_B_ST] &
		(ISP_IRQ_P1_STATUS_D_PASS1_DON_ST)) {
		if (pstRTBuf[ISP_IRQ_TYPE_INT_CAM_B_ST]->ring_buf[
			_rrzo_].active) {
			regWCNT = (pFbc[3].Raw & 0x0f000000) >>
				24;
			regRCNT = (pFbc[3].Raw & 0x00f00000) >>
				20;
			regFBCCNT = (pFbc[3].Raw & 0x0000000f);
			backup_WCNT = (g_backupReg.CAM_CTL_RRZO_D_FBC &
				0x0f000000) >> 24;
			backup_RCNT = (g_backupReg.CAM_CTL_RRZO_D_FBC &
				0x00f00000) >> 20;
			backup_FBCCNT = (g_backupReg.CAM_CTL_RRZO_D_FBC &
				0x0000000f);
		} else if (pstRTBuf[ISP_IRQ_TYPE_INT_CAM_B_ST]->ring_buf[
			_imgo_].active) {
			regWCNT =
				(pFbc[2].Raw & 0x0f000000) >> 24;
			regRCNT =
				(pFbc[2].Raw & 0x00f00000) >> 20;
			regFBCCNT = (pFbc[2].Raw & 0x0000000f);
			backup_WCNT =
				(g_backupReg.CAM_CTL_IMGO_D_FBC & 0x0f000000) >>
					24;
			backup_RCNT =
				(g_backupReg.CAM_CTL_IMGO_D_FBC & 0x00f00000) >>
					20;
			backup_FBCCNT =
				(g_backupReg.CAM_CTL_IMGO_D_FBC & 0x0000000f);
		}
		LOG_DBG("backup WCNT(%d), RCNT(%d), FBC_CNT(%d)\n)",
			backup_WCNT, backup_RCNT, backup_FBCCNT);
		LOG_DBG("Register WCNT(%d), RCNT(%d), FBC_CNT(%d)\n",
		...
		if ((backup_WCNT == backup_RCNT) &&
			...
			if (regFBCCNT == backup_FBCCNT) {
				for (i = 0; i < IRQ_USER_NUM_MAX; i++) {
					IspInfo.IrqInfo.Status[
						ISP_IRQ_TYPE_INT_CAM_B_ST][i] |=
					ISP_IRQ_P1_STATUS_PESUDO_P1_DON_ST;
				}
				/* Enable the CQ0, CQ0C, CQ0_D, CQ0C_D, */
				/* IMGO_D_BASE_ADDR and */
				...
				ISP_WR32((void *)(ISP_IMGSYS_BASE +
					0x74D4),
					g_backupReg.CAM_IMGO_D_BASE_ADDR);
				ISP_WR32((void *)(ISP_IMGSYS_BASE +
					0x74F4),
					g_backupReg.CAM_RRZO_D_BASE_ADDR);
				bResumeSignal = 0;
			...
			/* When we still have buffer to write.
			 * we only let the WCNT is equtal to
			 * backup WCNT and the RCNT is equal
			 * to backup RCNT
			 */
			if (regWCNT == backup_WCNT) {
				if (regRCNT >= backup_RCNT)
				...
				ISP_WR32(ISP_ADDR + 0x20,
					g_backupReg.CAM_CTL_CQ_EN);
				ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x74D4),
					g_backupReg.CAM_IMGO_D_BASE_ADDR);
				ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x74F4),
					g_backupReg.CAM_RRZO_D_BASE_ADDR);
				bResumeSignal = 0;
				wake_up_interruptible(
					&IspInfo.WaitQueueHead[
...
static signed int ISP_ResetResume_Cam(
	enum ISP_IRQ_TYPE_ENUM module, unsigned int flag)
{
#if 1
	...
	if (flag & 0x02) {
		...
		for (i = 0; i < _cam_max_; i++) {
			...
			case _imgo_:
				fbc_ctrl2[i] =
					ISP_RD32(
						CAM_REG_FBC_IMGO_CTL2(
						reg_module));
				break;
			case _rrzo_:
				fbc_ctrl2[i] =
					ISP_RD32(
						CAM_REG_FBC_RRZO_CTL2(
						reg_module));
				break;
			case _eiso_:
				fbc_ctrl2[i] =
					ISP_RD32(
						CAM_UNI_REG_FBC_EISO_A_CTL2(
						ISP_UNI_A_IDX));
				break;
			case _lcso_:
				fbc_ctrl2[i] =
					ISP_RD32(
						CAM_REG_FBC_LCSO_CTL2(
						reg_module));
				break;
			case _rsso_:
				fbc_ctrl2[i] =
			...
			case _flko_:
				fbc_ctrl2[i] =
					ISP_RD32(
						CAM_UNI_REG_FBC_FLKO_A_CTL2(
						ISP_UNI_A_IDX));
				break;
			case _pdo_:
				fbc_ctrl2[i] =
					ISP_RD32(
						CAM_REG_FBC_PDO_CTL2(
						reg_module));
				break;
			default:
	...
	if (flag & 0x02) {
		...
		for (i = 0; i < _cam_max_; i++) {
			...
			case _rrzo_:
				...
				break;
			case _eiso_:
				ISP_WR32(CAM_UNI_REG_FBC_EISO_A_CTL2(
					ISP_UNI_A_IDX),
					fbc_ctrl2[i]);
				break;
			case _lcso_:
				...
				break;
			case _rsso_:
				ISP_WR32(CAM_UNI_REG_FBC_RSSO_A_CTL2(
					ISP_UNI_A_IDX),
					fbc_ctrl2[i]);
				break;
			...
			case _afo_:
				...
				break;
			case _flko_:
				ISP_WR32(CAM_UNI_REG_FBC_FLKO_A_CTL2(
					ISP_UNI_A_IDX),
					fbc_ctrl2[i]);
				break;
			case _pdo_:
...
static long ISP_ioctl(struct file *pFile, unsigned int Cmd, unsigned long Param)
{
	...
	if (pFile->private_data == NULL) {
		LOG_WRN("private_data is NULL,(prc, pid, tgid)=(%s, %d, %d)\n",
			current->comm, current->pid, current->tgid);
		return -EFAULT;
	}
	/*  */
...
#undef ERR_STR
	...
	case ISP_VF_LOG:
		if (copy_from_user(DebugFlag,
			(void *)Param, sizeof(unsigned int) * 2) == 0) {
			unsigned int vf;
			...
			case 1: {
				...
				switch (DebugFlag[1]) {
				case 0:
#define TMP_STR1 "CAM_A viewFinder is ON,%s timestamp\n"
	LOG_INF(TMP_STR1, gEnableSwTimestamp ? "SW" : "HW");
#undef TMP_STR1
					...
					break;
				case 1:
#define TMP_STR1 "CAM_B viewFinder is ON, %s timestamp\n"
					LOG_INF(TMP_STR1,
						gEnableSwTimestamp ? "SW" :
						 "HW");
#undef TMP_STR1
					cam_dmao = ISP_RD32(CAM_REG_CTL_DMA_EN(
						ISP_CAM_B_IDX));
			...
			if (gEnableSwTimestamp) {
				...
				case ISP_IRQ_TYPE_INT_CAM_B_ST:
					...
					if (ISP_PopBufTimestamp(DebugFlag[0],
						dma_id,
						pTstp) != 0) {
#define TMP_STR1 "Get Buf sof timestamp fail"
						LOG_ERR(TMP_STR1);
#undef TMP_STR1
					}
...
#define TMP_STR1 "DebugFlag[0]:%d is out of range"
					LOG_ERR(TMP_STR1,
						DebugFlag[0]);
#undef TMP_STR1
					Ret = -EFAULT;
	...
	case ISP_ION_IMPORT:
		if (copy_from_user(&IonNode, (void *)Param,
			...
			if (IonNode.devNode < 0 ||
				IonNode.devNode >= CAM_MAX) {
...
#undef ERR_STR
			...
			spin_lock(&(SpinLock_IonHnd[IonNode.devNode]
				[IonNode.dmaPort]));
			/* */
			/* check if memID is exist */
			for (i = 0; i < _ion_keep_max_; i++) {
				if (G_WRDMA_IonFd[IonNode.devNode]
					[IonNode.dmaPort][i] == IonNode.memID)
					break;
			}
			spin_unlock(&(SpinLock_IonHnd[IonNode.devNode]
				[IonNode.dmaPort]));
			/* */
			if (i < _ion_keep_max_) {
				if (IspInfo.DebugMask & ISP_DBG_ION_CTRL) {
...
#undef TMP_STR2
			...
			for (i = 0; i < _ion_keep_max_; i++) {
				if (G_WRDMA_IonFd[IonNode.devNode][
					IonNode.dmaPort][i] == 0) {
					G_WRDMA_IonFd[IonNode.devNode][
					IonNode.dmaPort][i] = IonNode.memID;
					G_WRDMA_IonHnd[IonNode.devNode][
					IonNode.dmaPort][i] = handle;
...
#undef ERR_STR
			 ...
			 * memory.
			 */
			if (--G_WRDMA_IonCt[IonNode.devNode][
				IonNode.dmaPort][i] > 0) {
				spin_unlock(&(SpinLock_IonHnd[IonNode.devNode]
					[IonNode.dmaPort]));
				if (IspInfo.DebugMask & ISP_DBG_ION_CTRL) {
...
#undef TMP_STR
				...
				break;
			} else if (G_WRDMA_IonCt[IonNode.devNode][
				IonNode.dmaPort][i] < 0) {
				spin_unlock(&(SpinLock_IonHnd[IonNode.devNode]
					[IonNode.dmaPort]));
...
#undef TMP_STR
	...
	case ISP_RESET_LMV_FBC_CNT: {
		IspInfo.TstpQInfo[
			ISP_IRQ_TYPE_INT_CAM_A_ST].Dmao[
			_eiso_].PrevFbcWCnt = 0;
		IspInfo.TstpQInfo[
			ISP_IRQ_TYPE_INT_CAM_A_ST].Dmao[
			_rsso_].PrevFbcWCnt = 0;
		IspInfo.TstpQInfo[
			ISP_IRQ_TYPE_INT_CAM_B_ST].Dmao[
			_eiso_].PrevFbcWCnt = 0;
		IspInfo.TstpQInfo[
			ISP_IRQ_TYPE_INT_CAM_B_ST].Dmao[
			_rsso_].PrevFbcWCnt = 0;
...
static signed int ISP_probe(struct platform_device *pDev)
{
	...
	_ispdev = krealloc(isp_devs, sizeof(struct isp_device) * nr_isp_devs,
		GFP_KERNEL);
	if (!_ispdev) {
		dev_info(&pDev->dev, "ERROR: Unable to allocate isp_devs\n");
		return -ENOMEM;
	}
	isp_devs = _ispdev;
#else
...
#undef ERR_STR2
	...
	if (isp_dev->irq > 0) {
		...
		if (of_property_read_u32_array(pDev->dev.of_node, "interrupts",
			...
			dev_info(&pDev->dev, "ERROR: get irq flags from DTS fail!!\n");
			return -ENODEV;
		}
...
#undef TMP_STR
	...
	if (nr_isp_devs == 1) {
		...
		isp_clk.ISP_MM_SMI_COMMON =
			devm_clk_get(&pDev->dev, "ISP_MMSYS_SMI_COMMON");
		isp_clk.ISP_SCP_SYS_ISP =
			devm_clk_get(&pDev->dev, "ISP_SCP_SYS_ISP");
		isp_clk.ISP_SCP_SYS_CAM =
			devm_clk_get(&pDev->dev, "ISP_SCP_SYS_CAM");
		isp_clk.ISP_IMG_LARB5 =
			devm_clk_get(&pDev->dev, "ISP_IMG_LARB5");
		isp_clk.ISP_IMG_DIP =
			devm_clk_get(&pDev->dev, "ISP_IMG_DIP");
		isp_clk.ISP_IMG_RSC =
			devm_clk_get(&pDev->dev, "ISP_IMG_RSC");
		isp_clk.ISP_CAM_LARB2 =
			devm_clk_get(&pDev->dev, "ISP_CAMSYS_LARB2_CGPDN");
		isp_clk.ISP_CAM_CAMSYS =
			devm_clk_get(&pDev->dev, "ISP_CAMSYS_CAMSYS_CGPDN");
		isp_clk.ISP_CAM_CAMTG =
			devm_clk_get(&pDev->dev, "ISP_CAMSYS_CAMTG_CGPDN");
		isp_clk.ISP_CAM_SENINF =
			devm_clk_get(&pDev->dev, "ISP_CAMSYS_SENINF_CGPDN");
		isp_clk.ISP_CAM_CAMSV0 =
			devm_clk_get(&pDev->dev, "ISP_CAMSYS_CAMSV0_CGPDN");
		isp_clk.ISP_CAM_CAMSV1 =
			devm_clk_get(&pDev->dev, "ISP_CAMSYS_CAMSV1_CGPDN");
		isp_clk.ISP_CAM_CAMSV2 =
			devm_clk_get(&pDev->dev, "ISP_CAMSYS_CAMSV2_CGPDN");
		isp_clk.ISP_CAM_TSF =
			devm_clk_get(&pDev->dev, "ISP_CAMSYS_TSF_CGPDN");
...
static void backRegister(void)
{
	...
	for (i = 0; i <= 0x3c; i += 4)
		(*((unsigned int *)((unsigned long)pReg + i))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_CTL_SEL_GLOBAL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x4040));

	g_backupReg.CAM_CTL_INT_P1_EN =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x4048));
	g_backupReg.CAM_CTL_INT_P1_EN2 =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x4050));
	g_backupReg.CAM_CTL_INT_P1_EN_D =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x4058));
	g_backupReg.CAM_CTL_INT_P1_EN2_D =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x4060));
	g_backupReg.CAM_CTL_INT_P2_EN =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x4068));
	g_backupReg.CAM_CTL_TILE =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x407C));
	g_backupReg.CAM_CTL_TCM_EN =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x4084));

	pReg = &g_backupReg.CAM_CTL_SW_CTL;
	for (i = 0x8C; i <= 0xFC; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x8C)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_CTL_CLK_EN =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x4170));

	pReg = &g_backupReg.CAM_TG_SEN_MODE;
	for (i = 0x410; i <= 0x424; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x410)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	pReg = &g_backupReg.CAM_OBC_OFFST0;
	for (i = 0x500; i <= 0xD04; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x500)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	pReg = &g_backupReg.CAM_EIS_PREP_ME_CTRL1;
	for (i = 0xDC0; i <= 0xE50; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0xDC0)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	pReg = &g_backupReg.CAM_SL2_CEN;
	for (i = 0xF40; i <= 0xFD8; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0xF40)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);
	g_backupReg.CAM_GGM_CTRL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x5480));
	g_backupReg.CAM_PCA_CON1 =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x5E00));
	g_backupReg.CAM_PCA_CON2 =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x5E04));
	g_backupReg.CAM_TILE_RING_CON1 =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x5FF0));
	g_backupReg.CAM_CTL_IMGI_SIZE =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x5FF4));


	pReg = &g_backupReg.CAM_TG2_SEN_MODE;
	for (i = 0x2410; i <= 0x2424; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x2410)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	pReg = &g_backupReg.CAM_OBC_D_OFFST0;
	for (i = 0x2500; i <= 0x2854; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x2500)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	pReg = &g_backupReg.CAM_DMX_D_CTL;
	for (i = 0x2E00; i <= 0x2E28; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x2E00)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_TDRI_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7204));
	pReg = &g_backupReg.CAM_TDRI_XSIZE;
	for (i = 0x720C; i <= 0x7220; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x720C)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_LAST_ULTRA_EN =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7228));
	g_backupReg.CAM_IMGI_SLOW_DOWN =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x722C));
	g_backupReg.CAM_IMGI_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7230));

	pReg = &g_backupReg.CAM_IMGI_XSIZE;
	for (i = 0x3238; i <= 0x324C; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3238)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_BPCI_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7250));
	pReg = &g_backupReg.CAM_BPCI_XSIZE;
	for (i = 0x3258; i <= 0x3268; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3258)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_LSCI_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x726C));
	pReg = &g_backupReg.CAM_LSCI_XSIZE;
	for (i = 0x3274; i <= 0x3284; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3274)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_UFDI_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7288));
	pReg = &g_backupReg.CAM_UFDI_XSIZE;
	for (i = 0x3290; i <= 0x32A4; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3290)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	pReg = &g_backupReg.CAM_LCEI_XSIZE;
	for (i = 0x32AC; i <= 0x32C0; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x32AC)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	pReg = &g_backupReg.CAM_VIPI_XSIZE;
	for (i = 0x32C8; i <= 0x32E0; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x32C8)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	pReg = &g_backupReg.CAM_VIP2I_XSIZE;
	for (i = 0x32E8; i <= 0x32FC; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x32E8)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_IMGO_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7300));
	pReg = &g_backupReg.CAM_IMGO_XSIZE;
	for (i = 0x3308; i <= 0x331C; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3308)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_RRZO_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7320));
	pReg = &g_backupReg.CAM_RRZO_XSIZE;
	for (i = 0x3328; i <= 0x333C; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3328)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_LCSO_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7340));
	pReg = &g_backupReg.CAM_LCSO_XSIZE;
	for (i = 0x3348; i <= 0x3358; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3348)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	pReg = &g_backupReg.CAM_EISO_BASE_ADDR;
	for (i = 0x335C; i <= 0x3370; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x335C)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	pReg = &g_backupReg.CAM_ESFKO_YSIZE;
	for (i = 0x3378; i <= 0x3384; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3378)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_AAO_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7388));
	pReg = &g_backupReg.CAM_AAO_XSIZE;
	for (i = 0x3390; i <= 0x33A0; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3390)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_VIP3I_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x73A4));
	pReg = &g_backupReg.CAM_VIP3I_XSIZE;
	for (i = 0x33AC; i <= 0x33C0; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x33AC)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_UFEO_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x73C4));
	pReg = &g_backupReg.CAM_UFEO_XSIZE;
	for (i = 0x33CC; i <= 0x33DC; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x33CC)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_MFBO_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x73E0));
	pReg = &g_backupReg.CAM_MFBO_XSIZE;
	for (i = 0x33E8; i <= 0x33FC; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x33E8)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_IMG3BO_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7400));
	pReg = &g_backupReg.CAM_IMG3BO_XSIZE;
	for (i = 0x3408; i <= 0x341C; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3408)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_IMG3CO_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7420));
	pReg = &g_backupReg.CAM_IMG3CO_XSIZE;
	for (i = 0x3428; i <= 0x343C; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3428)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_IMG2O_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7440));
	pReg = &g_backupReg.CAM_IMG2O_XSIZE;
	for (i = 0x3448; i <= 0x345C; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3448)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_IMG3O_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7460));
	pReg = &g_backupReg.CAM_IMG3O_XSIZE;
	for (i = 0x3468; i <= 0x347C; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3468)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_FEO_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7480));
	pReg = &g_backupReg.CAM_FEO_XSIZE;
	for (i = 0x3488; i <= 0x3498; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3488)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_BPCI_D_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x749C));
	pReg = &g_backupReg.CAM_BPCI_D_XSIZE;
	for (i = 0x34A4; i <= 0x34B4; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x34A4)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_LSCI_D_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x74B8));
	pReg = &g_backupReg.CAM_LSCI_D_XSIZE;
	for (i = 0x34C0; i <= 0x34D0; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x34C0)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_IMGO_D_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x74D4));
	pReg = &g_backupReg.CAM_IMGO_D_XSIZE;
	for (i = 0x34DC; i <= 0x34F0; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x34DC)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_RRZO_D_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x74F4));
	pReg = &g_backupReg.CAM_RRZO_D_XSIZE;
	for (i = 0x34FC; i <= 0x3510; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x34FC)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_LCSO_D_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7514));
	pReg = &g_backupReg.CAM_LCSO_D_XSIZE;
	for (i = 0x351C; i <= 0x352C; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x351C)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_AFO_D_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7530));
	g_backupReg.CAM_AFO_D_XSIZE =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x7534));
	pReg = &g_backupReg.CAM_AFO_D_YSIZE;
	for (i = 0x353C; i <= 0x3548; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x353C)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);

	g_backupReg.CAM_AAO_D_BASE_ADDR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x754C));
	pReg = &g_backupReg.CAM_AAO_D_XSIZE;
	for (i = 0x3554; i <= 0x3564; i += 4)
		(*((unsigned int *)((unsigned long)pReg + (i - 0x3554)))) =
			(unsigned int)ISP_RD32(ISP_ADDR + i);


	g_SeninfBackupReg.SENINF_TOP_CTRL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8000));
	g_SeninfBackupReg.SENINF_TOP_CMODEL_PAR =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8004));
	g_SeninfBackupReg.SENINF_TOP_MUX_CTRL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8008));

	g_SeninfBackupReg.N3D_CTL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x80C0));
	g_SeninfBackupReg.N3D_POS =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x80C4));
	g_SeninfBackupReg.N3D_TRIG =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x80C8));
	g_SeninfBackupReg.N3D_INT =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x80CC));

	/* Seninf 1 */
	g_SeninfBackupReg.SENINF1_CTRL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8100));
	g_SeninfBackupReg.SENINF1_MUX_CTRL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8120));
	g_SeninfBackupReg.SENINF1_MUX_INTEN =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8124));
	g_SeninfBackupReg.SENINF1_MUX_SIZE =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x812C));

	g_SeninfBackupReg.SENINF_TG1_PH_CNT =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8200));
	g_SeninfBackupReg.SENINF_TG1_SEN_CK =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8204));

	g_SeninfBackupReg.SENINF1_CSI2_CTRL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8360));
	g_SeninfBackupReg.SENINF1_CSI2_DELAY =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8364));
	g_SeninfBackupReg.SENINF1_CSI2_INTEN =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8368));

	g_SeninfBackupReg.SENINF1_NCSI2_CTL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x83A0));
	g_SeninfBackupReg.SENINF1_NCSI2_LNRC_TIMING =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x83A4));
	g_SeninfBackupReg.SENINF1_NCSI2_LNRD_TIMING =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x83A8));
	g_SeninfBackupReg.SENINF1_NCSI2_INT_EN =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x83B0));
	g_SeninfBackupReg.SENINF1_NCSI2_DI_CTRL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x83E4));
	/* Seninf 1 */
	g_SeninfBackupReg.SENINF2_CTRL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8500));
	g_SeninfBackupReg.SENINF2_MUX_CTRL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8520));
	g_SeninfBackupReg.SENINF2_MUX_INTEN =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8524));
	g_SeninfBackupReg.SENINF2_MUX_SIZE =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x852C));

	g_SeninfBackupReg.SENINF_TG2_PH_CNT =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8600));
	g_SeninfBackupReg.SENINF_TG2_SEN_CK =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8604));

	g_SeninfBackupReg.SENINF2_CSI2_CTRL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8760));
	g_SeninfBackupReg.SENINF2_CSI2_DELAY =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8764));
	g_SeninfBackupReg.SENINF2_CSI2_INTEN =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x8768));

	g_SeninfBackupReg.SENINF2_NCSI2_CTL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x87A0));
	g_SeninfBackupReg.SENINF2_NCSI2_LNRC_TIMING =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x87A4));
	g_SeninfBackupReg.SENINF2_NCSI2_LNRD_TIMING =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x87A8));
	g_SeninfBackupReg.SENINF2_NCSI2_INT_EN =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x87B0));
	g_SeninfBackupReg.SENINF2_NCSI2_DI_CTRL =
		ISP_RD32((void *)(ISP_IMGSYS_BASE + 0x87E4));

	/* MIPI Analog backup */

	g_SeninfBackupReg.MIPIRX_ANALOG_BASE_000 =
		ISP_RD32((void *)(ISP_MIPI_ANA_ADDR + 0x0));
	g_SeninfBackupReg.MIPIRX_ANALOG_BASE_004 =
		ISP_RD32((void *)(ISP_MIPI_ANA_ADDR + 0x4));
	g_SeninfBackupReg.MIPIRX_ANALOG_BASE_008 =
		ISP_RD32((void *)(ISP_MIPI_ANA_ADDR + 0x8));
	g_SeninfBackupReg.MIPIRX_ANALOG_BASE_00C =
		ISP_RD32((void *)(ISP_MIPI_ANA_ADDR + 0xC));
	g_SeninfBackupReg.MIPIRX_ANALOG_BASE_010 =
		ISP_RD32((void *)(ISP_MIPI_ANA_ADDR + 0x10));
	g_SeninfBackupReg.MIPIRX_ANALOG_BASE_014 =
		ISP_RD32((void *)(ISP_MIPI_ANA_ADDR + 0x14));
	g_SeninfBackupReg.MIPIRX_ANALOG_BASE_018 =
		ISP_RD32((void *)(ISP_MIPI_ANA_ADDR + 0x18));
	g_SeninfBackupReg.MIPIRX_ANALOG_BASE_01C =
		ISP_RD32((void *)(ISP_MIPI_ANA_ADDR + 0x1C));
	g_SeninfBackupReg.MIPIRX_ANALOG_BASE_020 =
		ISP_RD32((void *)(ISP_MIPI_ANA_ADDR + 0x20));
	g_SeninfBackupReg.MIPIRX_ANALOG_BASE_04C =
		ISP_RD32((void *)(ISP_MIPI_ANA_ADDR + 0x4C));
	g_SeninfBackupReg.MIPIRX_ANALOG_BASE_050 =
		ISP_RD32((void *)(ISP_MIPI_ANA_ADDR + 0x50));
}
void ConfigM4uPort(void)
{
	/* Config m4u port, due to the m4u can't backup */
	/* the labr0/labr1/labr2 table */
	/* When spin_lock since 6795 and K2 */
...
static void restoreRegister(unsigned int openSensorIdx)
{
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x4040),
		g_backupReg.CAM_CTL_SEL_GLOBAL);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x4048),
		g_backupReg.CAM_CTL_INT_P1_EN);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x4050),
		g_backupReg.CAM_CTL_INT_P1_EN2);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x4058),
		g_backupReg.CAM_CTL_INT_P1_EN_D);

	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x4060),
		g_backupReg.CAM_CTL_INT_P1_EN2_D);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x4068),
		g_backupReg.CAM_CTL_INT_P2_EN);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x407C),
		g_backupReg.CAM_CTL_TILE);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x4084),
		g_backupReg.CAM_CTL_TCM_EN);
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x4170),
		g_backupReg.CAM_CTL_CLK_EN);
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7204),
		g_backupReg.CAM_TDRI_BASE_ADDR);
	pReg = &g_backupReg.CAM_TDRI_XSIZE;
	for (i = 0x720C; i <= 0x7220; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7228),
		g_backupReg.CAM_LAST_ULTRA_EN);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x722C),
		g_backupReg.CAM_IMGI_SLOW_DOWN);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7230),
		g_backupReg.CAM_IMGI_BASE_ADDR);
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7250),
		g_backupReg.CAM_BPCI_BASE_ADDR);
	pReg = &g_backupReg.CAM_BPCI_XSIZE;
	for (i = 0x3258; i <= 0x3268; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x726C),
		g_backupReg.CAM_LSCI_BASE_ADDR);
	pReg = &g_backupReg.CAM_LSCI_XSIZE;
	for (i = 0x3274; i <= 0x3284; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7288),
		g_backupReg.CAM_UFDI_BASE_ADDR);
	pReg = &g_backupReg.CAM_UFDI_XSIZE;
	for (i = 0x3290; i <= 0x32A4; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7300),
		g_backupReg.CAM_IMGO_BASE_ADDR);
	pReg = &g_backupReg.CAM_IMGO_XSIZE;
	for (i = 0x3308; i <= 0x331C; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7320),
		g_backupReg.CAM_RRZO_BASE_ADDR);
	pReg = &g_backupReg.CAM_RRZO_XSIZE;
	for (i = 0x3328; i <= 0x333C; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7340),
		g_backupReg.CAM_LCSO_BASE_ADDR);
	pReg = &g_backupReg.CAM_LCSO_XSIZE;
	for (i = 0x3348; i <= 0x3358; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7388),
		g_backupReg.CAM_AAO_BASE_ADDR);
	pReg = &g_backupReg.CAM_AAO_XSIZE;
	for (i = 0x3390; i <= 0x33A0; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x73A4),
		g_backupReg.CAM_VIP3I_BASE_ADDR);
	pReg = &g_backupReg.CAM_VIP3I_XSIZE;
	for (i = 0x33AC; i <= 0x33C0; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x73C4),
		g_backupReg.CAM_UFEO_BASE_ADDR);
	pReg = &g_backupReg.CAM_UFEO_XSIZE;
	for (i = 0x33CC; i <= 0x33DC; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x73E0),
		g_backupReg.CAM_MFBO_BASE_ADDR);
	pReg = &g_backupReg.CAM_MFBO_XSIZE;
	for (i = 0x33E8; i <= 0x33FC; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7400),
		g_backupReg.CAM_IMG3BO_BASE_ADDR);
	pReg = &g_backupReg.CAM_IMG3BO_XSIZE;
	for (i = 0x3408; i <= 0x341C; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7420),
		g_backupReg.CAM_IMG3CO_BASE_ADDR);
	pReg = &g_backupReg.CAM_IMG3CO_XSIZE;
	for (i = 0x3428; i <= 0x343C; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7440),
		g_backupReg.CAM_IMG2O_BASE_ADDR);
	pReg = &g_backupReg.CAM_IMG2O_XSIZE;
	for (i = 0x3448; i <= 0x345C; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7460),
		g_backupReg.CAM_IMG3O_BASE_ADDR);
	pReg = &g_backupReg.CAM_IMG3O_XSIZE;
	for (i = 0x3468; i <= 0x347C; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7480),
		g_backupReg.CAM_FEO_BASE_ADDR);
	pReg = &g_backupReg.CAM_FEO_XSIZE;
	for (i = 0x3488; i <= 0x3498; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x749C),
		g_backupReg.CAM_BPCI_D_BASE_ADDR);
	pReg = &g_backupReg.CAM_BPCI_D_XSIZE;
	for (i = 0x34A4; i <= 0x34B4; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x74B8),
		g_backupReg.CAM_LSCI_D_BASE_ADDR);
	pReg = &g_backupReg.CAM_LSCI_D_XSIZE;
	for (i = 0x34C0; i <= 0x34D0; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7514),
		g_backupReg.CAM_LCSO_D_BASE_ADDR);
	pReg = &g_backupReg.CAM_LCSO_D_XSIZE;
	for (i = 0x351C; i <= 0x352C; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7530),
		g_backupReg.CAM_AFO_D_BASE_ADDR);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x7534),
		g_backupReg.CAM_AFO_D_XSIZE);
	pReg = &g_backupReg.CAM_AFO_D_YSIZE;
	for (i = 0x353C; i <= 0x3548; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x754C),
		g_backupReg.CAM_AAO_D_BASE_ADDR);
	pReg = &g_backupReg.CAM_AAO_D_XSIZE;
	for (i = 0x3554; i <= 0x3564; i += 4) {
		ISP_WR32((ISP_ADDR + i), (unsigned int)(*(pReg)));
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8000),
		g_SeninfBackupReg.SENINF_TOP_CTRL);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8004),
		g_SeninfBackupReg.SENINF_TOP_CMODEL_PAR);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8008),
		g_SeninfBackupReg.SENINF_TOP_MUX_CTRL);
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x80C4),
		g_SeninfBackupReg.N3D_POS);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x80C8),
		g_SeninfBackupReg.N3D_TRIG);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x80CC),
		g_SeninfBackupReg.N3D_INT);

	/* Seninf 1 */
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8100),
		g_SeninfBackupReg.SENINF1_CTRL);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8120),
		g_SeninfBackupReg.SENINF1_MUX_CTRL);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8124),
		g_SeninfBackupReg.SENINF1_MUX_INTEN);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x812C),
		g_SeninfBackupReg.SENINF1_MUX_SIZE);

	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8200),
		g_SeninfBackupReg.SENINF_TG1_PH_CNT);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8204),
		g_SeninfBackupReg.SENINF_TG1_SEN_CK);

	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8360),
		g_SeninfBackupReg.SENINF1_CSI2_CTRL);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8364),
		g_SeninfBackupReg.SENINF1_CSI2_DELAY);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8368),
		g_SeninfBackupReg.SENINF1_CSI2_INTEN);

	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x83A4),
		g_SeninfBackupReg.SENINF1_NCSI2_LNRC_TIMING);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x83A8),
		g_SeninfBackupReg.SENINF1_NCSI2_LNRD_TIMING);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x83B0),
		g_SeninfBackupReg.SENINF1_NCSI2_INT_EN);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x83E4),
		g_SeninfBackupReg.SENINF1_NCSI2_DI_CTRL);

	ISP_WR32((void *)(ISP_MIPI_ANA_ADDR + 0x4C),
		(g_SeninfBackupReg.MIPIRX_ANALOG_BASE_04C &
		0xFEFBEFBE));
	/* clock lane input select mipi */
	ISP_WR32((void *)(ISP_MIPI_ANA_ADDR + 0x50),
		(g_SeninfBackupReg.MIPIRX_ANALOG_BASE_050 &
		0xFEFBEFBE));
	/* data lane 0 input select mipi */
	/* select main camera mipi enable for lane */
	ISP_WR32((void *)(ISP_MIPI_ANA_ADDR + 0x0),
		(g_SeninfBackupReg.MIPIRX_ANALOG_BASE_000 |
		0x00000008));
	/* clock lane input select mipi */
	ISP_WR32((void *)(ISP_MIPI_ANA_ADDR + 0x4),
		(g_SeninfBackupReg.MIPIRX_ANALOG_BASE_004 |
		0x00000008));
	/* data lane 0 input select mipi */
	ISP_WR32((void *)(ISP_MIPI_ANA_ADDR + 0x8),
		(g_SeninfBackupReg.MIPIRX_ANALOG_BASE_008 |
		0x00000008));
	/* data lane 1 input select mipi */
	ISP_WR32((void *)(ISP_MIPI_ANA_ADDR + 0xC),
		(g_SeninfBackupReg.MIPIRX_ANALOG_BASE_00C |
		0x00000008));
	/* data lane 2 input select mipi */
	ISP_WR32((void *)(ISP_MIPI_ANA_ADDR + 0x10),
		(g_SeninfBackupReg.MIPIRX_ANALOG_BASE_010 |
		0x00000008));
	/* data lane 3 input select mipi */

	ISP_WR32((void *)(ISP_MIPI_ANA_ADDR + 0x24),
		(g_SeninfBackupReg.MIPIRX_ANALOG_BASE_024 |
		0x00000001));
	/* RG_CSI_BG_CORE_EN */
	mDELAY(1);
	ISP_WR32((void *)(ISP_MIPI_ANA_ADDR + 0x20),
		(g_SeninfBackupReg.MIPIRX_ANALOG_BASE_020 |
		0x00000001));
	/* RG_CSI0_LDO_CORE_EN */
	mDELAY(2);
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x83A0),
		g_SeninfBackupReg.SENINF1_NCSI2_CTL);
	...
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8120),
		temp | 0x3); /* reset */
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8120),
		temp & 0xFFFFFFFC); /* clear reset */

	/* Seninf 2 */
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8500),
		g_SeninfBackupReg.SENINF2_CTRL);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8520),
		g_SeninfBackupReg.SENINF2_MUX_CTRL);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8524),
		g_SeninfBackupReg.SENINF2_MUX_INTEN);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x852C),
		g_SeninfBackupReg.SENINF2_MUX_SIZE);

	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8600),
		g_SeninfBackupReg.SENINF_TG2_PH_CNT);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8604),
		g_SeninfBackupReg.SENINF_TG2_SEN_CK);

	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8760),
		g_SeninfBackupReg.SENINF2_CSI2_CTRL);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8764),
		g_SeninfBackupReg.SENINF2_CSI2_DELAY);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x8768),
		g_SeninfBackupReg.SENINF2_CSI2_INTEN);

	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x87A4),
		g_SeninfBackupReg.SENINF2_NCSI2_LNRC_TIMING);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x87A8),
		g_SeninfBackupReg.SENINF2_NCSI2_LNRD_TIMING);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x87B0),
		g_SeninfBackupReg.SENINF2_NCSI2_INT_EN);
	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x87E4),
		g_SeninfBackupReg.SENINF2_NCSI2_DI_CTRL);


	ISP_WR32((void *)(ISP_IMGSYS_BASE + 0x87A0),
		g_SeninfBackupReg.SENINF2_NCSI2_CTL);
...
)
{
	...
	/* return here for those modules */
	/* who is not linked with sensor */
	if (module < 0)
		return ret;
	...
	if (regVal & 0x01) {
		...
		/* disable VF */
		ISP_WR32(CAM_REG_TG_VF_CON(module),
		(regVal & (~0x01)));
		 ...
		 * if it has P1_DON after set vf disable, g_BkReg no
		 * need to add 1
		 */
		regTGSt =
...
#define TMP_STR1 "bPass1_On_In_Resume_TG1(%d)."
#define TMP_STR2 "bPass1_On_In_Resume_TG2(%d)."
#define TMP_STR3 "regTG1Val(0x%08x). regTG2Val(0x%08x)\n"

	LOG_DBG(TMP_STR1 TMP_STR2 TMP_STR3,
		bPass1_On_In_Resume_TG1,
		bPass1_On_In_Resume_TG2,
		regTG1Val,
		regTG2Val);
...
static signed int ISP_resume(struct platform_device *pDev)
{
	...
	for (IrqType = 0; IrqType < ISP_IRQ_TYPE_AMOUNT; IrqType++) {
		if (strcmp(moduleName, IRQ_CB_TBL[IrqType].device_name) ==
			0)
			break;
	}
...
static signed int __init ISP_Init(void)
{
	...
	m4u_register_fault_callback(M4U_PORT_CAM_AAO,
		ISP_M4U_TranslationFault_callback, NULL);
	m4u_register_fault_callback(M4U_PORT_CAM_AFO,
		ISP_M4U_TranslationFault_callback, NULL);
	...
	m4u_register_fault_callback(M4U_PORT_CAM_SV0,
		ISP_M4U_TranslationFault_callback, NULL);
	m4u_register_fault_callback(M4U_PORT_CAM_SV1,
		ISP_M4U_TranslationFault_callback, NULL);
	m4u_register_fault_callback(M4U_PORT_CAM_SV2,
		ISP_M4U_TranslationFault_callback, NULL);
	m4u_register_fault_callback(M4U_PORT_CAM_BPCI,
		ISP_M4U_TranslationFault_callback, NULL);
	m4u_register_fault_callback(M4U_PORT_CAM_UFEO,
		ISP_M4U_TranslationFault_callback, NULL);
	m4u_register_fault_callback(M4U_PORT_CAM_PDO,
		ISP_M4U_TranslationFault_callback, NULL);
	...
	m4u_register_fault_callback(M4U_PORT_VIPI,
		ISP_M4U_TranslationFault_callback, NULL);
	m4u_register_fault_callback(M4U_PORT_ICEI,
		ISP_M4U_TranslationFault_callback, NULL);
#endif
...
#undef TMP_STR2
	...
	if ((tpipePA)) {
		...
		map_va = 0;
		m4u_mva_map_kernel(tpipePA, TPIPE_DUMP_SIZE,
			&map_va, &map_size);
		pMapVa = (int *)map_va;
	...
	int port, unsigned int mva, void *data)
{
	...
	LOG_DBG("[ISP_M4U]fault call port=%d, mva=0x%x",
		port, mva);

	switch (port) {
	case M4U_PORT_CAM_AAO:
		for (module = ISP_CAM_A_IDX; module <=
			ISP_CAM_B_IDX; module++) {
			LOG_DBG("[TF_%d]CAM_%d", port, module);
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0004),
				(unsigned int)
				ISP_RD32(CAM_REG_CTL_EN(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0008),
				(unsigned int)ISP_RD32(
					CAM_REG_CTL_DMA_EN(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x000C),
				(unsigned int)ISP_RD32(
					CAM_REG_CTL_FMT_SEL(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0010),
				(unsigned int)ISP_RD32(
					CAM_REG_CTL_SEL(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0014),
				(unsigned int)ISP_RD32(
					CAM_REG_CTL_MISC(module)));
			/*AAO FBC*/
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0138),
				(unsigned int)ISP_RD32(
					CAM_REG_FBC_AAO_CTL1(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x013C),
				(unsigned int)ISP_RD32(
					CAM_REG_FBC_AAO_CTL2(module)));
			/*CQ THR4*/
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0160),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_EN(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x013A0),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR4_CTL(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x01A4),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR4_BASEADDR(module)));
			/*AAO*/
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0C00),
				(unsigned int)ISP_RD32(
					CAM_REG_DMA_FRAME_HEADER_EN(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0C0C),
				(unsigned int)ISP_RD32(
					CAM_REG_AAO_FH_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0280),
				(unsigned int)ISP_RD32(
					CAM_REG_AAO_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0288),
				(unsigned int)ISP_RD32(
					CAM_REG_AAO_OFST_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0290),
				(unsigned int)ISP_RD32(
					CAM_REG_AAO_XSIZE(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0294),
				(unsigned int)ISP_RD32(
					CAM_REG_AAO_YSIZE(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0298),
				(unsigned int)ISP_RD32(
					CAM_REG_AAO_STRIDE(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x029C),
				(unsigned int)ISP_RD32(
					CAM_REG_AAO_CON(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x02A0),
				(unsigned int)ISP_RD32(
					CAM_REG_AAO_CON2(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x02A4),
				(unsigned int)ISP_RD32(
					CAM_REG_AAO_CON3(module)));

			if ((ISP_RD32(CAM_REG_TG_VF_CON(
				ISP_CAM_B_IDX)) & 0x01) == 0) {
	...
	case M4U_PORT_IMGI:
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0400),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0400));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0408),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0408));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0410),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0410));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0414),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0414));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0418),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0418));
		break;
	case M4U_PORT_ICEI:
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0580),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0580));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0588),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0588));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0590),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0590));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0594),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0594));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0598),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0598));
		break;
	case M4U_PORT_IMG2O:
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0230),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0230));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0238),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0238));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0240),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0240));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0244),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0244));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0248),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0248));
		break;
	case M4U_PORT_IMG3O:
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0290),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0290));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0298),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0298));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x02A0),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x02A0));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x02A4),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x02A4));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x02A8),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x02A8));
		break;
	case M4U_PORT_VIPI:
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0490),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0490));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x0498),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x0498));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x04A0),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x04A0));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x04A4),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x04A4));
		LOG_DBG("[TF_%d]0x%08X %08X", port,
			(unsigned int)(0x04A8),
			(unsigned int)ISP_RD32(
				ISP_DIP_A_BASE + 0x04A8));
		break;
	default:
		for (module = ISP_CAM_A_IDX; module <=
			ISP_CAM_B_IDX; module++) {
			...
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0C04),
				(unsigned int)ISP_RD32(
					CAM_REG_IMGO_FH_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0C08),
				(unsigned int)ISP_RD32(
					CAM_REG_RRZO_FH_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0C18),
				(unsigned int)ISP_RD32(
					CAM_REG_UFEO_FH_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0C0C),
				(unsigned int)ISP_RD32(
					CAM_REG_AAO_FH_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0C10),
				(unsigned int)ISP_RD32(
					CAM_REG_AFO_FH_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0C14),
				(unsigned int)ISP_RD32(
					CAM_REG_LCSO_FH_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0C18),
				(unsigned int)ISP_RD32(
					CAM_REG_UFEO_FH_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0C1C),
				(unsigned int)ISP_RD32(
					CAM_REG_PDO_FH_BASE_ADDR(module)));
			/*DMA base addr*/
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0220),
				(unsigned int)ISP_RD32(
					CAM_REG_IMGO_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0250),
				(unsigned int)ISP_RD32(
					CAM_REG_RRZO_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0280),
				(unsigned int)ISP_RD32(
					CAM_REG_AAO_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x02B0),
				(unsigned int)ISP_RD32(
					CAM_REG_AFO_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x02E0),
				(unsigned int)ISP_RD32(
					CAM_REG_LCSO_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0310),
				(unsigned int)ISP_RD32(
					CAM_REG_UFEO_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0340),
				(unsigned int)ISP_RD32(
					CAM_REG_PDO_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x0370),
				(unsigned int)ISP_RD32(
					CAM_REG_BPCI_BASE_ADDR(module)));
			LOG_DBG("[TF_%d]%08X %08X", port,
				(unsigned int)(0x03D0),
				(unsigned int)ISP_RD32(
					CAM_REG_LSCI_BASE_ADDR(module)));
#define TMP_STR1 \
	"[TF_%d]CQ0_%08X_%08X CQ1_%08X_%08X CQ2_%08X_%08X CQ3_%08X_%08X"
#define TMP_STR2 \
	"[TF_%d]CQ4_%08X_%08X CQ5_%08X_%08X CQ6_%08X_%08X CQ7_%08X_%08X"
#define TMP_STR3 \
	"[TF_%d]CQ8_%08X_%08X CQ9_%08X_%08X CQ10_%08X_%08X CQ11_%08X_%08X"

			LOG_DBG(TMP_STR1, port,
				(unsigned int)(0x0168),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR0_BASEADDR(module)),
				(unsigned int)(0x0180),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR1_BASEADDR(module)),
				(unsigned int)(0x018C),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR2_BASEADDR(module)),
				(unsigned int)(0x0198),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR3_BASEADDR(module)));
			LOG_DBG(TMP_STR2, port,
				(unsigned int)(0x01A4),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR4_BASEADDR(module)),
				(unsigned int)(0x01B0),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR5_BASEADDR(module)),
				(unsigned int)(0x01BC),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR6_BASEADDR(module)),
				(unsigned int)(0x01C8),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR7_BASEADDR(module)));
			LOG_DBG(TMP_STR3, port,
				(unsigned int)(0x01D4),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR8_BASEADDR(module)),
				(unsigned int)(0x01E0),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR9_BASEADDR(module)),
				(unsigned int)(0x01EC),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR10_BASEADDR(module)),
				(unsigned int)(0x01F8),
				(unsigned int)ISP_RD32(
					CAM_REG_CQ_THR11_BASEADDR(module)));
#undef TMP_STR1
#undef TMP_STR2
#undef TMP_STR3
			if ((ISP_RD32(
				CAM_REG_TG_VF_CON(ISP_CAM_B_IDX)) & 0x01) ==
				0)
				break;
		}
		break;
...
#define TMP_STR1 "cam:%d dma:%d overwrite preveFbcDropCnt %d <= %d\n"
				LOG_INF(TMP_STR1, irq_mod, dma_id,
					IspInfo.TstpQInfo[irq_mod].Dmao[
						dma_id].PrevFbcDropCnt,
...
static irqreturn_t ISP_Irq_CAM_A(
	signed int Irq, void *DeviceId)
{
	unsigned int module = ISP_IRQ_TYPE_INT_CAM_A_ST;
