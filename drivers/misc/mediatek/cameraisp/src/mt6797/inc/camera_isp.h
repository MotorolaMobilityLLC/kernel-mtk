...
typedef enum
{
    ...
    ISP_P2_BUFQUE_CTRL_WAKE_WAITFRAME,         // 5,wake all sleeped users to check buffer is dequeued or not
...
/* Everest reset ioctl */
#define ISP_RESET_BY_HWMODULE    _IOW  (ISP_MAGIC, ISP_CMD_RESET_BY_HWMODULE, unsigned int)
...
#define COMPAT_ISP_GET_START_TIME  _IOWR    (ISP_MAGIC, ISP_CMD_GET_START_TIME,      unsigned char*)
