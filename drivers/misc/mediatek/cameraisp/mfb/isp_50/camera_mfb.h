...
struct MFB_Config {
	...
	unsigned long MFB_MFBI_ADDR;
	unsigned long MFB_MFBI_STRIDE;
	unsigned long MFB_MFBI_YSIZE;
	unsigned long MFB_MFBI_B_ADDR;
	unsigned long MFB_MFBI_B_STRIDE;
	unsigned long MFB_MFBI_B_YSIZE;
	unsigned long MFB_MFB2I_ADDR;
	unsigned long MFB_MFB2I_STRIDE;
	unsigned long MFB_MFB2I_YSIZE;
	unsigned long MFB_MFB2I_B_ADDR;
	unsigned long MFB_MFB2I_B_STRIDE;
	unsigned long MFB_MFB2I_B_YSIZE;
	unsigned long MFB_MFB3I_ADDR;
	unsigned long MFB_MFB3I_STRIDE;
	unsigned long MFB_MFB3I_YSIZE;
	unsigned long MFB_MFB4I_ADDR;
	unsigned long MFB_MFB4I_STRIDE;
	unsigned long MFB_MFB4I_YSIZE;
	unsigned long MFB_MFBO_ADDR;
	unsigned long MFB_MFBO_STRIDE;
	unsigned long MFB_MFBO_YSIZE;
	unsigned long MFB_MFBO_B_ADDR;
	unsigned long MFB_MFBO_B_STRIDE;
	unsigned long MFB_MFBO_B_YSIZE;
	unsigned long MFB_MFB2O_ADDR;
	unsigned long MFB_MFB2O_STRIDE;
	unsigned long MFB_MFB2O_YSIZE;
	unsigned long MFB_TDRI_ADDR;
	unsigned long MFB_TDRI_XSIZE;
