...
struct mc_ioctl_info {
	__u32  ext_info_id;	/* extended info ID */
	__u32  state;	/* state */
	__u32  ext_info;	/* extended info */
};
...
struct mc_ioctl_map {
	...
	__u32	handle;	/* WSM handle */
	__u64	phys_addr; /* physical address of WSM (or 0) */
	__u32	rfu;
...
struct mc_compat_ioctl_reg_wsm {
	__u32 buffer;	/* base address of the virtual address  */
	__u32 len;		/* size of the virtual address space */
	__u32 pid;		/* process id */
	__u32 handle;	/* driver handle for locked memory */
	__u64 table_phys;	/* physical address of the MMU table */
};

struct mc_ioctl_reg_wsm {
	__u64 buffer;	/* base address of the virtual address  */
	__u32 len;		/* size of the virtual address space */
	__u32 pid;		/* process id */
	__u32 handle;	/* driver handle for locked memory */
	__u64 table_phys;/* physical address of the MMU table */
...
#define MC_IO_VERSION		_IOR(MC_IOC_MAGIC, 2, __u32)
/*
