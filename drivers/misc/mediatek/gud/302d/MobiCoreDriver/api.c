...
int mobicore_map_vmem(struct mc_instance *instance, void *addr, u32 len,
		      u32 *handle)
{
	phys_addr_t phys;
 ...
 *
 */
int mobicore_unmap_vmem(struct mc_instance *instance, u32 handle)
{
 ...
 *
 */
int mobicore_free_wsm(struct mc_instance *instance, u32 handle)
{
...
int mobicore_allocate_wsm(struct mc_instance *instance,
			  unsigned long requested_size, u32 *handle,
