 ...
 *					cannot be opened
 */
__MC_CLIENT_LIB_API enum mc_result mc_open_device(u32 device_id);
 ...
 */
__MC_CLIENT_LIB_API enum mc_result mc_close_device(u32 device_id);
 ...
 */
__MC_CLIENT_LIB_API enum mc_result mc_free_wsm(u32 device_id,
					       u8 *wsm);
...
__MC_CLIENT_LIB_API enum mc_result mc_map(
	struct mc_session_handle *session, void	*buf, u32 len,
