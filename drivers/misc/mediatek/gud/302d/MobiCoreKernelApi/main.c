...
static struct connection *mcapi_find_connection(u32 seq)
{
...
void mcapi_remove_connection(u32 seq)
{
...
static int __init mcapi_init(void)
{
	...
	mod_ctx->sk = netlink_kernel_create(&init_net, MC_DAEMON_NETLINK, &cfg);
