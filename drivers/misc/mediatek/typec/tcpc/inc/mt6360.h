...
/* MT6360 FOD */
#define MT6360_FOD_ALL_STAT				0xE3
#define MT6360_FOD_DISCHG_FAIL_STAT			BIT(7)
#define MT6360_FOD_HR_STAT				BIT(6)
#define MT6360_FOD_LR_STAT				BIT(5)
#define MT6360_FOD_OV_STAT				BIT(1)
#define MT6360_FOD_DONE_STAT				BIT(0)
