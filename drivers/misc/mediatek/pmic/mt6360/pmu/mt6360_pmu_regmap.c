...
RT_REG_DECL(MT6360_PMU_QC_CONTROL1, 1, RT_NORMAL_WR_ONCE, {});
RT_REG_DECL(MT6360_PMU_QC_CONTROL2, 1, RT_NORMAL_WR_ONCE, {});
RT_REG_DECL(MT6360_PMU_QC30_CONTROL1, 1, RT_NORMAL_WR_ONCE, {});
RT_REG_DECL(MT6360_PMU_QC30_CONTROL2, 1, RT_VOLATILE, {});
RT_REG_DECL(MT6360_PMU_USB_STATUS1, 1, RT_VOLATILE, {});
RT_REG_DECL(MT6360_PMU_QC_STATUS1, 1, RT_VOLATILE, {});
RT_REG_DECL(MT6360_PMU_QC_STATUS2, 1, RT_VOLATILE, {});
...
RT_REG_DECL(MT6360_PMU_CHGDET_FUNC, 1, RT_NORMAL_WR_ONCE, {});
RT_REG_DECL(MT6360_PMU_FOD_CTRL, 1, RT_NORMAL_WR_ONCE, {});
...
RT_REG_DECL(MT6360_PMU_QC_IRQ, 1, RT_VOLATILE, {});
RT_REG_DECL(MT6360_PMU_FOD_IRQ, 1, RT_VOLATILE, {});
...
RT_REG_DECL(MT6360_PMU_QC_STAT, 1, RT_VOLATILE, {});
RT_REG_DECL(MT6360_PMU_FOD_STAT, 1, RT_VOLATILE, {});
...
RT_REG_DECL(MT6360_PMU_QC_MASK, 1, RT_VOLATILE, {});
RT_REG_DECL(MT6360_PMU_FOD_MASK, 1, RT_VOLATILE, {});
...
RT_REG_DECL(MT6360_PMU_RGB_MASK, 1, RT_VOLATILE, {});
...
static const rt_register_map_t mt6360_pmu_regmap[] = {
	...
	RT_REG(MT6360_PMU_QC_CONTROL1),
	RT_REG(MT6360_PMU_QC_CONTROL2),
	RT_REG(MT6360_PMU_QC30_CONTROL1),
	RT_REG(MT6360_PMU_QC30_CONTROL2),
	RT_REG(MT6360_PMU_USB_STATUS1),
	RT_REG(MT6360_PMU_QC_STATUS1),
	RT_REG(MT6360_PMU_QC_STATUS2),
	...
	RT_REG(MT6360_PMU_CHGDET_FUNC),
	RT_REG(MT6360_PMU_FOD_CTRL),
	...
	RT_REG(MT6360_PMU_QC_IRQ),
	RT_REG(MT6360_PMU_FOD_IRQ),
	...
	RT_REG(MT6360_PMU_QC_STAT),
	RT_REG(MT6360_PMU_FOD_STAT),
