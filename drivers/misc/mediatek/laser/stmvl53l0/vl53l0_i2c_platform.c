...
int32_t VL53L0_write_multi(VL53L0_DEV dev, uint8_t index, uint8_t *pdata, int32_t count)
{
    int32_t i = 0;
    int32_t status = STATUS_OK;
...
int32_t VL53L0_read_multi(VL53L0_DEV dev, uint8_t index, uint8_t *pdata, int32_t count)
{
    int32_t i = 0;
    int32_t status = STATUS_OK;
