...
unsigned int module_list_scenario[DDP_SCENARIO_MAX][DDP_ENING_NUM] = {
	/*PRIMARY_DISP */
	{
	DISP_MODULE_OVL0, DISP_MODULE_OVL0_2L, DISP_MODULE_RDMA0, DISP_MODULE_COLOR0, DISP_MODULE_CCORR0,
	DISP_MODULE_AAL0, DISP_MODULE_GAMMA0, DISP_MODULE_DITHER0, DISP_MODULE_PWM0, DISP_MODULE_DSI0, -1},
	...
	/*PRIMARY_BYPASS_RDMA */
	{
	DISP_MODULE_OVL0, DISP_MODULE_OVL0_2L, DISP_MODULE_WDMA0_VIRTUAL,
	...
	/*PRIMARY_OVL_MEMOUT */
	{
	 DISP_MODULE_OVL0, DISP_MODULE_OVL0_2L, DISP_MODULE_WDMA0_VIRTUAL, DISP_MODULE_WDMA0, -1},
	...
	/*PRIMARY_DISP ALL*/
	{
	 DISP_MODULE_OVL0, DISP_MODULE_OVL0_2L, DISP_MODULE_WDMA0_VIRTUAL, DISP_MODULE_WDMA0,
	 DISP_MODULE_COLOR0, DISP_MODULE_CCORR0, DISP_MODULE_AAL0, DISP_MODULE_GAMMA0, /*DISP_MODULE_OD,*/
...
static struct sel_s sel_out_map[DDP_SEL_OUT_NUM] = {
	...
	{DISP_MODULE_RDMA0, {DISP_MODULE_DSI0, DISP_MODULE_COLOR0,
				    DISP_MODULE_CCORR0, DISP_MODULE_DSI1}, 0, 0},
	/* RDMA1_SOUT */
	{DISP_MODULE_RDMA1, {DISP_MODULE_DSI0, DISP_MODULE_DPI}, 0, 0},
};
...
static struct sel_s sel_in_map[DDP_SEL_IN_NUM] = {
	...
	/* WDMA_SEL */
	{DISP_MODULE_WDMA0, {DISP_MODULE_WDMA0_VIRTUAL, DISP_MODULE_DITHER0, -1}, 0, 0},
...
int ddp_path_init(void)
{
	...
	mout_map[2].reg = (unsigned long *)DISP_REG_CONFIG_DISP_OVL1_PQ_MOUT_EN;
	...
	sel_in_map[3].reg = (unsigned long *)DISP_REG_CONFIG_DISP_OVL_WDMA0_SEL_IN;
	sel_in_map[4].reg = (unsigned long *)DISP_REG_CONFIG_DSI0_SEL_IN;
	sel_in_map[5].reg = (unsigned long *)DISP_REG_CONFIG_DPI0_SEL_IN;
