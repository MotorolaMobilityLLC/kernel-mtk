...
#define DISP_REG_CONFIG_DISP_OVL1_MOUT_EN		(0)
#define DISP_REG_CONFIG_DISP_OVL1_PQ_MOUT_EN	(DISPSYS_CONFIG_BASE + 0xF08)
#define DISP_REG_CONFIG_DISP_DITHER_MOUT_EN		(DISPSYS_CONFIG_BASE + 0xF0C)
#define DISP_REG_CONFIG_DISP_DITHER1_MOUT_EN	(0)
#define DISP_REG_CONFIG_DISP_UFOE_MOUT_EN		(0)
#define DISP_REG_CONFIG_DISP_DSC_MOUT_EN		(0)
#define DISP_REG_CONFIG_DISP_COLOR0_SEL_IN		(DISPSYS_CONFIG_BASE + 0xF20)
#define DISP_REG_CONFIG_DISP_COLOR1_SEL_IN		(0)
#define DISP_REG_CONFIG_DISP_PATH0_SEL_IN		(DISPSYS_CONFIG_BASE + 0xF24)
#define DISP_REG_CONFIG_DISP_PATH1_SEL_IN		(0)
#define DISP_REG_CONFIG_DISP_WDMA0_SEL_IN		(DISPSYS_CONFIG_BASE + 0xF28)
#define DISP_REG_CONFIG_DISP_WDMA1_SEL_IN		(0)
#define DISP_REG_CONFIG_DISP_UFOE_SEL_IN			(0)
#define DISP_REG_CONFIG_DISP_DSC_SEL_IN			(0)
#define DISP_REG_CONFIG_DSI0_SEL_IN				(DISPSYS_CONFIG_BASE + 0xF2C)
#define DISP_REG_CONFIG_DSI1_SEL_IN				(0)
#define DISP_REG_CONFIG_DPI0_SEL_IN				(DISPSYS_CONFIG_BASE + 0xF30)
#define DISP_REG_CONFIG_DISP_OVL0_SEL_IN			(DISPSYS_CONFIG_BASE + 0xF34)
#define DISP_REG_CONFIG_DISP_OVL0_2L_SEL_IN		(DISPSYS_CONFIG_BASE + 0xF38)
#define DISP_REG_CONFIG_DISP_OVL_WDMA0_SEL_IN	(DISPSYS_CONFIG_BASE + 0xF40)
#define DISP_REG_CONFIG_DISP_OVL1_2L_SEL_IN		(0)
#define DISP_REG_CONFIG_DISP_PATH0_SOUT_SEL_IN		(0)
#define DISP_REG_CONFIG_DISP_PATH1_SOUT_SEL_IN		(0)
...
#define DISP_REG_CONFIG_DISP_OVL0_SOUT_SEL_IN		(0)
...
/* SMI_LARB4 */
#define DISP_REG_SMI_LARB4_MMU_EN			 (0)
