...
enum DDP_IRQ_BIT {
	...
	DDP_IRQ_DBI_EXT_TE = MAKE_DDP_IRQ_BIT(DISP_MODULE_DBI, 4),//add by yangccaixia 1217
//DP_IRQ_DBI_FRAME_DONE = MAKE_DDP_IRQ_BIT(DISP_MODULE_DBI,0),//add by yangccaixia 1217
