...
/*static unsigned int disp_global_stage = MAGIC_CODE |
...
const char *disp_helper_option_string[DISP_OPT_NUM] = {
	"DISP_OPT_USE_CMDQ", "DISP_OPT_USE_M4U", "DISP_OPT_MIPITX_ON_CHIP",
	"DISP_OPT_USE_DEVICE_TREE",
	  "DISP_OPT_FAKE_LCM_X", "DISP_OPT_FAKE_LCM_Y",
	"DISP_OPT_FAKE_LCM_WIDTH", "DISP_OPT_FAKE_LCM_HEIGHT",
	"DISP_OPT_OVL_WARM_RESET", "DISP_OPT_DYNAMIC_SWITCH_UNDERFLOW_EN",
	/* Begin: lowpower option*/
	"DISP_OPT_SODI_SUPPORT", "DISP_OPT_IDLE_MGR",
	"DISP_OPT_IDLEMGR_SWTCH_DECOUPLE", "DISP_OPT_IDLEMGR_ENTER_ULPS",
	"DISP_OPT_SHARE_SRAM", "DISP_OPT_DYNAMIC_SWITCH_MMSYSCLK",
	...
	"DISP_OPT_NO_LCM_FOR_LOW_POWER_MEASUREMENT", "DISP_OPT_NO_LK",
	"DISP_OPT_BYPASS_PQ", "DISP_OPT_ESD_CHECK_RECOVERY",
	"DISP_OPT_ESD_CHECK_SWITCH", "DISP_OPT_PRESENT_FENCE",
	"DISP_OPT_PERFORMANCE_DEBUG", "DISP_OPT_SWITCH_DST_MODE",
	"DISP_OPT_MUTEX_EOF_EN_FOR_CMD_MODE", "DISP_OPT_SCREEN_CAP_FROM_DITHER",
	"DISP_OPT_BYPASS_OVL", "DISP_OPT_FPS_CALC_WND", "DISP_OPT_SMART_OVL",
	"DISP_OPT_DYNAMIC_DEBUG", "DISP_OPT_SHOW_VISUAL_DEBUG_INFO",
	"DISP_OPT_RDMA_UNDERFLOW_AEE", "DISP_OPT_HRT",
	  "DISP_OPT_PARTIAL_UPDATE",
	"DISP_OPT_CV_BYSUSPEND", "DISP_OPT_DELAYED_TRIGGER",
...
void disp_helper_option_init(void)
{
	...
	/* test solution for 6795 rdma underflow caused by ufoe LR mode(ufoe
	 * fifo is larger than rdma) */
