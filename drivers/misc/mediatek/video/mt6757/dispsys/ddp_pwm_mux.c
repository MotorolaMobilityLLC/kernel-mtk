 ...
 *
*****************************************************************************/
enum disp_clk_id disp_pwm_get_clkid(unsigned int clk_req)
{
	enum disp_clk_id clkid = -1;
...
static int ulposc_enable(enum disp_clk_id clkid)
{
	ulposc_on();
	get_ulposc_status();
...
static int ulposc_disable(enum disp_clk_id clkid)
{
	ulposc_off();
	get_ulposc_status();
