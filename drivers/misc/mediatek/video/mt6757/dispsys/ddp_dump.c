...
static const char *ddp_signal[3][32] = {
	...
	{
	"ovl1_mout_out_1_to_ovl0_sel_in_2", "ovl1_mout_out_2_to_wdma1_sel_in_3",
	"ovl1_mout_out_3_to_color1_sel_in_2",
	"ovl1_pq_mout_out_0_to_color1_sel_in_1",
	"ovl1_pq_mout_out_1_to_wdma1_sel_in_0",
	"ovl1_pq_mout_out_2_to_ovl0_sel_in_1", "ufoe_to_ufoe_mout",
	"ufoe_mout_out_0_to_dsi0_sel_in_0", "ufoe_mout_out_1_to_split",
	"ufoe_mout_out_2_to_dpi0_sel_in_0", "ufoe_mout_out_3_to_wdma0_sel_in_2",
	"ufoe_mout_out_4_to_dsi1_sel_in_3", "ufoe_sel_to_ufoe",
...
static void mutex_dump_reg(void)
{
	if (disp_helper_get_option(DISP_OPT_REG_PARSER_RAW_DUMP)) {
		...
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x0, INREG32(DISPSYS_MUTEX_BASE + 0x0), 0x4,
			INREG32(DISPSYS_MUTEX_BASE + 0x4), 0x8,
			INREG32(DISPSYS_MUTEX_BASE + 0x8), 0xC,
			INREG32(DISPSYS_MUTEX_BASE + 0xC));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x10, INREG32(DISPSYS_MUTEX_BASE + 0x10), 0x14,
			INREG32(DISPSYS_MUTEX_BASE + 0x14), 0x18,
			INREG32(DISPSYS_MUTEX_BASE + 0x18), 0x1C,
			INREG32(DISPSYS_MUTEX_BASE + 0x1C));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x020, INREG32(DISPSYS_MUTEX_BASE + 0x020), 0x024,
			INREG32(DISPSYS_MUTEX_BASE + 0x024), 0x028,
			INREG32(DISPSYS_MUTEX_BASE + 0x028), 0x02C,
			INREG32(DISPSYS_MUTEX_BASE + 0x02C));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x030, INREG32(DISPSYS_MUTEX_BASE + 0x030), 0x034,
			INREG32(DISPSYS_MUTEX_BASE + 0x034), 0x040,
			INREG32(DISPSYS_MUTEX_BASE + 0x040), 0x044,
			INREG32(DISPSYS_MUTEX_BASE + 0x044));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x048, INREG32(DISPSYS_MUTEX_BASE + 0x048), 0x04C,
			INREG32(DISPSYS_MUTEX_BASE + 0x04C), 0x050,
			INREG32(DISPSYS_MUTEX_BASE + 0x050), 0x054,
			INREG32(DISPSYS_MUTEX_BASE + 0x054));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x060, INREG32(DISPSYS_MUTEX_BASE + 0x060), 0x064,
			INREG32(DISPSYS_MUTEX_BASE + 0x064), 0x068,
			INREG32(DISPSYS_MUTEX_BASE + 0x068), 0x06C,
			INREG32(DISPSYS_MUTEX_BASE + 0x06C));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x070, INREG32(DISPSYS_MUTEX_BASE + 0x070), 0x074,
			INREG32(DISPSYS_MUTEX_BASE + 0x074), 0x080,
			INREG32(DISPSYS_MUTEX_BASE + 0x080), 0x084,
			INREG32(DISPSYS_MUTEX_BASE + 0x084));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x088, INREG32(DISPSYS_MUTEX_BASE + 0x088), 0x08C,
			INREG32(DISPSYS_MUTEX_BASE + 0x08C), 0x090,
			INREG32(DISPSYS_MUTEX_BASE + 0x090), 0x094,
			INREG32(DISPSYS_MUTEX_BASE + 0x094));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x0A0, INREG32(DISPSYS_MUTEX_BASE + 0x0A0), 0x0A4,
			INREG32(DISPSYS_MUTEX_BASE + 0x0A4), 0x0A8,
			INREG32(DISPSYS_MUTEX_BASE + 0x0A8), 0x0AC,
			INREG32(DISPSYS_MUTEX_BASE + 0x0AC));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x0B0, INREG32(DISPSYS_MUTEX_BASE + 0x0B0), 0x0B4,
			INREG32(DISPSYS_MUTEX_BASE + 0x0B4), 0x0C0,
			INREG32(DISPSYS_MUTEX_BASE + 0x0C0), 0x0C4,
			INREG32(DISPSYS_MUTEX_BASE + 0x0C4));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x0C8, INREG32(DISPSYS_MUTEX_BASE + 0x0C8), 0x0CC,
			INREG32(DISPSYS_MUTEX_BASE + 0x0CC), 0x0D0,
			INREG32(DISPSYS_MUTEX_BASE + 0x0D0), 0x0D4,
			INREG32(DISPSYS_MUTEX_BASE + 0x0D4));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x0E0, INREG32(DISPSYS_MUTEX_BASE + 0x0E0), 0x0E4,
			INREG32(DISPSYS_MUTEX_BASE + 0x0E4), 0x0E8,
			INREG32(DISPSYS_MUTEX_BASE + 0x0E8), 0x0EC,
			INREG32(DISPSYS_MUTEX_BASE + 0x0EC));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x0F0, INREG32(DISPSYS_MUTEX_BASE + 0x0F0), 0x0F4,
			INREG32(DISPSYS_MUTEX_BASE + 0x0F4), 0x100,
			INREG32(DISPSYS_MUTEX_BASE + 0x100), 0x104,
			INREG32(DISPSYS_MUTEX_BASE + 0x104));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x108, INREG32(DISPSYS_MUTEX_BASE + 0x108), 0x10C,
			INREG32(DISPSYS_MUTEX_BASE + 0x10C), 0x110,
			INREG32(DISPSYS_MUTEX_BASE + 0x110), 0x114,
			INREG32(DISPSYS_MUTEX_BASE + 0x114));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x120, INREG32(DISPSYS_MUTEX_BASE + 0x120), 0x124,
			INREG32(DISPSYS_MUTEX_BASE + 0x124), 0x128,
			INREG32(DISPSYS_MUTEX_BASE + 0x128), 0x12C,
			INREG32(DISPSYS_MUTEX_BASE + 0x12C));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x130, INREG32(DISPSYS_MUTEX_BASE + 0x130), 0x134,
			INREG32(DISPSYS_MUTEX_BASE + 0x134), 0x140,
			INREG32(DISPSYS_MUTEX_BASE + 0x140), 0x144,
			INREG32(DISPSYS_MUTEX_BASE + 0x144));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x148, INREG32(DISPSYS_MUTEX_BASE + 0x148), 0x14C,
			INREG32(DISPSYS_MUTEX_BASE + 0x14C), 0x150,
			INREG32(DISPSYS_MUTEX_BASE + 0x150), 0x154,
			INREG32(DISPSYS_MUTEX_BASE + 0x154));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x160, INREG32(DISPSYS_MUTEX_BASE + 0x160), 0x164,
			INREG32(DISPSYS_MUTEX_BASE + 0x164), 0x168,
			INREG32(DISPSYS_MUTEX_BASE + 0x168), 0x16C,
			INREG32(DISPSYS_MUTEX_BASE + 0x16C));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x170, INREG32(DISPSYS_MUTEX_BASE + 0x170), 0x174,
			INREG32(DISPSYS_MUTEX_BASE + 0x174), 0x180,
			INREG32(DISPSYS_MUTEX_BASE + 0x180), 0x184,
			INREG32(DISPSYS_MUTEX_BASE + 0x184));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x188, INREG32(DISPSYS_MUTEX_BASE + 0x188), 0x18C,
			INREG32(DISPSYS_MUTEX_BASE + 0x18C), 0x190,
			INREG32(DISPSYS_MUTEX_BASE + 0x190), 0x194,
			INREG32(DISPSYS_MUTEX_BASE + 0x194));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x1A0, INREG32(DISPSYS_MUTEX_BASE + 0x1A0), 0x1A4,
			INREG32(DISPSYS_MUTEX_BASE + 0x1A4), 0x1A8,
			INREG32(DISPSYS_MUTEX_BASE + 0x1A8), 0x1AC,
			INREG32(DISPSYS_MUTEX_BASE + 0x1AC));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x1B0, INREG32(DISPSYS_MUTEX_BASE + 0x1B0), 0x1B4,
			INREG32(DISPSYS_MUTEX_BASE + 0x1B4), 0x1C0,
			INREG32(DISPSYS_MUTEX_BASE + 0x1C0), 0x1C4,
			INREG32(DISPSYS_MUTEX_BASE + 0x1C4));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x1C8, INREG32(DISPSYS_MUTEX_BASE + 0x1C8), 0x1CC,
			INREG32(DISPSYS_MUTEX_BASE + 0x1CC), 0x1D0,
			INREG32(DISPSYS_MUTEX_BASE + 0x1D0), 0x1D4,
			INREG32(DISPSYS_MUTEX_BASE + 0x1D4));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x1E0, INREG32(DISPSYS_MUTEX_BASE + 0x1E0), 0x1E4,
			INREG32(DISPSYS_MUTEX_BASE + 0x1E4), 0x1E8,
			INREG32(DISPSYS_MUTEX_BASE + 0x1E8), 0x1EC,
			INREG32(DISPSYS_MUTEX_BASE + 0x1EC));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x1F0, INREG32(DISPSYS_MUTEX_BASE + 0x1F0), 0x1F4,
			INREG32(DISPSYS_MUTEX_BASE + 0x1F4), 0x200,
			INREG32(DISPSYS_MUTEX_BASE + 0x200), 0x204,
			INREG32(DISPSYS_MUTEX_BASE + 0x204));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x208, INREG32(DISPSYS_MUTEX_BASE + 0x208), 0x20C,
			INREG32(DISPSYS_MUTEX_BASE + 0x20C), 0x210,
			INREG32(DISPSYS_MUTEX_BASE + 0x210), 0x214,
			INREG32(DISPSYS_MUTEX_BASE + 0x214));
		DDPDUMP("MUTEX: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x\n",
			0x300, INREG32(DISPSYS_MUTEX_BASE + 0x300), 0x304,
			INREG32(DISPSYS_MUTEX_BASE + 0x304), 0x30C,
			INREG32(DISPSYS_MUTEX_BASE + 0x30C));
...
static void mutex_dump_analysis(void)
{
	...
	for (i = 0; i < 5; i++) {
		...
		for (j = 0; j < 32; j++) {
			unsigned int regval =
			    DISP_REG_GET(DISP_REG_CONFIG_MUTEX_MOD1(i));

			if ((regval & (1 << j))) {
				len = sprintf(p, "%s,",
					      ddp_get_mutex_module1_name(j));
				p += len;
			}
		}
		DDPDUMP("%s)\n", mutex_module);
...
--------valid & ready
example :
ovl0->ovl0_mout_ready = 1 means engines after ovl_mout are ready for receiving
data
	ovl0_mout_ready = 0 means ovl0_mout can not receive data, maybe
	ovl0_mout or after engines config error
...
static void mmsys_config_dump_analysis(void)
{
	...
	DDPDUMP("valid0=0x%x,valid1=0x%x,valid2=0x%x,ready0=0x%x,ready1=0x%x,"
		"ready2=0x%x,greq=0%x\n",
	...
	if (greq)
		DDPDUMP("smi greq not grant module: (greq: 1 means SMI dose "
			"not grant, maybe SMI hang)");
...
static void gamma_dump_analysis(void)
{
	...
	DDPDUMP("gamma: en=%d, w=%d, h=%d, in_p_cnt=%d, in_l_cnt=%d, "
		"out_p_cnt=%d, out_l_cnt=%d, relay=%d, stall=%d\n",
		DISP_REG_GET(DISP_REG_GAMMA_EN),
...
static void aal_dump_analysis(void)
{
	...
	DDPDUMP("aal: bypass=%d, relay=%d, en=%d, w=%d, h=%d, "
		"in(%d,%d),out(%d,%d)\n",
...
static void pwm_dump_reg(enum DISP_MODULE_ENUM module)
{
	...
	if (disp_helper_get_option(DISP_OPT_REG_PARSER_RAW_DUMP)) {
		...
		DDPDUMP("PWM0: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x0, INREG32(reg_base + 0x0), 0x4,
			INREG32(reg_base + 0x4), 0x8, INREG32(reg_base + 0x8),
			0x10, INREG32(reg_base + 0x10));
		DDPDUMP("PWM0: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x14, INREG32(reg_base + 0x14), 0x18,
			INREG32(reg_base + 0x18), 0x1C,
			INREG32(reg_base + 0x1C), 0x20,
			INREG32(reg_base + 0x20));
		DDPDUMP("PWM0: 0x%04x=0x%08x\n", 0x30,
			INREG32(reg_base + 0x30));
...
{
	DDPDUMP("ccorr: en=%d, config=%d, w=%d, h=%d, in_p_cnt=%d, "
		"in_l_cnt=%d, out_p_cnt=%d, out_l_cnt=%d\n",
		DISP_REG_GET(DISP_REG_CCORR_EN),
		DISP_REG_GET(DISP_REG_CCORR_CFG),
...
{
	DDPDUMP("dither: en=%d, config=%d, w=%d, h=%d, in_p_cnt=%d, "
		"in_l_cnt=%d, out_p_cnt=%d, out_l_cnt=%d\n",
...
static int split_dump_regs(void)
{
	if (disp_helper_get_option(DISP_OPT_REG_PARSER_RAW_DUMP)) {
		...
		DDPDUMP("SPLIT: 0x%04x=0x%08x, 0x%04x=0x%08x, 0x%04x=0x%08x, "
			"0x%04x=0x%08x\n",
			0x00, INREG32(DDP_REG_BASE_DISP_SPLIT0 + 0x00), 0x04,
			INREG32(DDP_REG_BASE_DISP_SPLIT0 + 0x04), 0x20,
			INREG32(DDP_REG_BASE_DISP_SPLIT0 + 0x20), 0x60,
			INREG32(DDP_REG_BASE_DISP_SPLIT0 + 0x60));
		DDPDUMP("SPLIT: 0x%04x=0x%08x\n", 0x80,
			INREG32(DDP_REG_BASE_DISP_SPLIT0 + 0x80));
...
{
	unsigned int pixel =
	    DISP_REG_GET_FIELD(DEBUG_FLD_IN_PIXEL_CNT, DISP_REG_SPLIT_DEBUG);
	unsigned int state =
	    DISP_REG_GET_FIELD(DEBUG_FLD_SPLIT_FSM, DISP_REG_SPLIT_DEBUG);
