...
#define WRITE_REGISTER_UINT32(reg, val) ((*(unsigned int * const)(reg)) = (val))

#define READ_REGISTER_UINT16(reg)       ((*(unsigned short * const)(reg)))

#define WRITE_REGISTER_UINT16(reg, val) ((*(unsigned short * const)(reg)) = (val))

#define READ_REGISTER_UINT8(reg)        ((*(unsigned char * const)(reg)))

#define WRITE_REGISTER_UINT8(reg, val)  ((*(unsigned char * const)(reg)) = (val))
...
#ifndef ASSERT
    #define ASSERT(expr)        aee_kernel_exception("AEE", "[AEE] error:", expr)
#endif

#define AS_INT32(x)     (*(int *)((void *)x))
#define AS_INT16(x)     (*(int short *)((void *)x))
#define AS_INT8(x)      (*(char  *)((void *)x))
...
struct DSI_REGS {
	...
	unsigned int rsv_3c[5];	/* 003C..004C */
	...
	unsigned int rsv_006C[2];	/* 006c..0070 */
	...
	unsigned int rsv_00A8[22];	/* 0A8..0FC */
	unsigned int DSI_PHY_PCPAT;	/* 00100 */
	...
	unsigned int DSI_VM_CMD_DATA0;	/* 0134 */
	unsigned int DSI_VM_CMD_DATA4;	/* 0138 */
	unsigned int DSI_VM_CMD_DATA8;	/* 013C */
	unsigned int DSI_VM_CMD_DATAC;	/* 0140 */
	...
	unsigned int DSI_BIST_PATTERN;	/* 0178 */
	struct DSI_BIST_CON_REG DSI_BIST_CON;	/* 017C */
	unsigned int DSI_VM_CMD_DATA10;	/* 00180 */
	unsigned int DSI_VM_CMD_DATA14;	/* 00184 */
	unsigned int DSI_VM_CMD_DATA18;	/* 00188 */
	unsigned int DSI_VM_CMD_DATA1C;	/* 0018C */
	struct DSI_STATE_DBG11_REG DSI_STATE_DBG11;	/* 0190 */
	unsigned int rsv_0194;			/* 0194 */
