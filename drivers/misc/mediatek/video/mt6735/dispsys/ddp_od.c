...
/* #include <mach/memory.h> */ /* workaround comment for kernel 3.18 bring up */
#include "ddp_wdma.h"
#include <asm/uaccess.h>
/* #include <mach/mt_irq.h> */ /* workaround comment for kernel 3.18 bring up */
#if defined(CONFIG_MTK_LEGACY)
#include <mach/mt_clkmgr.h>
#endif
/* #include <mach/mt_typedefs.h> */ /* workaround comment for kernel 3.18 bring up */
#include <linux/types.h>
/* #include <mach/mt_spm_idle.h> */ /* workaround comment for kernel 3.18 bring up */
/* #include "disp_drv_platform.h" */ /* workaround comment for kernel 3.18 bring up */
#include "cmdq_def.h"
#include "ddp_drv.h"
#include "ddp_od.h"
#include "ddp_reg.h"
