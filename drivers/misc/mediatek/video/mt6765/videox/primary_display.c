...
#endif
/*Modify by hao.zhang
for [EKHAWAIPG-4752][When the screen refresh rate is set to 60Hz,
frames are dropped for a period of time] Date:20220407 Start*/
	if (primary_display_is_video_mode())
		primary_display_wakeup_pf_thread();
/*Modify by hao.zhang
for [EKHAWAIPG-4752][When the screen refresh rate is set to 60Hz,
frames are dropped for a period of time] Date:20220407 End*/
	mmprofile_log_ex(ddp_mmp_get_events()->session_release,
