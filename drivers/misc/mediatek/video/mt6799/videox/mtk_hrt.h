...
enum HRT_PATH_SCENARIO {
	HRT_PATH_GENERAL =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_NONE, HRT_PATH_PIPE_SINGLE, HRT_PATH_DISP_SINGLE, 0),
	HRT_PATH_DUAL_PIPE =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_NONE, HRT_PATH_PIPE_DUAL, HRT_PATH_DISP_SINGLE, 1),
	HRT_PATH_DUAL_DISP_MIRROR =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_NONE, HRT_PATH_PIPE_SINGLE, HRT_PATH_DISP_DUAL_MIRROR, 2),
	HRT_PATH_DUAL_DISP_EXT =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_NONE, HRT_PATH_PIPE_SINGLE, HRT_PATH_DISP_DUAL_EXT, 3),
	HRT_PATH_RESIZE_GENERAL =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_GENERAL, HRT_PATH_PIPE_SINGLE, HRT_PATH_DISP_SINGLE, 4),
	HRT_PATH_RESIZE_PARTIAL =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_PARTIAL, HRT_PATH_PIPE_SINGLE, HRT_PATH_DISP_SINGLE, 5),
	HRT_PATH_RESIZE_PARTIAL_PMA =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_PARTIAL_PMA, HRT_PATH_PIPE_SINGLE, HRT_PATH_DISP_SINGLE, 6),
	HRT_PATH_DUAL_PIPE_RESIZE_GENERAL =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_GENERAL, HRT_PATH_PIPE_DUAL, HRT_PATH_DISP_SINGLE, 7),
	HRT_PATH_DUAL_PIPE_RESIZE_PARTIAL =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_PARTIAL, HRT_PATH_PIPE_DUAL, HRT_PATH_DISP_SINGLE, 8),
	HRT_PATH_DUAL_PIPE_RESIZE_PARTIAL_PMA =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_PARTIAL_PMA, HRT_PATH_PIPE_DUAL, HRT_PATH_DISP_SINGLE, 9),
	HRT_PATH_DUAL_DISP_MIRROR_RESIZE_GENERAL =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_GENERAL, HRT_PATH_PIPE_SINGLE, HRT_PATH_DISP_DUAL_MIRROR, 10),
	HRT_PATH_DUAL_DISP_MIRROR_RESIZE_PARTIAL =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_PARTIAL, HRT_PATH_PIPE_SINGLE, HRT_PATH_DISP_DUAL_MIRROR, 11),
	HRT_PATH_DUAL_DISP_MIRROR_RESIZE_PARTIAL_PMA =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_PARTIAL_PMA, HRT_PATH_PIPE_SINGLE,
		HRT_PATH_DISP_DUAL_MIRROR, 12),
	HRT_PATH_DUAL_DISP_EXT_RESIZE_GENERAL =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_GENERAL, HRT_PATH_PIPE_SINGLE, HRT_PATH_DISP_DUAL_EXT, 13),
	HRT_PATH_DUAL_DISP_EXT_RESIZE_PARTIAL =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_PARTIAL, HRT_PATH_PIPE_SINGLE, HRT_PATH_DISP_DUAL_EXT, 14),
	HRT_PATH_DUAL_DISP_EXT_RESIZE_PARTIAL_PMA =
		MAKE_UNIFIED_HRT_PATH_FMT(HRT_PATH_RSZ_PARTIAL_PMA, HRT_PATH_PIPE_SINGLE, HRT_PATH_DISP_DUAL_EXT, 15),
	HRT_PATH_UNKNOWN = MAKE_UNIFIED_HRT_PATH_FMT(0, 0, 0, 16),
	HRT_PATH_NUM = MAKE_UNIFIED_HRT_PATH_FMT(0, 0, 0, 17),
};
