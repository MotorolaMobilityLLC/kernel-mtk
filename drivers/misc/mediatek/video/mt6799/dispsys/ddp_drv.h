...
#define DISP_IOCTL_AAL_INIT_DRE30  _IOW(DISP_IOCTL_MAGIC, 19, DISP_DRE30_INIT)
#define DISP_IOCTL_AAL_GET_SIZE    _IOW(DISP_IOCTL_MAGIC, 25, DISP_AAL_DISPLAY_SIZE)
