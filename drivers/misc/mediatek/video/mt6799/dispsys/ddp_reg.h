...
#define MMSYS_POWER_READ_FLD_DISP_WDMA0_DVFS_HALT		REG_FLD(1, 16)
#define MMSYS_POWER_READ_FLD_DISP_WDMA1_DVFS_HALT		REG_FLD(1, 17)
#define MMSYS_POWER_READ_FLD_DISP_RDMA0_DRS_HALT		REG_FLD(1, 20)
#define MMSYS_POWER_READ_FLD_DISP_RDMA1_DRS_HALT		REG_FLD(1, 21)
#define MMSYS_POWER_READ_FLD_DISP_RDMA2_DRS_HALT		REG_FLD(1, 22)
#define MMSYS_POWER_READ_FLD_DISP_WDMA0_DRS_HALT		REG_FLD(1, 24)
#define MMSYS_POWER_READ_FLD_DISP_WDMA1_DRS_HALT		REG_FLD(1, 25)
