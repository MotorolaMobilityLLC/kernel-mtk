...
#define DISP_REG_OVL_INTEN					(0x004UL)
	#define INTEN_FLD_OVL_START_INTEN			REG_FLD(1, 14)
...
#define DISP_REG_OVL_INTSTA					(0x008UL)
	#define INTSTA_FLD_OVL_START_INTSTA			REG_FLD(1, 14)
	#define INTSTA_FLD_ABNORMAL_SOF_INTSTA			REG_FLD(1, 13)
...
#define DISP_REG_OVL_EN						(0x00CUL)
	...
	#define EN_FLD_RD_WRK_REG				REG_FLD(1, 20)
	#define EN_FLD_FORCE_COMMIT				REG_FLD(1, 21)
	#define EN_FLD_BYPASS_SHADOW				REG_FLD(1, 22)
...
#define DISP_REG_OVL_ROI_SIZE					(0x020UL)
	#define ROI_SIZE_FLD_ROI_H				REG_FLD(13, 16)
	#define ROI_SIZE_FLD_ROI_W				REG_FLD(13, 0)

#define DISP_REG_OVL_DATAPATH_CON				(0x024UL)
	#define DATAPATH_CON_FLD_OUTPUT_CLAMP			REG_FLD(1, 26)
	#define DATAPATH_CON_FLD_GCLAST_EN			REG_FLD(1, 24)
	...
	#define DATAPATH_CON_FLD_OUTPUT_NO_RND			REG_FLD(1, 3)
...
#define DISP_REG_OVL_SRC_CON					(0x02CUL)
	#define SRC_CON_FLD_RELAY_MODE_EN			REG_FLD(1, 9)
	#define SRC_CON_FLD_FORCE_RELAY_MODE			REG_FLD(1, 8)
	#define SRC_CON_FLD_LC_EN				REG_FLD(1, 4)
	...
	#define SRC_CON_FLD_L_EN				REG_FLD(5, 0)
#define DISP_REG_OVL_L0_CON					(0x030UL)
	#define L_CON_FLD_SKEN					REG_FLD(1, 30)
	/* layer source 0:mem, 1:constant color */
	#define L_CON_FLD_LSRC					REG_FLD(2, 28)
...
#define DISP_REG_OVL_L0_PITCH					(0x044UL)
	...
	#define L_PITCH_FLD_SA_SEL				REG_FLD(2, 16)
	#define L_PITCH_FLD_SRGB_SEL				REG_FLD(2, 18)
	#define L_PITCH_FLD_DA_SEL				REG_FLD(2, 20)
	#define L_PITCH_FLD_DRGB_SEL				REG_FLD(2, 22)
	#define L_PITCH_FLD_SA_SEL_EXT				REG_FLD(1, 24)
	#define L_PITCH_FLD_SRGB_SEL_EXT			REG_FLD(1, 25)
	#define L_PITCH_FLD_DA_SEL_EXT				REG_FLD(1, 26)
	#define L_PITCH_FLD_DRGB_SEL_EXT			REG_FLD(1, 27)
	#define L_PITCH_FLD_CONST_BLD				REG_FLD(1, 28)
	#define L_PITCH_FLD_SRGB_SEL_EXT2			REG_FLD(1, 29)
	#define L_PITCH_FLD_BLEND_RND_SHT			REG_FLD(1, 30)
...
#define DISP_REG_OVL_RDMA0_CTRL					(0x0C0UL)
	...
	#define RDMA0_CTRL_FLD_RMDA_FIFO_USED_SZ		REG_FLD(12, 16)
...
#define DISP_REG_OVL_RDMA0_DBG					(0x24cUL)
	#define RDMA0_DBG_FLD_RDMA0_SMI_GREQ			REG_FLD(1, 31)
	#define RDMA0_DBG_FLD_RDMA0_SMI_BUSY			REG_FLD(1, 30)
	...
	#define RDMA0_DBG_FLD_RDMA0_LAYER_GREQ			REG_FLD(1, 3)
...
#define DISP_REG_OVL_LC_SRC_SEL					(0x290UL)
	#define LC_SRC_SEL_FLD_L_SEL				REG_FLD(3, 0)
