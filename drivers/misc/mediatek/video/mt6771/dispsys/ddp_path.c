...
unsigned int module_list_scenario[DDP_SCENARIO_MAX][DDP_ENING_NUM] = {
	...
	{
	DISP_MODULE_OVL0, DISP_MODULE_OVL0_2L, DISP_MODULE_RDMA0, DISP_MODULE_RDMA_VIRTUAL0,
#ifdef DISP_COLOR_ON
		DISP_MODULE_COLOR0,
#endif
	...
	{
		DISP_MODULE_RDMA0, DISP_MODULE_RDMA_VIRTUAL0, DISP_MODULE_PWM0, DISP_MODULE_DSI0,
		-1,
	},
	...
	{
		DISP_MODULE_OVL1_2L, DISP_MODULE_RDMA1, DISP_MODULE_DPI_VIRTUAL, DISP_MODULE_DPI,
		-1,
	},
	...
	{
	 DISP_MODULE_OVL1_2L, DISP_MODULE_WDMA_VIRTUAL0, DISP_MODULE_WDMA_VIRTUAL1,
		DISP_MODULE_WDMA0, DISP_MODULE_RDMA1, DISP_MODULE_DPI_VIRTUAL, DISP_MODULE_DPI,
		-1, -1, -1, -1, -1, -1, -1, -1, -1}
};
...
static struct mout_s mout_map[] = {
	...
	/* DITHER0_MOUT */
	{DISP_MODULE_DITHER0,
		{{DISP_MODULE_DSI0, 1 << 0}, {DISP_MODULE_DPI, 1 << 2},
