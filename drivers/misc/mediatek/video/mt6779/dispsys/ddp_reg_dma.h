...
#define DISP_REG_RDMA_INT_ENABLE		(DISPSYS_RDMA0_BASE+0x000)
	...
	#define INT_ENABLE_FLD_FIFO_EMPTY_INT_EN	REG_FLD_MSB_LSB(6, 6)
	#define INT_ENABLE_FLD_SOF_ABNORMAL_INT_EN	REG_FLD_MSB_LSB(7, 7)
#define DISP_REG_RDMA_INT_STATUS		(DISPSYS_RDMA0_BASE+0x004)
	...
	#define INT_STATUS_FLD_SOF_ABNORMAL_INT_FLAG	REG_FLD_MSB_LSB(7, 7)
...
#define DISP_REG_RDMA_MEM_CON			(DISPSYS_RDMA0_BASE+0x024)
	...
	#define MEM_CON_FLD_MEM_MODE_INTERLACE_EN	REG_FLD_MSB_LSB(2, 2)
...
#define DISP_REG_RDMA_CROP_CON_0		(DISPSYS_RDMA0_BASE+0x0e0)
	#define CROP_CON_0_FLD_CROP_LEFT	REG_FLD_MSB_LSB(12, 0)
	#define CROP_CON_0_FLD_CROP_RIGHT	REG_FLD_MSB_LSB(28, 16)
#define DISP_REG_RDMA_CROP_CON_1		(DISPSYS_RDMA0_BASE+0x0e4)
	#define CROP_CON_0_FLD_CROP_TOP		REG_FLD_MSB_LSB(12, 0)
	#define CROP_CON_0_FLD_CROP_BOTTOM	REG_FLD_MSB_LSB(28, 16)
#define DISP_REG_RDMA_THRESHOLD_FOR_URGENT	(DISPSYS_RDMA0_BASE+0x0e8)
	#define FLD_LOW_FOR_URGENT		REG_FLD_MSB_LSB(11, 0)
	#define FLD_HIGH_FOR_URGENT		REG_FLD_MSB_LSB(27, 16)
...
#define DISP_REG_WDMA_INTEN			(DISPSYS_WDMA0_BASE+0x000)
	...
	#define INTEN_FLD_FIFO_FULL		REG_FLD_MSB_LSB(2, 2)
#define DISP_REG_WDMA_INTSTA			(DISPSYS_WDMA0_BASE+0x004)
	...
	#define INTSTA_FLD_FIFO_FULL		REG_FLD_MSB_LSB(2, 2)
#define DISP_REG_WDMA_EN			(DISPSYS_WDMA0_BASE+0x008)
	...
	#define WDMA_EN_FLD_INTERNAL_GLOBAL_CG_ENABLE	REG_FLD_MSB_LSB(30, 30)
	#define WDMA_EN_FLD_INTERNAL_CG_ENABLE	REG_FLD_MSB_LSB(31, 31)
...
#define DISP_REG_WDMA_CFG			(DISPSYS_WDMA0_BASE+0x014)
	#define CFG_FLD_DITHER_INIT_H_POS	REG_FLD_MSB_LSB(1, 0)
	#define CFG_FLD_DITHER_INIT_V_POS	REG_FLD_MSB_LSB(3, 2)
	#define CFG_FLD_OUT_FORMAT		REG_FLD_MSB_LSB(7, 4)
	#define CFG_FLD_BYTE_SWAP		REG_FLD_MSB_LSB(8, 8)
	#define CFG_FLD_RGB_SWAP		REG_FLD_MSB_LSB(9, 9)
	#define CFG_FLD_UV_SWAP			REG_FLD_MSB_LSB(10, 10)
	...
	#define CFG_FLD_UNI_CONFIG		REG_FLD_MSB_LSB(17, 17)
	#define CFG_FLD_UFO_DCP_ENABLE		REG_FLD_MSB_LSB(18, 18)
	#define CFG_FLD_UFO_DCP_10BIT		REG_FLD_MSB_LSB(19, 19)
	#define CFG_FLD_BKGD_EN			REG_FLD_MSB_LSB(20, 20)
	#define CFG_FLD_DITHER_CEN		REG_FLD_MSB_LSB(21, 21)
...
#define DISP_REG_WDMA_INPUT_CNT_DBG		(DISPSYS_WDMA0_BASE+0x0A8)
	#define INPUT_CNT_DBG_FLD_X		REG_FLD_MSG_LSB(13, 0)
	#define INPUT_CNT_DBG_FLD_Y		REG_FLD_MSG_LSB(29, 16)
...
#define DISP_REG_WDMA_URGENT_CON0		(DISPSYS_WDMA0_BASE+0x260)
	#define FLD_WDMA_URGENT_LOW_Y		REG_FLD_MSB_LSB(9, 0)
	#define FLD_WDMA_URGENT_HIGH_Y		REG_FLD_MSB_LSB(25, 16)
#define DISP_REG_WDMA_URGENT_CON1		(DISPSYS_WDMA0_BASE+0x264)
	#define FLD_WDMA_URGENT_LOW_U		REG_FLD_MSB_LSB(9, 0)
	#define FLD_WDMA_URGENT_HIGH_U		REG_FLD_MSB_LSB(25, 16)
#define DISP_REG_WDMA_URGENT_CON2		(DISPSYS_WDMA0_BASE+0x268)
	#define FLD_WDMA_URGENT_LOW_V		REG_FLD_MSB_LSB(9, 0)
	#define FLD_WDMA_URGENT_HIGH_V		REG_FLD_MSB_LSB(25, 16)
#define DISP_REG_WDMA_UNCOMP_MON		(DISPSYS_WDMA0_BASE+0x280)
	#define FLD_WDMA_COMP_MON_CLR		REG_FLD_MSB_LSB(0, 0)
	#define FLD_WDMA_COMP_MON_RAW		REG_FLD_MSB_LSB(25, 1)
#define DISP_REG_WDMA_COMP_MON			(DISPSYS_WDMA0_BASE+0x284)
	#define FLD_WDMA_COMP_MON_COMP		REG_FLD_MSB_LSB(25, 1)
