			       ...
			       struct ESD_PARA *data)
{
	...
	err |= get_user(d, (unsigned long *)(&data32->esd_ret_buffer));
	err |= put_user(d, (unsigned long *)(&data->esd_ret_buffer));
			       ...
			       struct ESD_PARA *data)
{
	...
	err |= get_user(d, (unsigned long *)(&data->esd_ret_buffer));
	err |= put_user(d, (unsigned long *)(&data32->esd_ret_buffer));
