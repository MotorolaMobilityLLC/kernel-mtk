...
// O-film
#define MAX_LIMIT_VALUE_GROUP1 1827 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP1 640		// screen min limit
#define MAX_LIMIT_KEY_GROUP1 1171		// key_val max limit
#define MIN_LIMIT_KEY_GROUP1 540		// key_val min limit
#define UNIFORMITY_GROUP1 60 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP1 {\
	0x00,0xD0,0x02,0x00,0x05,0x05,0x05,0x41,0x01,0x08,0x28,0x05,0x50,0x32,0x03,\
	0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x8A,0x29,0x0B,\
	0x50,0x52,0xD3,0x07,0x00,0x00,0x00,0x00,0x03,0x1D,0x00,0x00,0x00,0x00,0x00,\
	0x03,0x64,0x32,0x00,0x00,0x00,0x0F,0x2C,0x94,0x45,0x02,0x07,0x00,0x00,0x04,\
	0xA1,0x10,0x00,0x86,0x14,0x00,0x70,0x19,0x00,0x5D,0x20,0x00,0x55,0x27,0x00,\
	0x55,0x10,0x30,0x50,0x00,0xF0,0x4A,0x3A,0xFF,0xFF,0x27,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x02,0x04,0x06,0x08,0x0A,0x0C,0x0E,0x10,\
	0x12,0x14,0x16,0xFF,0xFF,0xFF,0x1F,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,\
	0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x16,0x22,0x18,0x21,0x1C,0x20,0x1D,0x1E,\
	0x1F,0x0C,0x0A,0x10,0x0F,0x00,0x12,0x04,0x02,0x08,0x06,0xFF,0xFF,0xFF,0xFF,\
	0xFF,0xFF,0xFF,0x00,0xFF,0xFF,0xFB,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xAF,\
	0xFF,0xFF,0xFF,0xFF,0x34,0x01\
    }

//TODO: define your config for Sensor_ID == 1 here, if needed mudong

#define MAX_LIMIT_VALUE_GROUP2 3700 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP2 850		// screen min limit
#define MAX_LIMIT_KEY_GROUP2 1900		// key_val max limit
#define MIN_LIMIT_KEY_GROUP2 800		// key_val min limit
#define UNIFORMITY_GROUP2 200 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP2  {}
//0x41,} //{}

//TODO: define your config for Sensor_ID == 2 here, if needed Helitai


#define MAX_LIMIT_VALUE_GROUP3 2890 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP3 990		// screen min limit
#define MAX_LIMIT_KEY_GROUP3 2710		// key_val max limit
#define MIN_LIMIT_KEY_GROUP3 1050		// key_val min limit
#define UNIFORMITY_GROUP3 60 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP3 {}


//TODO: define your config for Sensor_ID == 3 here, if needed


#define MAX_LIMIT_VALUE_GROUP4 1800 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP4 1000		// screen min limit
#define MAX_LIMIT_KEY_GROUP4 1500		// key_val max limit
#define MIN_LIMIT_KEY_GROUP4 800		// key_val min limit
...
#define MAX_LIMIT_VALUE_GROUP5 1800 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP5 1000		// screen min limit
#define MAX_LIMIT_KEY_GROUP5 1500		// key_val max limit
#define MIN_LIMIT_KEY_GROUP5 800		// key_val min limit
#define UNIFORMITY_GROUP5 70 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP5 {\
    }

//TODO: define your config for Sensor_ID == 5 here, if needed Yushun


#define MAX_LIMIT_VALUE_GROUP6 3600 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP6 800		// screen min limit
#define MAX_LIMIT_KEY_GROUP6 2280		// key_val max limit
#define MIN_LIMIT_KEY_GROUP6 1000		// key_val min limit
#define UNIFORMITY_GROUP6 70 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP6 {}
...
#define SET_INFO_LINE_INFO(fmt, args...)       do{} while(0)
...
static void gtp_open_test_init(struct i2c_client *client)
{
	...
	u16 max_limit_value_info[] = { 	MAX_LIMIT_VALUE_GROUP1, MAX_LIMIT_VALUE_GROUP2, MAX_LIMIT_VALUE_GROUP3,
									MAX_LIMIT_VALUE_GROUP4, MAX_LIMIT_VALUE_GROUP5, MAX_LIMIT_VALUE_GROUP6};
	
	u16 min_limit_value_info[] = { 	MIN_LIMIT_VALUE_GROUP1, MIN_LIMIT_VALUE_GROUP2, MIN_LIMIT_VALUE_GROUP3,
									MIN_LIMIT_VALUE_GROUP4, MIN_LIMIT_VALUE_GROUP5, MIN_LIMIT_VALUE_GROUP6};	
#if defined(MAX_LIMIT_KEY_GROUP6)
	u16 max_limit_key_info[] = { 	MAX_LIMIT_KEY_GROUP1, MAX_LIMIT_KEY_GROUP2, MAX_LIMIT_KEY_GROUP3,
									MAX_LIMIT_KEY_GROUP4, MAX_LIMIT_KEY_GROUP5, MAX_LIMIT_KEY_GROUP6};
#endif
#if defined(MIN_LIMIT_KEY_GROUP6)
	u16 min_limit_key_info[] = { 	MIN_LIMIT_KEY_GROUP1, MIN_LIMIT_KEY_GROUP2, MIN_LIMIT_KEY_GROUP3,
									MIN_LIMIT_KEY_GROUP4, MIN_LIMIT_KEY_GROUP5, MIN_LIMIT_KEY_GROUP6};	
#endif
#if defined(UNIFORMITY_GROUP6)
	u16 uniformity_lmt_info[] = { 	UNIFORMITY_GROUP1, UNIFORMITY_GROUP2, UNIFORMITY_GROUP3,
	...
	u8 *send_test_cfg_buf[] = {test_cfg_info_group1, test_cfg_info_group2, test_cfg_info_group3,
                        test_cfg_info_group4, test_cfg_info_group5, test_cfg_info_group6};
    u8 tset_cfg_info_len[] = { CFG_GROUP_LEN(test_cfg_info_group1), 
    ...
    u8 test_config[GTP_CONFIG_MAX_LENGTH + GTP_ADDR_LENGTH] = {(u8)(GTP_REG_CONFIG_DATA >> 8), (u8)GTP_REG_CONFIG_DATA, 0};
...
#if defined(CONFIG_GTP_DEBUG_ON)
...
open_test_exit:
    ...
    msleep(100);
    gtp_send_cfg(client);
		msleep(300);//等待配置刷新到IC内部，msleep（300）ms，实际上会大于300ms，可以确保IC配置刷新。
    return ret;
}
...
static ssize_t gtp_sysfs_shorttest_show(struct device *dev,struct device_attribute *attr, char *buf)
{
	...
	if (ret == SUCCESS)
	{
		len = sprintf(buf, "Short Test PASS \n");
	}
	else
	{
		len = sprintf(buf, "Short Test FAIL \n");
	}
...
static ssize_t gtp_sysfs_opentest_show(struct device *dev,struct device_attribute *attr, char *buf)
{
	...
	if (ret == SUCCESS)
	{
		len = sprintf(buf, "Open Test SUCCEED \n");
	}
	else
	{
		len = sprintf(buf, "Open Test FAIL \n");
	}
