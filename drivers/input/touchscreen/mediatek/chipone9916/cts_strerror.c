...
static const char *const _error_text[] = {
	    [0] =
	    "Success", ERROR_TEXT_ENTRY(EPERM, "Operation not permitted"),
	...
	ERROR_TEXT_ENTRY(EFAULT, "Bad address"), ERROR_TEXT_ENTRY(ENOTBLK,
							    "Block device required"),
	ERROR_TEXT_ENTRY(EBUSY, "Device or resource busy"),
	ERROR_TEXT_ENTRY(EEXIST, "File exists"), ERROR_TEXT_ENTRY(EXDEV,
	...
	ERROR_TEXT_ENTRY(ESPIPE, "Illegal seek"), ERROR_TEXT_ENTRY(EROFS,
								     "Read-only file system"),
	ERROR_TEXT_ENTRY(EMLINK, "Too many links"),
	ERROR_TEXT_ENTRY(EPIPE, "Broken pipe"), ERROR_TEXT_ENTRY(EDOM,
	...
	ERROR_TEXT_ENTRY(ENOANO, "No anode"), ERROR_TEXT_ENTRY(EBADRQC,
	...
	ERROR_TEXT_ENTRY(ETIME, "Timer expired"), ERROR_TEXT_ENTRY(ENOSR,
	...
	ERROR_TEXT_ENTRY(ESRMNT, "Srmount error"), ERROR_TEXT_ENTRY(ECOMM,
	...
	ERROR_TEXT_ENTRY(ELIBMAX,
			  "Attempting to link in too many shared libraries"),
	ERROR_TEXT_ENTRY(ELIBEXEC,
		   "Cannot exec a shared library directly"),
	ERROR_TEXT_ENTRY(EILSEQ,
		   "Invalid or incomplete multibyte or wide character"),
	ERROR_TEXT_ENTRY(ERESTART,
	...
	ERROR_TEXT_ENTRY(EISCONN,
			  "Transport endpoint is already connected"),
	ERROR_TEXT_ENTRY(ENOTCONN, "Transport endpoint is not connected"),
	ERROR_TEXT_ENTRY(ESHUTDOWN,
			  "Cannot send after transport endpoint shutdown"),
	ERROR_TEXT_ENTRY(ETOOMANYREFS,
	...
	ERROR_TEXT_ENTRY(ERESTART_RESTARTBLOCK,
