...
#ifdef CTS_MTK_GET_PANEL
//char panel_name[100] = { 0 };
int cts_get_panel(void)
{
	if(strstr(saved_command_line, "icnl9916_hdp_dsi_vdo_tm")) {
		cts_info("%s:panel= icnl9916_hdp_dsi_vdo_tm\n",__func__);
		return 0;
	}
	cts_info("%s not icnl9916_hdp_dsi_vdo_tm", __func__);
	return -1;
}
/*
...
static const struct of_device_id cts_driver_of_match_table[] = {
	{.compatible = CFG_CTS_DRIVER_NAME, },
	{ },
};
