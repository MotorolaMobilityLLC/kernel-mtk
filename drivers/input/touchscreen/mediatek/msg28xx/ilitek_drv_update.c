...
extern char msg2836a_version[50];
...
static void _DrvMsg28xxCheckFirmwareUpdateBySwId(void) 
{
    ...
    if (nCrcMainA == nCrcMainB) 
    {
        ...
        else
        {
            ...
            if(g_FwVersionFlag)
            {
                snprintf(msg2836a_version,sizeof(msg2836a_version),"HLT-msg2836a-fw:%d.%d.%d",nMajor, (nMinor & 0xFF), ((nMinor >> 8) & 0xFF));               
            }
            else
            {
                snprintf(msg2836a_version,sizeof(msg2836a_version),"HLT-msg2836a-fw:%d.%d",nMajor, nMinor);  
            }
        }
    }
    else 
