...
u8 fw_file[] = {
#include FTS_UPGRADE_FW_FILE_TPK_TXD
};
u8 fw_file2[] = {
#include FTS_UPGRADE_FW2_FILE_TPK_HLT
};
#elif defined(LENOVO_PRJ)
#define FTS_UPGRADE_FW_FILE_LEO_TXD                      "include/firmware/Ontim_Alaska_TXD_FT8006U_V0x0D_L0x06_20180428.i"
#define FTS_UPGRADE_FW2_FILE_LEO_HLT                     "include/firmware/Ontim_Alaska_HLT_FT8006U_V0x0D_L0x06_20180428.i"

u8 fw_file[] = {
#include FTS_UPGRADE_FW_FILE_LEO_TXD
};
u8 fw_file2[] = {
#include FTS_UPGRADE_FW2_FILE_LEO_HLT
};
#elif defined(CROSS_PRJ)
#define FTS_UPGRADE_FW_FILE_CROSS_TXD                      "include/firmware/Ontim_TPLINK_TXD_FT8006U_VID0x7C_Ver0x0C_L0x06_20180426_all.i"
#define FTS_UPGRADE_FW2_FILE_CROSS_HLT                     "include/firmware/Ontim_TPLINK_HLT_FT8006U_VID0x7C_Ver0x0C_L0x06_20180426_all.i"

u8 fw_file[] = {
#include FTS_UPGRADE_FW_FILE_CROSS_TXD
};
u8 fw_file2[] = {
#include FTS_UPGRADE_FW2_FILE_CROSS_HLT
};
#endif
...
FTS_ERROR("wuyx--------TPK------name=%s--------",s);
 if(!strcmp(s,"ontim_ft8006u")){
	fw = &fw_list[0];
	FTS_ERROR("wuyx--------TPK--------fw_list[0]------");
   }
 if(!strcmp(s,"ontim_ft8006u_holitech")){
	fw = &fw_list[1];
	FTS_ERROR("wuyx--------TPK--------fw_list[1]------");
}
#elif defined(LENOVO_PRJ)
 FTS_ERROR("wuyx--------leo------name=%s--------",s);
 if(!strcmp(s,"ontim_ft8006u")){
	fw = &fw_list[0];
	FTS_ERROR("wuyx--------leo-------fw_list[0]-------");
  }
if(!strcmp(s,"lenovo_ft8006u")){
	fw = &fw_list[1];
	FTS_ERROR("wuyx--------leo-------fw_list[1]-------");
 }
#elif defined(CROSS_PRJ)
FTS_ERROR("wuyx--------cross------name=%s--------",s);
 if(!strcmp(s,"ontim_ft8006u")){
	fw = &fw_list[0];
	FTS_ERROR("wuyx--------cross--------fw_list[0]------");
   }
 if(!strcmp(s,"ontim_ft8006u_holitech")){
	fw = &fw_list[1];
	FTS_ERROR("wuyx--------cross--------fw_list[1]------");
}
#else
project reject
#endif
