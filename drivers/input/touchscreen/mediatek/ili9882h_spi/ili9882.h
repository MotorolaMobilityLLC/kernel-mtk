...
#define ILI9882H_VARIABLE_DEFINE

#ifdef ILI9882H_VARIABLE_DEFINE
#define short_para        short_para_9882h
#define open_para         open_para_9882h
#define ini_info          ini_info_9882h
#endif
...
({									\
	pr_info("ILITEK_9882H: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
})									\

#define ILI_ERR(fmt, arg...)						\
({									\
	pr_err("ILITEK_9882H: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
})									\
...
#define TDDI_DEV_ID				"ILITEK_TDDI_9882H"
