...
enum cts_device_fw_reg {
    ...
    CTS_DEVICE_FW_REG_DISPLAY_ON1 = 0xC044,
    CTS_DEVICE_FW_REG_DISPLAY_ON2 = 0xC0A4,
    CTS_DEVICE_FW_REG_DISPLAY_OFF1 = 0xC0A0,
    CTS_DEVICE_FW_REG_DISPLAY_OFF2 = 0xC040,
    CTS_DEVICE_FW_REG_DISPLAY = 0xD228,
