...
extern int cts_compensate_cap_test(struct cts_device *cts_dev, u8 min_thres, u8 max_thres);
extern int cts_rawdata_test(struct cts_device *cts_dev, u16 min_thres, u16 max_thres);
