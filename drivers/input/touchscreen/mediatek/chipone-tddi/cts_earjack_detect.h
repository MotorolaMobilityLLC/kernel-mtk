...
extern int cts_init_earjack_detect(struct chipone_ts_data *cts_data);
extern int cts_deinit_earjack_detect(struct chipone_ts_data *cts_data);
...
static inline int cts_init_earjack_detect(struct chipone_ts_data *cts_data)
{
    return -ENOTSUPP;
}
static inline int cts_deinit_earjack_detect(struct chipone_ts_data *cts_data)
{
    return -ENOTSUPP;
}
