...
#define PROC_NODE_WT_GESTURE_DEBUG_MODE                 "gesture_onoff"
...
#endif //CONFIG_ENABLE_GESTURE_INFORMATION_MODE
extern ssize_t DrvMainProcfsWtGestureDebugRead(struct file *pFile, char __user *pBuffer, size_t nCount, loff_t *pPos);
extern ssize_t DrvMainProcfsWtGestureDebugWrite(struct file *pFile, const char __user *pBuffer, size_t nCount, loff_t *pPos);
#endif //CONFIG_ENABLE_GESTURE_WAKEUP
