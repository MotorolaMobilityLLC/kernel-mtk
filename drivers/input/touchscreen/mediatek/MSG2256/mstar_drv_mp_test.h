...
#define DC_Range 	 (40)
#define DC_VA_Ratio 	 (8)
#define DC_Border_Ratio  (10)

#define MSTAR_TEST_DATA   "/sdcard/"
//#define NUM_OPEN_1_SENSOR_HLT_UP 20
//#define NUM_OPEN_2_SENSOR_HLT_DOWN 20
//s16 Golden_0[NUM_OPEN_1_SENSOR_HLT_UP] = {0};
//s16 Golden_1[NUM_OPEN_2_SENSOR_HLT_DOWN] = {0};
//- bug 282400 ,zwk.wt,20170802,add new tp openshort test mode 
