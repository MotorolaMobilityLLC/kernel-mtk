...
#include "include/tpd_common_s7xxx.h"
...
struct synaptics_rmi4_exp_fn {
	...
	void (*func_attn)(struct i2c_client *client, unsigned char intr_mask);
...
extern int tpd_i2c_read_data(struct i2c_client *client, unsigned short addr, unsigned char *data,
			     unsigned short length);

extern int tpd_i2c_write_data(struct i2c_client *client, unsigned short addr, unsigned char *data,
			      unsigned short length);
