...
#define FTS_FW_NAME_PREX_WITH_REQUEST               "focaltech_ts_fw_01.bin"
...
#define FTS_Y_MAX_DISPLAY_DEFAULT           1520
...
extern int fts_load_fw_init(struct fts_ts_data *ts_data);
