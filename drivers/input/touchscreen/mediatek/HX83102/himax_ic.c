...
#endif
extern void himax_refresh_senstive_ontim(void);
...
extern uint8_t sensitivity_addr[4];
extern uint8_t sensitivity_data[4];
extern uint8_t sensitivity_addr1[4];
extern uint8_t sensitivity_data1[4];

void himax_set_sensitivity_enable(struct i2c_client *client, uint8_t sensitivity)
{
    uint8_t tmp_addr[4];
    uint8_t tmp_data[4];
    ...
    if (sensitivity == 0) {//low sensitivity
        tmp_data[3] = sensitivity_data[3];
        tmp_data[2] = sensitivity_data[2];
        tmp_data[1] = sensitivity_data[1] + 2;
        tmp_data[0] = sensitivity_data[0];
        himax_flash_write_burst(client, sensitivity_addr, tmp_data);

        tmp_data[3] = sensitivity_data1[3];
        tmp_data[2] = sensitivity_data1[2] + 2;
        tmp_data[1] = sensitivity_data1[1] + 2;
        tmp_data[0] = sensitivity_data1[0] + 2;
        himax_flash_write_burst(client, sensitivity_addr1, tmp_data);
    ...
    } else if (sensitivity == 1){//normal sensitivity
        tmp_data[3] = sensitivity_data[3];
        tmp_data[2] = sensitivity_data[2];
        tmp_data[1] = sensitivity_data[1];
        tmp_data[0] = sensitivity_data[0];
        himax_flash_write_burst(client, sensitivity_addr, tmp_data);

        tmp_data[3] = sensitivity_data1[3];
        tmp_data[2] = sensitivity_data1[2];
        tmp_data[1] = sensitivity_data1[1];
        tmp_data[0] = sensitivity_data1[0];
        himax_flash_write_burst(client, sensitivity_addr1, tmp_data);
        ...
        I("data[0] = 0x%2x, data[1] = 0x%2x, data[2] = 0x%2x, data[3] = 0x%2x\n", sensitivity_data[0], sensitivity_data[1], sensitivity_data[2], sensitivity_data[3]);
        I("data1[0] = 0x%2x, data1[1] = 0x%2x, data1[2] = 0x%2x, data1[3] = 0x%2x\n", sensitivity_data1[0], sensitivity_data1[1], sensitivity_data1[2], sensitivity_data1[3]);
    } else if (sensitivity == 2){//high sensitivity
        tmp_data[3] = sensitivity_data[3];
        tmp_data[2] = sensitivity_data[2];
        tmp_data[1] = sensitivity_data[1] - 2;
        tmp_data[0] = sensitivity_data[0];
...
void himax_read_FW_ver(struct i2c_client *client)
{
    ...
    snprintf(version, sizeof(version),"himax83102 ver %d.0",ic_data->vendor_touch_cfg_ver );
    cmd[3] = 0x10;
    cmd[2] = 0x00;
    cmd[1] = 0x70;
    cmd[0] = 0x00;
