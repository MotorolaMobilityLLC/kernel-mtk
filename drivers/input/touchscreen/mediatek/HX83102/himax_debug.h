...
static struct proc_dir_entry *himax_proc_fwup_ontim_file 	= NULL;
static struct proc_dir_entry *himax_proc_gest_en_ontim_file 	= NULL;
//static struct proc_dir_entry *himax_proc_glove_en_ontim_file 	= NULL;
static struct proc_dir_entry *himax_proc_gest_coor_ontim_file 	= NULL;
static struct proc_dir_entry *himax_proc_psensor_distouch_ontim_file 	= NULL;
//static struct proc_dir_entry *himax_proc_senstive_ontim_file 	= NULL;
static struct proc_dir_entry *himax_proc_gest_id_ontim_file 	= NULL;
//static struct proc_dir_entry *himax_proc_senstive_ontim_file 	= NULL;
...
#ifdef HX_HIGH_SENSE
#define HIMAX_PROC_HSEN_FILE "glove_mode_enable"
struct proc_dir_entry *himax_proc_HSEN_file = NULL;
#endif

#ifdef HX_THRESHOLD_ADJUST_ENABLE
#define HIMAX_PROC_SENSITIVITY_FILE		"tp_thresh_value"
struct proc_dir_entry *himax_proc_sensitivity_file = NULL;
#endif
