...
#define TPD_CALIBRATION_MATRIX_ROTATION_NORMAL  {-4096, 0, 4915200, 0, -4096, 7864320, 0, 0}
#define TPD_CALIBRATION_MATRIX_ROTATION_FACTORY {-4096, 0, 4915200, 0, -4096, 7864320, 0, 0}
