...
#define FLASH_DUMP_FILE "/sdcard/Himax_Flash_Dump.bin"
...
static int HX_CHIP_MONITOR_EN=1;
#endif
...
/*key_range : [keyindex][key_data] {..{min_x,max_x,min_y,max_y}..}*/
static int key_range[3][4]={{120,240,1200,1600},{300,420,1200,1600},{480,600,1200,1600}};
