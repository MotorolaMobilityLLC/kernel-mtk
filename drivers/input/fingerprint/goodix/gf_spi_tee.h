...
// BEGIN Lenovo, hechuang1, 02/16/2017, INDRIYAPRO-24
#define GF_NAV_INPUT_UP			0x231
#define GF_NAV_INPUT_DOWN		0x230
#define GF_NAV_INPUT_LEFT		0x22F
#define GF_NAV_INPUT_RIGHT		0x22E
#define GF_NAV_INPUT_CLICK		0x232
#define GF_NAV_INPUT_DOUBLE_CLICK	0x234
#define GF_NAV_INPUT_LONG_PRESS		0x233
// END INDRIYAPRO-24
