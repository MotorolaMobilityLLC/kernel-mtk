...
#define GF_NAV_INPUT_CLICK				562 //
#define GF_NAV_INPUT_LONG_PRESS			563//KEY_SEARCH
#define GF_NAV_INPUT_DOWN				559//KEY_LEFT
#define GF_NAV_INPUT_UP					558//KEY_RIGHT
#define GF_NAV_INPUT_RIGHT				560//KEY_DOWN
#define GF_NAV_INPUT_LEFT				561//KEY_UP
...
struct gf_device {
	...
	struct pinctrl_state *ldo_1v8_on, *ldo_1v8_off, *ldo_3v3_on, *ldo_3v3_off;
#endif
};
