...
int fpsensor_spidev_dts_init(fpsensor_data_t *fpsensor)
{
    ...
    if (node) {
        ...
        if (IS_ERR(fpsensor->fp_cs_low)) {
            ...
            fpsensor_debug(ERR_LOG,"fpsensor Cannot find fp pinctrl fpsensor_spi_cs_low!\n");
            return ret;
        }
        ...
        if (IS_ERR(fpsensor->fp_cs_high)) {
            ...
            fpsensor_debug(ERR_LOG,"fpsensor Cannot find fp pinctrl fpsensor_spi_cs_high!\n");
            return ret;
        }
        ...
        if (IS_ERR(fpsensor->fp_mo_low)) {
            ...
            fpsensor_debug(ERR_LOG,"fpsensor Cannot find fp pinctrl fpsensor_spi_mo_low!\n");
            return ret;
        }
        ...
        if (IS_ERR(fpsensor->fp_mi_low)) {
            ...
            fpsensor_debug(ERR_LOG,"fpsensor Cannot find fp pinctrl fpsensor_spi_mi_low!\n");
            return ret;
        }

        fpsensor->fp_ck_low = pinctrl_lookup_state(fpsensor->pinctrl1, "fpsensor_spi_clk_low");
        if (IS_ERR(fpsensor->fp_ck_low)) {
            ret = PTR_ERR(fpsensor->fp_ck_low);
            fpsensor_debug(ERR_LOG,"fpsensor Cannot find fp pinctrl fpsensor_spi_clk_low!\n");
            return ret;
        }
...
#if  1
            irqf = IRQF_TRIGGER_NONE | IRQF_ONESHOT;
