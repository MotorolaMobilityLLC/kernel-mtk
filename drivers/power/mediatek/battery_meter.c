...
void fgauge_construct_battery_profile(kal_int32 temperature, BATTERY_PROFILE_STRUCT_P temp_profile_p)
{
...
void fgauge_construct_r_table_profile(kal_int32 temperature, R_PROFILE_STRUCT_P temp_profile_p)
{
