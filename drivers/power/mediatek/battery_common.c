...
/* sunxuebin.wt add for charging control when temperature in higher range begin */
#ifdef WT_LOW_TEMP_AND_HIGH_TEMP_CHARGING_CONTROL
extern void high_temp_charging_control(void);
#endif
/* sunxuebin.wt add for charging control when temperature in higher range end */
...
/*Other sunxuebin.wt add 20161029 start charging/stop charging*/
static ssize_t show_StopCharging_Test(struct device *dev,struct device_attribute *attr, char *buf)
{
	...
	battery_charging_control(CHARGING_CMD_ENABLE,&charging_enable);
        BMT_status.ruin_stop = KAL_TRUE; //wt.guojunbo merged
...
static ssize_t show_StartCharging_Test(struct device *dev,struct device_attribute *attr, char *buf)
{
	...
	unsigned int charging_enable = KAL_TRUE;
        BMT_status.ruin_stop = KAL_FALSE;//wt.guojunbo merged
...
/*Other, sunxuebin.wt add end*/
//Other baidabin.wt add 20161125 get Fg Current
/* ///////////////////////////////////////////////////////////////////////////////////////// */
...
/*+Other_platform_modify  sunxuebin.wt  ADD 20161029  ui_soc sync full in charging*/
			...
			/*Other_huawei_req	sunxuebin.wt  ADD 20161029 add ui_soc cannot fall down when charging*/
...
static void battery_update(struct battery_data *bat_data)
{
	...
	if (resetBatteryMeter == KAL_TRUE) {
		...
		if (BMT_status.bat_full == KAL_TRUE && is_uisoc_ever_100 == KAL_TRUE && BMT_status.ruin_stop != KAL_TRUE) { //wt.guojunbo merged
			BMT_status.UI_SOC = 100;
...
static int battery_probe(struct platform_device *dev)
{
	...
	/* For EM */
	{
		...
		/*Other sunxuebin.wt add 20170224 for runin start*/
		...
		/*Other sunxuebin.wt add 20170224 for runin end*/
}
	...
	BMT_status.charger_exist = KAL_FALSE;	/* for default, no charger */
        BMT_status.ruin_stop = KAL_FALSE; //wt.guojunbo mergerd
