...
int g_Q_MAX[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	/*bat1,   bat2,   bat3,    bat4*/
	{ 4850, 5013, 2490, 1965},/*T0*/
	{ 4909, 5069, 2468, 1984},/*T1*/
	{ 4900, 4967, 2310, 1946},/*T2*/
	{ 4927, 4839, 1858, 1873},/*T3*/
	{ 4609, 4335, 1843, 1851},/*T4*/
...
int g_Q_MAX_H_CURRENT[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	/*bat1,   bat2,   bat3,    bat4*/
	{ 4900, 4997, 2190, 1665},/*T0*/
	{ 4959, 5047, 2168, 1684},/*T1*/
	{ 4950, 4873, 2010, 1646},/*T2*/
	{ 4935, 4359, 1558, 1573},/*T3*/
	{ 4659, 3121, 1543, 1551},/*T4*/
...
/* T0 */
struct fuelgauge_profile_struct fg_profile_t0[TOTAL_BATTERY_NUMBER][102] = {
	{
		{0    , 44050, 900 },
		{500  , 43920, 900 },
		{1000 , 43800, 900 },
...
/* T1 */
struct fuelgauge_profile_struct fg_profile_t1[TOTAL_BATTERY_NUMBER][103] = {
	{
		{0    ,	44150, 1030},
		{501  ,	44020, 1025},
		{1002 ,	43910, 1025},
...
/* T2 */
struct fuelgauge_profile_struct fg_profile_t2[TOTAL_BATTERY_NUMBER][103] = {
	{
		{0    ,	44090, 1580},
		{500  , 43980, 1575},
		{1000 ,	43880, 1575},
...
/* T3 */
struct fuelgauge_profile_struct fg_profile_t3[TOTAL_BATTERY_NUMBER][103] = {
	{
		{0    ,	44140, 2180},
		{501  , 44010, 2175},
		{1002 ,	43900, 2200},
...
/* T4 */
struct fuelgauge_profile_struct fg_profile_t4[TOTAL_BATTERY_NUMBER][103] = {
	{
		{0    ,	44180, 3600},
		{501  ,	43450, 2075},
		{1002 ,	43180, 1750},
