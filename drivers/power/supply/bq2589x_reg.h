...
enum tcpc_attach_type {
	TCPC_ATTACH_TYPE_NONE,
	TCPC_ATTACH_TYPE_PWR_RDY,
	TCPC_ATTACH_TYPE_TYPEC,
	TCPC_ATTACH_TYPE_PD,
	TCPC_ATTACH_TYPE_PD_SDP,
	TCPC_ATTACH_TYPE_PD_DCP,
	TCPC_ATTACH_TYPE_PD_NONSTD,
};
