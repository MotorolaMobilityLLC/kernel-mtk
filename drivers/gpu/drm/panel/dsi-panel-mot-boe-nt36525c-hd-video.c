...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0x89, 0xDD);
	lcm_dcs_write_seq_static(ctx, 0x8A, 0xDD);
	lcm_dcs_write_seq_static(ctx, 0x8B, 0xDD);
	lcm_dcs_write_seq_static(ctx, 0x8C, 0xDD);
	lcm_dcs_write_seq_static(ctx, 0x8D, 0xDD);
	lcm_dcs_write_seq_static(ctx, 0x8E, 0xDD);
	lcm_dcs_write_seq_static(ctx, 0x94, 0xC0);
	lcm_dcs_write_seq_static(ctx, 0x95, 0x09);
	lcm_dcs_write_seq_static(ctx, 0x96, 0x1D);
	...
	lcm_dcs_write_seq_static(ctx, 0x01, 0x21);
	lcm_dcs_write_seq_static(ctx, 0x02, 0x1D);
	...
	lcm_dcs_write_seq_static(ctx, 0x0A, 0x1C);
	...
	lcm_dcs_write_seq_static(ctx, 0x18, 0x1D);
	...
	lcm_dcs_write_seq_static(ctx, 0x33, 0x0A);
	...
	lcm_dcs_write_seq_static(ctx, 0x3B, 0x7B);
	...
	lcm_dcs_write_seq_static(ctx, 0x5C, 0x88);
	...
	lcm_dcs_write_seq_static(ctx, 0x82, 0x0E);
	...
	lcm_dcs_write_seq_static(ctx, 0x89, 0x40);
	lcm_dcs_write_seq_static(ctx, 0x8A, 0x8F);
	lcm_dcs_write_seq_static(ctx, 0x8D, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x8E, 0x0F);
	lcm_dcs_write_seq_static(ctx, 0x91, 0x40);
	lcm_dcs_write_seq_static(ctx, 0x92, 0x90);
	...
	lcm_dcs_write_seq_static(ctx, 0xB1, 0x8C);
	...
	lcm_dcs_write_seq_static(ctx, 0x0B, 0xBC);
	...
	lcm_dcs_write_seq_static(ctx, 0xC6, 0x92);
	...
	lcm_dcs_write_seq_static(ctx, 0xD6, 0x1C);
	...
	lcm_dcs_write_seq_static(ctx, 0xFB, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x13, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x14, 0x55);
	lcm_dcs_write_seq_static(ctx, 0x15, 0xB4);
	lcm_dcs_write_seq_static(ctx, 0x1F, 0x55);
	lcm_dcs_write_seq_static(ctx, 0x26, 0x0F);
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x19);
	lcm_dcs_write_seq_static(ctx, 0xC1, 0x3A);
	lcm_dcs_write_seq_static(ctx, 0xC7, 0x03);
	lcm_dcs_write_seq_static(ctx, 0xC2, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xC3, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xC4, 0x3A);
	lcm_dcs_write_seq_static(ctx, 0xC5, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xC6, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xFF, 0x20);
	lcm_dcs_write_seq_static(ctx, 0xFB, 0x01);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x00, 0x15, 0x00, 0x16, 0x00,
		0x3D, 0x00, 0x52, 0x00, 0x67, 0x00, 0x78, 0x00, 0x89, 0x00,
		0x98);
	lcm_dcs_write_seq_static(ctx, 0xB1, 0x00, 0xA7, 0x00, 0xD9, 0x01,
		0x01, 0x01, 0x40, 0x01, 0x6F, 0x01, 0xBD, 0x01, 0xFA, 0x01,
		0xFC);
	lcm_dcs_write_seq_static(ctx, 0xB2, 0x02, 0x3B, 0x02, 0x80, 0x02,
		0xAE, 0x02, 0xE5, 0x03, 0x0C, 0x03, 0x39, 0x03, 0x49, 0x03,
		0x59);
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x03, 0x6B, 0x03, 0x82, 0x03,
		0x9F, 0x03, 0xC1, 0x03, 0xDC, 0x03, 0xE0, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB4, 0x00, 0x15, 0x00, 0x16, 0x00,
		0x3D, 0x00, 0x52, 0x00, 0x67, 0x00, 0x78, 0x00, 0x89, 0x00,
		0x98);
	lcm_dcs_write_seq_static(ctx, 0xB5, 0x00, 0xA7, 0x00, 0xD9, 0x01,
		0x01, 0x01, 0x40, 0x01, 0x6F, 0x01, 0xBD, 0x01, 0xFA, 0x01,
		0xFC);
	lcm_dcs_write_seq_static(ctx, 0xB6, 0x02, 0x3B, 0x02, 0x80, 0x02,
		0xAE, 0x02, 0xE5, 0x03, 0x0C, 0x03, 0x39, 0x03, 0x49, 0x03,
		0x59);
	lcm_dcs_write_seq_static(ctx, 0xB7, 0x03, 0x6B, 0x03, 0x82, 0x03,
		0x9F, 0x03, 0xC1, 0x03, 0xDC, 0x03, 0xE0, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB8, 0x00, 0x15, 0x00, 0x16, 0x00,
		0x3D, 0x00, 0x52, 0x00, 0x67, 0x00, 0x78, 0x00, 0x89, 0x00,
		0x98);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x00, 0xA7, 0x00, 0xD9, 0x01,
		0x01, 0x01, 0x40, 0x01, 0x6F, 0x01, 0xBD, 0x01, 0xFA, 0x01,
		0xFC);
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x02, 0x3B, 0x02, 0x80, 0x02,
		0xAE, 0x02, 0xE5, 0x03, 0x0C, 0x03, 0x39, 0x03, 0x49, 0x03,
		0x59);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x03, 0x6B, 0x03, 0x82, 0x03,
		0x9F, 0x03, 0xC1, 0x03, 0xDC, 0x03, 0xE0, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xFF, 0x21);
	lcm_dcs_write_seq_static(ctx, 0xFB, 0x01);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x00, 0x0D, 0x00, 0x0E, 0x00,
		0x35, 0x00, 0x4A, 0x00, 0x5F, 0x00, 0x70, 0x00, 0x81, 0x00,
		0x90);
	lcm_dcs_write_seq_static(ctx, 0xB1, 0x00, 0x9F, 0x00, 0xD1, 0x00,
		0xF9, 0x01, 0x38, 0x01, 0x67, 0x01, 0xB5, 0x01, 0xF2, 0x01,
		0xF4);
	lcm_dcs_write_seq_static(ctx, 0xB2, 0x02, 0x33, 0x02, 0x78, 0x02,
		0xA6, 0x02, 0xDD, 0x03, 0x04, 0x03, 0x31, 0x03, 0x41, 0x03,
		0x51);
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x03, 0x63, 0x03, 0x7A, 0x03,
		0x97, 0x03, 0xB9, 0x03, 0xD4, 0x03, 0xD8, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB4, 0x00, 0x0D, 0x00, 0x0E, 0x00,
		0x35, 0x00, 0x4A, 0x00, 0x5F, 0x00, 0x70, 0x00, 0x81, 0x00,
		0x90);
	lcm_dcs_write_seq_static(ctx, 0xB5, 0x00, 0x9F, 0x00, 0xD1, 0x00,
		0xF9, 0x01, 0x38, 0x01, 0x67, 0x01, 0xB5, 0x01, 0xF2, 0x01,
		0xF4);
	lcm_dcs_write_seq_static(ctx, 0xB6, 0x02, 0x33, 0x02, 0x78, 0x02,
		0xA6, 0x02, 0xDD, 0x03, 0x04, 0x03, 0x31, 0x03, 0x41, 0x03,
		0x51);
	lcm_dcs_write_seq_static(ctx, 0xB7, 0x03, 0x63, 0x03, 0x7A, 0x03,
		0x97, 0x03, 0xB9, 0x03, 0xD4, 0x03, 0xD8, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB8, 0x00, 0x0D, 0x00, 0x0E, 0x00,
		0x35, 0x00, 0x4A, 0x00, 0x5F, 0x00, 0x70, 0x00, 0x81, 0x00,
		0x90);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x00, 0x9F, 0x00, 0xD1, 0x00,
		0xF9, 0x01, 0x38, 0x01, 0x67, 0x01, 0xB5, 0x01, 0xF2, 0x01,
		0xF4);
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x02, 0x33, 0x02, 0x78, 0x02,
		0xA6, 0x02, 0xDD, 0x03, 0x04, 0x03, 0x31, 0x03, 0x41, 0x03,
		0x51);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x03, 0x63, 0x03, 0x7A, 0x03,
		0x97, 0x03, 0xB9, 0x03, 0xD4, 0x03, 0xD8, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xFF, 0x23);
	lcm_dcs_write_seq_static(ctx, 0xFB, 0x01);
	...
	lcm_dcs_write_seq_static(ctx, 0x09, 0xE4);
...
static int lcm_get_modes(struct drm_panel *panel)
{
	...
	panel->connector->display_info.panel_id = 0x02015C71;
	strcpy(panel->connector->display_info.panel_name, "mipi_mot_vid_boe_hdp_653");
	strcpy(panel->connector->display_info.panel_supplier, "boe-nt36525c");
...
MODULE_DESCRIPTION("nt36525c boe VDO LCD Panel Driver");
