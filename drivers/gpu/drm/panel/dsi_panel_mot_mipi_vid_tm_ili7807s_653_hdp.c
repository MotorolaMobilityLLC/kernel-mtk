...
#include "include/dsi_panel_mot_mipi_vid_tm_ili7807s_653_hdp.h"
#endif
...
static int csot_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("%s+ tianma,ili7807s,incell,90hz,hdplus1600\n", __func__);
	...
	pr_info("[%d  %s]- tianma,ili7807s,incell,90hz,hdplus1600  ret:%d  \n", __LINE__, __func__,ret);
