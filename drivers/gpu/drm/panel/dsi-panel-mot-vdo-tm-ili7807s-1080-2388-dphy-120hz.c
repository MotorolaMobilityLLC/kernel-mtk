...
#include "include/dsi-panel-mot-vdo-tm-ili7807s-1080-2388-dphy-120hz.h"
#endif
...
static void tianma_panel_init(struct tianma *ctx)
{
	...
	pr_info("tm ili7807s init start!\n");
	...
	tianma_dcs_write_seq_static(ctx,0xFF, 0x78,0x07,0x04);
	tianma_dcs_write_seq_static(ctx,0xBD, 0x01);
	tianma_dcs_write_seq_static(ctx,0xFF, 0x78,0x07,0x05);
	tianma_dcs_write_seq_static(ctx,0xB5, 0x50);
	tianma_dcs_write_seq_static(ctx,0xB7, 0x70);
...
static struct mtk_panel_params ext_params_mode_60 = {
	...
	.lcm_cellid = {
		...
		//.page_table[0] = {0x39, 0x04, 0xFF, 0x78, 0x07, 0x0B},
		//.page_post_table[0] = {0x39, 0x04, 0xFF, 0x78, 0x07, 0x00},
		.page_table = {
			{0x39, 0x04, 0xFF, 0x78, 0x07, 0x0B},
		},
		.page_post_table = {
			{0x39, 0x04, 0xFF, 0x78, 0x07, 0x00},
		},
	},
	.panel_ver = 1,
	//.panel_id = 0x01050791,
...
static int tianma_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("[%d  %s]- tm,ili7807s,vdo,120hz ret:%d\n", __LINE__, __func__,ret);
...
static struct mipi_dsi_driver tianma_driver = {
	...
	.driver = {
		.name = "tm_ili7807s_vdo_1080_2388",
		.owner = THIS_MODULE,
