...
static void tianma_panel_init(struct tianma *ctx)
{
	...
	pr_info("tm ili7807s init start!\n");
        ...
        tianma_dcs_write_seq_static(ctx, 0x01, 0xD2);
        tianma_dcs_write_seq_static(ctx, 0x02, 0x3F);
        tianma_dcs_write_seq_static(ctx, 0x03, 0xD3);
        ...
        tianma_dcs_write_seq_static(ctx, 0xFF, 0x78,0x07,0x06);
        tianma_dcs_write_seq_static(ctx, 0x8D, 0xD8);
        tianma_dcs_write_seq_static(ctx, 0xFF, 0x78,0x07,0x00);	
        msleep(65);
...
static struct mtk_panel_params ext_params_mode_60 = {
	...
	.panel_ver = 1,
	//.panel_id = 0x01050791,
	.panel_name = "tm_ili7807s_vid_1080_2388",
	.panel_supplier = "tm",
	.lcm_index = 0,
...
static struct mipi_dsi_driver tianma_driver = {
	...
	.driver = {
		.name = "tm_ili7807s_vid_1080_2388",
		.owner = THIS_MODULE,
