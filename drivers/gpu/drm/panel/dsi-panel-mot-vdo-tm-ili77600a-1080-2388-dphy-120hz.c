...
#include "include/dsi-panel-mot-vdo-tm-ili77600a-1080-2388-dphy-120hz.h"
#endif
...
static void tianma_panel_init(struct tianma *ctx)
{
	...
	pr_info("tm ili77600a init start!\n");
	...
	tianma_dcs_write_seq_static(ctx,0xFF, 0x5A,0xA5,0x02);
        ...
        tianma_dcs_write_seq_static(ctx,0x76, 0x13);
        tianma_dcs_write_seq_static(ctx,0x79, 0x00);
        tianma_dcs_write_seq_static(ctx,0xF4, 0xFC);
        tianma_dcs_write_seq_static(ctx,0xF5, 0xFC);
        tianma_dcs_write_seq_static(ctx,0xF6, 0xFC);
        tianma_dcs_write_seq_static(ctx,0xF7, 0xFC);
...
static struct mtk_panel_params ext_params_mode_60 = {
	...
	.panel_ver = 1,
	//.panel_id = 0x01050791,
	.panel_name = "tm_ili77600a_vid_1080_2388",
	.panel_supplier = "tm",
	.lcm_index = 2,
...
static int tianma_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("[%d  %s]- tm,ili77600a,vdo,120hz ret:%d\n", __LINE__, __func__,ret);
...
static struct mipi_dsi_driver tianma_driver = {
	...
	.driver = {
		.name = "tm_ili77600a_vid_1080_2388",
		.owner = THIS_MODULE,
