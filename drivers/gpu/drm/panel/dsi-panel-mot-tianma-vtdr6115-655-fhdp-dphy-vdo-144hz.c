...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	if (ctx->version == PANEL_V1) {
		...
		lcm_dcs_write_seq_static(ctx, 0xD0, 0x84,0x35,0x50,0x14,0x20,0x00,0x29,0x07,0x1d,0x19,0x00,0x00,0x07,0x1d,0x1a,0x00,0x00,0x0b,0x05,0x05,0x1d,0x1d);//swire pulse:ELVSS 30pulse-normal 24pulse-HBM		
	}
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-tianma-vtdr6115-vdo-144hz",
		.owner = THIS_MODULE,
