...
if(ctx->version <= PANEL_DVT1) {//dvt1 or before
	...
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xC1, 0x04, 0x47);
...
//MIPI Gatting Error
	...
	//T1A
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xF0, 0xAA, 0x10);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xB1, 0x01, 0x6B, 0x00, 0x18, 0x00, 0x54, 0x00, 0x01, 0xB5, 0x00, 0x18, 0x00, 0x54, 0x00, 0x01, 0xB5, 0x00, 0x18, 0x04, 0x14, 0x00, 0x01, 0xB5, 0x00, 0x18, 0x0B, 0x94, 0x00, 0x00, 0x14, 0x00, 0x4C, 0x00, 0x14, 0x00, 0x4C, 0x00, 0x14, 0x03, 0x7C, 0x00, 0x14, 0x09, 0xDC);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xB2, 0x01, 0xB5, 0x00, 0x18, 0x00, 0x54, 0x03, 0x01, 0xB5, 0x00, 0x18, 0x00, 0x54, 0x03, 0x01, 0xB5, 0x00, 0x18, 0x00, 0x54, 0x03, 0x00, 0x14, 0x00, 0x4C, 0x00, 0x14, 0x00, 0x4C, 0x00, 0x14, 0x00, 0x4C);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xF0, 0xAA, 0x14);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xCC, 0x00, 0x11, 0x00, 0x04, 0x00, 0x11, 0x00, 0x05, 0x00, 0x11, 0x00, 0x05, 0x00, 0x11, 0x00, 0x05, 0x00, 0x11, 0x00, 0x05, 0x00, 0x11, 0x00, 0x05, 0x00, 0x11, 0x00, 0x05);
	//OTK4
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xF0, 0xAA, 0x14);
	...
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xCA, 0x03, 0xBA, 0x04, 0x68, 0x04, 0x68, 0x04, 0x68, 0x02, 0xF2, 0x03, 0xA0, 0x03, 0xA0, 0x03, 0xA0);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0x65, 0x34);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xCA, 0x04, 0x68, 0x04, 0x68, 0x04, 0x68, 0x03, 0xA0, 0x03, 0xA0, 0x03, 0xA0);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0x65, 0x66);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xCA, 0x03, 0xA6, 0x04, 0x54, 0x04, 0x54, 0x04, 0x54, 0x03, 0x06, 0x03, 0xB4, 0x03, 0xB4, 0x03, 0xB4);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0x65, 0x76);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xCA, 0x04, 0x54, 0x04, 0x54, 0x04, 0x54, 0x03, 0xB4, 0x03, 0xB4, 0x03, 0xB4);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0x65, 0x14);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xCA, 0x03, 0x5E, 0x04, 0x0C, 0x04, 0x0C, 0x04, 0x0C, 0x03, 0x4E, 0x03, 0xFC, 0x03, 0xFC, 0x03, 0xFC);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0x65, 0x40);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xCA, 0x04, 0x0C, 0x04, 0x0C, 0x04, 0x0C, 0x03, 0xFC, 0x03, 0xFC, 0x03, 0xFC);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0x65, 0x24);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xCA, 0x00, 0xD8, 0x01, 0x04, 0x01, 0x04, 0x01, 0x04, 0x00, 0xD2, 0x00, 0xFE, 0x00, 0xFE, 0x00, 0xFE);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0x65, 0x4C);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xCA, 0x01, 0x04, 0x01, 0x04, 0x01, 0x04, 0x00, 0xFE, 0x00, 0xFE, 0x00, 0xFE);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0x65, 0x58);
	csot_vtdr6126A_dcs_write_seq_static(ctx, 0xCA, 0x01, 0xAB, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02);
...
static int panel_dc_set_cmdq(struct csot_vtdr6126A *ctx, void *dsi, dcs_grp_write_gce cb, void *handle, uint32_t dc_state)
{
	unsigned int para_count = 0;
...
static int panel_ripple_set_cmdq(struct csot_vtdr6126A *ctx, void *dsi, dcs_grp_write_gce cb, void *handle, uint32_t dc_state)
{
	unsigned int para_count = 0;
