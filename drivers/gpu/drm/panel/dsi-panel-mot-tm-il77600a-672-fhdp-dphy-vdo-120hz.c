...
#include "include/dsi-panel-mot-tm-il77600a-672-fhdp-dphy-vdo-120hz.h"
#endif
...
static struct mtk_panel_params ext_params = {
	...
	.panel_ver = 1,
	.panel_id = 0x10050a91,
	.panel_name = "tm_il77600a_vid_672_1080",
	.panel_supplier = "tm",
	.lcm_index = 0,
...
static int tianma_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("%s+ disp:tm,il77600a,672,vdo,120hz\n", __func__);
	...
	pr_info("[%d  %s]- tm,il77600a,672,vdo,120hz ret:%d\n", __LINE__, __func__,ret);
...
static const struct of_device_id tianma_of_match[] = {
	{
		.compatible = "tm,il77600a,672,vdo,120hz",
	},
	{}
};
...
MODULE_DESCRIPTION("tm il77600a incell 120hz Panel Driver");
