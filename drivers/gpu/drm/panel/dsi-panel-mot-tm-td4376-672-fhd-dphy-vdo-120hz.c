...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x00, 0x51, 0x01, 0x2C, 0x08, 0x09, 0x60, 0x00, 0x0C);
...
{
	struct lcm *ctx = panel_to_tm(panel);
	int ret = -1;
...
#endif
	pr_info("[%d  %s]- tm,td4376,672,vdo,120hz ret:%d  \n", __LINE__, __func__,ret);
