...
static void tianma_panel_init(struct tianma *ctx)
{
	...
	tianma_dcs_write_seq_static(ctx, 0xC1,0x00,0x20,0x26,0x6E,0x02,0x1C,0x1C,0x04,0x60,0x19,0x22,0x31);
...
static int pane_cabc_set_cmdq(struct tianma *ctx, void *dsi, dcs_grp_write_gce cb, void *handle, uint32_t hbm_state)
{
	...
	struct mtk_panel_para_table cabc_mv_table[7] = {
		...
		{3, {0xF0,0x5A,0x59}},
		{3, {0xF1,0xA5,0xA6}},
		{33, {0xE7,0x30,0x00,0x40,0x00,0x01,0x1F,0x20,0x42,0x1F,0xA0,0x24,0xCC,0x01,0x00,0x00,0x30,0x18,0x15,0x00,0xA8,0xFF,0xFF,0xF0,0xF0,0xF0,0xF0,0xF0,0xFF,0xF5,0xF8,0xFB,0xFF}},
