...
static void csot_panel_init(struct csot *ctx)
{
	...
	if (PANEL_V0 == ctx->version) {
		...
		csot_dcs_write_seq_static(ctx,0xCF,0x78);
		csot_dcs_write_seq_static(ctx,0x00,0x80);
		csot_dcs_write_seq_static(ctx,0xCC,0x03,0x07,0x09,0x0B,0x0D,0x24,0x2C,0x22,0x2C,0x24,0x26,0x25,0x2C,0x1B,0x1A,0x19);
		csot_dcs_write_seq_static(ctx,0x00,0x80);
		csot_dcs_write_seq_static(ctx,0xCD,0x02,0x06,0x08,0x0A,0x0C,0x24,0x2C,0x22,0x2C,0x24,0x26,0x25,0x2C,0x1B,0x1A,0x19);
		csot_dcs_write_seq_static(ctx,0x00,0xA0);
		csot_dcs_write_seq_static(ctx,0xCC,0x02,0x08,0x06,0x0C,0x0A,0x22,0x2C,0x24,0x2C,0x24,0x26,0x25,0x2C,0x1B,0x1A,0x19);
		csot_dcs_write_seq_static(ctx,0x00,0xA0);
		csot_dcs_write_seq_static(ctx,0xCD,0x03,0x09,0x07,0x0D,0x0B,0x22,0x2C,0x24,0x2C,0x24,0x26,0x25,0x2C,0x1B,0x1A,0x19);
		...
		csot_dcs_write_seq_static(ctx,0xCE,0x00,0x00,0x00,0x00,0x12,0x04);
		csot_dcs_write_seq_static(ctx,0x00,0x80);
		csot_dcs_write_seq_static(ctx,0xA4,0xCA);
		csot_dcs_write_seq_static(ctx,0x00,0x00);
		csot_dcs_write_seq_static(ctx,0xE1,0x05,0x06,0x09,0x0F,0x55,0x19,0x21,0x27,0x31,0x8B,0x39,0x40,0x46,0x4B,0xE7,0x50,0x58,0x60,0x67,0x60,0x6E,0x75,0x7D,0x85,0x13,0x8F,0x96,0x9C,0xA4,0xCC,0xAD,0xB8,0xC7,0xD0,0x62,0xDC,0xEC,0xF8,0xFF,0x5F);
		...
		csot_dcs_write_seq_static(ctx,0xE1,0x05,0x06,0x09,0x0F,0x55,0x19,0x21,0x27,0x31,0x8B,0x39,0x40,0x46,0x4B,0xE7,0x50);
		csot_dcs_write_seq_static(ctx,0x00,0x00);
		csot_dcs_write_seq_static(ctx,0xE2,0x58,0x60,0x67,0x60,0x6E,0x75,0x7D,0x85,0x13,0x8F,0x96,0x9C,0xA4,0xCC,0xAD,0xB8,0xC7,0xD0,0x62,0xDC,0xEC,0xF8,0xFF,0x5F);
		csot_dcs_write_seq_static(ctx,0x00,0x20);
		csot_dcs_write_seq_static(ctx,0xE4,0x00,0xAA,0xA8,0x00,0x00,0x00,0x00,0x00);
		csot_dcs_write_seq_static(ctx,0x00,0x30);
		csot_dcs_write_seq_static(ctx,0xE4,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
		csot_dcs_write_seq_static(ctx,0x00,0x90);
