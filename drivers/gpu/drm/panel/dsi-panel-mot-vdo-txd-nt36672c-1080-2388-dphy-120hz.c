...
/*BIST START
	tongxd_dcs_write_seq_static(ctx,0xFF, 0x20);
	tongxd_dcs_write_seq_static(ctx,0xFB, 0x01);
	tongxd_dcs_write_seq_static(ctx,0x74, 0x00);
	tongxd_dcs_write_seq_static(ctx,0x75, 0x00);
	tongxd_dcs_write_seq_static(ctx,0x76, 0x00);
	tongxd_dcs_write_seq_static(ctx,0x77, 0x01);
	tongxd_dcs_write_seq_static(ctx,0x78, 0x00);
	tongxd_dcs_write_seq_static(ctx,0x79, 0x00);
	tongxd_dcs_write_seq_static(ctx,0x7A, 0x00);
	tongxd_dcs_write_seq_static(ctx,0x7B, 0x00);
	tongxd_dcs_write_seq_static(ctx,0x86, 0x03);
BIST END*/

	tongxd_dcs_write_seq_static(ctx,0xFF, 0x27);
	tongxd_dcs_write_seq_static(ctx,0xFB, 0x01);
	tongxd_dcs_write_seq_static(ctx,0x40, 0xC0);

	tongxd_dcs_write_seq_static(ctx,0xFF,0x10);
	tongxd_dcs_write_seq_static(ctx,0xFB,0x01);
	tongxd_dcs_write_seq_static(ctx,0x68,0x03,0x01);
	tongxd_dcs_write_seq_static(ctx,0x51,0x06,0x66); //max 0x07,0xFF
