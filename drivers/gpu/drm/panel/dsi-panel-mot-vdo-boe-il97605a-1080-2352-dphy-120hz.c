...
static void boe_il97605a_panel_init(struct boe_il97605a *ctx)
{
	...
	if (IS_ERR(ctx->reset_gpio)) {
	 ...
	 boe_il97605a_dcs_write_seq_static(ctx, 0xE9, 0x10,0x00);
	 ...
	 boe_il97605a_dcs_write_seq_static(ctx, 0xB3, 0x08);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xB4, 0x1D);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xB5, 0x00,0x70,0x00,0x70,0x00,0x5A,0x00,0x5A,0x00,0x5A,0x00,0x5A,0x00,0x5A,0x00,0x5A,0x00,0x5A,0x00,0x70);
	 ...
	 boe_il97605a_dcs_write_seq_static(ctx, 0xC0, 0x01,0x14);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xC2, 0x01,0x10);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xC3, 0x01,0x40);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xC4, 0x01,0x01);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xCC, 0x01,0x81);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xCD, 0x01,0x59);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xCE, 0x01,0x80);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xCF, 0x01,0xFB);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xD0, 0x01,0x81);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xD1, 0x01,0x1E);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xD2, 0x01,0x85);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xD3, 0x01,0x66);
	 ...
	 boe_il97605a_dcs_write_seq_static(ctx, 0xC2, 0x40);
	 //--page8--
...
static int panel_cabc_set_cmdq(struct boe_il97605a *ctx, void *dsi, dcs_grp_write_gce cb, void *handle, uint32_t cabc_mode)
{
