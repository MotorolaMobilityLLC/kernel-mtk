...
static struct mtk_panel_para_table panel_dc_off[] = {
	{4, {0xFF,0x5A,0xA5,0x4F}},
	{2, {0x80,0x01}},//CORE0_MFSC_EN (CMDQ_Core0 Start)
	{2, {0x81,0x03}},
	{2, {0x88,0x78}},
	{4, {0xFF,0x5A,0xA5,0x24}},
	{5, {0x88,0x05,0x34,0x12,0x67}},
	{4, {0xFF,0x5A,0xA5,0x24}},
	{2, {0x9D,0x0D}},
	{2, {0x9E,0xC0}},
	{4, {0xFF,0x5A,0xA5,0x23}},
	{2, {0x80,0x50}},
	{4, {0xFF,0x5A,0xA5,0x53}},//Demura-pwm Start
	{11, {0x95,0x00,0x00,0x00,0x03,0x12,0x00,0x00,0x00,0x00,0x00}},
	{21, {0xA5,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{21, {0xA6,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{21, {0xA7,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x20,0x20,0x20,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{11, {0xA8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xF0,0xF0,0xF0}},
	{4, {0xFF,0x5A,0xA5,0x4F}},//Demura-pwm end
	{2, {0x8B,0x78}},//cmd queue set all done
};
...
static struct mtk_panel_para_table panel_dc_on[] = {
	...
	{2, {0x80,0x90}},
	{4, {0xFF,0x5A,0xA5,0x53}},//Demura-pwm Start
	{11, {0x95,0x00,0x00,0x40,0x07,0x56,0x00,0x00,0x00,0x00,0x00}},
	{21, {0xA5,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{21, {0xA6,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x20,0x20,0x20,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{21, {0xA7,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{11, {0xA8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xF0,0xF0,0xF0}},
	{4, {0xFF,0x5A,0xA5,0x4F}},//Demura-pwm end
	{2, {0x8B,0x78}},//cmd queue set all done
};

static struct mtk_panel_para_table panel_dc_off_dvt2[] = {
	{4, {0xFF,0x5A,0xA5,0x4F}},
	{2, {0x80,0x01}},//CORE0_MFSC_EN (CMDQ_Core0 Start)
	{2, {0x81,0x03}},
	{2, {0x88,0x78}},
	...
	{4, {0xFF,0x5A,0xA5,0x53}},//Demura-pwm Start
	{11, {0x95,0x00,0x00,0x00,0x03,0x12,0x00,0x00,0x00,0x00,0x00}},
	{21, {0xA5,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{21, {0xA6,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{21, {0xA7,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x20,0x20,0x20,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{11, {0xA8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xF0,0xF0,0xF0}},
	{4, {0xFF,0x5A,0xA5,0x4F}},//Demura-pwm end
...
static struct mtk_panel_para_table panel_dc_on_dvt2[] = {
	{4, {0xFF,0x5A,0xA5,0x4F}},
	{2, {0x80,0x01}}, //CORE0_MFSC_EN (CMDQ_Core0 Start)
	{2, {0x81,0x03}},
	{2, {0x88,0x78}},
...
static void boe_il97605a_panel_init(struct boe_il97605a *ctx)
{
	...
	//Page CRC
	 ...
	 //--------------------//
	 boe_il97605a_dcs_write_seq_static(ctx, 0xFF, 0x5A,0xA5,0x1F);
	 boe_il97605a_dcs_write_seq_static(ctx, 0x8F, 0x0B, 0x19);
	 //trim osc
	 boe_il97605a_dcs_write_seq_static(ctx, 0xFF, 0x5A, 0xA5, 0x22);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xDC, 0x84, 0x94, 0xBB, 0x00, 0x20, 0x41, 0xB3, 0x00, 0x12, 0x00, 0xF8, 0x7F, 0x7F);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xE5, 0x84, 0x94, 0xBB, 0x00, 0x03, 0x66, 0x11, 0x20, 0x7F, 0x7F);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xE6, 0x84, 0x94, 0xBB, 0x00, 0x03, 0x66, 0x11, 0x20, 0x7F, 0x7F);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xE7, 0x84, 0x94, 0xBB, 0x00, 0xC1, 0x71, 0x00, 0x10, 0x7F, 0x7F);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xDD, 0x12);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xDE, 0xA0);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xDF, 0x01);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xE0, 0x02, 0x1F, 0xB8, 0x62, 0x00, 0x20);
	 boe_il97605a_dcs_write_seq_static(ctx, 0xE4, 0x00, 0x00, 0x00);
...
static int panel_dc_set_cmdq(struct boe_il97605a *ctx, void *dsi, dcs_grp_write_gce cb, void *handle, uint32_t dc_state)
{
	unsigned int para_count = 0;
	...
	if (dc_state) {
		if(ctx->version <= PANEL_DVT1) {//evt and dvt1
			...
			para_count = sizeof(panel_dc_on_dvt2) / sizeof(struct mtk_panel_para_table);
			pTable = panel_dc_on_dvt2;
		}
	}
	else {
		if(ctx->version <= PANEL_DVT1) {//evt and dvt1
			...
			para_count = sizeof(panel_dc_off_dvt2) / sizeof(struct mtk_panel_para_table);
			pTable = panel_dc_off_dvt2;
		}
	}
	cb(dsi, handle, pTable, para_count);
	pr_info("%s: panel_ver %d, current_fps %d, dc_state %d\n", __func__, ctx->version, atomic_read(&ctx->current_fps), dc_state);
	return 0;
}
...
static void lcm_parse_panel_version(struct boe_il97605a *ctx)
{
	int rc;
	struct device_node *chosen = of_find_node_by_name(NULL, "chosen");
	...
	if(chosen) {
		...
		if (!rc) {
			if (PANEL_EVB == tmp) {
				ctx->version = PANEL_EVB;
			} else if (PANEL_EVT == tmp) {
...
static int boe_il97605a_probe(struct mipi_dsi_device *dsi)
{
	...
	//parse panel version for evb/evt/dvt/pvt
