...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xD0, 0x84,0x15,0x50,0x14,0x20,0x00,0x39,0x0D,0x1D,0x19,0x00,0x00,0x0D,0x1D,0x19,0x00,0x00,0x09,0x05,0x05,0x1D,0x1D);//swire pulse:ELVSS 30pulse-normal 24pulse-HBM
...
#define HACT (1080)
#define VACT (2400)
#define DISP_CLOCK (413199)	//1176*2460*144
