...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x86,0x85,0x03,0x02,0x8B,0x8A,0x02,0x01,0x33,0x33,0x33,0x33,0x70,0x01,0x01,0x60,0x01,0x01,0x03,0x05,0x04,0x03,0x02,0x01,0x02,0x03,0x04,0x00,0x00);
	lcm_dcs_write_seq_static(ctx, 0xB1, 0x13,0x82,0x87,0x80,0x70,0x00,0x00,0x60,0x00,0x00,0x04,0x08,0x54,0x00,0x00,0x00,0x44,0x40,0x02,0x01,0x40,0x02,0x01,0x40,0x02,0x01,0x40,0x02,0x01,0x00,0x00,0x00);
	lcm_dcs_write_seq_static(ctx, 0xB2, 0x54,0xC4,0x82,0x05,0x40,0x02,0x01,0x40,0x02,0x01,0x05,0x05,0x54,0x0C,0x0C,0x0D,0x0B);
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x02,0x00,0x00,0x0F,0x0A,0x26,0x26,0x91,0xA2,0x33,0x44,0x00,0x26,0x00,0x88,0x01,0x02,0x08,0x20,0x30,0x08,0x09,0x44,0x20,0x40,0x20,0x40,0x08,0x09,0x22,0x33);
	lcm_dcs_write_seq_static(ctx, 0xB4, 0x00,0x1C,0x1C,0xDD,0x08,0xC8,0x00,0x00,0x04,0x16,0x14,0x12,0x10,0x0E,0x0C,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0xFC,0x00,0x00,0x00);
	lcm_dcs_write_seq_static(ctx, 0xB5, 0x00,0x1C,0x1C,0xDD,0x09,0xC9,0x00,0x00,0x05,0x17,0x15,0x13,0x11,0x0F,0x0D,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0xFC,0x00,0x00,0x00);
	...
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x84,0x84);
	...
	lcm_dcs_write_seq_static(ctx, 0xBE, 0x6E,0x78,0x50,0x32,0x0C,0x77,0x43,0x07,0x0E,0x0E);
	...
	lcm_dcs_write_seq_static(ctx, 0xC1, 0xC0,0x20,0x20,0x96,0x04,0x30,0x30,0x04,0x2A,0x40,0x36,0x00,0x07,0xC0,0x10,0xFF,0x7C,0x00,0xC0);
	...
	lcm_dcs_write_seq_static(ctx, 0xC5, 0x03,0x1C,0xC0,0xC0,0x40,0x10,0x42,0x84,0x08,0x14,0x26);
	lcm_dcs_write_seq_static(ctx, 0xC6, 0x87,0x95,0x22,0x29,0x29,0x33,0x64,0x24,0x08,0x04);
	lcm_dcs_write_seq_static(ctx, 0xC7, 0xF7,0xB0,0x88,0x6B,0x3D,0x1D,0xEF,0x45,0x15,0xEF,0xCA,0xA0,0xFC,0xD4,0xB5,0x8E,0x72,0x48,0x1A,0x7E,0xC0,0x00);
	lcm_dcs_write_seq_static(ctx, 0xC8, 0xF7,0xB0,0x88,0x6B,0x3D,0x1D,0xEF,0x45,0x15,0xEF,0xCA,0xA0,0xFC,0xD4,0xB5,0x8E,0x72,0x48,0x1A,0x7E,0xC0,0x00);
	lcm_dcs_write_seq_static(ctx, 0xC9, 0x45,0x00,0x1F,0xFF,0x3F,0x03);
	lcm_dcs_write_seq_static(ctx, 0xCB, 0x05,0x40,0x55,0x40,0x04,0x40,0x35,0x43,0x43,0x50,0x1E,0x40,0x40,0x43,0x43,0x64,0x23);
	lcm_dcs_write_seq_static(ctx, 0xD0, 0x80,0x0D,0xFF,0x0F,0x61,0x0B,0x08,0x0C);
	lcm_dcs_write_seq_static(ctx, 0xD2, 0x42,0x0C,0x30,0x01,0x80,0x26,0x04,0x00,0x00,0xC3,0x00,0x00,0x00,0x00,0x30);
	lcm_dcs_write_seq_static(ctx, 0xD7, 0xDF);
	lcm_dcs_write_seq_static(ctx, 0xE0, 0x30,0x00,0x20,0x18,0x01,0x1F,0x23,0x62,0xDF,0xA0,0x04,0xCC,0x01);
	...
	lcm_dcs_write_seq_static(ctx, 0x51, 0xFF,0x0E);
