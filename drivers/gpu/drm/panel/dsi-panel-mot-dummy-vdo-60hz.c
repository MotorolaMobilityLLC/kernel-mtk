...
static int dummy_panel_probe(struct mipi_dsi_device *dsi)
{
	...
	dsi->mode_flags = MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_VIDEO_SYNC_PULSE |
			MIPI_DSI_MODE_LPM | MIPI_DSI_MODE_NO_EOT_PACKET | //MIPI_DSI_MODE_EOT_PACKET
	...
	ctx->prepared = true;
	ctx->enabled = true;
	drm_panel_init(&ctx->panel, dev, &dummy_panel_drm_funcs, DRM_MODE_CONNECTOR_DSI);
