...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x00, 0x08, 0x01, 0x5F, 0x01, 0x5F, 0x02, 0xA4, 0x02, 0xA4, 0x03, 0xBB);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x0C);
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x03, 0xBB, 0x05, 0x2F, 0x05, 0x2F, 0x06, 0x91, 0x06, 0x91, 0x06, 0x92);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x18);
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x06, 0x92, 0x0A, 0x2F, 0x0A, 0x2F, 0x0D, 0xB9, 0x0D, 0xB9, 0x0F, 0xFF);
	...
	lcm_dcs_write_seq_static(ctx, 0xBC, 0x11, 0x00, 0x09, 0x51);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x04);
	lcm_dcs_write_seq_static(ctx, 0xBC, 0x00, 0x09, 0x51, 0x00, 0x09, 0x51, 0x00, 0x0B, 0x41);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x0D);
	lcm_dcs_write_seq_static(ctx, 0xBC, 0x00, 0x11, 0x51);
	/*source op to level6*/
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xC6, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66);
	...
	//FPR_CENTER_X/Y Local HBM圆心点坐标
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x88, 0x02, 0x1C, 0x08, 0x73);
	...
	lcm_dcs_write_seq_static(ctx, 0xE1, 0x00, 0x03, 0x03, 0x03, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xE3, 0x46, 0xCC, 0x11, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF0);
	lcm_dcs_write_seq_static(ctx, 0xE4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xE5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xE6, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xE7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x04);
	lcm_dcs_write_seq_static(ctx, 0xC1, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x0E, 0xB3, 0x21);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x08);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x03);
	lcm_dcs_write_seq_static(ctx, 0xC1, 0x03);
	lcm_dcs_write_seq_static(ctx, 0xCE, 0x22, 0x00, 0x00, 0x22, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	...
	//Data scaling（由32灰阶改为8灰阶）
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x08);
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x8F, 0x7F);

	//Demura
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x04);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x01);
	lcm_dcs_write_seq_static(ctx, 0xcb, 0x05, 0x0F, 0x1F, 0x7C, 0xD9, 0x00, 0x08, 0x03, 0xbb, 0x06, 0x91, 0x0a, 0x2f, 0x0d, 0xb9);

	//VDC
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x08);
	lcm_dcs_write_seq_static(ctx, 0xB6, 0x0F, 0xFE, 0x0F, 0xFE, 0x0F, 0xFE, 0x0F, 0xFE, 0x0F, 0xFE, 0x0F, 0xFE, 0x0F, 0xFE, 0x0F, 0xFE);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xB6, 0x0F, 0xFE, 0x0F, 0xFE, 0x0F, 0xFE, 0x0F, 0xFE, 0x0F, 0xFE, 0x0F, 0xFE, 0x0F, 0xFE, 0x0F, 0xFE);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x20);
	lcm_dcs_write_seq_static(ctx, 0xB6, 0x0F, 0xFE, 0x0F, 0xFE, 0x0F, 0xFE);
	lcm_dcs_write_seq_static(ctx, 0xB7, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xB7, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x20);
	lcm_dcs_write_seq_static(ctx, 0xB7, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB8, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xB8, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x20);
	lcm_dcs_write_seq_static(ctx, 0xB8, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x01, 0x01, 0x00, 0x91, 0x00, 0x38, 0x60, 0x00, 0x00, 0x00, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x03, 0x00, 0x0D, 0x00, 0x1F, 0x00, 0x3D, 0x00, 0x69, 0x00, 0xA7, 0x00, 0xFA, 0x01, 0x63, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x20);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0xE8, 0x02, 0x89, 0x03, 0x4B, 0x04, 0x30, 0x05, 0x3B, 0x06, 0x6F, 0x07, 0xD0, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x30);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x00, 0x00, 0x03, 0x00, 0x0D, 0x00, 0x1F, 0x00, 0x3D, 0x00, 0x69, 0x00, 0xA7, 0x00, 0xFA, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x40);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x63, 0x01, 0xE8, 0x02, 0x89, 0x03, 0x4B, 0x04, 0x30, 0x05, 0x3B, 0x06, 0x6F, 0x07, 0xD0, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x50);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x0D, 0x00, 0x1F, 0x00, 0x3D, 0x00, 0x69, 0x00, 0xA7, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x60);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0xFA, 0x01, 0x63, 0x01, 0xE8, 0x02, 0x89, 0x03, 0x4B, 0x04, 0x30, 0x05, 0x3B, 0x06, 0x6F, 0x07);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x70);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0xD0, 0x02, 0x00, 0x00, 0x00, 0x01, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x80);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x90);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0xA0);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0xB0);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0xC0);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0xD0);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0xE0);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0xF0);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80);
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x20);
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00);
	...
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x60);
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x70);
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x80);
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x90);
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00);
	...
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0xE0);
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x00, 0x72, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x20);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x01, 0x00, 0x01, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x30);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x01, 0x00, 0x01, 0x00, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x40);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x72);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x50);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72, 0x00, 0x72);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x60);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x70);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x80);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x01, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x90);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0A, 0x0A, 0x0B);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0xA0);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x9F, 0x9C, 0x88, 0x00, 0x00, 0x00, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xE9, 0x00, 0x00, 0x00, 0x34);
	lcm_dcs_write_seq_static(ctx, 0xEE, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xEE, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x0F, 0xFF);
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	if (stage == BEFORE_DSI_POWERDOWN) {
		...
		lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x08);
		lcm_dcs_write_seq_static(ctx, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE3, 0x48, 0xF3, 0x49, 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFC);
		lcm_dcs_write_seq_static(ctx, 0xE4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE6, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	if (stage == BEFORE_DSI_POWERDOWN) {
		...
		lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x08);
		lcm_dcs_write_seq_static(ctx, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE3, 0x94, 0x36, 0x53, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF);
		lcm_dcs_write_seq_static(ctx, 0xE4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE6, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	if (stage == BEFORE_DSI_POWERDOWN) {
		struct lcm *ctx = panel_to_lcm(panel);
                ...
                lcm_dcs_write_seq_static(ctx, 0, 0x39, 0x2F, 0x07);
		// FFD2.0 RGB OFS CTRL
		lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x08);
		lcm_dcs_write_seq_static(ctx, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE3, 0x25, 0xFE, 0xE1, 0x4F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x92);
		lcm_dcs_write_seq_static(ctx, 0xE4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE6, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	if (stage == BEFORE_DSI_POWERDOWN) {
		...
		lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x08);
		lcm_dcs_write_seq_static(ctx, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE3, 0xC0, 0x0E, 0xF3, 0x5D, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x98);
		lcm_dcs_write_seq_static(ctx, 0xE4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE6, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		lcm_dcs_write_seq_static(ctx, 0xE7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
		...
		lcm_dcs_write_seq_static(ctx, 0xCE, 0x22, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("%s- lcm,nt37701,cmd,120hz, lhbm_en = %d\n", __func__, ctx->lhbm_en);
...
static const struct of_device_id lcm_of_match[] = {
	{
		.compatible = "tianma,nt37701,cmd,144hz,rode",
	},
	{}
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-tianma-nt37701a-cmd-144hz-rode",
		.owner = THIS_MODULE,
