...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	/* dc off*/
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB2, 0x18);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x0F);
	lcm_dcs_write_seq_static(ctx, 0xB2, 0x60, 0x50, 0x65, 0xE9, 0x85, 0xE9, 0x2F, 0xFF);
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x00, 0x01, 0x01, 0x59, 0x01, 0x59, 0x02, 0x1A, 0x02, 0x1A, 0x03, 0x0A);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x0C);
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x03, 0x0A, 0x04, 0x00, 0x04, 0x00, 0x05, 0xE9, 0x05, 0xE9, 0x05, 0xEA);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x18);
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x05, 0xEA, 0x09, 0x08, 0x09, 0x08, 0x0D, 0xBB, 0x0D, 0xBB, 0x0F, 0xFF);
	lcm_dcs_write_seq_static(ctx, 0x58, 0x00);

	/*Fcon setting*/
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x1C);
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x03, 0x14, 0x25, 0xA9, 0x78);

	/*Corner&Hole page0*/
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xFF, 0xAA, 0x55, 0xA5, 0x80);
	...
	lcm_dcs_write_seq_static(ctx, 0x2F, 0x03);//60HZ
...
static struct LCM_setting_table panel_dc_off[] = {
	...
	{REGFLAG_CMD, 2, {0xB2, 0x18}},
	{REGFLAG_CMD, 2, {0x6F, 0x0F}},
	{REGFLAG_CMD, 9, {0xB2, 0x60, 0x50, 0x65, 0xE9, 0x85, 0xE9, 0x2F, 0xFF}},
	{REGFLAG_CMD, 13, {0xB3, 0x00, 0x01, 0x01, 0x59, 0x01, 0x59, 0x02, 0x1A, 0x02, 0x1A, 0x03, 0x0A}},
	{REGFLAG_CMD, 2, {0x6F, 0x0C}},
	{REGFLAG_CMD, 13, {0xB3, 0x03, 0x0A, 0x04, 0x00, 0x04, 0x00, 0x05, 0xE9, 0x05, 0xE9, 0x05, 0xEA}},
	{REGFLAG_CMD, 2, {0x6F, 0x18}},
	{REGFLAG_CMD, 13, {0xB3, 0x05, 0xEA, 0x09, 0x08, 0x09, 0x08, 0x0D, 0xBB, 0x0D, 0xBB, 0x0F, 0xFF}},
...
static struct LCM_setting_table panel_dc_on[] = {
	{REGFLAG_CMD, 6, {0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00}},
	{REGFLAG_CMD, 2, {0xB2, 98}},
	{REGFLAG_CMD, 2, {0x6F, 0x0F}},
	{REGFLAG_CMD, 9, {0xB2, 0x60, 0x50, 0x60, 0x00, 0x80, 0x00, 0x2F, 0xFF}},
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("%s- lcm,csot,nt37701,cmd,120hz\n", __func__);
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-csot-nt37701a-cmd-144hz",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("CSOT nt37701 AMOLED CMD SPR LCD Panel Driver");
