...
KBUILD_CFLAGS += -DJOURNEY_FEATURE_LOG_AEE_NO_RESERVED
endif

ifeq ($(JOURNEY_FEATURE_USE_RESERVED_DISK), yes)
KBUILD_CFLAGS += -DJOURNEY_FEATURE_USE_RESERVED_DISK
endif

ifeq ($(JOURNEY_FEATURE_FSTRIM), yes)
KBUILD_CFLAGS += -DJOURNEY_FEATURE_FSTRIM
endif
...
LINUXINCLUDE    += -I$(srctree)/../kernel-4.4/tinno/common_features/
