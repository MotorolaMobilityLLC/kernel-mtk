...
#define OFFSET_MSDC_PATCH_BIT2					0x000000B8
#define OFFSET_MSDC_IOCON					0x00000004
#define OFFSET_MSDC_PAD_TUNE0					0x000000F0
#define OFFSET_MSDC_PAD_TUNE1					0x000000F4
#define OFFSET_MSDC_DAT_RDDLY0					0x000000F8
#define OFFSET_MSDC_DAT_RDDLY1					0x000000FC
...
#define MSDC_DAT_RDDLY0_ALL	(MSDC_DAT_RDDLY0_D0 | MSDC_DAT_RDDLY0_D1 | MSDC_DAT_RDDLY0_D2 | MSDC_DAT_RDDLY0_D3)
#define MSDC_DAT_RDDLY1_ALL	(MSDC_DAT_RDDLY0_D0 | MSDC_DAT_RDDLY0_D1 | MSDC_DAT_RDDLY0_D2 | MSDC_DAT_RDDLY0_D3)
...
#define MSDC_MASK_ALL	(0xffffffff)
