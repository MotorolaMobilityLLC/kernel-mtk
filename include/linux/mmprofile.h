...
static MMP_Event MMProfileRegisterEvent(MMP_Event parent, const char *name)
{
	return 0;
}

static MMP_Event MMProfileFindEvent(MMP_Event parent, const char *name)
{
	return 0;
}

static void MMProfileEnableEvent(MMP_Event event, long enable)
{
}

static void MMProfileEnableEventRecursive(MMP_Event event, long enable)
{
}

static void MMProfileEnableFTraceEvent(MMP_Event event, long enable, long ftrace)
{
}

static void MMProfileEnableFTraceEventRecursive(MMP_Event event, long enable, long ftrace)
{
}

static long MMProfileQueryEnable(MMP_Event event)
{
	return 0;
}

static void MMProfileLogEx(MMP_Event event, MMP_LogType type, unsigned long data1, unsigned long data2)
{
}

static void MMProfileLog(MMP_Event event, MMP_LogType type)
{
}

static long MMProfileLogMeta(MMP_Event event, MMP_LogType type, MMP_MetaData_t *pMetaData)
{
	return 0;
}

static long MMProfileLogMetaStructure(MMP_Event event, MMP_LogType type,
				MMP_MetaDataStructure_t *pMetaData)
{
	return 0;
}

static long MMProfileLogMetaStringEx(MMP_Event event, MMP_LogType type, unsigned long data1,
				unsigned long data2, const char *str)
{
	return 0;
}

static long MMProfileLogMetaString(MMP_Event event, MMP_LogType type, const char *str)
{
	return 0;
}

static long MMProfileLogMetaBitmap(MMP_Event event, MMP_LogType type, MMP_MetaDataBitmap_t *pMetaData)
{
	return 0;
}
#endif
