...
extern unsigned long __must_check __arch_clear_user(void __user *addr, unsigned long n);
...
{
	return __arch_copy_in_user(__uaccess_mask_ptr(to), __uaccess_mask_ptr(from), n);
}
