					 ...
					 struct snd_ctl_elem_value *ucontrol)
{
	...
	if (afe_priv->tdm_coclk) {
		...
		regmap_update_bits(afe->regmap, AFE_TDM_IN_CON1, (1 << 20), (1 << 20));
		...
		regmap_update_bits(afe->regmap, AFE_TDM_IN_CON1, (1 << 20), (0 << 20));
	}
