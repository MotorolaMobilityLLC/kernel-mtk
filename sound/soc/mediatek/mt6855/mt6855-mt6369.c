...
/*
 *  mt6855-mt6369.c  --  mt6855 mt6369 ALSA SoC machine driver
 *
...
static const char *const
	mt6855_spk_i2s_type_str[] = {MTK_SPK_I2S_0_STR,
				     MTK_SPK_I2S_1_STR,
				     MTK_SPK_I2S_2_STR,
				     MTK_SPK_I2S_3_STR,
				     MTK_SPK_I2S_5_STR,
...
static const struct soc_enum mt6855_spk_type_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6855_spk_type_str),
			    mt6855_spk_type_str),
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6855_spk_i2s_type_str),
			    mt6855_spk_i2s_type_str),
};

static int mt6855_spk_type_get(struct snd_kcontrol *kcontrol,
...
static int mt6855_spk_i2s_out_type_get(struct snd_kcontrol *kcontrol,
				       struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6855_spk_i2s_in_type_get(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
...
static const struct snd_kcontrol_new mt6855_mt6369_controls[] = {
	...
	SOC_ENUM_EXT("MTK_SPK_I2S_OUT_TYPE_GET", mt6855_spk_type_enum[1],
		     mt6855_spk_i2s_out_type_get, NULL),
	SOC_ENUM_EXT("MTK_SPK_I2S_IN_TYPE_GET", mt6855_spk_type_enum[1],
		     mt6855_spk_i2s_in_type_get, NULL),
};

/*
 * define mtk_spk_i2s_mck node in dts when need mclk,
 * BE i2s need assign snd_soc_ops = mt6855_mt6369_i2s_ops
 */
static int mt6855_mt6369_i2s_hw_params(struct snd_pcm_substream *substream,
...
static const struct snd_soc_ops mt6855_mt6369_i2s_ops = {
	.hw_params = mt6855_mt6369_i2s_hw_params,
};

static int mt6855_mt6369_mtkaif_calibration(struct snd_soc_pcm_runtime *rtd)
{
	...
	miso0_need_calib = mt6855_afe_gpio_is_prepared(MT6855_AFE_GPIO_DAT_MISO0_ON);
	miso1_need_calib = mt6855_afe_gpio_is_prepared(MT6855_AFE_GPIO_DAT_MISO1_ON);
	miso2_need_calib = mt6855_afe_gpio_is_prepared(MT6855_AFE_GPIO_DAT_MISO2_ON);
...
static int mt6855_mt6369_init(struct snd_soc_pcm_runtime *rtd)
{
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	...
	ops.enable_dc_compensation = mt6855_enable_dc_compensation;
	...
	/* mtkaif calibration */
	mt6855_mt6369_mtkaif_calibration(rtd);
...
static int mt6855_i2s_hw_params_fixup(struct snd_soc_pcm_runtime *rtd,
				      struct snd_pcm_hw_params *params)
{
...
static const struct snd_pcm_hardware mt6855_mt6369_vow_hardware = {
...
static int mt6855_mt6369_vow_startup(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	...
	dev_info(afe->dev, "%s(), start\n", __func__);
	snd_soc_set_runtime_hwparams(substream, &mt6855_mt6369_vow_hardware);

	mt6855_afe_gpio_request(afe, true, MT6855_DAI_VOW, 0);
...
static void mt6855_mt6369_vow_shutdown(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	...
	mt6855_afe_gpio_request(afe, false, MT6855_DAI_VOW, 0);
...
static const struct snd_soc_ops mt6855_mt6369_vow_ops = {
	.startup = mt6855_mt6369_vow_startup,
	.shutdown = mt6855_mt6369_vow_shutdown,
};
...
static struct snd_soc_dai_link mt6855_mt6369_dai_links[] = {
	/* Front End DAI links */
	{
		.name = "Playback_1",
	...
	},
	{
		...
		.ops = &mt6855_mt6369_i2s_ops,
		.no_pcm = 1,
		.dpcm_capture = 1,
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		.be_hw_params_fixup = mt6855_i2s_hw_params_fixup,
...
static struct snd_soc_card mt6855_mt6369_soc_card = {
	.name = "mt6855-mt6369",
	.owner = THIS_MODULE,
	.dai_link = mt6855_mt6369_dai_links,
	.num_links = ARRAY_SIZE(mt6855_mt6369_dai_links),

	.controls = mt6855_mt6369_controls,
	.num_controls = ARRAY_SIZE(mt6855_mt6369_controls),
	.dapm_widgets = mt6855_mt6369_widgets,
	.num_dapm_widgets = ARRAY_SIZE(mt6855_mt6369_widgets),
	.dapm_routes = mt6855_mt6369_routes,
	.num_dapm_routes = ARRAY_SIZE(mt6855_mt6369_routes),
};
...
static int mt6855_mt6369_dev_probe(struct platform_device *pdev)
{
	struct snd_soc_card *card = &mt6855_mt6369_soc_card;
...
static const struct of_device_id mt6855_mt6369_dt_match[] = {
	{.compatible = "mediatek,mt6855-mt6369-sound",},
	{}
};
#endif

static const struct dev_pm_ops mt6855_mt6369_pm_ops = {
	.poweroff = snd_soc_poweroff,
	.restore = snd_soc_resume,
};

static struct platform_driver mt6855_mt6369_driver = {
	.driver = {
		.name = "mt6855-mt6369",
#if IS_ENABLED(CONFIG_OF)
		.of_match_table = mt6855_mt6369_dt_match,
#endif
		.pm = &mt6855_mt6369_pm_ops,
	},
	.probe = mt6855_mt6369_dev_probe,
};

module_platform_driver(mt6855_mt6369_driver);

/* Module information */
MODULE_DESCRIPTION("MT6855 mt6369 ALSA SoC machine driver");
MODULE_AUTHOR("Shane Chien <shane.chien@mediatek.com>");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("mt6855 mt6369 soc card");
