...
static int aw87xxxx_monitor_switch_put(struct snd_kcontrol *kcontrol,
			struct snd_ctl_elem_value *ucontrol)
{
...
static int aw87xxxx_monitor_switch_get(struct snd_kcontrol *kcontrol,
			struct snd_ctl_elem_value *ucontrol)
{
	struct aw87xxx *aw87xxx = (struct aw87xxx *)kcontrol->private_value;
	struct aw_monitor *aw_monitor = &aw87xxx->monitor;
						...
						void *codec)
{
	...
	aw87xxx_kcontrol[2].get = aw87xxxx_monitor_switch_get;
	aw87xxx_kcontrol[2].put = aw87xxxx_monitor_switch_put;
