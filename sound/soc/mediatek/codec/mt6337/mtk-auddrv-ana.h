...
#define AFE_NCP_CFG2                  ((UINT32)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0098))
...
#define AFE_DCCLK_CFG2               ((UINT32)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0132))
#define AFE_DCCLK_CFG3               ((UINT32)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0134))
