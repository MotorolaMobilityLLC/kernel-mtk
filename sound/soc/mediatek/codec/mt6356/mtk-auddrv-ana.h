...
/*#define AFE_ADDA_MTKAIF_MON0          ((UINT32)(PMIC_REG_BASE + 0x15a6))
*#define AFE_ADDA_MTKAIF_MON1          ((UINT32)(PMIC_REG_BASE + 0x15a8))
*#define AFE_ADDA_MTKAIF_MON2          ((UINT32)(PMIC_REG_BASE + 0x15aa))
*#define AFE_ADDA_MTKAIF_MON3          ((UINT32)(PMIC_REG_BASE + 0x15ac))
*/
#define PMIC_ADDA_MTKAIF_CFG0          ((UINT32)(PMIC_REG_BASE + 0x15ae))
/*#define AFE_ADDA_MTKAIF_RX_CFG0       ((UINT32)(PMIC_REG_BASE + 0x15b0))
*#define AFE_ADDA_MTKAIF_RX_CFG1       ((UINT32)(PMIC_REG_BASE + 0x15b2))
*#define AFE_ADDA_MTKAIF_RX_CFG2       ((UINT32)(PMIC_REG_BASE + 0x15b4))
*#define AFE_ADDA_MTKAIF_RX_CFG3       ((UINT32)(PMIC_REG_BASE + 0x15b6))
*#define AFE_ADDA_MTKAIF_TX_CFG1       ((UINT32)(PMIC_REG_BASE + 0x15b8))
*/
