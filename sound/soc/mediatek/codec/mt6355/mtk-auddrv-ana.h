...
#define AFE_VOW_SN_INI_CFG           ((UINT32)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0088))
...
#define AFE_VOW_MON4                 ((UINT32)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x009a))
...
#define AFE_NCP_CFG2                 ((UINT32)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x0108))
...
#define AFE_DL_DCM_CON               ((UINT32)(PMIC_AUDIO_SYS_TOP_REG_BASE + 0x013a))
...
#define TOP_CKPDN_CON4        ((UINT32)(PMIC_REG_BASE + 0x0418))
#define TOP_CKPDN_CON4_SET    ((UINT32)(PMIC_REG_BASE + 0x041a))
#define TOP_CKPDN_CON4_CLR    ((UINT32)(PMIC_REG_BASE + 0x041c))
#define TOP_CKSEL_CON0        ((UINT32)(PMIC_REG_BASE + 0x041e))
#define TOP_CKSEL_CON0_SET    ((UINT32)(PMIC_REG_BASE + 0x0420))
#define TOP_CKSEL_CON0_CLR    ((UINT32)(PMIC_REG_BASE + 0x0422))
#define TOP_CKSEL_CON2_SET    ((UINT32)(PMIC_REG_BASE + 0x0426))
#define TOP_CKSEL_CON2_CLR    ((UINT32)(PMIC_REG_BASE + 0x0428))
#define TOP_CKDIVSEL_CON0     ((UINT32)(PMIC_REG_BASE + 0x042a))
#define TOP_CKDIVSEL_CON0_SET ((UINT32)(PMIC_REG_BASE + 0x042c))
#define TOP_CKDIVSEL_CON0_CLR ((UINT32)(PMIC_REG_BASE + 0x042e))
#define TOP_CKHWEN_CON0       ((UINT32)(PMIC_REG_BASE + 0x0430))
#define TOP_CKHWEN_CON0_SET   ((UINT32)(PMIC_REG_BASE + 0x0432))
#define TOP_CKHWEN_CON0_CLR   ((UINT32)(PMIC_REG_BASE + 0x0434))
#define TOP_CKHWEN_CON1       ((UINT32)(PMIC_REG_BASE + 0x0436))
#define TOP_CKHWEN_CON1_SET   ((UINT32)(PMIC_REG_BASE + 0x0438))
#define TOP_CKHWEN_CON1_CLR   ((UINT32)(PMIC_REG_BASE + 0x043a))

#define TOP_BUCK_ANACK_FREQ_SEL_CON0       ((UINT32)(PMIC_REG_BASE + 0x043c))
#define TOP_BUCK_ANACK_FREQ_SEL_CON0_SET   ((UINT32)(PMIC_REG_BASE + 0x043e))
#define TOP_BUCK_ANACK_FREQ_SEL_CON0_CLR   ((UINT32)(PMIC_REG_BASE + 0x0440))
#define TOP_BUCK_ANACK_FREQ_SEL_CON1       ((UINT32)(PMIC_REG_BASE + 0x0442))
#define TOP_BUCK_ANACK_FREQ_SEL_CON1_SET   ((UINT32)(PMIC_REG_BASE + 0x0444))
#define TOP_BUCK_ANACK_FREQ_SEL_CON1_CLR   ((UINT32)(PMIC_REG_BASE + 0x0446))

#define TOP_CLKSQ             ((UINT32)(PMIC_REG_BASE + 0x044c))
#define TOP_CLKSQ_SET         ((UINT32)(PMIC_REG_BASE + 0x044e))
#define TOP_CLKSQ_CLR         ((UINT32)(PMIC_REG_BASE + 0x0450))
#define TOP_CLKSQ_RTC         ((UINT32)(PMIC_REG_BASE + 0x0452))
#define TOP_CLKSQ_RTC_SET     ((UINT32)(PMIC_REG_BASE + 0x0454))
#define TOP_CLKSQ_RTC_CLR     ((UINT32)(PMIC_REG_BASE + 0x0456))
#define TOP_CLK_TRIM          ((UINT32)(PMIC_REG_BASE + 0x0458))
#define TOP_CLK_CON0_SET      ((UINT32)(PMIC_REG_BASE + 0x045c))
#define TOP_CLK_CON0_CLR      ((UINT32)(PMIC_REG_BASE + 0x045e))
#define TOP_CLK_CON1_SET      ((UINT32)(PMIC_REG_BASE + 0x0462))
#define TOP_CLK_CON1_CLR      ((UINT32)(PMIC_REG_BASE + 0x0464))

#define ZCD_CON0                       ((UINT32)(PMIC_REG_BASE+0x3800))
#define ZCD_CON1                       ((UINT32)(PMIC_REG_BASE+0x3802))
#define ZCD_CON2                       ((UINT32)(PMIC_REG_BASE+0x3804))
#define ZCD_CON3                       ((UINT32)(PMIC_REG_BASE+0x3806))
#define ZCD_CON4                       ((UINT32)(PMIC_REG_BASE+0x3808))
#define ZCD_CON5                       ((UINT32)(PMIC_REG_BASE+0x380A))

#define LDO_VA18_CON0       ((UINT32)(PMIC_REG_BASE + 0x1666))
#define LDO_VA18_CON1       ((UINT32)(PMIC_REG_BASE + 0x1674))
#define LDO_VA18_CON2       ((UINT32)(PMIC_REG_BASE + 0x1676))
#define LDO_VA18_CON3       ((UINT32)(PMIC_REG_BASE + 0x1678))

#define DRV_CON2            ((UINT32)(PMIC_REG_BASE+0x0224))
#define DRV_CON3            ((UINT32)(PMIC_REG_BASE+0x0226))

/* PMIC Analog Audio Register */
#define AUDDEC_ANA_CON0        ((UINT32)(PMIC_REG_BASE + 0x3600))
#define AUDDEC_ANA_CON1        ((UINT32)(PMIC_REG_BASE + 0x3602))
#define AUDDEC_ANA_CON2        ((UINT32)(PMIC_REG_BASE + 0x3604))
#define AUDDEC_ANA_CON3        ((UINT32)(PMIC_REG_BASE + 0x3606))
#define AUDDEC_ANA_CON4        ((UINT32)(PMIC_REG_BASE + 0x3608))
#define AUDDEC_ANA_CON5        ((UINT32)(PMIC_REG_BASE + 0x360A))
#define AUDDEC_ANA_CON6        ((UINT32)(PMIC_REG_BASE + 0x360C))
#define AUDDEC_ANA_CON7        ((UINT32)(PMIC_REG_BASE + 0x360E))
#define AUDDEC_ANA_CON8        ((UINT32)(PMIC_REG_BASE + 0x3610))
#define AUDDEC_ANA_CON9        ((UINT32)(PMIC_REG_BASE + 0x3612))
#define AUDDEC_ANA_CON10       ((UINT32)(PMIC_REG_BASE + 0x3614))
#define AUDDEC_ANA_CON11       ((UINT32)(PMIC_REG_BASE + 0x3616))
#define AUDDEC_ANA_CON12       ((UINT32)(PMIC_REG_BASE + 0x3618))
#define AUDDEC_ANA_CON13       ((UINT32)(PMIC_REG_BASE + 0x361A))
#define AUDDEC_ANA_CON14       ((UINT32)(PMIC_REG_BASE + 0x361C))

#define AUDENC_ANA_CON0        ((UINT32)(PMIC_REG_BASE + 0x361E))
#define AUDENC_ANA_CON1        ((UINT32)(PMIC_REG_BASE + 0x3620))
#define AUDENC_ANA_CON2        ((UINT32)(PMIC_REG_BASE + 0x3622))
#define AUDENC_ANA_CON3        ((UINT32)(PMIC_REG_BASE + 0x3624))
#define AUDENC_ANA_CON4        ((UINT32)(PMIC_REG_BASE + 0x3626))
#define AUDENC_ANA_CON5        ((UINT32)(PMIC_REG_BASE + 0x3628))
#define AUDENC_ANA_CON6        ((UINT32)(PMIC_REG_BASE + 0x362A))
#define AUDENC_ANA_CON7        ((UINT32)(PMIC_REG_BASE + 0x362C))
#define AUDENC_ANA_CON8        ((UINT32)(PMIC_REG_BASE + 0x362E))
#define AUDENC_ANA_CON9        ((UINT32)(PMIC_REG_BASE + 0x3630))
#define AUDENC_ANA_CON10       ((UINT32)(PMIC_REG_BASE + 0x3632))
#define AUDENC_ANA_CON11       ((UINT32)(PMIC_REG_BASE + 0x3634))
#define AUDENC_ANA_CON12       ((UINT32)(PMIC_REG_BASE + 0x3636))
#define AUDENC_ANA_CON13       ((UINT32)(PMIC_REG_BASE + 0x3638))
#define AUDENC_ANA_CON14       ((UINT32)(PMIC_REG_BASE + 0x363A))
#define AUDENC_ANA_CON15       ((UINT32)(PMIC_REG_BASE + 0x363C))
#define AUDENC_ANA_CON16       ((UINT32)(PMIC_REG_BASE + 0x363E))

/* ACCDET register */
#define ACCDET_CON14        ((UINT32)(PMIC_REG_BASE + 0x1C1C))

/* PMIC GPIO register */
#define GPIO_MODE0          ((UINT32)(PMIC_REG_BASE + 0x2422))
#define GPIO_MODE1          ((UINT32)(PMIC_REG_BASE + 0x2428))
#define GPIO_MODE2          ((UINT32)(PMIC_REG_BASE + 0x242E))
