...
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	/* uint32_t eSamplingRate = mt_afe_rate_to_idx(runtime->rate); */
	...
	mt_afe_set_reg(AFE_TOP_CON0, 0x00000000, 0xffffffff);
...
static const struct of_device_id mt_soc_pcm_uldlloopback_of_ids[] = {
	...
	{.compatible = "mediatek," MT_SOC_ULDLLOOPBACK_PCM,},
	{}
};
MODULE_DEVICE_TABLE(of, mt_soc_pcm_uldlloopback_of_ids);
...
#endif
#ifdef CONFIG_OF
module_platform_driver(mtk_afe_uldllopback_driver);
#else
