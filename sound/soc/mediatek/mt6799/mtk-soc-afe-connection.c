...
bool SetDl1ToModem1Out(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I05,
			Soc_Aud_InterConnectionOutput_O07);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I06,
...
bool SetDl1ToModem2Out(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I05,
			Soc_Aud_InterConnectionOutput_O17);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I06,
...
bool SetAdc2ToModem1OutCh3(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I17,
...
bool SetProximityCicToDai2(unsigned int ConnectionState)
{
...
static bool SetI2s2ToVulData2(unsigned int ConnectionState)
{
...
static bool SetI2s2ToawbData2(unsigned int ConnectionState)
{
