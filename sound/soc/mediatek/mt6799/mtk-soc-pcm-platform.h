...
#define AUDIO_SRAM_PLAYBACK_FULL_SIZE	(1024 * 40)
#define AUDIO_SRAM_PLAYBACK_PARTIAL_SIZE	(1024 * 40)
#define AUDIO_DRAM_PLAYBACK_SIZE	(1024 * 40)
#else
#define AUDIO_SRAM_PLAYBACK_FULL_SIZE	(1024 * 32)
#define AUDIO_SRAM_PLAYBACK_PARTIAL_SIZE	(1024 * 32)
