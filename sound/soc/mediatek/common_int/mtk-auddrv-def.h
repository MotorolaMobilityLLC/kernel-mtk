...
#define MT_SOC_DL1_DATA2_PCM   "mt-soc-dl1-data2-pcm"
...
#define MT_SOC_CODEC_DL1DATA2TXDAI_NAME "mt-soc-codec-dl1data2tx-dai"
...
#define MT_SOC_DL1_DATA2_STREAM_NAME "DL1_DATA2_PLayback"
