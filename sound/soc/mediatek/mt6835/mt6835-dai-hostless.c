...
static const struct snd_pcm_hardware mt6835_hostless_hardware = {
...
static const struct snd_soc_dapm_route mtk_dai_hostless_routes[] = {
	...
	{"PCM_2_PB_CH4", "HW_SRC_2_OUT_CH1", "Hostless_HW_SRC_2_IN_DL"},
	{"PCM_2_PB_CH5", "HW_SRC_2_OUT_CH2", "Hostless_HW_SRC_2_IN_DL"},
				    ...
				    struct snd_soc_dai *dai)
{
	...
	snd_soc_set_runtime_hwparams(substream, &mt6835_hostless_hardware);
...
static struct snd_soc_dai_driver mtk_dai_hostless_driver[] = {
	...
	},
	{
		...
		.id = MT6835_DAI_HOSTLESS_SPH_ECHO_REF,
		.playback = {
	...
	},
	{
		...
		.id = MT6835_DAI_HOSTLESS_SPK_INIT,
		.playback = {
	...
	},
	{
		...
		.id = MT6835_DAI_HOSTLESS_IMPEDANCE,
		.playback = {
	...
	},
	{
		...
		.id = MT6835_DAI_HOSTLESS_HW_SRC_1_OUT,
		.playback = {
	...
	},
	{
		...
		.id = MT6835_DAI_HOSTLESS_HW_SRC_1_IN,
		.playback = {
	...
	},
	{
		...
		.id = MT6835_DAI_HOSTLESS_HW_SRC_2_OUT,
		.playback = {
	...
	},
	{
		...
		.id = MT6835_DAI_HOSTLESS_HW_SRC_2_IN,
		.playback = {
	...
	},
	{
		...
		.id = MT6835_DAI_HOSTLESS_HW_SRC_3_OUT,
		.playback = {
	...
	},
	{
		...
		.id = MT6835_DAI_HOSTLESS_HW_SRC_3_IN,
		.playback = {
	...
	},
	{
		...
		.id = MT6835_DAI_HOSTLESS_SRC_BARGEIN,
		.playback = {
	...
	},
	{
		...
		.id = MT6835_DAI_HOSTLESS_HW_GAIN_AAUDIO,
		.capture = {
	...
	},
	{
		...
		.id = MT6835_DAI_HOSTLESS_SRC_AAUDIO,
		.playback = {
