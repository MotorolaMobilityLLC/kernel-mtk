...
static int mtk_compr_offload_gdma_int_prepare(struct snd_compr_stream *stream)
{
	...
	if (mPrepareDone == false) {
		...
		if (afe_offload_block.pcmformat == SNDRV_PCM_FORMAT_S32_LE ||
			...
			SetoutputConnectionFormat(OUTPUT_DATA_FORMAT_24BIT, Soc_Aud_InterConnectionOutput_O28);
			SetoutputConnectionFormat(OUTPUT_DATA_FORMAT_24BIT, Soc_Aud_InterConnectionOutput_O29);
			...
			SetoutputConnectionFormat(OUTPUT_DATA_FORMAT_16BIT, Soc_Aud_InterConnectionOutput_O28);
		...
		u32AudioI2S = SampleRateTransform(afe_offload_block.samplerate, Soc_Aud_Digital_Block_I2S_OUT_2) << 8;
...
static int mtk_compr_offload_gdma_int_start(struct snd_compr_stream *stream)
{
	...
	SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I10, Soc_Aud_InterConnectionOutput_O28);
	SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I11, Soc_Aud_InterConnectionOutput_O29);
...
static int mtk_compr_offload_gdma_int_stop(struct snd_compr_stream *stream)
{
	...
	SetConnection(Soc_Aud_InterCon_DisConnect, Soc_Aud_InterConnectionInput_I12, Soc_Aud_InterConnectionOutput_O28);
	SetConnection(Soc_Aud_InterCon_DisConnect, Soc_Aud_InterConnectionInput_I13, Soc_Aud_InterConnectionOutput_O29);
