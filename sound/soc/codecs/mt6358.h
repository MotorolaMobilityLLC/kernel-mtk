...
/*receiver input_key*/
#define HANDSET_MONITOR_ON_KEY 0x248
#define HANDSET_MONITOR_OFF_KEY 0x249

/*PA Type*/
extern int pa_type;
enum{
	NONE_PA = -1,      //UNKNOW PA TYPE
	FS15XX,            //FSM Class-K PA
	AW87XXX,           //AWINIC Class-K PA
};
void switch_type(int type);

/*receiver input_key*/
extern struct input_dev *input;
extern int handset_mode_flag;
...
/*receiver input_key*/
void handset_monitor_select(struct input_dev *input,int handset_monitor_key);
