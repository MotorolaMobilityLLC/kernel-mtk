	...
	void *context)
{
	...
	pr_debug("[debug][%s] %s: enter load bin\r\n", LOG_FLAG, __func__);
	...
	// the firmware import operation for multi-channel is processed in parallel
...
void sipa_param_release(sipa_dev_t *si_pa)
{
	sipa_fw_loaded = 0;
