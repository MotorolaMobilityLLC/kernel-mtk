...
int fsm_reg_dump(fsm_dev_t *fsm_dev)
{
    ...
    for (reg_addr = 0; reg_addr <= 0xE8; reg_addr++) {
        if (reg_addr == 0x0B) reg_addr = 0x46;
        else if (reg_addr == 0x49) reg_addr = 0x4D;
        else if (reg_addr == 0x50) reg_addr = 0x5B;
        else if (reg_addr == 0x6D) reg_addr = 0x89;
        else if (reg_addr == 0x8A) reg_addr = 0xA0;
        else if (reg_addr == 0xA2) reg_addr = 0xAF;
        else if (reg_addr == 0xB0) reg_addr = 0xBB;
        else if (reg_addr == 0xBE) reg_addr = 0xC0;
        else if (reg_addr == 0xC5) reg_addr = 0xC9;
        else if (reg_addr == 0xCE) reg_addr = 0xD0;
        else if (reg_addr == 0xD1) reg_addr = 0xD7;
        else if (reg_addr == 0xD8) reg_addr = 0xE8;
        if (reg_addr == 0xD0) {
