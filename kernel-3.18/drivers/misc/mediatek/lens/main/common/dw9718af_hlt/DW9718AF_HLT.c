...
#define AF_DRVNAME "DW9718AF_HLT_DRV"
...
static int s4DW9718AF_HLT_ReadReg(unsigned short *a_pu2Result)
{
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		initdrv();
		ret = s4DW9718AF_HLT_ReadReg(&InitPos);
...
/* ////////////////////////////////////////////////////////////// */
long DW9718AF_HLT_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int DW9718AF_HLT_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void DW9718AF_HLT_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
